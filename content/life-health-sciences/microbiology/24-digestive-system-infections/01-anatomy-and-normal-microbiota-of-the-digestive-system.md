...
description: >-
  Digestive-system anatomy from mouth to anus, the normal microbiota of the
  oral cavity and GI tract, the tract's defenses against infection, and the
  general signs and symptoms — gastritis, enteritis, colitis, dysentery — of
  digestive disease — adapted from OpenStax Microbiology, Section 24.1.
source_section: "24.1"
weight: 1
---
...
*The case continues in [Bacterial Infections of the Gastrointestinal Tract](/life-health-sciences/microbiology/24-digestive-system-infections/03-bacterial-infections-of-the-gastrointestinal-tract/).*
{{< /callout >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_24_01_OralCavity" kind="diagram" alt="(a) A head shown in profile, labeled with the nasal cavity, oral cavity, tongue, lips, jaw, uvula, pharynx, esophagus, and larynx. (b) The same head in profile, labeled with the teeth and the three salivary glands — the parotid gland at the back of the jaw, the submandibular gland below the jaw, and the sublingual gland beneath the tongue." longdesc="Panel (a), front to back: lips, jaw, and the tongue in the oral cavity; the nasal cavity above; the uvula at the back of the mouth; the pharynx, continuing down as the esophagus; and the larynx, which also connects to the pharynx but leads to the respiratory system — no teeth are labeled in this panel. Panel (b) shows the same head with the teeth and three labeled salivary glands, drawn as if seen through the skin: the sublingual gland, a thin gland just beneath the lower teeth toward the front of the jaw; the submandibular gland, a rounded gland just behind and below it at the lower edge of the jaw; and the parotid gland, the largest of the three, higher up on the cheek over the back of the jaw, in front of and below the ear." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_24_01_Tooth" kind="diagram" alt="A tooth shown in cross-section within the jawbone and gum. Above the gum line, the crown is capped by a layer of enamel over a layer of dentin surrounding the pulp cavity. Below the gum line, the thinner root is covered by cementum and contains the pulp canal (root canal) with nerves and blood vessels, all set in bone. A small gap between the tooth and gum is labeled the gingival crevice." longdesc="A brace on the left marks the crown, above the gum line, and a second brace marks the root, below the gum line; the tooth drawn has two roots, each with its own pulp canal. Labels on the right, top to bottom: enamel, the outermost layer of the crown; dentin, the layer beneath the enamel, continuing around the pulp canal in the root but narrowing toward the root's tip; pulp cavity and pulp; gingival crevice, a small gap where the tooth meets the gum; gingiva (gums); bone, surrounding the root; pulp canal (root canal), inside the root; cementum, covering the outside of the root; and nerves and blood vessels, running through the pulp canal." >}}
...
saliva's lysozyme damages microbial cells by cleaving peptidoglycan linkages
immunoglobulins and phagocytic cells are produced in the gingival spaces
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_24_01_Villi" kind="diagram" alt="(a) A diagram of the small intestine's wall at three levels of magnification: a segment of gut tube with muscle layers and villi lining the lumen; a cutaway of two villi showing absorptive cells, goblet cells, capillaries, arteries, veins, lymphatic vessels, an intestinal crypt, and Peyer's patches; and a single absorptive cell's surface covered in microvilli (brush border). (b–d) Micrographs of the same structures at increasing magnification, from whole villi down to the microvilli, with scale bars of 1.5 mm, 100 microns, and 100 nm." longdesc="Panel (a) has three parts. First, a segment of the intestinal tube with a wavy ridged inner surface, lined with muscle layers, with a blood vessel entering from outside and the lumen labeled at the tube's open center; at the opened tube's cut lower edge the wall is shown in section, bearing several frond-shaped villi, each with a feathery, lobed outline, marked by three leaders from the label 'villi'. A small box on that cut edge leads by a gray arrow to the second part. Second, a magnified cutaway of two villus folds: the surface is covered with absorptive cells and goblet cells; capillaries, arteries, veins, and lymphatic vessels run inside each fold; the indentation between the folds is the intestinal crypt; darker patches beneath the folds are Peyer's patches; and two unlabeled ring-shaped structures sit at the base of the tissue. Third, a gray arrow from a small box on one absorptive cell near a villus tip leads to that whole cell enlarged, its top surface covered in a row of finger-shaped microvilli, labeled the brush border. Panels (b), (c), and (d) are micrographs at increasing magnification, each linked to the next by an arrow from a boxed region — a light micrograph of whole villi (scale bar 1.5 mm), a closer light micrograph of the boxed villus surface (scale bar 100 microns), and an electron micrograph of the microvilli from the box in (c) (scale bar 100 nm)." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_24_01_GobletCell" kind="photo" alt="A micrograph of two bands of pink-stained intestinal lining tissue separated by a clear gap. Along the edge of each band that faces the pale central gap, a two-headed arrow labeled goblet cells points to one of several lighter, oval-shaped goblet cells among the darker-staining cells." >}}
...
fermentation by anaerobic microbes in the mouth can cause tooth decay, cavities, and periodontal disease
lower GI infections and intoxications often produce symptoms such as nausea, vomiting, diarrhea, aches, and fever
in some cases, lower GI infections and intoxications can produce severe dehydration
{{< /selfcheck >}}
...
{{< multiplechoice
  question="What types of microbes live in the intestines?"
  answer="Diverse species of bacteria, archaea, and fungi, especially *Bacteroides* and *Firmicutes* bacteria"
  hint="Read the paragraph on the harsh environment of most of the GI tract."
>}}
...
{{< multiplechoice
  question="Which of the following is NOT a way the normal microbiota of the intestine helps to prevent infection?"
  answer="It generates large quantities of oxygen that kill anaerobic pathogens."
  hint="Read the paragraph that begins with the constant movement of materials through the gastrointestinal tract."
>}}
It secretes protein toxins that bind to specific receptors on the surface of susceptible bacteria.
...
{{< textin
  question="Bacteria of the normal microbiota that outcompete potential pathogens for space and nutrients within the intestine are said to exhibit ________."
  answer="competitive exclusion"
  hint="The mechanism is named right after the description of outcompeting pathogens for space and nutrients."
>}}
...
{{< multiplechoice
  question="How does the diarrhea caused by dysentery differ from other types of diarrhea?"
  answer="Damage to the epithelial cells of the colon causes bleeding and excess mucus to appear in the stools."
  hint="Read the last sentence of the paragraph on clinical terms for gastrointestinal symptoms."
>}}
Damage to the epithelial cells of the colon causes bleeding and excess mucus to appear in the stools.
An inflamed colon simply fails to reabsorb water as effectively as normal, making the stools watery without any bleeding or mucus.
Vomiting and severe dehydration occur, but the stools themselves show no change in appearance.
Nausea, aches, and fever accompany the diarrhea, but the stool's water content is unaffected.
{{< /multiplechoice >}}

...
{{< selfcheck question="Compare and contrast the microbiota of the small and large intestines." hint="One region's environment is less harsh and hosts a narrower set of microbes; the other's is more diverse and abundant — name what each includes." >}}
...
{{< multiplechoice
  ...
  hint="Think about where in the GI tract the microbiota is most abundant and varied — not a narrow group."
>}}
...
{{< multiplechoice
  ...
  hint="Three options are established mechanisms named in the text; one attributes an implausible antimicrobial byproduct to the microbiota."
>}}
...
{{< multiplechoice
  ...
  hint="The defining difference is in what appears in the stool itself, not simply that the stool is watery."
>}}

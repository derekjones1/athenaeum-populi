...
description: >-
  Giardiasis, cryptosporidiosis, amoebiasis, and cyclosporiasis — the
  protozoan pathogens, signs and symptoms, and treatments of gastrointestinal
  infections — adapted from OpenStax Microbiology, Section 24.5.
source_section: "24.5"
weight: 5
---
...
Also called backpacker's diarrhea or beaver fever, **giardiasis** is a common disease in the United States caused by the flagellated protist *Giardia lamblia*, also known as *Giardia intestinalis* or *Giardia duodenalis* (see the *Giardia lamblia* micrograph in [Types of Microorganisms](/life-health-sciences/microbiology/01-an-invisible-world/03-types-of-microorganisms/)). To establish infection, *G. lamblia* uses a large adhesive disk to attach to the intestinal mucosa. The disk is comprised of microtubules. During adhesion, the flagella of *G. lamblia* move in a manner that draws fluid out from under the disk, resulting in an area of lower pressure that promotes its adhesion to the intestinal epithelial cells. Due to its attachment, *Giardia* also blocks absorption of nutrients, including fats.
...
{{< mediafigure src="microbiology/OSC_Microbio_24_05_Cryptospor" kind="photo" eager="true" alt="Micrograph of several green glowing, ring-shaped circles of varying sizes scattered on a dark background, including a cluster of three touching circles and one larger bright glowing patch, with a 10 µm scale bar in the lower right." >}}
Immunofluorescent staining allows for visualization of *Cryptosporidium* spp. (credit: modification of work by EPA/H.D.A. Lindquist)
{{< /mediafigure >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_24_05_Cyclospor" kind="photo" alt="Micrograph of a bright blue glowing sphere near the center of a mottled, hazy dark blue background, with a line pointing to the sphere and a label reading C. cayetanensis." >}}
*Cyclospora cayetanensis* are autofluorescent under ultraviolet light. (credit: modification of work by Centers for Disease Control and Prevention)
{{< /mediafigure >}}

**Check Your Understanding**

{{< selfcheck question="Which protozoan GI infections are common in the United States?" hint="Look at the transmission and prevalence sentences in each of the four disease subsections." >}}
...
cryptosporidiosis causes outbreaks in the United States through the public water supply, water parks, swimming pools, and day-care centers, though it is more common overall in developing countries
amoebiasis is most widespread in the developing world
cyclosporiasis is uncommon in the United States, with outbreaks tied to contaminated imported produce
{{< /selfcheck >}}
...
{{< textin
  ...
  answer="giardia"
  accept="Giardia lamblia|G. lamblia|Giardia intestinalis|Giardia duodenalis"
  hint="Look at the symptoms paragraph of the first disease subsection."
>}}
...
{{< multiplechoice
  question="Which protozoan has a unique appearance, with a blue halo, when viewed using ultraviolet fluorescence microscopy?"
  answer="*Cyclospora cayetanensis*"
  hint="Look at this section's second figure and the sentence that introduces it."
>}}
*Giardia lamblia*
*Cryptosporidium hominis*
*Cyclospora cayetanensis*
...
{{< mediafigure src="microbiology/OSC_Microbio_24_05_ArtCon_img" kind="photo" alt="Micrograph of many pear-shaped cells, each trailing several thin thread-like tails, densely packed together on a textured surface." >}}
Protozoans attached to the intestinal wall of a gerbil. (credit: Dr. Stan Erlandsen, Centers for Disease Control and Prevention)
{{< /mediafigure >}}
...
{{< multiplechoice
  question="What is an O&P exam?"
  answer="Direct examination of a stool sample for the presence of cysts and trophozoites, used to distinguish common parasitic intestinal infections."
  hint="Look at the diagnosis paragraph of the first disease subsection."
>}}
Magnetic resonance imaging (MRI) to detect a liver abscess
Direct examination of a stool sample for the presence of cysts and trophozoites, used to distinguish common parasitic intestinal infections.
Enzyme immunoassay testing that may not distinguish a current infection from a past one
A commercial direct fluorescence antibody kit
{{< /multiplechoice >}}

{{< textin
  question="Microscopic examination of stool or ________ specimens is often used in diagnosis, in combination with other approaches."
  answer="biopsy"
...
{{< multiplechoice
  question="Which of these protozoan gastrointestinal infections is diagnosed in part using acid-fast staining?"
  answer="Cryptosporidiosis"
  hint="Compare the diagnosis paragraphs of the four disease subsections."
>}}
Amoebiasis
Giardiasis
Cryptosporidiosis

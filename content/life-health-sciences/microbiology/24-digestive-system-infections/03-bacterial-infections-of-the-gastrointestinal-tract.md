...
description: >-
  Staphylococcal food poisoning, shigellosis, salmonellosis, typhoid fever,
  pathogenic E. coli groups, cholera, Campylobacter, peptic ulcers,
  Clostridioides difficile, and other bacterial infections of the
  gastrointestinal tract — adapted from OpenStax Microbiology, Section 24.3.
source_section: "24.3"
weight: 3
---
...
**Staphylococcal food poisoning** is one form of food intoxication. When *Staphylococcus aureus* grows in food, it may produce enterotoxins that, when ingested, can cause symptoms such as nausea, diarrhea, cramping, and vomiting within one to six hours. In some severe cases, it may cause headache, dehydration, and changes in blood pressure and heart rate. Signs and symptoms resolve within 24 to 48 hours. *S. aureus* is often associated with a variety of raw or undercooked and cooked foods including meat (e.g., canned meat, ham, and sausages) and dairy products (e.g., cheeses, milk, and butter). It is also commonly found on hands and can be transmitted to prepared foods through poor hygiene, including poor handwashing and the use of contaminated food preparation surfaces, such as cutting boards. The greatest risk is for food left at a temperature below 60 °C (140 °F), which allows the bacteria to grow. Cooked foods should generally be reheated to at least 60 °C (140 °F) for safety and most raw meats should be cooked to even higher internal temperatures (shown below).

{{< mediafigure src="microbiology/OSC_Microbio_24_03_DangerZone" kind="diagram" eager="true" alt="A large thermometer scaled in Fahrenheit and Celsius, from a freezer temperature of 0°F/−18°C on the left to a poultry-safe temperature of 165°F/74°C on the right. A red starburst reading DANGER ZONE marks the middle of the scale, between the refrigerator temperature (40°F/4°C) and the safe holding temperature for cooked foods (140°F/60°C)." longdesc="The thermometer reads, left to right: 0°F (−18°C), labeled freezer temperature; 40°F (4°C), labeled refrigerator temperature; the danger zone, marked with a red starburst reading DANGER ZONE, spanning roughly the middle of the scale; 140°F (60°C), labeled holding temperature for cooked foods and reheating of fully cooked ham; 145°F (63°C), labeled beef, pork, lamb, veal, roasts, steaks, chops; 160°F (71°C), labeled egg dishes and ground meat; and 165°F (74°C), labeled poultry, stuffing, casseroles, and reheat leftovers." >}}
...
{{< multiplechoice
  question="How can *S. aureus* cause food intoxication?"
  answer="It grows in food and produces enterotoxins, which cause symptoms once the contaminated food is ingested."
  hint="Reread the opening paragraph of this section, then the first paragraph of the Staphylococcal Food Poisoning subsection."
>}}
It colonizes the gut after ingestion and then produces toxins that damage host cells.
It grows in food and produces enterotoxins, which cause symptoms once the contaminated food is ingested.
It invades intestinal epithelial cells and multiplies within the cytoplasm.
It attaches to epithelial cells and releases an A-B toxin that raises cAMP levels.
{{< /multiplechoice >}}
...
Stool samples, which should be processed promptly, are analyzed using serological or molecular techniques. One common method is to perform immunoassays for *S. dysenteriae*. Other methods that can be used to identify *Shigella* include API test strips, Enterotube systems, or PCR testing. The presence of white blood cells and blood in fecal samples occurs in about 70% of patients (Jaya Sureshbabu. "Shigella Infection Workup." *Medscape*. Updated Jun 28, 2016.) (shown below). Severe cases may require antibiotics such as ciprofloxacin and azithromycin, but these must be carefully prescribed because resistance is increasingly common.

{{< mediafigure src="microbiology/OSC_Microbio_24_03_Shigella" kind="photo" alt="A micrograph of a stool sample showing small round red blood cells and larger, darker-staining white blood cells scattered among thin rod-shaped bacteria, with one white blood cell and one pair of red blood cells labeled." >}}
Red and white blood cells can be seen in this micrograph of a stool sample from a patient with shigellosis.
{{< /mediafigure >}}

**Check Your Understanding**

{{< selfcheck question="Compare and contrast Shigella infections and intoxications." hint="Reread the section's opening paragraph on infection and intoxication, then the second paragraph of the Shigellosis subsection." >}}
An infection, as defined at the start of this section, occurs when the microbial agent is ingested, colonizes the gut, and then produces toxins that damage host cells — this is what happens with *Shigella*, which invades intestinal epithelial cells, escapes the phagosome, and multiplies within the cytoplasm or spreads to adjacent cells, ulcerating the epithelium and Peyer's patches. An intoxication, by contrast, occurs when bacteria produce toxins in food before it is ingested, as with *Staphylococcus aureus*. *S. dysenteriae* type 1 also produces a toxin, Shiga toxin, which targets the endothelial cells of small blood vessels in the small and large intestine; the section describes it as part of the infection and never as produced in food.
===CHECKS===
an infection occurs when the microbial agent is ingested, colonizes the gut, and then produces toxins that damage host cells
Shigella invades intestinal epithelial cells, escapes the phagosome, and multiplies within the cytoplasm or spreads to adjacent cells
an intoxication occurs when bacteria produce toxins in food before it is ingested
S. dysenteriae type 1 also produces Shiga toxin, which targets the endothelial cells of small blood vessels
{{< /selfcheck >}}
...
Once the bacteria are ingested, they multiply within the intestines and penetrate the epithelial mucosal cells via M cells where they continue to grow (shown below). They trigger inflammatory processes and the hypersecretion of fluids. Once inside the body, they can persist inside the phagosomes of macrophages. *Salmonella* can cross the epithelial cell membrane and enter the bloodstream and lymphatic system. Some strains of *Salmonella* also produce an enterotoxin that can cause an intoxication.

{{< mediafigure src="microbiology/OSC_Microbio_24_03_Salmonella" kind="photo" alt="A colorized scanning electron micrograph showing pink, rod-shaped Salmonella cells with thin fimbriae attached to and burrowing into a folded, textured yellow-green host cell surface." >}}
...
{{< selfcheck question="Why is serotyping particularly important in Salmonella infections and typhoid fever?" hint="Reread the Salmonellosis paragraph on diagnosis and treatment and the opening of Typhoid Fever." >}}
Serotyping matters for two reasons this section gives. First, in salmonellosis, diagnosis involves culture followed by serotyping and DNA fingerprinting if needed, and serotyping is important for determining treatment. Second, the serotype separates the two diseases: certain serotypes of *S. enterica*, primarily serotype Typhi but also Paratyphi, cause a more severe type of salmonellosis called typhoid fever, a serious illness with an untreated mortality rate of 10%, which the section discusses separately from the salmonellosis caused by other serotypes.
===CHECKS===
in salmonellosis, diagnosis involves culture followed by serotyping, and serotyping is important for determining treatment
certain serotypes of *S. enterica*, primarily serotype Typhi but also Paratyphi, cause a more severe type of salmonellosis called typhoid fever
typhoid fever, a serious illness with an untreated mortality rate of 10%
{{< /selfcheck >}}

{{< callout type="info" >}}
**Eye on Ethics.** *Typhoid Mary*
...
Cholera may be self-limiting and treatment involves rehydration and electrolyte replenishment. Although antibiotics are not typically needed, they can be used for severe or disseminated disease. Tetracyclines are recommended, but doxycycline, erythromycin, orfloxacin, ciprofloxacin, and TMP/SMZ may be used. Recent evidence suggests that azithromycin is also a good first-line antibiotic. Good sanitation—including appropriate sewage treatment, clean supplies for cooking, and purified drinking water—is important to prevent infection (shown below).

{{< mediafigure src="microbiology/OSC_Microbio_24_03_VibrioChol" kind="photo" alt="(a) A photo of a person collecting water from a murky waterway beside makeshift wooden boats. (b) A photo of a person lying on a cot inside a treatment tent, receiving intravenous fluids. (c) A micrograph of a single curved, rod-shaped cell about 1 micrometer long." >}}
(a) Outbreaks of cholera often occur in areas with poor sanitation or after natural disasters that compromise sanitation infrastructure. (b) At a cholera treatment center in Haiti, patients are receiving intravenous fluids to combat the dehydrating effects of this disease. They often lie on a cot with a hole in it and a bucket underneath to allow for monitoring of fluid loss. (c) This scanning electron micrograph shows *Vibrio cholerae*. (credit a, b: modification of work by Centers for Disease Control and Prevention; credit c: modification of work by Janice Carr, Centers for Disease Control and Prevention)
{{< /mediafigure >}}

*V. cholerae* is not the only *Vibrio* species that can cause disease. *V. parahemolyticus* is associated with consumption of contaminated seafood and causes gastrointestinal illness with signs and symptoms such as watery diarrhea, nausea, fever, chills, and abdominal cramps. The bacteria produce a heat-stable hemolysin, leading to dysentery and possible disseminated disease. It also sometimes causes wound infections. *V. parahemolyticus* is diagnosed using cultures from blood, stool, or a wound. As with *V. cholerae*, selective medium (especially TCBS agar) works well. Tetracycline and ciprofloxacin can be used to treat severe cases, but antibiotics generally are not needed.
...
{{< selfcheck question="How does V. cholerae infection cause rapid dehydration?" hint="Reread the second paragraph of the Cholera and Other Vibrios subsection." >}}
*V. cholerae* cells attach to intestinal epithelial cells and release cholera enterotoxin, an A-B toxin that acts through adenylate cyclase. Inside the intestinal cell, this raises cyclic AMP (cAMP) levels, which activates a chloride channel and releases ions into the intestinal lumen. The resulting increase in osmotic pressure in the lumen draws water in after the ions, and as this water and these electrolytes leave the body, they cause the profuse "rice water stool" diarrhea that produces rapid dehydration and electrolyte imbalance.
===CHECKS===
V. cholerae releases cholera enterotoxin, an A-B toxin that acts through adenylate cyclase
inside the intestinal cell this raises cAMP levels, which activates a chloride channel and releases ions into the lumen
the increase in osmotic pressure draws water into the lumen
as water and electrolytes leave the body they cause rapid dehydration and electrolyte imbalance
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_24_03_Ulcers" kind="diagram" alt="A cross-section diagram of the stomach lining showing a wavy layer of mucus-covered epithelial cells above a blood vessel carrying red blood cells, neutrophils, and monocytes; at center, a green rod-shaped Helicobacter pylori cell with flagella sits in a gap in the mucus layer, with inset photos above showing a smooth pink healthy stomach lining and an ulcer as a pale crater in reddened tissue." longdesc="Left side: healthy stomach epithelium, its cells topped by a thick, even layer of mucus, with an arrow up to an inset photo of smooth, glistening pink tissue, labeled 'Healthy stomach epithelia are coated in a layer of mucus.' Center: a single Helicobacter pylori cell, drawn as a green rod with several thin flagella, sits directly on the epithelial cells where the mucus layer thins, labeled 'Helicobacter pylori colonizes epithelial cells and decreases the production of mucus.' Right side: over a stretch labeled 'ulcer,' the epithelial cells are gone, with torn cells at its edges and the exposed tissue stained orange, with an arrow up to an inset photo of a pale, crater-like sore in reddened tissue, labeled 'Gastric acids cause the formation of ulcers.' Below the epithelial layer, a blood vessel runs the width of the figure carrying red blood cells and labeled neutrophils and monocytes." >}}
...
Although treatment is often valuable, there are also risks to *H. pylori* eradication. Infection with *H. pylori* may actually protect against some cancers, such as esophageal adenocarcinoma and gastroesophageal reflux disease (Martin J. Blaser. "Disappearing Microbiota: *Helicobacter pylori* Protection against Esophageal Adenocarcinoma." *Cancer Prevention Research* 1 (2008) 5: pp. 308–311.) (Ivan F. N. Hung and Benjamin C. Y. Wong. "Assessing the Risks and Benefits of Treating *Helicobacter pylori* Infection." *Therapeutic Advances in Gastroenterology* 2 (2009) 3: pp. 141–147. doi: 10.1177/1756283X08100279.).

**Check Your Understanding**

{{< selfcheck question="How does H. pylori cause peptic ulcers?" hint="Reread the second paragraph of the Peptic Ulcers subsection." >}}
*H. pylori* colonizes epithelial cells in the stomach using pili for adhesion, and produces urease, which stimulates an immune response and creates ammonia that neutralizes stomach acids to provide a more hospitable microenvironment for the bacteria. The infection damages the cells of the stomach lining, including those that normally produce the protective mucus that serves as a barrier between the tissue and stomach acid. As a result, inflammation (gastritis) occurs and ulcers may slowly develop; ulcer formation can also be caused by the activity of the bacterium's own toxin, VacA.
===CHECKS===
H. pylori produces urease, which creates ammonia that neutralizes stomach acid
the infection damages the stomach-lining cells that normally produce protective mucus
inflammation (gastritis) occurs and ulcers may slowly develop
ulcer formation can also be caused by the toxin VacA
{{< /selfcheck >}}
...
This bacterium produces two toxins, *Clostridioides difficile* toxin A (TcdA) and *Clostridioides difficile* toxin B (TcdB). These toxins inactivate small GTP-binding proteins, resulting in actin condensation and cell rounding, followed by cell death. Infections begin with focal necrosis, then ulceration with exudate, and can progress to **pseudomembranous colitis**, which involves inflammation of the colon and the development of a pseudomembrane of fibrin containing dead epithelial cells and leukocytes (shown below). Watery diarrhea, dehydration, fever, loss of appetite, and abdominal pain can result. Perforation of the colon can occur, leading to septicemia, shock, and death. *C. difficile* is also associated with necrotizing enterocolitis in premature babies and neutropenic enterocolitis associated with cancer therapies.

{{< mediafigure src="microbiology/OSC_Microbio_24_03_pseudocoli" kind="diagram" alt="A cross-section diagram of the colon lining, similar to the peptic-ulcer figure, showing a mucus-covered epithelium above a blood vessel; at left a mixed community of small rod- and coccus-shaped bacteria sits in normal mucus, and at center a cluster of yellow rod-shaped Clostridioides difficile cells releases small dots labeled TcdA and TcdB, building into a raised, damaged pseudomembrane at right where neutrophils and monocytes migrate up from the blood vessel below; an inset photo above shows a dense mat of green rod-shaped cells." longdesc="Left side: the normal microbiota, drawn as a mix of small rod- and coccus-shaped bacteria of several colors, sits just above the surface of the mucus layer (labeled 'mucus') that coats healthy epithelial cells, under a bracket labeled 'normal microbiota.' Center: a cluster of yellow rod-shaped cells labeled Clostridioides difficile sits where the mucus has thinned, releasing small red dots labeled TcdA and small yellow dots labeled TcdB onto the epithelial cells beneath it, and scattered further onto the pseudomembrane at right; an arrow points up from this cluster to an inset photo of a dense mat of green rod-shaped cells. Right side: a raised, swollen orange layer labeled 'pseudomembrane' covers the damaged epithelial cells, with more yellow rods lying on its surface and toxin dots and immune cells inside it; neutrophils and monocytes, drawn like the labeled ones in the blood vessel, are shown migrating up from the vessel through the tissue into it. Below the epithelial layer, a blood vessel runs the width of the figure carrying red blood cells and the same labeled neutrophils and monocytes." >}}
...
{{< multiplechoice
  question="How does antibiotic use lead to *C. difficile* infections?"
  answer="Long-term antibiotic use disrupts the normal microbiota, allowing C. difficile to overgrow and cause diarrhea."
  hint="Read the opening paragraph of the subsection on this organism."
>}}
Long-term antibiotic use disrupts the normal microbiota, allowing C. difficile to overgrow and cause diarrhea.
C. difficile produces endospores that let it survive for long periods in harsh environments.
The toxins TcdA and TcdB inactivate small GTP-binding proteins, causing cell death.
In severe cases, perforation of the colon can lead to septicemia and shock.
{{< /multiplechoice >}}
...
{{< selfcheck question="Compare and contrast foodborne illnesses due to B. cereus and Yersinia." hint="Reread the Foodborne Illness Due to *Bacillus cereus* and Foodborne Illness Due to *Yersinia* subsections." >}}
*B. cereus* foodborne illness is generally mild, with signs and symptoms — nausea, pain, and abdominal cramps — appearing within a few hours of eating contaminated rice or other prepared foods, caused by two toxins (one producing diarrhea, one producing vomiting); antibiotics are not typically needed because it is due to toxin activity. *Yersinia* infection is also normally relatively mild and self-limiting, generally transmitted through the fecal-oral route, but it can behave differently: severe diarrhea and dysentery can develop in infants, and in adults the infection can spread beyond the gut to cause complications such as reactive arthritis, thyroid disorders, endocarditis, glomerulonephritis, eye inflammation, or erythema nodosum, with bacteremia in rare cases — complications *B. cereus* is not described as causing.
===CHECKS===
B. cereus illness is generally mild, from two toxins, one causing diarrhea and one vomiting
antibiotics are not typically needed for B. cereus because it is due to toxin activity
Yersinia infection is normally mild and self-limiting but severe diarrhea and dysentery can develop in infants
in adults, Yersinia infection can spread and cause complications such as reactive arthritis, thyroid disorders, endocarditis, or glomerulonephritis
{{< /selfcheck >}}

{{< callout type="info" >}}
**Disease Profile.** *Bacterial Infections of the Gastrointestinal Tract*

Bacterial infections of the gastrointestinal tract generally occur when bacteria or bacterial toxins are ingested in contaminated food or water. Toxins and other virulence factors can produce gastrointestinal inflammation and general symptoms such as diarrhea and vomiting. Bacterial GI infections can vary widely in terms of severity and treatment. Some can be treated with antibiotics, but in other cases antibiotics may be ineffective in combating toxins or even counterproductive if they compromise the GI microbiota. The table below summarizes the key features of common bacterial GI infections.
...
| *Clostridioides difficile* infection | *Clostridioides difficile* | Pseudomembranous colitis, watery diarrhea, fever, abdominal pain, loss of appetite, dehydration; in severe cases, perforation of the colon, septicemia, shock, and death | Overgrowth of *C. difficile* in the normal microbiota due to antibiotic use; hospital-acquired infections in immunocompromised patients | Detection of toxin in stool, nucleic acid amplification tests (e.g., PCR) | Discontinuation of previous antibiotic treatment; metronidazole or vancomycin |
...
| *E. coli* infection | ETEC, EPEC, EIEC, EHEC | Watery diarrhea, dysentery, cramps, malaise, fever, chills, dehydration; in EHEC, possible severe complications such as hemolytic uremic syndrome | Ingestion of contaminated food or water | Tissue culture, immunochemical assays, PCR, gene probes | Not recommended for EIEC and EHEC; fluoroquinolones, doxycycline, rifaximin, and TMP/SMZ possible for ETEC and EPEC |
...
| Salmonellosis | *Salmonella enterica*, serotype Enteritidis | Fever, nausea, vomiting, abdominal cramps, headache, diarrhea; can be fatal in infants | Ingestion of contaminated food, handling of eggshells or contaminated animals | Culturing, serotyping and DNA fingerprinting | Not generally recommended; fluoroquinolones, ampicillin, others for immunocompromised patients |
...
*The case continues in [Helminthic Infections of the Gastrointestinal Tract](/life-health-sciences/microbiology/24-digestive-system-infections/06-helminthic-infections-of-the-gastrointestinal-tract/). The case began in [Anatomy and Normal Microbiota of the Digestive System](/life-health-sciences/microbiology/24-digestive-system-infections/01-anatomy-and-normal-microbiota-of-the-digestive-system/).*
{{< /callout >}}
...
- **traveler's diarrhea** — a relatively mild diarrheal illness caused by ETEC, common in less developed countries.
...
- **cholera** — gastrointestinal illness caused by *Vibrio cholerae* characterized by severe diarrhea.
...
- **peptic ulcers** — an ulcer in the lining of the stomach or duodenum, often associated with *Helicobacter pylori*.
...
{{< textin
  question="Antibiotic associated pseudomembranous colitis is caused by ________."
  answer="Clostridioides difficile"
  accept="C. difficile|Clostridium difficile"
  hint="Look at the second paragraph of the subsection that follows *Clostridium perfringens* Gastroenteritis."
>}}

{{< textin
  question="A serious illness caused by infection with certain serotypes of *Salmonella*, with an untreated mortality rate of 10%, is called ________."
  answer="typhoid fever"
  accept="typhoid"
  hint="Look at the opening sentence of the subsection that follows Salmonellosis."
>}}

{{< textin
  question="A serious gastrointestinal infection often associated with poor sanitation, especially after natural disasters, causing severe diarrhea and rapid dehydration, is called ________."
  answer="cholera"
  hint="Look at the opening paragraph of the subsection that follows the *E. coli* infections."
>}}

{{< textin
  question="This relatively mild illness caused by ETEC, common in less developed countries and nicknamed Montezuma's Revenge in Mexico, is more generally known as ________."
  answer="traveler's diarrhea"
  accept="traveller's diarrhoea|traveller's diarrhea|traveler's diarrhoea"
  hint="Look at the first sentence of the ETEC paragraph."
>}}

### Compare the major characteristics of specific bacterial diseases affecting the GI tract

{{< multiplechoice
  question="Which type of *E. coli* infection can be severe with life-threatening consequences such as hemolytic uremic syndrome?"
  answer="EHEC"
  hint="Compare the Signs and Symptoms cells of the four groups in the *E. coli* table."
>}}
ETEC
EPEC
EHEC
...
{{< multiplechoice
  question="Which species of *Shigella* has a type that produces Shiga toxin?"
  answer="*S. dysenteriae*"
  hint="Find the paragraph on Shiga toxin in the Shigellosis subsection."
>}}
*S. boydii*
*S. flexneri*
*S. dysenteriae*
...
{{< multiplechoice
  question="Which type of bacterium produces an A-B toxin?"
  answer="*Vibrio cholerae*"
  hint="Find the one sentence in this section that names an A-B toxin."
>}}
*Salmonella*
*Vibrio cholerae*
ETEC
...
{{< selfcheck question="Why does use of antibiotics and/or proton pump inhibitors contribute to the development of *Clostridioides difficile* infections?" hint="Reread the opening paragraph of the subsection on this organism." >}}
Long-term antibiotic use disrupts the normal gut microbiota, allowing *C. difficile* to overgrow and cause antibiotic-associated diarrhea. Separately, proton pump inhibitors reduce stomach acidity, and that reduced acidity also allows *C. difficile* to proliferate.
===CHECKS===
antibiotic use disrupts the normal microbiota and allows C. difficile to overgrow
proton pump inhibitors reduce stomach acidity and allow C. difficile to proliferate
{{< /selfcheck >}}

{{< selfcheck question="Why did scientists initially think it was unlikely that a bacterium caused peptic ulcers?" hint="This section never states the belief; reread the first sentence of Peptic Ulcers here, then the Micro Connection on the stomach's low pH in Section 9.3." >}}
This section does not state why scientists doubted a bacterial cause of peptic ulcers. It says only that *H. pylori* is able to tolerate the acidic environment of the human stomach. An earlier section, [The Effects of pH on Microbial Growth](/life-health-sciences/microbiology/09-microbial-growth/03-the-effects-of-ph-on-microbial-growth/), adds that until the 1980s, peptic ulcers were believed to be caused by spicy foods, stress, or a combination of both.
===CHECKS===
H. pylori is able to tolerate the acidic environment of the human stomach
until the 1980s, peptic ulcers were believed to be caused by spicy foods, stress, or a combination of both
{{< /selfcheck >}}

{{< selfcheck question="Does it make a difference in treatment to know if a particular illness is caused by a bacterium (an infection) or a toxin (an intoxication)?" hint="Compare the treatment paragraphs of the Staphylococcal Food Poisoning, Shigellosis, and *E. coli* subsections." >}}
Yes — treatment differs by mechanism. An intoxication such as staphylococcal food poisoning generally resolves without antibiotics, because the toxin itself, not a living infection, is causing the symptoms. Treating an infection caused by living bacteria that release toxins, such as EHEC, with antibiotics is not recommended and may even worsen disease, because killing the bacteria releases more toxin and can worsen HUS. By contrast, some true infections, such as severe *Shigella* infections, may require treatment directly with antibiotics.
===CHECKS===
intoxications such as staphylococcal food poisoning generally resolve without antibiotics because the toxin, not a living infection, causes the symptoms
antibiotic treatment of EHEC is not recommended because killing the bacteria can release more toxin and worsen HUS
severe Shigella infections may require treatment directly with antibiotics
{{< /selfcheck >}}

<small>This section is adapted from [Microbiology, Section 24.3: Bacterial Infections of the Gastrointestinal Tract](https://openstax.org/books/microbiology/pages/24-3-bacterial-infections-of-the-gastrointestinal-tract) by Nina Parker, Mark Schneegurt, Anh-Hue Thi Tu, Philip Lister, Brian M. Forster, and OpenStax, © OpenStax, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). Access the original for free at [openstax.org](https://openstax.org/details/books/microbiology). Changes: all six ordinary figures re-encoded as WebP and rendered as mediafigures with `kind` set explicitly after each image was inspected — `kind="diagram"` for DangerZone, Ulcers, and pseudocoli (each a drawn diagram) and `kind="photo"` for Shigella, Salmonella, and VibrioChol (each photographic or micrograph), overriding the media manifest's file-type guess for the three diagrams; DangerZone carries `eager="true"` as the page's first figure; the DangerZone, Ulcers, and pseudocoli alts are rewritten as plain descriptions from the images, each with its full label walk-through moved into an extended description; the Ulcers longdesc quotes the image's own top-left caption as "Healthy stomach epithelia are coated in a layer of mucus," correcting the source alt, which misquotes that printed caption as ending in "mucous" even though the image itself prints "mucus"; the Shigella, Salmonella, and VibrioChol alts are likewise rewritten from the images; the two Disease Profile table images (`OSC_Microbio_24_03_DisProTbl1`, `OSC_Microbio_24_03_DisProTbl2`) are combined into one Markdown table, transcribed from their source alts and checked against the printed PDF pages (no wording divergence found beyond the two one-word alt misspellings corrected and disclosed below), and are not vendored, per this book's Disease Profile rule; the real `<table summary>` "Some Pathogenic Strains of *E. coli*" is transcribed as a Markdown table at its source position and given a `sortbins` graded form (bins ETEC/EIEC/EPEC/EHEC, 7 items drawn only from the table's Virulence Factors/Genes and Signs and Symptoms cells, never its Treatment or Diagnostic Tests cells, each checked against every cell of the table, not only its own column, for uniqueness to its row; two candidate items were dropped for reading true of a second row when checked this way — "Locus of enterocyte effacement (LEE) pathogenicity island," which the table's own EHEC Diagnostic Tests cell also attests, and "Relatively mild, watery diarrhea," a verbatim substring of EIEC's own Signs and Symptoms cell — leaving the ETEC bin with its one remaining unique item rather than two), placed as the body Check Your Understanding item at that bullet's own position ("Compare and contrast the virulence factors and signs and symptoms of infections with the four main *E. coli* groups" is the `sortbins`'s stem), per this book's rule that a comparison table's sortbins lives in the self-check that asks its contrast; a one-word source misspelling in the Disease Profile alt's *E. coli* row, "hematolytic uremic syndrome" for "hemolytic uremic syndrome," is corrected in place with no inline note (the module's own body prose spells it correctly three times elsewhere); a one-word source misspelling in the same alt's Salmonellosis row, "Enteritides" for "Enteritidis," is likewise corrected in place with no inline note (the module's own body prose spells it correctly once, in the Salmonellosis section); the module's nine footnote citations are rendered as inline parenthetical citations after the sentences they support, with bare access URLs dropped and the two DOIs (Hung & Wong; Rohlke & Stollman) kept; the cross-reference to Virulence Factors of Bacterial and Viral Pathogens (m58868, cited twice) is rendered as a link to Section 15.3; the Clinical Focus Part 2 box's "Jump to the next/previous Clinical Focus box" links are replaced with a plain sentence naming that the case continues in Section 24.6 and began in Section 24.1; the Eye on Ethics "Typhoid Mary" box's closing four discussion questions are kept as plain prose inside the callout, unanswered, and no item is built from them, matching this book's precedent for a feature box's closing questions; a one-word source misspelling, "Vibrio cholera"/"V. cholera" for "Vibrio cholerae"/"V. cholerae" (the source drops the final "e" after its first, correctly spelled use of the full binomial), is corrected in place with no inline note in the six places it recurs on this page — the VibrioChol figure's panel (c) caption, two body sentences in the Vibrios subsection, the Check Your Understanding stem asking about rapid dehydration, the Disease Profile table's Cholera row, and Multiple Choice option B; the third Critical Thinking question's source stem, "Does it makes a difference in treatment…," is printed with its one-word grammatical correction, "Does it make a difference in treatment…"; the three source Multiple Choice items and the one Fill in the Blank item are adapted into Practice unchanged with their source options, order, and keys (C, C, B; the Fill in the Blank's two-word key "Clostridioides difficile" becomes a `textin` with `accept="C. difficile"`, the module's own abbreviation); of the section's three unkeyed Critical Thinking questions, all three remain self-checks with author-written model answers assembled from this module's own sentences, one with an added sentence from Section 9.3 — the peptic-ulcer-history question's model answer states plainly that this section never says why scientists doubted a bacterial cause, quotes this section's own "tolerate the acidic environment of the human stomach" sentence, and adds, with a link, Section 9.3's sentence that until the 1980s peptic ulcers were believed to be caused by spicy foods, stress, or both; all eight body Check Your Understanding bullets are rendered at their own note positions: two are graded as `multiplechoice` from a single fixing sentence of their own subsection (the *S. aureus* food-intoxication mechanism and the antibiotic-to-*C. difficile* mechanism), one (the *E. coli* groups comparison) is graded as the `sortbins` described above, and the remaining five stay self-checks whose model answers are assembled from more than one of this module's own sentences; three `textin` items built from `## Key terms` (typhoid fever, cholera, traveler's diarrhea) fill out the first objective's Practice group alongside the source Fill in the Blank; key terms are compiled from the module's 18 `<term>` elements (no repeats, 18 distinct bullets); 17 are taken from the book's Glossary appendix and one ("traveler's diarrhea") is sentence-derived, since the appendix nests its meaning only inside the Enterotoxigenic *E. coli* (ETEC) entry with no headword of its own; no source exercise, table, or Check Your Understanding bullet is omitted.</small>

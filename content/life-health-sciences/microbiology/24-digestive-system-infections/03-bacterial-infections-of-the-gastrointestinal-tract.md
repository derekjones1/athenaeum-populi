...
{{< selfcheck question="Compare and contrast Shigella infections and intoxications." hint="Shigella causes disease through invasion, not through a toxin made in food before ingestion — check the general infection/intoxication distinction defined earlier in this section against what this subsection says Shigella actually does." >}}
...
{{< selfcheck question="Why is serotyping particularly important in Salmonella infections and typhoid fever?" hint="Serotyping is described twice in this section — once for what it determines in ordinary salmonellosis, and once for which serotypes produce the more severe typhoid fever." >}}
Serotyping matters for two reasons this section gives. First, in ordinary salmonellosis, serotyping (with DNA fingerprinting) is part of diagnosis, and it is important for determining treatment. Second, serotyping is what distinguishes ordinary salmonellosis from typhoid fever in the first place: typhoid fever is caused specifically by the Typhi and Paratyphi A serotypes of *S. enterica*, which produce a more severe illness — with an untreated mortality rate of 10% — than the other serotypes that cause ordinary salmonellosis. Without serotyping, a clinician could not tell which of these two very different courses of disease and treatment a patient's infection calls for.
===CHECKS===
serotyping is part of diagnosis for salmonellosis and is important for determining treatment
typhoid fever is caused specifically by the Typhi and Paratyphi A serotypes of S. enterica
typhoid fever is a more severe illness, with an untreated mortality rate of 10%, than ordinary salmonellosis
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_24_03_Ulcers" kind="diagram" alt="A cross-section diagram of the stomach lining showing a wavy layer of mucus-covered epithelial cells above a blood vessel carrying red blood cells, neutrophils, and monocytes; at center, a green rod-shaped Helicobacter pylori cell with flagella sits in a gap in the mucus layer, with inset photos above showing a smooth pink healthy stomach lining and an ulcer as a pale crater in reddened tissue." longdesc="Left side: healthy stomach epithelium, its cells topped by a thick, even layer of mucus, with an arrow up to an inset photo of smooth, glistening pink tissue, labeled 'Healthy stomach epithelia are coated in a layer of mucous.' Center: a single Helicobacter pylori cell, drawn as a green rod with several thin flagella, sits directly on the epithelial cells where the mucus layer thins, labeled 'Helicobacter pylori colonizes epithelial cells and decreases the production of mucus.' Right side: the epithelium is eroded into an open crater labeled 'ulcer,' with an arrow up to an inset photo of a pale, crater-like sore in reddened tissue, labeled 'Gastric acids cause the formation of ulcers.' Below the epithelial layer, a blood vessel runs the width of the figure carrying red blood cells and labeled neutrophils and monocytes." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_24_03_pseudocoli" kind="diagram" alt="A cross-section diagram of the colon lining, similar to the peptic-ulcer figure, showing a mucus-covered epithelium above a blood vessel; at left a mixed community of small rod- and coccus-shaped bacteria sits in normal mucus, and at center a cluster of yellow rod-shaped Clostridioides difficile cells releases small dots labeled TcdA and TcdB, building into a raised, damaged pseudomembrane at right where neutrophils and monocytes migrate up from the blood vessel below; an inset photo above shows a dense mat of green rod-shaped cells." longdesc="Left side: the normal microbiota, drawn as a mix of small rod- and coccus-shaped bacteria of several colors, sits in the mucus above healthy epithelial cells, labeled 'normal microbiota.' Center: a cluster of yellow rod-shaped cells labeled Clostridioides difficile sits where the mucus has thinned, releasing small dots labeled TcdA and TcdB onto the epithelial cells beneath it; an arrow points up from this cluster to an inset photo of a dense mat of green rod-shaped cells. Right side: the epithelium has become a raised, swollen pseudomembrane, labeled 'pseudomembrane,' with several immune cells labeled neutrophils and monocytes shown migrating up into the tissue. Below the epithelial layer, a blood vessel runs the width of the figure carrying red blood cells and the same labeled neutrophils and monocytes." >}}
...
{{< multiplechoice
  ...
  hint="Antibiotic use changes the population of bacteria already living in the gut — think about what that change then allows to happen."
>}}
...
{{< selfcheck question="Compare and contrast foodborne illnesses due to B. cereus and Yersinia." hint="B. cereus's toxins act on food already contaminated before ingestion; Yersinia's disease can develop and spread well after infection — compare how each illness typically stays contained or spreads." >}}
*B. cereus* foodborne illness is generally mild, with signs and symptoms — nausea, pain, and abdominal cramps — appearing within a few hours of eating contaminated rice or other prepared foods, caused by two toxins (one producing diarrhea, one producing vomiting); antibiotics are not typically needed because it is due to toxin activity. *Yersinia* infection is also normally relatively mild and self-limiting, transmitted through the fecal-oral route rather than through a toxin already present in food, but it can behave differently: severe diarrhea and dysentery can develop in infants, and in adults the infection can spread beyond the gut to cause complications such as reactive arthritis, thyroid disorders, endocarditis, glomerulonephritis, eye inflammation, or erythema nodosum, with bacteremia in rare cases — complications *B. cereus* is not described as causing.
===CHECKS===
...
{{< textin
  ...
  hint="This is the more severe form of salmonellosis, caused by serotypes Typhi and Paratyphi A."
>}}
...
{{< textin
  ...
  answer="cholera"
  hint="The bacterium's genus name is *Vibrio*."
>}}
...
{{< textin
  ...
  hint="It is caused by the same E. coli group that produces a heat-stable enterotoxin similar to cholera toxin."
>}}
...
{{< multiplechoice
  ...
  answer="EHEC"
  hint="This is the most dangerous *E. coli* group, capable of causing epidemics."
>}}
ETEC
EPEC
EHEC
...
{{< multiplechoice
  ...
  hint="This is the same species whose Shiga toxin genes were later found in EHEC via horizontal gene transfer."
>}}
*S. boydii*
*S. flexneri*
*S. dysenteriae*
...
{{< multiplechoice
  ...
  hint="This toxin increases cAMP levels inside intestinal cells via adenylate cyclase."
>}}
*Salmonella*
*Vibrio cholerae*
ETEC

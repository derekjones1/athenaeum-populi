...
{{< multiplechoice
  ...
  hint="Food intoxication was defined at the top of this section — think about WHERE the toxin is produced, in the food or in the gut."
>}}
...
S. dysenteriae type 1 produces Shiga toxin after infecting the host, not beforehand in food
{{< /selfcheck >}}
...
{{< sortbins
  ...
  hint="Match each toxin or gene name to its group first, then match the symptom pattern — bloody vs. nonbloody, mild vs. potentially fatal."
>}}
{"bins": ["ETEC", "EIEC", "EPEC", "EHEC"],
 "items": [
  ...
  {"label": "Bloody diarrhea; may result in HUS", "bin": 3}]}
{{< /sortbins >}}
...
{{< selfcheck question="How does V. cholerae infection cause rapid dehydration?" hint="Trace the chain from where the toxin attaches, through what it does inside the intestinal cell, to what finally leaves the body." >}}
...
{{< selfcheck question="How does H. pylori cause peptic ulcers?" hint="Trace the chain from how the bacterium neutralizes stomach acid to what that does to the stomach lining's own protection." >}}
...
{{< textin
  ...
  accept="C. difficile"
  hint="This organism can survive for long periods as endospores and often overgrows in the gut after long-term antibiotic use."
>}}
...
{{< selfcheck question="Why does use of antibiotics and/or proton pump inhibitors contribute to the development of *Clostridioides difficile* infections?" hint="The module gives two separate mechanisms in two different paragraphs — one for antibiotics, one for proton pump inhibitors." >}}
...
{{< selfcheck question="Why did scientists initially think it was unlikely that a bacterium caused peptic ulcers?" hint="The module never states this belief directly — look for the one sentence about the stomach's own acidity that comes closest to an answer." >}}
This module does not state why scientists doubted a bacterial cause of peptic ulcers. The only clue it gives toward such doubt is that *H. pylori* is unusual in being able to tolerate the acidic environment of the human stomach — a condition scientists would not generally expect a bacterium to survive.
===CHECKS===
the module does not state why scientists doubted a bacterial cause of peptic ulcers
H. pylori is unusual in being able to tolerate the acidic environment of the human stomach
{{< /selfcheck >}}

{{< selfcheck question="Does it make a difference in treatment to know if a particular illness is caused by a bacterium (an infection) or a toxin (an intoxication)?" hint="Compare how an intoxication like staph food poisoning is treated with how an infection like EHEC or severe shigellosis is treated." >}}

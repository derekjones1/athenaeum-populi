...
description: >-
  Rotavirus, norovirus, and astrovirus gastroenteritis, and the five
  hepatitis viruses A through E — their transmission, symptoms, and
  treatment — adapted from OpenStax Microbiology, Section 24.4.
source_section: "24.4"
weight: 4
---
...
In the developing world, acute viral gastroenteritis is devastating and a leading cause of death for children (Caleb K. King, Roger Glass, Joseph S. Bresee, Christopher Duggan, "Managing Acute Gastroenteritis Among Children: Oral Rehydration, Maintenance, and Nutritional Therapy," *MMWR* 52 (2003) RR16: pp. 1–16). Worldwide, diarrhea is the second leading cause of mortality for children under age five, and 70% of childhood gastroenteritis is viral (Elizabeth Jane Elliott, "Acute Gastroenteritis in Children," *British Medical Journal* 334 (2007) 7583: 35–40, doi: 10.1136/bmj.39036.406169.80; S. Ramani and G. Kang, "Viruses Causing Diarrhoea in the Developing World," *Current Opinions in Infectious Diseases* 22 (2009) 5: pp. 477–482, doi: 10.1097/QCO.0b013e328330662f; Michael Vincent F Tablang, "Viral Gastroenteritis," *Medscape*). As discussed, there are a number of bacteria responsible for diarrhea, but viruses can also cause diarrhea. *E. coli* and rotavirus are the most common causative agents in the developing world. In this section, we will discuss rotaviruses and other, less common viruses that can also cause gastrointestinal illnesses.

## Gastroenteritis Caused by Rotaviruses

Rotaviruses are double-stranded RNA viruses in the family Reoviridae. They are responsible for common diarrheal illness, although prevention through vaccination is becoming more common. The virus is primarily spread by the fecal-oral route (shown below).

{{< mediafigure src="microbiology/OSC_Microbio_24_04_Rotavirus" kind="photo" eager="true" alt="An electron micrograph of dozens of round viral particles, densely packed together, each with a stippled, spoke-like texture on its surface." >}}
Rotaviruses in a fecal sample are visualized using electron microscopy. (credit: Dr. Graham Beards)
{{< /mediafigure >}}

These viruses are widespread in children, especially in day-care centers. The CDC estimates that 95% of children in the United States have had at least one rotavirus infection by the time they reach age five (Centers for Disease Control and Prevention, "Rotavirus," *The Pink Book*, updated September 8, 2015). Due to the memory of the body's immune system, adults who come into contact with rotavirus will not contract the infection or, if they do, are asymptomatic. The elderly, however, are vulnerable to rotavirus infection due to weakening of the immune system with age, so infections can spread through nursing homes and similar facilities. In these cases, the infection may be transmitted from a family member who may have subclinical or clinical disease. The virus can also be transmitted from contaminated surfaces, on which it can survive for some time.
...
{{< selfcheck question="Why are rotaviruses, noroviruses, and astroviruses more common in children?" hint="Look at what the text says happens to adults who have already been exposed to rotavirus, and at who each virus's own paragraph names as most affected." >}}
Young children have not yet built up the immune memory that protects most adults from these infections — the section notes that adults who come into contact with rotavirus typically do not become infected, or are asymptomatic if they do, because of this immune memory, while children have not yet acquired it. All three viruses are also noted as especially common in infants and young children, and rotavirus and norovirus are further noted as common in the elderly, whose immune systems have weakened with age.
===CHECKS===
adults who come into contact with rotavirus typically do not become infected, or are asymptomatic, because of immune memory
children have not yet acquired this immune memory
all three viruses are especially common in infants and young children
rotavirus and norovirus are further noted as common in the elderly, whose immune systems have weakened with age
{{< /selfcheck >}}

{{< callout type="info" >}}
**Disease Profile.** *Viral Infections of the Gastrointestinal Tract*
...
Hepatitis is a general term meaning inflammation of the liver, which can have a variety of causes. In some cases, the cause is viral infection. There are five main hepatitis viruses that are clinically significant: hepatitis viruses A (HAV), B (HBV), C (HCV), D (HDV) and E (HEV) (shown below). Note that other viruses, such as Epstein-Barr virus (EBV), yellow fever, and cytomegalovirus (CMV) can also cause hepatitis and are discussed in Viral Infections of the Circulatory and Lymphatic Systems.

{{< mediafigure src="microbiology/OSC_Microbio_24_04_Hepatitis" kind="diagram" alt="Five labeled virus diagrams. Hepatitis A: a plain polyhedron shell around a single wavy strand. Hepatitis B: a larger particle with two strands inside, wrapped in an outer envelope studded with bulb-shaped spikes. Hepatitis C: similar to B, with one strand inside and an outer envelope studded with rectangular spikes. Hepatitis D: a sphere with one wavy circular strand inside and an outer envelope studded with oval spikes. Hepatitis E: a more complex, many-faceted polyhedron shell around a single wavy strand, with no outer envelope." >}}
Five main types of viruses cause hepatitis. HAV is a non-enveloped ssRNA(+) virus and is a member of the picornavirus family (Baltimore Group IV). HBV is a dsDNA enveloped virus, replicates using reverse transcriptase, and is a member of the hepadnavirus family (Baltimore Group VII). HCV is an enveloped ssRNA(+) virus and is a member of the flavivirus family (Baltimore Group IV). HDV is an enveloped ssRNA(–) that is circular (Baltimore Group V). This virus can only propagate in the presence of HBV. HEV is a non-enveloped ssRNA(+) virus and a member of the hepeviridae family (Baltimore Group IV).
{{< /mediafigure >}}
...
Learn more information about [hepatitis virus infections](https://www.cdc.gov/hepatitis/resources/professionals/pdfs/abctable.pdf).
{{< /callout >}}

**Check Your Understanding**

{{< multiplechoice
  question="Why do the five different hepatitis viruses all cause similar signs and symptoms?"
  answer="They all have an affinity for hepatocytes (liver cells)."
  hint="Reread the sentence, right after this section starts describing how HAV, HBV, and the others differ, that names the one thing every form of hepatitis targets in the body."
>}}
They are all transmitted by the fecal-oral route.
They all require infection with another hepatitis virus first.
They all have an affinity for hepatocytes (liver cells).
They all become chronic infections.
{{< /multiplechoice >}}

{{< callout type="info" >}}
**Micro Connection.** *Preventing HBV Transmission in Health-Care Settings*
...
{{< multiplechoice
  question="Which cause of viral gastroenteritis commonly causes projectile vomiting?"
  answer="Noroviruses"
  hint="This virus is notorious for rapid outbreaks in close quarters, such as on cruise ships, a detail from the paragraph before its symptoms are listed."
>}}
hepatitis virus
Astroviruses
Rotavirus
...
{{< textin
  question="Astroviruses are single-stranded RNA viruses in the family ________."
  answer="Astroviridae"
  hint="The family name appears in a parenthetical right after this virus is first named."
>}}
...
{{< textin
  question="Jaundice results from a buildup of ________."
  answer="bilirubin"
  hint="The liver normally breaks this pigment down, and cannot do so effectively when it is diseased or injured."
>}}

{{< multiplechoice
  question="Which forms of viral hepatitis are transmitted through the fecal-oral route?"
  answer="HAV and HEV"
  hint="The module names exactly two forms as spread through ingestion, while naming the rest as spread through body-fluid contact."
>}}
HBV and HCV
HAV and HEV
HBV, HCV, and HDV
...
{{< multiplechoice
  question="Which hepatitis virus has the longest mean incubation period, at about 120 days?"
  answer="HBV"
  hint="Compare each form's own stated mean incubation period, in days, paragraph by paragraph."
>}}
HAV
HCV
HBV
...
using post-exposure treatment, including hepatitis B immunoglobulin (HBIG) and vaccination, after a possible exposure
disinfecting surfaces, for example with a 10% bleach solution
{{< /selfcheck >}}

<small>This section is adapted from [Microbiology, Section 24.4: Viral Infections of the Gastrointestinal Tract](https://openstax.org/books/microbiology/pages/24-4-viral-infections-of-the-gastrointestinal-tract) by Nina Parker, Mark Schneegurt, Anh-Hue Thi Tu, Philip Lister, Brian M. Forster, and OpenStax, © OpenStax, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). Access the original for free at [openstax.org](https://openstax.org/details/books/microbiology). Changes: all three photographic/diagrammatic figures (Rotavirus, Hepatitis, HepJaundic) re-encoded as WebP and rendered as mediafigures, `kind` set after image inspection (Rotavirus is a micrograph, `kind="photo"`, and carries `eager="true"` as the page's first figure; Hepatitis and HepJaundic each carry a drawn/diagrammed panel, `kind="diagram"`); the Rotavirus, Hepatitis, and HepJaundic alts are rewritten from the images rather than reused from the source's own alt text; the two Disease Profile summary tables (`OSC_Microbio_24_04_GastroTBL`, "Viral Infections of the Gastrointestinal Tract," and `OSC_Microbio_24_04_HepTBL`, "Viral Hepatitis") are transcribed as Markdown tables from their source alts, checked cell by cell against the printed table images, rather than vendored, per this book's Disease Profile rule (`GastroTBL` matches the printed image exactly; `HepTBL`'s Hepatitis A cell silently drops a stray comma before "chronic" — "sometimes longer but not, chronic" in the source — as a punctuation-level correction, disclosed here rather than reproduced); the Link to Learning box keeps its source URL; the module's six footnote citations are rendered as inline parenthetical citations after the sentences they support, bare access URLs dropped and DOIs kept, with one footnote citing three sources (Elliott; Ramani and Kang; Tablang) rendered as one semicolon-joined citation; the cross-reference to *Viral Infections of the Circulatory and Lymphatic Systems* (m58937, chapter 25) is rendered as plain text, unlinked, because that section has not been authored yet; a systemic one-word (missing-space) source defect — "hepatitisvirus"/"hepatitisviruses" printed with no space between "hepatitis" and "virus(es)" — recurs in the module's own defined-term line, in both source Multiple Choice items (one item's stem twice and one item's option), and in the `OSC_Microbio_24_04_HepTBL` table image's Pathogen column alone (`GastroTBL`'s Pathogen column reads "Astroviruses"/"Noroviruses"/"Rotaviruses" correctly spaced and carries no such defect), and is corrected to "hepatitis virus(es)" everywhere on the page with no inline note (reported below); the body sentence naming the five hepatitis viruses silently drops a stray comma the source prints before "(HDV)" — "D, (HDV) and E (HEV)" — as the same kind of punctuation-level correction, disclosed here rather than reproduced; the two source Multiple Choice items and the one Fill in the Blank item keep their source keys and source option order; of the section's one unkeyed Short Answer question, it is graded as a `multiplechoice` from the module's own HAV/HEV-ingestion sentence, since the source prints no key for it; of the section's one unkeyed Critical Thinking question, it remains a self-check with an author-written model answer assembled from the Micro Connection box's own sentences, since no single sentence fixes a list of health-care precautions and the source prints no key for it; of the section's two body Check Your Understanding bullets, the hepatitis-symptom-similarity bullet is graded as a `multiplechoice` from the module's own hepatocyte-affinity sentence, and the rotavirus/norovirus/astrovirus-in-children bullet remains a self-check whose model answer draws on more than one of this module's own sentences; two Practice items (the Astroviridae and Reoviridae family-name recalls) are author-built `textin` items from this module's own defining sentences rather than the source's keyed sets, to fill the first objective's group without reusing a virus name that already appears as an option of the source-keyed Multiple Choice item in the same group; a third Practice item (the longest-mean-incubation-period `multiplechoice`, key HBV) is likewise author-built, comparing the module's own separately stated mean incubation periods for HAV (30 days), HBV (120 days), and HCV (45 days) — no source exercise asks this — to fill the second objective's group to the book's floor; the single Key terms bullet (jaundice) is not also built into a term-recall `textin`, because the module's own Fill in the Blank stem ("Jaundice results from a buildup of ________.") already prints the word "jaundice" on the page, which would hand a jaundice-keyed recall item its answer; no source exercise, table, or Check Your Understanding bullet is omitted.</small>

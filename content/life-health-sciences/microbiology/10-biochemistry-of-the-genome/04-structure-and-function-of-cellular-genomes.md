...
description: >-
  How a cell's genotype and phenotype differ, how eukaryotic and prokaryotic
  chromosomes are organized, supercoiled, and packaged, and why noncoding
  DNA, extrachromosomal plasmids, and highly variable viral genomes are all
  part of a cell's genome — adapted from OpenStax Microbiology,
  Section 10.4.
source_section: "10.4"
weight: 4
---
...
{{< mediafigure src="microbiology/OSC_Microbio_10_04_GenoPheno" alt="A photo of two agar plates side by side, both labeled S. marcescens. The plate on the left, grown at room temperature, shows pink-red streaked bacterial growth; the plate on the right, grown at 37 °C, shows pale beige growth." kind="photo" eager="true" >}}
...
View this [animation](https://www.openstax.org/l/22dnapackanim) from the DNA Learning Center to learn more about DNA packaging in eukaryotes.
{{< /callout >}}
...
phenotype is the set of genes being expressed at any given point in time
...
DNA supercoiling, the process by which DNA is twisted to fit inside the cell
topoisomerases involved in supercoiling and preventing overwinding
histones perform various levels of DNA wrapping and attachment to scaffolding proteins, forming chromatin
...
Serving as the location where DNA replication initiates
Providing a few nonessential genes that may be helpful under specific conditions
{{< /multiplechoice >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_10_04_Bacilli" alt="A diagram of two oval bacterial cells labeled Bacillus cereus and Bacillus anthracis. Both cells contain a labeled chromosome drawn as a tangled loop. The Bacillus anthracis cell additionally contains two small labeled circles: one labeled pX01 encoding toxin and the other labeled pX02 encoding toxin." kind="diagram" >}}
...
The case began in [Using Microbiology to Discover the Secrets of Life](/life-health-sciences/microbiology/10-biochemistry-of-the-genome/01-using-microbiology-to-discover-the-secrets-of-life/).
{{< /callout >}}

## Viral Genomes

Viral genomes exhibit significant diversity in structure. Some viruses have genomes that consist of DNA as their genetic material. This DNA may be single stranded, as exemplified by human parvoviruses, or double stranded, as seen in the herpesviruses and poxviruses. Additionally, although all cellular life uses DNA as its genetic material, some viral genomes are made of either single-stranded or double-stranded RNA molecules, as we have discussed. Viral genomes are typically smaller than most bacterial genomes, encoding only a few genes, because they rely on their hosts to carry out many of the functions required for their replication. The diversity of viral genome structures and their implications for viral replication life cycles are discussed in more detail in [The Viral Life Cycle](/life-health-sciences/microbiology/06-acellular-pathogens/02-the-viral-life-cycle/).
...
other viral genomes are made of either single-stranded or double-stranded RNA molecules
typically smaller than most bacterial genomes, encoding only a few genes
rely on their hosts to carry out many of the functions required for their replication
{{< /selfcheck >}}

{{< callout type="info" >}}
**Micro Connection.** *Genome Size Matters*
...
Visit the [genome database](https://www.openstax.org/l/22NCBIgendata) of the National Center for Biotechnology Information (NCBI) to see the genomes that have been sequenced and their sizes.
{{< /callout >}}
...
some regions are more accessible to enzymes and thus more readily used as templates for gene expression
genes being actively copied into RNA would be expected to be less compact
regions containing inactive genes would be expected to be more compact
{{< /selfcheck >}}
...
{"bins": ["Eukaryotic cells", "Prokaryotic cells"],
 "items": [
  ...
  {"label": "Chromosomes are usually circular", "bin": 1},
  {"label": "Multiple distinct chromosomes are typically present", "bin": 0},
  {"label": "A cell typically contains only a single chromosome", "bin": 1},
  {"label": "Two copies of each chromosome are present", "bin": 0},
  {"label": "Only one copy of each gene is present", "bin": 1},
  {"label": "The chromosome is housed in the membrane-bound nucleus", "bin": 0},
  {"label": "The chromosome is found in an area of the cytoplasm called the nucleoid", "bin": 1}]}
{{< /sortbins >}}

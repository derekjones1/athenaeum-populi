...
description: >-
  The chemical structure of DNA nucleotides, the discovery and structure of
  the double helix, and how antiparallel, complementary base pairing gives
  DNA its role in heredity — adapted from OpenStax Microbiology, Section
  10.2.
source_section: "10.2"
weight: 2
---
...
{{< mediafigure src="microbiology/OSC_Microbio_10_02_Nucleotide" alt="(a) A deoxyribonucleotide drawn as three linked parts: a phosphate group bonded to one carbon of a pentagon-shaped deoxyribose sugar, and a two-ringed nitrogenous base (adenine) bonded to another carbon of the sugar. (b) The deoxyribose sugar alone, its ring oxygen at the top and its five carbons numbered clockwise: 1′ (bonded to the base position, with an OH shown), 2′ (H), 3′ (OH), 4′ (bonded to 5′), and 5′ (CH₂OH)." kind="diagram" eager="true" >}}
(a) Each deoxyribonucleotide is made up of a sugar called deoxyribose, a phosphate group, and a nitrogenous base—in this case, adenine. (b) The five carbons within deoxyribose are designated as 1′, 2′, 3′, 4′, and 5′.
{{< /mediafigure >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_10_02_Bases" alt="Four ring structures grouped as pyrimidines and purines. The pyrimidines, cytosine and thymine, each have a single six-membered ring; cytosine's ring carries an NH₂ group and thymine's carries a CH₃ group, each also with =O and NH groups on the ring. The purines, adenine and guanine, each have a six-membered ring fused to a five-membered ring; adenine's rings carry an NH₂ group and guanine's carry =O and NH₂ groups." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_10_02_X-rayDiff" alt="A purple-tinted photograph of an X-ray diffraction pattern: a fuzzy, roughly circular arrangement of dark spots forming an X-shaped or figure-eight pattern around a brighter center, characteristic of a helical molecule." kind="photo" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_10_02_DNAHelix" alt="A photograph of a wire-frame ball-and-stick model of the DNA double helix on display in a museum case, with blurred visitors walking past in the background." kind="photo" >}}
...
View an [animation on DNA structure](https://www.openstax.org/l/22dnastruanim) from the DNA Learning Center to learn more.
{{< /callout >}}
...
Adenine and thymine form three hydrogen bonds; cytosine and guanine form two hydrogen bonds.
...
{{< callout type="info" >}}
**Eye on Ethics.** *Paving the Way for Women in Science and Health Professions*
...
{{< mediafigure src="microbiology/OSC_Microbio_10_02_SciGirls" alt="(a) A black-and-white photograph of a woman in a lab coat working with laboratory glassware beside a microscope. (b) A color photograph of two women in white lab coats and safety glasses examining an image on a computer monitor in a laboratory." kind="photo" >}}
...
The case continues in [Structure and Function of Cellular Genomes](/life-health-sciences/microbiology/10-biochemistry-of-the-genome/04-structure-and-function-of-cellular-genomes/). The case began in [Using Microbiology to Discover the Secrets of Life](/life-health-sciences/microbiology/10-biochemistry-of-the-genome/01-using-microbiology-to-discover-the-secrets-of-life/).
{{< /callout >}}
...
They link nucleotides together, forming the sugar-phosphate backbone that is the framework of the nucleic acid strand.
They determine which nitrogenous base attaches to each sugar.
{{< /multiplechoice >}}
...
{{< multiplechoice
  question="The A-T base pair has more hydrogen bonding than the C-G base pair."
  answer="False"
  hint="Compare the hydrogen-bond counts given for each base pair."
>}}
True
False
{{< /multiplechoice >}}

{{< mediafigure src="microbiology/OSC_Microbio_10_02_ArtConnect1_img" alt="A four-column table with headers adenine, guanine, thymine, and cytosine. The thymine column is filled in as 22%; the adenine, guanine, and cytosine columns each show only a blank followed by a percent sign." kind="diagram" >}}
This table lists the four nitrogenous bases in DNA, with only thymine's percentage filled in.
{{< /mediafigure >}}
...
adenine 22%, guanine 22%, cytosine 34%
adenine 39%, guanine 20%, cytosine 19%
{{< /multiplechoice >}}
...
Because guanine and cytosine are both purines, giving their pairing extra ring-stacking stability.
Because of the additional hydrogen bonding between the C-G base pair, compared with the A-T base pair.
{{< /multiplechoice >}}
...
Each strand has a free phosphate group at both of its ends.
...
purines (adenine and guanine) have a double-ring structure with a six-carbon ring fused to a five-carbon ring
pyrimidines (cytosine and thymine) have only a single six-carbon ring
the section gives no further detail about how such alternative pairings would affect the geometry of the helix
{{< /selfcheck >}}

...
{{< selfcheck question="What organism did Morgan and his colleagues use to develop the Chromosomal Theory of Inheritance? What traits did they track?" hint="Name the fruit fly species Morgan's laboratory bred, and recall what kind of observations his group correlated with it." >}}
...
{{< multiplechoice
  ...
  answer="the nucleus"
  hint="Recall the module's own concluding sentence about where Hämmerling's grafting evidence located the cell's hereditary information."
>}}
the foot
the nucleus
the stalk
...
{{< selfcheck question="How did Avery, MacLeod, and McCarty's experiments show that DNA was the transforming principle first described by Griffith?" hint="Walk through the systematic elimination study: which single treatment abolished transformation, and what did that treatment specifically destroy?" >}}
...
{{< selfcheck question="How did Hershey and Chase use microbes to prove that DNA is genetic material?" hint="Combine the labeling scheme (which isotope marks DNA, which marks protein) with the blender-and-centrifuge result of where each label ended up." >}}
...
{{< textin
  ...
  answer="phosphorus"
  hint="Recall the element Miescher's original chemicals were rich in, isolated from leukocyte nuclei, that sets nucleic acids apart from proteins and carbohydrates."
>}}

{{< textin
  question="Miescher's student Richard Altmann discovered the acidic nature of the compound nuclein and renamed it the ________."
  answer="nucleic acid"
  hint="This is the modern name for the phosphorus-rich compound Miescher first isolated and named nuclein."
>}}
...
{{< multiplechoice
  ...
  hint="This German biochemist received the 1910 Nobel Prize in Physiology or Medicine for this work and for his research on proteins."
>}}
Friedrich Miescher
Richard Altmann
Albrecht Kossel
...
{{< multiplechoice
  ...
  hint="Recall what Morgan's 'Fly Room' group actually did with Drosophila chromosomes and traits, as opposed to what Mendel, Griffith, or Beadle and Tatum did."
>}}
...
{{< textin
  ...
  answer="protein"
  hint="This macromolecule's twenty different amino acids were thought to give it enough complexity for genetic information, unlike the four nucleotides of DNA."
>}}

{{< selfcheck question="Why was nucleic acid disregarded for so long as the molecule responsible for the transmission of hereditary information?" hint="Compare the number of building blocks in each candidate molecule, and ask which one 19th- and early 20th-century scientists thought could combine in enough different ways to store complex genetic information." >}}
...
{{< multiplechoice
  ...
  hint="Recall the structural feature of Acetabularia cells — mentioned right before the grafting experiments are described — that let Hämmerling perform surgery on them by eye."
>}}
...
{{< selfcheck question="Why do bacteria and viruses make good model systems for various genetic studies?" hint="This section names two practical advantages of microbes and viruses over Mendel's peas, Morgan's flies, and McClintock's corn — growth and structure, not reproduction mode." >}}
...
{{< selfcheck question="In the figure shown, if the nuclei were contained within the stalks of *Acetabularia* rather than the feet, what types of caps would you expect from the pictured grafts?" hint="Hämmerling's actual results showed that the foot's species determines the cap; here, imagine that rule applying to the stalk instead, and read each graft's stalk species off the figure." >}}
...
{{< multiplechoice
  ...
  hint="Recall which strain Griffith injected live in this combination, and whether any DNA needed to pass between strains for that strain alone to be lethal."
>}}
...
{{< multiplechoice
  ...
  hint="If protein carried the genetic material, the labeled protein would have to travel with the phage DNA into the bacterial cell — recall which fraction, pellet or supernatant, holds the infected bacteria after centrifugation."
>}}
...
{{< multiplechoice
  question="According to Beadle and Tatum's \"one gene–one enzyme\" hypothesis, which of the following enzymes will eliminate the transformation of hereditary material from pathogenic bacteria to nonpathogenic bacteria?"
  answer="deoxyribonucleases"
  hint="Recall which single enzyme class, in Avery, MacLeod, and McCarty's systematic elimination study, was the only one whose degradation activity abolished transformation."
>}}
...
{{< selfcheck question="Bacteriophages inject their genetic material into host cells, whereas animal viruses enter host cells completely. Why was it important to use a bacteriophage in the Hershey–Chase experiment rather than an animal virus?" hint="Recall which part of the T2 bacteriophage actually crosses into the bacterial cell during infection, and which part stays outside where the blender can remove it." >}}
...
{{< selfcheck question="Why are Hershey and Chase credited with identifying DNA as the carrier of heredity even though DNA had been discovered many years before?" hint="Separate what Miescher, Altmann, and Kossel established about DNA's chemistry from what Hershey and Chase specifically proved about its function." >}}
...
===CHECKS===
DNA had been chemically discovered and characterized as early as the 1860s and 1870s

...
description: >-
  How microbiologists — from Miescher's isolation of "nuclein" to Griffith's,
  Avery's, and Hershey and Chase's experiments — helped establish that DNA,
  not protein, is the hereditary material — adapted from OpenStax
  Microbiology, Section 10.1.
source_section: "10.1"
weight: 1
---
...
The case continues in [Structure and Function of DNA](/life-health-sciences/microbiology/10-biochemistry-of-the-genome/02-structure-and-function-of-dna/).
{{< /callout >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_10_01_Mendel" alt="Diagram of three generations of Mendel's pea cross: the P generation shows one plant with violet flowers and one with white flowers; an arrow labeled hybridization of true-breeding plants leads to the F₁ generation, a single plant labeled all hybrid progeny have violet flowers; a second arrow labeled self-fertilization of hybrid plants leads to the F₂ generation, shown as two plants labeled 705 violet flowers and 224 white flowers." longdesc="The diagram reads left to right in three labeled generations. The P generation shows two pea plants side by side, one bearing violet flowers and one bearing white flowers. An arrow labeled 'hybridization of true-breeding plants' points to the F₁ generation, a single plant labeled 'all hybrid progeny have violet flowers.' A second arrow labeled 'self-fertilization of hybrid plants' points to the F₂ generation, shown as two plants labeled '705 violet flowers' and '224 white flowers.'" kind="diagram" eager="true" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_10_01_footandcap" alt="Two-panel figure. Panel (a) is a photograph of several Acetabularia cells in shallow water, each with a thin whitish stalk topped by a round, disc-shaped cap; the stalks' bases disappear into a dark, rocky, algae-covered bottom where no separate foot is visible. Panel (b) is a diagram of one Acetabularia cell labeled cap, stalk, nucleus, and foot; when the cap is removed a new cap regenerates, but when the foot is removed no new foot regenerates." longdesc="Panel (a) is a photograph of a cluster of Acetabularia cells growing from a rocky, algae-covered surface underwater; each cell has a thin upright stalk and a pale, disc-shaped cap. Panel (b) shows two rows of diagrams. In the top row, a labeled cell (cap, stalk, nucleus, foot) has its cap removed, leaving a bare stalk with a red cut mark at the top; an arrow labeled 'new cap regenerated' shows the same stalk regrowing a full cap. In the bottom row, the same labeled cell has its foot removed, leaving a red cut mark at the base of the stalk; an arrow labeled 'no new foot regenerated' shows the stalk with its cap intact but no foot regrowing below." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_10_01_X-rayMold" alt="Diagram of the Beadle and Tatum experiment. A red arrow labeled X-rays strikes a cluster of mutagenized spores; the mutagenized and wild-type spores are crossed, then grown on complete medium (with amino acids) and minimal medium (without amino acids), looking for a mutant that grows on complete but not minimal medium; spores that fail to grow on minimal medium are then tested on minimal medium with a single amino acid added — separate tubes for alanine, threonine, tyrosine, methionine, proline, arginine (circled), lysine, tryptophan, valine, and isoleucine." longdesc="The diagram reads left to right. A red arrow labeled X-rays points down onto a cluster of mutagenized spores (blue ovals); a cluster of wild-type spores (orange ovals) sits below them. Gray arrows show the mutagenized and wild-type spores being crossed, producing purple spores drawn as chains of ovals. From the cross, gray arrows lead to three rows of paired test tubes labeled 'complete media' and 'minimal media'; the top and bottom rows show growth (orange contents) in both tubes, and the middle row shows growth only in the complete-medium tube. A caption notes that mutants growing on complete but not minimal medium are sought. A final arrow leads to a row of ten tubes, each labeled with a single amino acid added to minimal medium — alanine, threonine, tyrosine, methionine, proline, arginine, lysine, tryptophan, valine, isoleucine, in that order — with the arginine tube circled in red to mark the one tube that supports growth for the mutant under study." kind="diagram" >}}
...
{{< selfcheck question="What organism did Morgan and his colleagues use to develop the Chromosomal Theory of Inheritance? What traits did they track?" hint="Reread the third paragraph of The Chromosomal Theory of Inheritance." >}}
...
meticulous microscopic observations of fly chromosomes
correlated these observations with the resulting fly characteristics
{{< /selfcheck >}}

{{< multiplechoice
  question="What did Hämmerling prove with his experiments on *Acetabularia*?"
  answer="that the genetic information in a eukaryotic cell is housed within the nucleus"
  hint="Reread the first sentence of the Hämmerling paragraph in Microbes and Viruses in Genetic Research."
>}}
that each gene encodes one enzyme
that the genetic information in a eukaryotic cell is housed within the nucleus
that DNA was the transforming principle
that hereditary information could be transferred from one cell to another horizontally
{{< /multiplechoice >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_10_01_DNATrans" alt="Diagram titled Determining the Identity of the Hereditary Material. A single tube of heat-killed S strain extract, with green dots for proteins, blue dots for DNA, and red dots for RNA, splits into four tubes treated with no enzyme, proteases, ribonucleases, or deoxyribonucleases; R cells are then added to each, and only the deoxyribonuclease tube fails to yield S cells." longdesc="A single starting tube, labeled 'heat is used to kill S strain of S. pneumoniae and capsule components are removed from solution,' contains green dots (proteins), blue dots (DNA), and red dots (RNA); a key at left defines these three colors. Four arrows lead from this tube to four treated tubes, each showing the dots that remain. Each branch then has an arrow down to a second tube of the same colored dots plus a few gray dots the key does not define, and an arrow labeled Add R cells. Branches 1 to 3 end in a drawn encapsulated pair of cells (S cells); branch 4 ends with no cell drawn. Branch 1, the control, uses no enzyme, so all three molecule types remain, and adding R cells yields S cells, so transformation occurred. Branch 2 uses proteases, which degrade proteins, leaving RNA and DNA; R cells are added and S cells appear, so transformation occurred without protein. Branch 3 uses ribonucleases, which degrade RNA, leaving proteins and DNA; R cells are added and S cells appear, so transformation occurred without RNA. Branch 4 uses deoxyribonucleases, which degrade DNA, leaving proteins and RNA; R cells are added and no S cells appear, so transformation does not occur without DNA." kind="diagram" >}}
...
{{< selfcheck question="How did Avery, MacLeod, and McCarty's experiments show that DNA was the transforming principle first described by Griffith?" hint="Reread the paragraph after the Griffith figure and the figure that follows it." >}}
...
===CHECKS===
treated separate samples with enzymes that specifically degraded proteins, RNA, or DNA
when DNA was degraded, the resulting mixture was no longer able to transform the R strain bacteria
degrading proteins or RNA did not prevent transformation
DNA ... was the transforming principle Griffith had described
{{< /selfcheck >}}

### Hershey and Chase's Proof of DNA as Genetic Material

Alfred Hershey and Martha Chase performed their own experiments in 1952 and were able to provide confirmatory evidence that DNA, not protein, was the genetic material (A.D. Hershey, M. Chase, "Independent Functions of Viral Protein and Nucleic Acid in Growth of Bacteriophage," *Journal of General Physiology* 36 no. 1 (1952):39–56). Hershey and Chase were studying a bacteriophage, a virus that infects bacteria. Viruses typically have a simple structure: a protein coat, called the capsid, and a nucleic acid core that contains the genetic material, either DNA or RNA (see [Viruses](/life-health-sciences/microbiology/06-acellular-pathogens/01-viruses/)). The particular bacteriophage they were studying was the T2 bacteriophage, which infects *E. coli* cells. As we now know today, T2 attaches to the surface of the bacterial cell and then it injects its nucleic acids inside the cell. The phage DNA makes multiple copies of itself using the host machinery, and eventually the host cell bursts, releasing a large number of bacteriophages.
...
{{< mediafigure src="microbiology/OSC_Microbio_10_01_HersheyChase" alt="Diagram of the Hershey–Chase experiment in four numbered steps. Step 1: one batch of phage is labeled with ³²P, incorporated into the DNA; another batch is labeled with ³⁵S, incorporated into the protein coat. Step 2: bacteria are infected with each labeled phage. Step 3: each culture is blended and centrifuged, separating the lighter phage particles from the heavier bacterial cells. Step 4: bacteria infected with ³²P-labeled phage produce ³²P-labeled phage; bacteria infected with ³⁵S-labeled phage produce unlabeled phage." longdesc="Two rows of drawings above four numbered text boxes, each row reading left to right with gray arrows. Top row: a phage labeled ³²P-labeled DNA, with blue DNA coiled in its head and gray tail fibers; then the same phage sitting on a bacterial cell, its tail fibers on the cell surface and a blue thread, the labeled DNA, running from the tail into the cell; then a tube of liquid with a phage near the top and a pellet at the bottom. Curved arrows enlarge each: the phage from the upper liquid has a gray head with no blue, and the pellet is drawn as a bacterial cell holding three new phage with blue heads. Bottom row: a phage labeled ³⁵S-labeled protein coat, its head and tail fibers outlined in red and black DNA in its head; on the cell, a black DNA thread enters while the red coat stays outside; in the tube, the phage from the upper liquid keeps its red coat, and the pellet's cell holds three new phage with gray, unlabeled heads. No centrifuge or bursting cell is drawn. The four numbered boxes below state: (1) one batch of phage was labeled with ³²P, incorporated into the DNA, and another batch with ³⁵S, incorporated into the protein coat; (2) bacteria were infected with the phage, to identify whether viral DNA or viral protein entered the host cell; (3) the cultures were blended and centrifuged to separate the lighter phage particles from the heavier bacterial cells; (4) bacteria infected with phage containing ³²P-labeled DNA produced ³²P-labeled phage, while bacteria infected with ³⁵S-labeled phage produced unlabeled phage." kind="diagram" >}}
...
To learn more about the experiments involved in the history of genetics and the discovery of DNA as the genetic material of cells, visit this [website](https://www.openstax.org/l/22dnalearncen) from the DNA Learning Center.
{{< /callout >}}

**Check Your Understanding**

{{< selfcheck question="How did Hershey and Chase use microbes to prove that DNA is genetic material?" hint="Reread the second and third paragraphs of Hershey and Chase's Proof of DNA as Genetic Material." >}}
...
===CHECKS===
labeling one batch's DNA with radioactive phosphorus (³²P) and another batch's protein coat with radioactive sulfur (³⁵S)
used a blender to detach the phage coats from the host cells and a centrifuge to separate the heavier bacterial cells from the lighter phage particles
the radioactivity from the protein label remained only in the supernatant
the radioactivity from the DNA label was detected only in the bacterial cells
it was the phage DNA ... that entered the cell and carried the information to produce more phage particles
{{< /selfcheck >}}

{{< mediafigure src="microbiology/OSC_Microbio_10_01_Timeline" alt="A timeline from 1865 to the 1990s tracking the discovery of DNA as the hereditary molecule, with photographs of several named scientists beside fifteen dated milestones from Mendel's pea-plant crosses through Hershey and Chase's proof and Watson and Crick's double helix to the start of genome sequencing projects." longdesc="A horizontal line carries fifteen dated points, with labels placed above or below the line (mostly alternating, but 1930s and 1931 both sit above and 1953 and 1961 both below), each with a short description and some with a black-and-white photograph of the scientist(s) named: 1865, Mendel, documents patterns of heredity in pea plants (photo); 1869, Miescher, first identifies DNA ('nuclein') (photo); 1902, Sutton and Boveri, propose chromosome theory of heredity (photos); 1915, Morgan and his 'Fly Room' colleagues confirm the chromosome theory of heredity; 1927, Muller shows that X-rays induce mutation; 1928, Griffith's 'transformation experiments' transform nonpathogenic bacterial strains to pathogenic; 1930s, Hämmerling shows that hereditary information is contained in the nuclei of eukaryotic cells; 1931, McClintock demonstrates genetic recombination in corn (photo); 1941, Beadle and Tatum describe the 'one gene–one enzyme' hypothesis; 1944, Avery, McLeod, and McCarty show that DNA is the 'transforming principle' responsible for heredity; 1950, Chargaff discovers that A=T and C=G (Chargaff's rules); 1952, Hershey and Chase use radioactive labeling to prove that DNA is responsible for heredity (photos); 1953, Watson and Crick propose the double helix structure of DNA; 1961, Jacob and Monod propose the existence of mRNA; 1990s, genome sequencing projects begin." kind="diagram" >}}
...
{{< textin
  question="The five different nucleotide bases composing nucleic acid are adenine, guanine, cytosine, thymine (in DNA), and ________ (in RNA)."
  answer="uracil"
  hint="Reread the paragraph under Discovery and Characterization of DNA."
>}}

{{< multiplechoice
  question="Which scientist isolated and characterized the five different nucleotide bases composing nucleic acid?"
  answer="Albrecht Kossel"
  hint="Reread the last three sentences of the paragraph under Discovery and Characterization of DNA."
>}}
Friedrich Miescher
Richard Altmann
Albrecht Kossel
...
{{< textin
  question="The element ________ is unique to nucleic acids compared with other macromolecules."
  answer="phosphorus"
  hint="Reread the second paragraph of Hershey and Chase's Proof of DNA as Genetic Material."
>}}

### Explain the historical experiments that led to the characterization of DNA

{{< multiplechoice
  question="Which method did Morgan and colleagues use to show that hereditary information was carried on chromosomes?"
  answer="correlations between microscopic observations of chromosomal movement and the characteristics of offspring"
  hint="Reread the Morgan paragraph in The Chromosomal Theory of Inheritance."
>}}
...
{{< textin
  question="In the late 1800s and early 1900s, the macromolecule thought to be responsible for heredity was ______________."
  answer="protein"
  hint="Reread the opening paragraph of DNA as the Molecule Responsible for Heredity."
>}}

{{< selfcheck question="Why was nucleic acid disregarded for so long as the molecule responsible for the transmission of hereditary information?" hint="Reread the opening paragraph of DNA as the Molecule Responsible for Heredity." >}}
...
protein was thought to have the complexity required ... because it is composed of 20 different amino acids that could be combined in a huge variety of combinations
{{< /selfcheck >}}

### Describe how microbiology and microorganisms have been used to discover the biochemistry of genes

{{< multiplechoice
  question="Why was the alga *Acetabularia* a good model organism for Joachim Hämmerling to use to identify the location of genetic material?"
  answer="It is a large, asymmetrical, single cell easy to see with the naked eye."
  hint="Reread the Hämmerling paragraph in Microbes and Viruses in Genetic Research."
>}}
...
{{< selfcheck question="Why do bacteria and viruses make good model systems for various genetic studies?" hint="Reread the first paragraph of Microbes and Viruses in Genetic Research." >}}
...
===CHECKS===
propagated more easily in the laboratory ... growing to high population densities in a small amount of space and in a short time
because of their structural simplicity, microbes and viruses are more readily manipulated genetically
{{< /selfcheck >}}

{{< mediafigure src="microbiology/OSC_Microbio_10_01_AcetabStalk_img" alt="Diagram of two grafting experiments with Acetabularia mediterranea (round, disc-shaped cap; green stalk and foot) and Acetabularia crenulata (clustered, pompom-shaped cap; blue stalk and foot), shown at left as reference. Graft A combines the foot of A. mediterranea with the upper stalk of A. crenulata. Graft B combines the foot of A. crenulata with the upper stalk of A. mediterranea." kind="diagram" >}}
...
{{< selfcheck question="In the figure shown, if the nuclei were contained within the stalks of *Acetabularia*, what types of caps would you expect from the pictured grafts?" hint="Reread Hämmerling's grafting paragraph and its figure, then read each graft's pieces off the figure above." >}}
...
===CHECKS===
cap morphology is dictated by the species of its nucleus-containing foot
if the nucleus were instead located in the stalk, cap morphology would be dictated by the species of the stalk piece
Graft A ... would be expected to develop a clustered, A. crenulata-type cap
Graft B ... would be expected to develop a round, A. mediterranea-type cap
{{< /selfcheck >}}

### Explain how scientists established the link between DNA and heredity

{{< multiplechoice
  question="Frederick Griffith infected mice with a combination of dead R and live S bacterial strains. What was the outcome, and why did it occur?"
  answer="The mice will die. Transformation was not required."
  hint="Reread the Griffith paragraph that walks through each injection, then check which strain the stem calls live."
>}}
...
{{< multiplechoice
  question="Which of the following best describes the results from Hershey and Chase's experiment using bacterial viruses with ³⁵S-labeled proteins or ³²P-labeled DNA that are consistent with protein being the molecule responsible for hereditary?"
  answer="After infection with the ³⁵S-labeled viruses and centrifugation, only the pellet would be radioactive."
  hint="Reread the blender-and-centrifuge paragraph of Hershey and Chase's Proof of DNA as Genetic Material."
>}}
After infection with the ³⁵S-labeled viruses and centrifugation, only the pellet would be radioactive.
After infection with the ³⁵S-labeled viruses and centrifugation, both the pellet and the supernatant would be radioactive.
After infection with the ³²P-labeled viruses and centrifugation, only the pellet would be radioactive.
After infection with the ³²P-labeled viruses and centrifugation, both the pellet and the supernatant would be radioactive.
{{< /multiplechoice >}}

{{< multiplechoice
  question="According to the experiments of Avery, MacLeod, and McCarty, which of the following enzymes will eliminate the transformation of hereditary material from pathogenic bacteria to nonpathogenic bacteria? *(Source note: the source's stem opens \"According to Beadle and Tatum's 'one gene–one enzyme' hypothesis\"; that hypothesis says nothing about transformation, and this section credits the result to Avery, MacLeod, and McCarty, who found that when DNA was degraded the mixture could no longer transform the R strain.)*"
  answer="deoxyribonucleases"
  hint="Reread the Avery, MacLeod, and McCarty paragraph under Griffith's Transformation Experiments, and its figure."
>}}
...
{{< selfcheck question="Bacteriophages inject their genetic material into host cells, whereas animal viruses enter host cells completely. Why was it important to use a bacteriophage in the Hershey–Chase experiment rather than an animal virus?" hint="Reread the first and third paragraphs of Hershey and Chase's Proof of DNA as Genetic Material." >}}
...
===CHECKS===
the T2 bacteriophage ... injects only its nucleic acids inside the cell, while its protein coat remains outside
label each component separately and then use a blender and centrifuge to determine which one ... was carried into the bacterial cell
an animal virus that enters a host cell completely would carry both its protein and its nucleic acid inside the cell together
{{< /selfcheck >}}

{{< selfcheck question="Why are Hershey and Chase credited with identifying DNA as the carrier of heredity even though DNA had been discovered many years before?" hint="The answer draws on the opening of Foundations of Genetics, the opening paragraph of DNA as the Molecule Responsible for Heredity, and the end of the Hershey and Chase subsection." >}}
DNA had been discovered and characterized in the late 1800s, but for decades afterward scientists did not connect it to heredity — DNA's only four different nucleotides seemed too structurally simple, so protein, with its twenty amino acids, was instead thought to carry genetic information. Hershey and Chase's 1952 experiment provided direct, confirmatory experimental evidence that it was specifically DNA, not protein, that entered bacterial cells and directed the production of new phage particles. It was this demonstrated proof of DNA's function as the genetic material — not its earlier chemical discovery — that led the scientific community to more broadly accept DNA as the molecule responsible for heredity.
===CHECKS===
DNA had been discovered and characterized in the late 1800s
protein, with its twenty amino acids, was instead thought to carry genetic information
Hershey and Chase's 1952 experiment provided direct, confirmatory experimental evidence that it was specifically DNA, not protein, that entered bacterial cells
led the scientific community to more broadly accept DNA as the molecule responsible for heredity
{{< /selfcheck >}}

---

<small>This section is adapted from [Microbiology, Section 10.1: Using Microbiology to Discover the Secrets of Life](https://openstax.org/books/microbiology/pages/10-1-using-microbiology-to-discover-the-secrets-of-life) by Nina Parker, Mark Schneegurt, Anh-Hue Thi Tu, Philip Lister, Brian M. Forster, and OpenStax, © OpenStax, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). Access the original for free at [openstax.org](https://openstax.org/details/books/microbiology). Changes: this module defines no class-less `<term>` elements — its fifty-four `<term class="no-emphasis">` elements are index entries, not defined terms — so this page carries no `## Key terms` heading, per the life-sciences rule that a defined-term count of zero means no block; all nine figures are re-encoded as WebP and set `kind="diagram"` after inspection (the footandcap figure mixes one photographic panel with one drawn panel and is a diagram by the composite rule), each alt rewritten from the image rather than the source alt, and each given a `longdesc` walking its steps, branches, or labels in reading order; three source-alt defects found by inspection are not carried into the page's alts (a misspelling of "Hämmerling" and a one-year date discrepancy in the Timeline figure's alt, and a missing word-boundary typo in the Beadle–Tatum X-ray figure's alt), none of them printed anywhere in the running prose; the four footnotes (Mendel 1865, Beadle and Tatum 1941, Griffith 1928, Hershey and Chase 1952) are rendered as inline parenthetical citations after the sentences they support, with the Mendel footnote's "for English translation, see" access URL dropped; isotopes are set as Unicode superscripts (³²P, ³⁵S) and the filial generations as Unicode subscripts (F₁, F₂); the Clinical Focus box is rendered as a callout with its closing question kept as an unanswered plain bullet, and its "Jump to the next Clinical Focus box" link replaced by a sentence naming where the case continues, [Structure and Function of DNA](/life-health-sciences/microbiology/10-biochemistry-of-the-genome/02-structure-and-function-of-dna/) (this section opens the case, so no "the case began in" sentence is needed); both Link to Learning boxes keep their source URLs, described by the surrounding sentence; the cross-reference to Viruses is an absolute link to [Viruses](/life-health-sciences/microbiology/06-acellular-pathogens/01-viruses/); same-module figure cross-references are rendered as describing prose ("shown below," "shown in the timeline below") rather than numbered references; the four body Check Your Understanding bullets (2 in the Microbes and Viruses subsection, 1 each in the Griffith and Hershey–Chase subsections) are rendered as body items at their note's position — the Hämmerling-proof bullet is graded as a multiple choice keyed to the module's own sentence that Hämmerling "established that the genetic information in a eukaryotic cell is housed within the nucleus," its distractors the conclusions the module attributes to Beadle and Tatum, to Avery, MacLeod, and McCarty, and to Griffith, and the other three (Morgan's organism and traits, the Avery–MacLeod–McCarty elimination study, and the Hershey–Chase labeling logic) stay self-checks because their honest answers assemble two or more sentences of the module; of the five source Multiple Choice items, all five are used in Practice, keyed as the source keys them, four as printed and one with a corrected stem: the enzyme-that-eliminates-transformation item's source stem attributes the result to "Beadle and Tatum's 'one gene–one enzyme' hypothesis," which this section never connects to transformation, so the page names Avery, MacLeod, and McCarty's experiments instead, with a visible Source note in the stem (key "deoxyribonucleases" unchanged); both Fill in the Blank items are used as printed `textin`s; of the three unkeyed Short Answer questions, all three stay self-checks: why nucleic acid was disregarded needs the DNA-four-nucleotides sentence AND the protein-twenty-amino-acids sentence assembled (two module sentences, not one fixing sentence — reverted from an earlier multiple-choice draft after the checker's one-sentence read); why bacteria and viruses make good model systems likewise needs the laboratory-propagation sentence AND the structural-simplicity sentence assembled (also reverted from an earlier multiple-choice draft for the same reason); and why a bacteriophage rather than an animal virus stays a self-check because its honest answer requires assembling the phage-infection mechanism with the experiment's separation logic across two paragraphs; of the two unkeyed Critical Thinking questions, the bare-media item (the *Acetabularia* stalk-graft hypothetical) is rendered as a `mediafigure` with an author-written caption immediately followed by a self-check whose model answer inverts Hämmerling's actual foot-determines-cap finding, and the other (why Hershey and Chase are credited despite DNA's earlier discovery) stays a self-check assembling the module's opening historical paragraphs with the Hershey–Chase section's own conclusion; two author-built select-the-term items (naming Albrecht Kossel from the body's Miescher–Altmann–Kossel passage, and a cloze of the body's five-bases sentence, "These are adenine, guanine, cytosine, thymine (in DNA), and uracil (in RNA)," with "These" replaced by its referent) fill the first objective's group to the book's floor, since none of the module's twelve keyed and unkeyed exercises tests nucleic-acid discovery directly; the source Multiple Choice on Hershey and Chase's results prints "protein being the molecule responsible for hereditary" in its stem, which also answers the source Fill in the Blank on the macromolecule once thought responsible for heredity — both are source-verbatim items under different objectives, so the overlap is kept rather than either item being reworded; the module prints this scientist's name both correctly ("Kossel," at his first, term-marked occurrence) and misspelled ("Kossell," later in the same paragraph and again in the Summary) — both misspelled occurrences are corrected in place to "Kossel" with no inline note, per the one-word-typo rule; and the two author-built graded multiple-choice items (naming Kossel, and the Hämmerling body item) key different option positions rather than both defaulting to the first option. No source exercise item is otherwise omitted. One citation correction: the Griffith 1928 *Journal of Hygiene* page range is printed as 113–159 (the source prints "8–159").</small>

...
{{< mediafigure src="microbiology/OSC_Microbio_12_01_RecombTech" alt="A flow diagram showing the human insulin gene removed from a cell nucleus and inserted into a plasmid, forming a recombinant plasmid; the plasmid is inserted into a bacterial cell, producing a transgenic bacterium that divides and secretes insulin." longdesc="Five stages, left to right. A human cell with its nucleus is shown holding the insulin gene on its DNA; an arrow shows the insulin gene being removed. A plain circular plasmid sits below the cell. An arrow leads to the insulin gene combined with the cut plasmid, forming a recombinant DNA plasmid. An arrow leads to an oval transgenic bacterium containing the recombinant plasmid inside it. A final arrow leads to several small oval bacteria, each still holding the plasmid, secreting dots labeled insulin into the surrounding solution." kind="diagram" eager="true" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_12_01_Recuts" alt="Two diagrams comparing restriction-enzyme cuts. (a) Sticky-end cutting: a double-stranded DNA ladder is cut by BamHI between the two G's on each strand, leaving short single-stranded GATC overhangs on each fragment. (b) Blunt-end cutting: the same kind of DNA is cut by HaeIII directly between G and C on each strand, leaving no single-stranded overhangs." longdesc="(a) A six-base-pair double helix reading GGATCC over CCTAGG, top strand 5′ to 3′ left to right; black arrows mark the cut points between the two G's on each strand. After cutting, the two resulting fragments each carry a single-stranded 5′ GATC overhang — the sticky ends. (b) A four-base-pair double helix reading GGCC over CCGG; black arrows mark cut points directly between the G and the C on each strand. After cutting, both fragments have flush, blunt ends with no overhang." kind="diagram" >}}
...
{{< multiplechoice
  ...
  hint="Recall which colonies keep an uninterrupted lacZ gene and why that matters for the color reaction."
>}}
It contains a nonrecombinant plasmid, because the intact lacZ gene still produces functional beta-galactosidase
It contains a recombinant plasmid, because the foreign DNA insert produces a blue pigment
It took up no plasmid at all, so the ampicillin resistance gene was never expressed
It contains a nonrecombinant plasmid, because the polylinker site was never cut by a restriction enzyme
{{< /multiplechoice >}}
...
{{< multiplechoice
  ...
  hint="Recall why bacteria naturally produce these enzymes, before researchers ever put them to use in the laboratory."
>}}
...
{{< selfcheck question="What two processes are exploited to get recombinant DNA into a bacterial host cell?" hint="This subsection describes manipulating two natural mechanisms of horizontal gene transfer, other than the uptake of free DNA covered above, to deliver recombinant DNA into bacteria." >}}
...
{{< selfcheck question="Distinguish the uses of an antibiotic resistance gene and a reporter gene in a plasmid vector." hint="One of these features lets a researcher find cells that took up any plasmid at all; the other lets a researcher tell a recombinant plasmid apart from a non-recombinant one." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_12_01_CloneLibry" alt="A flow diagram of genomic library construction: DNA is extracted from an organism and cut into fragments, each fragment is inserted into a separate plasmid, bacteria are transformed with the plasmids, and each transformed bacterium replicates into a colony of clones carrying one genomic fragment." longdesc="The figure begins with a blue-tinted micrograph of the source organism's tissue, labeled 'DNA is extracted from the organism and cut into fragments.' An arrow leads to several short, colored DNA fragments and a plain circular plasmid, labeled 'DNA fragments' and 'plasmid.' A further arrow leads to circular recombinant plasmids, each holding one colored fragment, labeled 'DNA fragments are inserted into plasmids.' Arrows lead to several ovals of bacteria, each transformed with one recombinant plasmid, labeled 'Bacteria are transformed with vectors.' Final arrows fan out to clusters of identical bacterial colonies, each fanning out from one transformed cell, labeled 'Bacteria replicate, producing colonies of clones.'" kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_12_01_cDNALibry" alt="A flow diagram of cDNA library construction: RNA is extracted from an organism, reverse transcription converts the RNA into cDNA, the cDNA fragments are inserted into separate plasmids, bacteria are transformed with the plasmids, and each transformed bacterium replicates into a colony of clones carrying one cDNA fragment." longdesc="The figure begins with a blue-tinted micrograph of the source organism's tissue, labeled 'RNA is extracted from the organism.' An arrow labeled 'Reverse transcription builds cDNA' leads to colored double-stranded cDNA fragments and a plain circular plasmid. A further arrow leads to circular recombinant plasmids, each holding one cDNA fragment, labeled 'cDNA fragments are inserted into plasmids.' Arrows lead to ovals of bacteria, each transformed with one recombinant plasmid, labeled 'Bacteria are transformed with vectors,' and finally to clusters of identical bacterial colonies fanning out from each transformed cell, labeled 'Bacteria replicate, producing colonies of clones.'" kind="diagram" >}}
...
{{< textin question="What are the hosts for the genomic libraries described in this section?" answer="bacteria" accept="bacterial cells|bacterium|E. coli" hint="Both the plasmid-based and the phage-based methods of building a genomic library ultimately grow their recombinant DNA inside the same kind of cell." >}}

{{< multiplechoice
  question="What is cDNA?"
  answer="A DNA molecule made from an mRNA template by the retroviral enzyme reverse transcriptase"
  hint="Recall which molecule reverse transcriptase uses as its template to make this DNA copy."
>}}
A DNA molecule made from an mRNA template by the retroviral enzyme reverse transcriptase
...
{{< selfcheck question="What are the methods used to introduce recombinant DNA vectors into animal cells?" hint="This section names several distinct techniques for transfecting eukaryotic cells; not every one of them is specific to plants." >}}
...
{{< multiplechoice
  ...
  answer="DNA ligase"
  hint="Recall which enzyme rejoins the two sugar-phosphate backbones after sticky or blunt ends anneal."
>}}
cDNA
...
{{< multiplechoice
  ...
  hint="Name the retroviral enzyme used to build cDNA from mRNA."
>}}
...
{{< multiplechoice
  ...
  hint="Recall the section's opening distinction between biotechnology in a broad, technical sense and biotechnology in its contemporary, genetic-engineering sense."
>}}
...
{{< multiplechoice
  ...
  hint="Recall which colony color results from the lacZ gene being uninterrupted, whether or not the cell took up a plasmid at all."
>}}
...
{{< multiplechoice
  ...
  answer="False"
  hint="Recall that horizontal gene transfer by conjugation, transduction, and transformation, all of which rely on recombination, occur naturally in bacteria."
>}}
True
False
{{< /multiplechoice >}}
...
{{< multiplechoice
  ...
  hint="Recall which kind of end lacks a complementary overhang to facilitate the annealing step."
>}}
...
{{< textin question="Plasmid vectors used for cloning typically have a short sequence containing multiple unique restriction enzyme recognition sites, called a ________ site." answer="polylinker" accept="multiple cloning site|MCS" hint="Name the short sequence within a reporter gene where foreign DNA is inserted after restriction digestion." >}}
...
{{< multiplechoice
  ...
  hint="Three of these four terms name mechanisms of horizontal gene transfer this book covers; the fourth is a step of gene expression."
>}}
transformation
transduction
transcription
...
{{< multiplechoice
  ...
  answer="True"
  hint="Recall how this section describes eukaryotic cells' competence for taking up foreign DNA compared with bacteria's."
>}}
True
False
{{< /multiplechoice >}}

{{< selfcheck question="Name three elements incorporated into a plasmid vector for efficient cloning." hint="This section names several plasmid features that make cloning work: one lets researchers select for cells that took up a plasmid, one lets researchers insert foreign DNA at several possible restriction sites, and one lets researchers tell recombinant plasmids apart from non-recombinant ones." >}}
...
{{< multiplechoice
  ...
  hint="Recall what a cDNA library is built from, and how that differs from what a genomic library represents."
>}}
...
{{< multiplechoice
  ...
  hint="Recall what a single phage particle can carry compared with a single plasmid vector."
>}}
...
{{< textin question="A repository of an organism's entire genome maintained as cloned fragments in the genomes of strains of a host organism is called a ________." answer="genomic library" hint="Name the term this section defines at the start of the subsection on constructing this kind of collection." >}}
...
{{< multiplechoice
  ...
  answer="plant cells"
  hint="Recall which organism's cells the Ti plasmid of Agrobacterium tumefaciens naturally transfers its T-DNA into."
>}}
animal cells
plant cells
bacteriophages

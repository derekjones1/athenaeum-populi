...
{{< multiplechoice
  ...
  hint="Recall the general definition given for extracellular enzymes secreted by pathogens, at the start of this subsection."
>}}
...
{"bins":["Endotoxin","Exotoxin"],"items":[{"label":"Produced by gram-negative bacteria","bin":0},{"label":"Composed of protein","bin":1},{"label":"Causes general systemic symptoms of inflammation and fever","bin":0},{"label":"Produced primarily by gram-positive bacteria, but also gram-negative bacteria","bin":1},{"label":"Heat stable","bin":0},{"label":"Causes specific damage to cells through receptor-mediated targeting","bin":1},{"label":"Composed of the lipid A component of lipopolysaccharide","bin":0},{"label":"Mostly heat labile, though some are heat stable","bin":1},{"label":"Has a high LD₅₀","bin":0},{"label":"Has a low LD₅₀","bin":1}]}
{{< /sortbins >}}

{{< multiplechoice
  question="Name the three classes of exotoxins."
  answer="Intracellular targeting, membrane disrupting, and superantigens"
  hint="Recall the one sentence, right after the Comparison of Endotoxin and Exotoxins table, that names the three groups exotoxins are sorted into by their target."
>}}
...
Whether a pathogen produces a capsule to resist phagocytosis
...
{{< multiplechoice
  ...
  hint="Recall what hyaluronidase's target molecule, hyaluronan, normally does between adjacent cells in connective tissue."
>}}
...
{{< multiplechoice
  ...
  hint="Recall where on a pathogen adhesins are found, and the two general classes of molecules that typically compose them."
>}}
...
{{< textin question="The Shiga and diphtheria toxins target ________ in host cells." answer="protein synthesis" hint="Recall what elongation factor 2 (EF-2) does for a cell, and what happens once the diphtheria toxin's A subunit blocks it." >}}

{{< sortbins question="Sort each toxin under the category that describes its target, from the Some Common Exotoxins table above." hint="Match each toxin to one of the three target-based categories: intracellular-targeting, membrane-disrupting, or superantigens." >}}
...
{{< selfcheck question="Two types of toxins are hemolysins and leukocidins. (a) How are these toxins similar? (b) How do they differ?" hint="The similarity is in one sentence about pore formation and cell lysis; the difference is in the sentence right after it, about what each toxin was originally thought to target." >}}
...
the activated G protein leads to activation of adenylyl cyclase and an increase in cAMP

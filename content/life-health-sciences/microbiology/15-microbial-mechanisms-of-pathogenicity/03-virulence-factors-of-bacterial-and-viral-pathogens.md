...
description: >-
  Bacterial virulence factors — exoenzymes, endotoxin and exotoxin, the three
  categories of exotoxins, and the ways bacteria evade the immune system —
  plus how viruses use adhesins for tropism and antigenic drift and shift to
  escape immune recognition — adapted from OpenStax Microbiology, Section
  15.3.
source_section: "15.3"
weight: 3
---
...
The case continues in this section's Resolution, below. The case began in [Characteristics of Infectious Disease](/life-health-sciences/microbiology/15-microbial-mechanisms-of-pathogenicity/01-characteristics-of-infectious-disease/).
{{< /callout >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_15_03_Edema" alt="A photograph of a person's two hands, palms down; the right hand is visibly more swollen than the left, with less-defined bone and tendon contours beneath the skin." kind="photo" eager="true" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_15_03_CollClost" alt="A diagram of a human leg with a circular inset zooming into a cross-section of a blood vessel: a central lumen lined by endothelial cells, surrounded by dense irregular connective tissue, with small collagenase dots breaking gaps between the endothelial cells; an arrow leads to a micrograph of red, fibrous connective tissue." kind="diagram" >}}
...
Two types of cell death are apoptosis and necrosis. Visit this [website](https://openstax.org/l/22CellDeath) to learn more about the differences between these mechanisms of cell death and their causes.
{{< /callout >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_15_03_LPS" alt="A long row of green pentagon and triangle shapes labeled O antigen, connecting to a shorter row of blue diamond, triangle, circle, square, and hexagon shapes labeled core, ending in two orange circles labeled lipid A, each with two or three wavy tails." kind="diagram" >}}
...
| Intracellular-targeting toxins | Tetanus toxin | *Clostridium tetani* | Inhibits the release of inhibitory neurotransmitters in the central nervous system, causing spastic paralysis |
| Intracellular-targeting toxins | Botulinum toxin | *Clostridium botulinum* | Inhibits release of the neurotransmitter acetylcholine from neurons, resulting in flaccid paralysis |
| Intracellular-targeting toxins | Diphtheria toxin | *Corynebacterium diphtheriae* | Inhibition of protein synthesis, causing cellular death |
...
| Membrane-disrupting toxins | Pneumolysin | *Streptococcus pneumoniae* | Proteins that assemble into pores in cell membranes, disrupting their function and killing the cell |
| Membrane-disrupting toxins | Alpha-toxin | *Staphylococcus aureus* | Proteins that assemble into pores in cell membranes, disrupting their function and killing the cell |
| Membrane-disrupting toxins | Alpha-toxin | *Clostridium perfringens* | Phospholipases that degrade cell membrane phospholipids, disrupting membrane function and killing the cell |
| Membrane-disrupting toxins | Phospholipase C | *Pseudomonas aeruginosa* | Phospholipases that degrade cell membrane phospholipids, disrupting membrane function and killing the cell |
| Membrane-disrupting toxins | Beta-toxin | *Staphylococcus aureus* | Phospholipases that degrade cell membrane phospholipids, disrupting membrane function and killing the cell |
| Superantigens | Toxic shock syndrome toxin | *Staphylococcus aureus* | Stimulates excessive activation of immune system cells and release of cytokines (chemical mediators). Life-threatening fever, inflammation, and shock are the result. |
| Superantigens | Streptococcal mitogenic exotoxin | *Streptococcus pyogenes* | Stimulates excessive activation of immune system cells and release of cytokines (chemical mediators). Life-threatening fever, inflammation, and shock are the result. |
| Superantigens | Streptococcal pyrogenic toxins | *Streptococcus pyogenes* | Stimulates excessive activation of immune system cells and release of cytokines (chemical mediators). Life-threatening fever, inflammation, and shock are the result. |
...
{{< multiplechoice
  question="Describe how exoenzymes contribute to bacterial invasion."
  answer="They are secreted enzymes that enable pathogens to invade host cells and deeper tissues"
  hint="Reread the opening paragraph of the Exoenzymes subsection."
>}}
They are protein or glycoprotein molecules that attach the pathogen to receptors on host cells
They are secreted enzymes that enable pathogens to invade host cells and deeper tissues
They are biological poisons that assist a pathogen's ability to invade and cause damage to tissues
They are polysaccharide layers that prevent phagocytic cells from engulfing the pathogen
{{< /multiplechoice >}}

{{< sortbins question="Explain the difference between exotoxins and endotoxin by sorting each characteristic below under the toxin type it describes." hint="Use the Comparison of Endotoxin and Exotoxins table above: check the toxin's source, composition, effect on the host, heat stability, and LD₅₀ column by column." >}}
{"bins":["Endotoxin","Exotoxin"],"items":[{"label":"Released when a gram-negative cell dies or undergoes binary fission","bin":0},{"label":"Composed of protein","bin":1},{"label":"Causes general systemic symptoms of inflammation and fever","bin":0},{"label":"Produced primarily by gram-positive bacteria, but also gram-negative bacteria","bin":1},{"label":"Requires heating at 121 °C for 45 minutes to inactivate","bin":0},{"label":"Causes specific damage to cells through receptor-mediated targeting","bin":1},{"label":"Composed of the lipid A component of lipopolysaccharide","bin":0},{"label":"Mostly heat labile, though some are heat stable","bin":1},{"label":"Has a high LD₅₀","bin":0},{"label":"Has a low LD₅₀","bin":1}]}
{{< /sortbins >}}

{{< multiplechoice
  question="Name the three classes of exotoxins."
  answer="Intracellular targeting, membrane disrupting, and superantigens"
  hint="Reread the sentence right after the Comparison of Endotoxin and Exotoxins table."
>}}
Endotoxin, exotoxin, and enterotoxin
...
{{< mediafigure src="microbiology/OSC_Microbio_15_03_Phago" alt="Three-panel diagram. (a) A micrograph of blue oval bacterial cells; some have a thick clear capsule ring around them and one small cluster of cells has none. (b) A capsule-covered bacterial cell with surface antigens; a Y-shaped antibody approaches but cannot reach the antigen because the capsule covers it, and a phagocytic cell sits nearby. (c) A capsule-covered bacterial cell releasing small dots labeled proteases that are breaking apart a Y-shaped antibody into fragments." longdesc="Panel (a): a micrograph showing several round, capsule-covered bacterial cells as blue ovals surrounded by a wide, clear halo, labeled 'capsule,' beside one small cluster of cells with no halo, labeled 'nonencapsulated bacteria.' Panel (b): a labeled diagram of a blue-and-white oval 'bacterial cell' surrounded by a light cyan 'capsule' layer, with small yellow-green round dots on its surface labeled 'antigen'; a teal Y-shaped 'antibody' approaches from a large orange 'phagocytic cell' but cannot contact the antigen because the capsule surrounds it. Panel (c): the same encapsulated bacterial cell, with its cyan capsule and yellow-green antigen dots both labeled again, now releasing small pink dots labeled 'protease' toward a teal Y-shaped antibody, which is shown broken into two separate pieces labeled 'broken-down antibody.'" kind="diagram" >}}
...
coagulase triggers the fibrinogen-to-fibrin cascade, coating the bacteria in a protective clot
antigenic variation alters surface proteins so that antibodies against the earlier version are no longer effective
{{< /selfcheck >}}
...
The case began in [Characteristics of Infectious Disease](/life-health-sciences/microbiology/15-microbial-mechanisms-of-pathogenicity/01-characteristics-of-infectious-disease/).
{{< /callout >}}
...
For another explanation of how [antigenic shift and drift](https://openstax.org/l/22Antigenic) occur, watch this video.
{{< /callout >}}
...
{{< multiplechoice
  ...
  answer="Their interaction with specific cell receptors defines which cells, tissues, and organs the virus targets"
  hint="Reread the first paragraph of the Viral Adhesins subsection."
>}}
They mix the genes of two different influenza viruses that infect the same host
They alter the virus's surface proteins so the host immune system no longer recognizes it
They digest antibody molecules so that phagocytes cannot ingest the virus
Their interaction with specific cell receptors defines which cells, tissues, and organs the virus targets
{{< /multiplechoice >}}
...
antigenic shift is a major change in spike proteins due to gene reassortment
gene reassortment for antigenic shift typically occurs when two different influenza viruses infect the same host
{{< /selfcheck >}}
...
{{< multiplechoice
  ...
  hint="Reread the section's opening paragraph and the paragraph that follows the first heading."
>}}
...
{{< multiplechoice
  question="Which of the following applies to hyaluronidase?"
  answer="It acts as a spreading factor."
  hint="Reread the opening paragraph of the Exoenzymes subsection and the first row of the table that follows it."
>}}
...
{{< multiplechoice
  question="Adhesins are usually located on __________ of the pathogen and are composed mainly of __________ and __________."
  answer="surface; proteins; sugars"
  hint="Reread the first paragraph of the Virulence Factors for Adhesion discussion."
>}}
surface; proteins; sugars
cytoplasm; lipids; nucleic acids
surface; lipids; nucleic acids
capsule; proteins; lipids
{{< /multiplechoice >}}

{{< sortbins question="Sort each adhesin and disease under the pathogen that produces it, from the Some Bacterial Adhesins table above." hint="Match each pathogen to its own named adhesin and the disease it causes (Vibrio cholerae is left out here to keep the sort to four groups)." >}}
{"bins":["Streptococcus pyogenes","Streptococcus mutans","Neisseria gonorrhoeae","Enterotoxigenic E. coli (ETEC)"],"items":[{"label":"Protein F","bin":0},{"label":"Dental caries","bin":1},{"label":"Type IV pili","bin":2},{"label":"Traveler's diarrhea","bin":3},{"label":"Strep throat","bin":0},{"label":"Type 1 fimbriae","bin":3},{"label":"Gonorrhea","bin":2},{"label":"Adhesin P1","bin":1}]}
{{< /sortbins >}}

{{< sortbins question="Sort each enzyme example and its function under the exoenzyme class it belongs to, from the Some Classes of Exoenzymes table above." hint="Match each enzyme example and its function to the one exoenzyme class it belongs to." >}}
{"bins":["Glycohydrolases","Nucleases","Phospholipases","Proteases"],"items":[{"label":"Hyaluronidase S in Staphylococcus aureus","bin":0},{"label":"Degrades collagen in connective tissue to promote spread","bin":3},{"label":"DNAse produced by S. aureus","bin":1},{"label":"Degrades phospholipid bilayer of host cells, causing lysis","bin":2},{"label":"Degrades hyaluronic acid that cements cells together","bin":0},{"label":"Collagenase in Clostridium perfringens","bin":3},{"label":"Degrades DNA released by dying cells to prevent bacterial entrapment","bin":1},{"label":"Example from Bacillus anthracis","bin":2}]}
{{< /sortbins >}}

### Differentiate between endotoxins and exotoxins

{{< textin question="The ability of a pathogen to produce toxins to cause damage to host cells is called ________." answer="toxigenicity" hint="Reread the opening paragraph of the Toxins subsection." >}}

{{< textin question="A classic method of detecting endotoxin is by using the ________ test, in which the blood cells of the horseshoe crab are mixed with a patient's serum." answer="Limulus amebocyte lysate" accept="LAL|LAL test|Limulus amebocyte lysate test|Limulus amoebocyte lysate" hint="Reread the paragraph that follows the lipopolysaccharide figure." >}}
...
{{< multiplechoice
  ...
  answer="exotoxin"
  hint="Compare the characteristics given — composition, toxicity, and heat stability — with the Comparison of Endotoxin and Exotoxins table above."
>}}
superantigen
endotoxin
exotoxin
...
{{< textin question="The Shiga and diphtheria toxins target ________ in host cells." answer="protein synthesis" hint="Reread the paragraph on the diphtheria toxin that follows the A-B toxin figure." >}}

{{< sortbins question="Sort each toxin under the category that describes its target, from the Some Common Exotoxins table above." hint="Use the Some Common Exotoxins table above." >}}
{"bins":["Intracellular-targeting","Membrane-disrupting","Superantigens"],"items":[{"label":"Cholera toxin","bin":0},{"label":"Streptolysin","bin":1},{"label":"Toxic shock syndrome toxin","bin":2},{"label":"Tetanus toxin","bin":0},{"label":"Pneumolysin","bin":1},{"label":"Streptococcal pyrogenic toxins","bin":2},{"label":"Botulinum toxin","bin":0},{"label":"Alpha-toxin (Staphylococcus aureus)","bin":1},{"label":"Alpha-toxin (Clostridium perfringens)","bin":1},{"label":"Diphtheria toxin","bin":0},{"label":"Phospholipase C","bin":1},{"label":"Beta-toxin","bin":1}]}
{{< /sortbins >}}

{{< selfcheck question="Two types of toxins are hemolysins and leukocidins. (a) How are these toxins similar? (b) How do they differ?" hint="Reread the paragraph on membrane-disrupting toxins that follows the botulinum and tetanus figure." >}}

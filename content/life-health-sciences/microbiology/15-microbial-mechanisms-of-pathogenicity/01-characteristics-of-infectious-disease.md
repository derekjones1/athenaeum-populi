...
description: >-
  The distinction between signs and symptoms, how diseases are classified as
  communicable, contagious, noncommunicable, iatrogenic, nosocomial, or
  zoonotic, and the five periods of an acute infectious disease from
  incubation through convalescence — adapted from OpenStax Microbiology,
  Section 15.1.
source_section: "15.1"
weight: 1
---
...
The case continues in [How Pathogens Cause Disease](/life-health-sciences/microbiology/15-microbial-mechanisms-of-pathogenicity/02-how-pathogens-cause-disease/).
{{< /callout >}}
...
| Degenerative | Progressive, irreversible loss of function | Parkinson disease (affecting the central nervous system) |
...
{{< mediafigure src="microbiology/OSC_Microbio_15_01_Blood" alt="(a) A micrograph of round red blood cells with one darker, oval cell labeled Plasmodium falciparum and a nearby red blood cell (erythrocyte) labeled. (b) A micrograph of red blood cells, mostly round, with one crescent- or C-shaped cell labeled sickle cell." kind="photo" eager="true" >}}
...
Lists of common infectious diseases can be found at the [Centers for Disease Control and Prevention](https://openstax.org/l/22CDCdis) (CDC), the World Health Organization's website (who.int), and [International Classification of Diseases](https://openstax.org/l/22WHOclass) websites.
{{< /callout >}}
...
transmission ... requires close intimate contact between an infected person and an uninfected person
typically only transmitted through contact with a skin wound
...
transmitted easily via improperly sterilized medical equipment
by clinicians, nurses, or therapists who do not wash their hands

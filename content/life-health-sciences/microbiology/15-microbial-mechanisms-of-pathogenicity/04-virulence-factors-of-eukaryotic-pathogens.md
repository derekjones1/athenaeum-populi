...
description: >-
  How fungi, protozoa, and helminths cause disease with the same basic
  strategies as bacteria — adhesins, mycotoxins, capsules, antigenic
  variation, and glycan mimicry — and how helminths' size and immune
  suppression add strategies bacteria and fungi do not use — adapted from
  OpenStax Microbiology, Section 15.4.
source_section: "15.4"
weight: 4
---
...
exotoxins, called mycotoxins in fungi
exoenzymes such as proteases and phospholipases
...
aflatoxin acts as a mutagen and carcinogen
gliotoxin ... inducing host cells to self-destruct
evading the host's immune response, inhibiting the function of phagocytic cells
{{< /selfcheck >}}
...
antigenic variations ... prevent it from being easily recognized and eliminated
allowing malaria to persist as a chronic infection
alter the structure of the glycoprotein to evade recognition
{{< /selfcheck >}}
...
{{< multiplechoice
  question="Describe how helminths avoid being destroyed by the host immune system."
  answer="By expressing polysaccharides called glycans that resemble host molecules"
  hint="This mechanism relies on a helminth's own surface molecules being mistaken for the host's — recall what changes about a parasite's surface characteristics over the course of its life cycle."
>}}
...
{{< multiplechoice
  question="Which of the following is a major virulence factor for the fungal pathogen *Cryptococcus?*"
  answer="capsule"
  hint="Recall which of these four choices this section names as what protects *Cryptococcus* from phagocytosis."
>}}
hemolysin
capsule
collagenase
...
{{< multiplechoice
  question="Which of the following pathogens undergoes antigenic variation to avoid immune defenses?"
  answer="*Plasmodium*"
  hint="Recall which of these four pathogens is described as altering the structure of a surface protein, PfEMP1, over time to escape recognition."
>}}
*Candida*
*Cryptococcus*
*Plasmodium*
...
{{< selfcheck question="Describe the virulence factors associated with the fungal pathogen *Aspergillus*." hint="This section names four separate virulence factors for *Aspergillus*: two mycotoxins and two proteases." >}}
...
===CHECKS===
aflatoxin, which acts as both a mutagen and a carcinogen
gliotoxin ... inducing host cells to self-destruct
evading the host's immune response, inhibiting the function of phagocytic cells
elastase, which breaks down the elastin
...
{{< textin question="The larval form of *Schistosoma mansoni* uses a ________ to help it gain entry through intact skin." answer="protease" hint="Recall the enzyme class, described earlier in this section, that degrades structural proteins such as keratin and elastin to help a pathogen invade tissue." >}}
...
{{< multiplechoice
  ...
  answer="exotoxins"
  hint="The module says fungi produce these toxins 'like some bacteria' — recall the general term for a toxin a pathogen releases, as opposed to a capsule or an enzyme."
>}}
capsules
adhesins
exotoxins
...
degradation of host antibodies
{{< /multiplechoice >}}
...
{{< multiplechoice
  ...
  answer="Protozoa"
  hint="Recall which of the module's three pathogen groups is introduced as unicellular and having mechanisms analogous to prokaryotic and viral pathogens."
>}}
Fungi
Protozoa
Helminths
...
{{< selfcheck question="Compare how protozoan parasites and helminths each avoid detection or destruction by the host immune system." hint="Recall the one strategy this section highlights for protozoa, altering a surface protein over time, against the several strategies it lists for helminths: size, cuticle, surface mimicry, and immune suppression." >}}
...
===CHECKS===
evade the immune system through antigenic variation
altering the structure of a recognizable surface protein over time so ... antibodies ... no longer recognize it
...
By producing a capsule that resists phagocytosis
By producing mycotoxins that inhibit phagocytic cells
{{< /multiplechoice >}}

{{< multiplechoice
  question="Besides suppressing host defenses directly, how else can helminths interfere with the immune system, according to this section?"
  answer="By releasing large amounts of material that overwhelm the immune system or cause it to respond inappropriately"
  hint="Recall what this section says can happen when helminths release large quantities of material into the host, described in the sentence that closes the Helminth Virulence discussion."
>}}
By releasing large amounts of material that overwhelm the immune system or cause it to respond inappropriately
By producing a capsule that resists phagocytosis
By producing mycotoxins that inhibit phagocytic cells
By using an adhesive disc to attach to host intestinal cells
{{< /multiplechoice >}}

{{< selfcheck question="Explain how a helminth's large size or tough outer cuticle can help it avoid destruction by the host immune system." hint="This section names these two traits before it discusses surface mimicry or immune suppression — look at the paragraph's first two sentences." >}}
...
===CHECKS===
so large that the immune system is ineffective against them
adult roundworms ... are protected ... by a tough outer cuticle
{{< /selfcheck >}}

{{< selfcheck question="Explain how helminths evade the immune system." hint="This section gives four separate reasons across three paragraphs: two about the parasite's own body (size and cuticle), one about how its surface mimics the host, and one about what it does to the host's defenses." >}}
...
so large that the immune system is ineffective against them
protected by a tough outer cuticle
express polysaccharides called glycans ... the immune system fails to recognize and attack the helminth as a foreign body
actively suppress the immune system ... degrades host antibodies with proteases
{{< /selfcheck >}}

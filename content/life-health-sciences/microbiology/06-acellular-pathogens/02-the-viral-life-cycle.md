...
{{< multiplechoice
  question="Is a latent phage undetectable in a bacterium?"
  answer="Yes — it is typical of temperate phages to remain latent or inactive within the cell."
  hint="Compare what defines a temperate phage's behavior with what defines a virulent phage's behavior."
>}}
No — a temperate phage destroys its host cell immediately upon infection, the way a virulent phage does.
Yes — it is typical of temperate phages to remain latent or inactive within the cell.
{{< /multiplechoice >}}
...
{{< multiplechoice
  ...
  hint="Recall which cycle packages random host DNA by mistake, and which one begins with a prophage being excised."
>}}
...
{{< multiplechoice
  ...
  hint="Check which party 'brings in' the RdRP enzyme, according to the paragraph on negative-strand RNA viruses."
>}}
...
{{< multiplechoice
  ...
  hint="Look at the sentence right after the two categories of persistent infection are named."
>}}
...
{{< selfcheck question="What is the structure and genome of a typical plant virus?" hint="Assemble the module's statements on plant-virus envelope, genome type, and strandedness into one description." >}}
...
{{< multiplechoice
  ...
  answer="lytic cycle"
  hint="Recall which cycle takes over and destroys its host, versus which one integrates without killing it."
>}}
lysogenic cycle
lytic cycle
prophage
...
{{< textin
  ...
  answer="eclipse"
  hint="Name the growth-curve stage between virus penetration and the steep rise in titer."
>}}

{{< sortbins question="Sort each description under the phage life cycle it describes." hint="Ask whether the described event destroys the host cell right away or leaves it alive and dividing." >}}
...
{{< selfcheck question="Bacteriophages have lytic and lysogenic cycles. Discuss the advantages and disadvantages for the phage." hint="Weigh what each cycle costs the host cell against what it gains the phage." >}}
In the lytic cycle, the phage takes over the host cell and rapidly produces many new phages, but this destroys the cell in the process. In the lysogenic cycle, the phage genome integrates into the bacterial chromosome as a prophage and is replicated along with the host's own DNA into daughter cells, so the host survives and carries the phage forward; the phage remains latent and produces no new progeny until induction excises it from the chromosome and it proceeds through a lytic cycle.
===CHECKS===
the phage takes over the host cell and rapidly produces many new phages
this destroys the cell in the process
the phage genome integrates into the bacterial chromosome as a prophage
is replicated along with the host's own DNA into daughter cells
the phage remains latent and produces no new progeny until induction
{{< /selfcheck >}}
...
{{< multiplechoice
  ...
  answer="release"
  hint="Recall which stage releases new virions from the host cell, picking up membrane on the way out."
>}}
attachment
penetration
assembly
...
{{< sortbins question="Sort each description under the type of virus that enters a cell this way." hint="One mechanism punches a hole and injects genetic material from outside; the other brings the whole particle inside the cell." >}}
...
{{< multiplechoice
  ...
  hint="Identify the special enzyme HIV carries within its capsid to copy its RNA genome into DNA."
>}}
...
{{< selfcheck question="How does reverse transcriptase aid a retrovirus in establishing a chronic infection?" hint="Trace the enzyme's product from ssDNA through to a permanent part of the host chromosome." >}}
...
{{< textin
  ...
  answer="reverse transcriptase"
  hint="Name the HIV enzyme discussed in the retrovirus paragraph."
>}}
...
{{< textin
  ...
  answer="latent"
  hint="Name the term this section uses for a virus capable of remaining hidden or dormant inside the cell."
>}}

### Discuss human viruses and their virus-host cell interactions

{{< multiplechoice
  question="Animal viruses can undergo ________, similar to lysogeny for a bacteriophage."
  answer="latency"
  hint="Name the process, discussed alongside lysogeny, that lets an animal virus persist without producing progeny."
>}}
lysis
penetration
latency
...
{{< multiplechoice
  question="HIV is an example of a virus that produces a ________ infection, often after a long period of latency."
  answer="chronic"
  hint="Recall the term for a long-term infection the body cannot fully clear, as HIV often causes after a period of latency."
>}}
acute
lytic
subclinical
...
{{< multiplechoice
  ...
  answer="contagious"
  hint="Recall what changes about transmissibility once Ebola symptoms appear, according to the case discussion."
>}}
contagious
latent
dormant
...
{{< textin
  ...
  answer="shingles"
  hint="Name the disease that can emerge years later from the nerve-cell ganglia where varicella-zoster went dormant."
>}}
...
{{< multiplechoice
  ...
  answer="transduction"
  hint="Name the process this whole section's heading describes."
>}}
transduction
penetration
excision
...
{{< sortbins question="Sort each description under the type of transduction it describes." hint="Ask whether the DNA transferred is a random piece or a specific piece near where the phage integrated." >}}
{"bins": ["Generalized transduction", "Specialized transduction"],
 "items": [
  {"label": "A random piece of bacterial chromosomal DNA is transferred by the phage during the lytic cycle.", "bin": 0},
  {"label": "This form of gene transfer occurs only at the end of the lysogenic cycle, when the prophage is excised.", "bin": 1},
  {"label": "Results when the packaging of phage DNA occasionally makes a mistake and packs bacterial DNA instead.", "bin": 0},
  {"label": "The DNA that moves is not random — it is a specific piece of the chromosome located near the site of viral integration.", "bin": 1}]}
{{< /sortbins >}}

{{< textin
  question="The phage genome that has incorporated into the host genome, and that specialized transduction excises from the bacterial chromosome, is called a ________."
  answer="prophage"
  hint="Name the integrated viral genome discussed in the Lysogenic Cycle subsection."
>}}
...
{{< textin
  ...
  hint="Name the narrow-host-range virus contrasted with the broad-host-range cucumber mosaic virus."
>}}

{{< multiplechoice
  question="However, most plant viruses do not have a DNA genome; the majority have a ________ genome, which acts like messenger RNA."
  answer="+ssRNA"
  hint="Recall which RNA type, discussed earlier for animal viruses, acts directly like messenger RNA."
>}}
−ssRNA
+ssRNA
dsDNA
...
{{< selfcheck question="Discuss some methods by which plant viruses are transmitted from a diseased plant to a healthy one." hint="Separate the general contact-based routes from the vector- and wound-based ones." >}}

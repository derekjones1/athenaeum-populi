...
description: >-
  How bacteriophages replicate through the lytic and lysogenic cycles and
  transfer genes by transduction, how animal viruses enter cells, replicate
  their diverse genomes, and establish latent or chronic infections, and how
  plant viruses spread from an infected host to a healthy one — adapted from
  OpenStax Microbiology, Section 6.2.
source_section: "6.2"
weight: 2
---
...
{{< mediafigure src="microbiology/OSC_Microbio_06_02_lyticcycle" alt="A five-panel diagram of the bacteriophage lytic cycle. In panel 1 a spider-shaped bacteriophage sits on the surface of an oval bacterial cell, with a tangled host DNA strand inside the cell. In panel 2 a thin phage-DNA strand now runs from the phage into the cell, alongside the host DNA. In panel 3 the cell interior is filled with loose viral DNA strands, empty capsid shells, and phage tail parts. In panel 4 several fully assembled bacteriophages fill the cell. In panel 5 the cell membrane has ruptured and completed bacteriophages spill out." longdesc="The five panels are labelled by stage: (1) Attachment — the phage attaches to the surface of the host. (2) Penetration — the viral DNA enters the host cell, leaving the phage's head drawn empty. (3) Biosynthesis — the phage DNA replicates and phage proteins are made; from this panel on the magenta host DNA is no longer drawn. (4) Maturation — the new phage particles are assembled. (5) Lysis — the cell lyses and the newly made phages are released." kind="diagram" eager="true" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_06_02_lyscycle" alt="An eight-position diagram tracing a temperate bacteriophage through both the lytic and lysogenic cycles, each position a small oval bacterial cell with a phage or its DNA drawn inside, connected by arrows left to right along the top row, down the right side, and right to left along the bottom row." longdesc="Top row, left to right: (1) the phage infects a cell, attaching outside and injecting its DNA. (2) The phage DNA becomes incorporated into the host genome. (3) The cell divides, and prophage DNA is passed on to both daughter cells. (4) Under stressful conditions, the prophage DNA is excised from the bacterial chromosome and enters the lytic cycle. Bottom row, right to left, continuing from panel 4: (5) the phage DNA replicates and phage proteins are made. (6) New phage particles are assembled. (7) The cell lyses, releasing the newly made phages." kind="diagram" >}}
...
This [video](https://www.openstax.org/l/22lyticcycle) illustrates the lytic cycle.
{{< /callout >}}

**Check Your Understanding**

{{< selfcheck question="Is a latent phage undetectable in a bacterium?" hint="Reread the Lysogenic Cycle subsection." >}}
This section does not say whether a latent phage can be detected. It says that it is typical of temperate phages to be latent or inactive within the cell, and that as the bacterium replicates its chromosome, it also replicates the phage's DNA and passes it on to new daughter cells. The presence of the phage may alter the phenotype of the bacterium, since it can bring in extra genes, such as toxin genes that can increase bacterial virulence.
===CHECKS===
typical of temperate phages to be latent or inactive within the cell
it also replicates the phage's DNA and passes it on to new daughter cells
The presence of the phage may alter the phenotype of the bacterium
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_06_02_transd" alt="A six-position diagram of specialized transduction, each position a small oval bacterial cell with phage and DNA drawn inside." longdesc="1. Viral attachment and penetration — the phage infects a cell. 2. Integration — the phage DNA becomes incorporated into the host genome. 3. Excision — the phage is excised from the bacterial chromosome along with a short piece of bacterial DNA; a following panel shows the DNA packaged into newly formed capsids. 4. Infection — the phage, now carrying both viral and bacterial DNA, infects a new host cell. 5. Recombination — the phage DNA, along with the attached bacterial DNA, is incorporated into the new cell's genome." kind="diagram" >}}
...
{{< multiplechoice
  question="Which phage life cycle is associated with which forms of transduction?"
  answer="Generalized transduction occurs during the lytic cycle; specialized transduction occurs during the lysogenic cycle."
  hint="Reread the Transduction paragraph's sentences that define each form."
>}}
Generalized transduction occurs during the lytic cycle; specialized transduction occurs during the lysogenic cycle.
Generalized transduction occurs during the lysogenic cycle; specialized transduction occurs during the lytic cycle.
Both generalized and specialized transduction occur only during the lytic cycle.
Both generalized and specialized transduction occur only during the lysogenic cycle.
{{< /multiplechoice >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_06_02_RepAnVirus" alt="A six-panel diagram of influenza virus infection of an epithelial cell, each panel a light-blue oval cell with a lavender nucleus." longdesc="1. Attachment — the influenza virus becomes attached to a target epithelial cell. 2. Penetration — the cell engulfs the virus by endocytosis. 3. Fusion and uncoating — the viral RNA is released from the vesicle. 4. Biosynthesis — the viral RNA enters the nucleus, where it is replicated by the viral RNA polymerase. 5. Protein synthesis — two arrows leave the nucleus, one to a scattered cluster of viral proteins (labeled Assembly) and one to copies of the RNA genome, as viral mRNA is used to make viral proteins. 6. Assembly and release — the same two products, viral proteins and RNA genome copies, combine into new, fully assembled viral particles, which are released into the extracellular fluid; the cell, not killed in the process, continues to make new virus." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_06_02_RNAvirus" alt="A flow chart of three boxes. Two arrows both marked RdRP run between a box labelled −ssRNA and a box labelled +ssRNA, one arrow pointing each way. A third arrow, marked host ribosomes, runs from the +ssRNA box to a box labelled viral proteins. Below the chart, RdRP is defined as viral RNA-dependent RNA polymerase, +ssRNA as the positive (+) single strand, and −ssRNA as the negative (−) single-stranded RNA." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_06_02_hiv" alt="A seven-step diagram of the HIV life cycle inside a large host immune cell, with an HIV particle's gp120 protein labelled at left where it binds the host cell's CD4 and coreceptor, both also labelled and a mature virion labelled at lower left." longdesc="1. HIV fuses to the host-cell surface: the gp120 protein on the virus surface binds CD4, which binds a coreceptor (CCR5 or CXCR4). 2. HIV RNA, reverse transcriptase, integrase, and other viral proteins enter the host cell as a preintegration complex. 3. Viral DNA is formed by reverse transcription. 4. Viral DNA is transported across the nucleus and integrates into the host DNA, forming a provirus. 5. New viral RNA is used as genomic RNA and to make viral proteins. 6. New viral RNA and proteins move to the cell surface, and a new, immature HIV particle forms by budding. 7. The virus matures when protease releases the proteins that form the mature HIV virion." kind="diagram" >}}
...
{{< multiplechoice
  question="Is RNA-dependent RNA polymerase made from a viral gene or a host gene?"
  answer="A gene the virus itself brings into the host cell."
  hint="Reread the paragraph on RNA genomes in Life Cycle of Viruses with Animal Hosts."
>}}
A gene encoded by the host cell's own genome.
A gene the virus itself brings into the host cell.
{{< /multiplechoice >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_06_02_latency" alt="(a) A transmission electron micrograph of an enveloped, roughly round varicella-zoster virus particle with a scale bar marked 50 nm. (b) A photograph of a person's face and scalp showing several raised, fluid-filled red blisters clustered on one side." kind="photo" >}}
(a) Varicella-zoster, the virus that causes chickenpox, has an enveloped icosahedral capsid visible in this transmission electron micrograph. Its double-stranded DNA genome becomes incorporated in the host DNA. (b) After a period of latency, the virus can reactivate in the form of shingles, usually manifesting as a painful, localized rash on one side of the body. (credit a: modification of work by Erskine Palmer and B.G. Partin—scale-bar data from Matt Russell; credit b: Paulo O / Flickr (CC-BY))
{{< /mediafigure >}}
...
{{< multiplechoice
  question="In what two ways can a virus manage to maintain a persistent infection?"
  answer="By regulating the viral or host gene expressions, or by altering the host immune response."
  hint="Reread the first paragraph of Persistent Infections."
>}}
By undergoing lysis to destroy the host cell and release new virions.
By regulating the viral or host gene expressions, or by altering the host immune response.
By transferring host DNA between bacteria through transduction.
By fusing with the host-cell membrane to release its genome by endocytosis or membrane fusion.
{{< /multiplechoice >}}
...
{{< selfcheck question="What is the structure and genome of a typical plant virus?" hint="Reread the first paragraph of Life Cycle of Viruses with Plant Hosts." >}}
Plant viruses may be enveloped or non-enveloped, and, like many animal viruses, can have either a DNA or an RNA genome that is single stranded or double stranded. However, most plant viruses do not have a DNA genome; the majority have a +ssRNA genome, which acts like messenger RNA (mRNA).
===CHECKS===
plant viruses may be enveloped or non-enveloped
can have either a DNA or an RNA genome that is single stranded or double stranded
most plant viruses do not have a DNA genome
the majority have a +ssRNA genome, which acts like messenger RNA (mRNA)
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_06_02_growth" alt="A line graph of the logarithm of the number of infectious virions on the y-axis against hours on the x-axis. The line starts low on the axis, dips further through a labelled inoculation point, flattens through a labelled eclipse period, then rises steeply through a labelled burst point before leveling off at a labelled burst-size plateau." longdesc="The curve carries four labelled call-outs in order: 1. Inoculation — the inoculum of virus binds to cells. 2. Eclipse — virions penetrate the cells. 3. Burst — host cells release many viral particles. 4. Burst size — the number of virions released per bacterium." kind="diagram" >}}
...
{{< selfcheck question="What aspect of the life cycle of a virus leads to the sudden increase in the growth curve?" hint="Look at the third step of the one-step multiplication curve described under the figure above." >}}
The burst, when sufficient numbers of new virions are produced and emerge from the host cell, produces the sudden increase; the burst size is the maximum number of virions produced per bacterium.
===CHECKS===
sufficient numbers of new virions are produced and emerge from the host cell
the burst size is the maximum number of virions produced per bacterium
{{< /selfcheck >}}

{{< callout type="info" >}}
**Eye on Ethics.** *Unregistered Treatments*
...
{{< mediafigure src="microbiology/OSC_Microbio_06_02_hazmat" alt="A photograph of two researchers fully covered in white biohazard suits with hoods and face coverings, working with laboratory samples inside a ventilated hood." kind="photo" >}}
Researchers working with Ebola virus use layers of defenses against accidental infection, including protective clothing, breathing systems, and negative air-pressure cabinets for bench work. (credit: modification of work by Randal J. Schoepp)
{{< /mediafigure >}}
{{< /callout >}}
...
For additional information about Ebola, please visit the [CDC](https://www.openstax.org/l/22ebolacdc) website.
{{< /callout >}}
...
{{< multiplechoice
  question="Which of the following leads to the destruction of the host cells?"
  answer="lytic cycle"
  hint="Reread the first sentence of the first subsection of The Life Cycle of Viruses with Prokaryote Hosts."
>}}
lysogenic cycle
lytic cycle
prophage
...
{{< textin
  question="For lytic viruses, ________ is a phase during a viral growth curve when the virus is not detected."
  answer="eclipse"
  accept="eclipse phase|eclipse period"
  hint="Reread the Viral Growth Curve paragraph."
>}}

{{< sortbins question="Sort each description under the phage life cycle it describes." hint="Reread the two subsections of The Life Cycle of Viruses with Prokaryote Hosts." >}}
{"bins": ["Lytic cycle", "Lysogenic cycle"],
 "items": [
  {"label": "The bacteriophage takes over the cell, reproduces new phages, and destroys the cell.", "bin": 0},
  {"label": "The integrated phage genome persists in the host chromosome until induction triggers its excision.", "bin": 1},
  {"label": "The host cell is destroyed by lysis, releasing progeny viruses.", "bin": 0},
  {"label": "A temperate phage can become part of a host chromosome and be replicated with the cell genome.", "bin": 1},
  {"label": "A virulent phage leads to the death of the host cell through cell lysis.", "bin": 0},
...
{{< selfcheck question="Label the five stages of a bacteriophage infection in the figure above." hint="Match each panel's drawn process to the five stage names the Lytic Cycle subsection lists in order." >}}
Panel A shows attachment, when the phage interacts with the bacterial surface receptors. Panel B shows penetration, when the tail sheath contracts and injects the viral genome into the host cell. Panel C shows biosynthesis, when the phage DNA replicates and phage proteins are made. Panel D shows maturation, when the new phage particles are assembled. Panel E shows lysis (release), when the host cell wall is disrupted and the progeny viruses are liberated into the environment.
===CHECKS===
Panel A shows attachment
Panel B shows penetration
Panel C shows biosynthesis
Panel D shows maturation
Panel E shows lysis (release)
{{< /selfcheck >}}

{{< selfcheck question="Bacteriophages have lytic and lysogenic cycles. Discuss the advantages and disadvantages for the phage." hint="Reread The Lytic Cycle and The Lysogenic Cycle subsections." >}}
In the lytic cycle, the bacteriophage takes over the cell and reproduces new phages, but it destroys the cell in the process. In the lysogenic cycle, instead of killing the host, the phage genome integrates into the bacterial chromosome and becomes part of the host; as the bacterium replicates its chromosome, it also replicates the phage's DNA and passes it on to new daughter cells. The integrated phage genome persists in the host chromosome until induction, after which the temperate phage can proceed through a lytic cycle.
===CHECKS===
the bacteriophage takes over the cell and reproduces new phages
it destroys the cell in the process
the phage genome integrates into the bacterial chromosome and becomes part of the host
it also replicates the phage's DNA and passes it on to new daughter cells
persists in the host chromosome until induction
{{< /selfcheck >}}
...
{{< multiplechoice
  ...
  answer="release"
  hint="Reread the influenza figure's caption in Life Cycle of Viruses with Animal Hosts."
>}}
attachment
penetration
assembly
...
{{< multiplechoice
  question="A positive-strand RNA virus:"
  answer="can be used directly to translate viral proteins."
  hint="Compare how host ribosomes treat +ssRNA versus −ssRNA."
>}}
...
{{< sortbins question="Sort each description under the type of virus that enters a cell this way." hint="Reread the penetration sentences in the first subsection of The Life Cycle of Viruses with Prokaryote Hosts and in Life Cycle of Viruses with Animal Hosts." >}}
{"bins": ["Bacteriophages", "Animal viruses"],
 "items": [
  {"label": "Tail-sheath contraction acts like a hypodermic needle, injecting the genome through the cell wall and membrane.", "bin": 0},
  {"label": "The cell engulfs the particle by endocytosis.", "bin": 1},
  {"label": "The head and remaining components stay outside the cell after the genome is injected.", "bin": 0},
  {"label": "The envelope fuses directly with the host-cell membrane.", "bin": 1}]}
{{< /sortbins >}}

### Describe unique characteristics of retroviruses and latent viruses

{{< textin
  question="An enzyme from HIV that can make a copy of DNA from RNA is called ________."
  answer="reverse transcriptase"
  hint="Reread the retrovirus paragraph in Life Cycle of Viruses with Animal Hosts."
>}}

{{< textin
  question="A virus capable of remaining hidden or dormant inside a cell, which may initially cause an acute infection before becoming inactive, is called a ________ virus."
  answer="latent"
  hint="Reread the first paragraph of the first subsection of Persistent Infections."
>}}

{{< multiplechoice
  question="Which of the following components is brought into a cell by HIV?"
  answer="reverse transcriptase"
  hint="Reread the retrovirus paragraph in Life Cycle of Viruses with Animal Hosts."
>}}
...
{{< selfcheck question="How does reverse transcriptase aid a retrovirus in establishing a chronic infection?" hint="Reread the retrovirus paragraph in Life Cycle of Viruses with Animal Hosts." >}}
Reverse transcriptase, carried within the capsid, synthesizes a complementary ssDNA (cDNA) copy of the retrovirus's +ssRNA genome. This ssDNA is then made into dsDNA, which integrates into the host chromosome as a provirus. Because the provirus becomes a permanent part of the host and does not undergo excision once it splices into the genome, the virus can remain in the host for a long time, establishing a chronic infection.
===CHECKS===
synthesizes a complementary ssDNA (cDNA) copy of the retrovirus's +ssRNA genome
this ssDNA is then made into dsDNA
integrates into the host chromosome as a provirus
does not undergo excision once it splices into the genome
the virus can remain in the host for a long time, establishing a chronic infection
{{< /selfcheck >}}

### Discuss human viruses and their virus-host cell interactions

{{< multiplechoice
  question="Which virus does this section give as an example of tropism for the tissues of the brain and spinal cord?"
  answer="poliovirus"
  hint="Reread the first paragraph of Life Cycle of Viruses with Animal Hosts."
>}}
influenza virus
HIV
poliovirus
...
{{< multiplechoice
  question="According to the Ebola case discussed in this section, once an infected individual begins exhibiting symptoms, the disease becomes very ________."
  answer="contagious"
  hint="Reread the third paragraph of the Case in Point box."
>}}
contagious
chronic
dormant
...
{{< textin
  question="Whereas chickenpox affects many areas throughout the body, ________ is a nerve cell-specific disease emerging from the ganglia in which the virus was dormant."
  answer="shingles"
  hint="Reread the varicella-zoster paragraph in the first subsection of Persistent Infections."
>}}

### Explain the process of transduction

{{< multiplechoice
  question="What is the name for the transfer of genetic information from one bacterium to another bacterium by a phage?"
  answer="transduction"
  hint="Reread the first sentence after the first Check Your Understanding box."
>}}
transduction
penetration
excision
...
{{< textin
  question="In transduction, the asexual transfer of genetic information can allow for DNA ________ to occur, thus providing the new host with new genes."
  answer="recombination"
  hint="Reread the Transduction paragraph."
>}}

{{< sortbins question="Sort each description under the type of transduction it describes." hint="Reread the Transduction paragraph's sentences that define each form." >}}
{"bins": ["Generalized transduction", "Specialized transduction"],
 "items": [
  {"label": "A random piece of bacterial chromosomal DNA is transferred by the phage.", "bin": 0},
  {"label": "During excision from the host chromosome, the phage occasionally removes some bacterial DNA near the site of viral integration.", "bin": 1},
  {"label": "Packaging occasionally makes a mistake and packs a random piece of host DNA into the capsid instead of viral DNA.", "bin": 0},
  {"label": "The DNA transferred is not randomly packaged but is a specific piece of DNA near the site of integration.", "bin": 1}]}
{{< /sortbins >}}

### Describe the replication process of plant viruses

{{< textin
  question="Viruses that infect plants are considered ________ parasites, meaning they can establish an infection without killing the host, similar to what is observed in the lysogenic life cycles of bacteriophages."
  answer="biotrophic"
  hint="Use the one-word term the plant-virus paragraph applies to these parasites."
>}}

{{< textin
  question="The ________ infects only a few plants of the Citrus genus, whereas the cucumber mosaic virus infects thousands of plants of various plant families."
  answer="citrus tristeza virus"
  accept="citrus tristeza"
  hint="Reread the second paragraph of Life Cycle of Viruses with Plant Hosts."
>}}

{{< textin
  question="To establish a systemic infection, a plant virus must enter a part of the vascular system of the plant, such as the ________."
  answer="phloem"
  hint="Reread the third paragraph of Life Cycle of Viruses with Plant Hosts."
>}}

{{< selfcheck question="Discuss some methods by which plant viruses are transmitted from a diseased plant to a healthy one." hint="Reread the second paragraph of Life Cycle of Viruses with Plant Hosts." >}}
Most plant viruses are transmitted by contact between plants, or by fungi, nematodes, insects, or other arthropods that act as mechanical vectors, though some viruses can be transferred only by a specific insect vector, such as aphids but not whiteflies. In some cases, viruses may also enter healthy plants through wounds, as might occur due to pruning or weather damage.
===CHECKS===
transmitted by contact between plants, or by fungi, nematodes, insects, or other arthropods that act as mechanical vectors
some viruses can be transferred only by a specific insect vector, such as aphids but not whiteflies
viruses may also enter healthy plants through wounds, as might occur due to pruning or weather damage
{{< /selfcheck >}}

---

<small>This section is adapted from [Microbiology, Section 6.2: The Viral Life Cycle](https://openstax.org/books/microbiology/pages/6-2-the-viral-life-cycle) by Nina Parker, Mark Schneegurt, Anh-Hue Thi Tu, Philip Lister, Brian M. Forster, and OpenStax, © OpenStax, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). Access the original for free at [openstax.org](https://openstax.org/details/books/microbiology). Changes: all nine source figures and the bare Critical Thinking exercise media re-encoded as WebP and rendered as mediafigures after image and PDF inspection, with explicit `kind` set from the artwork (the eight drawn process figures — seven source figures and the Critical Thinking media — set `kind="diagram"`, overriding the manifest's JPEG-driven "photo" guess; the two-panel latency figure and the hazmat photograph set `kind="photo"`, overriding the manifest's "diagram" guess for the former); alts rewritten from the source's incomplete or garbled alts (the transduction alt's missing space in "excisionwhen," the HIV alt's "reverse transtriptase," the growth-curve alt's "the grap his," and the latency alt's "a a shpere" are not reproduced); `longdesc` added to every process/life-cycle figure and the growth curve, walking each numbered or lettered stage in order; the Link to Learning and Eye on Ethics/Case in Point boxes rendered as callouts, the Case in Point kept in its source order (its closing questions, then its figure) with its two closing questions left unanswered as plain bullets; the WHO footnote rendered as an inline parenthetical citation with its bare access URL dropped and its printed date "March 18, 2005" corrected to "March 18, 2015" with a visible Source note (the linked URL itself encodes 20150318, and the citation supports an event from 2014) — a source defect; the animal-virus replication figure's source alt calls the new particles "phage" particles, which the page's alt does not repeat; the malformed binomial "V. cholera" corrected to "V. cholerae" to match the same paragraph's own "Vibrio cholerae" three sentences earlier — a suspected source defect; the latency figure's credit line's unbalanced parenthesis closed to match its "(credit a: …; credit b: … (CC-BY))" structure; all eight source figure cross-references rendered as "(see the figure below)"; the Critical Thinking exercise "Label the five stages of a bacteriophage infection in the figure" (fs-id1168326822762) kept its bare media as a Practice mediafigure, with an author-written caption describing the panels (the source prints none) and its own source problem text moved into the self-check's question; it stays a self-check because honestly labelling all five panels needs five separate keys, which neither a single-answer multiplechoice nor a 4-bin sortbins can hold; all six body Check Your Understanding bullets rendered as body items at their note positions — three are graded (multiplechoice) from a single sentence or paired sentence of this module, and three stay self-checks — "Is a latent phage undetectable in a bacterium?" because the module says only that temperate phages are typically latent or inactive within the cell and never whether they can be detected, "What is the structure and genome of a typical plant virus?" because the honest answer assembles several sentences of one paragraph rather than a single fixed fact, and "What aspect of the life cycle of a virus leads to the sudden increase in the growth curve?" because the growth-curve figure beside it names the burst in its caption; of the section's 14 numbered source exercises, all five Multiple Choice and both Fill in the Blank items are used as printed and keyed from the source; two of the three Short Answer questions ("Differentiate between lytic and lysogenic cycles," "Discuss the difference between generalized and specialized transduction") are graded as `sortbins` from this module's own contrasting sentences (the source prints no key for either), the third ("Briefly explain the difference between the mechanism of entry of a T-even bacteriophage and an animal virus") is graded as a `sortbins` from the penetration paragraphs of the Lytic Cycle and Animal Hosts sections; of the four Critical Thinking questions, the labelling item is a self-check as described above, "Discuss some methods by which plant viruses are transmitted…" stays a self-check because its honest answer is a list of several transmission routes, and the remaining two ("Discuss the advantages and disadvantages…," "How does reverse transcriptase aid a retrovirus…") stay self-checks because their honest answers assemble several module sentences into an explanation; eight author-written items (two multiplechoice items — a select-the-term item on poliovirus's brain-and-spinal-cord tropism from the animal-host paragraph and a cloze on Ebola becoming contagious from the Case in Point — three term-recall `textin`s from `## Key terms` or a body sentence, one cloze `textin` on DNA recombination from the Transduction paragraph — it replaced a prophage term-recall, because the source lytic-cycle Multiple Choice prints "prophage" among its options — and one cloze `textin` on biotrophic parasites and one on the phloem, both from the plant-virus life-cycle paragraph) fill out the "retroviruses and latent viruses," "human viruses," "transduction," and "plant viruses" objective groups to the book's three-per-group floor; the Multiple Choice item testing which HIV component is "brought into a cell" (fs-id1168329002208) and the Fill in the Blank item naming that same enzyme (fs-id1168326830123) are both genuine, separately source-keyed items that key the same fact ("reverse transcriptase"); both are kept as printed rather than dropped, since the source itself prints both, and the overlap is disclosed here for the checker; in the retroviruses-and-latent-viruses group that Fill in the Blank item is placed first, ahead of the HIV Multiple Choice item and the reverse-transcriptase Critical Thinking self-check printed before it, because both of those print "reverse transcriptase"; key terms compiled from the module's 29 defined `<term>` elements and the book's Glossary appendix, with `lysogenic conversion` and `phage conversion` merged into one bullet because the module defines both in the same sentence against one appendix entry, for 28 distinct bullets; 1 definition ("positive (+) single-strand (+ssRNA)," which has no appendix entry under that or any near form) is taken from the module's own defining sentence, and the other 27 are glossary-sourced; no source exercise was omitted. The Case in Point's dates for Thomas Eric Duncan's hospital visits are corrected with a visible Source note citing the CDC investigation, per this book's prose claim pass.</small>

...
description: >-
  How viruses are isolated by filtration, cultivated in vivo and in vitro,
  and detected by cytopathic effects, molecular tests, and serological
  assays — adapted from OpenStax Microbiology, Section 6.3.
source_section: "6.3"
weight: 3
---
...
{{< mediafigure src="microbiology/OSC_Microbio_06_03_filters" alt="(a) A grayscale electron micrograph of rod-shaped bacterial cells resting on a punctured membrane filter; the round pores in the membrane are visibly smaller than the bacteria. (b) A diagram of two identical filtration setups, each a syringe of red, blue, and green spheres emptying through a filter into a flask. The left filter is labeled a pore size of 5 µm and its flask collects blue and green spheres, not red; the right filter is labeled a pore size of 200 nm (0.2 µm) and its flask collects only green spheres." kind="diagram" eager="true" >}}
...
lets only the smallest particles, the virions, pass through
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_06_03_egg" alt="(a) A gloved technician injects a tray of intact chicken eggs with a syringe. (b) A labeled cutaway diagram of one egg with three syringe needles inserted at different depths, and labels reading chorioallantoic membrane, amniotic cavity, embryo, albumin, yolk sac, and shell." kind="diagram" longdesc="The cutaway diagram labels, moving from the shell inward: the shell; the albumin surrounding the inner contents; the chorioallantoic membrane, where the first syringe needle is inserted near the shell; the amniotic cavity, which surrounds the embryo and receives the second needle; the yolk sac, a large yellow region that receives the third needle; and the embryo itself, shown connected to the yolk sac and enclosed within the amniotic cavity." >}}
(a) The cells within chicken eggs are used to culture different types of viruses. (b) Viruses can be replicated in various locations within the egg, including the chorioallantoic membrane, the amniotic cavity, and the yolk sac. (credit a: modification of work by "Chung Hoang"/YouTube)
{{< /mediafigure >}}
...
In 2023, the family of Henrietta Lacks settled a historic [lawsuit against Thermo Fisher Scientific](https://www.openstax.org/r/22Lackslawsuit).

{{< mediafigure src="microbiology/OSC_Microbio_06_03_hela" alt="A fluorescence micrograph of several adjoining cells, each containing a large blue-stained round nucleus; near several nuclei is a small cluster of orange ovals, and a dense green fibrous network fills the rest of each cell." kind="photo" >}}
A multiphoton fluorescence image of HeLa cells in culture. Various fluorescent stains have been used to show the DNA (cyan), microtubules (green), and Golgi apparatus (orange). (credit: modification of work by National Institutes of Health)
{{< /mediafigure >}}
{{< /callout >}}
...
Watch this [video on the effects of viruses on cells](https://www.openstax.org/l/22virusesoncell) to learn about the effects of viruses on cells.
{{< /callout >}}
...
The case continues in [Viroids, Virusoids, and Prions](/life-health-sciences/microbiology/06-acellular-pathogens/04-viroids-virusoids-and-prions/). The case began in [Viruses](/life-health-sciences/microbiology/06-acellular-pathogens/01-viruses/).
{{< /callout >}}
...
{{< textin question="Porcelain ________ filters, with pores small enough to let viruses pass through, were used to discover TMV." answer="Chamberland" hint="Name the filter type mentioned in the section's opening sentence, before it was replaced by membrane filters." >}}
...
The virus and erythrocytes agglutinate, producing an even red color throughout the well.
Anything present in the solution that is larger than the virions.
Nucleotide sequences amplified by PCR.
{{< /multiplechoice >}}

{{< multiplechoice
  question="What does viral filtrate serve as a rich source of?"
...
In vivo methods introduce the virus into a developing embryo or a whole host animal
In vitro methods grow the virus in cultured cells, either primary cell cultures or continuous cell lines
Bacteriophages are cultivated by growing them in the presence of a dense bacterial lawn
{{< /selfcheck >}}

{{< selfcheck question="What are some characteristics of the viruses that are similar to a computer virus?" hint="This section never discusses computer viruses directly, so answer only with the biological characteristic it states." >}}
This module does not discuss computer viruses. It does state that a biological virus requires a living host cell for replication and cannot grow or reproduce on its own outside that host.
===CHECKS===
This module does not discuss computer viruses
a biological virus requires a living host cell for replication
cannot grow or reproduce on its own outside that host
{{< /selfcheck >}}

{{< mediafigure src="microbiology/OSC_Microbio_06_03_lawn_img" alt="A Petri dish photograph. A smooth, pale beige surface fills most of the plate, and an arrow labeled (A) points into that smooth area. Scattered across the plate are many small, round, darker spots, and an arrow labeled (B) points to one of them." kind="photo" >}}
A bacteriophage plaque assay plate, with two arrows pointing to different features of the plate. (credit: modification of work by American Society for Microbiology)
{{< /mediafigure >}}

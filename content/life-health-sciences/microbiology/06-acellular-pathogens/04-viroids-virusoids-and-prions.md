...
description: >-
  The distinctive structures of viroids, virusoids, and prions — acellular
  infectious agents that self-propagate without a full viral genome or
  capsid — and the transmissible spongiform encephalopathies prions cause in
  humans and animals — adapted from OpenStax Microbiology, Section 6.4.
source_section: "6.4"
weight: 4
---
...
{{< mediafigure src="microbiology/OSC_Microbio_06_04_CJDbrain" alt="Panel a shows two side-by-side grayscale axial brain scans labeled Normal brain and CJD brain; the CJD brain scan is more uniformly hazy and blurred, with less distinct gray-and-white-matter detail, than the normal brain scan beside it. Panel b shows two stacked micrographs: normal brain tissue, a tight pink-stained cellular pattern, above tissue labeled sponge-like lesions in the brain tissue of a CJD patient, which is dotted with many pale round holes among the pink-stained cells." kind="photo" >}}
...
For more information on the handling of animals and prion-contaminated materials, see the World Health Organization's laboratory biosafety guidelines (who.int).
{{< /callout >}}
...
The case began in [Viruses](/life-health-sciences/microbiology/06-acellular-pathogens/01-viruses/).
{{< /callout >}}
...
{{< multiplechoice
  question="Which of the following is true of prions?"
  answer="They are a rogue form of protein, PrP."
  hint="Compare each option against the paragraph naming the two forms of prion protein and the paragraph on how resistant prions are to destruction."
>}}
...
{{< selfcheck question="Describe the disease symptoms observed in animals infected with prions." hint="Use the paragraph describing what rogue prion protein does to brain tissue once a transmissible spongiform encephalopathy develops." >}}
...
===CHECKS===
the brain tissue becomes sponge-like, killing brain cells and forming holes in the tissue
...
stimulates other endogenous normal prion proteins (PrPc) to become misfolded into more PrPsc

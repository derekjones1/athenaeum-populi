...
{{< mediafigure src="microbiology/OSC_Microbio_02_01_Refraction" alt="Two panels. In (a), a photograph shows a white light beam entering a wedge of transparent material resting on an opaque surface; part of the light reflects off the near face of the wedge while the rest bends and continues through it as a refracted ray. In (b), a diagram shows an incident ray striking a boundary at an angle, splitting into a reflected ray that leaves at an equal angle on the same side of a dashed normal line, and a refracted ray that continues at a different angle into the medium below the boundary." kind="diagram" >}}

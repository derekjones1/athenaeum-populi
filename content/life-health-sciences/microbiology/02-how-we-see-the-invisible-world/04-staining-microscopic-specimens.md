...
description: >-
  How wet mounts, fixation, and staining prepare specimens for light
  microscopy, and how simple, differential, acid-fast, capsule, endospore,
  and flagella stains — along with the very different preparation steps for
  electron and fluorescence microscopy — are used to identify and classify
  microorganisms — adapted from OpenStax Microbiology, Section 2.4.
source_section: "2.4"
weight: 4
---
...
{{< mediafigure src="microbiology/OSC_Microbio_02_04_Fixation" alt="Three photographs of tissue fixation: (a) a glass slide resting on a flat electric slide warmer, (b) a gloved hand holding a slide over a heated metal microincinerator, and (c) a small glass jar of clear liquid holding a piece of pink tissue, labeled Place into fixative (e.g., 10% formalin)." kind="photo" eager="true" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_02_04_StaintablA" alt="Three sample micrographs, one for each row of the simple-stains table: a basic-stain field of purple, thread-like bacterial chains; an acidic-stain field showing a single umbrella-shaped organism stained solid pink; and a negative-stain field of pale, unstained rods on a dark red background." kind="photo" >}}
Sample micrographs for each simple-stain type. (credit "basic stains": modification of work by Centers for Disease Control and Prevention; credit "Acidic stains": modification of work by Roberto Danovaro, Antonio Dell'Anno, Antonio Pusceddu, Cristina Gambi, Iben Heiner, Reinhardt Mobjerg Kristensen; credit "Negative stains": modification of work by Anh-Hue Tu)
{{< /mediafigure >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_02_04_StaintablB" alt="Five sample micrographs, one for each differential stain: purple and pink round cells for the Gram stain; red spiral chains on a blue field for the acid-fast stain; pink rods each holding a green oval for the endospore stain; red rods trailing wavy filaments for the flagella stain; and pale spheres against a dark field for the capsule stain." kind="photo" >}}
Sample micrographs for each differential stain. (credit "Gram stain": modification of work by Nina Parker; credit "Acid-fast stain": modification of work by American Society for Microbiology; credit "Endospore stain": modification of work by American Society for Microbiology; credit "Capsule stain": modification of work by American Society for Microbiology; credit "Flagella stain": modification of work by Centers for Disease Control and Prevention)
{{< /mediafigure >}}
...
{{< selfcheck question="Explain the difference between a positive stain and a negative stain." hint="Think about which part of the sample — the cells or the background — actually absorbs each type of stain." >}}
A positive stain is a dye that will be absorbed by the cells or organisms being observed, adding color to objects of interest to make them stand out against the background. A negative stain is absorbed by the background but not by the cells or organisms in the specimen, producing an outline or silhouette of the organisms against a colorful background.
===CHECKS===
absorbed by the cells or organisms being observed, adding color to objects of interest
absorbed by the background but not by the cells or organisms in the specimen
...
The case began in [The Properties of Light](/life-health-sciences/microbiology/02-how-we-see-the-invisible-world/01-the-properties-of-light/), continued in [Instruments of Microscopy](/life-health-sciences/microbiology/02-how-we-see-the-invisible-world/03-instruments-of-microscopy/), and continues in the Resolution below.
{{< /callout >}}

{{< mediafigure src="microbiology/OSC_Microbio_02_04_StaphGram" alt="A micrograph showing dense, irregular clusters of small purple spherical cells." kind="photo" >}}
...
{{< selfcheck question="Why are acid-fast stains useful?" hint="Think about the two things this staining approach can reveal: what's in the cell wall, and whether a diagnostically important organism is present." >}}
Acid-fast stains are useful because they can differentiate two types of gram-positive cells — those with waxy mycolic acids in their cell walls and those without — and because a number of specific diseases are caused by acid-fast bacteria, so if these bacteria are present in a tissue sample, their red or pink color can be seen clearly against the blue background of the surrounding tissue cells.
===CHECKS===
differentiate two types of gram-positive cells — those with waxy mycolic acids in their cell walls and those without
a number of specific diseases are caused by acid-fast bacteria
their red or pink color can be seen clearly against the blue background
{{< /selfcheck >}}

{{< callout type="info" >}}
**Micro Connection.** *Using Microscopy to Diagnose Tuberculosis*
...
{{< mediafigure src="microbiology/OSC_Microbio_02_04_Acidfast" alt="A micrograph of red, thread-like curved bacterial chains scattered across a blue-stained background." kind="photo" >}}
Ziehl-Neelsen staining has rendered these *Mycobacterium tuberculosis* cells red and the surrounding growth indicator medium blue. (credit: modification of work by American Society for Microbiology)
{{< /mediafigure >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_02_04_CapsuStain" alt="Two micrographs: (a) round, clear, unstained circular cells surrounded by a dark background. (b) Pink-red rod-shaped cells, each surrounded by a pale bluish halo, against a dark purple background." kind="photo" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_02_04_Endospores" alt="A micrograph of pink rod-shaped bacterial cells, each containing a smaller oval region stained green, labeled by two arrows reading green endospores inside bacterial cells." kind="photo" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_02_04_FlagStain" alt="A micrograph of two red, rod-shaped bacterial cells on a pale pink background, each trailing many thin, wavy, thread-like filaments, with small pink specks scattered between them." kind="photo" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_02_04_Microtome" alt="Two photographs: (a) a bright metal ultramicrotome chuck holding a small pale blue specimen block above a knife. (b) A bare hand adjusting a dial on an ultramicrotome mounted at a lab bench." kind="photo" >}}
...
{{< selfcheck question="Why is it important to dehydrate cells before examining them under an electron microscope?" hint="Think about what has to happen to the specimen — for each type of microscope — before it can be embedded in resin or coated with metal." >}}
For TEM, the ethanol replaces the water in the cells so that the resin, which dissolves in ethanol, can enter the cell and solidify, letting the cell be cut into thin sections. For SEM, critical point drying with inert liquid carbon dioxide under pressure is used to displace the water from the specimen so that it can be sputter-coated with metal, which prevents the specimen from becoming charged by the SEM's electron beam.
===CHECKS===
the ethanol replaces the water in the cells so that the resin ... can enter the cell and solidify
critical point drying ... is used to displace the water from the specimen
...
{{< mediafigure src="microbiology/OSC_Microbio_02_04_IndIrectFl" alt="A labeled diagram showing a blue, curved T. pallidum cell with a black Y-shaped primary antibody attached to its surface. Two green Y-shaped secondary antibodies attach to the primary antibody, each tipped with a yellow starburst fluorochrome." kind="diagram" longdesc="Reading the diagram: the T. pallidum cell (blue) carries an unstained primary antibody (black, Y-shaped) bound to its surface. Two unstained secondary antibodies (green, Y-shaped), each carrying a yellow starburst fluorochrome, bind to the primary antibody, so several fluorescent tags cluster at the one site where the primary antibody attached." >}}
...
Cornell University's and St. Joseph's University's [Case Studies in Microscopy](https://www.openstax.org/l/22cornellstud) offers a series of clinical problems based on real-life events. Each case study walks you through a clinical problem using appropriate techniques in microscopy at each step.
{{< /callout >}}
...
This resolves the case that began in [The Properties of Light](/life-health-sciences/microbiology/02-how-we-see-the-invisible-world/01-the-properties-of-light/).
{{< /callout >}}
...
{{< textin
  question="A chemical added to a specimen to set or stabilize a stain or dye is called a ________."
  answer="mordant"
  hint="This chemical acts on some stains by trapping the primary dye inside thick layers of a cell wall's peptidoglycan."
>}}

{{< selfcheck question="Why doesn't a specimen need to be heat-fixed before capsule staining?" hint="Think about which part of the specimen this technique actually stains, and whether heat-fixing is needed to attach cells that are never directly dyed." >}}
A negative staining technique (staining around the cells) is typically used for capsule staining, and the dye stains the background but does not penetrate the capsules. Because the technique does not rely on the dye entering or attaching to the cells themselves, the specimen does not need to be heat-fixed prior to negative staining.
===CHECKS===
a negative staining technique ... is typically used for capsule staining

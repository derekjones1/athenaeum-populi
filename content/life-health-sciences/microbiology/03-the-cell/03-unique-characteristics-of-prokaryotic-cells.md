...
description: >-
  The structures common to prokaryotic cells — morphology and arrangement,
  the nucleoid, plasmids, 70S ribosomes, inclusions, endospores, the plasma
  membrane and its transport mechanisms, the bacterial cell wall, glycocalyces
  and S-layers, and fimbriae, pili, and flagella — and how bacterial and
  archaeal cells differ — adapted from OpenStax Microbiology, Section 3.3.
source_section: "3.3"
weight: 3
---
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_ProkCell-dd83" alt="A cutaway diagram of a rod-shaped prokaryotic cell. From outside to inside, a thick teal capsule surrounds a thin cell wall and an even thinner plasma membrane. Inside the membrane are cytoplasm dotted with small ribosomes and larger round inclusions, a small looped plasmid, and a long tangled loop of nucleoid DNA. Numerous short fimbriae and a longer pilus project from the surface, and one long flagellum extends from one end." kind="diagram" longdesc="Reading from outside in at the cell's cut edge: a thick teal capsule, a thin cell wall, and a thinner plasma membrane enclose the cytoplasm. Inside, small dots mark ribosomes, larger pale spheres mark inclusions, a small looped strand marks a plasmid, and a long tangled loop marks the nucleoid. Several dozen short bristle-like fimbriae project all over the cell surface (the fimbriae label has two leader lines), a single longer, thinner pilus curves out from near the cut end, and one long flagellum trails from one end of the cell." eager="true" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_ProkTable" alt="A four-column reference table titled Common Prokaryotic Cell Shapes, naming and illustrating six cell shapes: coccus (round), bacillus (rod), vibrio (curved rod), coccobacillus (short rod), spirillum (spiral), and spirochete (long, loose helical spiral). Each row pairs a drawn icon of the shape with a sample micrograph." kind="diagram" longdesc="The table has four columns — Name, Description, Illustration, Image — and six rows. Coccus (plural cocci): round; drawn as a sphere; micrograph shows two round cells, with a 0.2 µm scale bar. Bacillus (plural bacilli): rod; drawn as a rounded rectangle; micrograph shows several elongated rods. Vibrio (plural vibrios): curved rod; drawn as a comma shape; micrograph shows one curved rod. Coccobacillus (plural coccobacilli): short rod; drawn as an oval; micrograph shows many small, short, scattered rods. Spirillum (plural spirilla): spiral; drawn as a gently wavy cell with three shallow bends; micrograph shows several thick, dark blue wavy cells. Spirochete (plural spirochetes): long, loose, helical spiral; drawn as a coiled cell with more and taller turns than the spirillum drawing; micrograph shows a single thin cell with about seven small, regular coils." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_ProkArrang" alt="A three-column reference table titled Common Prokaryotic Cell Arrangements, naming and illustrating nine arrangements of cocci and bacilli: coccus, diplococcus, tetrad, streptococcus, and staphylococcus for round cells, and bacillus, diplobacillus, streptobacillus, and palisade for rod-shaped cells. Each row pairs the name with a drawn icon of the arrangement." kind="diagram" longdesc="Three columns (Name, Description, Illustration) and nine rows, each naming an arrangement, describing it, and showing a drawn icon. Coccus (plural cocci): a single round cell. Diplococcus (plural diplococci): a pair of two cocci joined together. Tetrad (plural tetrads): four cocci arranged in a square. Streptococcus (plural streptococci): a chain of cocci. Staphylococcus (plural staphylococci): a cluster of cocci grouped in a bundle. Bacillus (plural bacilli): a single rod. Diplobacillus (plural diplobacilli): a pair of rods. Streptobacillus (plural streptobacilli): a chain of rods. Palisade (plural palisades): the printed description reads V- or L-shaped formations of rods, but the icon beside it draws six rods standing side by side in a straight parallel row, with no V or L angle." >}}
{{< /mediafigure >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_Tonicity" alt="Three diagrams of a cell without a cell wall in solutions of different solute concentration. (a) In an isotonic solution the cell and surrounding solution both hold 20% solute; water moves into and out of the cell equally, with no change in size. (b) In a hypertonic solution the surroundings hold more solute than the cell; water leaves the cell, which shrivels into a scalloped shape (crenation). (c) In a hypotonic solution the surroundings hold less solute than the cell; water enters the cell, which swells." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_Plasmolysi" alt="Three diagrams of a rectangular cell with a cell wall, in solutions of different solute concentration. (a) Isotonic: the cell membrane lies against the cell wall; water moves in and out equally. (b) Hypertonic: water leaves the cell; the membrane pulls away from the wall at several points, leaving a star-shaped gap (plasmolysis), while the wall keeps its outline. (c) Hypotonic: water enters the cell; the membrane and wall bulge outward slightly, but the wall keeps the cell from swelling further." kind="diagram" >}}
...
{{< multiplechoice
  question="Explain the difference between cell morphology and arrangement."
  answer="Morphology is the shape of an individual cell, while arrangement is the way cells of the same species group together."
  hint="Reread the opening paragraph of Common Cell Morphologies and Arrangements."
>}}
Arrangement is the shape of an individual cell, while morphology is the way cells of the same species group together.
Morphology is the way cells of the same species group together, while arrangement is a cell's ability to withstand changes in osmotic pressure.
Morphology is the shape of an individual cell, while arrangement is the way cells of the same species group together.
Morphology is the process by which a vegetative cell forms an endospore, while arrangement is the shape of an individual cell.
{{< /multiplechoice >}}

{{< selfcheck question="What advantages do cell walls provide prokaryotic cells?" hint="Think about what happens to a cell without a wall in a hypertonic or hypotonic environment, compared with a cell that has one." >}}
...
===CHECKS===
better able to withstand subtle changes in osmotic pressure and maintain their shape
undergo plasmolysis rather than crenation, keeping the cell wall intact
maintain its shape and integrity for a longer time before lysing
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_Nucleoid" alt="A transmission electron micrograph of an oval prokaryotic cell in cross-section. A green dashed line encloses a lighter, less densely stained region occupying roughly a third of the cell's interior, with an arrow labeling it nucleoid." kind="photo" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_Ribosome" alt="A drawing of three blob shapes side by side: a small subunit labeled 30S, a larger subunit labeled 50S roughly twice its size, and the two joined together on the right and bracketed as the complete 70S ribosome." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_IncBodies" alt="Five micrographs under the heading prokaryote inclusion bodies, each with a scale bar. (a) Gray oval cells, each holding two to eight white spheres. (b) Thin chains dotted with dark spots. (c) One large oval cell with a cluster of small white spheres near its lower edge. (d) A section of an oval cell with a pale outer zone and many dark angular bodies in its center. (e) A curved cell with short lines of tiny dark particles along its length, and a magnified inset of one chain of angular dark crystals." kind="photo" longdesc="(a) A transmission electron micrograph (600 nm scale bar) of gray oval cells, each containing two to eight white droplets — polyhydroxybutyrate lipid droplets. (b) A light micrograph (10 µm scale bar) of thin, crossing chains dotted with small dark granules — volutin granules. (c) A phase-contrast micrograph (2 µm scale bar) of one large oval cell with a cluster of small white spheres near its lower edge — sulfur granules. (d) A transmission electron micrograph (2 µm scale bar) of a section through an oval cell, lettered CW at its wall and GV in the pale, finely striated outer zone that surrounds a darker center; the center, lettered N, V, and LD at points, holds many dark angular bodies and a few white holes — the caption identifies gas vacuoles. (e) A transmission electron micrograph (500 nm scale bar) of a curved cell with three short lines of tiny dark particles running along its length; a strip below (50 nm scale bar) magnifies one line into a chain of angular, many-sided dark crystals — magnetosomes." >}}
...
| Nearly all endospore-producing bacteria gram-positive as vegetative cells | Do not absorb Gram stain, only special endospore stains (see [Staining Microscopic Specimens](/life-health-sciences/microbiology/02-how-we-see-the-invisible-world/04-staining-microscopic-specimens/)) |
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_Sporulation" alt="(a) A six-step diagram of sporulation: DNA replicates; membranes form around the DNA; the forespore forms additional membranes; a protective cortex forms; a protein coat forms around the cortex as the outer cell lyses; the endospore is released. (b) An electron micrograph of an endospore showing a dark core inside a lighter region, surrounded by thick outer layers. (c) A micrograph of red-stained rod-shaped cells in chains, many holding a green endospore." kind="diagram" longdesc="Panel (a), six drawn steps: 1, a rod-shaped cell holds two loops of DNA, one central and one near its right end, as the DNA replicates, and the cell membrane has begun to pinch inward between them, near that end. 2, a curved membrane walls off the end of the cell around the DNA loop there. 3, the forespore, now an oval with a double membrane, lies free inside the mother cell. 4, a protective cortex forms, thickening the lines further. 5, a protein coat forms around the cortex, thickening the lines again, and the outer cell begins to lyse. 6, the mature endospore is released as a small layered oval structure: a yellow outer coat around a red membrane ring enclosing the DNA. Panel (b), an electron micrograph shows an oval endospore with a dark central core inside a lighter surrounding region, encased in thick outer layers, which extend to the right as a tail-like strand. Panel (c), a micrograph shows red-stained rod-shaped cells in chains, many holding a small green-stained oval endospore; one leader line labels a red rod vegetative cell and another labels a green oval endospore." >}}
...
{{< multiplechoice
  question="What is an inclusion?"
  answer="A cytoplasmic structure that some prokaryotic cells use to store excess nutrients."
  hint="Reread the opening paragraph of the Inclusions subsection."
>}}
A structure that protects the bacterial genome in a dormant state when environmental conditions are unfavorable.
An organized layer located outside of the cell wall, usually composed of polysaccharides or proteins.
A region of the cell where prokaryotic DNA and DNA-associated proteins are concentrated.
A cytoplasmic structure that some prokaryotic cells use to store excess nutrients.
{{< /multiplechoice >}}

{{< multiplechoice
  question="What is the function of an endospore?"
  answer="To protect the bacterial genome in a dormant state so the cell can survive unfavorable conditions such as lack of food or water, chemicals, extreme temperatures, or radiation."
  hint="Reread the opening paragraph of the Endospores subsection."
>}}
To store excess nutrients, such as glycogen or starches, that the cell can later access for energy.
To protect the bacterial genome in a dormant state so the cell can survive unfavorable conditions such as lack of food or water, chemicals, extreme temperatures, or radiation.
To enable the cell to attach to surfaces and to other cells.
To allow the cell to move through aqueous environments.
{{< /multiplechoice >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_PlasmaMem" alt="A diagram of the plasma membrane as a phospholipid bilayer, each phospholipid drawn as a sphere with two tails, with the tails of the two layers facing each other. A variety of large proteins are embedded in the bilayer: protein channels spanning it with a central pore, peripheral proteins sitting on one face only, and transmembrane proteins spanning the full width. Glycolipids and glycoproteins carry carbohydrate chains, shown as strings of hexagons, that extend from the outer face only. No cytoskeleton is drawn." kind="diagram" longdesc="Labeled top to bottom: outside of cell above the bilayer, cytoplasm below it. The phospholipid bilayer is two layers of sphere-and-two-tail phospholipids, tails facing inward. Embedded proteins include protein channels that span the bilayer with a central pore connecting outside to cytoplasm, peripheral proteins sitting on one face of the bilayer, and transmembrane proteins spanning its full width. Glycolipids (a carbohydrate chain on a single phospholipid) and glycoproteins (a carbohydrate chain on a protein) both carry their carbohydrate chains on the outside of the membrane only; four such chains are drawn, two of them branched. Nothing is drawn below the inner leaflet's heads. The printed labels are only outside of cell, cytoplasm, phospholipid bilayer (a bracket spanning the bilayer's thickness), glycoprotein (one leader line to its carbohydrate chain, one to its protein), and glycolipid (one leader line to its carbohydrate chain, one to its lipid); the channel, peripheral, and transmembrane proteins are drawn but not labeled." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_simplediff" alt="A diagram of simple diffusion across a phospholipid bilayer over time. At left, many hexagon-shaped molecules crowd the extracellular fluid above the bilayer and none appear in the cytoplasm below. At a later point shown toward the middle, a few hexagons have crossed into the cytoplasm. At the latest point shown at right, roughly equal numbers of hexagons appear on both sides of the bilayer." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_facdiff" alt="A diagram of facilitated diffusion across a phospholipid bilayer. Many hexagon-shaped molecules and a few oval molecules are scattered above and below the bilayer, most of the hexagons in the extracellular fluid above; a labeled protein channel spans the bilayer, moving hexagons through its pore into the cytoplasm below." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_Transport" alt="A diagram of active transport across a phospholipid bilayer. Hexagon-shaped sodium ions are more concentrated in the extracellular fluid above the bilayer, and oval-shaped potassium ions are more concentrated in the cytoplasm below. A membrane pump, drawn four times across the bilayer, moves sodium ions out of the cytoplasm and potassium ions into it, both against their concentration gradients, while breaking down ATP into ADP and phosphate at the pump." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_Peptidogly" alt="Two diagrams comparing peptidoglycan structure. In both, chains of alternating blue NAG and orange NAM spheres run diagonally, and a short chain of green beads, the tetrapeptide, hangs from each NAM. In the gram-positive diagram, longer chains of yellow beads labeled pentapeptide join the tetrapeptides of neighboring chains. In the gram-negative diagram there are no pentapeptides; thin lines labeled direct link join the tetrapeptides of neighboring chains instead." kind="diagram" longdesc="Left panel, gram-positive: parallel diagonal chains of alternating spheres; the label NAG (N-acetylglucosamine) has two leader lines to blue spheres and the label NAM (N-acetylmuramic acid) two leader lines to orange spheres. A short vertical chain of green beads hangs from each orange NAM; one is labeled tetrapeptide. Longer chains of yellow beads, one labeled pentapeptide, run across between the glycan chains, each joining a tetrapeptide to tetrapeptides on neighboring chains, so the chains form a cross-linked mesh. Right panel, gram-negative: the same blue NAG and orange NAM chains, labeled the same way, with the same green tetrapeptides hanging from each NAM, but no yellow pentapeptides; instead, thin straight lines, one labeled direct link, run across between neighboring chains through the ends of the tetrapeptides." >}}
...
The Gram staining protocol (see [Staining Microscopic Specimens](/life-health-sciences/microbiology/02-how-we-see-the-invisible-world/04-staining-microscopic-specimens/)) is used to differentiate two common types of cell wall structures (shown below). Gram-positive cells have a cell wall consisting of many layers of peptidoglycan totaling 30–100 nm in thickness. These peptidoglycan layers are commonly embedded with teichoic acids (TAs), carbohydrate chains that extend through and beyond the peptidoglycan layer (Silhavy, Kahne, and Walker, *Cold Spring Harbor Perspectives in Biology* 2, no. 5 [2010]: a000414). TA is thought to stabilize peptidoglycan by increasing its rigidity. TA also plays a role in the ability of pathogenic gram-positive bacteria such as *Streptococcus* to bind to certain proteins on the surface of host cells, enhancing their ability to cause infection. In addition to peptidoglycan and TAs, bacteria of the family Mycobacteriaceae have an external layer of waxy **mycolic acids** in their cell wall; as described in [Staining Microscopic Specimens](/life-health-sciences/microbiology/02-how-we-see-the-invisible-world/04-staining-microscopic-specimens/), these bacteria are referred to as acid-fast, since acid-fast stains must be used to penetrate the mycolic acid layer for purposes of microscopy (shown below).

{{< mediafigure src="microbiology/OSC_Microbio_03_03_CellWalls" alt="Two side-by-side diagrams of bacterial cell wall structure. The gram-positive wall is a thick layer of peptidoglycan sitting above a labeled periplasmic space and the plasma membrane, threaded through by teichoic acid strands. The gram-negative wall shows a plasma membrane, a thin periplasmic space, a thin peptidoglycan layer, and an outer membrane studded with murein lipoprotein, lipid A, O antigen, and porin channels." kind="diagram" longdesc="Left, gram-positive bacteria: cytoplasm at the base, then the plasma membrane (its phospholipid tails labeled fatty acids), then a thin periplasmic space (labeled), then a thick peptidoglycan cell wall built of stacked rectangular units threaded vertically by teichoic acid strands. Right, gram-negative bacteria: cytoplasm, inner (plasma) membrane with embedded membrane proteins and phospholipids, a thin periplasmic space, a thin peptidoglycan cell wall, and an outer membrane; murein lipoprotein anchors the outer membrane to the peptidoglycan, and the outer membrane's outer face carries a pink band labeled lipid A topped by short red strands labeled O antigen, the two together labeled lipopolysaccharide, alongside a porin channel that spans the outer membrane. The labels periplasmic space, peptidoglycan cell wall, plasma membrane, fatty acids, and cytoplasm each have leader lines to both diagrams; the gram-negative plasma membrane is also bracketed as the inner membrane." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_acidfast" alt="(a) A diagram of a gram-positive, acid-fast cell wall: a plasma membrane, a thick peptidoglycan layer threaded by teichoic acid, and an outer layer of mycolic acids, lipomannan, and arabinoglycans. (b) A micrograph of thin red-stained rod-shaped cells scattered on a blue-stained background, labeled acid-fast bacteria." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_LPS" alt="A diagram of a lipopolysaccharide molecule as a vertical chain: a long run of red pentagons, diamonds, and triangles labeled O antigen at the top, a shorter run of blue shapes labeled core below it, and two pink spheres labeled lipid A at the base, with wavy fatty-acid tails hanging from lipid A." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_Capsules" alt="(a) A diagram of a cell's outer structures: a thick outer capsule, a thinner cell wall beneath it, and an even thinner plasma membrane innermost. (b) A micrograph of purple-stained round cells, each surrounded by a clear halo, against a pale lavender background, with one cell and one halo labeled cell and capsule and a 10.0 µm scale bar." kind="diagram" >}}
...
The ability to produce a capsule can contribute to a microbe's pathogenicity (ability to cause disease) because the capsule can make it more difficult for phagocytic cells (such as white blood cells) to engulf and kill the microorganism. *Streptococcus pneumoniae*, for example, produces a capsule that is well known to aid in this bacterium's pathogenicity. As explained in [Staining Microscopic Specimens](/life-health-sciences/microbiology/02-how-we-see-the-invisible-world/04-staining-microscopic-specimens/), capsules are difficult to stain for microscopy; negative staining techniques are typically used.
...
The case continues in [Unique Characteristics of Eukaryotic Cells](/life-health-sciences/microbiology/03-the-cell/04-unique-characteristics-of-eukaryotic-cells/). The case began in [Spontaneous Generation](/life-health-sciences/microbiology/03-the-cell/01-spontaneous-generation/).
{{< /callout >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_FimbrPili" alt="A micrograph of two rod-shaped cells connected to each other and to structures outside the frame by several long, thin, string-like filaments, labeled pili." kind="photo" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_BaFlagella" alt="Two diagrams of the basal body where a bacterial flagellum attaches. In gram-positive bacteria, the filament connects through a junction and hook to a rod anchored by an MS-ring and C-ring in the inner membrane, with a type III secretion protein and stator proteins. In gram-negative bacteria, the same filament, junction, and hook connect through an L-ring in the outer membrane and a P-ring in the cell wall to the same inner-membrane structures, plus the periplasmic space between the two membranes." kind="diagram" longdesc="Both panels enlarge a boxed spot at one end of a small cell drawing (a curved arrow leads from the box to the enlargement) and show a wavy filament ending in a tip, connected through a junction and a bent hook to a rod. In the gram-positive panel, the rod passes through the thick cell wall directly to the structures in the inner membrane: an MS-ring at the rod's base, stator proteins on either side, a central type III secretion protein, and a C-ring beneath; a bracket labels the rod through the C-ring together as the basal body. In the gram-negative panel, the rod passes through an L-ring seated in the outer membrane, then a P-ring seated in the thin cell wall, which lies within the bracketed periplasmic space between the outer and inner membranes, before reaching the same C-ring, type III secretion system, MS-ring, and stator arrangement in the inner membrane." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_FlagellaAr" alt="Four diagrams of bacterial flagellar arrangements: a monotrichous cell with a single flagellum at one end, an amphitrichous cell with a flagellum at each end, a lophotrichous cell with a tuft of flagella at one end, and a peritrichous cell with flagella covering its whole surface." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_RunTumble" alt="Two diagrams contrasting bacterial tumbling and running. In tumbling, several flagella splay outward from the cell while rotating clockwise, and a circular arrow shows the cell moving with no fixed direction. In running, the flagella bundle together on one side while rotating counterclockwise, and a straight arrow shows the cell moving in a line." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_03_03_DirectRand" alt="A diagram of chemotaxis as a sequence of three cell drawings joined by gray arrows: a run, with flagella bundled and rotating counterclockwise, moving the cell in a straight line; a tumble, with flagella separated and rotating clockwise, reorienting it; and a second run in a new direction, whose gray arrow is the longest in the diagram and points toward the label attractant." kind="diagram" longdesc="Reading from the top: a run, labeled bundled flagella (counter-clockwise rotation), shows a cell with its flagella bundled behind it, a black circular arrow around the bundle, and a red arrow showing it moving down and to the right; a gray arrow leads from just ahead of it to the tumble at right, labeled flagella separated (clockwise rotation), where the flagella splay out in all directions and a curved, double-headed red arrow shows the cell turning. A second gray arrow leads down and to the left to a second run, labeled flagella bundled (counter-clockwise rotation), whose red arrow points up and to the left. From just ahead of this cell, the longest gray arrow in the diagram runs up and to the left and ends at the label at upper left: attractant, chemical gradient extends the length of the run. No arrow leads back from the second run to the first, so the diagram is a sequence, not a closed cycle." >}}
...
{{< sortbins question="What is the peptidoglycan layer and how does it differ between gram-positive and gram-negative bacteria?" hint="Reread the Cell Wall subsection's paragraphs on gram-positive and gram-negative cells." >}}
{"bins": ["Gram-positive", "Gram-negative"],
 "items": [
  {"label": "many layers of peptidoglycan totaling 30–100 nm in thickness", "bin": 0},
  {"label": "no more than about 4 nm of peptidoglycan", "bin": 1},
  {"label": "commonly embedded with teichoic acids", "bin": 0},
  {"label": "an outer membrane containing lipopolysaccharide", "bin": 1},
  {"label": "tetrapeptide chains linked by pentaglycine cross-bridges", "bin": 0},
  {"label": "tetrapeptide chains directly cross-linked", "bin": 1}]}
{{< /sortbins >}}

{{< sortbins question="Compare and contrast monotrichous, amphitrichous, lophotrichous, and peritrichous flagella." hint="Think about how many flagella each arrangement has and where on the cell they are located." >}}
{"bins": ["Monotrichous", "Amphitrichous", "Lophotrichous", "Peritrichous"],
 "items": [
  {"label": "a single flagellum, typically located at one end of the cell", "bin": 0},
  {"label": "a flagellum or tuft of flagella at each end of the cell", "bin": 1},
  {"label": "a tuft of flagella at one end of the cell", "bin": 2},
  {"label": "flagella covering the entire surface of the cell", "bin": 3},
  {"label": "the gram-negative bacterium that causes cholera", "bin": 0},
  {"label": "the cause of spirillary rat-bite fever", "bin": 1},
  {"label": "an opportunistic pathogen known for causing swimmer's ear and burn wound infections", "bin": 2},
  {"label": "Escherichia coli", "bin": 3}]}
{{< /sortbins >}}
...
{{< multiplechoice
  question="Which of the following do prokaryotic cells generally lack, in contrast to eukaryotic cells?"
  answer="membrane-bound organelles"
  hint="Reread the fourth paragraph of this section's introduction."
>}}
...
{{< textin
  question="Prokaryotic cells lack a nucleus surrounded by a complex nuclear membrane and generally have a single, circular chromosome located in a ________."
  answer="nucleoid"
  hint="Reread the second paragraph of this section's introduction."
>}}

{{< multiplechoice
  question="Bacteria have 80S ribosomes each composed of a 60S large subunit and a 40S small subunit."
  answer="False"
  hint="Recall the S values given earlier in this section for prokaryotic ribosomes and their subunits, and compare them with the values in this statement."
>}}
True
False
{{< /multiplechoice >}}
...
{{< textin
  question="Prokaryotic cells that are rod-shaped are called ________."
  answer="bacilli"
  accept="bacillus"
  hint="Look through the Name column of the cell-shapes table in Common Cell Morphologies and Arrangements."
>}}

{{< multiplechoice
  question="Which of the following terms refers to a prokaryotic cell that is comma shaped?"
  answer="vibrio"
  hint="Look through the cell-shapes table in Common Cell Morphologies and Arrangements."
>}}
coccus
coccobacilli
vibrio
...
{{< multiplechoice
  question="What is the direction of water flow for a bacterial cell living in a hypotonic environment? How do cell walls help bacteria living in such environments?"
  answer="Water moves into the cell, and the cell wall helps by preventing the cell membrane from expanding to the point of bursting."
  hint="Reread the caption of the figure showing a cell with a cell wall in three different solutions."
>}}
Water moves out of the cell, and the cell wall helps by allowing the membrane to detach from the wall and undergo plasmolysis.
Water moves into the cell, and the cell wall helps by allowing the membrane to detach from the wall and undergo plasmolysis.
Water moves out of the cell, and the cell wall helps by preventing the cell membrane from expanding to the point of bursting.
Water moves into the cell, and the cell wall helps by preventing the cell membrane from expanding to the point of bursting.
{{< /multiplechoice >}}

{{< mediafigure src="microbiology/OSC_Microbio_03_03_ExStaph_img" alt="Four scanning electron micrographs labeled A through D. (A) Rod-shaped cells grouped in an irregular cluster. (B) Individual elongated rod-shaped cells scattered separately. (C) Round cells joined together in a single chain. (D) Round cells grouped together in a dense cluster." kind="photo" >}}
...
{{< multiplechoice
  question="Which of the slides above is a good example of staphylococci?"
  answer="D"
  hint="Compare the four micrographs with the cell-arrangements table earlier in this section."
>}}
A
B
C
...
{{< multiplechoice
  question="Which of the following cell wall components is unique to gram-negative cells?"
  answer="lipopolysaccharide"
  hint="Reread the Cell Wall subsection's paragraph on gram-negative cells."
>}}
lipopolysaccharide
teichoic acid
mycolic acid
...
{{< multiplechoice
  ...
  hint="Reread the Flagella subsection's paragraph on flagellar arrangements."
>}}
monotrichous
amphitrichous
peritrichous
...
{{< multiplechoice
  question="Bacterial cell walls are primarily composed of which of the following?"
  answer="peptidoglycan"
  hint="Reread the opening paragraphs of the Cell Wall subsection."
>}}
phospholipid
protein
carbohydrate
...
{{< sortbins question="Sort each structure by whether it is one the section names as important for a bacterial cell's adherence to surfaces." hint="Reread what this section says each of these structures is used for." >}}
{"bins": ["Aids adherence to surfaces", "Does not aid adherence to surfaces"],
 "items": [
  {"label": "fimbriae", "bin": 0},
  {"label": "endospores", "bin": 1},
  {"label": "capsules", "bin": 0},
  {"label": "cell walls", "bin": 1},
  {"label": "flagella", "bin": 1}]}
{{< /sortbins >}}

{{< textin
  question="The type of inclusion containing polymerized inorganic phosphate is called ________."
  answer="volutin"
  accept="metachromatic granule|volutin granule"
  hint="Reread the opening paragraph of the Inclusions subsection."
>}}

{{< multiplechoice
  question="How do bacterial flagella respond to a chemical gradient of an attractant to move toward a higher concentration of the chemical?"
  answer="They increase the length of runs and decrease the length of tumbles."
  hint="Think about how the balance between straight-line movement and reorienting movement changes when an attractant is present."
>}}
They increase the length of runs and decrease the length of tumbles.
They decrease the length of runs and increase the length of tumbles.
They increase both the length of runs and the length of tumbles.
They decrease both the length of runs and the length of tumbles.
{{< /multiplechoice >}}

{{< mediafigure src="microbiology/OSC_Microbio_03_03_PartsProk_img" alt="A cutaway diagram of a rod-shaped prokaryotic cell like the one earlier in this section, but with its structures marked by unlabeled letters A through F instead of names. Short projections at the surface are marked A, small dots inside the cytoplasm are marked B, a long tangled loop is marked C, a long projection extending from the cell is marked D, and two thin layers at the cell's cut edge are marked E and F. The thick outer layer at the edge is not marked." kind="diagram" longdesc="Reading the cutaway from outside in: the thick outer layer is unlabeled. The next layer in, thinner, is marked E. An even thinner layer inside that is marked F. Inside the cell, small dots are marked B, and a long tangled loop is marked C. On the outside of the cell, short projections are marked A, and one long projection is marked D." >}}
A cutaway diagram of a prokaryotic cell with six structures marked by letters instead of names.
{{< /mediafigure >}}

{{< selfcheck question="Label the parts of the prokaryotic cell in the figure above." hint="Compare the position of each letter with the fully labeled cutaway diagram near the beginning of this section." >}}
...
===CHECKS===
A labels the fimbriae
B labels the ribosomes
C labels the nucleoid
D labels the flagellum
E labels the cell wall, and F labels the plasma membrane
{{< /selfcheck >}}

{{< selfcheck question="Provide some examples of bacterial structures that might be used as antibiotic targets and explain why." hint="Think about the structure this section names as a common antibiotic target, and why interfering with it weakens the cell." >}}
...
===CHECKS===
peptidoglycan ... is a common antibiotic target
because peptidoglycan is unique to bacteria, many antibiotic drugs are designed to interfere with its synthesis
making bacterial cells more susceptible to the effects of osmotic pressure
{{< /selfcheck >}}

{{< selfcheck question="The causative agent of botulism, a deadly form of food poisoning, is an endospore-forming bacterium called *Clostridium botulinum*. Why might it be difficult to kill this bacterium in contaminated food?" hint="Think about the dormant structure this species can form, and how long such structures can persist and what conditions they can survive." >}}

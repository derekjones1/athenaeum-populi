...
description: >-
  Chemical and enzymatic mediators in body fluids, antimicrobial peptides,
  plasma protein mediators including the complement system and cytokines,
  and inflammation-eliciting mediators — adapted from OpenStax Microbiology,
  Section 17.2.
source_section: "17.2"
weight: 2
---
...
Fluids produced by the skin include examples of both endogenous and exogenous mediators. Sebaceous glands in the dermis secrete an oil called sebum that is released onto the skin surface through hair follicles. This sebum is an endogenous mediator, providing an additional layer of defense by helping seal off the pore of the hair follicle, preventing bacteria on the skin's surface from invading sweat glands and surrounding tissue. Certain members of the microbiome, such as the bacterium *Cutibacterium acnes* and the fungus *Malassezia*, among others, can use lipase enzymes to degrade sebum, using it as a food source. This produces oleic acid, which creates a mildly acidic environment on the surface of the skin that is inhospitable to many pathogenic microbes. Oleic acid is an example of an exogenously produced mediator because it is produced by resident microbes and not directly by body cells.

{{< mediafigure src="microbiology/OSC_Microbio_17_03_Sebum" alt="A micrograph and diagram both show a large hair follicle (a vase-shaped pocket) with a hair projecting out past the epidermis. On the side of the hair follicle is the sebaceous gland, which is a lumpy structure." kind="diagram" eager="true" >}}
...
Both endogenous and exogenous mediators are produced by human body cells, but at different body sites.
...
Because AMPs act broadly against many different types of microbes rather than targeting one specific pathogen.
Because AMPs are produced exclusively by phagocytic cells such as macrophages and neutrophils.
{{< /multiplechoice >}}
...
{{< callout type="info" >}}
**Micro Connection.** *Plasma versus Serum*
...
| Serum amyloid A | Coats bacteria (opsonization), preparing them for ingestion by phagocytes |
| Ferritin | Bind and sequester iron, thereby inhibiting the growth of pathogens |
| Transferrin | Bind and sequester iron, thereby inhibiting the growth of pathogens |
...
{{< mediafigure src="microbiology/OSC_Microbio_17_01_Cytokine" alt="A three-panel diagram titled Cytokines: Molecular Messengers, comparing autocrine, paracrine, and endocrine signaling. In autocrine signaling, a cell secretes cytokines that bind receptors on its own surface. In paracrine signaling, a secreting cell's cytokines bind receptors on a nearby responding cell. In endocrine signaling, cytokines enter a blood vessel and bind receptors on a distant responding cell." longdesc="Autocrine panel: a single cell releases cytokines that curve back and bind receptors on that same cell's own surface. Paracrine panel: a secreting cell releases cytokines that travel down through two arrows to bind receptors on a nearby responding cell below it. Endocrine panel: a secreting cell releases cytokines into a blood vessel; the cytokines travel along the vessel and then bind receptors on a distant responding cell." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_17_03_Interferon" alt="A cell with viruses inside it releases signals labeled interferons. The interferons travel to 3 different cells. The interferon signals neighboring uninfected cells to destroy RNA and reduce protein synthesis. The interferon signals neighboring infected cells to undergo apoptosis. The interferon also activates immune cells." kind="diagram" >}}
...
{"bins": ["Autocrine", "Paracrine", "Endocrine"],
 "items": [
  ...
  {"label": "Cytokines are released to stimulate a nearby cell", "bin": 1},
  {"label": "Cytokines travel through the bloodstream to reach a distant cell", "bin": 2},
  {"label": "A cell stimulates itself with its own released cytokine", "bin": 0},
  {"label": "A nearby cell responds to cytokines released by an adjacent cell", "bin": 1},
...
prostaglandins promote inflammation and can raise body temperature to cause fever
bradykinin increases vascular permeability and contributes to edema
{{< /selfcheck >}}
...
The case continues in [Cellular Defenses](/life-health-sciences/microbiology/17-innate-nonspecific-host-defenses/03-cellular-defenses/). The case began in [Physical Defenses](/life-health-sciences/microbiology/17-innate-nonspecific-host-defenses/01-physical-defenses/).
{{< /callout >}}

The table below provides a summary of the chemical defenses discussed in this section.

**Chemical Defenses of Nonspecific Innate Immunity**

| Defense | Example | Function |
|---|---|---|
...
| **Cytokines** | | |
| | Interleukins | Stimulate and modulate most functions of immune system |
...
{"bins": ["Opsonization", "Iron sequestration", "Clot formation", "Complement activation"],
 "items": [
  ...
  {"label": "Ferritin", "bin": 1},
  {"label": "Fibrinogen", "bin": 2},
  {"label": "Mannose-binding lectin", "bin": 3},
  {"label": "Serum amyloid A", "bin": 0},
  {"label": "Transferrin", "bin": 1}]}
{{< /sortbins >}}
...
the alternative pathway is initiated by the spontaneous activation of the complement protein C3, whose hydrolysis produces C3a and C3b
the lectin pathway is triggered by the binding of mannose-binding lectin to carbohydrates on the microbial surface
{{< /selfcheck >}}
...
Opsonization, antibody production, chemotaxis, and cytolysis
Vasodilation, inflammation, chemotaxis, and cytolysis
{{< /multiplechoice >}}

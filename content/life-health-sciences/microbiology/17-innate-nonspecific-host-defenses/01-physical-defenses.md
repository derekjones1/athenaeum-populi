...
{{< mediafigure src="microbiology/OSC_Microbio_17_02_Junction" alt="Tight junctions – two membranes connected with many spot welds in multiple lines. Desmosomes – two membranes with long strands weaving them together. Gap junctions – two membranes with a few spot welds each of which has a pore in the center." kind="diagram" eager="true" >}}

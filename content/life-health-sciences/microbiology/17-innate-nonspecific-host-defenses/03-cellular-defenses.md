...
{{< selfcheck question="Describe the granules and nuclei of neutrophils, eosinophils, basophils, and mast cells." hint="Give each cell type's nucleus shape first, then its granule color, working through the four in the order the module introduces them." >}}
...
{{< selfcheck question="Describe the signals that activate natural killer cells." hint="Name the inhibitory signal that normally prevents killing, then the activating signal that overrides it." >}}
...
{{< selfcheck question="What is the difference between monocytes and macrophages?" hint="One of these two names is used only after the cell has left the bloodstream and taken up residence in a tissue." >}}
...
{{< multiplechoice
  ...
  answer="leukocytes"
  hint="This module's opening paragraph gives this term as the third of three names for the formed elements of blood."
>}}
platelets
erythrocytes
leukocytes
...
{{< multiplechoice
  ...
  hint="This is the lymphocyte of the four options — the other three are a granulocyte, a monocyte-derived phagocyte, and another granulocyte."
>}}
natural killer cell
basophil
macrophage
...
{{< textin
  ...
  answer="mast cells"
  hint="This cell type is one of the module's defined terms and appears in the hematopoiesis flowchart, branching from the myeloid stem cell line."
>}}

{{< selfcheck question="Neutrophils can sometimes kill human cells along with pathogens when they release the toxic contents of their granules into the surrounding tissue. Likewise, natural killer cells target human cells for destruction. Explain why it is advantageous for the immune system to have cells that can kill human cells as well as pathogens." hint="Think about what NK cells' targets have in common, and what happens to neutrophils' collateral damage afterward." >}}
Natural killer cells specifically target the body's own cells once those cells have become abnormal in some way — for example, infected with a virus or cancerous — so their ability to kill human cells lets the immune system eliminate a threat hiding inside a human cell, which a defense aimed only at extracellular pathogens could not reach. In the case of neutrophils, the toxic proteins released during degranulation and in neutrophil extracellular traps may kill some of the body's own cells along with invading pathogens, but this collateral damage can be repaired after the danger of the infection has been eliminated.
===CHECKS===
natural killer cells specifically target the body's own cells once those cells have become abnormal in some way
infected with a virus or cancerous

...
description: >-
  The formed elements of blood and how they arise from hematopoietic stem
  cells, the granulocytes (neutrophils, eosinophils, basophils) and mast
  cells, natural killer cells and their perforin/granzyme killing
  mechanism, and monocytes and their differentiation into macrophages and
  dendritic cells — adapted from OpenStax Microbiology, Section 17.3.
source_section: "17.3"
weight: 3
---
...
All of the formed elements of blood are derived from multipotent hematopoietic stem cells (HSCs) in the bone marrow. As the HSCs make copies of themselves in the bone marrow, individual cells receive different cues from the body that control how they develop and mature. As a result, the HSCs differentiate into different types of blood cells that, once mature, circulate in peripheral blood. This process of differentiation, called **hematopoiesis**, is shown in more detail in the figure below.
...
| Formed Element | Major Subtypes | Numbers per µL (Range) | Appearance in a Standard Blood Smear | Summary of Functions | Comments |
|---|---|---|---|---|---|
| Erythrocytes (red blood cells) | — | 5.2 million (4.4–6.0 million) | Flattened biconcave disk; no nucleus; pale red | Transport oxygen and some carbon dioxide between tissue and lungs | Lifespan of approximately 120 days |
| Leukocytes (white blood cells) | — | 7,000 (5,000–10,000) | Obvious dark-staining nucleus | All function in body defenses | Exit capillaries and move into tissues; lifespan of usually a few hours or days |
| — Granulocytes (neutrophils, eosinophils, basophils) | Total leukocytes (%) | 4,360 (1,800–9,950) | Abundant granules in cytoplasm; nucleus normally lobed | Nonspecific (innate) resistance to disease | Classified according to membrane-bound granules in cytoplasm |
| —— Neutrophils | 50–70% | 4,150 (1,800–7,300) | Nucleus lobes increase with age; pale lilac granules | Phagocytic; particularly effective against bacteria; release cytotoxic chemicals from granules | Most common leukocyte; lifespan of minutes to days |
| —— Eosinophils | 1–3% | 165 (0–700) | Nucleus generally two-lobed; bright red-orange granules | Phagocytic cells; particularly active with antigen-antibody complexes; release degradative enzymes, toxic proteins, and antihistamines; combat parasitic infections | Lifespan of minutes to days |
| —— Basophils | <1% | 44 (0–150) | Nucleus generally two-lobed but difficult to see due to presence of heavy, dense, dark purple granules | Pro-inflammatory | Least common leukocyte; lifespan unknown |
| — Agranulocytes (lymphocytes and monocytes) | — | 2,640 (1,700–4,950) | Lack abundant granules in cytoplasm; have a simple-shaped nucleus that may be indented | Body defenses | Group consists of two major cell types from different lineages |
| —— Lymphocytes | 20–40% | 2,185 (1,500–4,000) | Spherical cells with a single, often large, nucleus occupying much of the cell's volume; stains purple; seen in large (natural killer cells) and small (B and T cells) variants | Primarily specific (adaptive) immunity: T cells directly attack other cells (cellular immunity); B cells release antibodies (humoral immunity); natural killer cells are similar to T cells but nonspecific | Initial cells originate in bone marrow, but secondary production occurs in lymphatic tissue; several distinct subtypes; memory cells form after exposure to a pathogen and rapidly increase responses to subsequent exposure; lifespan of many years |
| —— Monocytes | 1–6% | 455 (200–950) | Largest leukocyte; has an indented or horseshoe-shaped nucleus | Very effective phagocytic cells engulfing pathogens or worn-out cells; also serve as antigen presenting cells (APCs) or other components of the immune system | Produced in red bone marrow; referred to as macrophages and dendritic cells after leaving circulation |
| Platelets | — | 350,000 (150,000–500,000) | Cellular fragments surrounded by a plasma membrane and containing granules; stains purple | Hemostasis; release growth factors for repair and healing of tissue | Formed from megakaryocytes that remain in the red bone marrow and shed platelets into circulation |

{{< mediafigure src="microbiology/OSC_Microbio_17_05_FormElem" kind="diagram" alt="A six-column table of the formed elements of blood, headed Formed Element, Major Subtypes, Numbers Present per Microliter and Mean (Range), Appearance in a Standard Blood Smear, Summary of Functions, and Comments. Each row carries a small illustrated icon of the cell beside its name — erythrocytes and each leukocyte subtype (neutrophils, eosinophils, basophils, lymphocytes, monocytes) and platelets are each shown as a stylized, colored cell rendering matching its described appearance." >}}
Formed elements of blood include erythrocytes (red blood cells), leukocytes (white blood cells), and platelets.
{{< /mediafigure >}}

## Granulocytes

The various types of granulocytes can be distinguished from one another in a blood smear by the appearance of their nuclei and the contents of their granules, which confer different traits, functions, and staining properties. The **neutrophils**, also called **polymorphonuclear neutrophils (PMNs)**, have a nucleus with three to five lobes and small, numerous, lilac-colored granules. Each lobe of the nucleus is connected by a thin strand of material to the other lobes. The **eosinophils** have fewer lobes in the nucleus (typically 2–3) and larger granules that stain reddish-orange. The **basophils** have a two-lobed nucleus and large granules that stain dark blue or purple (see the figure below).

{{< mediafigure src="microbiology/OSC_Microbio_17_05_GranTypes" kind="diagram" alt="Three pairs of images, one pair per granulocyte. Above each is a micrograph of the stained cell; below is a matching drawn illustration with a line labeling its nucleus. The neutrophil's nucleus has several connected lobes; the eosinophil's two-lobed nucleus sits beside bright granules; the basophil's two-lobed nucleus is nearly hidden by dense, dark granules filling the cell." >}}
...
{{< selfcheck question="Describe the granules and nuclei of neutrophils, eosinophils, basophils, and mast cells." hint="See the opening paragraph of the Granulocytes section and the Mast Cells subsection." >}}
Neutrophils have a nucleus with three to five lobes, connected by thin strands, and small, numerous, lilac-colored granules. Eosinophils have fewer lobes in the nucleus (typically two to three) and larger granules that stain reddish-orange. Basophils have a two-lobed nucleus and large granules that stain dark blue or purple. Mast cells are functionally very similar to basophils, containing many of the same granule components (such as histamine), but reside in tissues rather than circulating in the blood.
===CHECKS===
neutrophils have a nucleus with three to five lobes, connected by thin strands, and small, numerous, lilac-colored granules
eosinophils have fewer lobes in the nucleus (typically two to three) and larger granules that stain reddish-orange
basophils have a two-lobed nucleus and large granules that stain dark blue or purple
...
stimulated to release toxic molecules into the surrounding tissue, a process called degranulation
neutrophil extracellular traps (NETs), mesh or lattice-like structures of chromatin coupled with antimicrobial proteins
{{< /selfcheck >}}
...
*The case continues in [Inflammation and Fever](/life-health-sciences/microbiology/17-innate-nonspecific-host-defenses/05-inflammation-and-fever/). The case began in [Physical Defenses](/life-health-sciences/microbiology/17-innate-nonspecific-host-defenses/01-physical-defenses/).*
{{< /callout >}}

## Agranulocytes

As their name suggests, **agranulocytes** lack visible granules in the cytoplasm. Agranulocytes can be categorized as lymphocytes or monocytes (see the table above). Among the lymphocytes are natural killer cells, which play an important role in nonspecific innate immune defenses. Lymphocytes also include the B cells and T cells, which are discussed in the next chapter because they are central players in the specific adaptive immune defenses. The monocytes differentiate into macrophages and dendritic cells, which are collectively referred to as the mononuclear phagocyte system.
...
NK cells contain these toxic compounds in granules in their cytoplasm. When stained, the granules are azurophilic and can be visualized under a light microscope (see the figure below). Even though they have granules, NK cells are not considered granulocytes because their granules are far less numerous than those found in true granulocytes. Furthermore, NK cells have a different lineage than granulocytes, arising from lymphoid rather than myeloid stem cells (see the hematopoiesis figure above).

{{< mediafigure src="microbiology/OSC_Microbio_17_05_Nkgranul" kind="photo" alt="A micrograph of numerous densely packed, purple-stained white blood cells with dark, irregularly lobed nuclei filling most of each cell. A label reading 'perforin-containing granules' points with two lines to granular regions inside two adjacent cells near the center of the image." >}}
Natural killer cell with perforin-containing granules. (credit: modification of work by Rolstad B)
{{< /mediafigure >}}

### Monocytes

The largest of the white blood cells, **monocytes** have a nucleus that lacks lobes, and they also lack granules in the cytoplasm (see the figure below). Nevertheless, they are effective phagocytes, engulfing pathogens and apoptotic cells to help fight infection.
...
{{< mediafigure src="microbiology/OSC_Microbio_17_05_monomacro" kind="photo" alt="Two micrographs. Left: a stained blood smear with several large, purple-nucleated monocytes clustered together, a smaller neutrophil (PMN) with a dark, multi-lobed nucleus, and many small, pale pink red blood cells, several of which are labeled. Right: a tissue section with several large, irregularly shaped macrophages, two labeled with arrows." >}}
...
{{< selfcheck question="Describe the signals that activate natural killer cells." hint="See the first paragraph of the Natural Killer Cells subsection and the figure after it." >}}
NK cells recognize normal MHC markers on the surface of healthy cells, and these markers serve as an inhibitory signal that prevents NK cell activation. Cancer cells and virus-infected cells actively diminish or eliminate their MHC markers, and they also display activating molecules ("altered self" or "nonself" molecules). When an NK cell recognizes a decrease in the inhibitory MHC signal together with an increase in activating molecules on a cell's surface, it is activated to eliminate that cell.
===CHECKS===
NK cells recognize normal MHC markers on the surface of healthy cells, and these markers serve as an inhibitory signal
cancer cells and virus-infected cells actively diminish or eliminate their MHC markers
display activating molecules ("altered self" or "nonself" molecules)
a decrease in the inhibitory MHC signal together with an increase in activating molecules ... it is activated to eliminate that cell
{{< /selfcheck >}}

{{< selfcheck question="What is the difference between monocytes and macrophages?" hint="See the first two paragraphs of the Monocytes subsection." >}}
Monocytes have a nucleus that lacks lobes and circulate in the bloodstream as effective phagocytes. When monocytes leave the bloodstream and enter a specific body tissue, they differentiate into tissue-specific phagocytes called macrophages (and dendritic cells).
===CHECKS===
monocytes ... circulate in the bloodstream as effective phagocytes
when monocytes leave the bloodstream and enter a specific body tissue, they differentiate into tissue-specific phagocytes called macrophages
{{< /selfcheck >}}
...
- **dendritic cells** — phagocytes that monocytes differentiate into upon leaving the bloodstream and entering body tissue, alongside macrophages; important sentinels residing in the skin and mucous membranes.
...
{{< multiplechoice
  question="White blood cells are also referred to as which of the following?"
  answer="leukocytes"
  hint="See this module's opening paragraph."
>}}
platelets
erythrocytes
leukocytes
...
{{< selfcheck question="Explain the difference between plasma and the formed elements of the blood." hint="See the first two sentences of this section." >}}
Plasma is the fluid portion of blood. The formed elements are the nonfluid portion of blood — red blood cells, platelets, and white blood cells — all of which are formed from the same stem cells found in the bone marrow.
===CHECKS===
plasma is the fluid portion of blood
the formed elements are the nonfluid portion of blood
red blood cells, platelets, and white blood cells
{{< /selfcheck >}}

{{< multiplechoice
  question="Refer to the table of formed elements above. In a blood smear taken from a healthy patient, which type of leukocyte would you expect to observe in the highest numbers?"
  answer="neutrophils"
  hint="Compare the percentage of total leukocytes each type makes up in the table above."
>}}
lymphocytes
neutrophils
monocytes
...
{{< textin
  question="The formation, development, and differentiation of blood cells is called ________."
...
{{< multiplechoice
  ...
  hint="See the first paragraph of the Hematopoiesis subsection."
>}}
myeloid stem cell
...
{{< multiplechoice
  question="Which cell type recognizes abnormal cells, binds to them, and releases perforin and granzyme molecules, which induce apoptosis?"
  answer="natural killer cell"
  hint="See the paragraph that names perforin and granzymes."
>}}
natural killer cell
basophil
macrophage
...
{{< textin
  question="_____________ are similar to basophils, but reside in tissues rather than circulating in the blood."
  answer="mast cells"
  hint="See the subsection that follows the Basophils subsection."
>}}

{{< selfcheck question="Neutrophils can sometimes kill human cells along with pathogens when they release the toxic contents of their granules into the surrounding tissue. Likewise, natural killer cells target human cells for destruction. Explain why it is advantageous for the immune system to have cells that can kill human cells as well as pathogens." hint="See the first paragraph of the Natural Killer Cells subsection and the Neutrophils (PMNs) subsection's paragraph on extracellular traps." >}}
Natural killer cells use nonspecific mechanisms to recognize and destroy cells that are abnormal in some way; cancer cells and cells infected with viruses are two examples of cellular abnormalities that NK cells target. In the case of neutrophils, the toxic proteins in neutrophil extracellular traps may kill some of the body's own cells along with invading pathogens, but this collateral damage can be repaired after the danger of the infection has been eliminated.
===CHECKS===
natural killer cells use nonspecific mechanisms to recognize and destroy cells that are abnormal in some way
cancer cells and cells infected with viruses are two examples of cellular abnormalities that NK cells target
this collateral damage can be repaired after the danger of the infection has been eliminated
{{< /selfcheck >}}

...
{{< mediafigure src="microbiology/OSC_Microbio_23_02_Microassay" kind="photo" alt="A micrograph showing a purple-stained field with several irregular, roughly round clusters of cells; three clusters are marked with white arrows and one small speck is marked with a black arrow, with a 25 µm scale bar in the lower left." >}}

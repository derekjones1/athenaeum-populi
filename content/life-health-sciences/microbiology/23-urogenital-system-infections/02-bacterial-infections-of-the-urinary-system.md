...
description: >-
  Cystitis, kidney infections (pyelonephritis and glomerulonephritis),
  leptospirosis, and nongonococcal urethritis — adapted from OpenStax
  Microbiology, Section 23.2.
source_section: "23.2"
weight: 2
---
...
Leptospirosis is extremely rare in the United States, although it is endemic in Hawaii; 50% of all cases in the United States come from Hawaii (Centers for Disease Control and Prevention. "Leptospirosis." 2015.). It is more common in tropical than in temperate climates, and individuals who work with animals or animal products are most at risk. The bacteria can also be cultivated in specialized media, with growth observed in broth in a few days to four weeks; however, diagnosis of leptospirosis is generally made using faster methods, such as detection of antibodies to *Leptospira* spp. in patient samples using serologic testing. Polymerase chain reaction (PCR), enzyme-linked immunosorbent assay (ELISA), slide agglutination, and indirect immunofluorescence tests may all be used for diagnosis. Treatment for leptospirosis involves broad-spectrum antibiotics such as penicillin and doxycycline. For more serious cases of leptospirosis, antibiotics may be given intravenously.

{{< mediafigure src="microbiology/OSC_Microbio_23_02_Leptospira" kind="photo" alt="(a) A dark-field micrograph showing numerous faint, thread-like spiral cells against a dark background, with a 1 µm scale bar. (b) A higher-magnification scanning electron micrograph showing two distinct spiral-shaped cells in clear detail, with a 1 µm scale bar." >}}
...
{{< textin question="What is the most common cause of a kidney infection?" answer="E. coli" accept="Escherichia coli|fecal bacteria|faecal bacteria" hint="See the first paragraph of the Kidney Infections subsection." >}}

{{< selfcheck question="What are the most common symptoms of a kidney infection?" hint="One sentence lists three signs, right after explaining why one of them is tied to the kidneys' location." >}}
Common signs and symptoms of a kidney infection (pyelonephritis) include back pain, due to the location of the kidneys, fever, and nausea or vomiting.
===CHECKS===
back pain, due to the location of the kidneys
fever
nausea or vomiting
{{< /selfcheck >}}
...
There are two main categories of bacterial urethritis: gonorrheal and nongonococcal. Gonorrheal urethritis is caused by *Neisseria gonorrhoeae* and is associated with gonorrhea, a common STI. This cause of urethritis will be discussed in [Bacterial Infections of the Reproductive System](/life-health-sciences/microbiology/23-urogenital-system-infections/03-bacterial-infections-of-the-reproductive-system/). The term **nongonococcal urethritis (NGU)** refers to inflammation of the urethra that is unrelated to *N. gonorrhoeae*. In females, NGU is often asymptomatic. In males, NGU is typically a mild disease, but can lead to purulent discharge and dysuria. Because the symptoms are often mild or nonexistent, most infected individuals do not know that they are infected, yet they are carriers of the disease. Asymptomatic patients also have no reason to seek treatment, and although not common, untreated NGU can spread to the reproductive organs, causing pelvic inflammatory disease and salpingitis in females and epididymitis and prostatitis in males. Important bacterial pathogens that cause nongonococcal urethritis include *Chlamydia trachomatis*, *Mycoplasma genitalium*, *Ureaplasma urealyticum*, and *Mycoplasma hominis*.

*C. trachomatis* is a difficult-to-stain, gram-negative bacterium with an ovoid shape. An intracellular pathogen, *C. trachomatis* causes the most frequently reported STI in the United States, chlamydia. Although most persons infected with *C. trachomatis* are asymptomatic, some patients can present with NGU. *C. trachomatis* can also cause non-urogenital infections such as the ocular disease trachoma (see [Bacterial Infections of the Skin and Eyes](/life-health-sciences/microbiology/21-skin-and-eye-infections/02-bacterial-infections-of-the-skin-and-eyes/)). The life cycle of *C. trachomatis* is illustrated in a figure of [Nonproteobacteria Gram-Negative Bacteria and Phototrophic Bacteria](/life-health-sciences/microbiology/04-prokaryotic-diversity/03-nonproteobacteria-gram-negative-bacteria-and-phototrophic-bacteria/).
...
{{< selfcheck question="What are the three most common causes of urethritis?" hint="The module distinguishes gonorrheal urethritis from nongonococcal urethritis (NGU) and names NGU's several bacterial causes." >}}
The module describes two categories of bacterial urethritis: gonorrheal urethritis, caused by *Neisseria gonorrhoeae*, and nongonococcal urethritis (NGU), caused primarily by *Chlamydia trachomatis*, *Mycoplasma genitalium*, *Ureaplasma urealyticum*, and *Mycoplasma hominis*.
===CHECKS===
gonorrheal urethritis is caused by Neisseria gonorrhoeae
NGU is caused primarily by Chlamydia trachomatis, Mycoplasma genitalium, Ureaplasma urealyticum, and Mycoplasma hominis
{{< /selfcheck >}}

{{< selfcheck question="What three members of the normal microbiota can cause urethritis?" hint="These three species are named as the 'other species' associated with NGU once Chlamydia trachomatis has been discussed separately." >}}
*Mycoplasma genitalium*, *Ureaplasma urealyticum*, and *Mycoplasma hominis* are commonly found in the normal microbiota of healthy individuals but can sometimes cause urethritis.
===CHECKS===
Mycoplasma genitalium
Ureaplasma urealyticum
Mycoplasma hominis
commonly found in the normal microbiota of healthy individuals
{{< /selfcheck >}}

{{< callout type="info" >}}
**Disease Profile.** *Bacterial Infections of the Urinary Tract*

Urinary tract infections can cause inflammation of the urethra (urethritis), bladder (cystitis), and kidneys (pyelonephritis), and can sometimes spread to other body systems through the bloodstream. The table below captures the most important features of various types of UTIs.
...
{{< multiplechoice
  question="Which species is not associated with NGU?"
  answer="*Neisseria gonorrhoeae*"
  hint="See the first paragraph of the section's last subsection."
>}}
...
{{< multiplechoice
  question="A strain of bacteria associated with a bladder infection shows gram-negative rods. What species is most likely to be the causative agent?"
  answer="*Escherichia coli*"
  hint="See the Cystitis subsection's paragraph on the bacteria that cause bladder infections."
>}}
*Mycoplasma hominis*
*Escherichia coli*
*Neisseria gonorrhoeae*
...
{{< textin question="Painful urination accompanied by burning or discomfort is called ________." answer="dysuria" hint="See the first paragraph of the Cystitis subsection." >}}

### Compare the major characteristics of specific bacterial diseases affecting the urinary tract

{{< textin question="Pyelonephritis is a potentially severe infection of the ________." answer="kidneys" hint="See the first sentence of the subsection that follows the Case in Point box." >}}

{{< textin question="What is pyuria?" answer="pus in the urine" accept="pus in urine|pus" hint="The section defines this symptom in the same breath as two other urinary symptoms." >}}

{{< textin question="A bacterial infection of the kidney that can be transmitted by exposure to infected animal urine, especially in contaminated water, is called ________." answer="leptospirosis" hint="See the third bullet of the Summary." >}}

{{< selfcheck question="What are some factors that would increase an individual's risk of contracting leptospirosis?" hint="The section names both an environmental exposure and an occupational group at particular risk." >}}
Humans generally become infected by coming in contact with contaminated soil or water, often while swimming or during flooding, or through contact with body fluids containing the bacteria. Individuals who work with animals or animal products are most at risk.
===CHECKS===
contact with contaminated soil or water, often while swimming or during flooding
contact with body fluids containing the bacteria
individuals who work with animals or animal products are most at risk
{{< /selfcheck >}}

{{< textin question="A nonspecific infection of the urethra unrelated to *Neisseria gonorrhoeae* is called ________." answer="nongonococcal urethritis" accept="NGU|non-gonococcal urethritis" hint="See the first paragraph of the section's last subsection." >}}

---

<small>This section is adapted from [Microbiology, Section 23.2: Bacterial Infections of the Urinary System](https://openstax.org/books/microbiology/pages/23-2-bacterial-infections-of-the-urinary-system) by Nina Parker, Mark Schneegurt, Anh-Hue Thi Tu, Philip Lister, Brian M. Forster, and OpenStax, © OpenStax, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). Access the original for free at [openstax.org](https://openstax.org/details/books/microbiology). Changes: all three photographic and micrograph figures re-encoded as WebP and rendered as mediafigures with `kind="photo"` after image inspection; the Dipstick figure carries `eager="true"` as the page's first figure; the Disease Profile table image (`OSC_Microbio_23_02_BlaKidTbl`) is transcribed as a Markdown table from the pinned CNXML alt (checked against the PDF) rather than vendored, per this book's Disease Profile rule — the NGU row's Transmission cell follows the pinned alt ("Transmitted sexually or from a pregnant person to neonate during birth"), where the printed table image reads "from mother to neonate during birth"; the Cystitis and Pyelonephritis/glomerulonephritis rows' Antimicrobial Drugs cells follow the pinned alt's "cephalosporins," where the printed table image misspells it "cephalosprins" in both rows; feature boxes rendered as callouts; the three footnote citations are rendered as inline parenthetical citations, bare access URLs dropped; the cross-reference to Section 23.3 (*Bacterial Infections of the Reproductive System*) and the cross-references to *Bacterial Infections of the Skin and Eyes* (Section 21.2) and to a figure of *Nonproteobacteria Gram-Negative Bacteria and Phototrophic Bacteria* (Section 4.3) are links to those pages; the two source Multiple Choice items and the one Fill in the Blank item are adapted into Practice unchanged with their source keys; the unkeyed Short Answer question ("What is pyuria?") is graded as a `textin` from this module's own defining sentence; the unkeyed Critical Thinking question (leptospirosis risk factors) remains a self-check with a model answer assembled from this module's own two risk-factor sentences, since no single sentence states them both; of this section's four body Check Your Understanding bullets, one (the most common cause of a kidney infection) is graded as a `textin` from a single fixing sentence, and three remain self-checks whose model answers are assembled from this module's own text, because each needs more than one sentence to answer honestly — the "three most common causes of urethritis" self-check's model answer states only the two categories and their causative species the module gives, since the module does not name exactly three; three author-written `textin` items fill out the Practice groups against this module's thin exercise bank: key-term recall items for dysuria and nongonococcal urethritis, and a leptospirosis item whose prompt is the Summary's own leptospirosis sentence. One one-word source typo is corrected: "K. pneumonia" to "K. pneumoniae" in the Cystitis subsection. A claim correction in the Nongonococcal Urethritis subsection replaces the source's "It can generate hydrogen peroxide" (attributing hydrogen-peroxide production to the immunoglobulin α protease) with "*U. urealyticum* can also generate hydrogen peroxide," with a visible Source note beside the passage, because the Ureaplasma virulence-factor literature documents IgA protease activity and hydrogen-peroxide production as separate factors of the organism, not one enzyme performing both.</small>

...
description: >-
  How *Candida* causes vaginal candidiasis (a yeast infection) when the
  normal vaginal microbiota is disrupted, and how the infection is
  diagnosed and treated — adapted from OpenStax Microbiology, Section 23.5.
source_section: "23.5"
weight: 5
---
...
{{< mediafigure src="microbiology/OSC_Microbio_23_05_GermTubes" alt="Micrograph of two circular cells attached to each other; one is labeled daughter cell and the other is labeled mother cell. The mother cell has a small protrusion labeled germ tube (6 minutes old)." kind="photo" >}}
...
culturing is less useful because Candida is part of the normal microbiota and will regularly appear
cultivation can be used to identify chlamydospores and pseudohyphae, which develop from germ tubes
a diagnostic test combines cultured yeast cells with rabbit serum and checks for the presence of germ tubes
the Affirm VPIII Microbial Identification Test tests simultaneously for C. albicans, G. vaginalis, and Trichomonas vaginalis
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_23_05_LactoBacil" alt="(a) A micrograph of a large pink squamous epithelial cell with smaller dark purple rod-shaped bacteria on and around it. (b) A micrograph of a wet-mount preparation showing branching filaments labeled pseudohyphae." kind="photo" >}}

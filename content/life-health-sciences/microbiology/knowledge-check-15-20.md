---
title: "Knowledge Check: Chapters 15–20 — Pathogenicity, Epidemiology, and Immunity"
description: >-
  A cumulative self-test on Chapters 15–20, Pathogenicity, Epidemiology, and
  Immunity, with every question written from the chapters' own text in
  OpenStax Microbiology.
source_chapters: "15-20"
weight: 24
---

{{< callout type="info" >}}
  **Test yourself on Chapters 15–20: Pathogenicity, Epidemiology, and
  Immunity.** Every question below was written from the chapters' own text —
  their summaries, key terms, explanations, and tables — and none repeats a
  question from the section pages. There are no hints: treat it like a test.
  Questions are grouped by the section they come from, so a miss tells you
  exactly which section to review.
{{< /callout >}}
...
{{< multiplechoice
  question="Which gram-positive bacterium is given as an example of a pathogen capable of crossing the placental barrier, posing a risk of spontaneous abortion to the fetus?"
...
{{< multiplechoice
  question="Among the following foodborne pathogens, which has the highest ID₅₀?"
...
{{< textin
  question="*Giardia lamblia* attaches to the intestinal mucosa using a large adhesive disc composed of ________."
  answer="microtubules"
>}}

{{< selfcheck question="Explain how the *Plasmodium falciparum* adhesin protein PfEMP1 contributes to the pathology of malaria, apart from helping the parasite evade the immune system." >}}
PfEMP1 is expressed on the surface of red blood cells infected by *Plasmodium falciparum*, causing the infected cells to stick to each other and to the walls of blood vessels. This impedes blood flow, which can lead to organ failure, anemia, and jaundice from the buildup of bilirubin released by lysed red blood cells, and can ultimately result in death.
===CHECKS===
infected cells stick to each other and to the walls of blood vessels
impedes blood flow, which can lead to organ failure
anemia and jaundice from the buildup of bilirubin
released by lysed red blood cells
{{< /selfcheck >}}
...
{{< multiplechoice
  question="Between 1876 and 1905, the causative agents of many common diseases were established during what is known as the Golden Age of Microbiology. Which of the following was among those diseases?"
  answer="cholera"
>}}
HIV infection
cholera
...
{{< selfcheck question="Why do infections of the bacterium that causes tetanus occur only rarely and in scattered locations in the United States, even though the bacterium is ubiquitous in the soil environment?" >}}
In the United States, the bacterium that causes tetanus is ubiquitous in the soil environment, but incidences of infection occur only rarely and in scattered locations because most individuals are vaccinated, clean wounds appropriately, or are only rarely in a situation that would cause infection.
===CHECKS===
most individuals are vaccinated
clean wounds appropriately
only rarely in a situation that would cause infection
{{< /selfcheck >}}

{{< multiplechoice
  question="In the CDC's notifiable-disease incidence report for the week ending January 2, 2016, which disease had by far the most cumulative cases reported in the United States in 2015?"
...
{{< textin
  question="In an experimental study on human subjects, when neither the subjects nor the researchers know who is receiving the treatment and who is receiving a placebo, the study is called a ________ study."
  answer="double-blind"
>}}
...
{{< textin
  question="Transmission of pathogens to a fetus or infant during pregnancy, birth, or breastfeeding is called ________ direct contact transmission."
  answer="vertical"
>}}

{{< multiplechoice
  question="Hemipterans, called 'kissing bugs' or 'assassin bugs,' transmit which disease to humans by defecating when they bite, after which the human scratches or rubs the infected feces into a mucous membrane or a break in the skin?"
...
{{< multiplechoice
  question="The World Health Organization's vaccination program against smallpox, begun in the mid-1960s, resulted in the global eradication of the disease by which year?"
  answer="1980"
>}}
1976
1980
...
{{< textin
  question="On November 16, 2002, the first reported case of a SARS outbreak occurred in which Chinese province?"
  answer="Guangdong"
  accept="Guangdong Province"
>}}
...
{{< multiplechoice
  question="Which type of cell junction has intermediate fibers that act like shoelaces, tying two cells together and allowing small materials to pass through the resulting spaces?"
  answer="Desmosomes"
>}}
Tight junctions
Desmosomes
...
{{< textin
  question="The layer of fatty tissue that lies beneath the dermis and contains blood and lymph vessels is called the ________."
  answer="hypodermis"
>}}
...
{{< textin
  question="Lactoferrin inhibits microbial growth by chemically binding and sequestering ________, starving many microbes that require it for growth."
  answer="iron"
>}}

{{< selfcheck question="Describe the ways antimicrobial peptides (AMPs) can damage microorganisms." >}}
...
{{< multiplechoice
  question="In terms of sheer numbers, into which type of formed element do the vast majority of hematopoietic stem cells (HSCs) differentiate?"
  answer="erythrocytes"
>}}
erythrocytes
leukocytes
...
{{< selfcheck question="What does the presence of pus at a site of infection indicate about the immune response, and why is deliberately inducing pus formation no longer considered good medical practice?" >}}
The presence of pus is a sign that the immune defenses have been activated against an infection, and a small amount of pus formation can indicate a strong immune response. However, artificially inducing pus formation does not promote recovery; the historical practice of promoting "laudable pus" is now known not to be effective.
===CHECKS===
the presence of pus is a sign that the immune defenses have been activated against an infection
...
{{< textin
  question="When nitric oxide reacts with superoxide, it forms a highly reactive nitrogen compound with degrading capabilities similar to reactive oxygen species, called ________."
...
Chronic inflammation may be involved in the progression of degenerative neurological diseases such as Alzheimer's and Parkinson's, heart disease, and metastatic cancer. Chronic inflammation is also an important cause of tissue damage from viral infections: the extensive scarring observed with hepatitis C infections and liver cirrhosis is the result of chronic inflammation.
===CHECKS===
degenerative neurological diseases such as Alzheimer's and Parkinson's
heart disease and metastatic cancer
the extensive scarring observed with hepatitis C infections and liver cirrhosis
{{< /selfcheck >}}
...
{{< textin
  question="A disulfide bond in an antibody molecule is a covalent bond between the sulfhydryl R groups found on two ________ amino acids."
  answer="cysteine"
>}}

{{< textin
  question="The hapten found in the oil of plants that cause poison ivy, producing an immune response that can result in contact dermatitis, is called ________."
  answer="urushiol"
>}}
...
{{< textin
  question="When B-cell receptor immunoglobulins bind an antigen, a B cell internalizes the antigen by ________ before processing and presenting it to T cells."
  answer="endocytosis"
>}}

{{< textin
  question="MHC I and MHC II molecules are both transmembrane glycoproteins that assemble as ________ in the cytoplasmic membrane of a cell."
  answer="dimers"
>}}
...
{{< multiplechoice
  question="The same genetic rearrangement mechanism that generates the diversity of BCRs on a B cell's surface also generates diversity in which other molecules?"
  answer="the antibodies secreted after B cell activation"
>}}
the CD4 molecule on a helper T cell
the toll-like receptors involved in T cell-independent activation
the antibodies secreted after B cell activation
the MHC II molecules used for antigen presentation
{{< /multiplechoice >}}
...
{{< multiplechoice
  question="During the primary antibody response, IgG levels rise until they reach a peak at about what point?"
...
{{< multiplechoice
  question="IgM antibodies that cross-react with blood-group antigens not present on an individual's own red blood cells, produced within the first few weeks after birth and persisting throughout life, are called which of the following?"
  answer="Isohemagglutinins"
>}}
...
Pathology associated with HP can be due to both type III (mediated by immune complexes) and type IV (mediated by TH1 cells and macrophages) hypersensitivities. Repeated exposure to allergens can cause alveolitis due to the formation of immune complexes in the alveolar wall of the lung accompanied by fluid accumulation, and the formation of granulomas and other lesions in the lung as a result of TH1-mediated macrophage activation. Alveolitis with fluid and granuloma formation results in poor oxygen perfusion in the alveoli, causing symptoms such as coughing, dyspnea, chills, fever, sweating, myalgias, headache, and nausea.
===CHECKS===
HP pathology can result from both type III (immune-complex-mediated) and type IV (TH1-cell/macrophage-mediated) hypersensitivities
repeated exposure to allergens causes alveolitis from immune-complex formation in the alveolar wall with fluid accumulation
TH1-mediated macrophage activation causes granuloma and other lesion formation in the lung
poor oxygen perfusion from alveolitis causes symptoms such as coughing, dyspnea, chills, and fever
{{< /selfcheck >}}

### 19.2 Autoimmune Disorders

{{< textin
  question="Celiac disease results from a reaction to proteins found mainly in wheat, barley, rye, and other grains, commonly called ________."
  answer="gluten"
>}}

{{< textin
  question="Which enzyme involved in steroid synthesis is the target of the most common autoantibody found in autoimmune Addison disease (AAD)?"
  answer="21-hydroxylase"
  accept="21-OH"
>}}

{{< multiplechoice
  question="Which of the following causes the hallmark lesions of multiple sclerosis in the central nervous system?"
  answer="Infiltration of immune cells across the blood-brain barrier"
>}}
Autoantibodies directed against acetylcholine receptors at the neuromuscular junction
Infiltration of immune cells across the blood-brain barrier
Formation of immune complexes that deposit in the joints
Cytokine activation of keratinocytes that speeds up epidermal cell turnover
{{< /multiplechoice >}}
...
{{< multiplechoice
  question="Which alternative approach to organ transplantation involves removing, from a donor embryo, the genes most responsible for the rejection reaction after transplantation?"
  answer="Using genetically engineered pigs to grow transplantable organs"
>}}
Matching all of the recipient's MHC genes to the donor's
Growing replacement organs from the patient's own harvested cells
Removing donor APCs and T cells before a bone marrow graft
Using genetically engineered pigs to grow transplantable organs
{{< /multiplechoice >}}

{{< selfcheck question="Why is no non-self grafted tissue likely to completely avoid rejection, even with a good MHC gene match?" >}}
Although matching all of the MHC genes can lower the risk for rejection, there are a number of additional gene products that also play a role in stimulating responses against grafted tissue. Because of this, no non-self grafted tissue is likely to completely avoid rejection. However, the more similar the MHC gene match, the more likely the graft is to be tolerated for a longer time.
===CHECKS===
matching all of the MHC genes can lower the risk for rejection
there are a number of additional gene products that also play a role in stimulating responses against grafted tissue
the more similar the MHC gene match, the more likely the graft is to be tolerated for a longer time
{{< /selfcheck >}}

### 19.4 Immunodeficiency

{{< textin
  question="In patients whose B cells are unable to produce sufficient amounts of Btk, B-cell maturation and differentiation halts at the ________ stage of growth."
  answer="pre-B-cell"
  accept="pre-B"
>}}
...
Vetter received a bone marrow transplant from his sister to correct the defects in lymphocyte development that lead to the SCID phenotype. Because of a latent Epstein-Barr virus infection in her bone marrow, however, he developed mononucleosis and died of Burkitt lymphoma at the age of 12 years.
===CHECKS===
his sister's bone marrow carried a latent Epstein-Barr virus infection
he developed mononucleosis and died of Burkitt lymphoma
...
{{< textin
  question="An abnormal mass of cells that is cancerous is described as ________, as opposed to benign."
  answer="malignant"
>}}
...
{{< multiplechoice
  question="Antiserum obtained from an animal must be purified before it is used for research or diagnostic assays because"
  answer="it also contains antibodies to other antigens the animal was exposed to."
>}}
it also contains antibodies to other antigens the animal was exposed to.
it has not yet undergone affinity maturation from a second antigen injection.
it binds with high affinity to only one epitope on the antigen.
{{< /multiplechoice >}}
...
In a minor cross-match, a small aliquot of donor serum is mixed with patient red blood cells, which allows the detection of agglutinizing antibodies in the donor serum. This test is rarely necessary because transfusions generally use packed red blood cells with most of the plasma removed by centrifugation.
===CHECKS===
a small aliquot of donor serum is mixed with patient red blood cells
which allows the detection of agglutinizing antibodies in the donor serum
...
{{< textin
  question="In a fluorescent enzyme immunoassay (FEIA), the resulting fluorescence can be detected using either a fluorescence microscope or a ________."
...
{{< textin
  question="A technique in which a large volume of fluid is passed through a porous membrane into an absorbent pad, so that an antigen or antibody attached to the membrane can capture its target molecule as the fluid passes, is called ________."

...
{{< selfcheck question="How does one use the information from a Kirby-Bauer assay to predict the therapeutic effectiveness of an antimicrobial drug in a patient?" hint="Recall what the zone diameter is compared against, and what that comparison can and cannot tell you about a drug's potency." >}}
...
===CHECKS===
the diameter of the zone of inhibition ... compared to a standardized chart, determines the susceptibility or resistance of the bacterial pathogen to the drug
...
{{< mediafigure src="microbiology/OSC_Microbio_14_05_MIC" alt="Five glass tubes in a rack, each labeled below with a drug concentration: 2, 4, 8, 16, and 32 µg/mL. The 2 and 4 µg/mL tubes hold cloudy, opaque yellowish broth. The 8, 16, and 32 µg/mL tubes hold clearer broth with a thin band of sediment near the bottom." kind="photo" eager="true" >}}
...
{{< multiplechoice
  ...
  answer="diameter"
  hint="Recall the one linear measurement of the zone that is compared to the standardized chart."
>}}
diameter
...
{{< multiplechoice
  ...
  hint="Recall what geographic scope an antibiogram's compiled data represents."
>}}

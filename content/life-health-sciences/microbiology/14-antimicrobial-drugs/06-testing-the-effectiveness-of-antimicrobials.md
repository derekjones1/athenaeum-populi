...
description: >-
  The Kirby-Bauer disk diffusion test and antibiograms, and how macrobroth,
  microdilution, and Etest assays determine the minimal inhibitory and
  minimal bactericidal concentrations of an antimicrobial drug — adapted
  from OpenStax Microbiology, Section 14.6.
source_section: "14.6"
weight: 6
---
...
{{< selfcheck question="How does one use the information from a Kirby-Bauer assay to predict the therapeutic effectiveness of an antimicrobial drug in a patient?" hint="Reread the two paragraphs of The Kirby-Bauer Disk Diffusion Test discussion." >}}
...
the assay cannot distinguish between bacteriostatic and bactericidal activities
differences in zone sizes cannot be used to compare drug potencies or efficacies
comparison of zone sizes to a standardized chart will only provide information on the antibacterials to which a bacterial pathogen is susceptible or resistant
{{< /selfcheck >}}
...
Visit this website to view an [interactive antibiogram](https://openstax.org/l/22StanUnintanti) provided by Stanford University.
{{< /callout >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_14_05_MIC" alt="Five glass tubes in a rack, each labeled below with a drug concentration: 2, 4, 8, 16, and 32 µg/mL. The 2 and 4 µg/mL tubes hold cloudy, opaque yellowish broth. The 8, 16, and 32 µg/mL tubes hold clear broth, through which a dark band of the background shows halfway up each tube; the bottoms of these tubes are clear." kind="photo" eager="true" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_14_05_microdilut" alt="A photograph of a 96-well plate titled 'Antimicrobial Susceptibility Test,' with an arrow above the columns labeled low concentration on the left and high concentration on the right. Rows are bracketed and labeled clindamycin, penicillin, and erythromycin. A red circle marks one well in each of those three rows, labeled MIC >32 µg/mL for clindamycin, MIC 0.06 µg/mL for penicillin, and MIC 8 µg/mL for erythromycin. The bottom row is labeled minimal inhibitory concentration (MIC), growth control, and sterile control." longdesc="The plate has 8 rows, A through H, and 12 columns running left to right beneath an arrow labeled low concentration at the left and high concentration at the right. A bracket beside row A is labeled clindamycin; the well at the far right (highest-concentration) end of row A is circled in red and labeled MIC >32 µg/mL. A bracket beside row F is labeled penicillin; a well toward the left of row F is circled in red and labeled MIC 0.06 µg/mL. A bracket beside row G is labeled erythromycin; a well further right in row G is circled in red and labeled MIC 8 µg/mL. Row H, at the bottom, is labeled minimal inhibitory concentration (MIC) at its left end, growth control further right, and sterile control at its far right end." kind="photo" >}}
...
MIC and MBC both refer to the lowest drug concentration that inhibits visible bacterial growth, determined by different assays.
MIC and MBC both refer to the lowest drug concentration that kills $\geq 99.9\%$ of the starting inoculum, determined by different assays.
{{< /multiplechoice >}}
...
The case began in [History of Chemotherapy and Antimicrobial Discovery](/life-health-sciences/microbiology/14-antimicrobial-drugs/01-history-of-chemotherapy-and-antimicrobial-discovery/).
{{< /callout >}}
...
{{< multiplechoice
  question="In the Kirby-Bauer disk diffusion test, the _______ of the zone of inhibition is measured and used for interpretation."
  answer="diameter"
  hint="Reread the last sentence of the first Kirby-Bauer paragraph."
>}}
diameter
...
{{< textin question="A compilation of antibiotic susceptibility data broken down by bacterial pathogen is called a(n) ________." answer="antibiogram" hint="Reread the second paragraph of the Micro Connection box." >}}

{{< multiplechoice
  question="The utility of an antibiogram is that it shows antimicrobial susceptibility trends"
  answer="in a localized population."
  hint="Reread the Micro Connection box's definition of an antibiogram."
>}}
...
{{< multiplechoice
  ...
  answer="False"
  hint="Reread the second paragraph of The Kirby-Bauer Disk Diffusion Test discussion."
>}}
True
False
{{< /multiplechoice >}}
...
{{< textin question="The MIC assay can also be performed using 96-well ________ trays, which allow for the use of small volumes and automated dispensing devices, as well as the testing of multiple antimicrobials and/or microorganisms in one tray." answer="microdilution" accept="micro-dilution|microbroth dilution" hint="Reread the paragraph after the test-tube figure in the Dilution Tests discussion." >}}

{{< textin question="The method that can determine the MICs of multiple antimicrobial drugs against a microbial strain using a single agar plate is called the ________." answer="Etest" accept="E-test" hint="Reread the paragraph before the last figure in the Dilution Tests discussion." >}}
...
{{< multiplechoice
  ...
  hint="Reread the opening sentences of the Dilution Tests discussion, then the Etest paragraph."
>}}
Etest

...
description: >-
  How microbes develop or acquire antimicrobial resistance, the five
  biochemical mechanisms of resistance, and the clinically important
  multidrug-resistant organisms — MRSA, VRE/VRSA/VISA, ESBL producers, CRE,
  and MDR-/XDR-TB — adapted from OpenStax Microbiology, Section 14.5.
source_section: "14.5"
weight: 5
---
...
Exposure of a pathogen to an antimicrobial compound can select for chromosomal mutations conferring resistance, which can be transferred vertically to subsequent microbial generations and eventually become predominant in a microbial population that is repeatedly exposed to the antimicrobial. Alternatively, many genes responsible for drug resistance are found on plasmids or in transposons that can be transferred easily between microbes through horizontal gene transfer (see [How Asexual Prokaryotes Achieve Genetic Diversity](/life-health-sciences/microbiology/11-mechanisms-of-microbial-genetics/06-how-asexual-prokaryotes-achieve-genetic-diversity/)). Transposons also have the ability to move resistance genes between plasmids and chromosomes to further promote the spread of resistance.

## Mechanisms for Drug Resistance

There are several common mechanisms for drug resistance, which are summarized in the figure below. These mechanisms include enzymatic modification of the drug, modification of the antimicrobial target, and prevention of drug penetration or accumulation.

{{< mediafigure src="microbiology/OSC_Microbio_14_06_Resistance" alt="A diagram of a bacterial cell with four callout boxes naming antimicrobial resistance strategies — efflux pump, blocked penetration, inactivation by enzymes, and target modification — each connected by an arrow to a drawn structure in the cell membrane or cytoplasm, with a list of drug classes beside each box." longdesc="Top-left, 'Efflux pump': an arrow points to a cylindrical channel in the cell membrane through which drug molecules are pumped out of the cell; drug classes listed: fluoroquinolones, aminoglycosides, tetracyclines, β-lactams, macrolides. Top-right, 'Blocked penetration': an arrow points to a second membrane channel marked with a red X, blocking drug entry; drug classes listed: β-lactams, tetracyclines, fluoroquinolones. Bottom-left, 'Inactivation by enzymes': an arrow points to a multicolored ribbon-diagram enzyme bound to a small ball-and-stick drug molecule inside the cytoplasm; drug classes listed: β-lactams, aminoglycosides, macrolides, rifamycins. Bottom-right, 'Target modification': two arrows point to a DNA double helix and to a red-and-light-blue paired shape beside it; drug classes listed: fluoroquinolones, rifamycins, vancomycin, β-lactams, macrolides, aminoglycosides. A separate orange ribbon-diagram protein below the DNA helix has no arrow or callout box connecting it to any of the four labeled mechanisms." kind="diagram" eager="true" >}}
...
{{< selfcheck question="List several mechanisms for drug resistance." hint="Reread the subsection headings under Mechanisms for Drug Resistance." >}}
...
Although developing new antimicrobial drugs is one solution to this problem, scientists have explored new approaches, including the development of compounds that inactivate resistance mechanisms. The development of clavulanic acid represents an early example of this strategy. Clavulanic acid is a molecule produced by the bacterium *Streptomyces clavuligerus*. *(Source note: the source prints the genus as *Streptococcus*; the clavulanic-acid producer is the soil actinomycete *Streptomyces clavuligerus*, as the species' standing name records (List of Prokaryotic names with Standing in Nomenclature, *Streptomyces clavuligerus*).)* It contains a β-lactam ring, making it structurally similar to penicillin and other β-lactams, but shows no clinical effectiveness when administered on its own. Instead, clavulanic acid binds irreversibly within the active site of β-lactamases and prevents them from inactivating a coadministered penicillin.
...
VISA and VRSA strains differ from each other in the mechanism of resistance and the degree of resistance each mechanism confers. VISA strains exhibit intermediate resistance, with a minimum inhibitory concentration (MIC) of 4–8 µg/mL, and the mechanism involves an increase in vancomycin targets. VISA strains decrease the crosslinking of peptide chains in the cell wall, providing an increase in vancomycin targets that trap vancomycin in the outer cell wall. In contrast, VRSA strains acquire vancomycin resistance through horizontal transfer of resistance genes from VRE, an opportunity provided in individuals coinfected with both VRE and MRSA. VRSA exhibit a higher level of resistance, with MICs of 16 µg/mL or higher (Centers for Disease Control and Prevention, "Healthcare-Associated Infections (HIA): General Information about VISA/VRSA"). In the case of all three types of vancomycin-resistant bacteria, rapid clinical identification is necessary so proper procedures to limit spread can be implemented. The oxazolidinones like linezolid are useful for the treatment of these vancomycin-resistant, opportunistic pathogens, as well as MRSA.
...
{{< multiplechoice
  question="How does drug resistance lead to superbugs?"
  answer="Microbes that carry one or more resistance mechanisms become resistant to multiple antimicrobials"
  hint="Reread the sentence in the Multidrug-Resistant Microbes and Cross Resistance discussion that gives superbugs their colloquial name."
>}}
Methicillin was designed to resist inactivation by β-lactamases
Microbes that carry one or more resistance mechanisms become resistant to multiple antimicrobials
The cooking process typically inactivates any antimicrobials remaining in meat
Clavulanic acid prevents β-lactamases from inactivating a coadministered penicillin
{{< /multiplechoice >}}
...
{{< callout type="info" >}}
**Micro Connection.** *Factory Farming and Drug Resistance*
...
The case began in [History of Chemotherapy and Antimicrobial Discovery](/life-health-sciences/microbiology/14-antimicrobial-drugs/01-history-of-chemotherapy-and-antimicrobial-discovery/). The case continues in [Testing the Effectiveness of Antimicrobials](/life-health-sciences/microbiology/14-antimicrobial-drugs/06-testing-the-effectiveness-of-antimicrobials/).
{{< /callout >}}
...
- **multidrug-resistant microbes (MDRs)** — group of pathogens that carry one or more resistance mechanisms, making them resistant to multiple antimicrobials; also called superbugs.
- **cross-resistance** — when a single resistance mechanism confers resistance to multiple antimicrobial drugs.
- **methicillin-resistant *S. aureus* (MRSA)** — strains of *S. aureus* that develop resistance to methicillin, and to virtually all β-lactam drugs, through acquisition of a new low-affinity penicillin-binding protein.
...
- **vancomycin-resistant *S. aureus* (VRSA)** — strains of *S. aureus* that acquire vancomycin resistance through horizontal transfer of resistance genes from VRE.
- **vancomycin-intermediate *S. aureus* (VISA)** — strains of *S. aureus* with intermediate vancomycin resistance, resulting from decreased cross-linkage of peptide chains in the cell wall that increases the number of vancomycin-binding targets.
...
- **multidrug-resistant *Mycobacterium tuberculosis* (MDR-TB)** — strains of *Mycobacterium tuberculosis* resistant to both rifampin and isoniazid, the drug combination typically prescribed for tuberculosis treatment.
- **extensively drug-resistant *Mycobacterium tuberculosis* (XDR-TB)** — MDR-TB strains additionally resistant to any fluoroquinolone and at least one of three second-line drugs (amikacin, kanamycin, or capreomycin), leaving very few treatment options.
...
{{< multiplechoice
  question="Which of the following resistance mechanisms describes the function of β-lactamase?"
  answer="drug inactivation"
  hint="Reread the first mechanism subsection after the figure, where β-lactamases are discussed."
>}}
efflux pump
target mimicry
drug inactivation
...
{{< multiplechoice
  question="Which of the following types of drug-resistant bacteria do not typically persist in individuals as a member of their intestinal microbiota?"
  answer="MRSA"
  hint="Reread the subsections on the multidrug-resistant organisms that follow the mechanisms, for where each is carried."
>}}
MRSA
VRE
CRE
...
{{< textin question="*Staphylococcus aureus*, including MRSA strains, may commonly be carried as a normal member of the ________ microbiota in some people." answer="nasal" accept="nose|nasal passages|nasal cavity" hint="Reread the last sentences of the MRSA subsection." >}}

{{< textin question="The ability of a microbe to persist and grow in the presence of an antimicrobial drug is called ________." answer="drug resistance" accept="antimicrobial resistance|antimicrobial drug resistance" hint="This is the term this whole section defines in its opening paragraph." >}}

### Describe how microorganisms develop or acquire drug resistance

{{< selfcheck question="Why does the length of time of antimicrobial treatment for tuberculosis contribute to the rise of resistant strains?" hint="Reread the opening paragraph of this section and the last sentence of the Multidrug-Resistant *Mycobacterium tuberculosis* subsection." >}}
Several factors accelerate the evolution of drug resistance, including inappropriate use of antimicrobials, subtherapeutic dosing, and patient noncompliance with the recommended course of treatment. The development of resistance in *Mycobacterium tuberculosis* strains often results from the incorrect use of antimicrobials for tuberculosis treatment, selecting for resistance.
===CHECKS===
inappropriate use of antimicrobials, subtherapeutic dosing, and patient noncompliance with the recommended course of treatment
the incorrect use of antimicrobials for tuberculosis treatment, selecting for resistance
{{< /selfcheck >}}

{{< sortbins question="What is the difference between multidrug resistance and cross-resistance? Sort each phrase under the one it describes." hint="Reread the opening sentences of the Multidrug-Resistant Microbes and Cross Resistance discussion, which define both terms." >}}
{"bins":["Multidrug resistance","Cross-resistance"],"items":[{"label":"Carries one or more separate defense mechanisms against antimicrobials","bin":0},{"label":"A single mechanism renders a microbe unaffected by multiple antimicrobial drugs","bin":1},{"label":"Colloquially known as a superbug","bin":0},{"label":"Tylosin use in animals selects for bacteria unaffected by other macrolides, such as erythromycin","bin":1}]}
{{< /sortbins >}}

{{< textin question="Drug resistance genes are often carried on plasmids or in transposons that can undergo vertical transfer easily and between microbes through ________." answer="horizontal gene transfer" accept="HGT|horizontal transfer" hint="Reread the second paragraph of this section, on plasmids and transposons." >}}

### Describe the different mechanisms of antimicrobial drug resistance

{{< multiplechoice
  question="Which of the following resistance mechanisms is commonly effective against a wide range of antimicrobials in multiple classes?"
  answer="efflux pump"
  hint="Reread the last sentence of the second mechanism subsection after the figure."
>}}
efflux pump
target mimicry
target modification
...
{{< multiplechoice
  question="Which of the following resistance mechanisms is the most nonspecific to a particular class of antimicrobials?"
  answer="efflux pump"
  hint="Compare the scope of each mechanism subsection after the figure."
>}}
drug modification
target mimicry
target modification
...
{{< textin question="A common mechanism of carbapenem resistance among *Pseudomonas aeruginosa* is to decrease the amount of its OprD ________, which is the primary portal of entry for carbapenems through the outer membrane of this pathogen." answer="porin" accept="porin channel" hint="Reread the second mechanism subsection after the figure, on gram-negative pathogens." >}}

---

<small>This section is adapted from [Microbiology, Section 14.5: Drug Resistance](https://openstax.org/books/microbiology/pages/14-5-drug-resistance) by Nina Parker, Mark Schneegurt, Anh-Hue Thi Tu, Philip Lister, Brian M. Forster, and OpenStax, © OpenStax, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). Access the original for free at [openstax.org](https://openstax.org/details/books/microbiology). Changes: the section's one figure is re-encoded as WebP and rendered as a mediafigure; it is explicit `kind="diagram"` (the media manifest guesses `kind="photo"` from the JPEG source, which is wrong for this drawn, labeled mechanism diagram); its alt is rewritten from the rendering rather than the source alt, which misspells "rifamycins" as "rfamycins" and capitalizes "Beta-lactams" inconsistently with its other three lower-case occurrences — both are uncorrected source defects; a longdesc walks all four labeled boxes because the caption names none of them, plus a fifth, unlabeled shape near the DNA helix that no callout box or arrow connects to any mechanism. Both body Check Your Understanding bullets are rendered at their note positions: "List several mechanisms for drug resistance" stays a self-check because its honest answer is a list of five mechanisms drawn from five separate subsections, longer than a graded form holds; "How does drug resistance lead to superbugs?" is graded as a multiple choice keyed to the module's own MDR sentence ("MDRs are colloquially known as 'superbugs' and carry one or more resistance mechanism(s), making them resistant to multiple antimicrobials"); its three distractors are other statements this module prints (methicillin's design against β-lactamases, cooking's inactivation of antimicrobials in meat, and clavulanic acid's inhibition of β-lactamases), none of which describes how a microbe becomes resistant to multiple drugs. Of the module's two unkeyed Short Answer questions, the source's own "What is the difference between multidrug resistance and cross-resistance?" is kept verbatim as the stem of a `sortbins` (a compare-and-contrast pair the module's own sentences fix), with the sort instruction appended, rather than answered in prose; "Why does the length of time of antimicrobial treatment for tuberculosis contribute to the rise of resistant strains?" stays a self-check because the module never connects treatment length specifically to resistance, so its model answer states only what the module gives (the general resistance-accelerating factors and the tuberculosis incorrect-use sentence) without adding an inference. All four Multiple Choice items and the one Fill in the Blank item are used in Practice, sorted under the objective each serves; the fourth Multiple Choice (which drug-resistant bacteria do not typically persist in the intestinal microbiota) is placed in the first group ahead of the Fill in the Blank, keeping their source order, because the Fill in the Blank's stem says MRSA strains are carried in the nasal microbiota; the Fill in the Blank's `accept` list adds "nose," "nasal passages," and "nasal cavity." The multidrug-resistance/cross-resistance sort's efflux-pump item is replaced by the Factory Farming box's tylosin example, because the efflux-pump phrase answered the two efflux-pump Multiple Choice items. Three Practice items are author-written filler, strictly from this section's own text: a term-recall `textin` for "drug resistance" from its own defining sentence (`accept` adds the Summary's "antimicrobial resistance" and "antimicrobial drug resistance"), a summary-sentence cloze `textin` for "horizontal gene transfer" (`accept` adds "HGT" and "horizontal transfer" for a learner who drops "gene"), and a body-sentence cloze `textin` for "porin" from the *Pseudomonas aeruginosa* OprD sentence (`accept` adds "porin channel"), which keeps the third group at the book's floor. All three body objectives are used as Practice group headings. The three footnoted CDC citations drop their bare access URLs; the Kalokhe and Lowy journal citations are kept in full (neither carries a DOI). The source's *Stenotrophomonas maltophila* is printed corrected as *Stenotrophomonas maltophilia*. The vancomycin MIC values' micro sign is set as µ (U+00B5) rather than the Greek mu the source CNXML uses. Feature boxes are rendered as callouts: two Micro Connections keep their citations; the Link to Learning keeps its external URL; Clinical Focus Part 3 keeps its closing question as an unanswered bullet and links the case back to its start (History of Chemotherapy and Antimicrobial Discovery) and forward to its next part (Testing the Effectiveness of Antimicrobials) rather than the source's "jump to next/previous box" links. The cross-reference to How Asexual Prokaryotes Achieve Genetic Diversity is rendered as a link using the source's own link text. Key terms are compiled from the module's 12 defined-term elements and the book's Glossary appendix, rendered as 11 bullets: `drug resistance`, `multidrug-resistant microbes (MDRs)`, `cross-resistance`, `vancomycin-resistant enterococci (VRE)`, `extended-spectrum β-lactamases (ESBLs)`, and `carbapenem-resistant Enterobacteriaceae (CRE)` come from the Glossary appendix; `methicillin-resistant *S. aureus* (MRSA)`, `vancomycin-resistant *S. aureus* (VRSA)`, `vancomycin-intermediate *S. aureus* (VISA)`, and `multidrug-resistant *Mycobacterium tuberculosis* (MDR-TB)` have no appendix entry and are defined from this module's own sentences; `extensively drug-resistant *Mycobacterium tuberculosis*` and its abbreviation `XDR-TB`, marked as two separate defined-term elements, are combined into one sentence-derived bullet, the fifth sentence-derived definition. The claim pass corrected one source name: clavulanic acid's producer, printed as *Streptococcus clavuligerus*, is *Streptomyces clavuligerus*, with a Source note.</small>

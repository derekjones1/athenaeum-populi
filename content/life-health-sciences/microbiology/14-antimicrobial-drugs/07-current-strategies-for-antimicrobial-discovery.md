...
description: >-
  How researchers are searching for new antimicrobial agents — high-throughput
  screening, the iChip, marine environments, combinatorial chemistry, and
  inhibitors of resistance mechanisms and virulence factors — and the
  economics and ethics of antimicrobial drug development — adapted from
  OpenStax Microbiology, Section 14.7.
source_section: "14.7"
weight: 7
---
...
{{< selfcheck question="What are new sources and strategies for developing drugs to fight infectious diseases?" hint="Think about untapped environments to search, ways to generate candidate compounds synthetically, and approaches that target something other than the microbe's growth directly." >}}
...
===CHECKS===
marine environments have not been examined as fully as soil
combinatorial chemistry makes a very large number of related compounds from simple precursors to test for antimicrobial activity
compounds that inhibit bacterial resistance mechanisms can restore the activity of older drugs, such as β-lactamase inhibitors like clavulanic acid
inhibitors of virulence factor production and function could slow the progression of an infection and provide an advantage for the immune system
{{< /selfcheck >}}

{{< callout type="info" >}}
**Eye on Ethics.** *The (Free?) Market for New Antimicrobials*
...
{{< mediafigure src="microbiology/OSC_Microbio_14_01_FDAAntibio" alt="A bar graph titled New Antimicrobials Approved by FDA, 1983-2012, plotting the number of antimicrobial approvals against six five-year periods. The bars fall steadily: 16 for 1983-1987, 14 for 1988-1992, 10 for 1993-1997, 7 for 1998-2002, 5 for 2003-2007, and 2 for 2008-2012." kind="diagram" eager="true" >}}
...
To further examine the scope of the problem, view [this video on the shortage of new antimicrobial drugs](https://openstax.org/l/22PBSDecAntimic).

To [learn more about the history of antimicrobial drug discovery](https://openstax.org/l/22MSUAntResLeaH), visit Michigan State University's Antimicrobial Resistance Learning Site.
{{< /callout >}}
...
{{< multiplechoice
  question="Which of the following has yielded compounds with the most antimicrobial activity?"
  answer="soil"
  hint="Consider which natural environment the iChip and its first major discovery, described above, both came from."
>}}
water
air
volcanoes
...
{{< multiplechoice
  question="The rate of discovery of antimicrobial drugs has decreased significantly in recent decades."
  answer="True"
  hint="Compare today's pace of new antimicrobial discovery with the FDA-approval trend the Eye on Ethics box describes."
>}}
True
False
{{< /multiplechoice >}}

{{< selfcheck question="Who should be responsible for discovering and developing new antibiotics? Support your answer with reasoning." hint="Reread the Eye on Ethics box's discussion of pharmaceutical incentives, government subsidies, and the ethical obligations of for-profit companies." >}}
...
===CHECKS===
pharmaceutical companies have moved away from antimicrobial development because such drugs are less profitable than treatments for chronic diseases
government agencies could provide financial incentives to keep pharmaceutical companies engaged in antimicrobial research
some argue drug companies have an ethical obligation to pursue high-utility drugs even where they are not highly profitable
government agencies might instead assume responsibility for developing critical drugs with little or no return on investment
{{< /selfcheck >}}
...
Mine marine environments for antimicrobial-producing microbes
Develop compounds that block a specific bacterial virulence factor
{{< /multiplechoice >}}

{{< textin
  question="Use of the iChip has resulted in the discovery of a novel antimicrobial from a soil sample collected in Maine, called ________."
  answer="teixobactin"
  hint="It is named in the same sentence that introduces the iChip's first real-world discovery."
>}}

{{< multiplechoice
  question="Which strategy involves making a very large number of related chemical compounds from simple precursors and testing them for antimicrobial activity?"
  answer="Combinatorial chemistry"
  hint="This strategy is about generating many candidate molecules synthetically, not about screening natural samples."
>}}
Development of virulence-factor inhibitors
High-throughput screening
Combinatorial chemistry
Development of resistance-mechanism inhibitors
{{< /multiplechoice >}}

{{< multiplechoice
  question="Clavulanic acid is an example of a compound that restores the activity of older antibacterial drugs by doing what?"
  answer="Inhibiting a bacterial resistance mechanism"
  hint="Think about what a resistant bacterium relies on to withstand an older antibiotic, and what would need to be blocked to restore that antibiotic's effect."
>}}
Mining marine environments for new antimicrobial producers
Inhibiting a bacterial resistance mechanism
Targeting bacterial virulence factor production
Screening large numbers of soil samples simultaneously
{{< /multiplechoice >}}

{{< selfcheck question="According to the graph in the Eye on Ethics box above, how did the number of new antimicrobials the FDA approved change between the 1988–1992 period and the 1998–2002 period?" hint="Read the height of the two bars for those two labeled periods directly off the graph." >}}

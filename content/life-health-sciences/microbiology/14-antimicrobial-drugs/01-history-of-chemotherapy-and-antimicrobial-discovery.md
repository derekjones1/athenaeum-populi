...
description: >-
  The purposeful fermentation and plant-based remedies of ancient societies,
  Paul Ehrlich's search for a chemical "magic bullet," and the discoveries of
  Salvarsan, sulfanilamide, penicillin, and the actinomycetes that opened the
  modern age of antimicrobial drug development — adapted from OpenStax
  Microbiology, Section 14.1.
source_section: "14.1"
weight: 1
---
...
The case continues in [Mechanisms of Antibacterial Drugs](/life-health-sciences/microbiology/14-antimicrobial-drugs/03-mechanisms-of-antibacterial-drugs/).
{{< /callout >}}
...
{{< selfcheck question="Give examples of how antimicrobials were used in ancient societies." hint="Reread the Use of Antimicrobials in Ancient Societies paragraph." >}}
...
===CHECKS===
purposeful fermentation of tetracycline-producing Streptomyces during beer-making, and the resulting ... beer was used to treat a variety of ailments, including gum disease and wounds
Indian and Chinese herbalists have long used plants for a wide variety of medical purposes
moldy bread or other mold-containing products to treat wounds
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_14_01_Ehrlich" alt="A black-and-white photograph of an older, bearded man in a dark suit standing in a laboratory, holding a small vial up in one hand. Behind him is a tall cabinet topped with a row of glass bottles, and a counter to his right holds many more small bottles beside a sink with two taps." kind="photo" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_14_01_Oxford" alt="Three black-and-white photographs. (a) Alexander Fleming, an older man in a white lab coat with a bow tie, sits at a bench holding a small round dish. (b) Beside a formal portrait of a bespectacled man in a suit (Howard Florey) is a photograph of a mustached man in a lab coat (Ernst Chain) leaning over a round-bottomed flask and glass apparatus under a desk lamp." kind="photo" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_14_01_Waksman" alt="A black-and-white photograph of a balding man wearing glasses and a light-colored lab coat, leaning on a cluttered laboratory bench. In front of him sits a round-bottomed flask connected by glass tubing to condensers and other apparatus; more bottles and equipment line a shelf behind him." kind="photo" >}}
...
{{< selfcheck question="Why is the soil a reservoir for antimicrobial resistance genes?" hint="Reread the paragraph about Selman Waksman; this section does not answer the question directly." >}}
...
===CHECKS===
actinomycetes ... are the source of more than half of all natural antibiotics
continue to serve as an excellent reservoir for the discovery of novel antimicrobial agents
{{< /selfcheck >}}
...
{{< multiplechoice
  question="A scientist discovers that a soil bacterium he has been studying produces an antimicrobial that kills gram-negative bacteria. She isolates and purifies the antimicrobial compound, then chemically converts a chemical side chain to a hydroxyl group. When she tests the antimicrobial properties of this new version, she finds that this antimicrobial drug can now also kill gram-positive bacteria. The new antimicrobial drug with broad-spectrum activity is considered to be which of the following?"
  answer="semisynthetic"
  hint="Reread the paragraph about Dorothy Hodgkin."
>}}
resistant
semisynthetic
synthetic
...
{{< multiplechoice
  question="Which of the following antimicrobial drugs is synthetic?"
  answer="sulfanilamide"
  hint="Reread the paragraph about Klarer, Mietzsch, and Domagk."
>}}
sulfanilamide
penicillin
actinomycin
...
{{< selfcheck question="Where do antimicrobials come from naturally? Why?" hint="This section names the kinds of organisms that produce antimicrobials in nature; it does not explain why they do so." >}}
...
===CHECKS===
natural antibiotics are antimicrobial compounds produced naturally by microorganisms in nature
Penicillium notatum ... penicillin
actinomycetes ... are the source of more than half of all natural antibiotics
{{< /selfcheck >}}

{{< selfcheck question="In nature, why do antimicrobial-producing microbes commonly also have antimicrobial resistance genes?" hint="Reread the paragraph about Selman Waksman; this section does not answer the question directly." >}}
This section states that the actinomycetes, soil bacteria that include the genus *Streptomyces*, are known for their natural production of a wide variety of antimicrobials and are the source of more than half of all natural antibiotics. It does not say anything about antimicrobial resistance genes in these producers, so it does not answer why producers commonly also carry them.
===CHECKS===
known for their natural production of a wide variety of antimicrobials
the source of more than half of all natural antibiotics
it does not say anything about antimicrobial resistance genes in these producers
{{< /selfcheck >}}

### Describe the chemotherapeutic approaches of ancient societies

{{< multiplechoice
  question="Chemical analysis of skeletal remains of an ancient population from Nubia, dating from between 350 and 550 AD, showed residue of which antimicrobial agent, in high enough quantities to suggest purposeful fermentation during beer-making?"
  answer="tetracycline"
  hint="Reread the second sentence of Use of Antimicrobials in Ancient Societies."
>}}
penicillin
tetracycline
streptomycin
...
{{< textin question="In the 1970s, Chinese researcher Tu Youyou searched for a cure for malaria using the plant ________, which she identified by consulting a 4th-century physician's handbook." answer="Artemisia" hint="Reread the sentences about Tu Youyou in Use of Antimicrobials in Ancient Societies." >}}

{{< selfcheck question="How did Tu Youyou's team succeed in developing an effective malaria treatment from Artemisia after their initial efforts failed?" hint="Reread the sentences about Tu Youyou in Use of Antimicrobials in Ancient Societies." >}}
...
===CHECKS===
more carefully followed the 1650-year-old text's method of extracting the plant's chemicals
within a year had conducted a trial that successfully cured malaria patients
{{< /selfcheck >}}

### Describe the historically important individuals and events that led to the development of antimicrobial drugs

{{< textin question="The group of soil bacteria known for their ability to produce a wide variety of antimicrobials is called the ________." answer="actinomycetes" accept="Actinobacteria|Streptomyces" hint="Reread the paragraph about Selman Waksman." >}}

{{< textin question="A few decades later, German scientists Josef Klarer, Fritz Mietzsch, and Gerhard Domagk discovered the antibacterial activity of a synthetic dye, ________, that could treat streptococcal and staphylococcal infections in mice." answer="prontosil" hint="Reread the second paragraph of The First Antimicrobial Drugs." >}}

{{< selfcheck question="Why was Salvarsan considered to be a “magic bullet” for the treatment of syphilis?" hint="Reread the first paragraph of The First Antimicrobial Drugs." >}}
...
Compound 606 targeted the bacterium Treponema pallidum, the causative agent of syphilis
found to successfully cure syphilis in rabbits and soon after was marketed under the name Salvarsan as a remedy for the disease in humans
{{< /selfcheck >}}

---

<small>This section is adapted from [Microbiology, Section 14.1: History of Chemotherapy and Antimicrobial Discovery](https://openstax.org/books/microbiology/pages/14-1-history-of-chemotherapy-and-antimicrobial-discovery) by Nina Parker, Mark Schneegurt, Anh-Hue Thi Tu, Philip Lister, Brian M. Forster, and OpenStax, © OpenStax, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). Access the original for free at [openstax.org](https://openstax.org/details/books/microbiology). Changes: all four source figures are re-encoded as WebP and rendered as mediafigures, all `kind="photo"`; the Ehrlich alt is rewritten because the source alt calls the image a "Drawing" when the rendered photograph is a black-and-white photographic portrait, not a line drawing (reported as a suspected source-alt defect); the Woodcut and Oxford alts are rewritten from the image because the source alts ("Photo of a variety of plants being sold by a street vendor," "a) Photo of Alexander Fleming. B) Photo of Howard Florey and Ernst Chain.") do not describe what is actually drawn or how many photographs the Oxford figure holds; two cross-references to the same-module figures are rendered as parenthetical pointers ("pictured below") rather than print figure numbers. The six source footnotes are rendered as inline parenthetical citations after the sentences they support, author names and titles unabridged; none carries a DOI or a bare access URL. Both body Check Your Understanding bullets are rendered as self-checks at their note positions rather than graded: the ancient-societies bullet asks for a list of examples the module gives in three separate places, and the soil-reservoir bullet asks why soil is a reservoir for antimicrobial *resistance* genes specifically, a connection this module's text never states (it only says the actinomycetes are a reservoir for antimicrobial *discovery*) — both self-check model answers are built only from what the module actually says, the second one saying so explicitly rather than inventing the missing reasoning. Of the module's six source exercises, both Multiple Choice items and the Fill in the Blank item are adapted into Practice, source order and options kept; of the two unkeyed Short Answer questions, neither is fixed by one module sentence, so both are self-checks with model answers assembled strictly from this module's own text; the one unkeyed Critical Thinking question ("In nature, why do antimicrobial-producing microbes commonly also have antimicrobial resistance genes?") — a different ask from the soil-reservoir Check Your Understanding bullet (producer self-resistance, not a soil-wide reservoir) — is kept as a Practice self-check under the "natural, semisynthetic, and synthetic" objective, its model answer stating only what the module says about these producers (the actinomycetes' natural production of a wide variety of antimicrobials) and saying explicitly that the module says nothing about their resistance genes. Three filler items fill the "ancient societies" objective and complete the section's practice floor, all built strictly from this module's own sentences with no new claim: a multiple choice on the Nubian tetracycline residue (distractors are other antimicrobials this module names), a text-recall cloze naming the plant *Artemisia*, and a self-check on how Tu Youyou's team succeeded after their initial efforts failed; a fourth filler, a text-recall cloze naming prontosil built from the body sentence that introduces it (not the Summary sentence, which would print the key of the source "Which of the following antimicrobial drugs is synthetic?" item), fills the "historically important individuals and events" objective to the three-item floor. The Fill in the Blank on the actinomycetes accepts "Actinobacteria" and "Streptomyces", the module's own names for the group and genus it calls "known for their natural production of a wide variety of antimicrobials." The source's "Handbook of Prescription's for Emergencies" (a stray possessive apostrophe in a book title) is printed here as "Handbook of Prescriptions for Emergencies," disclosed here as a suspected one-word source defect; the printed text otherwise keeps the source's own inconsistent naming of the Nobel Prize in Physiology or Medicine (given as "Medicine," "Physiology and Medicine," and "Physiology or Medicine" at different points in this same module) exactly as printed, reviewed and not corrected. The claim pass corrected one source name: the streptomycin co-discoverer the source calls "Arthur Shatz" is Albert Schatz, with a Source note giving the discovery paper.</small>

...
{{< selfcheck question="Give examples of how antimicrobials were used in ancient societies." hint="This subsection names three different ancient uses of antimicrobials: a fermented drink, plant remedies, and mold-containing products." >}}
...
{{< selfcheck question="Why is the soil a reservoir for antimicrobial resistance genes?" hint="This section states only one fact about soil bacteria and natural antibiotics on this point; it does not spell out the resistance-gene connection itself." >}}
...
{{< multiplechoice
  ...
  hint="Recall what a chemical modification made to an already-natural antibiotic, without starting from a chemical not found in nature, is called."
>}}
resistant
semisynthetic
synthetic
...
{{< multiplechoice
  ...
  hint="Recall which drug in this list was developed from a synthetic dye rather than isolated from a living organism."
>}}
sulfanilamide
penicillin
actinomycin
...
{{< selfcheck question="In nature, why do antimicrobial-producing microbes commonly also have antimicrobial resistance genes?" hint="Recall which soil bacteria this section names as antimicrobial producers, and think about what a microbe that manufactures a toxic compound would need in order to avoid killing itself." >}}
...
===CHECKS===
producers such as the actinomycetes are the source of most natural antibiotics
a microbe that manufactures an antimicrobial compound must have a way to survive its own product
the module does not go further than this
{{< /selfcheck >}}
...
{{< multiplechoice
  ...
  answer="tetracycline"
  hint="Name the antimicrobial this section says was found in the skeletal remains; the same paragraph names the soil bacterium genus fermented to produce it."
>}}
penicillin
tetracycline
streptomycin
...
{{< textin question="In the 1970s, Chinese researcher Tu Youyou searched for a cure for malaria using the plant ________, which she identified by consulting a 4th-century physician's handbook." answer="Artemisia" hint="Name the plant genus, printed in italics, that Youyou's team extracted chemicals from." >}}

{{< selfcheck question="How did Tu Youyou's team succeed in developing an effective malaria treatment from Artemisia after their initial efforts failed?" hint="Recall what the team changed about their extraction method after their first attempts did not work." >}}
...
{{< textin question="The group of soil bacteria known for their ability to produce a wide variety of antimicrobials is called the ________." answer="actinomycetes" hint="Name the group of soil bacteria Selman Waksman studied, which includes the genus Streptomyces." >}}

{{< textin question="Sulfanilamide, the first synthetic antimicrobial, was discovered by Gerhard Domagk and colleagues and is a breakdown product of the synthetic dye, ________." answer="prontosil" hint="Name the synthetic dye Domagk and colleagues showed had antibacterial activity against streptococcal and staphylococcal infections." >}}

{{< selfcheck question="Why was Salvarsan considered to be a “magic bullet” for the treatment of syphilis?" hint="Recall what kind of compound Ehrlich set out to find, and what Compound 606 specifically targeted and cured." >}}

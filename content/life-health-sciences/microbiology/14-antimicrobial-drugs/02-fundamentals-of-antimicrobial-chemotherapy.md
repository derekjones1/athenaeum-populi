...
description: >-
  Bacteriostatic versus bactericidal activity, narrow- versus broad-spectrum
  drugs, superinfections, dosage, route of administration, side effects, and
  drug interactions — adapted from OpenStax Microbiology, Section 14.2.
source_section: "14.2"
weight: 2
---
...
{{< mediafigure src="microbiology/OSC_Microbio_14_04_Supinfect" alt="A three-panel diagram of superinfection. Panel 1, normal microbiota: a mix of orange rods, tan rods, orange wavy rods, and blue circles, with one dark-blue rod labeled pathogen. Panel 2, broad-spectrum antibiotics kill nonresistant cells: the same mix, every cell marked with a black X except the pathogen rod, which is unmarked. Panel 3, drug-resistant pathogens proliferate: many dark-blue rods matching the surviving pathogen, no other cell types." kind="diagram" eager="true" >}}
...
the antibacterial intended for the preexisting infection kills the protective microbiota
another pathogen resistant to the antibacterial to proliferate and cause a secondary infection
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_14_04_PlasConcen" alt="A line graph of plasma drug concentration (y-axis) against time from t₀ to t₄ (x-axis), with three curves for oral, intramuscular (IM), and intravenous (IV) administration. The IV curve rises fastest and highest right after t₀, then falls off steadily. The IM curve rises more slowly to a lower peak near t₁ and falls at about the same rate as the IV curve. The oral curve rises slowest of the three, peaking later and lower than the IM curve, then declines gradually until all three curves meet near zero by t₄." kind="diagram" >}}
On this graph, t<sub>0</sub> represents the time at which a drug dose is administered. The curves illustrate how plasma concentration of the drug changes over specific intervals of time (t<sub>1</sub> through t<sub>4</sub>). As the graph shows, when a drug is administered intravenously, the concentration peaks very quickly and then gradually decreases. When drugs are administered orally or intramuscularly, it takes longer for the concentration to reach its peak.
{{< /mediafigure >}}

**Check Your Understanding**

{{< selfcheck question="List five factors to consider when determining the dosage of a drug." hint="The Dosage and Route of Administration discussion names several patient-side and drug-side factors that affect an appropriate dose." >}}
Factors to consider when determining the dosage of a drug include the patient's mass (particularly in children), the patient's liver and kidney function (which affects drug metabolism and clearance), the drug's half-life (which affects how often it must be dosed), whether the drug is dose dependent or time dependent, and the route of administration (which affects how quickly and how high plasma levels of the drug rise).
===CHECKS===
the patient's mass
the patient's liver and kidney function
the drug's half-life
whether the drug is dose dependent or time dependent
...
reduce drug metabolism or clearance, resulting in increased drug levels that may lead to toxicity
a longer half-life ... drug levels ... remain in the body for a longer time
{{< /selfcheck >}}
...
===CHECKS===
empiric therapy to cover a wide range of potential pathogens while waiting on laboratory identification
polymicrobic infections ... or as prophylactic prevention of infections with surgery or invasive procedures
when a narrow-spectrum drug has failed because the target pathogen developed drug resistance
{{< /selfcheck >}}
...
a history of liver or kidney dysfunction
reduced drug metabolism or clearance from the body, resulting in increased drug levels that may lead to toxicity
{{< /selfcheck >}}
...
fails to kill the target organisms to expected levels
selects for drug-resistant variants within the target population and within the patient's microbiota
{{< /selfcheck >}}

...
{{< mediafigure src="microbiology/OSC_Microbio_14_03_antifungal" alt="A fungal cell with insets showing five drug-target sites: the nucleus and a mitochondrion inside the cell, and a zoomed section of the cell wall and membrane showing chitin fibers, glucan fibers crossed by rod-like bundles, and membrane sterols, each labeled with the drug class that inhibits it there." longdesc="Left inset: a fungal cell cross-section with its nucleus and several mitochondria; one arrow from the nucleus reads 'Inhibit DNA and RNA synthesis: flucytosine,' and one arrow from a mitochondrion reads 'Inhibit mitochondria function: naphthoquinone.' A callout zooms into a boxed section of the cell's outer layers. Right panel, top to bottom: an unlabeled outer layer of pink branched fibers; beneath it, green wavy fibers (β(1→3) glucans), labeled by an arrow 'Inhibit synthesis of β(1→3) glucans: echinocandins', crossed by bundles of gold rod-like fibers (chitin), labeled by an arrow 'Inhibit chitin synthesis: polyoxins and nikkomycins'; below that, a plasma membrane studded with teal molecules labeled 'ergosterol,' labeled by two more arrows 'Disrupt membrane: polyenes' and 'Inhibit ergosterol synthesis: imidazole and allylamine.' In the left-hand fungal cell inset, arrows read 'Inhibit DNA and RNA synthesis: flucytosine' (to the nucleus), 'Disrupt microtubule function: griseofulvin' (to the cell periphery), and 'Inhibit mitochondria function: naphthoquinone' (to a mitochondrion)." kind="diagram" >}}
...
{{< selfcheck question="How is disruption of ergosterol biosynthesis an effective mode of action for antifungals?" hint="Recall which sterol human cell membranes use instead of ergosterol, discussed at the start of this section." >}}
...
{{< selfcheck question="List two modes of action for antiprotozoan drugs." hint="This section groups antiprotozoan drugs by whether they act as antimetabolites, interfere with nucleic acid synthesis, inhibit heme detoxification, or produce reactive oxygen species — name any two." >}}
...
{{< multiplechoice
  ...
  hint="Recall what this section's opening sentence says helminths have in common with the organisms whose cells they closely resemble."
>}}
...
{{< multiplechoice
  ...
  answer="cholesterol"
  hint="Recall which sterol human cell membranes use instead of ergosterol — that is the one antifungal drugs do not need to target."
>}}
ergosterol
chitin
cholesterol
...
{{< multiplechoice
  ...
  answer="avermectins"
  hint="Recall which drug class binds glutamate-gated chloride channels specific to invertebrates, blocking neuronal transmission and causing paralysis."
>}}
quinolines
avermectins
amantadines
...
{{< multiplechoice
  ...
  hint="Recall which of these is a synthetic nucleoside analog specifically used against HIV reverse transcriptase, distinct from the guanosine analogs used against herpes viruses."
>}}
acyclovir
ribavirin
adenine-arabinoside
...
{{< multiplechoice
  ...
  answer="artemisinin"
  hint="Recall which antimalarial drug is thought to act as a prodrug that is metabolized into reactive oxygen species that damage target cells."
>}}
artemisinin
amphotericin b
praziquantel
...
{{< multiplechoice
  ...
  answer="True"
  hint="This item tests whether the echinocandins' nickname correctly describes their target, the polysaccharide found in fungal cell walls."
>}}
True
False
{{< /multiplechoice >}}

{{< textin question="Antiviral drugs, like Tamiflu and Relenza, that are effective against the influenza virus by preventing viral escape from host cells are called ________." answer="neuraminidase inhibitors" hint="Name the drug class, exemplified by Tamiflu and Relenza, that blocks the influenza enzyme responsible for releasing new virus particles from infected cells." >}}

{{< selfcheck question="How does the biology of HIV necessitate the need to treat HIV infections with multiple drugs?" hint="Recall what the HIV discussion says about the HIV reverse transcriptase's error rate, and what the module says ART typically combines because of it." >}}
...
{{< multiplechoice
  question="How does the insolubility of niclosamide aid its effectiveness as a treatment for tapeworm infection?"
  ...
  hint="Recall what the module says happens to a drug that is not absorbed into the bloodstream from the gastrointestinal tract."
>}}
...
{{< multiplechoice
  ...
  answer="Structure A"
  hint="A nucleoside pairs a nitrogen-containing ring system with a small ring; compare how many rings each structure has and how they connect, rather than relying on any drug name you may recognize."
>}}
Structure A
Structure B
Structure C
...
{{< selfcheck question="Why can't drugs used to treat influenza, like amantadines and neuraminidase inhibitors, be used to treat a wider variety of viral infections?" hint="Recall that both drug classes named in this question bind a protein or enzyme specific to the influenza virus rather than something shared by many kinds of viruses." >}}

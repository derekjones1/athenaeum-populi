...
description: >-
  How antifungal, antiprotozoan, antihelminthic, and antiviral drugs exploit
  differences between microbial and human cells — ergosterol synthesis and
  binding, cell-wall and chitin synthesis, microtubule and DNA-replication
  inhibition, neuraminidase and reverse-transcriptase targeting, and why
  combination antiretroviral therapy is needed against HIV — adapted from
  OpenStax Microbiology, Section 14.4.
source_section: "14.4"
weight: 4
---
...
{{< mediafigure src="microbiology/OSC_Microbio_14_03_sterols" alt="Two skeletal chemical structures side by side, cholesterol and ergosterol, each a four-ring fused steroid backbone with a hydroxyl group at one end and a branched carbon side chain at the other; the two differ only in the placement of a few double bonds and methyl branches along the rings and side chain." kind="diagram" eager="true" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_14_03_antifungal" alt="A fungal cell with insets showing six drug-target sites: the nucleus, the cell periphery, and a mitochondrion inside the cell, and a zoomed section of the cell wall and membrane showing glucan fibers, chitin fiber bundles, and membrane ergosterol, each labeled with the drug class that inhibits it there." longdesc="Left inset: a fungal cell cross-section, its outer wall teal, with a purple nucleus holding two unlabeled DNA double helices, five orange mitochondria and small red and green dots scattered through the cytoplasm, and thin gray fibers running just inside the wall. Three arrows point into the cell: 'Inhibit DNA and RNA synthesis: flucytosine' to a DNA helix in the nucleus; 'Disrupt microtubule function: griseofulvin' to the thin gray fibers at the cell periphery; and 'Inhibit mitochondria function: naphthoquinone' to a mitochondrion. A small boxed region on the cell wall connects, by a curved gray arrow, to a zoomed-in cross-section at right. Right panel, top to bottom: an unlabeled outer layer of pink branched fibers; beneath it, green wavy fibers (β(1→3) glucans) crossed by bundles of gold rod-like fibers (chitin) — an arrow labeled 'Inhibit synthesis of β(1→3) glucans: echinocandins' points to the green fibers, and one labeled 'Inhibit chitin synthesis: polyoxins and nikkomycins' points to a gold chitin bundle; below that, a phospholipid bilayer plasma membrane studded with five teal ergosterol molecules, three of which carry their own arrows — 'Disrupt membrane: polyenes' to the leftmost, 'Inhibit ergosterol synthesis: imidazole and allylamine' to the fourth, and the plain label 'ergosterol' to the fifth, at the right end, naming the molecule itself without a drug." kind="diagram" >}}
...
| Inhibit ergosterol synthesis | Triazoles | Fluconazole | Systemic yeast infections, oral thrush, and cryptococcal meningitis |
| Inhibit ergosterol synthesis | Allylamines | Terbinafine | Dermatophytic skin infections (athlete's foot, ring worm, jock itch), and infections of fingernails and toenails |
...
| Bind ergosterol in the cell membrane and create pores that disrupt the membrane | Polyenes | Amphotericin B | Variety systemic fungal infections |
| Inhibit cell wall synthesis | Echinocandins | Caspofungin | Aspergillosis and systemic yeast infections |
| Inhibit cell wall synthesis | Not applicable | Nikkomycin Z | Coccidioidomycosis (Valley fever) and yeast infections |
...
{{< selfcheck question="How is disruption of ergosterol biosynthesis an effective mode of action for antifungals?" hint="Reread the first paragraph of Antifungal Drugs." >}}
...
===CHECKS===
human cell membranes use cholesterol, instead of ergosterol
antifungal drugs that target ergosterol synthesis are selectively toxic
{{< /selfcheck >}}

{{< callout type="info" >}}
**Case in Point.** *Treating a Fungal Infection of the Lungs*
...
{{< mediafigure src="microbiology/OSC_Microbio_14_03_Pjiroveci" alt="A light micrograph of green-stained lung tissue containing about a dozen dark, round to oval cells scattered through it; two of the dark cells are marked P. jirovecii by leader lines, and a leader line elsewhere marks the green background as lung tissue." kind="photo" >}}
...
One class of antiprotozoan drugs, the nitroimidazoles, interferes with nucleic acid synthesis; a second class, the quinolines, acts on heme detoxification, as described below. *(Source note: the source's topic sentence says "Two classes of antiprotozoan drugs interfere with nucleic acid synthesis: nitroimidazoles and quinolines"; this section's own quinolines paragraph, its Common Antiprotozoan Drugs table, and the book's Glossary all give the quinolines' mechanism as interfering with heme detoxification, so the sentence is corrected here; see the erratum named in the footer.)* Nitroimidazoles, including semisynthetic metronidazole, which was discussed previously as an antibacterial drug, and synthetic tinidazole, are useful in combating a wide variety of protozoan pathogens, such as *Giardia lamblia*, *Entamoeba histolytica*, and *Trichomonas vaginalis*. Upon introduction into these cells in low-oxygen environments, nitroimidazoles become activated and introduce DNA strand breakage, interfering with DNA replication in target cells. Unfortunately, metronidazole is associated with carcinogenesis (the development of cancer) in humans.
...
| Inhibit folic acid synthesis | Not applicable | Proquanil (proguanil) | Combination therapy with atovaquone for malaria treatment and prevention |
| Inhibit folic acid synthesis | Sulfonamide | Sulfadiazine | Malaria and toxoplasmosis |
| Inhibit folic acid synthesis | Not applicable | Pyrimethamine | Combination therapy with sulfadoxine (sulfa drug) for malaria |
...
| Inhibit DNA synthesis | Not applicable | Pentamidine | African sleeping sickness and leishmaniasis |
| Inhibit heme detoxification | Quinolines | Chloroquine | Malaria and infections with *E. histolytica* |
| Inhibit heme detoxification | Quinolines | Mepacrine, mefloquine | Malaria |

*Common Antiprotozoan Drugs*

**Check Your Understanding**

{{< selfcheck question="List two modes of action for antiprotozoan drugs." hint="Reread the Antiprotozoan Drugs paragraphs, or the Common Antiprotozoan Drugs table." >}}
...
===CHECKS===
antimetabolites that block electron transport or inhibit folic acid synthesis
interfere with nucleic acid synthesis
inhibit heme detoxification
produce reactive oxygen species that damage target cells
{{< /selfcheck >}}
...
{{< multiplechoice
  question="Why are antihelminthic drugs difficult to develop?"
  answer="Because helminths are multicellular eukaryotes like humans"
  hint="Reread the first sentence of Antihelminthic Drugs."
>}}
Because viruses are obligate intracellular pathogens that use the host's cellular machinery to replicate
Because fungal cell membranes use ergosterol instead of cholesterol
Because helminths are multicellular eukaryotes like humans
Because protozoan drugs must bind to the DNA found within a parasite's kinetoplast
{{< /multiplechoice >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_14_03_ART" alt="A diagram of an HIV particle and a host cell, with a red X marking each of four blocked steps: the virus's surface proteins binding the cell's CD4 and CCR5 receptors, its RNA converting to DNA, that DNA integrating into the host chromosome, and new viral proteins being processed at the cell surface as new particles bud off." longdesc="A reference HIV particle, plainly labeled 'HIV,' sits at the far upper left, unconnected to the cell. A second, separate HIV particle just to its right, its two kinds of surface spike labeled GP120 and GP41, approaches the host cell membrane, which is studded with repeated copies of two receptor proteins labeled CD4 receptor and CCR5 co-receptor; a red X drawn where the virus contacts the membrane is labeled fusion inhibitors (enfuvirtide). At left, a third HIV particle is fusing with the membrane, its viral RNA (a red squiggle) shown converting into DNA (an orange-and-white double helix), blocked by a red X labeled reverse-transcriptase inhibitors (AZT and etravirine). A brown arrow carries this viral DNA toward a dashed circle representing the nucleus, where it is blocked by a red X, labeled integrase inhibitors (raltegravir), just short of the chromosome — a blue double helix with an orange viral-DNA segment already shown integrated at its center, illustrating the outcome the inhibitor prevents. Past the chromosome, two arrows lead to two new red viral-RNA squiggles. Above the left one sits a cluster of small colored dots representing viral proteins; three short arrows lead from it to a second, looser cluster, and a red X across those arrows is labeled protease inhibitors (ritonavir); two arrows lead on from the second cluster to a fourth HIV particle budding from the membrane at the right. The right RNA squiggle's own long arrow runs straight to that budding particle, unblocked. A fifth, free and complete virion is drawn just beyond it at the upper right." kind="diagram" >}}
...
| Nucleoside analog inhibition of nucleic acid synthesis | Azidothymidine/zidovudine (AZT) | HIV infections |
| Nucleoside analog inhibition of nucleic acid synthesis | Ribavirin | Hepatitis C virus and respiratory syncytial virus infections |
| Nucleoside analog inhibition of nucleic acid synthesis | Vidarabine | Herpes virus infections |
| Nucleoside analog inhibition of nucleic acid synthesis | Sofosbuvir | Hepatitis C virus infections |
...
| Inhibit neuraminadase (neuraminidase) | Olsetamivir (oseltamivir), zanamivir, peramivir | Infections with influenza virus |
| Inhibit viral uncoating | Pleconaril | Serious enterovirus infections |
| Inhibition of protease | Ritonavir | HIV infections |
| Inhibition of protease | Simeprevir | Hepatitis C virus infections |
| Inhibition of integrase | Raltegravir | HIV infections |
| Inhibition of membrane fusion | Enfuviritide (enfuvirtide) | HIV infections |

*Common Antiviral Drugs*

**Check Your Understanding**

{{< selfcheck question="Why is HIV difficult to treat with antivirals?" hint="The paragraph right before the drug-class list names three separate reasons HIV is hard to treat." >}}
...
===CHECKS===
HIV targets CD4-positive white blood cells, which are necessary for a normal immune response
HIV is a retrovirus ... it converts its RNA genome into a DNA copy that integrates into the host cell's genome, thus hiding within host cell DNA
...
To learn more about the various classes of antiretroviral drugs used in the ART of HIV infection, explore each of the drugs in the HIV drug classes described by the US Department of Health and Human Services at HIV.gov (hiv.gov).
{{< /callout >}}
...
{{< multiplechoice
  question="Which of the following is not an appropriate target for antifungal drugs?"
  answer="cholesterol"
  hint="Reread the first paragraph of Antifungal Drugs."
>}}
ergosterol
chitin
cholesterol
...
{{< multiplechoice
  question="Which of the following drug classes specifically inhibits neuronal transmission in helminths?"
  answer="avermectins"
  hint="Reread the second paragraph of Antihelminthic Drugs."
>}}
quinolines
avermectins
amantadines
...
{{< multiplechoice
  question="Which of the following is a nucleoside analog commonly used as a reverse transcriptase inhibitor in the treatment of HIV?"
  answer="azidothymidine"
  hint="Reread the paragraph after the HIV difficulty paragraph near the end of Antiviral Drugs."
>}}
acyclovir
ribavirin
adenine-arabinoside
...
{{< multiplechoice
  question="Which of the following is an antimalarial drug that is thought to increase ROS levels in target cells?"
  answer="artemisinin"
  hint="Reread the second paragraph of Antiprotozoan Drugs."
>}}
artemisinin
amphotericin b
praziquantel
...
{{< multiplechoice
  question="Echinocandins, known as \"penicillin for fungi,\" target $\beta(1\to3)$ glucan in fungal cell walls."
  answer="True"
  hint="Reread the paragraph just above the antifungal-targets figure."
>}}
True
False
{{< /multiplechoice >}}

{{< textin question="Antiviral drugs, like Tamiflu and Relenza, that are effective against the influenza virus by preventing viral escape from host cells are called ________." answer="neuraminidase inhibitors" hint="Reread the fifth paragraph of Antiviral Drugs." >}}

{{< selfcheck question="How does the biology of HIV necessitate the need to treat HIV infections with multiple drugs?" hint="Reread the two HIV paragraphs near the end of Antiviral Drugs." >}}
...
===CHECKS===
the HIV reverse transcriptase lacks proofreading activity and introduces mutations that allow for rapid development of antiviral drug resistance
a combination of specific synthetic antiviral drugs is typically used in ART for HIV
reverse transcriptase inhibitors, protease inhibitors, integrase inhibitors, and drugs that interfere with viral binding and fusion
{{< /selfcheck >}}

{{< multiplechoice
  question="Niclosamide is insoluble and thus is not readily absorbed from the stomach into the bloodstream. How does the insolubility of niclosamide aid its effectiveness as a treatment for tapeworm infection?"
  answer="It is not absorbed from the gastrointestinal tract, so it can achieve high localized intestinal concentrations where tapeworms live"
  hint="Reread the third paragraph of Antihelminthic Drugs."
>}}
It binds to helminthic β-tubulin, preventing microtubule formation
It is not absorbed from the gastrointestinal tract, so it can achieve high localized intestinal concentrations where tapeworms live
It binds to glutamate-gated chloride channels, blocking neuronal transmission in the worm
It induces an influx of calcium into the worm, causing intense spasm and paralysis
{{< /multiplechoice >}}

{{< mediafigure src="microbiology/OSC_Microbio_14_03_nucleoside_img" alt="Four numbered chemical structures. A: a fused two-ring nitrogen-containing system joined to a separate five-membered ring bearing three oxygen substituents. B: a central carbon joined to a five-membered, two-nitrogen ring and three six-membered rings, one chlorine-substituted. C: three fused six-membered rings, chlorine- and methoxy-substituted, linked through nitrogen to a methyl-branched three-carbon chain ending in a nitrogen bonded to two ethyl groups. D: a long unsaturated carbon chain closed into a large ring with hydroxyl groups, a carboxylic acid, and a second oxygen-linked ring." longdesc="A: a bicyclic system of a six-membered and a five-membered ring, both containing nitrogen atoms, joined by a single bond to a separate five-membered ring that carries two hydroxyl groups and one hydroxymethyl group. B: a central carbon atom bonded to a five-membered ring containing two nitrogen atoms and to three six-membered carbon rings, one of which carries a chlorine substituent. C: three fused six-membered rings, one bearing a chlorine substituent and another a methoxy substituent, linked through a nitrogen atom to a three-carbon chain, with a methyl branch on its first carbon, that ends in a nitrogen atom bonded to two ethyl groups. D: a long carbon chain with six carbon–carbon double bonds (two, then two single bonds, then four more in alternation) and several hydroxyl substituents, closed into a large ring through an ester linkage; the large ring also includes a six-membered oxygen-containing ring bearing a carboxylic acid group, with a separate six-membered ring attached by an oxygen bridge and carrying its own hydroxyl and amino substituents." kind="diagram" >}}
Four numbered chemical structures, each a candidate answer for the multiple-choice question below.
{{< /mediafigure >}}

{{< multiplechoice
  question="Which of the following molecules is an example of a nucleoside analog?"
  answer="Structure A"
  hint="Compare each structure with the guanosine structure drawn in the acyclovir figure."
>}}
Structure A
Structure B
Structure C
...
{{< selfcheck question="Why can't drugs used to treat influenza, like amantadines and neuraminidase inhibitors, be used to treat a wider variety of viral infections?" hint="Reread the amantadine and neuraminidase inhibitor paragraphs of Antiviral Drugs." >}}

...
description: >-
  The anatomy of the upper and lower respiratory tract, its normal
  microbiota, and the mucosal and cellular defenses microorganisms must
  overcome to cause a respiratory infection — adapted from OpenStax
  Microbiology, Section 22.1.
source_section: "22.1"
weight: 1
---
...
*The case continues in [Bacterial Infections of the Respiratory Tract](/life-health-sciences/microbiology/22-respiratory-system-infections/02-bacterial-infections-of-the-respiratory-tract/).*
{{< /callout >}}
...
The respiratory system can be conceptually divided into upper and lower regions at the point of the **epiglottis**, the structure that seals off the lower respiratory system from the **pharynx** during swallowing (shown below). The upper respiratory system is in direct contact with the external environment. The nares (or nostrils) are the external openings of the nose that lead back into the **nasal cavity**, a large air-filled space behind the nares. These anatomical sites constitute the primary opening and first section of the respiratory tract, respectively. The nasal cavity is lined with hairs that trap large particles, like dust and pollen, and prevent their access to deeper tissues. The nasal cavity is also lined with a mucous membrane and Bowman's glands that produce mucus to help trap particles and microorganisms for removal. The nasal cavity is connected to several other air-filled spaces. The sinuses, a set of four, paired small cavities in the skull, communicate with the nasal cavity through a series of small openings. The **nasopharynx** is part of the upper throat extending from the posterior nasal cavity. The nasopharynx carries air inhaled through the nose. The middle ear is connected to the nasopharynx through the **eustachian tube**. The middle ear is separated from the outer ear by the **tympanic membrane**, or ear drum. And finally, the lacrimal glands drain to the nasal cavity through the **nasolacrimal ducts** (tear ducts). The open connections between these sites allow microorganisms to move from the nasal cavity to the sinuses, middle ears (and back), and down into the lower respiratory tract from the nasopharynx.

The oral cavity is a secondary opening for the respiratory tract. The oral and nasal cavities connect through the fauces to the pharynx, or throat. The pharynx can be divided into three regions: the nasopharynx, the **oropharynx**, and the **laryngopharynx**. Air inhaled through the mouth does not pass through the nasopharynx; it proceeds first through the oropharynx and then through the laryngopharynx. The **palatine tonsils**, which consist of lymphoid tissue, are located within the oropharynx. The laryngopharynx, the last portion of the pharynx, connects to the **larynx**, which contains the vocal fold (shown below).

{{< mediafigure src="microbiology/OSC_Microbio_22_01_UpperResp" kind="diagram" eager="true" alt="Two drawn panels. (a) The outer, middle, and inner ear in cross-section: a canal runs from the outer ear to a membrane, behind which sits an air-filled cavity holding tiny bones, with a tube running down toward the throat and a coiled structure beside it. (b) A head and neck in profile, mouth open: air-filled spaces sit above and behind the nose; a passage runs from behind the nose down past the mouth to a flap-guarded opening, leading into a neck tube that continues into the chest; the tongue and patches of lymphoid tissue line the mouth and the passage's upper walls." longdesc="Panel (a), the ear, top to bottom: a canal leads in from the outer ear to a disk-shaped membrane; just behind the membrane is an air-filled cavity containing small bones; a narrow tube runs downward from this cavity toward the throat; beside the cavity sits a coiled, shell-like structure. Panel (b), the head and neck in profile, drawn from above downward: an air-filled space sits in the bone above the nose, and a second one behind and above the nasal space; the nasal space itself opens into a short duct running toward the eye; below the nasal space, a single passage runs backward and then down, first behind the nose, then behind the mouth, then past a lump of lymphoid tissue at the back of the tongue; a raised patch of tissue sits at the very top of this passage, and another patch sits at the side wall where the mouth's cavity opens into it; the passage narrows and, guarded by a flap, opens into a short tube in the neck; that tube continues downward, in front of the spine and a gland at its base, into the chest; a second, thinner tube begins at the flap and runs down beside the first one." >}}
...
nasopharynx to the oropharynx and then the laryngopharynx
laryngopharynx connects to the larynx
{{< /selfcheck >}}

{{< multiplechoice
  question="What two anatomical points do the eustachian tubes connect?"
  answer="The middle ear and the nasopharynx"
  hint="This is the same connection that lets pressure changes in one of these spaces be felt in the other, such as when swallowing on a descending flight."
>}}
The nasal cavity and the sinuses
The middle ear and the nasopharynx
The lacrimal glands and the nasal cavity
The outer ear and the middle ear
{{< /multiplechoice >}}

## Anatomy of the Lower Respiratory System

The lower respiratory system begins below the epiglottis in the larynx or voice box (shown below). The **trachea**, or windpipe, is a cartilaginous tube extending from the larynx that provides an unobstructed path for air to reach the lungs. The trachea bifurcates into the left and right **bronchi** as it reaches the lungs. These paths branch repeatedly to form smaller and more extensive networks of tubes, the **bronchioles**. The terminal bronchioles formed in this tree-like network end in cul-de-sacs called the **alveoli**. These structures are surrounded by capillary networks and are the site of gas exchange in the respiratory system. Human lungs contain on the order of 400,000,000 alveoli. The outer surface of the lungs is protected with a double-layered pleural membrane. This structure protects the lungs and provides lubrication to permit the lungs to move easily during respiration.

{{< mediafigure src="microbiology/OSC_Microbio_22_01_LowerResp" kind="diagram" alt="A drawing of a person's upper body from behind, airway and lungs inside the torso. A flap tops a short neck tube that continues into a longer chest tube, which splits into two branches, one per lung; inside one lung, the branch divides repeatedly into thinner branches ending in small, rounded terminal branches. A sheet-like structure spans the torso's base below the lungs. Two insets zoom in on one terminal branch: the first a cluster of small round sacs threaded with fine vessels; the second one enlarged sac, its wall meshed with vessels and crossed by two small opposite-pointing arrows." longdesc="The main drawing, top to bottom: a flap sits where the throat narrows into a short tube in the neck; that tube runs down into a longer, ringed tube in the chest; the ringed tube forks into a left and a right branch, one entering each lung; inside the visible lung, that branch divides into two thinner branches, each of which divides again into even thinner branches, and those end in many small, rounded terminal branches scattered through the lung tissue; a sheet-like structure stretches across the bottom of the torso beneath both lungs. An arrow leads from one terminal branch down to the first inset panel, which enlarges it into a cluster of small round sacs wrapped in a fine web of vessels; a second arrow leads from that cluster to the final inset panel, which enlarges a single sac further: its thin wall is covered by a mesh of vessels, and two small arrows cross the wall pointing in opposite directions, one inward and one outward." >}}
...
The inner lining of the respiratory system consists of mucous membranes (shown below) and is protected by multiple immune defenses. The goblet cells within the respiratory epithelium secrete a layer of sticky mucus. The viscosity and acidity of this secretion inhibits microbial attachment to the underlying cells. In addition, the respiratory tract contains ciliated epithelial cells. The beating cilia dislodge and propel the mucus, and any trapped microbes, upward to the epiglottis, where they will be swallowed. Elimination of microbes in this manner is referred to as the mucociliary escalator effect and is an important mechanism that prevents inhaled microorganisms from migrating further into the lower respiratory tract.

{{< mediafigure src="microbiology/OSC_Microbio_22_01_MucousMem" kind="photo" alt="A stained tissue cross-section. A pale, open space runs across the top. Beneath it, a continuous band of tall, densely packed cells stands upright, their free surface fringed with fine, hair-like projections; scattered among them are wider, paler, flask-shaped cells. Below this band lies a looser layer of tissue, within which sit several small, rounded clusters of cells." >}}
...
trachea bifurcates into the left and right bronchi
bronchi branch repeatedly to form the bronchioles
...
Vaccines have been developed for many of the most serious bacterial and viral pathogens. Several of the most important respiratory pathogens and their vaccines, if available, are summarized in the table below. Components of these vaccines will be explained later in the chapter.
...
*Full names of vaccines listed in the table: Haemophilus influenzae type B (Hib); Diphtheria, tetanus, and acellular pertussis (DtaP); tetanus, diphtheria, and acellular pertussis (Tdap); diphtheria and tetanus (DT); tetanus and diphtheria (Td); diphtheria, pertussis, and tetanus (DTP); Bacillus Calmette-Guérin; Measles, mumps, rubella (MMR).*
...
polysaccharide capsules allow microbes to evade phagocytosis
endotoxins of gram-negative bacteria stimulate a strong inflammatory response
exotoxins, survival within host cells, and impairing the mucociliary escalator
{{< /selfcheck >}}
...
laryngitis: inflammation of the larynx that may interfere with vocal cord function, causing voice loss
{{< /selfcheck >}}
...
- **nasolacrimal ducts** — tear duct connecting the lacrimal glands to the nasal cavity.
...
- **palatine tonsils** — lymphoid tissue located near the oropharynx.
...
- **bronchiole** — smaller air passages within the lung that are formed as the bronchi become further subdivided.
...
{{< multiplechoice
  ...
  hint="The nasopharynx sits behind the nasal cavity; think about which of these four structures drains into the nasal cavity instead."
>}}
middle ear
oropharynx
lacrimal glands
...
{{< multiplechoice
  question="Which of these correctly orders the structures through which air passes during inhalation?"
  answer="pharynx → larynx → trachea → bronchi"
  hint="The pharynx comes first; after that, recall which structure holds the vocal fold and sits above the windpipe."
>}}
...
{{< multiplechoice
  question="The ___________ separates the upper and lower respiratory tract."
  answer="epiglottis"
  hint="This is the same structure that diverts food away from the airway during swallowing."
>}}
bronchi
larynx
epiglottis
...
{{< multiplechoice
  question="Which label marks the trachea?"
  answer="G"
  hint="Trace the narrow, ringed tube that runs down from the throat into the chest before it forks."
>}}
A
B
C
...
F is the larynx, where the lower respiratory system begins, with a small microbiota
G is the trachea, A the bronchi, and B the bronchioles, all part of the lower respiratory tract with a small microbiota
C is an alveolus, kept nearly devoid of microbes by alveolar macrophages
{{< /selfcheck >}}
...
{{< multiplechoice
  ...
  answer="goblet cells"
  hint="These same cells give the trachea's lining its distinctive vase-shaped cells under the microscope."
>}}
goblet cells
macrophages
phagocytes
...
{{< multiplechoice
  question="Which microbial virulence factor is most important for attachment to host respiratory tissues?"
  answer="adhesins"
  hint="This factor's name comes directly from the word for sticking to a surface."
>}}
adhesins
lipopolysaccharide
hyaluronidase
...
{{< textin question="Unattached microbes are moved from the lungs to the epiglottis by the _______ effect." answer="mucociliary escalator" hint="This is the same effect the beating cilia and sticky mucus of the respiratory epithelium produce together." >}}

{{< textin question="Many bacterial pathogens produce _______ to evade phagocytosis." answer="capsules" accept="capsule" hint="These are polysaccharide structures that coat the outside of a bacterial cell." >}}

{{< textin question="The main type of antibody in the mucous membrane defenses is _______." answer="IgA" hint="This antibody is named along with lysozyme, surfactant, and defensins as a mucosal defense." >}}

{{< textin question="_______ phagocytize potential pathogens in the lower lung." answer="Alveolar macrophages" accept="Alveolar macrophage" hint="These phagocytic cells sit right in the alveoli themselves, the lower respiratory tract's last line of defense." >}}
...
The lower respiratory tract is protected by mucosa-associated lymphoid tissue (MALT), secreted antibodies (IgA), lysozyme, surfactant, and antimicrobial peptides called defensins, and, in the alveoli, by alveolar macrophages that efficiently kill any microbes that evade the other defenses. The combined action of these factors renders the lower respiratory tract nearly devoid of colonized microbes.
===CHECKS===
protected by mucosa-associated lymphoid tissue (MALT), IgA, lysozyme, surfactant, and defensins
alveolar macrophages efficiently kill microbes that evade the other defenses
...
dry, caked mucus would be harder for the cilia to dislodge and propel
the mucociliary escalator would be less able to move trapped microbes out of the lower respiratory tract
{{< /selfcheck >}}

### Explain how microbes and the respiratory system interact and modify each other in healthy individuals and during an infection

{{< textin question="_______ results from an inflammation of the 'voice box.'" answer="Laryngitis" hint="The 'voice box' is another name for the larynx." >}}

{{< textin question="Pulmonary inflammation that causes the lungs to fill with fluids is called ________." answer="pneumonia" hint="This is the most serious of the conditions this section names with an '-itis'-style ending, though its own name does not end in '-itis.'" >}}
...
this reduces the lungs' ability to exchange gases

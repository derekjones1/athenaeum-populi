...
description: >-
  The phylogenetic position, extreme-environment adaptations, and significant
  representatives of deeply branching bacteria, including Acetothermus,
  Aquifex, Thermotoga, and Deinococcus radiodurans.
source_section: "4.5"
weight: 5
---
...
{{< mediafigure src="microbiology/OSC_Microbio_04_05_Dradiodura" alt="A green-tinted electron micrograph of four large round Deinococcus radiodurans cells grouped closely in a square-like cluster, with partial cells at the image edges." kind="photo" >}}
...
support hypotheses about early ancestors when the earth was hot and lacked an atmosphere
produce molecular hydrogen, which can be used in industry
{{< /selfcheck >}}
...
a peculiar sheath-like outer membrane
the ability to reduce nitrogen in anaerobic conditions

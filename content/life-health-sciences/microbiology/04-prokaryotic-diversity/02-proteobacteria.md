...
description: >-
  The distinguishing features and representative members of the alpha, beta,
  gamma, delta, and epsilon classes of Proteobacteria, including their roles
  in human disease and other environments.
source_section: "4.2"
weight: 2
---
...
{{< mediafigure src="microbiology/OSC_Microbio_04_02_RRicketsii" alt="A stained micrograph of two blue tick hemolymph cells. Small red rod-shaped R. rickettsii cells occur inside both cells; arrows identify the tick cells and a boxed cluster identifies R. rickettsii." kind="photo" eager="true" >}}
...
{{< selfcheck question="What is a common characteristic among the human pathogenic Alphaproteobacteria?" hint="Compare the descriptions of the pathogenic genera in the table with the discussion of rickettsias." >}}
...
===CHECKS===
an intracellular relationship with host cells
Rickettsias are obligate intracellular pathogens
Bartonella and Brucella are facultative intracellular bacteria
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_04_02_Neisseria" alt="A close photograph of many round, creamy white Neisseria meningitidis colonies scattered across a brown chocolate agar plate." kind="photo" >}}
...
{{< multiplechoice question="Why are *Neisseria* classified as microaerophilic?" answer="They require low levels of oxygen." hint="Look for the sentence that defines microaerophilic in the discussion of Neisseria." >}}
They require high levels of oxygen.
They require low levels of oxygen.
They cannot grow in the presence of oxygen.
They use oxygen only when growing on chocolate agar.
{{< /multiplechoice >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_04_02_Xray" alt="An anteroposterior chest radiograph. White triangles mark bilateral pulmonary infiltrates in both lungs, and black arrows outline a cavity in the right upper lung region." kind="photo" >}}
...
The case continues in [Nonproteobacteria Gram-Negative Bacteria and Phototrophic Bacteria](/life-health-sciences/microbiology/04-prokaryotic-diversity/03-nonproteobacteria-gram-negative-bacteria-and-phototrophic-bacteria/). The previous part is in [Prokaryote Habitats, Relationships, and Microbiomes](/life-health-sciences/microbiology/04-prokaryotic-diversity/01-prokaryote-habitats-relationships-and-microbiomes/).
{{< /callout >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_04_02_vibrionale" alt="Two photographs. At left, a culture plate glows green from bioluminescent Aliivibrio fischeri colonies. At right, a Hawaiian bobtail squid against a dark background is mottled brown and orange with blue-green glowing spots near its underside." kind="photo" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_04_02_Legionella" alt="Two panels. At left, a grayscale micrograph shows overlapping rod-shaped Legionella pneumophila cells. At right, a rooftop air-conditioning unit is shown among other building equipment." kind="photo" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_04_02_Salmonella" alt="A colorized scanning electron micrograph densely filled with pink rod-shaped Salmonella typhi cells. A 2 µm scale bar appears at the bottom." kind="photo" >}}
...
{{< selfcheck question="List two families of Gammaproteobacteria." hint="Look for the family names that introduce the discussion of Gammaproteobacteria and enteric bacteria." >}}
Two families of Gammaproteobacteria discussed here are *Pseudomonaceae* and *Pasteurellaceae*. Another is *Enterobacteriaceae*.
===CHECKS===
Pseudomonaceae and Pasteurellaceae
Enterobacteriaceae
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_04_02_Myxobac" alt="A color photograph of a dark myxobacterial fruiting body topped with numerous round yellow-orange sporangia. A bracket identifies the fruiting body, and an arrow identifies a sporangium containing myxospores." kind="photo" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_04_02_Hpylori" alt="A grayscale electron micrograph of a single curved, rod-shaped Helicobacter pylori cell with a tuft of several long, thin flagella extending from one pole; other flagella loop across the field around the cell." kind="photo" >}}
...
{{< selfcheck question="Name two Epsilonproteobacteria that cause gastrointestinal disorders." hint="Compare the two clinically relevant genera described in this subsection." >}}
*Campylobacter* can cause severe enteritis, and *Helicobacter* can cause chronic gastritis and peptic ulcers.
===CHECKS===
Campylobacter can cause severe enteritis
Helicobacter can cause chronic gastritis and peptic ulcers
{{< /selfcheck >}}
...
{{< multiplechoice question="Which of the following describes Proteobacteria in domain Bacteria?" answer="phylum" hint="The opening paragraph names the taxonomic rank assigned to Proteobacteria." >}}
phylum
class
species
genus
...
{{< multiplechoice question="Class Betaproteobacteria includes all but which of the following genera?" answer="*Campylobacter*." hint="Use the class headings and the genera introduced under them." >}}
*Neisseria*.
*Bordetella*.
*Leptothrix*.
*Campylobacter*.
...
{{< multiplechoice question="Which of the following Alphaproteobacteria is the cause of Rocky Mountain spotted fever and typhus?" answer="*Rickettsia*" hint="Compare the genus descriptions with the diseases named in the Alphaproteobacteria discussion." >}}
*Bartonella*
*Coxiella*
*Rickettsia*
*Ehrlichia*

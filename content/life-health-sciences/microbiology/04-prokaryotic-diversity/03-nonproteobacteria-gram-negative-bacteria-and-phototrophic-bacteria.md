...
description: >-
  The distinctive nonproteobacterial gram-negative groups and the diverse
  bacteria that capture sunlight for energy, including Chlamydia, spirochetes,
  the CFB group, Planctomycetes, sulfur bacteria, and Cyanobacteria — adapted
  from OpenStax Microbiology, Section 4.3.
source_section: "4.3"
weight: 3
---
...
Because electron microscopy provides a more detailed view of their cellular morphology.
Because their axial filament wraps around the cell in the periplasmic space.
{{< /multiplechoice >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_04_03_bacteroide" alt="A colorized scanning electron micrograph of many closely packed rod-shaped Bacteroides cells, purple with gold-edged surfaces and fine tangled strands between some cells." kind="photo" >}}
...
They all reproduce by budding.
They all perform oxygenic photosynthesis.
{{< /multiplechoice >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_04_03_planctomyc" alt="Two electron micrographs of Planctomycetes. Panel (a) shows a sessile oval cell attached to a branching holdfast on a surface; panel (b) shows a similarly shaped swarmer cell without a holdfast." kind="photo" >}}
...
By forming an endospore inside an epithelial cell.
By producing a holdfast that divides into two daughter cells.
{{< /multiplechoice >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_04_03_chromatium" alt="A clear tube containing dark purple and green bacterial growth. Arrows label the dark upper region as purple bacteria and a bright green region below as green bacteria." kind="photo" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_04_03_Cyanobact" alt="Two photographs of cyanobacteria: panel (a) is a close micrograph of a green cluster of nearly spherical cells, and panel (b) is an aerial view of a pale green bloom spreading across a lake near a wooded shoreline." kind="photo" >}}
...
| Proteobacteria | Betaproteobacteria | *Rhodocyclus* | Purple nonsulfur bacteria | Anoxygenic | None |
| Proteobacteria | Gammaproteobacteria | *Chromatium* | Purple sulfur bacteria | Anoxygenic | Inside the cell |
...
They all produce oxygen during photosynthesis.
They all deposit sulfur inside the cell.
{{< /multiplechoice >}}
...
phylum of gram-negative nonproteobacteria
share similarities in their DNA nucleotide sequences
rod-shaped bacteria adapted to anaerobic environments
avid fermenters
{{< /selfcheck >}}
...
{{< multiplechoice
  question="How do sulfur bacteria and nonsulfur bacteria differ in the electron donors they use?"
  answer="Sulfur bacteria use sulfites, whereas nonsulfur bacteria use organic substrates such as succinate and malate."
  hint="Compare the two donor categories stated directly after the tube figure."
>}}
Sulfur bacteria use sulfites, whereas nonsulfur bacteria use organic substrates such as succinate and malate.
Sulfur bacteria use water, whereas nonsulfur bacteria use carbon dioxide.
Sulfur bacteria use nitrogen, whereas nonsulfur bacteria use oxygen.
Sulfur bacteria use only organic substrates, whereas nonsulfur bacteria use only sulfites.
{{< /multiplechoice >}}

### Identify phototrophic bacteria

{{< sortbins question="Sort each bacterium by the photosynthesis type listed in the phototrophic-bacteria table." hint="Use the Oxygenic or Anoxygenic column of the table, rather than the organism's color or phylum." >}}
{"bins": ["Oxygenic", "Anoxygenic"],
 "items": [
  {"label": "Chlorobium", "bin": 1},
  {"label": "Cyanobacteria", "bin": 0},
  {"label": "Chloroflexus", "bin": 1},
  {"label": "Microcystis aeruginosa", "bin": 0},
  {"label": "Rhodospirillum", "bin": 1},
  {"label": "Cyanophyceae", "bin": 0}]}
{{< /sortbins >}}

{{< multiplechoice
  question="What are the specialized cells in which the reactions of nitrogen fixation occur in many cyanobacteria?"
  answer="heterocysts"
  hint="Look for the named specialized cells in the paragraph on cyanobacteria’s adaptable forms and habitats."
>}}
chlorosomes
heterocysts
inclusions
...
played a critical role in changing Earth’s anoxic atmosphere to the oxygen-rich environment
thrive in marine and freshwater environments, soil, and rocks

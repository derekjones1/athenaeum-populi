...
title: Archaea
description: >-
  The distinctive structures, metabolisms, environmental habitats, and known
  disease associations of archaea, including Crenarchaeota and Euryarchaeota —
  adapted from OpenStax Microbiology, Section 4.6.
source_section: "4.6"
weight: 6
---
...
Like organisms in the domain Bacteria, organisms of the domain **Archaea** are all unicellular organisms. However, archaea differ structurally from bacteria in several significant ways, as discussed in [Unique Characteristics of Prokaryotic Cells](/life-health-sciences/microbiology/03-the-cell/03-unique-characteristics-of-prokaryotic-cells/). To summarize:
...
{{< mediafigure src="microbiology/OSC_Microbio_04_06_Sulfolobus" alt="A transmission electron micrograph of a roughly spherical Sulfolobus cell with many irregular pale granules inside and a 1 µm scale bar." kind="photo" >}}
...
the most abundant microorganisms in the oceans
Most, but not all, are hyperthermophiles
Sulfolobus is a thermophile that prefers 70–80°C and an acidophile that prefers a pH of 2–3
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_04_06_Halobact" alt="A wide photograph of a salt-pond landscape divided into many rectangular evaporation ponds, some pale white and others pink to purple, beneath a cloudy sky and low brown hills." kind="photo" >}}
Halobacteria growing in these salt ponds give them a distinct purple color. (credit: modification of work by Tony Hisgett)
{{< /mediafigure >}}
...
In human gastrointestinal tracts, where they produce gases.
In strictly anaerobic environments at an optimal temperature of 85 °C.
{{< /multiplechoice >}}

{{< callout type="info" >}}
**Micro Connection.** *Finding a Link Between Archaea and Disease*
...
It is a methane-producing archaeon that reduces carbon dioxide in the presence of hydrogen.
It is a thermophile that stores sulfuric acid in granules at a preferred pH of 2–3.
{{< /multiplechoice >}}
...
They oxidize sulfur and store sulfuric acid in granules.
They form ether linkages with branched isoprene chains.
{{< /multiplechoice >}}
...
Halobacteria have been found in Martian salt ponds.
Archaea cause infectious diseases in astronauts.
{{< /multiplechoice >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_04_06_ArtConn4_img" alt="A close photograph of a dark wet bog surface covered with many small pale bubbles among green and brown plant material." kind="photo" >}}

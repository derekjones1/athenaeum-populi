...
description: >-
  How electron transport, chemiosmosis, the proton motive force, and ATP
  synthase generate ATP by oxidative phosphorylation during aerobic and
  anaerobic cellular respiration — adapted from OpenStax Microbiology,
  Section 8.3.
source_section: "8.3"
weight: 3
---
...
{{< multiplechoice
  question="Do both aerobic respiration and anaerobic respiration use an electron transport chain?"
  answer="Yes; both pass electrons through an electron transport system, but the final electron acceptor differs — oxygen in aerobic respiration, or a non-oxygen inorganic molecule in anaerobic respiration."
  hint="Reread the section's opening paragraph and the last two paragraphs under Electron Transport System."
>}}
No; anaerobic respiration makes ATP only by substrate-level phosphorylation and does not use an electron transport system.
Yes; but both aerobic and anaerobic respiration use oxygen as their final electron acceptor.
Yes; both pass electrons through an electron transport system, but the final electron acceptor differs — oxygen in aerobic respiration, or a non-oxygen inorganic molecule in anaerobic respiration.
No; an electron transport system operates only in aerobic respiration, where oxygen is the final electron acceptor.
{{< /multiplechoice >}}
...
The potential energy of this electrochemical gradient generated by the ETS causes the H⁺ to diffuse across a membrane (the plasma membrane in prokaryotic cells and the inner membrane in mitochondria in eukaryotic cells). This flow of hydrogen ions across the membrane, called **chemiosmosis**, must occur through a channel in the membrane via a membrane-bound enzyme complex called **ATP synthase** (shown below). The tendency for movement in this way is much like water accumulated on one side of a dam, moving through the dam when opened. ATP synthase (like a combination of the intake and generator of a hydroelectric dam) is a complex protein that acts as a tiny generator, turning by the force of the H⁺ diffusing through the enzyme, down their electrochemical gradient from where there are many mutually repelling H⁺ to where there are fewer H⁺. In prokaryotic cells, H⁺ flows from the outside of the cytoplasmic membrane into the cytoplasm, whereas in eukaryotic mitochondria, H⁺ flows from the intermembrane space to the mitochondrial matrix. The turning of the parts of this molecular machine regenerates ATP from ADP and inorganic phosphate (P<sub>i</sub>) by oxidative phosphorylation, a second mechanism for making ATP that harvests the potential energy stored within an electrochemical gradient.

{{< mediafigure src="microbiology/OSC_Microbio_08_03_Chemiosmos" alt="A diagram of the bacterial electron transport chain and ATP synthase spanning the cytoplasmic membrane. On the left, membrane protein complexes and the mobile carriers ubiquinone (Q) and cytochrome c (Cyt c) pass electrons from NADH and FADH₂ while pumping H⁺ to the outside of the membrane; the last complex combines the electrons with H⁺ and O₂ to form H₂O. On the right, ATP synthase spans the membrane, and an arrow shows H⁺ flowing from outside into the cytoplasm through the enzyme, driving the conversion of ADP and Pᵢ to ATP." longdesc="Left panel, labeled Electron Transport Chain, with 'outside the cytoplasmic membrane' above the membrane and 'cytoplasm' below it. Reading left to right, three tall complexes span the membrane, each with an upward arrow pumping H⁺ to the outside, and a smaller rounded protein sits in the inner half of the membrane between the first and second of them, with no H⁺ arrow of its own. The first tall complex receives electrons from NADH, which becomes NAD⁺ + H⁺ below it, and a red arrow carries its electrons to ubiquinone (Q), a small round carrier resting on top of the rounded protein. Below the rounded protein, an arrow shows FADH₂ oxidized to FAD, and a second red arrow carries those electrons up through the rounded protein to Q. From Q, a red arrow carries the electrons through the top of the second tall complex to cytochrome c (Cyt c), a small carrier on the outer surface between the second and third tall complexes, and then down through the third tall complex, where the electrons (2e⁻) combine with 2H⁺ and 1/2 O₂ to form H₂O. Right panel, labeled ATP synthase, drawn as a bulb-shaped protein spanning the membrane with five H⁺ ions clustered on the outside above it, beside a label for the cytoplasmic membrane; a shaded arrow inside the protein shows H⁺ flowing down through it into the cytoplasm, and a curved arrow beneath it runs from ADP plus Pᵢ to ATP." kind="diagram" eager="true" >}}
...
| Source | Carbon Flow | Molecules of Reduced Coenzymes Produced | Net ATP by Substrate-Level Phosphorylation | Net ATP by Oxidative Phosphorylation | Theoretical Maximum Yield of ATP Molecules |
|---|---|---|---|---|---|
| Glycolysis (EMP) | Glucose (6C) → 2 pyruvates (3C) | 2 NADH | 2 ATP | 6 ATP from 2 NADH | 8 |
| Transition reaction | 2 pyruvates (3C) → 2 acetyl (2C) + 2 CO₂ | 2 NADH | — | 6 ATP from 2 NADH | 6 |
| Krebs cycle | 2 acetyl (2C) → 4 CO₂ | 6 NADH, 2 FADH₂ | 2 ATP | 18 ATP from 6 NADH, 4 ATP from 2 FADH₂ | 24 |
| **Total:** | Glucose (6C) → 6 CO₂ | 10 NADH, 2 FADH₂ | 4 ATP | 34 ATP | 38 ATP |

{{< mediafigure src="microbiology/OSC_Microbio_08_03_ATPYield" alt="A table with four rows (Glycolysis, the transition reaction, the Krebs cycle, and the glucose-to-CO₂ total) and six columns (source, carbon flow, reduced coenzymes produced, net ATP from substrate-level phosphorylation, net ATP from oxidative phosphorylation, and theoretical maximum ATP yield), transcribed above." kind="diagram" >}}
{{< /mediafigure >}}

**Check Your Understanding**

{{< multiplechoice
  question="What are the functions of the proton motive force?"
  answer="Making ATP by chemiosmosis through ATP synthase, and driving other energetically unfavorable processes such as nutrient transport and flagella rotation for motility."
  hint="Reread the last sentence of the first paragraph under Chemiosmosis, Proton Motive Force, and Oxidative Phosphorylation."
>}}
Reducing oxygen to water at the end of the electron transport system.
Making ATP by chemiosmosis through ATP synthase, and driving other energetically unfavorable processes such as nutrient transport and flagella rotation for motility.
Establishing the redox potential of the four major classes of electron carriers.
Regenerating NAD⁺ and FAD so they can be reused in glycolysis and the Krebs cycle.
{{< /multiplechoice >}}
...
- **anaerobic respiration** — use of a non-oxygen inorganic molecule, like CO₂, nitrate, nitrite, oxidized iron, or sulfate, as the final electron acceptor at the end of the electron transport system.
...
{{< textin
  question="Term for the tendency for a molecule to acquire electrons and become reduced."
  answer="redox potential"
  hint="Reread the first paragraph under Electron Transport System."
>}}

{{< multiplechoice
  question="Which is the location of electron transports systems in prokaryotes?"
  answer="the cytoplasmic membrane"
  hint="Reread the last two sentences of the section's opening paragraph."
>}}
...
{{< multiplechoice
  question="In prokaryotes, which of the following is true?"
  answer="As electrons are transferred through an ETS, H⁺ is pumped out of the cell."
  hint="Reread the first paragraph under Chemiosmosis, Proton Motive Force, and Oxidative Phosphorylation."
>}}
...
{{< textin
  question="Oxidative phosphorylation is a mechanism for making ATP that uses the ________ stored within an electrochemical gradient to add Pi to ADP."
  answer="potential energy"
  hint="Reread the last sentence of the second paragraph under Chemiosmosis, Proton Motive Force, and Oxidative Phosphorylation."
>}}

{{< multiplechoice
  question="Which is the source of the energy used to make ATP by oxidative phosphorylation?"
  answer="the proton motive force"
  hint="Reread the first two paragraphs of the section's second subsection."
>}}
oxygen
...
{{< selfcheck question="How does oxidative phosphorylation differ from substrate-level phosphorylation?" hint="The answer spans the section's opening paragraph and the last sentence of the second paragraph under Chemiosmosis, Proton Motive Force, and Oxidative Phosphorylation." >}}
...
===CHECKS===
Glycolysis and the Krebs cycle generate ATP by substrate-level phosphorylation
oxidative phosphorylation, which harvests the potential energy stored within an electrochemical gradient
to regenerate ATP from ADP and inorganic phosphate as hydrogen ions diffuse through ATP synthase
{{< /selfcheck >}}

### Explain the relationship between chemiosmosis and proton motive force

{{< textin
  question="Because the ions involved are H⁺, a pH gradient is also established, with the side of the membrane having the higher concentration of H⁺ being more ________."
  answer="acidic"
  hint="Reread the proton motive force paragraph, just after the term is defined."
>}}

{{< textin
  question="There is an uneven distribution of H⁺ across the membrane that establishes an electrochemical gradient because H⁺ ions are positively charged (________) and there is a higher concentration (chemical) on one side of the membrane."
  answer="electrical"
  accept="electric"
  hint="Reread the first paragraph under Chemiosmosis, Proton Motive Force, and Oxidative Phosphorylation."
>}}

{{< selfcheck question="What is the relationship between chemiosmosis and the proton motive force?" hint="The answer spans the first two paragraphs under Chemiosmosis, Proton Motive Force, and Oxidative Phosphorylation." >}}
...
===CHECKS===
the electrochemical gradient formed by the accumulation of H⁺ on one side of a membrane
causes H⁺ to diffuse back across the membrane through the channel of ATP synthase
a flow called chemiosmosis
{{< /selfcheck >}}

### Describe the function and location of ATP synthase in a prokaryotic versus eukaryotic cell

{{< textin
  question="The final ETS complex used in aerobic respiration that transfers energy-depleted electrons to oxygen to form H₂O is called ________."
  answer="cytochrome oxidase"
  accept="cytochrome c oxidase"
  hint="Reread the aerobic respiration paragraph under Electron Transport System."
>}}

{{< textin
  question="The passage of hydrogen ions through ________ down their electrochemical gradient harnesses the energy needed for ATP synthesis by oxidative phosphorylation."
  answer="ATP synthase"
  hint="Reread the second paragraph of the section's second subsection."
>}}

{{< multiplechoice
  question="Which of the following is not an electron carrier within an electron transport system?"
  answer="ATP synthase"
  hint="Reread the first two paragraphs under Electron Transport System and the electron transport chain figure."
>}}
flavoprotein
ATP synthase
ubiquinone
...
{{< selfcheck question="How does the location of ATP synthase differ between prokaryotes and eukaryotes? Where do protons accumulate as a result of the ETS in each cell type?" hint="The answer spans the first two paragraphs under Chemiosmosis, Proton Motive Force, and Oxidative Phosphorylation." >}}
...
===CHECKS===
H⁺ is pumped to the outside of the cytoplasmic membrane
in eukaryotic cells, H⁺ is pumped from the mitochondrial matrix across the inner mitochondrial membrane into the intermembrane space
ATP synthase sits in that same membrane in each cell type — the plasma membrane in prokaryotic cells and the inner membrane in mitochondria in eukaryotic cells
in prokaryotic cells H⁺ flows from outside the cytoplasmic membrane into the cytoplasm, whereas in eukaryotic mitochondria H⁺ flows from the intermembrane space to the mitochondrial matrix
{{< /selfcheck >}}

### Compare and contrast aerobic and anaerobic respiration

{{< multiplechoice
  question="A cell might perform anaerobic respiration for which of the following reasons?"
  answer="It lacks a cytochrome oxidase for passing electrons to oxygen."
  hint="Reread the bulleted list under Electron Transport System and the paragraph after it."
>}}
...
{{< multiplechoice
  question="All organisms that use aerobic cellular respiration have cytochrome oxidase."
  answer="True"
  hint="Reread the aerobic respiration paragraph under Electron Transport System and the Summary bullet on aerobic respiration."
>}}
True
False
{{< /multiplechoice >}}
...
{{< textin
  question="The cell lacks genes encoding enzymes to minimize the severely damaging effects of dangerous oxygen radicals produced during aerobic respiration, such as hydrogen peroxide (H₂O₂) or ________ (O₂⁻)."
  answer="superoxide"
  hint="Reread the second item of the bulleted list under Electron Transport System."
>}}

---

<small>This section is adapted from [Microbiology, Section 8.3: Cellular Respiration](https://openstax.org/books/microbiology/pages/8-3-cellular-respiration) by Nina Parker, Mark Schneegurt, Anh-Hue Thi Tu, Philip Lister, Brian M. Forster, and OpenStax, © OpenStax, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). Access the original for free at [openstax.org](https://openstax.org/details/books/microbiology). Changes: both source figures re-encoded as WebP and rendered as mediafigures after image and PDF inspection, with explicit `kind="diagram"`; the electron transport chain figure's alt and longdesc rewritten from the manifest's ATP-synthase-only alt to also describe the electron transport chain half of the drawing (the complexes, ubiquinone, and cytochrome c) after inspecting the image, with chemical formulas in Unicode and the H⁺ ions above ATP synthase counted directly from the image (four, in two rows of two); the ATP-yield figure is a table with no photographic or micrograph content in any cell, so per the book's "table printed as an image" rule it is transcribed as a Markdown table from the image (checked against PDF page p-0311), kept at the sentence that refers to it, with the vendored figure immediately after as a brief-alt `mediafigure` and no longdesc (the table already carries the data); both same-module figure cross-references rendered as describing phrases ("illustrated below", "shown below"); the two body Check Your Understanding bullets rendered as graded multiple-choice items, each keyed from one named module sentence (the source prints no answer key for them), with their option order varied so the key does not sit at the first position on every author-built item; all three unkeyed Short Answer questions — on the relationship between chemiosmosis and PMF, on oxidative versus substrate-level phosphorylation, and on ATP synthase's location and where protons accumulate in each cell type — remain self-checks with model answers and rubrics assembled only from this module's own sentences, the last of these needing two named module sentences rather than one; the five Multiple Choice, two Fill in the Blank, and one True/False item are adapted into Practice with the True/False item rendered as a two-option multiple choice, all four options of every source multiple choice kept verbatim in source order; the "which is not an electron carrier" Multiple Choice's own printed options include both "ATP synthase" and "cytochrome oxidase," which are also two other `textin` keys on the page, so the `cytochrome oxidase` `textin` (the source's Fill in the Blank fs-id1167660350553, thematically Objective 5's) is placed first in Objective 4's group, ahead of the `ATP synthase` `textin` (the source's Fill in the Blank fs-id1167660149447, whose key Objective 4's own heading also prints) and that multiple choice, so every key it prints has already been typed by the learner rather than read off the option list; Objective 5's group is filled back to three items with a body-sentence cloze `textin` ("superoxide," from the aerobic-respiration bulleted list) in the vacated slot; a key-term recall `textin` ("redox potential," from its Glossary definition), a cloze of the Glossary definition of oxidative phosphorylation ("potential energy"), and two body-sentence cloze `textin` items ("acidic", "electrical") fill out the remaining thin objective groups to the section's three-item floor, since the module's eleven source exercises alone left them short; the group-3 fillers replace an earlier pair of clozes keyed "chemiosmosis" and "proton motive force" — the first because its own stem printed two sibling items' keys, the second because the source-keyed multiple choice in the group above already prints "the proton motive force" as its correct option, so a later typed-recall of the same phrase would be answered by a term the learner had already read rather than by understanding it; the first two replace earlier summary clozes keyed "electron transport system" and "oxidative phosphorylation," each of which its own objective heading printed; key terms compiled from the module's nine defined terms and the book's Glossary appendix. No source item was omitted.</small>

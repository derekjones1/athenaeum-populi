...
{{< mediafigure src="microbiology/OSC_Microbio_08_01_EndoExo" kind="diagram" alt="A tilted parallelogram labeled 'exergonic' at its top corner and 'endergonic' at its bottom corner, with an ATP starburst and ADP + Pᵢ at its center. On the left, a red arrow shows glucose broken down through glycolysis, the Krebs cycle, and oxidative phosphorylation into CO₂, H₂O, and heat, coupled to a blue arrow that builds ATP from ADP + Pᵢ. On the right, a red arrow shows ATP broken down to ADP + Pᵢ, coupled to a blue arrow labeled bond formation that joins glucose into a polysaccharide." >}}

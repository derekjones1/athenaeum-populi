...
{{< textin question="In a phototrophic eukaryote, where does photosynthesis take place?" answer="chloroplast" hint="Identify the double-membrane-bound organelle this subsection names as the site of eukaryotic photosynthesis." >}}
...
{{< multiplechoice question="In prokaryotes, in which direction are hydrogen ions pumped by the electron transport system of photosynthetic membranes?" answer="to the outside of the plasma membrane" hint="Prokaryotes have no membrane-bound organelle enclosing their photosynthetic membranes, so the electron transport system pumps across the plasma membrane itself, not into an internal compartment." >}}
...
{{< textin question="The types of pigment molecules found in plants, algae, and cyanobacteria are ________." answer="chlorophylls and carotenoids" accept="chlorophyll and carotenoid|carotenoid and chlorophyll|carotenoids and chlorophyll|chlorophylls and carotenoid" hint="Two of the five photosynthetic pigment types this section names are the ones common to plants, algae, and cyanobacteria; the others belong to other bacterial phototrophs." >}}

{{< selfcheck question="What is the function of photosynthetic pigments in the light-harvesting complex?" hint="Describe what the pigments do with light energy first, and then where that energy goes." >}}
...
{{< multiplechoice question="During the light-dependent reactions, which molecule loses an electron?" answer="a reaction center pigment molecule" hint="Recall which of the two kinds of pigment in a photosystem actually gives up an electron upon excitation, rather than only passing energy along." >}}
...
{{< multiplechoice question="Which of the following are two products of the light-dependent reactions?" answer="NADPH and ATP" hint="These are the two energy carriers the light-dependent reactions produce to temporarily store chemical energy for the light-independent reactions." >}}
glucose and NADPH
NADPH and ATP
...
{{< multiplechoice question="Photosynthesis always results in the formation of oxygen." answer="False" hint="Compare this statement with the difference between oxygenic and anoxygenic photosynthesis." >}}
True
False
{{< /multiplechoice >}}
...
{{< textin question="The enzyme responsible for CO₂ fixation during the Calvin cycle is called ________." answer="ribulose bisphosphate carboxylase" accept="RuBisCO" hint="Name the enzyme this section calls the most plentiful enzyme on earth." >}}

{{< textin question="Six molecules of both ATP and NADPH from the light-dependent reactions are used to convert 3-PGA into ________." answer="glyceraldehyde 3-phosphate" accept="G3P" hint="Some of this molecule is used to build glucose; the rest regenerates RuBP." >}}

{{< selfcheck question="Is life dependent on the carbon fixation that occurs during the light-independent reactions of photosynthesis? Explain." hint="Trace the chain this section draws: what heterotrophs like E. coli and humans rely on, and where that comes from." >}}
...
{{< multiplechoice question="Which of the following does not occur during cyclic photophosphorylation in cyanobacteria?" answer="NADPH formation" hint="Cyclic photophosphorylation bypasses the production of one particular energy carrier." >}}
...
{{< multiplechoice question="Why would an organism perform cyclic phosphorylation instead of noncyclic phosphorylation?" answer="Its need for ATP is significantly greater than its need for NADPH." hint="Compare a cell's relative need for ATP against its need for NADPH — this pathway meets primarily one of them." >}}
...
{{< sortbins question="Sort each feature below under the type of photophosphorylation it describes." hint="Three features belong to each pathway: check whether both photosystems are engaged, whether the pathway can produce NADPH, and how the reaction center that loses an electron gets it back." >}}
{"bins": ["Cyclic photophosphorylation", "Noncyclic photophosphorylation"],
 "items": [
  ...
  {"label": "Produces only ATP", "bin": 0},
  {"label": "Produces both ATP and NADPH", "bin": 1},

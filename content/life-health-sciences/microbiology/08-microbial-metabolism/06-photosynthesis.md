...
description: >-
  How light-dependent and light-independent reactions convert solar energy
  into chemical energy, the difference between oxygenic and anoxygenic
  photosynthesis, and the three stages of the Calvin-Benson cycle — adapted
  from OpenStax Microbiology, Section 8.6.
source_section: "8.6"
weight: 6
---
...
{{< mediafigure src="microbiology/OSC_Microbio_08_06_LightDepIn" kind="diagram" eager="true" alt="An oval chloroplast is divided by a dashed line into light-dependent reactions (left) and CO₂ fixation (right). Light strikes a stack of membranes (the granum) inside the chloroplast's outer and inner membranes; H₂A entering the granum is converted to ½A, and this drives production of ATP + NADPH/NADH, which feeds the CO₂ fixation cycle on the right. That cycle turns CO₂ into organics, and returns ADP + Pᵢ + NADP⁺/NAD⁺ to the granum to be reused." longdesc="The oval chloroplast is divided by a dashed vertical line into the light-dependent reactions (left) and CO₂ fixation (right). On the left, three yellow arrows carry light onto a stack of green disc-shaped membranes labeled the granum (a leader marks one disc as photosynthetic membrane), sitting in the stroma inside the chloroplast's two envelope membranes, labeled outer membrane and inner membrane; a red arrow labeled H₂A points into the top of the stack, and a second red arrow labeled ½A points out of its bottom. A red arrow leads right from the granum to a box reading ATP + NADPH/NADH, and a black arrow leads left from a box reading ADP + Pᵢ + NADP⁺/NAD⁺ back into the granum. On the right, a red circular arrow represents the CO₂ fixation cycle: CO₂, labeled at the upper right, enters the top of the cycle, the ATP + NADPH/NADH box feeds into the cycle from the left, the cycle releases organics at the lower right, and a black arrow carries ADP + Pᵢ + NADP⁺/NAD⁺ back out of the cycle to the left, closing the loop with the light-dependent side." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_08_06_GenPhoto" kind="diagram" alt="Light energy strikes a light-harvesting (LH) pigment in a photosystem; the energy is transferred between LH pigments and then to a reaction center (RC) pigment, exciting an electron. The electron leaves the RC and passes through an electron transport system (ETS), whose proton motive force (PMF) is used to make ATP; the ETS also converts NADP⁺ to NADPH. The electron lost from the RC is replaced from a reduced molecule H₂A, which becomes A." longdesc="Light energy (a yellow arrow from the left) strikes the leftmost of four light-harvesting (LH) pigments inside the dashed circle labeled photosystem. Single-headed red arrows pass that energy in a zigzag from LH to LH — left, lower left, right, lower right — and then up to the reaction center (RC) pigment in the upper middle of the circle, exciting an electron. A red arrow carries that electron up to a second, duplicate RC circle drawn above and outside the dashed boundary, labeled 'RC with high-energy electron'; from there a red arrow carries the electron on to the electron transport system (ETS); the ETS uses the resulting proton motive force (PMF) to make ATP and separately reduces NADP⁺ to NADPH (both shown as arrows branching to the right). A black arrow leads from the outer RC circle down to a third green circle, RC⁺ (the oxidized reaction center, just outside the dashed boundary), which recovers a replacement electron (black arrow) from a reduced molecule H₂A entering from below, converting it to A; a final black arrow carries that replacement electron from RC⁺ back into the circle to the original RC pigment, closing the cycle." >}}
...
{{< textin question="In a phototrophic eukaryote, where does photosynthesis take place?" answer="chloroplast" accept="in the chloroplast|in a chloroplast|inside a chloroplast" hint="Reread the first paragraph under Photosynthetic Structures in Eukaryotes and Prokaryotes." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_08_06_PhotoEquat" kind="diagram" alt="Oxygenic photosynthesis: 6CO₂ + 12H₂O + light energy → C₆H₁₂O₆ + 6O₂ + 6H₂O (carbon dioxide + water + light energy → glucose + oxygen + water). Anoxygenic photosynthesis: CO₂ + 2H₂A + light energy → [CH₂O] + 2A + H₂O (carbon dioxide + an electron donor + light energy → a carbohydrate + water), where H₂A stands for H₂O, H₂S, H₂, or another electron donor." >}}
...
{{< multiplechoice question="Why would a photosynthetic bacterium have different pigments?" answer="It allows the organism to absorb energy from more wavelengths of light." hint="Reread the paragraph on the different kinds of light-harvesting pigments, under Photosynthetic Structures in Eukaryotes and Prokaryotes." >}}
It allows the organism to alternate between cyclic and noncyclic photophosphorylation.
It allows the organism to fix CO₂ using the Calvin-Benson cycle.
It allows the organism to absorb energy from more wavelengths of light.
It allows the organism to generate a proton motive force for ATP synthesis.
{{< /multiplechoice >}}
...
{{< selfcheck question="Describe the three stages of the Calvin cycle." hint="Name the three stages in order, and give the one defining action of each: what it does to CO₂, what it builds, and what it regenerates." >}}
...
RuBisCO catalyzes the addition of a CO₂ to ribulose bisphosphate (RuBP), producing 3-phosphoglycerate (3-PGA)
ATP and NADPH ... are used to convert 3-PGA into glyceraldehyde 3-phosphate (G3P), some of which is then used to build glucose
the remaining G3P ... is used to regenerate RuBP, enabling the cycle to continue fixing CO₂
{{< /selfcheck >}}
...
{{< multiplechoice question="In prokaryotes, in which direction are hydrogen ions pumped by the electron transport system of photosynthetic membranes?" answer="to the outside of the plasma membrane" hint="Reread the second paragraph under Photosynthetic Structures in Eukaryotes and Prokaryotes." >}}
...
{{< textin question="The types of pigment molecules found in plants, algae, and cyanobacteria are ________." answer="chlorophylls and carotenoids" accept="chlorophyll and carotenoid|carotenoid and chlorophyll|carotenoids and chlorophyll|chlorophylls carotenoids|carotenoids chlorophylls|chlorophyll carotenoid|carotenoid chlorophyll" hint="Reread the paragraph that lists examples of photosynthetic pigments." >}}

{{< selfcheck question="What is the function of photosynthetic pigments in the light-harvesting complex?" hint="Reread the paragraph on photosystems, the third under Photosynthetic Structures in Eukaryotes and Prokaryotes." >}}
...
===CHECKS===
pigments that each may absorb light energy and, thus, become excited
this energy is transferred from one pigment molecule to another
eventually delivered to the reaction center
{{< /selfcheck >}}

### Describe the major products of the light-dependent and light-independent reactions

{{< multiplechoice question="During the light-dependent reactions, which molecule loses an electron?" answer="a reaction center pigment molecule" hint="Reread the paragraph on photosystems, the third under Photosynthetic Structures in Eukaryotes and Prokaryotes." >}}
...
{{< multiplechoice question="Which of the following are two products of the light-dependent reactions?" answer="NADPH and ATP" hint="Reread the second paragraph of the section's introduction." >}}
glucose and NADPH
NADPH and ATP
...
{{< multiplechoice question="Photosynthesis always results in the formation of oxygen." answer="False" hint="Reread the first paragraph under Oxygenic and Anoxygenic Photosynthesis." >}}
True
False
{{< /multiplechoice >}}
...
{{< textin question="The enzyme responsible for CO₂ fixation during the Calvin cycle is called ________." answer="ribulose bisphosphate carboxylase" accept="RuBisCO|ribulose bisphosphate carboxylase RuBisCO" hint="Reread the Fixation stage in the list under Light-Independent Reactions." >}}

{{< textin question="Six molecules of both ATP and NADPH from the light-dependent reactions are used to convert 3-PGA into ________." answer="glyceraldehyde 3-phosphate" accept="G3P" hint="Reread the Reduction stage in the list under Light-Independent Reactions." >}}

{{< selfcheck question="Is life dependent on the carbon fixation that occurs during the light-independent reactions of photosynthesis? Explain." hint="The answer draws on the section's first paragraph and the first paragraph under Light-Independent Reactions." >}}
...
===CHECKS===
heterotrophic organisms ... rely on the chemical energy found mainly in carbohydrate molecules
many of these carbohydrates are produced by photosynthesis
the carbon comes from CO₂
heterotrophs depend on the carbohydrates produced by autotrophs
{{< /selfcheck >}}

### Compare and contrast cyclic and noncyclic photophosphorylation

{{< multiplechoice question="Which of the following does not occur during cyclic photophosphorylation in cyanobacteria?" answer="NADPH formation" hint="Reread the last paragraph under Oxygenic and Anoxygenic Photosynthesis." >}}
...
{{< multiplechoice question="Why would an organism perform cyclic phosphorylation instead of noncyclic phosphorylation?" answer="Its need for ATP is significantly greater than its need for NADPH." hint="Reread the last paragraph under Oxygenic and Anoxygenic Photosynthesis." >}}
Its need for NADPH is significantly greater than its need for ATP.
It lacks a functional photosystem II.
Its need for ATP is significantly greater than its need for NADPH.
It performs anoxygenic rather than oxygenic photosynthesis.
{{< /multiplechoice >}}

{{< sortbins question="Sort each feature below under the type of photophosphorylation it describes." hint="Reread the last two paragraphs under Oxygenic and Anoxygenic Photosynthesis." >}}
{"bins": ["Cyclic photophosphorylation", "Noncyclic photophosphorylation"],
 "items": [
  {"label": "Uses only PSI", "bin": 0},
  {"label": "Uses both PSI and PSII", "bin": 1},
  {"label": "The PSI reaction center electron returns to the oxidized PSI pigment via an ETS carrier", "bin": 0},
  {"label": "Its flow of electrons is called the Z-scheme", "bin": 1},
  {"label": "The lost PSII electron is replaced by the splitting of water", "bin": 1}]}
{{< /sortbins >}}

---

<small>This section is adapted from [Microbiology, Section 8.6: Photosynthesis](https://openstax.org/books/microbiology/pages/8-6-photosynthesis) by Nina Parker, Mark Schneegurt, Anh-Hue Thi Tu, Philip Lister, Brian M. Forster, and OpenStax, © OpenStax, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). Access the original for free at [openstax.org](https://openstax.org/details/books/microbiology). Changes: all five figures are re-encoded as WebP and rendered as mediafigures, all given explicit `kind="diagram"` after image inspection (the manifest guessed "photo" for all five because every source file is a JPEG, but all five are drawn schematics); the thylakoid-structure figure's source alt misspelled "thylakoids" as "thyladoids," corrected without a source note (a suspected source-alt defect); the photosystem-mechanism figure's source alt misspelled "also" as "aslo" and named the electron transport system "ETC" in one place after calling it "ETS" everywhere else in the same sentence, both corrected without a source note (suspected source-alt defects); the PSI/PSII figure's own artwork — not just its source alt — prints the label "PO" four times (paired with "PQH2" in panel a, again on the carrier after "cytochrome" in panel a, and twice more in panel b), prints the carrier label "OQHS" (evidently PQH₂) in panel b, and never prints "PQ" or "PC" anywhere; the longdesc identifies only the carrier paired with the artwork's own "PQH2" label as plastoquinone (PQ), disclosing that the artwork itself prints that label as "PO" (a suspected artwork defect), and describes the other "PO"-labelled carrier only by its position, between the cytochrome complex and PSI, without naming it as plastocyanin, since the artwork gives it no distinguishing text of its own; the equation figure (a rendered image of the oxygenic/anoxygenic reaction equations) has its alt rewritten with Unicode formulas and arrows rather than reused verbatim, since the source alt states the equations in words only; five same-module figure cross-references (`<link target-id>`) are rendered as "the diagram below," "the figure below," or "(a)"/"(b)" callouts; the cross-reference to Section 3.4 is an absolute site-root Markdown link (the page exists); the cross-reference to Appendix C is left as plain text (not authored); the light-dependent-reactions, photosystem-mechanism, and PSI/PSII figures each carry a `longdesc` walking their electron or metabolite flow in the order drawn, since none is fully named by its caption; the one footnote (a PNAS citation) is rendered as an inline parenthetical after the sentence it supports, with no bare access URL to drop and no DOI printed; of the section's three body Check Your Understanding bullets, the first (where eukaryotic photosynthesis takes place) is graded as a text-recall from the subsection's own defining sentence, the second (why a photosynthetic bacterium would have different pigments) is graded as a multiple choice from the module's own "more wavelengths" sentence, with distractors built from this module's other pathway facts, and the third (the three stages of the Calvin cycle) remains a self-check because its honest answer assembles three bulleted stages into one description; the section's four Multiple Choice and one True/False item (rendered as two-option multiple choice, True then False) keep the source's own keys and option order; of the two Fill in the Blank items, the RuBisCO item keeps the source key and accepts the abbreviation alone or the source's full "ribulose bisphosphate carboxylase (RuBisCO)", and the two-blank "chlorophylls and carotenoids" item — unordered — is rendered as one `textin` whose `accept` list carries the reversed order and the singular and mixed-number forms a learner might type, each with and without "and" (confirmed against `assets/js/lib/text/check-text.mjs` for every number/order combination); of the two unkeyed Short Answer questions, "why cyclic instead of noncyclic phosphorylation" is graded as a multiple choice from the module's own single sentence about a cell's relative ATP/NADPH need, with distractors built from this module's other pigment and photosynthesis-type facts, and "the function of photosynthetic pigments in the light-harvesting complex" remains a self-check because its honest answer assembles two sentences (absorption, then energy transfer to the reaction center); the unkeyed Critical Thinking question (whether life depends on the carbon fixation of the light-independent reactions) remains a self-check, assembled from this module's own opening and Calvin-cycle sentences, because the module never states the conclusion outright; no source exercise was omitted; two filler items round out two Practice groups past their own three source items — a text-recall `textin` for glyceraldehyde 3-phosphate (G3P) from the Reduction step's own sentence, and a five-item `sortbins` comparing cyclic and noncyclic photophosphorylation built from this module's own distinguishing sentences (photosystems used, where the lost electron comes from, the Z-scheme), leaving out the ATP-versus-NADPH contrast the source multiple choice on cyclic photophosphorylation already asks, since this section is one of the "compare and contrast" objectives but prints no comparison table; key terms are compiled from the module's 15 defined terms and the book's Glossary appendix, all 15 definitions taken directly from the Glossary.</small>

...
{{< multiplechoice question="Describe the interaction between heterotrophs and autotrophs in the carbon cycle." answer="Heterotrophs produce CO₂ through respiration or fermentation, and autotrophs use that CO₂ to build organic molecules through carbon fixation." hint="Compare what heterotrophs release through respiration and fermentation with what autotrophs do with that same molecule." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_08_07_Ncycle" kind="diagram" alt="A landscape cutaway of the nitrogen cycle, labeled 'gaseous atmospheric nitrogen store' at top. 'Lightning fixation' and 'bacteria fixation' arrows lead into 'organic matter (R-NH2).' A tractor labeled 'fertilizers' and an arrow labeled 'mineralization' lead to 'ammonium (NH4+).' 'Nitrification' leads from ammonium to 'nitrates (NO2-)' and on to 'nitrates (NO3-)'; 'run off' and 'leaching' arrows feed a lake labeled 'eutrophication.' 'Plant consumption' and 'denitrification' lead from nitrates to the land and to 'gaseous losses N2 & N2O,' fed also by a smokestack labeled 'fossil fuel emission.'" longdesc="Reading the diagram's labeled arrows in sequence: atmospheric nitrogen gas is converted to organic matter (R-NH2) by two fixation pathways, labeled 'lightning fixation' and 'bacteria fixation.' Fertilizers, applied by tractor, and 'mineralization' of organic matter both lead to an ammonium (NH4+) box. From ammonium, an arrow labeled 'nitrification' leads to a box the diagram itself labels 'nitrates (NO2-),' which a second arrow labeled 'nitrification' converts to a box labeled 'nitrates (NO3-).' From the nitrate boxes, a 'plant consumption' arrow leads back toward the organic-matter side of the cycle and a 'denitrification' arrow leads to a box labeled 'gaseous losses N2 & N2O,' which also receives an arrow from a smokestack building labeled 'fossil fuel emission.' A lake in the middle of the scene is labeled 'eutrophication'; it is fed by 'run off' and 'leaching' arrows that curve down from the fertilized fields on the left and by a 'leaching' arrow from each of the two nitrate boxes below it. A large gray oval arrow frames the whole illustration." >}}
...
{{< selfcheck question="What are the four steps of the nitrogen cycle?" hint="The module names an entry step in one sentence and then three further steps, in order, in the next." >}}
...
{{< selfcheck question="Which groups of microbes carry out the sulfur cycle?" hint="The module names which organisms oxidize hydrogen sulfide, which ones use sulfate, and which ones decompose dead organisms to release it again." >}}
...
{{< sortbins question="Compare and contrast the benefits of in situ and ex situ bioremediation. Sort each phrase below under the form of bioremediation it describes." hint="The module describes one form as staying at the contamination site and the other as being moved elsewhere for treatment, often in a lined pit." >}}
{"bins": ["In situ", "Ex situ"],
 "items": [
  {"label": "Treats contaminated material at the original site", "bin": 0},
  {"label": "Removes contaminated material from the site so it can be treated elsewhere", "bin": 1},
  {"label": "Does not involve moving the contaminated material", "bin": 0},
  {"label": "Often carried out in a large, lined pit with conditions optimized for degradation", "bin": 1}]}
{{< /sortbins >}}
...
{{< multiplechoice question="Which of the following is the group of archaea that can use CO₂ as their final electron acceptor during anaerobic respiration, producing CH₄?" answer="methanogens" hint="This group's name is built from the gas it produces, methane, not from the gas it uses as an electron acceptor." >}}
methylotrophs
methanotrophs
methanogens
...
{{< multiplechoice question="Which of the following processes is not involved in the conversion of organic nitrogen to nitrogen gas?" answer="nitrogen fixation" hint="Three of these four processes move nitrogen from organic and ammonia forms toward nitrogen gas — one of them moves nitrogen the other direction, into living systems." >}}
nitrogen fixation
ammonification
nitrification
denitrification
...
{{< multiplechoice question="Which of the following processes produces hydrogen sulfide?" answer="anaerobic respiration" hint="This is the process by which sulfate-reducing bacteria and archaea use sulfate as a final electron acceptor." >}}
...
{{< multiplechoice question="The biogeochemical cycle of which of the following elements is based on changes in solubility rather than redox chemistry?" answer="phosphorus" hint="Compare this element's cycle, described under Other Biogeochemical Cycles, with the redox-based carbon, nitrogen, and sulfur cycles." >}}
carbon
sulfur
nitrogen
phosphorus
...
{{< textin question="The molecule central to the carbon cycle that is exchanged within and between ecosystems, being produced by heterotrophs and used by autotrophs, is ________." answer="carbon dioxide" accept="CO2" hint="This gas is released by respiration and fermentation, and it is the molecule autotrophs fix to build organic matter." >}}

{{< selfcheck question="Why must autotrophic organisms also respire or ferment in addition to fixing CO₂?" hint="The module says autotrophs do not fix carbon only to hand it off to heterotrophs — think about who actually uses the molecules they build." >}}
...
{{< selfcheck question="How can human activity lead to eutrophication?" hint="The module traces this from a farming input through runoff to what happens to aquatic algae and then to the water itself." >}}
Human activity releases nitrogen into the environment by the use of artificial fertilizers that contain nitrogen and phosphorus compounds, which are then washed into lakes, rivers, and streams by surface runoff. A major effect from fertilizer runoff is saltwater and freshwater eutrophication, in which nutrient runoff causes the overgrowth and subsequent death of aquatic algae, making water sources anaerobic and inhospitable for the survival of aquatic organisms.
===CHECKS===
...
{{< textin question="The use of microbes to remove pollutants from a contaminated system is called ________." answer="bioremediation" hint="This is the general term for using microbial metabolism to clean up pollution — the word appears in this subsection's own heading." >}}

{{< multiplechoice question="There are many naturally occurring microbes that have the ability to degrade several of the compounds found in oil." answer="True" hint="Compare this statement with the module's description of Rhodococcus, Pseudomonas, and Alcanivorax borkumensis and their known ability to act on oil compounds." >}}
True
False
{{< /multiplechoice >}}

{{< textin question="Term for a compound synthesized by humans and introduced into the environment in much higher concentrations than would occur naturally." answer="xenobiotic" hint="This word describes human-made pollutants such as adhesives, dyes, and pesticides — not the microbes that break them down." >}}

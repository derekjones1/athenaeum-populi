...
description: >-
  How microbes catabolize lipids through lipases, phospholipases, and
  β-oxidation, and proteins through extracellular and intracellular
  proteases, and how these enzymes help identify clinically important
  bacteria — adapted from OpenStax Microbiology, Section 8.5.
source_section: "8.5"
weight: 5
---
...
use phospholipases to destroy lipids and phospholipids in host cells
use the catabolic products for energy
{{< /selfcheck >}}
...
production of the extracellular protease gelatinase by members of the genera Proteus and Serratia can be used to distinguish them from other gram-negative enteric bacteria
it prevents gelatin broth from solidifying when refrigerated
production of the extracellular protease caseinase, detected as a zone of clearing on skim milk agar, can likewise be used to distinguish the opportunist pathogen Pseudomonas aeruginosa from other related gram-negative bacteria
{{< /selfcheck >}}
...
*The case continues in [Biogeochemical Cycles](/life-health-sciences/microbiology/08-microbial-metabolism/07-biogeochemical-cycles/). The case began in [Energy, Matter, and Enzymes](/life-health-sciences/microbiology/08-microbial-metabolism/01-energy-matter-and-enzymes/).*
{{< /callout >}}
...
the resulting acetyl groups are carried to the Krebs cycle for further degradation to CO₂
the module does not state whether this fatty acid degradation could proceed in an organism lacking cellular respiration
{{< /selfcheck >}}
...
The acetyl groups produced during fatty acid degradation are carried by coenzyme A to the Krebs cycle
...
lipases and phospholipases release fatty acids from the glycerol backbone
extracellular proteases cut proteins internally into smaller peptides
these smaller products can then be taken up by the cell, where further breakdown occurs
{{< /selfcheck >}}

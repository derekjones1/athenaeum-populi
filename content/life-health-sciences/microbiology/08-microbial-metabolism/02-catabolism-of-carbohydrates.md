...
description: >-
  How glycolysis, the transition reaction, and the Krebs cycle break down a
  glucose molecule into ATP, NADH, FADH₂, and CO₂, and how the cycle's own
  intermediates feed biosynthesis — adapted from OpenStax Microbiology,
  Section 8.2.
source_section: "8.2"
weight: 2
---
...
{{< mediafigure src="microbiology/OSC_Microbio_08_02_SubPhos" kind="diagram" alt="The enzyme pyruvate kinase, drawn as a rounded arch, holds two substrates: phosphoenolpyruvate, drawn as three linked blue units with one attached phosphate group, and ADP, drawn with two linked phosphate groups attached to an adenine-ribose ring. An arrow shows the enzyme converting these into pyruvate, the same three blue units without a phosphate group, plus ATP, drawn with three linked phosphate groups attached to the same ring structure." longdesc="Two panels under the same pyruvate-kinase enzyme arch. Left panel: the substrate phosphoenolpyruvate (three linked carbon units with one phosphate group attached) sits beside ADP (two linked phosphate groups attached to an adenine-and-ribose ring). Right panel, after the reaction: the product pyruvate (the same three carbon units, now with no phosphate group) sits beside ATP (three linked phosphate groups attached to the same ring), with a burst symbol labeling the newly made ATP. The phosphate removed from phosphoenolpyruvate is transferred directly to ADP, illustrating substrate-level phosphorylation without an electron transport chain." >}}
The ATP made during glycolysis is a result of substrate-level phosphorylation. One of the two enzymatic reactions in the energy payoff phase of Embden Meyerhof-Parnas glycolysis that produce ATP in this way is shown here.
{{< /mediafigure >}}
...
other bacteria, like *E. coli*, can use either the ED pathway or the EMP pathway
may be favored when the cell has need for nucleic acid and/or protein synthesis
its intermediates are used for the biosynthesis of nucleotides and amino acids
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_08_02_Transition" kind="diagram" alt="Coenzyme A is drawn as a five-carbon ribose ring with adenine attached at carbon 1 and a phosphate group at carbon 3. At carbon 5, outside the ring, two linked phosphate groups connect to a long carbon-and-nitrogen chain ending in a sulfur atom; in panel (a) that sulfur is free (coenzyme A alone), and in panel (b) an acetyl group is bound to it, forming acetyl-CoA." longdesc="The backbone runs from a sulfur-terminated end, through two amide bonds and a two-methyl, hydroxyl-bearing carbon unit, to a chain of two linked phosphate groups that attaches to carbon 5 of the ribose ring; the ring also carries a single phosphate group on carbon 3 and the base adenine on carbon 1. In panel (a) the terminal sulfur is unbound (coenzyme A); in panel (b) an acetyl group (highlighted) is attached to that same sulfur, forming acetyl-CoA." >}}
...
{{< multiplechoice
  question="Glycolysis requires oxygen or another inorganic final electron acceptor to proceed."
  answer="False"
  hint="Compare this statement against the sentence stating whether the process of glycolysis itself uses oxygen."
>}}
True
False
{{< /multiplechoice >}}
...
It can be broken down further through either aerobic or anaerobic respiration
It cannot be broken down further by any other process
{{< /multiplechoice >}}

{{< multiplechoice
  question="For an organism that is unable to respire, what role can glycolysis play in its ATP production?"
  answer="It may be the organism's only source of generating ATP"
  hint="Read the sentence about organisms, including many microbes, that may be unable to respire."
>}}
It is one of several equally important ATP sources
It may be the organism's only source of generating ATP
It cannot generate any ATP without respiration
It generates ATP only when coupled to fermentation
{{< /multiplechoice >}}
...
during the energy payoff phase of glycolysis, when high-energy phosphate groups from the intermediate molecules are added to ADP to make ATP
in the Krebs cycle, where one ATP (or GTP) is produced per turn by substrate-level phosphorylation
{{< /selfcheck >}}
...
The two-carbon acetyl group produced in the transition reaction must be attached to the large carrier compound coenzyme A before it can proceed to the next phase of metabolism, and coenzyme A is what transports that two-carbon acetyl to the Krebs cycle. A cell that could not synthesize coenzyme A would have nothing to carry the acetyl group forward, so the transition reaction could not hand its product on to the Krebs cycle.
===CHECKS===
must be attached to the large carrier compound coenzyme A before it can proceed to the next phase of metabolism
coenzyme A is what transports that two-carbon acetyl to the Krebs cycle
the transition reaction could not hand its product on to the Krebs cycle
{{< /selfcheck >}}
...
{{< multiplechoice
  question="Per turn of the Krebs cycle, one acetyl is oxidized, forming ____ CO₂, ____ ATP, ____ NADH, and ____ FADH₂ molecules. Which set of numbers, in that order, correctly fills the blanks?"
  answer="2; 1; 3; 1"
  hint="Recount the CO₂, ATP, NADH, and FADH₂ totals stated for one turn of the cycle, in the same order as the blanks."
>}}
1; 2; 3; 2
3; 1; 2; 1
2; 2; 4; 1

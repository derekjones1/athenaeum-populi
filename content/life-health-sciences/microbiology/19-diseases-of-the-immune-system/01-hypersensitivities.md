...
description: >-
  Type I–IV hypersensitivity reactions — IgE-mediated allergy and
  anaphylaxis, ABO and Rh blood-group incompatibilities, immune-complex
  disease, and T-cell-mediated delayed hypersensitivity, with their
  diagnosis and treatment — adapted from OpenStax Microbiology, Section
  19.1.
source_section: "19.1"
weight: 1
---
...
- Type III hypersensitivity reactions involve the interactions of IgG, IgM, and, occasionally, IgA antibodies with antigen to form immune complexes (D.S. Strayer et al., eds., *Rubin's Pathology: Clinicopathologic Foundations of Medicine*, 7th ed. (Philadelphia, PA: Lippincott, Williams & Wilkins, 2014)). Accumulation of immune complexes in tissue leads to tissue damage mediated by other immune system effectors.
...
{{< mediafigure src="microbiology/OSC_Microbio_19_01_Degran" alt="A five-step diagram of mast cell sensitization and activation in type I hypersensitivity, from first antigen exposure through IgE production to mast cell degranulation on a later exposure." longdesc="1. On first exposure to an allergen, an antigen-presenting cell engulfs the antigen, processes it, and displays a fragment on a class II MHC molecule at its surface, where a TH2 cell's receptor binds it. 2. The TH2 cell releases IL-4 and IL-13, which activate a B cell displaying the same antigen on its own MHC II and antibodies. 3. The activated B cell proliferates and differentiates into plasma cells that synthesize and secrete IgE antibody. 4. The secreted IgE binds to mast cells by its Fc region, sensitizing the mast cells. 5. On a later exposure to the allergen, the antigen binds the IgE on the sensitized mast cell, and the mast cell releases inflammatory molecules, producing allergy symptoms." kind="diagram" >}}
On first exposure to an allergen in a susceptible individual, antigen-presenting cells process and present allergen epitopes with major histocompatibility complex (MHC) II to T helper cells. B cells also process and present the same allergen epitope to T<sub>H</sub>2 cells, which release cytokines IL-4 and IL-13 to stimulate proliferation and differentiation into IgE-secreting plasma cells. The IgE molecules bind to mast cells with their Fc region, sensitizing the mast cells for activation with subsequent exposure to the allergen. With each subsequent exposure, the allergen cross-links IgE molecules on the mast cells, activating the mast cells and causing the release of preformed chemical mediators from granules (degranulation), as well as newly formed chemical mediators that collectively cause the signs and symptoms of type I hypersensitivity reactions.
{{< /mediafigure >}}

Type I hypersensitivity reactions can be either localized or systemic. Localized type I hypersensitivity reactions include hay fever rhinitis, hives, and asthma (see the table below). Systemic type I hypersensitivity reactions are referred to as **anaphylaxis** or **anaphylactic shock**. Although anaphylaxis shares many symptoms common with the localized type I hypersensitivity reactions, the swelling of the tongue and trachea, blockage of airways, dangerous drop in blood pressure, and development of shock can make anaphylaxis especially severe and life-threatening. In fact, death can occur within minutes of onset of signs and symptoms.
...
the late-phase reaction develops 4 to 12 hours later
it is mediated by eosinophils, neutrophils, and lymphocytes recruited by chemotactic factors from mast cells
...
{{< callout type="info" >}}
**Micro Connection.** *The Hygiene Hypothesis*
...
| Common Name | Cause | Signs and Symptoms |
|---|---|---|
| Hemolytic disease of the newborn (HDN) | IgG from female crosses the placenta, targeting the fetus' RBCs for destruction | Anemia, edema, enlarged liver or spleen, hydrops (fluid in body cavity), leading to death of newborn in severe cases |
...
Hospitals, medical centers, and associated clinical laboratories typically use hemovigilance systems to minimize the risk of HTRs due to clerical error. Hemovigilance systems are procedures that track transfusion information from the donor source and blood products obtained to the follow-up of recipient patients. Hemovigilance systems used in many countries identify HTRs and their outcomes through mandatory reporting (e.g., to the Food and Drug Administration in the United States), and this information is valuable to help prevent such occurrences in the future. For example, if an HTR is found to be the result of laboratory or clerical error, additional blood products collected from the donor at that time can be located and labeled correctly to avoid additional HTRs. As a result of these measures, HTR-associated deaths in the United States occur in about one per 2 million transfused units (E.C. Vamvakas and M.A. Blajchman, "Transfusion-Related Mortality: The Ongoing Risks of Allogeneic Blood Transfusion and the Available Strategies for Their Prevention," *Blood* 113, no. 15 (2009): 3406–3417).

{{< mediafigure src="microbiology/OSC_Microbio_19_01_HTR" alt="A three-step diagram of a hemolytic transfusion reaction after a type B recipient is given type A blood." longdesc="1. Donated type A blood carrying type A antigens enters the bloodstream of a type B recipient, whose plasma carries anti-A antibodies; the drawing shows two type A donor cells plus three type B recipient cells and two free anti-A antibodies. 2. The recipient's anti-A antibodies in plasma bind to the donated type A red blood cells; the drawing shows four type A cells cross-linked by the antibodies into one clump, with no type B cells in it. 3. The bound anti-A antibodies activate the complement cascade, causing hemolysis and release of hemoglobin; in the drawing, complement pieces sit on the antibodies, two of the four clumped cells have burst open, releasing hemoglobin, and two are still intact." kind="diagram" >}}
...
Many different types of erythrocyte antigens have been discovered since the description of the ABO red cell antigens. The second most frequently described RBC antigens are **Rh factor**s, named after the rhesus macaque (*Macaca mulatta*) factors identified by Karl Landsteiner and Alexander Weiner in 1940. The Rh system of RBC antigens is the most complex and immunogenic blood group system, with more than 50 specificities identified to date. Of all the Rh antigens, the one designated Rho (Weiner) or D (Fisher-Race) is the most immunogenic. Cells are classified as Rh positive (Rh+) if the Rho/D antigen is present or as Rh negative (Rh−) if the Rho/D antigen is absent. In contrast to the carbohydrate molecules that distinguish the ABO blood groups and are the targets of IgM isohemagglutinins in HTRs, the Rh factor antigens are proteins. As discussed in [B Lymphocytes and Humoral Immunity](/life-health-sciences/microbiology/18-adaptive-specific-host-defenses/04-b-lymphocytes-and-humoral-immunity/), protein antigens activate B cells and antibody production through a T-cell–dependent mechanism, and the T<sub>H</sub>2 cells stimulate class switching from IgM to other antibody classes. In the case of Rh factor antigens, T<sub>H</sub>2 cells stimulate class switching to IgG, and this has important implications for the mechanism of HDN.

Like ABO incompatibilities, blood transfusions from a donor with the wrong Rh factor antigens can cause a type II hypersensitivity HTR. However, in contrast to the IgM isohemagglutinins produced early in life through exposure to environmental antigens, production of anti-Rh factor antibodies requires the exposure of an individual with Rh− blood to Rh+ positive RBCs and activation of a primary antibody response. Although this primary antibody response can cause an HTR in the transfusion patient, the hemolytic reaction would be delayed up to 2 weeks during the extended lag period of a primary antibody response (see [B Lymphocytes and Humoral Immunity](/life-health-sciences/microbiology/18-adaptive-specific-host-defenses/04-b-lymphocytes-and-humoral-immunity/)). However, if the patient receives a subsequent transfusion with Rh+ RBCs, a more rapid HTR would occur with anti-Rh factor antibody already present in the blood. Furthermore, the rapid secondary antibody response would provide even more anti-Rh factor antibodies for the HTR.

Rh factor incompatibility between a pregnant person and fetus can also cause a type II hypersensitivity hemolytic reaction, referred to as **hemolytic disease of the newborn (HDN)** (illustrated below). If an Rh− female carries an Rh+ baby to term, pregnant person's immune system can be exposed to Rh+ fetal red blood cells. This exposure will usually occur during the last trimester of pregnancy and during the delivery process. If this exposure occurs, the Rh+ fetal RBCs will activate a primary adaptive immune response in the pregnant person, and anti-Rh factor IgG antibodies will be produced. IgG antibodies are the only class of antibody that can cross the placenta to impact the fetus; however, in most cases, the first Rh+ baby is unaffected by these antibodies because the first exposure typically occurs late enough in the pregnancy that the pregnant person does not have time to mount a sufficient primary antibody response before the baby is born.

If a subsequent pregnancy with an Rh+ fetus occurs, however, the female's second exposure to the Rh factor antigens causes a strong secondary antibody response that produces larger quantities of anti-Rh factor IgG. These antibodies can cross the placenta to the fetus and cause HDN, a potentially lethal condition for the baby (shown below).

Prior to the development of techniques for diagnosis and prevention, Rh factor incompatibility was the most common cause of HDN, resulting in thousands of infant deaths each year worldwide (G. Reali, "Forty Years of Anti-D Immunoprophylaxis," *Blood Transfusion* 5, no. 1 (2007): 3–6). For this reason, the Rh factors of prospective parents are regularly screened, and treatments have been developed to prevent HDN caused by Rh incompatibility. To prevent Rh factor-mediated HDN, human Rho(D) immune globulin (e.g., RhoGAM) is injected intravenously or intramuscularly into pregnant people during the 28th week of pregnancy and within 72 hours after delivery. Additional doses may be administered after events that may result in transplacental hemorrhage (e.g., umbilical blood sampling, chorionic villus sampling, abdominal trauma, amniocentesis). This treatment is initiated during the first pregnancy with an Rh+ fetus. The anti-Rh antibodies in Rho(D) immune globulin will bind to the Rh factor of any fetal RBCs that gain access to the pregnant person's bloodstream, preventing these Rh+ cells from activating the primary antibody response. Without a primary anti-Rh factor antibody response, the next pregnancy with an Rh+ fetus will have minimal risk of HDN. However, the person will need to be retreated with Rho(D) immune globulin during that pregnancy to prevent a primary anti-Rh antibody response that could threaten subsequent pregnancies.

{{< mediafigure src="microbiology/OSC_Microbio_19_01_HDN" alt="Two panels showing Rh incompatibility across pregnancies. Panel (a): without treatment, a first pregnancy with an Rh-positive fetus sensitizes an Rh-negative parent, and a second Rh-positive pregnancy triggers hemolytic disease of the newborn. Panel (b): with anti-Rh antibody treatment, a first Rh-positive pregnancy is prevented from sensitizing the parent." longdesc="(a) 1. Rh-positive fetal red blood cells cross the placenta into the Rh-negative pregnant person's circulation during a first pregnancy with an Rh-positive fetus. 2. Anti-Rh antibodies are produced in the pregnant person upon exposure to the fetal Rh antigens. 3. During a second pregnancy with an Rh-positive fetus, the anti-Rh antibodies remain in the pregnant person's circulation and cross the placenta. 4. The maternal anti-Rh antibodies attack and destroy the fetal Rh-positive red blood cells, and the fetus becomes hemolytic. (b) 1. The pregnant person is injected with Rho(D) immune globulin during the first pregnancy with an Rh-positive fetus. 2. Rh-positive fetal red blood cells enter the pregnant person's bloodstream. 3. The injected anti-Rh antibodies bind and inactivate the fetal Rh antigens before they can stimulate an immune response in the pregnant person." kind="diagram" >}}
(a) When an Rh− person has an Rh+ fetus, fetal erythrocytes are introduced into the pregnant person's circulatory system before or during birth, leading to production of anti-Rh IgG antibodies. These antibodies remain in the female after birth and, during a pregnancy with a second Rh+ baby, they can cross the placenta and attach to fetal Rh+ erythrocytes. Complement-mediated hemolysis of fetal erythrocytes results in a lack of sufficient cells for proper oxygenation of the fetus. (b) HDN can be prevented by administering Rho(D) immune globulin during and after each pregnancy with an Rh+ fetus. The immune globulin binds fetal Rh+ RBCs that gain access to the pregnant person's bloodstream, preventing activation of a primary immune response.
{{< /mediafigure >}}

{{< callout type="info" >}}
**Link to Learning**

Use this interactive [Blood Typing Game](https://openstax.org/l/22actbloodtyping) to reinforce your knowledge of blood typing.
{{< /callout >}}
...
They activate helper T cells, which release cytokines that recruit macrophages against them
...
these IgG antibodies can cross the placenta in a later Rh+ pregnancy and destroy fetal red blood cells
HDN is prevented by injecting Rho(D) immune globulin (RhoGAM) during and after each Rh+ pregnancy
the immune globulin's anti-Rh antibodies bind fetal Rh+ cells before they can trigger a primary antibody response
{{< /selfcheck >}}
...
The case continues in *Part 3* below.
{{< /callout >}}
...
Systemic type III hypersensitivity (**serum sickness**) occurs when immune complexes deposit in various body sites, resulting in a more generalized systemic inflammatory response. These immune complexes involve non-self proteins such as antibodies produced in animals for artificial passive immunity (see [Vaccines](/life-health-sciences/microbiology/18-adaptive-specific-host-defenses/05-vaccines/)), certain drugs, or microbial antigens that are continuously released over time during chronic infections (e.g., subacute bacterial endocarditis, chronic viral hepatitis). The mechanisms of serum sickness are similar to those described in localized type III hypersensitivity but involve widespread activation of mast cells, complement, neutrophils, and macrophages, which causes tissue destruction in areas such as the kidneys, joints, and blood vessels. As a result of tissue destruction, symptoms of serum sickness include chills, fever, rash, vasculitis, and arthritis. Development of glomerulonephritis or hepatitis is also possible.

Autoimmune diseases such as systemic lupus erythematosus (SLE) and rheumatoid arthritis can also involve damaging type III hypersensitivity reactions when auto-antibodies form immune complexes with self antigens. These conditions are discussed in [Autoimmune Disorders](/life-health-sciences/microbiology/19-diseases-of-the-immune-system/02-autoimmune-disorders/).

{{< mediafigure src="microbiology/OSC_Microbio_19_01_Type3" alt="Panel (a): a diagram of immune complexes of IgG and antigen depositing along a column of tissue cells, where they activate complement and a neutrophil, with a bracket listing the body sites affected. Panel (b): a photo of a patient connected to a dialysis machine." longdesc="(a) At left, free Y-shaped IgG antibodies (labeled IgG), small triangles (labeled antigen), and a lattice of IgG bound to antigen (labeled immune complex). A gray arrow leads to a drawing headed 'immune complex deposition in tissues, activation of complement, and inflammation': immune complexes lodge along the surface of a column of tissue cells. A neutrophil, with its lobed nucleus, binds one complex through its Fc receptor and releases red granules onto the top cells, whose surface is breaking down. Lower down, free C5a pieces float near the tissue, C3b is bound to a cell surface, and C1 is bound to another immune complex. A bracket beside the whole column lists the sites this damage can affect, from top to bottom: blood vessels, heart, joints, skin, and kidneys. (b) A patient sits connected by tubing to a dialysis machine, which treats the kidney damage a type III hypersensitivity reaction can cause." kind="diagram" >}}
Type III hypersensitivities and the systems they affect. (a) Immune complexes form and deposit in tissue. Complement activation, stimulation of an inflammatory response, and recruitment and activation of neutrophils result in damage to blood vessels, heart tissue, joints, skin, and/or kidneys. (b) If the kidneys are damaged by a type III hypersensitivity reaction, dialysis may be required. (Credit b: Tech. Sgt. Bennie J. Davis III / US Air Force; Public Domain)
{{< /mediafigure >}}

**Check Your Understanding**

{{< multiplechoice
  question="Why is antibody excess important in type III hypersensitivity?"
  answer="Together with a relatively low antigen concentration, it produces small immune complexes that deposit on blood vessel and tissue surfaces"
  hint="Reread the paragraph in Type III Hypersensitivities that names a unique characteristic of this type."
>}}
It cross-links IgE molecules on mast cells, triggering degranulation
It coats red blood cells for complement-mediated lysis
It activates helper T cells to release cytokines that recruit macrophages
...
The case continues in [Organ Transplantation and Rejection](/life-health-sciences/microbiology/19-diseases-of-the-immune-system/03-organ-transplantation-and-rejection/).
{{< /callout >}}

## Type IV Hypersensitivities

Type IV hypersensitivities are not mediated by antibodies like the other three types of hypersensitivities. Rather, **type IV hypersensitivities** are regulated by T cells and involve the action of effector cells. These types of hypersensitivities can be organized into three subcategories based on T-cell subtype, type of antigen, and the resulting effector mechanism (see the table below).
...
In the third type IV subcategory, CD8 cytotoxic T lymphocyte (CTL)-mediated reactions are associated with tissue transplant rejection and contact dermatitis (shown below). For this form of cell-mediated hypersensitivity, APCs process and present the antigen with MHC I to naïve CD8 T cells. When these naïve CD8 T cells are activated, they proliferate and differentiate into CTLs. Activated T<sub>H</sub>1 cells can also enhance the activation of the CTLs. The activated CTLs then target and induce granzyme-mediated apoptosis in cells presenting the same antigen with MHC I. These target cells could be "self" cells that have absorbed the foreign antigen (such as with contact dermatitis due to poison ivy), or they could be transplanted tissue cells displaying foreign antigen from the donor.

{{< mediafigure src="microbiology/OSC_Microbio_19_01_Type4" alt="Panel (a), sensitization: a photo of poison ivy leaves above a diagram of antigen entering the skin and activating a dendritic cell, which produces a memory helper T cell. Panel (b), immune response: a photo of a skin lesion above a diagram of macrophages, memory helper T cells, and cytotoxic T cells producing the lesion." longdesc="(a) A photo of poison ivy leaves sits above a cross-section of skin. A curved arrow leads from a circled spot on a leaf down into the skin: antigen from the plant enters the skin and is taken up by a dendritic cell, whose branching processes reach through the tissue. The dendritic cell presents the antigen to a T cell, and an arrow leads from that T cell to a memory helper T cell. An arrow leads on to panel (b). (b) A second cross-section of skin with a raised, reddened swelling labeled lesion; a curved arrow leads from the lesion up to a photo of a forearm with a fluid-filled blister. Below the lesion, a memory helper T cell sends an arrow up to a cluster of dots labeled cytokines. A macrophage and a cytotoxic T cell, carrying red granules, each send their own arrow to the lesion." kind="diagram" >}}
...
{"bins": ["Subcategory 1", "Subcategory 2", "Subcategory 3"],
 "items": [
  ...
  {"label": "Eosinophils are recruited and release cytokines and other pro-inflammatory chemicals", "bin": 1},
  {"label": "The antigen is cell-associated rather than soluble", "bin": 2},
  {"label": "Examples include contact dermatitis from latex and a positive tuberculin skin test", "bin": 0},
  {"label": "Examples include chronic asthma and chronic allergic rhinitis", "bin": 1},
  {"label": "Cytotoxic T lymphocytes mediate the tissue damage", "bin": 2},
...
TH2-mediated reactions recruit and activate eosinophils, which release inflammatory mediators
CD8 cytotoxic T lymphocytes are activated after APCs present antigen with MHC I
activated CTLs induce granzyme-mediated apoptosis in target cells presenting the same antigen
{{< /selfcheck >}}

{{< callout type="info" >}}
**Micro Connection.** *Using Delayed Hypersensitivity to Test for TB*

Austrian pediatrician Clemens von Pirquet (1874–1929) first described allergy mechanisms, including type III serum sickness (B. Huber, "100 Jahre Allergie: Clemens von Pirquet–sein Allergiebegriff und das ihm zugrunde liegende Krankheitsverständnis," *Wiener Klinische Wochenschrift* 118, no. 19–20 (2006): 573–579). His interest led to the development of a test for tuberculosis (TB), using the tuberculin antigen, based on earlier work identifying the TB pathogen performed by Robert Koch. Pirquet's method involved scarification, which results in simultaneous multiple punctures, using a device with an array of needles to break the skin numerous times in a small area. The device Pirquet used was similar to the tine test device with four needles shown below.
...
{{< mediafigure src="microbiology/OSC_Microbio_19_01_Types" alt="A table titled 'Hypersensitivity Types and Their Mechanisms,' with immune reactant, antigen form, mechanism of activation, and example rows for types I through IV, transcribed above." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_19_01_SkinTest" alt="A photo of two forearms marked with rows of numbered pen marks over small raised, reddened bumps from an allergy skin-prick test; one arm's image is labeled to show a wheal and its surrounding flare." kind="photo" >}}
...
their symptoms may be associated with any of a number of other diseases
a strong, comprehensive patient history is crucial to accurate diagnosis
{{< /selfcheck >}}
...
the quantity of allergen is increased over a buildup period until an effective dose is determined and maintained for the duration of treatment, which can last years
patients wait 30 minutes after injection in case of a severe systemic reaction
the allergy shots elicit production of IgG antibodies instead of IgE, and the excess IgG acts as blocking antibodies that neutralize the allergen before it binds IgE on mast cells
{{< /selfcheck >}}
...
It counteracts the drop in blood pressure during systemic anaphylaxis
It increases production of IgG antibodies to shift the response away from IgE
{{< /multiplechoice >}}
...
- **type II hypersensitivities** — cytotoxic reaction triggered by IgG and IgM antibodies binding to antigens on cell surfaces.
...
- **isohemagglutinin** — IgM class antibodies produced against A or B red blood cell antigens.
...
- **type IV hypersensitivities** — delayed T-cell-mediated inflammatory reaction that takes longer to manifest than the first three hypersensitivity types, due to the need for activation of antigen-presenting cell and T-cell subsets.
...
{{< multiplechoice
  question="Type I hypersensitivities require which of the following initial priming events to occur?"
  answer="sensitization"
  hint="Reread the last sentence of the paragraph on a susceptible individual's first exposure to an allergen."
>}}
sensitization
...
{{< multiplechoice
  question="Which of the following is a common treatment for type III hypersensitivity reactions?"
  answer="anti-inflammatory steroid treatments"
  hint="Reread the paragraph on treating type III hypersensitivities in Treatments of Hypersensitivities."
>}}
...
{{< multiplechoice
  question="Which of the following induces a type III hypersensitivity?"
  answer="accumulation of immune complexes in tissues and small blood vessels"
  hint="Reread the Type III row of the Hypersensitivity Types and Their Mechanisms table."
>}}
...
{{< multiplechoice
  question="Which one of the following is not an example of a type IV hypersensitivity?"
  answer="hemolytic disease of the newborn"
  hint="Check each option against the Examples column of the Type IV Hypersensitivities table."
>}}
latex allergy
...
{"bins": ["Preformed", "Newly formed"],
 "items": [
  ...
  {"label": "Leukotriene causes smooth-muscle contraction and mucus secretion, increasing vascular permeability", "bin": 1},
  {"label": "Histamine increases vascular permeability and stimulates mucus and tear formation", "bin": 0},
  {"label": "Prostaglandin causes smooth-muscle contraction and vasodilation", "bin": 1},
  {"label": "Serotonin increases vascular permeability and causes vasodilation and smooth-muscle contraction", "bin": 0},
  {"label": "TNF-alpha causes inflammation and stimulates cytokine production by other cell types", "bin": 1}]}
{{< /sortbins >}}

{{< sortbins question="Sort each cause or sign into the type I hypersensitivity condition it describes." hint="Read each item against the Cause and Signs and Symptoms columns of the Type I Hypersensitivities table." >}}
{"bins": ["Allergy-induced asthma", "Anaphylaxis", "Hay fever", "Hives"],
 "items": [
  {"label": "Constricts the bronchi and brings chills and body aches", "bin": 0},
  {"label": "A systemic reaction affecting the whole body", "bin": 1},
  {"label": "Caused by inhaling mold spores or pollen", "bin": 2},
  {"label": "Triggered by a food or drug allergen or an insect sting", "bin": 3},
...
a later exposure cross-links the IgE on mast cells, triggering degranulation and release of mediators like histamine
type II hypersensitivity is mediated by IgG and IgM antibodies that bind directly to antigens on the surface of cells
this binding activates complement, causing cell lysis, or triggers antibody-dependent cell-mediated cytotoxicity
{{< /selfcheck >}}

{{< selfcheck question="What types of antibodies are most common in type III hypersensitivities, and why?" hint="Reread the paragraph in Type III Hypersensitivities that names a unique characteristic of this type." >}}
IgG antibodies are the most common antibodies involved in type III hypersensitivity. A unique characteristic of type III hypersensitivity is antibody excess, primarily of IgG, together with a relatively low concentration of antigen. This imbalance results in the formation of small immune complexes that deposit on the surface of epithelial cells lining small blood vessels or on the surfaces of tissues, rather than being efficiently cleared, which is what leads to the tissue damage characteristic of type III hypersensitivity.
===CHECKS===
IgG antibodies are the most common antibodies involved in type III hypersensitivity
antibody excess, together with a relatively low concentration of antigen, is the unique characteristic
...
the intradermal test injects allergen into the dermis with a small needle
both tests are read for a wheal-flare reaction within 15–20 minutes, whose size indicates sensitivity
...
a positive reaction develops because memory T cells recognizing the antigen are reactivated
a positive test does not necessarily mean the patient is currently infected, since the memory T cells may date from a past, cleared, or latent infection
the vaccine itself and its effect on the test are not discussed in this section
{{< /selfcheck >}}

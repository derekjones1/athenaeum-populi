...
description: >-
  Primary immunodeficiencies from inherited defects — chronic granulomatous
  disease, X-linked agammaglobulinemia, selective IgA deficiency, and severe
  combined immunodeficiency — compared with acquired secondary
  immunodeficiencies such as HIV/AIDS and malnutrition, and how each is
  treated — adapted from OpenStax Microbiology, Section 19.4.
source_section: "19.4"
weight: 4
---
...
Without treatment, babies with SCID do not typically survive infancy. In some cases, a bone marrow transplant may successfully correct the defects in lymphocyte development that lead to the SCID phenotype, by replacing the defective component. However, this treatment approach is not without risks, as demonstrated by the famous case of David Vetter (1971–1984), better known as "Bubble Boy" (see the photo below). Vetter, a patient with SCID who lived in a protective plastic bubble to prevent exposure to opportunistic microbes, received a bone marrow transplant from his sister. Because of a latent Epstein-Barr virus infection in her bone marrow, however, he developed mononucleosis and died of Burkitt lymphoma at the age of 12 years.

{{< mediafigure src="microbiology/OSC_Microbio_19_04_SCID" alt="A young boy wears a white protective suit with a clear bubble helmet and stands connected by a long orange flexible tube to something out of frame. A man in a plaid shirt holds the tube, and a woman in a white coat looks on. A mirror at the left reflects the scene from another angle." kind="photo" eager="true" >}}
...
Malnutrition or another nutritional deficiency
...
phagocytes cannot produce superoxide radicals, so their antibacterial activity is impaired
...
secretory IgA is normally an important defense mechanism for the lungs and gastrointestinal tract
this deficiency predisposes these individuals to lung and gastrointestinal infections
{{< /selfcheck >}}

## Secondary Immunodeficiency

A **secondary immunodeficiency** occurs as a result of an acquired impairment of function of B cells, T cells, or both. Secondary immunodeficiencies can be caused by:
...
{{< callout type="info" >}}
**Case in Point.** *An Immunocompromised Host*
...
{"bins": ["Primary", "Secondary"],
 "items": [
  ...
  {"label": "Malnutrition", "bin": 1},
  {"label": "Selective IgA deficiency", "bin": 0},
  {"label": "Viral infection such as HIV", "bin": 1},
  {"label": "Severe combined immunodeficiency disease (SCID)", "bin": 0},
  {"label": "Immunosuppressive therapies such as chemotherapy or radiotherapy", "bin": 1},
  {"label": "X-linked agammaglobulinemia", "bin": 0}]}
{{< /sortbins >}}

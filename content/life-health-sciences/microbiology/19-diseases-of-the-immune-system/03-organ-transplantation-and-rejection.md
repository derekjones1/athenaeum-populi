...
description: >-
  Why human leukocyte antigens (HLAs) matter in tissue transplantation, the
  four types of grafts (autograft, isograft, allograft, xenograft) and their
  risk of rejection, how the recipient's dendritic cells and T cells
  recognize and reject foreign tissue, graft-versus-host disease in bone
  marrow transplants, and the future of transplantation — adapted from
  OpenStax Microbiology, Section 19.3.
source_section: "19.3"
weight: 3
---
...
the host's dendritic cells process and present the foreign HLAs to helper T cells and cytotoxic T cells
cytotoxic T cells target and kill the grafted cells through the same mechanism they use to kill virus-infected cells
...
a genetic match between the MHC genes is much more likely between blood relatives
...
Bone marrow transplants are never matched for HLA type.
...
leading to activation of the donor's cytotoxic T cells
once activated, the donor's T cells attack the recipient's cells
{{< /selfcheck >}}
...
There are currently more than a dozen different tissues and organs used in human transplantations. Learn more about them at [this website listing transplantable tissues and organs](https://openstax.org/l/22organstransp).
{{< /callout >}}
...
*The case began in [Hypersensitivities](/life-health-sciences/microbiology/19-diseases-of-the-immune-system/01-hypersensitivities/).*
{{< /callout >}}
...
- **graft-versus-host disease (GVHD)** — specific type of transplantation reaction in which a transplanted immune system (e.g., a bone marrow transplant) contains APCs and T cells that are activated and attack the recipient's tissue.
...
A parent is always an identical genetic match to the recipient at every MHC gene.
The recipient's dendritic cells cannot process a parent's HLA molecules.
{{< /multiplechoice >}}
...
{{< multiplechoice
  question="According to this section, within what timeframe does acute GVHD typically develop after a bone marrow transplant?"
  answer="weeks"
  hint="This is the sentence that opens the paragraph describing acute GVHD's tissue damage."
>}}
hours
weeks
months

...
description: >-
  Malaria, toxoplasmosis, babesiosis, Chagas disease, leishmaniasis, and
  schistosomiasis, with cercarial dermatitis (swimmer's itch) and the
  Barbara catheter-sepsis Clinical Focus case's resolution — adapted from
  OpenStax Microbiology, Section 25.4.
source_section: "25.4"
weight: 4
---
...
{{< mediafigure src="microbiology/OSC_Microbio_25_04_BloodSmear" kind="photo" alt="A micrograph of light purple red blood cells with a 10-micrometer scale bar. A leader line labeled 'ring form' points to a cell containing a small dark violet ring, and a second leader line labeled 'schizont' points to a cell containing a larger, denser cluster of dark violet granules." >}}
...
The Nothing But Nets campaign, an initiative of the United Nations Foundation, has partnered with the Bill and Melinda Gates Foundation to make mosquito bed nets available in developing countries in Africa. Visit [their website](https://openstax.org/l/22mosquitonet) to learn more about their efforts to prevent malaria.
{{< /callout >}}
...
about 214 million cases worldwide
about 438,000 deaths
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_25_04_SabinFeld" kind="photo" alt="Two micrographs, each with a 10-micrometer scale bar. (a) Several crescent-shaped, purple-stained cells with a central nucleus, scattered on a pale background. (b) A round tissue cyst densely packed with hundreds of small, deep pink-stained bodies, surrounded by paler tissue." >}}
...
tachyzoites cross the placenta from mother to fetus
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_25_04_babesia" kind="photo" alt="A micrograph of pale red blood cells. Leader lines labeled 'erythrocytes' point to unmarked cells, and leader lines labeled 'Babesia parasites' point to cells containing small violet ring- or comma-shaped inclusions." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_25_04_Trypanosom" kind="photo" alt="(a) A micrograph of densely packed pink-stained red blood cells with a leader line labeled 'T. cruzi' pointing to a single curved, comma-shaped violet parasite lying among them. (b) A photo of a brown, elongated triatomine bug with long thin legs and antennae, resting on a pale surface." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_25_04_Leishmania" kind="photo" alt="(a) A micrograph of stained tissue with a leader line labeled 'Leishmania spp.' pointing to a small dark brown speck among the tissue cells, with a 10-micrometer scale bar. (b) A photo of an open, crusted red ulcer with a raised border on a person's lower leg." >}}
...
{"bins": ["Cutaneous leishmaniasis", "Mucosal leishmaniasis"],
 "items": [
  ...
  {"label": "Usually not treated, and resolves after weeks or months, though scarring may remain", "bin": 0},
  {"label": "Occurs less often when the original skin infection is promptly treated", "bin": 1}]}
{{< /sortbins >}}
...
{{< callout type="info" >}}
**Disease Profile.** *Common Eukaryotic Pathogens of the Human Circulatory System*
...
*Go back to the previous [Clinical Focus](/life-health-sciences/microbiology/25-circulatory-and-lymphatic-system-infections/02-bacterial-infections-of-the-circulatory-and-lymphatic-systems/) box (Bacterial Infections of the Circulatory and Lymphatic Systems, Part 2). The case began in [Anatomy of the Circulatory and Lymphatic Systems](/life-health-sciences/microbiology/25-circulatory-and-lymphatic-system-infections/01-anatomy-of-the-circulatory-and-lymphatic-systems/).*
{{< /callout >}}
...
oocysts spread to humans through contact with fecal matter in litter boxes

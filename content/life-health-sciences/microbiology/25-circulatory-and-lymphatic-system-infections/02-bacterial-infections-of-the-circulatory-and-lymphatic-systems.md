...
{{< mediafigure src="microbiology/OSC_Microbio_25_02_PlagueTran" kind="diagram" alt="A diagram of plague transmission with a human figure at the center. Two flea icons connect the human to a sylvatic rodent-flea cycle (squirrels, chipmunks, an osprey, a crow, and a cat, joined by flea and meat-consumption arrows) and an urban rodent-flea cycle (rats and a cow); a blue arrow shows airborne pneumonic transmission directly between humans, and gray arrows show long-distance transport of infected animals or people by ship." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_25_02_Ixodes" kind="diagram" alt="A circular diagram of the two-year Ixodes scapularis life cycle. In spring, an egg becomes a larva that feeds once for two days on a mouse; the larva overwinters one month and molts into a nymph, which feeds once (deer preferred host) the following winter; eggs are deposited three weeks later and the adults die, restarting the cycle in spring." >}}

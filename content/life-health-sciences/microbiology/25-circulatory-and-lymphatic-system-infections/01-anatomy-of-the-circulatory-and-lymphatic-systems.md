...
{{< mediafigure src="microbiology/OSC_Microbio_25_01_spleenLnode" kind="diagram" alt="Two-panel diagram: (a) the spleen's location in the abdomen beside the pancreas and diaphragm, with the splenic artery and vein entering at the hilum; (b) a cross-section of a lymph node with six labels: afferent lymphatic vessels and lymph in at the bottom, efferent lymphatic vessels and lymph out at the top, the connective tissue capsule, and red germinal centers in the outer lobes." longdesc="(a) The spleen sits at the end of the pancreas just under the diaphragm; the hilum, where the spleen is closest to the pancreas, is where the splenic artery and vein enter and leave. (b) In the close-up cross-section of a lymph node, afferent lymphatic vessels bring lymph into the node and efferent lymphatic vessels carry it out; a connective tissue capsule surrounds the node; inside, unlabeled walls fold inward from the capsule, dividing an outer layer into lobes, and germinal centers appear as red structures within those lobes.">}}
...
{{< textin
  ...
  hint="This is the tissue where the hematopoietic stem cells that mature into blood cells and lymphocytes are found — not the tissue that includes the spleen and lymph nodes."
>}}

{{< multiplechoice
  question="The lymph reenters the vascular circulation at ________."
  answer="the subclavian veins"
  hint="The module describes the lymphatic system's two drainage points as emptying into large veins just above the heart, not into the vessels of the pulmonary circuit or into a lymphoid organ."
>}}
the pulmonary veins
the lymph nodes
...
{{< multiplechoice
  ...
  answer="capillaries"
  hint="This vessel is the smallest of the four options, sitting directly among the tissue cells rather than carrying blood to or from that network."
>}}
lymphatics
arterioles
capillaries
...
{{< multiplechoice
  ...
  answer="lymph nodes"
  hint="This structure filters lymph, not blood — a different fluid from the one the spleen and blood capillaries handle."
>}}
spleen
lymph nodes
pericardium
...
{{< textin
  ...
  answer="toxemia"
  hint="Compare it with bacteremia (bacteria) and viremia (viruses) — this term names the same idea for microbial poisons rather than organisms."
>}}

### Describe general signs and symptoms of disease associated with infections of the circulatory and lymphatic systems

{{< textin
  question="Inflammation of the lymphatic vessels is called ________."
  answer="lymphangitis"
  hint="This condition is distinct from lymphadenitis, which is inflammation of the lymph nodes themselves rather than the vessels connecting them."
>}}

{{< multiplechoice
  question="Which term refers to an inflammation of the blood vessels?"
  answer="vasculitis"
  hint="Its own name gives away the tissue it inflames — vessels, not a chamber, a lining, or a lymph node."
>}}
lymphangitis
endocarditis
pericarditis
...
{{< multiplechoice
  ...
  hint="A bubo is itself a swollen lymph node — pick the term that names the inflamed-lymph-node condition, not the swelling or a blood-vessel condition."
>}}
lymphangitis
lymphadenitis
ischemia

...
{{< mediafigure src="microbiology/OSC_Microbio_25_01_LymphSyst" kind="diagram" alt="Three-part diagram of the lymphatic system: the whole body with the tonsil, thymus, lymph nodes, lymph vessels, and the right lymphatic duct emptying into a neck vein labeled; a close-up of a lymph node with lymph vessels entering and leaving it; and a close-up of tissue showing lymphatic capillaries interwoven with a blood capillary network, draining interstitial fluid from tissue cells." longdesc="The whole-body view labels the tonsil (a pale patch beside a lymph vessel at the back of the jaw), the thymus (a lumpy structure near the heart), lymph nodes (swellings along the lymph vessels throughout the body), the right lymphatic duct, which empties into a vein in the neck, and a lymph vessel in the thigh. An arrow from a small box on the thigh leads to the lymph-node close-up, labeled lymph node: a rounded structure with several vessels attached and a boxed central region labeled masses of lymphocytes and macrophages. An arrow from that box leads up to the tissue close-up, which shows tissue cells surrounded by a red blood capillary network and a green lymphatic capillary network; arrows show interstitial fluid from around the cells entering the lymphatic capillaries and moving into the larger lymphatic vessels.">}}
...
{{< selfcheck question="Why does the circulatory system have no normal microbiota?" hint="Think about both why microbes rarely get in, given the system's shape, and what happens to the few that do." >}}
...
{{< selfcheck question="Explain why the presence of microbes in the circulatory system can lead to serious consequences." hint="Follow the chain from rapid spread through the blood to the overreacting immune response these terms name." >}}
...
{{< textin
  ...
  answer="spleen"
  hint="This organ sits near the stomach and left kidney and also stores blood, as the earlier cross-section figure shows."
>}}
...
===CHECKS===
lymph nodes contain macrophages and dendritic cells for antigen presentation
lymph from nearby tissues enters the lymph node through afferent lymphatic vessels
lymph encounters these lymphocytes as it passes through the node
{{< /selfcheck >}}

### Explain how microorganisms overcome defenses of the circulatory and lymphatic systems to cause infection

{{< selfcheck question="Why would septicemia be considered a more serious condition than bacteremia?" hint="The module defines bacteremia as bacteria simply present in the blood — think about what changes once those bacteria start doing something more." >}}
...
the module does not state directly why septicemia would be considered more serious than bacteremia
{{< /selfcheck >}}

{{< textin
  question="The life-threatening condition that systemic inflammatory response syndrome (SIRS) can lead to is called ________."
  answer="sepsis"
  hint="This condition can progress to shock and death if not treated promptly, and its name is distinct from the syndrome that triggers it."
>}}
...
{{< textin
  ...
  answer="petechiae"
  accept="petechia"
  hint="This word names the tiny areas of bleeding under the skin that vasculitis was just described as causing."
>}}

{{< mediafigure src="microbiology/OSC_Microbio_25_01_Lymph_img" kind="photo" alt="A forearm and elbow with a small dark red-black spot at the elbow crease and several thin red lines radiating outward from it under the skin; black arrows point to two of the lines and the central spot." >}}

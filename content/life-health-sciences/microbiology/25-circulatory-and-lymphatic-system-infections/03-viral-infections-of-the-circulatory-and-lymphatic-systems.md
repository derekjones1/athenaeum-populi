...
{{< mediafigure src="microbiology/OSC_Microbio_25_03_AIDS" kind="diagram" alt="A graph plotting CD4 T-lymphocyte count (left axis, cells/mm³) and HIV RNA copies per mL plasma (right axis, log scale) against time, first in weeks (0–12) then, after an axis break, in years (1–11). The CD4 line (blue) falls sharply after primary infection, partly recovers, then declines slowly across years to near zero by year 10; the HIV RNA line (red) spikes during acute infection, falls during a plateau labeled classical latency, then rises again before death." longdesc="Reading left to right: at about week 1, a line labeled primary infection marks where the blue CD4 line begins, near 1,050 cells/mm³; the red HIV RNA line begins near its lowest point about a week later. A bracket over weeks 3–9 labels acute HIV syndrome, wide dissemination of virus, and seeding of lymphoid organs: the red line rises sharply to a peak near 10⁶ copies/mL around week 7, while the blue line falls to its low of about 500 cells/mm³ around week 6. The red line then drops steeply to roughly 10³ copies/mL by week 10, as the blue line recovers to about 670 cells/mm³ just after week 12. The x-axis then breaks and switches from weeks to years. A bracket spanning from about week 9, before the axis break, to about year 7 labels classical latency: across this span the blue line declines gradually while the red line stays low and creeps upward. A vertical line labeled constitutional symptoms, at about year 7, marks a point on the red line about a year before it starts climbing steeply (still just under 10⁴ copies/mL); a second line labeled opportunistic diseases, at about year 9.5, marks a point higher up the red line's climb (around 10⁵ copies/mL) — not the blue line, which by then has already fallen close to its floor. Both curves end at death, around year 10–11, with the blue line near zero and the red line near or above 10⁶ copies/mL." >}}
...
{{< textin
  ...
  answer="Arboviruses"
  accept="arthropod-borne viruses"
  hint="See the opening paragraph of the subsection that follows Cytomegalovirus Infections."
>}}
...
{{< multiplechoice
  ...
  answer="1"
  hint="Compare the patient's CD4 T-cell count with the range given for each stage in the Human Immunodeficiency Virus subsection's three-stage list."
>}}
1
2
3

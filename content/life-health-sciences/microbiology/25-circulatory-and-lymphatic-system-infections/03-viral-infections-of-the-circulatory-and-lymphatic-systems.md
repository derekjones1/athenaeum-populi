...
description: >-
  Infectious mononucleosis and Burkitt lymphoma, cytomegalovirus infection,
  the arboviral diseases yellow fever, dengue fever, and chikungunya fever,
  Ebola virus disease, the two hantavirus syndromes, and HIV infection and
  AIDS — adapted from OpenStax Microbiology, Section 25.3.
source_section: "25.3"
weight: 3
---
...
{{< mediafigure src="microbiology/OSC_Microbio_25_03_Burkitts" kind="photo" eager="true" alt="(a) A child, face pixelated for privacy, with a large white bandage covering a swelling on the side of the neck. (b) A micrograph of a blood smear crowded with irregularly shaped, purple-staining lymphocytes with pale vacuoles among smaller round red blood cells; scale bar 20 µm." >}}
...
{{< callout type="info" >}}
**Micro Connection.** *Yellow Fever: Altering the Course of History*
...
Use this [interactive map](https://openstax.org/l/22denguemap) to explore the global distribution of dengue.
{{< /callout >}}
...
arboviruses are arthropod-borne viruses, transmitted by arthropod vectors such as mosquitoes
each of the three diseases is transmitted to humans by a mosquito vector
{{< /selfcheck >}}
...
The Ebola virus disease (EVD) is a highly contagious disease caused by species of *Ebolavirus*, a BSL-4 filovirus (shown below). Transmission to humans occurs through direct contact with body fluids (e.g., blood, saliva, sweat, urine, feces, or vomit), and indirect contact by contaminated fomites. Infected patients can easily transmit Ebola virus to others if appropriate containment and use of personal protective equipment is not available or used. Handling and working with patients with EVD is extremely hazardous to the general population and health-care workers. In almost every EVD outbreak there have been Ebola infections among health-care workers. This ease of Ebola virus transmission was recently demonstrated in the Ebola epidemic in Guinea, Liberia, and Sierra Leone in 2014, in which more than 28,000 people in 10 countries were infected and more than 11,000 died (HealthMap. "2014 Ebola Outbreaks.").
...
{{< mediafigure src="microbiology/OSC_Microbio_25_03_Ebola" kind="photo" alt="A colorized electron micrograph of a single yellow, thread-like virus particle that curves into a loop at one end and tapers to a blunt tip at the other. Scale bar 100 nm." >}}
An Ebola virus particle viewed with electron microscopy. These filamentous viruses often exhibit looped or hooked ends. (credit: modification of work by Centers for Disease Control and Prevention)
{{< /mediafigure >}}
...
Through inhalation of aerosols of dried rodent urine and feces.
Through sexual contact and the sharing of intravenous needles.
{{< /multiplechoice >}}
...
HFRS, which has not been reported in the US, begins with fever, headache, chills, nausea, eye inflammation, or rash and can progress to hemorrhaging, kidney failure, shock, and death, with a mortality rate up to 15%
HPS has no clinical treatment other than supportive care, while HFRS can be treated with ribavirin
{{< /selfcheck >}}

## Human Immunodeficiency Virus

Human immunodeficiency viruses (HIV) are retroviruses that are the causative agent of acquired immune deficiency syndrome (AIDS). *(Source note: the source prints "Human T-lymphotropic viruses (HTLV), also called human immunodeficiency viruses (HIV)"; HTLV-1 and HTLV-2 are distinct retroviruses of the genus Deltaretrovirus, and HIV, a lentivirus, carried the provisional name HTLV-III only in 1984.)* There are two main variants of **human immunodeficiency virus (HIV)**. HIV-1 (shown in the micrograph below) occurs in human populations worldwide, whereas HIV-2 is concentrated in West Africa. Currently, the most affected region in the world is sub-Saharan Africa, with an estimated 25.6 million people living with HIV in 2015 (World Health Organization. "HIV/AIDS: Fact Sheet." 2016.). Sub-Saharan Africa also accounts for two-thirds of the global total of new HIV infections (shown in the map below) (ibid.).

{{< mediafigure src="microbiology/OSC_Microbio_25_03_HIV" kind="photo" alt="A colorized scanning electron micrograph, titled HIV-1, of small green spherical virus particles studding the surface of a pink lymphocyte with slender branching extensions, beside a blue-tinted neighboring cell also carrying green particles. Scale bar 1 µm." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_25_03_HIVPrev" kind="diagram" alt="Map of global prevalence of HIV in 2015. Global rate is 0.8%. Middle East and North Africa = 0.1%. Asia and the Pacific = 0.2%. Western and Central Europe and North America = 0.3%. Latin America and the Caribbean = 0.5%. Eastern Europe and Central Asia = 0.9%. West and Central Africa = 2.2%. East and Southern Africa = 7.1%." >}}
...
When people are infected with HIV, their disease progresses through three stages based on CD4 T-cell counts and the presence of clinical symptoms (shown in the graph below).

- **Stage 1: Acute HIV infection.** Two to 4 weeks after infection with HIV, patients may experience a flu-like illness, which can last for a few weeks. Patients with acute HIV infection have more than 500 cells/µL CD4 T cells and a large amount of virus in their blood. Patients are very contagious during this stage. To confirm acute infection, either a fourth-generation antibody-antigen test or a nucleic acid test (NAT) must be performed.
- **Stage 2: Clinical latency.** During this period, HIV enters a period of dormancy. Patients have between 200 and 499 cells/µL CD4 T cells; HIV is still active but reproduces at low levels, and patients may not experience any symptoms of illness. For patients who are not taking medicine to treat HIV, this period can last a decade or longer. For patients receiving antiretroviral therapy, the stage may last for several decades, and those with low levels of the virus in their blood are much less likely to transmit HIV than those who are not virally suppressed. Near the end of the latent stage, the patient's viral load starts to increase and the CD4 T-cell count begins to decrease, leading to the development of symptoms and increased susceptibility to opportunistic infections.
- **Stage 3: Acquired immunodeficiency syndrome (AIDS).** Patients are diagnosed with AIDS when their CD4 T-cell count drops below 200 cells/µL or when they develop certain opportunistic illnesses. During this stage, the immune system becomes severely damaged by HIV. Common symptoms of AIDS include chills, fever, sweats, swollen lymph glands, weakness, and weight loss; in addition, patients often develop rare cancers such as Kaposi's sarcoma and opportunistic infections such as *Pneumocystis* pneumonia, tuberculosis, cryptosporidiosis, and toxoplasmosis. This is a fatal progression that, in the terminal stages, includes wasting syndrome and dementia complex. Patients with AIDS have a high viral load and are highly infectious; they typically survive about 3 years without treatment.

{{< mediafigure src="microbiology/OSC_Microbio_25_03_AIDS" kind="diagram" alt="A graph plotting CD4 T-lymphocyte count (left axis, cells/mm³) and HIV RNA copies per mL plasma (right axis, log scale) against time, first in weeks (0–12) then, after an axis break, in years (1–11). The CD4 line (blue) falls sharply after primary infection, partly recovers, then declines slowly across years to near zero by year 10; the HIV RNA line (red) spikes during acute infection, falls during a plateau labeled classical latency, then rises again before death." longdesc="Reading left to right: at week 0 (primary infection), the blue CD4 line begins near 1,050 cells/mm³ and the red HIV RNA line is near its lowest point. A bracket over weeks 3–9 labels acute HIV syndrome, wide dissemination of virus, and seeding of lymphoid organs: the red line rises sharply to a peak near 10⁶ copies/mL around week 6–7, while the blue line dips to about 500 cells/mm³ by week 9. From week 9 to about week 12, the blue line rises again toward about 680 cells/mm³ as the red line falls back to roughly 10³ copies/mL. The x-axis then breaks and switches from weeks to years. A bracket spanning roughly year 1 to year 7 labels classical latency: across this span the blue line declines gradually while the red line stays low and creeps upward. Around year 8, a line labeled constitutional symptoms marks where the red line begins climbing again; around year 9, a line labeled opportunistic diseases marks the blue line falling below roughly 200 cells/mm³ as the red line approaches 10⁶ copies/mL again. Both curves end at death, around year 10–11, with the blue line near zero and the red line near or above 10⁶ copies/mL." >}}
...
{{< callout type="info" >}}
**Disease Profile.** *Viral Diseases of the Circulatory and Lymphatic Systems*

Many viruses are able to cause systemic, difficult-to-treat infections because of their ability to replicate within the host. Some of the more common viruses that affect the circulatory system are summarized below.
...
| Chikungunya fever | Chikungunya virus | Fever, rash, joint pain | Transmitted between humans by *Aedes aegypti* and *A. albopictus* vectors | Viral culture, IFA, EIA, ELISA, PCR, RT-PCR | None |
| Cytomegalovirus infection | Cytomegalovirus (HHV-5) | Usually asymptomatic but may cause non-Epstein-Barr mononucleosis in adults; may cause developmental issues in developing fetus; in transplant recipients, may cause fever, transplant rejection, death | Contact with body fluids, blood transfusions, organ transplants; infected people can transmit virus to fetus transplacentally or to newborn in breastmilk, saliva | Histology, culture, EIA, IFA, PCR | Ganciclovir, valganciclovir, foscarnet, cidofovir |
| Dengue fever (breakbone fever) | Dengue fever viruses 1–4 | Fever, headache, extreme bone and joint pain, abdominal pain, vomiting, hemorrhaging; can be fatal | Transmitted between humans by *A. aegypti* and *A. albopictus* vectors | Serologic testing, ELISA, and RT-PCR | None |
| Ebola virus disease (EVD) | Ebola virus | Fever, headache, joint pain, diarrhea, vomiting, hemorrhaging in gastrointestinal tract, organ failure; often fatal | Contact with body fluids (e.g., blood, saliva, sweat, urine, feces, vomit); highly contagious | ELISA, IgM ELISA, PCR, and virus isolation | None |
| Hantavirus pulmonary syndrome (HPS) | Hantavirus | Initial flu-like symptoms followed by pulmonary edema and hypotension leading to pneumonia and shock; can be fatal | Inhalation of dried feces, urine from infected mouse or rat | ELISA, Western blot, RIBA, RT-PCR | None |
| Hemorrhagic fever with renal syndrome | Hantavirus | Fever, headache, nausea, rash, or eye inflammation, followed by hemorrhaging and kidney failure; can be fatal | Inhalation of dried feces, urine from infected mouse or rat | ELISA, Western blot, RIBA, RT-PCR | None |
...
| Yellow fever | Yellow fever virus | Dizziness, fever, chills, headache, myalgia, nausea, vomiting, constipation, fatigue; moderate to severe cases may include jaundice, rash, mucosal hemorrhaging, seizures, shock, and death | From monkeys to humans or between humans via *Aedes* or *Haemagogus* mosquito vectors | Culture, serology, PCR | None for treatment; preventive vaccine available |
{{< /callout >}}
...
{{< textin
  ...
  hint="This is the malignant cancer Epstein-Barr virus can cause in patients with malaria or HIV coinfection."
>}}
...
{{< textin
  ...
  answer="Epstein-Barr virus"
  accept="EBV"
  hint="This is the virus this section also calls human herpesvirus 4, abbreviated by its discoverers' initials."
>}}

{{< textin
  question="________ are transmitted by vectors such as ticks or mosquitoes."
  answer="Arboviruses"
  accept="Arbovirus"
  hint="This is the general name for arthropod-borne viruses, the category this section opens with."
>}}

### Compare the major characteristics of specific viral diseases affecting the circulatory and lymphatic systems

{{< multiplechoice
  question="A patient at a clinic has tested positive for HIV. Her blood contained 700/µL CD4 T cells and she does not have any apparent illness. Her infection is in which stage?"
  answer="1"
  hint="Patients in this stage have more than 500 CD4 T cells/µL and no symptoms yet, though they are very contagious."
>}}
1
2
3
...
it can take weeks or months for the body to produce detectable antibodies, so a fourth-generation antibody-antigen test or a nucleic acid test confirms infection early
Stage 2 (clinical latency): CD4 T cells between 200 and 499 cells/µL, HIV reproduces at low levels, sometimes for a decade or longer
near the end of the latent stage, viral load increases again and the CD4 T-cell count begins to decrease
...
fourth-generation tests detect both HIV antibodies and HIV antigens, present even before antibodies appear
...
yellow fever was once common in the US, caused serious outbreaks between 1700 and 1900, and has since been eliminated from the US through vector control, with a vaccine available but no effective treatment

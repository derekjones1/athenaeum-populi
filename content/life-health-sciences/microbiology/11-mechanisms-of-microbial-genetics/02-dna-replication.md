...
{{< mediafigure src="microbiology/OSC_Microbio_11_02_DNARep" alt="Diagram comparing three proposed models of DNA replication across two rounds. Conservative: parental strands stay paired together, producing one all-parental and one all-new double helix after round one, and by round two one all-parental helix and three all-new helices. Semiconservative: round one produces two hybrid helices, each with one parental strand and one new strand; round two produces two hybrid helices and two all-new helices. Dispersive: each round mixes parental and new DNA segments within the same strands rather than keeping whole parental or new strands intact." kind="diagram" eager="true" >}}

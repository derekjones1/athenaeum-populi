...
description: >-
  How semiconservative replication was demonstrated by Meselson and Stahl,
  the enzymes that initiate, elongate, and terminate bidirectional bacterial
  DNA replication, how eukaryotic replication differs, and how rolling
  circle replication copies plasmids — adapted from OpenStax Microbiology,
  Section 11.2.
source_section: "11.2"
weight: 2
---
...
{{< mediafigure src="microbiology/OSC_Microbio_11_02_DNARep" alt="Diagram comparing three proposed models of DNA replication across two rounds. Conservative: parental strands stay paired together, producing one all-parental and one all-new double helix after round one, and by round two one all-parental helix and three all-new helices. Semiconservative: each round produces helices with one parental strand and one new strand. Dispersive: each round mixes parental and new DNA segments within the same strands rather than keeping whole parental or new strands intact." kind="diagram" eager="true" >}}
...
That DNA replication is dispersive, since every strand would mix old and new DNA segments.
That no DNA replication had actually occurred.
{{< /multiplechoice >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_11_01_dGTP" alt="Diagram of dGTP. In the center is deoxyribose, a pentagon-shaped sugar. The top point of the pentagon has an oxygen; moving around the ring are carbons 1, 2, 3, and 4, with carbon 5 attached to carbon 4 outside the ring. Carbon 1 carries guanine, a structure made of two carbon-and-nitrogen rings bound along their edges. Carbon 2 carries only hydrogens; carbon 3 carries a hydrogen and an OH; carbon 4 carries a nitrogen and carbon 5. Carbon 5 is attached to three phosphate groups in a row, labeled triphosphate, each phosphate made of a phosphorus attached to four oxygen atoms." kind="diagram" >}}
...
{{< multiplechoice
  question="How does the origin of replication differ between eukaryotes and prokaryotes?"
  answer="Most prokaryotes have a single origin of replication per chromosome, while eukaryotic chromosomes have multiple origins of replication."
  hint="Compare the Number of origins per chromosome row of the comparison table above."
>}}
Most prokaryotes have a single origin of replication per chromosome, while eukaryotic chromosomes have multiple origins of replication.
Prokaryotes have multiple origins of replication per chromosome, while eukaryotes have only one.
Both prokaryotes and eukaryotes typically have a single origin of replication per chromosome.
Neither prokaryotes nor eukaryotes require an origin of replication to begin DNA synthesis.
{{< /multiplechoice >}}
...
To copy their nucleic acids, plasmids and viruses frequently use variations on the pattern of DNA replication described for prokaryote genomes. For more information on the wide range of viral replication strategies, see [The Viral Life Cycle](/life-health-sciences/microbiology/06-acellular-pathogens/02-the-viral-life-cycle/).
...
===CHECKS===
Pairing each base of the template with its complement (A↔T, G↔C)
the new strand antiparallel to the template — so the new strand's 5′ end aligns under the template's 3′ end
The complementary DNA sequence is 5′-ATGACTGACTGCTAG-3′
{{< /selfcheck >}}
...
formed two bands ... and these results could only be explained if DNA replicates in a semiconservative manner
If DNA replication was dispersive, a single purple band positioned closer to the red ¹⁴N band would have been observed
Stopping after only one round would therefore have left the semiconservative and dispersive models indistinguishable
{{< /selfcheck >}}
...
It relaxes the supercoiled chromosome to make the DNA accessible for replication.
It removes the RNA primers from the lagging strand and replaces them with DNA.
{{< /multiplechoice >}}
...
It synthesizes a short RNA primer complementary to the template strand.
...
it cannot add nucleotides if a free 3′-OH group is not available
DNA polymerase would be unable to attach the next nucleotide, and elongation of that strand would stop at that point
{{< /selfcheck >}}

{{< sortbins question="Sort each function below under the enzyme of bacterial DNA replication it describes." hint="Match each function phrase to that enzyme's row in the table above, or to the body paragraph describing it." >}}
{"bins": ["DNA polymerase I", "DNA polymerase III", "Helicase", "DNA ligase"],
 "items": [
  {"label": "Removes RNA primers from the lagging strand", "bin": 0},
  {"label": "Adds nucleotides in the 5′ to 3′ direction as the main replicating enzyme", "bin": 1},
  {"label": "Opens the DNA helix by breaking hydrogen bonds between the nitrogenous bases", "bin": 2},
  {"label": "Seals the gaps between Okazaki fragments on the lagging strand", "bin": 3},
  {"label": "Replaces a removed RNA primer with newly synthesized DNA", "bin": 0},
  {"label": "Extends the RNA primer once it provides a free 3′-OH group", "bin": 1},
  {"label": "Requires ATP hydrolysis to separate the DNA strands", "bin": 2},
  {"label": "Catalyzes a covalent phosphodiester linkage between the 3′-OH end of one DNA fragment and the 5′ phosphate end of another", "bin": 3}]}
{{< /sortbins >}}
...
{"bins": ["Bacteria", "Eukaryotes"],
 "items": [
  {"label": "Single circular chromosome", "bin": 0},
  {"label": "Multiple linear chromosomes", "bin": 1},
  {"label": "Single origin of replication per chromosome", "bin": 0},
  {"label": "Multiple origins of replication per chromosome", "bin": 1},
  {"label": "Replication rate of about 1000 nucleotides per second", "bin": 0},
  {"label": "Replication rate of about 100 nucleotides per second", "bin": 1},
  {"label": "Telomerase not present", "bin": 0},
  {"label": "Telomerase present", "bin": 1},
  {"label": "RNA primer removed by DNA polymerase I", "bin": 0},
  {"label": "RNA primer removed by RNase H", "bin": 1},
  {"label": "Strand elongated by DNA polymerase III", "bin": 0},
  {"label": "Strand elongated by pol δ and pol ε", "bin": 1}]}
{{< /sortbins >}}
...
It is degraded immediately by DNA ligase once the nick forms.
It serves as the template for a second replication fork moving in the opposite direction.
{{< /multiplechoice >}}

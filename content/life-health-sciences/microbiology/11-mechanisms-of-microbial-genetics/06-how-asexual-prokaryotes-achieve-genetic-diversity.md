...
description: >-
  ...
  F⁺/F⁻/Hfr/F′ cells, and how transposons move DNA to create genetic
  diversity in asexually reproducing prokaryotes — adapted from OpenStax
  Microbiology, Section 11.6.
source_section: "11.6"
weight: 6
---
...
2. Transduction: genes are transferred between cells in a virus (see [The Viral Life Cycle](/life-health-sciences/microbiology/06-acellular-pathogens/02-the-viral-life-cycle/))
3. Conjugation: use of a hollow tube called a conjugation pilus to transfer genes between cells

{{< mediafigure src="microbiology/OSC_Microbio_11_06_HGT" alt="Three diagrams. (a) Transformation: a beige cell before and after; a magenta circle of DNA outside it ends up as a magenta arc in its chromosome. (b) Transduction: the same, but a purple bacteriophage on its surface delivers the magenta arc. (c) Conjugation: one static scene of two gold, rod-shaped cells joined by a bridge, each with a plain chromosome circle; the left cell is edged with pale outward-pointing arrows, the right with short knob-tipped pili. A magenta plasmid in the left cell sends a strand into the bridge, and a small black arrow points on into the right cell." longdesc="(a) Transformation: two beige oval cells stacked with a downward arrow between them; the top cell has a magenta circle of free DNA outside it, with a curved arrow from it into the cell; the bottom cell's chromosome now carries a magenta arc where the DNA has recombined in. (b) Transduction: the same before/after layout; the top cell has a purple bacteriophage particle attached to its surface, its magenta DNA passing down through the cell's edge; the bottom cell's chromosome carries the same kind of magenta arc, delivered by the phage instead of taken up directly. (c) Conjugation: unlike (a) and (b), a single static scene, not a before/after pair. Two gold/tan, rod-shaped cells are connected by a bridge drawn as two short parallel gray lines. The left cell is edged with pale arrows pointing outward on all sides; the right cell is edged with short knob-tipped pili. Each cell has a plain, uncolored circular chromosome. The left cell also holds a small magenta plasmid circle; a magenta line runs from that plasmid into the bridge, and a small black arrow beyond its end points into the right cell, showing the plasmid copy being transferred." kind="diagram" eager="true" >}}
...
{{< selfcheck question="What are three ways sexual reproduction introduces genetic variation into offspring?" hint="Reread this section's opening paragraph." >}}
...
===CHECKS===
crossing-over events during meiosis
independent assortment of individual chromosomes during meiosis
the combination of the genetic information from two parents ... producing new combinations of parental genotypes in the diploid offspring
{{< /selfcheck >}}

{{< multiplechoice
  question="What is a benefit of asexual reproduction?"
  answer="It produces more offspring more quickly"
  hint="Reread the first sentences of the introduction's second paragraph."
>}}
It combines genetic information from two different parents
It produces more offspring more quickly
It allows genes to be shared with distantly related species
It introduces new combinations of parental genotypes
{{< /multiplechoice >}}

{{< selfcheck question="What are the three mechanisms of horizontal gene transfer in prokaryotes?" hint="The list right above the HGT figure names all three mechanisms and how each moves DNA." >}}
...
transduction ... genes are transferred between cells in a virus
conjugation ... a hollow tube called a conjugation pilus to transfer genes between cells
{{< /selfcheck >}}

## Transformation

Frederick Griffith was the first to demonstrate the process of transformation. In 1928, he showed that live, nonpathogenic *Streptococcus pneumoniae* bacteria could be transformed into pathogenic bacteria through exposure to a heat-killed pathogenic strain. He concluded that some sort of agent, which he called the "transforming principle," had been passed from the dead pathogenic bacteria to the live, nonpathogenic bacteria. In 1944, Oswald Avery (1877–1955), Colin MacLeod (1909–1972), and Maclyn McCarty (1911–2005) demonstrated that the transforming principle was DNA (see [Using Microbiology to Discover the Secrets of Life](/life-health-sciences/microbiology/10-biochemistry-of-the-genome/01-using-microbiology-to-discover-the-secrets-of-life/)).
...
{{< selfcheck question="Why does a bacterial cell make environmental DNA brought into the cell into a single-stranded form?" hint="Reread the middle of the second paragraph of Transformation." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_11_06_VC" alt="A scanning electron micrograph filling the frame with many overlapping curved, rod-shaped bacterial cells rendered in grayscale, giving the surface a densely tangled, fibrous texture." kind="photo" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_11_06_FtoHfr" alt="Panel (a): a cell with a host chromosome loop, a separate small F-plasmid loop, and a pilus; an arrow leads to a cell where the F plasmid has integrated into the host chromosome, labeled as becoming an Hfr male (donor). Panel (b): an Hfr cell whose chromosome carries the integrated F plasmid, with the lac gene marked at the junction; an arrow leads to the same DNA folded into a figure-eight shape as the plasmid begins to excise, with lac at the pinch point; a further arrow leads to an F′ cell containing a separate F′ plasmid carrying the lac gene and a separate chromosome." longdesc="Panel (a), left to right: a cell containing a host chromosome (blue loop), a separate F plasmid (small pink loop), and a pilus; an arrow leads to a cell where the F plasmid, now a short pink arc marked by an arrow, has integrated into the host chromosome to form one loop, labeled 'F plasmid inserted into host chromosome to become Hfr male (donor)'. Panel (b), left to right: an Hfr cell whose chromosome carries the integrated F plasmid, with the lac gene marked at the plasmid–chromosome junction; an arrow leads to the same DNA folded into a figure-eight shape as the F plasmid begins to excise imprecisely, with lac now positioned at the pinch point; a second arrow leads to the outcome, an F′ cell containing two separate circles — an F′ plasmid that has picked up the lac gene, and the chromosome it came from." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_11_06_HFR" alt="Panel (a): an Hfr cell with an integrated F plasmid and four numbered genes on its chromosome conjugates with a second cell; one strand of its chromosome, led by part of the F plasmid, heads into the recipient with genes 1 and 2 first and 3 and 4 behind, and printed text notes that conjugation ends before the entire chromosome is transferred. Panel (b): a circular genomic map of E. coli, marked in minutes from 0 to 100 around the circle and shaded from light to dark red, with genes positioned by how many minutes of transfer it takes to reach them." longdesc="Panel (a), top to bottom: two cells joined by a narrow neck, with a pair of arrows above pointing toward each other. The left cell (both left cells are labeled Hfr cells) holds a double-ringed chromosome whose outer ring carries a pink integrated F plasmid on its left side; genes numbered 1 to 4 (labeled genes) run around the ring — 1 just past the plasmid's upper end, 2 and 3 on the right, and 4 just below the plasmid's lower end. The right cell holds only a plain double-ringed chromosome. Below, a single strand peels off the donor's ring and runs to the neck, its pink leading end in the neck and an arrow labeled origin of transfer pointing into the recipient; genes 1 and 2 lie along this strand, 3 where it leaves the ring, and 4 still on the ring beside the rest of the pink plasmid. Nothing has yet entered the recipient. Printed below: 'Conjugation ends before entire chromosome is transferred.' Panel (b): a circular genomic map of E. coli, marked in minutes from 0 at the top around to 100 at the same point, shaded from light near 0 minutes to dark red near 100 minutes; genes are positioned around the circle by how many minutes of conjugational transfer it takes to reach them, including proA,B and pabB (early, lightly shaded) and pyrG, argG, argR, oriC, polA, and metA (later, more darkly shaded), with gyrA near the bottom." kind="diagram" >}}
...
Genes required for the production of various toxins and molecules important for colonization during infection may also be found encoded on plasmids. For example, verotoxin-producing strains of *E. coli* (VTEC) appear to have acquired the genes encoding the Shiga toxin from its gram-negative relative *Shigella dysenteriae*, most likely through transduction by a bacteriophage rather than on a plasmid. *(Source note: the source says VTEC acquired these genes "through the acquisition of a large plasmid encoding this toxin." This book's own section on bacterial infections of the gastrointestinal tract says the Shiga toxin genes "were most likely acquired through transduction" and that a "prophage from a bacteriophage that previously infected Shigella integrated into the chromosome of E. coli," so the page follows that account.)* VTEC causes severe diarrheal disease that may result in hemolytic uremic syndrome (HUS), which may lead to kidney failure and death.
...
Watch this [animation](https://openstax.org/l/22conjuganim) to learn more about the process of conjugation.
{{< /callout >}}

**Check Your Understanding**

{{< textin question="What type of replication occurs during conjugation?" answer="rolling circle replication" accept="rolling circle" hint="Name the replication mode of the F plasmid identified early in the Conjugation section." >}}

{{< multiplechoice
  question="What occurs to produce an Hfr E. coli cell?"
  answer="The F plasmid integrates into the bacterial chromosome through recombination between the plasmid and the chromosome"
  hint="Reread the first paragraph of Conjugation of F′ and Hfr Cells."
>}}
The F plasmid is imprecisely excised from the chromosome, carrying adjacent chromosomal DNA with it
The F plasmid integrates into the bacterial chromosome through recombination between the plasmid and the chromosome
A single-stranded copy of the F plasmid is transferred through a cytoplasmic bridge to a recipient cell
A transposon excises from the chromosome and inserts into the F plasmid
{{< /multiplechoice >}}

{{< selfcheck question="What types of traits are encoded on plasmids?" hint="Reread the Consequences and Applications of Conjugation subsection." >}}
...
===CHECKS===
R plasmids carry genes for resistance to one or more antibiotics
genes required for the production of toxins and other molecules important for colonization during infection
metabolic enzymes needed to degrade specialized atypical compounds such as polycyclic aromatic hydrocarbons
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_11_06_Transpos" alt="A three-panel diagram of transposition. Panel 1: a light-blue chromosome segment carries a transposon — a transposase gene flanked by two inverted repeat sequences — beside a separate green segment labeled gene B. Panel 2: a transposase enzyme sits where the transposon has looped out beneath it, its two inverted repeats meeting at the enzyme, while the DNA bends back so gene B also reaches the enzyme. Panel 3: the excised transposon has inserted itself into gene B, splitting it into two segments labeled disrupted gene B." longdesc="Panel 1, labeled 1: a light-blue chromosome segment carries a transposon — a transposase gene (red) flanked on both sides by short inverted repeat sequences (yellow) — positioned beside a separate green segment labeled gene B. Panel 2, labeled 2: a tan, irregular blob labeled transposase sits on the DNA; beneath it the red transposase gene has looped out into a ring so the two yellow inverted repeats meet at the enzyme, and the chromosome bends back over the top so that green gene B also reaches the enzyme; the printed step text says transposase facilitates recombination between the inverted repeats, and the transposon is cut out and inserted into a new location. Panel 3, unlabeled: the excised transposon has inserted itself into gene B, splitting the green gene into a longer left segment and a short right segment on either side of the inserted transposase gene and its flanking repeats, labeled disrupted gene B." kind="diagram" >}}
...
{{< multiplechoice
  question="What are two ways a transposon can affect the phenotype of a cell it moves to?"
  answer="By inactivating a gene or by activating a gene"
  hint="Reread the last sentence of the first Transposition paragraph."
>}}
By replicating the entire bacterial chromosome
By producing a conjugation pilus
By inactivating a gene or by activating a gene
By introducing naked DNA from the environment
{{< /multiplechoice >}}
...
The case continues in [Gene Regulation: Operon Theory](/life-health-sciences/microbiology/11-mechanisms-of-microbial-genetics/07-gene-regulation-operon-theory/). The case began in [The Functions of Genetic Material](/life-health-sciences/microbiology/11-mechanisms-of-microbial-genetics/01-the-functions-of-genetic-material/).
{{< /callout >}}
...
- **F⁺ cells** or **donor cells** — *E. coli* cells containing the F plasmid, capable of forming a conjugation pilus.
- **F⁻ cells** or **recipient cells** — *E. coli* cells lacking an F plasmid.
...
{{< multiplechoice
  question="Which is the mechanism by which improper excision of a prophage from a bacterial chromosome results in packaging of bacterial genes near the integration site into a phage head?"
  answer="specialized transduction"
  hint="Reread the Transduction subsection."
>}}
conjugation
...
{{< multiplechoice
  question="Which of the following refers to the uptake of naked DNA from the surrounding environment?"
  answer="transformation"
  hint="Reread the list above the horizontal-gene-transfer figure."
>}}
conjugation
generalized transduction
specialized transduction
...
{{< multiplechoice
  question="The F plasmid is involved in which of the following processes?"
  answer="conjugation"
  hint="Reread the F plasmid subsection that follows Transduction."
>}}
conjugation
transduction
transposition
...
{{< multiplechoice
  question="Which of the following refers to the mechanism of horizontal gene transfer naturally responsible for the spread of antibiotic resistance genes within a bacterial population?"
  answer="conjugation"
  hint="Reread the Summary's seventh bullet."
>}}
conjugation
generalized transduction
specialized transduction
...
{{< selfcheck question="Briefly describe two ways in which chromosomal DNA from a donor cell may be transferred to a recipient cell during the process of conjugation." hint="The Conjugation of F′ and Hfr Cells discussion names two different routes by which chromosomal DNA, not just the F plasmid, ends up in a recipient cell." >}}
...
===CHECKS===
an Hfr cell ... may treat the entire chromosome like an enormous F plasmid and attempt to transfer a copy of it to a recipient F⁻ cell
the integrated F plasmid may be imprecisely excised from the chromosome, producing an F′ plasmid that carries some chromosomal DNA adjacent to the integration site
{{< /selfcheck >}}

### Explain how asexual gene transfer results in prokaryotic genetic diversity

{{< textin question="________ is a group of mechanisms that allow for the introduction of genetic material from one organism to another organism within the same generation." answer="horizontal gene transfer" accept="HGT" hint="Name the term this whole section defines in its second paragraph." >}}

{{< multiplechoice
  question="Asexually reproducing organisms lack mechanisms for generating genetic diversity within a population."
  answer="False"
  hint="Reread the introduction's second paragraph."
>}}
True
False
{{< /multiplechoice >}}

{{< sortbins question="Sort each phrase under the mechanism of genetic diversity in prokaryotes it describes." hint="Match each definition or distinguishing detail to the mechanism from the Summary of Mechanisms of Genetic Diversity in Prokaryotes table and the surrounding text." >}}
{"bins":["Conjugation","Transduction","Transformation","Transposition"],"items":[{"label":"Transfer of DNA between two cells in direct contact through a hollow tube called a pilus","bin":0},{"label":"Mechanism of horizontal gene transfer in bacteria in which genes are transferred through viral infection","bin":1},{"label":"Mechanism of horizontal gene transfer in which naked environmental DNA is taken up by a bacterial cell","bin":2},{"label":"Process whereby DNA independently excises from one location in a DNA molecule and integrates elsewhere","bin":3},{"label":"Requires an F plasmid-containing donor cell and an F⁻ recipient cell","bin":0},{"label":"Genes are packaged into a bacteriophage and carried to a new host cell","bin":1},{"label":"The recipient bacterium must be naturally competent to bind and transport DNA into its cytoplasm","bin":2},{"label":"Found in both prokaryotes and eukaryotes, unlike the other three mechanisms","bin":3}]}
{{< /sortbins >}}

### Explain the structure and consequences for bacterial genetic diversity of transposons

{{< textin question="A small DNA molecule that has the ability to independently excise from one location in a larger DNA molecule and integrate into the DNA elsewhere is called a ________." answer="transposon" accept="transposable element|jumping gene" hint="Name the mobile genetic element this module's last subsection opens by defining." >}}

{{< textin question="Transposons are molecules of DNA with inverted repeats at their ends that also encode the enzyme ________, allowing for their movement from one location in DNA to another." answer="transposase" hint="Reread the Summary's last bullet." >}}

{{< selfcheck question="Describe what happens when a nonsense mutation is introduced into the gene encoding transposase within a transposon." hint="The answer combines the Transposition subsection with what a nonsense mutation does to a protein (Section 11.5)." >}}
Transposons have the ability to move from one location to another because they code for the enzyme transposase, which lets the entire sequence excise from one location in a DNA molecule and integrate into the DNA elsewhere. A nonsense mutation introduces a premature stop codon, so the transposase gene would encode a truncated, nonfunctional protein. Without functional transposase, the transposon could no longer excise from its location or insert itself elsewhere in the DNA, so that particular transposon would remain fixed in place.
===CHECKS===
Transposons have the ability to move from one location to another because they code for the enzyme transposase
a nonsense mutation introduces a premature stop codon, so the transposase gene would encode a truncated, nonfunctional protein
the transposon could no longer excise from its location or insert itself elsewhere in the DNA
{{< /selfcheck >}}

---

<small>This section is adapted from [Microbiology, Section 11.6: How Asexual Prokaryotes Achieve Genetic Diversity](https://openstax.org/books/microbiology/pages/11-6-how-asexual-prokaryotes-achieve-genetic-diversity) by Nina Parker, Mark Schneegurt, Anh-Hue Thi Tu, Philip Lister, Brian M. Forster, and OpenStax, © OpenStax, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). Access the original for free at [openstax.org](https://openstax.org/details/books/microbiology). Changes: all six source figures are re-encoded as WebP and rendered as mediafigures; the media manifest guesses `kind="photo"` for all six, which is correct only for the *Vibrio cholerae* micrograph — the other five (HGT, conjugation, F-to-Hfr, Hfr, and transposition) are explicit `kind="diagram"` because each is a genuinely drawn, labeled diagram; the HGT figure's alt is rewritten because the source alt describes the panels as narrated definitions ("Transformation is when DNA enters into a cell...") rather than what the artwork shows (paired before/after cell diagrams with color-coded DNA), with a longdesc walking each panel; the conjugation figure's alt is rewritten because the source alt numbers four steps but the artwork itself carries only three numbered call-out boxes (the third box combines the source alt's steps 3 and 4); the Hfr genomic-map figure's alt is corrected because the source alt mislabels the mapped object as "a sample plasmid" of "1000bp total," when the caption and the map itself show it is the bacterial chromosome/genome mapped in minutes of conjugational transfer (0–100), not base pairs — a source-alt defect; the transposition figure's alt is rewritten because it narrates a third numbered step that the artwork does not draw a call-out box for (only boxes 1 and 2 are printed); all figure superscript F⁺/F⁻ marks in captions and alts are normalized to the Unicode superscript characters. All three body objectives are used as Practice group headings. All ten body Check Your Understanding bullets are rendered as body items at their note positions: six are graded (four multiple choice and two textin) and four are self-checks with model answers and rubrics assembled only from this module's own sentences, because their honest answers require assembling several sentences or naming a long list; the four graded multiple-choice items each draw their distractors from this module's own sibling HGT and transposon descriptions, never invented content. Of the module's nine source exercises, all four Multiple Choice, both Fill in the Blank, and the one True/False item are adapted into Practice (the True/False as a two-option multiple choice); of the two unkeyed Short Answer questions, neither is fixed by a single module sentence, so both are self-checks with model answers assembled strictly from this module's own text (the conjugation question from the Conjugation of F′ and Hfr Cells discussion, the transposase-mutation question from the transposase and transposon definitions plus the mutation-type reasoning this book teaches for a nonsense mutation). The Consequences and Applications of Conjugation Check Your Understanding item "What occurs to produce an Hfr *E. coli* cell?" is rendered as a multiple choice whose distractors are this module's own descriptions of F′-plasmid excision, typical F⁺/F⁻ conjugation, and transposition, rather than invented alternatives. The four-row Summary of Mechanisms of Genetic Diversity in Prokaryotes table is transcribed from the CNXML cells and feeds one Practice `sortbins` under "Explain how asexual gene transfer results in prokaryotic genetic diversity," padded with one additional distinguishing phrase per mechanism drawn from this module's own text (an F⁺/F⁻ requirement for conjugation, phage packaging for transduction, natural competence for transformation, and the eukaryote/prokaryote reach of transposition), because a table row alone is not enough items for the sortbins minimum. One filler Practice item is author-written strictly from this module's own text: a cloze textin from the Key Concepts and Summary sentence on transposase, filling the Explain the structure and consequences for bacterial genetic diversity of transposons objective to the three-item floor. Feature boxes are rendered as callouts: the Case in Point (with the *Vibrio cholerae* micrograph) keeps its three closing questions as unanswered plain bullets at their document position, before the figure, exactly as printed; the Link to Learning keeps its animation link; Clinical Focus Part 3 links the case forward to Gene Regulation: Operon Theory and names The Functions of Genetic Material as where the case began, regardless of which earlier Clinical Focus part the source's own "previous" link points to. Cross-references to the not-yet-authored *Microbes and the Tools of Genetic Engineering* (the chapter 12 introduction, cited twice) are left as plain italicized text naming the target rather than links. The two `<link document="m58809">` references to The Viral Life Cycle (one with visible link text, one an empty reference to its transduction figure) are both rendered as links to that page, the second as a describing phrase since it names no link text of its own. Key terms are compiled from the module's 18 defined terms and the book's Glossary appendix, rendered as 15 bullets: `donor cell`, `F⁻ cell`, and `recipient cell` have no distinct appendix entry, so their meanings are taken from this module's own defining sentences; `F plasmid` and `fertility factor` are defined in the same sentence ("also known as") and share the one appendix entry `F plasmid (fertility factor)`, so they are combined into a single bullet; the `F⁺ cell`/`donor cell` and `F⁻ cell`/`recipient cell` pairs, each naming one appendix concept under two body terms, are likewise combined into two bullets rather than four. In the Multiple Choice "Which of the following refers to the mechanism of horizontal gene transfer naturally responsible for the spread of antibiotic resistance genes within a bacterial population?", the source distractor "transformation" is replaced with "vertical gene transfer" (key "conjugation" unchanged), because this module's own sentence that "bacterial transformation is an important mechanism for the acquisition of genetic elements encoding virulence factors and antibiotic resistance" made it a second correct option; the replacement is the module's own contrasting term. The source's "may be lead to kidney failure" is corrected to "may lead to kidney failure". In the same paragraph, the source's claim that VTEC acquired the Shiga toxin genes "through the acquisition of a large plasmid encoding this toxin" is printed as "most likely through transduction by a bacteriophage rather than on a plasmid," with a visible Source note, because the book's own [Bacterial Infections of the Gastrointestinal Tract](/life-health-sciences/microbiology/24-digestive-system-infections/03-bacterial-infections-of-the-gastrointestinal-tract/) says the genes arrived by transduction on a prophage. The source's F⁺/F⁻ superscript minus sign, printed inconsistently across the module (as −, -, and – in different `<sup>` elements), is normalized to F⁺/F⁻ everywhere on this page, and the F' plasmid's typewriter apostrophe is normalized to F′ throughout. The body Check Your Understanding on where the DNA in specialized transduction comes from and the source Multiple Choice on improper prophage excision (key specialized transduction) ask the same fact from opposite ends; both are source items and both are kept.</small>

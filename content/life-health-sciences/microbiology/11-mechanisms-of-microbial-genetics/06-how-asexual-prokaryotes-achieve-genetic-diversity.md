...
{{< selfcheck question="What are three ways sexual reproduction introduces genetic variation into offspring?" hint="The opening paragraph names two events that occur during meiosis and a third event that happens when two parents' genetic information combines." >}}
...
{{< multiplechoice
  ...
  hint="Recall what the module says is traded off against the diversity that is lost in asexual reproduction."
>}}
...
{{< selfcheck question="Why does a bacterial cell make environmental DNA brought into the cell into a single-stranded form?" hint="Recall which form of foreign DNA the cell's nucleases usually destroy, and which form they cannot." >}}
...
{{< textin question="What is the agent of transduction of prokaryotic cells?" answer="bacteriophages" accept="bacteriophage|phage" hint="Name the viruses that infect bacteria, introduced at the start of this section." >}}
...
{{< multiplechoice
  ...
  hint="Recall which process packages DNA from a fixed location beside the prophage, rather than a random piece of the chromosome."
>}}
...
{{< textin question="What type of replication occurs during conjugation?" answer="rolling circle replication" hint="Name the replication mode of the F plasmid identified early in the Conjugation section." >}}
...
{{< multiplechoice
  ...
  hint="Distinguish integration of the F plasmid into the chromosome from its later excision, which produces a different kind of cell."
>}}
...
Rolling circle replication transfers a single strand of the F plasmid to a recipient cell
A transposon excises from the chromosome and inserts into the F plasmid
{{< /multiplechoice >}}

{{< selfcheck question="What types of traits are encoded on plasmids?" hint="The Consequences and Applications of Conjugation discussion names several categories of plasmid-encoded traits, from resistance genes to metabolic enzymes." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_11_06_Transpos" alt="A three-panel diagram of transposition. Panel 1: a light-blue chromosome segment carries a transposon — a transposase gene flanked by two inverted repeat sequences — beside a separate green segment labeled gene B. Panel 2: a loop-shaped transposase enzyme has bound the transposon, folding the DNA so its two inverted repeats meet. Panel 3: the excised transposon has inserted itself into the middle of gene B, splitting it into two segments labeled disrupted gene B." longdesc="Panel 1, labeled 1: a light-blue chromosome segment carries a transposon — a transposase gene (red) flanked on both sides by short inverted repeat sequences (yellow) — positioned beside a separate green segment labeled gene B. Panel 2, labeled 2: a tan, loop-shaped transposase enzyme has bound the transposon, bending the DNA so its two inverted repeats meet, letting the enzyme cut the transposon out of its original location. Panel 3, unlabeled: the excised transposon has inserted itself into the middle of gene B, splitting the green gene into two segments on either side of the inserted transposase gene and its flanking repeats, labeled disrupted gene B." kind="diagram" >}}
...
{{< multiplechoice
  ...
  hint="Recall what happens when a transposon's movement disrupts, or lands near, a gene within the same DNA molecule."
>}}
...
{{< multiplechoice
  ...
  hint="This is the process the section names for a prophage that carries chromosomal DNA from beside its own integration site."
>}}
conjugation
...
{{< multiplechoice
  ...
  hint="Recall which of the three HGT mechanisms does not involve a virus or a pilus at all."
>}}
conjugation
generalized transduction
specialized transduction
...
{{< multiplechoice
  ...
  answer="conjugation"
  hint="Recall which mechanism depends on the conjugation pilus encoded by the F plasmid."
>}}
conjugation
transduction
transposition
...
{{< multiplechoice
  ...
  answer="conjugation"
  hint="Recall which mechanism the section names for the transfer of R plasmids between cells."
>}}
conjugation
generalized transduction
specialized transduction
...
{{< multiplechoice
  ...
  answer="False"
  hint="Recall whether this section identifies mechanisms, beyond mutation, that let asexually reproducing organisms generate genetic diversity."
>}}
True
False
{{< /multiplechoice >}}
...
{{< textin question="A small DNA molecule that has the ability to independently excise from one location in a larger DNA molecule and integrate into the DNA elsewhere is called a ________." answer="transposon" accept="transposable element|jumping gene" hint="Name the genetic element with inverted repeats at its ends and its own gene for the enzyme transposase, introduced at the start of the Transposition section." >}}

{{< textin question="Transposons are molecules of DNA with inverted repeats at their ends that also encode the enzyme ________, allowing for their movement from one location in DNA to another." answer="transposase" hint="Name the enzyme, encoded by the transposon itself, that lets it excise and reinsert elsewhere (see Summary)." >}}

{{< selfcheck question="Describe what happens when a nonsense mutation is introduced into the gene encoding transposase within a transposon." hint="Recall what transposase does for a transposon, and what a nonsense mutation does to the protein a gene encodes." >}}
...
===CHECKS===
transposase ... facilitates recombination between the transposon's own inverted repeat sequences, cutting the transposon from its original location and inserting it elsewhere

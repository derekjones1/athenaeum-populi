...
{{< textin question="What type of mutation occurs when a gene has two fewer nucleotides in its sequence?" answer="frameshift mutation" accept="frameshift|frame shift|deletion|deletion mutation" hint="Reread this subsection's paragraph, together with the second paragraph of Effects of Mutations on Protein Structure and Function." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_11_05_EffMut" alt="Four side-by-side before-and-after diagrams of the same twelve-base DNA strand paired with its four encoded amino acids. Silent: the sixth base changes but all four amino acids (Ser, Val, Pro, Tyr) stay the same. Missense: the seventh base changes and the third amino acid changes from Pro to Thr. Nonsense: the last base changes and the fourth amino acid changes from Tyr to a stop codon. Frameshift: two highlighted bases, the fifth and sixth, are deleted, and the amino acids after that point change to Leu and Leu." longdesc="Four labeled panels, each showing a twelve-base DNA strand above its four bracketed codons and their amino acids, with an arrow to the mutated version. Point Mutations: (1) Silent — AGCGTACCCTAC becomes AGCGTTCCCTAC (position 6, A to T); amino acids stay Ser-Val-Pro-Tyr. (2) Missense — AGCGTACCCTAC becomes AGCGTAACCTAC (position 7, C to A); amino acids become Ser-Val-Thr-Tyr (Pro to Thr). (3) Nonsense — AGCGTACCCTAC becomes AGCGTACCCTAG (last position, C to G); amino acids become Ser-Val-Pro-Stop (Tyr to Stop). Frameshift Mutations: AGCGTACCCTAC becomes AGCGCCCTACTT (the highlighted T and A at positions 5 and 6 are deleted, and two more bases, T and T, appear at the end to complete four codons); amino acids become Ser-Val-Leu-Leu." kind="diagram" eager="true" >}}
Mutations can lead to changes in the protein sequence encoded by the DNA.
{{< /mediafigure >}}

**Check Your Understanding**

{{< textin question="What are the reasons a nucleotide change in a gene for a protein might not have any effect on the phenotype of that gene?" answer="degeneracy" accept="degeneracy of the code|code degeneracy|genetic code degeneracy|silent mutation|silent" hint="Reread the opening sentences of this subsection's first paragraph." >}}

{{< selfcheck question="Is it possible for an insertion of three nucleotides together after the fifth nucleotide in a protein-coding gene to produce a protein that is shorter than normal? How or how not?" hint="Reread this subsection's second paragraph and the end of its first paragraph." >}}
Insertions or deletions in groups of three nucleotides do not shift the reading frame, because codons are triplets of nucleotides; such an in-frame change may lead to the insertion or deletion of one or more amino acids and may not cause significant effects on the resulting protein's functionality. A protein shorter than normal results when a codon encoding an amino acid is converted into a stop codon, as in a nonsense mutation, so an in-frame insertion of three nucleotides could shorten the protein only if the inserted nucleotides create a stop codon; this section does not discuss that case directly.
===CHECKS===
...
could shorten the protein only if the inserted nucleotides create a stop codon
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_11_05_NucAnMod" alt="Chemical diagrams comparing normal nitrogenous bases with their nucleoside analogs. Adenine nucleoside is redrawn as 2-aminopurine nucleoside: a hydrogen sits where adenine carries its amine group, and a new amine group appears at the ring's other carbon, where adenine carries a hydrogen. Thymine's ring is compared with 5-bromouracil, which carries a bromine where thymine carries a methyl group and is shown base-pairing with guanine. Cytosine reacts with nitrous acid to lose its amine group, becoming uracil, which is then shown hydrogen-bonded to adenine instead of guanine." longdesc="Panel (a): a normal adenine nucleoside (a sugar attached to a purine ring bearing an NH₂ group) is converted by an arrow into 2-aminopurine nucleoside, the same purine ring with an H in place of the NH₂ and, at the ring's other carbon (an H in adenine), a new NH₂ — the amine group is relocated, not deleted. Below, thymine and 5-bromouracil are drawn as separate pyrimidine rings — thymine has a methyl (CH₃) group and 5-bromouracil has a bromine (Br) at the equivalent ring position — and an arrow connects them to a hydrogen-bonded pair labeled guanine (normal state) hydrogen-bonded to 5-bromouracil (rare enol form) through three dashed hydrogen bonds, with sugar groups labeled on each base. Panel (b): cytosine, drawn with an NH₂ group on its ring, reacts with nitrous acid (HNO₂) to form uracil, which carries a double-bonded O where cytosine's NH₂ was (both highlighted in red); uracil is then shown hydrogen-bonded through two dashed bonds to adenine, in place of cytosine's normal hydrogen bonding to guanine." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_11_05_Intercal" alt="Diagram of acridine, a three-ringed molecule with a dimethylamino group at each end, wedged between two base pairs of a DNA double helix. A red X and a black arrow mark two highlighted top-strand bases, C and A, just past the acridine, and a second black arrow marks the bottom strand at the acridine's edge. After replication the diagram branches to two outcomes: a daughter DNA molecule missing those two top-strand bases, or one with three extra bases inserted in the bottom strand." longdesc="Top left, boxed: the structure of acridine, three fused rings with a dimethylamino group at each end. At the far left, a ladder labeled normal parent DNA reads TTACCAACTA on the top strand and AATGGTTGAT on the bottom. A gray arrow leads from it to the same ladder with the acridine (a curved arrow from the box) drawn inside an oval, wedged between the fourth and fifth base pairs; just right of the oval, the top strand's next two bases, C and A, are highlighted in red under a red X and a downward black arrow, and an upward black arrow below points at the bottom strand at the oval's right edge. An arrow labeled replication leads to two outcomes joined by 'or'. Left, 'deletion in top strand': a strand TTACACTA, missing the highlighted C and A, then below it the daughter DNA, TTACACTA over a newly made bottom strand AATGTGAT. Right, 'insertion in bottom strand': a strand AATGCTAGTTGAT with three extra bases, CTA, highlighted where the acridine sat, then below it the daughter DNA, a newly made top strand TTACGATCAACTA (GAT highlighted) over AATGCTAGTTGAT. The new strand in each daughter is drawn with a red backbone." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_11_05_Rad" alt="Two panels. (a) Ionizing radiation: a segment of double-helix DNA drawn as two ribbons with rung-like base pairs, with X-rays or γ-rays striking it (small black arrows), producing a single-strand break in one backbone ribbon and, a short distance away, a double-strand break severing both ribbons. (b) Nonionizing radiation: a close-up of two adjacent thymine bases on one strand, each drawn as a hexagon, joined to each other by covalent bonds instead of to the adenines on the opposite strand; a UV-light arrow points at the thymine dimer, and the double helix is shown kinked at that point." longdesc="Panel (a), labeled ionizing radiation: a length of double-helix DNA (two backbone ribbons with paired rungs) with three small arrows labeled 'x-rays or γ-rays' striking it from above; a label 'single strand break' points to a spot where only one backbone ribbon is cut, and a label 'double strand break' points to a nearby spot where both backbone strands are cut all the way through. Panel (b), labeled nonionizing radiation: a boxed close-up of one strand's two adjacent thymine (T) bases, each still attached by its sugar-phosphate backbone (3′ and 5′ labeled) and now joined to each other by a pair of covalent bonds instead of to their normal adenine (A) partners on the complementary strand, with two red zigzag arrows labeled UV light striking the dimer; to the right, joined to the box by a curved arrow, the full double helix is drawn with a visible kink at the position of the thymine dimer, and the two unpaired adenines are labeled on the opposite strand." kind="diagram" >}}
...
| Nitrous acid | Deaminates C to U | Converts GC to AT base pair | Point |
...
*(Source note: the source's table names "nitrous oxide" as the nucleotide-modifying agent. This section's own chemical-mutagen paragraph and nucleoside-analog figure caption both name nitrous acid as the chemical that deaminates cytosine to uracil; nitrous oxide is a different compound, so the row is printed as nitrous acid.)*
...
{{< selfcheck question="How does an intercalating agent introduce a mutation?" hint="Reread the second paragraph of Chemical Mutagens." >}}
...
{{< textin question="What type of mutagen causes thymine dimers?" answer="nonionizing radiation" accept="non-ionizing radiation|nonionizing|ultraviolet light|UV light|ultraviolet radiation|UV radiation|ultraviolet|UV" hint="Reread the second paragraph of the Radiation subsection." >}}
...
{{< multiplechoice
  ...
  hint="Reread the Mismatch Repair subsection."
>}}
The parental strand is methylated while the newly synthesized daughter strand has not yet been methylated.
An enzyme complex scans the DNA for a distortion in the double helix.
The photolyase enzyme recognizes a distortion in the DNA helix and binds to it.
DNA polymerase compares each newly added base to the corresponding base in the template strand.
{{< /multiplechoice >}}

{{< textin question="What type of mutation does photolyase repair?" answer="thymine dimers" accept="pyrimidine dimer" hint="Reread the second paragraph of the subsection just above this box." >}}
...
{{< multiplechoice
  ...
  hint="Reread the Identifying Bacterial Mutants paragraph, from the velvet step onward."
>}}
...
{{< multiplechoice
  ...
  hint="Reread The Ames Test paragraph."
>}}
...
{{< selfcheck question="Why can the Ames test work as a test for carcinogenicity?" hint="The answer draws on the Causes of Mutations paragraph and The Ames Test paragraph." >}}
...
{{< multiplechoice
  ...
  hint="Reread the second paragraph of Effects of Mutations on Protein Structure and Function."
>}}
...
{{< selfcheck question="Why is it more likely that insertions or deletions will be more detrimental to a cell than point mutations?" hint="The answer draws on both paragraphs of Effects of Mutations on Protein Structure and Function." >}}
A point mutation affects only a single base: because of the degeneracy of the genetic code it often changes nothing at all (a silent mutation), it may change the one amino acid encoded by that codon (a missense mutation), or it may convert that codon into a stop codon (a nonsense mutation). An insertion or a deletion is far more often destructive, because whenever the number of nucleotides added or removed is not a multiple of three, a frameshift mutation results: since ribosomes read the mRNA in triplet codons, a frameshift mutation can change every amino acid after the point of the mutation, and the new reading frame may also include a stop codon before the end of the coding sequence. Consequently, proteins made from genes containing frameshift mutations are nearly always nonfunctional, whereas many missense point mutations still produce a protein that is at least partly functional.
===CHECKS===
...
{{< multiplechoice
  ...
  hint="Reread the last sentences of the first paragraph of Effects of Mutations on Protein Structure and Function."
>}}
missense mutation
nonsense mutation
silent mutation
...
{{< textin question="A missense mutation whose effects are only apparent under certain environmental conditions is called a ________ mutation." answer="conditional" hint="Reread the middle of the first paragraph of Effects of Mutations on Protein Structure and Function." >}}

### Describe the differences between light and dark repair

{{< textin question="The enzyme used in light repair to split thymine dimers is called ________." answer="photolyase" hint="Reread the second paragraph of Repair of Thymine Dimers." >}}
...
{{< multiplechoice
  ...
  hint="Reread the second paragraph of Repair of Thymine Dimers."
>}}
direct repair
...
{{< multiplechoice
  ...
  hint="Reread the first paragraph of Repair of Thymine Dimers."
>}}
...
{{< multiplechoice
  ...
  hint="Reread the second paragraph of the Radiation subsection."
>}}
...
{{< textin question="A chemical mutagen that is structurally similar to a nucleotide but has different base-pairing rules is called a ________." answer="nucleoside analog" accept="nucleoside analogue|base analog|base analogue" hint="Reread the first paragraph of Chemical Mutagens." >}}
...
{"bins": ["Nucleoside analogs", "Intercalating agents", "Ionizing radiation", "Nonionizing radiation"],
 "items": [
  ...
  {"label": "Introduces small deletions and insertions, resulting in a frameshift mutation", "bin": 1},
  {"label": "X-rays or γ-rays modify bases (for example, deaminating C to U), converting a GC to an AT base pair", "bin": 2},
  {"label": "Causes DNA replication errors, resulting in frameshift or point mutations", "bin": 3}]}
{{< /sortbins >}}
...
{{< multiplechoice
  ...
  answer="True"
  hint="Reread the Causes of Mutations paragraph."
>}}
True
False
{{< /multiplechoice >}}

{{< selfcheck question="Why do you think the Ames test is preferable to the use of animal models to screen chemical compounds for mutagenicity?" hint="Reread The Ames Test paragraph, first and last sentences." >}}

...
{{< selfcheck question="What is the difference between immunohistochemistry and immunocytochemistry?" hint="Compare which one examines a whole tissue section and which one requires the cell membrane itself to be made permeable." >}}
...
{{< selfcheck question="What must be true of the product of the enzymatic reaction used in immunohistochemistry?" hint="Think about what a substrate for the enzyme has to turn into so a stained cell can actually be seen." >}}
...
{{< selfcheck question="What is the purpose of the secondary antibody in a direct ELISA?" hint="The module's summary treats the sandwich procedure as the direct ELISA — think about what the second antibody carries and what its enzyme then does." >}}
...
{{< multiplechoice
  ...
  hint="One of the two assays swaps which molecule is attached to the plate and which one is measured from the patient's sample."
>}}
...
{{< textin question="What physical process does the lateral flow method require to function?" answer="capillary action" accept="capillarity|capillary flow" hint="Look at the sentence describing how the fluid moves through the absorbent pad and stripes of the test strip." >}}
...
{{< multiplechoice
  ...
  hint="Read the second paragraph of this section, on what the substrate for the enzyme can be."
>}}
antigen
...
{{< textin question="To detect antibodies against bacteria in the bloodstream using an EIA, we would run a(n) ________, which we would start by attaching antigen from the bacteria to the wells of a microtiter plate." answer="indirect ELISA" accept="indirect ELISA assay" hint="Read the third paragraph of Enzyme-linked Immunosorbent Assays (ELISAs)." >}}
...
{{< textin question="The staining technique in which labeled antibodies are bound to specific cells in a tissue section is called ________." answer="immunohistochemistry" accept="IHC" hint="This is the technique demonstrated on the CD8-stained tissue section earlier in this section." >}}

{{< textin question="Immunostaining is an EIA technique for visualizing cells in a tissue (IHC) or examining ________ (immunocytochemistry)." answer="intracellular structures" accept="structures inside the cell|structures inside cells|intracellular targets" hint="Read the Summary bullet on immunostaining." >}}

### Describe the different purposes of direct and indirect ELISA

{{< selfcheck question="Why is it important in a sandwich ELISA that the antigen has multiple epitopes? And why might it be advantageous to use polyclonal antisera rather than mAb in this assay?" hint="Think about how many separate binding sites the primary and secondary antibodies each need on the very same antigen molecule." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_20_04_ArtConnect_img" kind="diagram" alt="A drawn sandwich-ELISA schematic, redrawn without its labels: three orange Y-shaped molecules are fixed side by side to the floor of a well, each with a small red circle bound between its arms; above each, a second, green Y-shaped molecule carrying a small purple oval at the top of its stem sits attached to the red circle below it." >}}
A drawn sandwich-ELISA schematic: a well surface, two Y-shaped molecules, a bound particle, and a small circle on the upper Y-shape, redrawn without its labels.
{{< /mediafigure >}}

{{< selfcheck question="Label the primary and secondary antibodies, and discuss why the production of end product will be proportional to the amount of antigen." hint="Identify which Y-shape is fixed to the well first, and which one arrives afterward carrying the enzyme." >}}
The Y-shape fixed to the floor of the well is the primary antibody, added first so it can capture antigen from the sample. The Y-shape above it, carrying a small filled circle, is the secondary antibody, which is conjugated to an enzyme and is added afterward to bind the same captured antigen. The amount of color produced (measured as absorbance) is directly proportional to the amount of enzyme present, which in turn is directly proportional to the amount of captured antigen — so more antigen captured means more secondary antibody bound, which means more enzyme, and more colored end product.
===CHECKS===
the Y-shape fixed to the floor of the well is the primary antibody
the Y-shape above it, carrying a small filled circle, is the secondary antibody, conjugated to an enzyme

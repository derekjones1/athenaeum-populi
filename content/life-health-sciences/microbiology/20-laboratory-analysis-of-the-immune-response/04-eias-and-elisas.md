...
description: >-
  How enzyme immunoassays use an enzyme-antibody conjugate to detect and
  quantify antigens and antibodies — the shared logic of EIA, FEIA, and
  ELISA, immunostaining by immunohistochemistry and immunocytochemistry,
  direct, sandwich, and indirect ELISA, and immunofiltration and
  immunochromatographic (lateral flow) tests — adapted from OpenStax
  Microbiology, Section 20.4.
source_section: "20.4"
weight: 4
---
...
{{< mediafigure src="microbiology/OSC_Microbio_20_04_EIA" kind="diagram" eager="true" alt="A three-panel drawn diagram numbered 1 to 3. Panel 1: three red diamonds (antigen) sit on a tan surface. Panel 2: a green Y-shaped antibody carrying a purple oval (enzyme) binds to each diamond. Panel 3: a yellow circle (substrate) beside each antibody's enzyme is joined by a curved arrow to a blue starburst (colored product)." longdesc="The figure numbers its three steps 1 to 3, left to right. (1) Antigen binds to surface: three red diamonds rest side by side on a tan surface. (2) Antibody-enzyme conjugate attaches to antigen: a green Y-shaped antibody, each carrying a purple oval enzyme at the free top end of its stem, opposite the two antigen-binding arms, binds to each diamond. (3) Substrate and enzyme interaction creates color change detection: beside each antibody's enzyme a yellow circle (substrate) is joined by a curved gray arrow to a blue starburst (colored product)." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_20_04_IHC" kind="photo" alt="A micrograph of many round cells; scattered cells are stained dark brown against a background of lighter, blue-tinted cells, and a line labeled 'CD8 cell' points to one of the dark brown cells." >}}
...
{{< selfcheck question="What is the difference between immunohistochemistry and immunocytochemistry?" hint="Read the two paragraphs of Immunostaining." >}}
Immunohistochemistry (IHC) is used for examining whole tissues, staining a tissue section to visualize the various cell types it contains. Immunocytochemistry (ICC) is similar, but the extracellular matrix material is stripped away and the cell membrane is etched with alcohol to make it permeable to antibodies, allowing antibodies to pass through the cell membrane and bind to specific targets inside the cell.
===CHECKS===
IHC is used for examining whole tissues
in ICC, extracellular matrix material is stripped away, and the cell membrane is etched with alcohol to make it permeable to antibodies
this allows antibodies to pass through the cell membrane and bind to specific targets inside the cell
{{< /selfcheck >}}

{{< selfcheck question="What must be true of the product of the enzymatic reaction used in immunohistochemistry?" hint="Read the second paragraph of this section and the caption of the CD8 micrograph." >}}
The product of the enzymatic reaction has to be detectable so the stained cells can be seen: in EIAs, the substrate for the enzyme is most often a chromogen, a colorless molecule that is converted into a colored end product, and the CD8 tissue in this section's own micrograph is stained using such a chromogen.
===CHECKS===
the substrate for the enzyme is most often a chromogen, a colorless molecule that is converted into a colored end product
the CD8 tissue in this section's own micrograph is stained using a chromogen
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_20_04_ELISA" kind="diagram" alt="(a) A seven-step diagrammed sandwich ELISA in two columns, positive and negative sample, showing antibodies bound to a well, capturing antigen, then binding an enzyme-linked antibody, ending with a color change only in the positive column. (b) A photo of a microtiter plate whose wells are shaded from clear to teal in a checkerboard pattern." longdesc="The figure numbers seven steps down two columns headed 'positive sample' and 'negative sample.' (1) Primary antibody binds well: identical rows of yellow Y-shaped antibodies line the floor of both columns. (2) Blocking agent is added: a speckled layer covers the exposed surface between the antibodies in both columns. (3) Sample added: in the positive column a red particle (antigen) attaches to four of the five antibodies, leaving one (the fourth from the left) bare; in the negative column nothing attaches. (4) Unbound sample is washed away, shown by arrows; the positive column keeps its four red particles and the negative column has none. (5) Antibody-enzyme conjugate is added: a second, purple-topped Y-shape attaches to three of the positive column's four red particles (the second antigen from the left is left without one), while in the negative column two of the same purple-topped Y-shapes are drawn detached, unable to bind anything. (6) Unbound secondary antibody-enzyme conjugate is washed away: the three bound conjugates remain attached in the positive column and both unbound ones disappear from the negative column. (7) Substrate is added: in the positive column a small circle beside each of the three remaining enzymes turns into a blue starburst (colored product); the negative column, having no enzyme left, shows no color change. Panel (b) is a photograph of a microtiter plate under the handwritten heading 'ELISA checkerboard titration.' The three leftmost columns of wells, marked as controls, are clear; the next column is a deep teal, and the color fades column by column to the right across dilutions of the positive control marked 1:500 to 1:5000 along the bottom, and slightly down the rows, marked with conjugate dilutions 1:1000 to 1:4000 along the right edge." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_20_04_Indirect" kind="diagram" alt="A seven-step diagrammed indirect ELISA in two columns, positive and negative sample, showing antigen bound to a well, then patient antibody binding it, then an anti-human enzyme-linked antibody binding that, ending in a color change only in the positive column." longdesc="The figure numbers seven steps down two columns headed 'positive sample' and 'negative sample.' (1) Antigen is bound to well: identical rows of red diamonds line the floor of both columns. (2) Blocking agent is added: a speckled layer covers the surface between the diamonds in both columns. (3) Sample added: in the positive column a yellow Y-shaped primary antibody with forked tips attaches to each of the three diamonds, and two antibodies with differently shaped, non-matching tips (one square, one rounded) float unattached; in the negative column four antibodies, all with those non-matching tips, float unattached above the diamonds. (4) Unbound sample is washed away: the positive column keeps its three bound antibodies and the negative column loses all of its antibodies. (5) Antihuman enzyme-linked antibody is added: a second, purple-topped Y-shape attaches to each bound primary antibody in the positive column, while in the negative column only two of the purple-topped shapes are drawn, unattached. (6) Unbound antihuman antibody is washed away: it remains in the positive column and disappears from the negative column. (7) Substrate is added: in the positive column a small circle beside each secondary antibody turns into a blue starburst (colored product) — the artwork's own label misprints this step's reagent as 'subtrate' rather than 'substrate' — and the negative column's three substrate circles stay unchanged, with no color change." >}}
...
{{< multiplechoice
  question="What do the direct and indirect ELISAs quantify?"
  answer="Direct ELISA quantifies antigen; indirect ELISA quantifies antibody."
  hint="Read the third paragraph of Enzyme-linked Immunosorbent Assays (ELISAs) and the Summary bullets on the two ELISAs."
>}}
Direct ELISA quantifies antigen; indirect ELISA quantifies antibody.
Direct ELISA quantifies antibody; indirect ELISA quantifies antigen.
Both direct and indirect ELISA quantify antigen.
Both direct and indirect ELISA quantify antibody.
{{< /multiplechoice >}}

{{< selfcheck question="What is the purpose of the secondary antibody in a direct ELISA?" hint="Read the sandwich ELISA paragraph of Enzyme-linked Immunosorbent Assays (ELISAs) and the Summary bullet on direct ELISA." >}}
In the direct (sandwich) ELISA, after the primary antibody captures the antigen, the secondary antibody — a polyclonal antibody conjugated to an enzyme — is added, and the enzyme converts a colorless substrate into a colored end product whose intensity is directly proportional to the amount of captured antigen.
===CHECKS===
the secondary antibody is a polyclonal antibody that is conjugated to an enzyme
the enzyme converts it into a colored end product
...
{{< mediafigure src="microbiology/OSC_Microbio_20_04_Lateral" kind="diagram" alt="A two-part diagram, 'Positive test' and 'Negative test,' each showing a test strip with three zones — mix area, test line, control line — as urine flows left to right, with numbered callouts describing the antibody-bead chemistry and starbursts marking where a color develops. A legend keys the hCG-first antibody, the hCG antigen, the hCG-second antibody-gold conjugate, and IgG." longdesc="Two labeled diagrams stack vertically, 'Positive test' above 'Negative test.' Each shows a tilted rectangular strip divided into three zones from left to right — a mix area, a test line, and a control line — with 'flow' arrows between them. Four numbered callouts above the positive test read: (1) Human chorionic gonadotropin (hCG) urine sample is applied to absorbent sample pad — the artwork's own legend misprints this hormone's name as 'gonadortropin' rather than 'gonadotropin.' (2) hCG antigen bonds with the anti-hCG antibody-colloidal gold conjugates. (3) hCG antigen bound to anti-hCG antibody-colloidal gold conjugate is captured by immobilized anti-hCG antibody. (4) Free hCG antibody-colloidal gold is captured by antibodies. In each row an arrow carries the urine sample onto the mix area, which holds seven gold conjugates, and the band after it is labeled 'hCG strip.' In the positive-test row the urine sample carries four red hCG diamonds; at the test line, green hCG-first antibodies hold four diamonds, each also bound by a gold conjugate, while other green antibodies stay empty; at the control line, purple IgG holds four gold conjugates; a starburst reading 'color' appears above both the test line and the control line. In the negative-test row, drawn without the numbered callouts, the urine sample carries no diamonds, the test line holds only empty green antibodies, the control line's IgG again holds four gold conjugates, and a starburst reading 'color' appears above the control line only. A legend beneath both rows keys four symbols: a green Y-shape for the hCG-first antibody, a small red diamond for human chorionic gonadotropin, a yellow circle bearing an orange Y for the hCG-second antibody-gold-nanoparticle conjugate ('Au'), and a purple Y-shape for IgG." >}}
...
{{< textin question="What physical process does the lateral flow method require to function?" answer="capillary action" accept="capillarity|capillary flow|capillary|capillary force" hint="Look at the sentence describing how the fluid moves through the absorbent pad and stripes of the test strip." >}}

{{< multiplechoice
  question="Explain the purpose of the third strip in a lateral flow assay."
  answer="It binds beads regardless of the test result, showing that the test worked properly."
  hint="Read the lateral flow paragraph in Immunofiltration and Immunochromatographic Assays and the lateral flow figure's caption."
>}}
It binds beads regardless of the test result, showing that the test worked properly.
It binds antigen in the test fluid to the antibody-coated beads.
It retains the beads that have bound antigen, producing the test line's color.
It hydrates the dried reagents so the sample can flow through the strip.
{{< /multiplechoice >}}

The table below compares some of the key mechanisms and examples of some of the EIAs discussed in this section as well as immunoblots, discussed in [Detecting Antigen-Antibody Complexes](/life-health-sciences/microbiology/20-laboratory-analysis-of-the-immune-response/02-detecting-antigen-antibody-complexes/).
...
*The case began in [Polyclonal and Monoclonal Antibody Production](/life-health-sciences/microbiology/20-laboratory-analysis-of-the-immune-response/01-polyclonal-and-monoclonal-antibody-production/). The case continues in Part 3, below.*
{{< /callout >}}
...
*The case began in [Polyclonal and Monoclonal Antibody Production](/life-health-sciences/microbiology/20-laboratory-analysis-of-the-immune-response/01-polyclonal-and-monoclonal-antibody-production/). The case continues in [Fluorescent Antibody Techniques](/life-health-sciences/microbiology/20-laboratory-analysis-of-the-immune-response/05-fluorescent-antibody-techniques/).*
{{< /callout >}}
...
{{< multiplechoice
  question="In an enzyme immunoassay, the enzyme"
  answer="is bound to the constant region of the secondary antibody."
  hint="Read the opening paragraph of this section, on what all EIAs have in common."
>}}
...
{{< multiplechoice
  question="In a lateral-flow pregnancy test, you see a blue band form on the control line and no band form on the test line. This is probably a ________ test for pregnancy."
  answer="negative"
  hint="Read the last two sentences of the lateral flow paragraph in Immunofiltration and Immunochromatographic Assays."
>}}
positive
false-positive
false-negative
...
{{< multiplechoice
  question="When performing an FEIA, the fluorogen replaces the ________ that is used in an EIA."
  answer="chromogenic substrate"
  hint="Read the second paragraph of this section."
>}}
antigen
...
{{< textin question="To detect antibodies against bacteria in the bloodstream using an EIA, we would run a(n) ________, which we would start by attaching antigen from the bacteria to the wells of a microtiter plate." answer="indirect ELISA" accept="indirect ELISA assay|indirect enzyme-linked immunosorbent assay" hint="Read the third paragraph of Enzyme-linked Immunosorbent Assays (ELISAs)." >}}

### Describe the difference and similarities between immunohistochemistry and immunocytochemistry

{{< multiplechoice
  question="When using an EIA to study microtubules or other structures inside a cell, we first chemically fix the cell and then treat the cells with alcohol. What is the purpose of this alcohol treatment?"
  answer="It makes holes in the cell membrane large enough for antibodies to pass."
  hint="Read the second paragraph of Immunostaining."
>}}
...
{{< textin question="The staining technique in which labeled antibodies are bound to specific cells in a tissue section is called ________." answer="immunohistochemistry" accept="IHC" hint="Read the first paragraph of Immunostaining." >}}

{{< textin question="Immunostaining is an EIA technique for visualizing cells in a tissue or examining ________ (immunocytochemistry)." answer="intracellular structures" accept="structures inside the cell|structures inside cells|intracellular targets|structures within the cell|structures within cells" hint="Read the Summary bullet on immunostaining." >}}

### Describe the different purposes of direct and indirect ELISA

{{< selfcheck question="Why is it important in a sandwich ELISA that the antigen has multiple epitopes? And why might it be advantageous to use polyclonal antisera rather than mAb in this assay?" hint="Read the sandwich ELISA paragraph of Enzyme-linked Immunosorbent Assays (ELISAs) and the caption of the sandwich ELISA figure." >}}
In a sandwich ELISA, the primary antibody first captures the antigen from solution; then, following a wash, the secondary antibody — described in this section as a polyclonal antibody conjugated to an enzyme — is added and must also bind the same captured antigen molecule so that its enzyme can generate the measurable colored end product. This requires the antigen to present at least two separate epitopes: one already occupied by the primary antibody, and a second, still-free epitope for the secondary antibody to attach to. This section identifies the secondary antibody as polyclonal but does not itself explain further why a polyclonal secondary antibody would be advantageous here.
===CHECKS===
the primary antibody first captures the antigen from solution
the secondary antibody is a polyclonal antibody conjugated to an enzyme
the secondary antibody must also bind the same captured antigen molecule
this requires the antigen to present at least two separate epitopes
{{< /selfcheck >}}

{{< multiplechoice
  question="The pregnancy test strip detects the presence of human chorionic gonadotrophin in urine. This hormone is initially produced by the fetus and later by the placenta. Why is the test strip preferred for this test rather than using either a direct or indirect ELISA with their more quantifiable results?"
  answer="Because it is fast, inexpensive, and not dependent on special equipment."
  hint="Read the paragraph after the lateral flow description, which compares these tests with ELISA."
>}}
Because it requires special laboratory equipment to interpret.
Because it is fast, inexpensive, and not dependent on special equipment.
Because it is more sensitive and quantifiable than an ELISA.
Because it takes longer to produce a result than an ELISA.
{{< /multiplechoice >}}

{{< mediafigure src="microbiology/OSC_Microbio_20_04_ArtConnect_img" kind="diagram" alt="An unlabeled drawing: five orange Y-shaped molecules stand stem-down on a surface, with a row of small gray beads covering the surface between their stems. Four small red circles sit at the tips of orange arms; the fourth orange Y from the left holds none. Three green Y-shaped molecules hang arms-down from above, each with a large purple oval at the top of its stem and each touching one red circle with an arm; the red circle on the second orange Y has no green Y." >}}
An unlabeled sandwich-ELISA drawing: two kinds of Y-shaped molecule, small bound particles, and a large oval on each upper Y-shape above a coated surface.
{{< /mediafigure >}}

{{< selfcheck question="Label the primary and secondary antibodies, and discuss why the production of end product will be proportional to the amount of antigen." hint="Read the sandwich ELISA paragraph of Enzyme-linked Immunosorbent Assays (ELISAs)." >}}
The Y-shape fixed to the floor of the well is the primary antibody, added first so it can capture antigen from the sample. The green Y-shape above it, carrying a large oval, is the secondary antibody, which is conjugated to an enzyme and is added afterward to bind the same captured antigen. The amount of color produced (measured as absorbance) is directly proportional to the amount of enzyme present, which in turn is directly proportional to the amount of captured antigen — so more antigen captured means more secondary antibody bound, which means more enzyme, and more colored end product.
===CHECKS===
the Y-shape fixed to the floor of the well is the primary antibody
the green Y-shape above it, carrying a large oval, is the secondary antibody, conjugated to an enzyme
the amount of color produced is directly proportional to the amount of enzyme, which in turn is directly proportional to the amount of captured antigen
{{< /selfcheck >}}

---

<small>This section is adapted from [Microbiology, Section 20.4: EIAs and ELISAs](https://openstax.org/books/microbiology/pages/20-4-eias-and-elisas) by Nina Parker, Mark Schneegurt, Anh-Hue Thi Tu, Philip Lister, Brian M. Forster, and OpenStax, © OpenStax, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). Access the original for free at [openstax.org](https://openstax.org/details/books/microbiology). Changes: all seven images re-encoded as WebP and rendered as mediafigures after image and PDF inspection, with `kind="diagram"` set on the EIA, ELISA, Indirect, Lateral, and Art Connection figures and `kind="photo"` on the IHC micrograph and the Torch pregnancy-test photo, overriding the media manifest's JPEG-based photo guess for the five drawn figures; the EIA figure carries `eager="true"` as the page's first figure; a `longdesc` added for the EIA, ELISA, Indirect, and Lateral figures, walking each numbered step in reading order; the Indirect ELISA figure's own printed label misspells "substrate" as "subtrate" at its seventh step, transcribed as printed with the correct spelling named beside it in the longdesc; the Lateral flow figure's own legend misspells "gonadotropin" as "gonadortropin," transcribed as printed with the correct spelling named beside it in the longdesc; feature boxes rendered as callouts; the Clinical Focus Part 2 and Part 3 boxes' "Jump to the previous/next Clinical Focus box" links are replaced with plain sentences naming that the case began in Section 20.1 (this run's own naming rule, since the case runs past two sections) and where it continues, linking to Section 20.1 and, from Part 3, to Section 20.5 (both already on disk); the footnote in Part 3 is rendered as an inline parenthetical citation; the cross-reference to Section 20.1's lab-on-a-chip figure is rendered as a link to the chapter introduction (on disk at authoring time); the cross-reference to Section 20.2 (m58901) is a link to that page; the "Immunoblots & Enzyme Immunoassays" table is a section-level recap spanning every EIA type this chapter covers rather than one objective's own contrast, so it is transcribed as a Markdown table only, with no `sortbins` built for it, per this book's chapter- or section-level recap table rule; the four source Multiple Choice items and the one Fill in the Blank item are adapted into Practice unchanged with their source keys, each under the objective it tests, which places the alcohol-treatment Multiple Choice (second in the source) after the lateral-flow and FEIA items; in the second Check Your Understanding box, the "What do the direct and indirect ELISAs quantify?" bullet is moved above the secondary-antibody bullet, so that the secondary-antibody self-check's rubric, which ends on the captured antigen, does not sit directly above it; three of the section's six body Check Your Understanding bullets are graded from this module's own sentences rather than left in prose — "What do the direct and indirect ELISAs quantify?" is now a `multiplechoice` keyed by the indirect-ELISA paragraph's own contrast sentence; "What physical process does the lateral flow method require to function?" is now a `textin` keyed by the paragraph's own "capillary action" phrase; "Explain the purpose of the third strip in a lateral flow assay" is now a `multiplechoice` keyed by the Lateral figure's own caption sentence, with distractors drawn from the module's other lateral-flow steps — the source prints no key for any of the three; the other three body Check Your Understanding bullets remain self-checks with model answers assembled from this section's own text, because each needs more than one sentence to answer honestly; the unkeyed Short Answer question about sandwich-ELISA epitopes remains a self-check whose model answer states what this section gives (the mechanics of the two-antibody sandwich) and stops, since the section identifies the secondary antibody as polyclonal but does not itself explain why that is advantageous; the unkeyed Short Answer question comparing the pregnancy strip to a direct or indirect ELISA is now a `multiplechoice` whose key is the paragraph's own three reasons verbatim ("fast, inexpensive, and not dependent on special equipment"), with distractors negating each reason in turn; the unkeyed Critical Thinking Art Connection question is rendered as a `mediafigure` (its bare inline image has no source caption, so the caption above is author-written, describing only the unlabeled Y-shapes' positions) immediately followed by a self-check whose model answer is assembled from the sandwich-ELISA paragraph's own sentences; its alt is written from the artwork (five fixed Y-shapes, four bound particles, three upper Y-shapes), not from the source alt; two filler `textin` items — a cloze from this section's summary sentence about immunostaining (its "(immunohistochemistry)" gloss omitted, since it would print the neighbouring item's key), and a term-recall item for "Immunohistochemistry (IHC)" — fill the second objective group to the section floor; key terms compiled from the module's fifteen defined terms and the book's Glossary appendix, all fifteen taken directly from the appendix, except "immunostaining," whose nearest appendix headwords ("immunostain," "staining") do not match the module's own sense and whose meaning is instead drawn from this module's defining sentence. A Check Your Understanding bullet in this section asks about "the secondary antibody in a direct ELISA," though this section's own text describes a secondary antibody only in the sandwich ELISA procedure; the bullet is transcribed and answered verbatim, drawing on the sandwich ELISA paragraph, as the module's own wording, and flagged for the claim pass.</small>

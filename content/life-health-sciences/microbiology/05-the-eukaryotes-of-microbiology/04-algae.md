...
title: Algae
description: >-
  The unique characteristics of algae, the major algal groups and their
  toxin-producing members, and why algae are studied within microbiology —
  adapted from OpenStax Microbiology, Section 5.4.
source_section: "5.4"
weight: 4
---
...
{{< mediafigure src="microbiology/OSC_Microbio_05_04_dino" alt="A scanning electron micrograph of a boxy, ridged dinoflagellate cell with two long projections extending from one side — a thicker, tightly coiled beaded strand and a thinner smooth strand — beside a 10 µm scale bar." kind="photo" eager="true" >}}
The dinoflagellates exhibit great diversity in shape. Many are encased in cellulose armor and have two flagella that fit in grooves between the plates. Movement of these two perpendicular flagella causes a spinning motion. (credit: modification of work by CSIRO)
{{< /mediafigure >}}
...
{{< textin
  question="Structures in chloroplasts used to synthesize and store starch are called ________."
  answer="pyrenoids"
  hint="This is the same structure named early in the paragraph on algal cell complexity."
>}}
...
{{< textin
  question="Some brown algae can be extremely large, such as the giant kelp, ________."
  answer="Laminaria"
  hint="This is the genus name printed in italics beside 'giant kelp' in the brown algae paragraph."
>}}
...
red algae are mainly multicellular
green algae range from unicellular to various levels of coloniality to multicellular forms
{{< /selfcheck >}}

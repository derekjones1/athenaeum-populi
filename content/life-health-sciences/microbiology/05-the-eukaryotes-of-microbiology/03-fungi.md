...
{{< textin question="Some fungi have proven medically useful because they can be used to produce ________." answer="antibiotics" accept="antibiotic" hint="The opening paragraphs name penicillin as an example." >}}

### Describe the unique characteristics of fungi

{{< textin question="Nonseptate hyphae are also called ________." answer="coenocytic" hint="Use the term paired with 'nonseptate' in the Characteristics of Fungi discussion." >}}

{{< textin question="Unicellular fungi are called ________." answer="yeasts" accept="yeast" hint="Contrast this term with the multicellular fungi called molds." >}}

{{< textin question="Fungal cell walls are composed of the polysaccharide ________, unlike the cellulose found in the cell walls of plants and many protists." answer="chitin" hint="This substance also gives the fungal cell wall its resistance and is a target for some antifungal drugs." >}}
...
{{< textin question="Ascomycota may produce sexually produced ascospores as well as asexual spores called ________." answer="conidia" accept="conidium" hint="These asexual spores are produced at the end of specialized hyphae called conidiophores." >}}
...
{{< multiplechoice question="Which ascomycete genus is noted in this section for its use in genetics research, because the spores produced by meiosis are kept inside the ascus in a row that reflects the cell divisions that produced them?" answer="*Neurospora crassa*" hint="Look for the genus whose ascus arrangement gives a direct view of gene segregation and assortment." >}}
*Neurospora crassa*
*Aspergillus flavus*
*Penicillium*
*Candida albicans*
...
{{< multiplechoice question="Which fungal group described in this section is made up of obligate symbionts that promote plant growth by acting like an extended root system?" answer="Glomeromycota" hint="Look for the group described as including the mycorrhizal fungi." >}}
Urediniomycetes
Ustilagomycetes
Chytridiomycetes
Glomeromycota
...
{{< multiplechoice question="Which of the following is the most common cause of human yeast infections?" answer="*Candida albicans*" hint="Look for the yeast described as part of the normal microbiota of the skin, intestine, genital tract, and ear." >}}
*Candida albicans*
...
{{< multiplechoice question="Which of the following is an ascomycete fungus associated with bat droppings that can cause a respiratory infection if inhaled?" answer="*Histoplasma capsulatum*" hint="Use the dimorphic fungus discussed with the bat-guano life-cycle figure." >}}
*Candida albicans*
...
{{< textin question="*Aspergillus flavus* produces a ________ that is both a toxin and the most potent known natural carcinogen." answer="aflatoxin" hint="This word names the toxin itself and shares its first syllable with the genus that produces it." >}}

{{< multiplechoice question="Which basidiomycete mushroom produces toxins that have been used to study transcription?" answer="*Amanita phalloides*" hint="Look for the poisonous mushroom known as the death cap." >}}
*Agaricus campestris*
*Cryptococcus neoformans*
*Amanita phalloides*
...
{{< multiplechoice question="Which classification includes the unicellular yeast *Saccharomyces cerevisiae*, used with other *Saccharomyces* species for brewing beer?" answer="Ascomycota" hint="This yeast has haploid and diploid stages and produces ascospores like other members of its group." >}}
Basidiomycota
Zygomycota
Microsporidia
Ascomycota
...
{{< multiplechoice question="Mushrooms are a type of which of the following?" answer="basidiocarp" hint="Use the term for the fruiting body that contains basidia in its gills." >}}
conidia
ascus
polar tubule
basidiocarp
...
{{< mediafigure src="microbiology/OSC_Microbio_05_03_Hyphae_img" alt="Two drawings of tan, tubular fungal filaments on a lavender background, side by side. The left drawing shows branching filaments divided into segments by cross-walls, each segment containing a dot. The right drawing shows similar branching filaments with dots but no cross-walls dividing them into segments." kind="diagram" >}}
Two drawings of fungal filaments for comparison.
{{< /mediafigure >}}

{{< multiplechoice question="Which of the drawings shows septate hyphae?" answer="drawing (a)" hint="Septate hyphae have walls between their cells; compare the two drawings for internal cross-walls." >}}
drawing (a)
drawing (b)
{{< /multiplechoice >}}

...
title: Fungi
description: >-
  The unique structures, life cycles, and major taxonomic groups of fungi —
  Zygomycota, Ascomycota, Basidiomycota, and Microsporidia — including
  examples of infection- and toxin-causing species — adapted from OpenStax
  Microbiology, Section 5.3.
source_section: "5.3"
weight: 3
---
...
{{< mediafigure src="microbiology/OSC_Microbio_05_03_struct" alt="A two-part illustration of Histoplasma capsulatum's environmental and host-associated forms. At left, a drawing shows two bats in an attic above a guano nest, with an inset numbered 1 showing fungal filaments dotted with round spore clusters; below it, a blue-stained micrograph labeled hyphae and conidia shows the same filaments and spore clusters. At right, a drawing of a person's head and upper torso traces numbered stages 2 through 6 as inhaled spores travel from the air into the nose, lungs, lymph, and blood." kind="diagram" longdesc="The figure walks through Histoplasma capsulatum's dimorphic life cycle in six numbered stages. (1) In the environmental form, fungal filaments bearing round spore clusters called conidia grow in soil enriched with bird or bat guano, shown in an attic setting and confirmed by the micrograph below it. (2) Spores become airborne. (3) A person inhales the airborne spores through the nose. (4) The spores reach the lungs, shown as three small round structures: two are budding, drawn as two fused circles, and one is a single circle. (5) The organism travels to the lymphatic system, shown as single round cells, not budding, clustered in threes and twos at three swollen points along a branching green lymph vessel. (6) The organism reaches the bloodstream, shown as several single round cells, not budding, inside each of three larger cells with a folded purple nucleus, alongside smaller plain pink blood cells that hold none. Brown arrows lead from the lung inset to the lymph inset and from the lymph inset to the blood inset, and three more brown arrows fan out from the lower chest across the body." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_05_03_zygo" alt="A circular diagram of the zygomycete life cycle. At the top, an asexual loop joins mycelia and a spore cluster: as printed, the arrow from the mycelia down to the spores is labeled Germination and the arrow from the spores back up to the mycelia is labeled Mitosis, a label placement disclosed below. Below, the sexual cycle runs from the spores through plus and minus mating-type mycelia (1n), gametangia, a zygosporangium, and a zygote (2n) to a sporangium (1n) on a short stalk, whose arrow, also labeled Germination, returns to the spores." kind="diagram" longdesc="An arrow leads from the spore cluster down the left side to two mycelia (1n), labeled + Mating type and – Mating type, and four numbered stages of sexual reproduction follow, each printed in its own box beside the diagram. (1) Germination: mycelia form; if the plus and minus mating types are close together, extensions called gametangia form between them. (2) Plasmogamy: fusion between the plus and minus mating types produces a zygosporangium with multiple haploid nuclei, which forms a thick, protective coat. (3) Karyogamy: the nuclei fuse to form a zygote (2n) with multiple diploid nuclei. (4) Meiosis and germination: a sporangium (1n) grows on a short stalk, and haploid spores form inside it. An arrow labeled Germination carries the released spores from the sporangium back up to the spore cluster. Above the spore cluster, two arrows labeled Asexual reproduction link it with the mycelia at the top of the diagram: as printed, the arrow from the mycelia down to the spores is labeled Germination, and the arrow from the spores back up to the mycelia is labeled Mitosis. This module's own text and source alt instead describe mycelia forming spores by mitosis and spores germinating into new mycelia." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_05_03_spores" alt="Two panels of spore-producing fungal structures. (a) A brightfield micrograph labeled hyphae and sporangium, showing a bulbous sporangium at the end of a branching filament, with a 25 µm scale bar. (b) A photograph of fuzzy gray-white mold growing on a piece of bread, with an arrow pointing from a circled patch to an enlarged inset labeled sporangium showing many small dark dots on the fuzzy surface." kind="photo" >}}
...
{{< selfcheck question="Is a dimorphic fungus a yeast or a mold? Explain." hint="Use the sentence describing how dimorphic fungi change appearance with temperature, not just the definition of the term." >}}
...
===CHECKS===
can appear as either a yeast or a mold
depending on environmental changes such as nutrient availability or temperature
grows as a mold at 25 °C (77 °F)
as yeast cells at 37 °C (98.6 °F)
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_05_03_ascomyLC" alt="A circular diagram of the ascomycete life cycle, with a spore cluster at the top and mycelia below it. In the asexual loop, a branching conidiophore rises from the mycelia and an arrow labeled Germination leads from it up to the spores, while an arrow labeled Mitosis returns from the spores down to the mycelia, a label placement disclosed below. In the sexual cycle, five numbered stages lead from an ascogonium and antheridium on the mycelia through an ascocarp, a zygote (2n), and an ascus to eight ascospores (1n) that return to the mycelia." kind="diagram" longdesc="Five numbered stages of sexual reproduction, each printed in its own box beside the diagram. An ascogonium and an antheridium, two round cells on neighboring hyphae below the mycelia, are joined, and an arrow leads down the left side. (1) Plasmogamy and mitosis: the ascogonium and antheridium fuse; mitosis and cell division form many dikaryotic hyphae, which form a fruiting body called the ascocarp, with asci forming at the tips of these hyphae. (2) Karyogamy: the nuclei in the asci fuse to form a diploid zygote (2n). (3) Meiosis: an ascus with four haploid nuclei is formed. (4) Mitosis and cell division: eight haploid ascospores (1n) are formed in the ascus. (5) Dispersal and germination: an arrow carries the ascospores back to the mycelia. In the asexual loop at the top of the diagram, labeled Asexual reproduction, a branching conidiophore (chains of small red-dotted cells) rises from the right end of the mycelia; as printed, the arrow from the conidiophore up to the spore cluster is labeled Germination, and the arrow from the spore cluster back down to the mycelia is labeled Mitosis. This module's own text and source alt instead describe conidiophores producing spores by mitosis and the spores germinating into new mycelia." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_05_03_basidioLC" alt="A circular diagram of the basidiomycete life cycle showing seven numbered stages of sexual reproduction, from germinating plus and minus mating-type mycelia through plasmogamy, a mitosis step that forms a basidiocarp (shown in a photograph of two mushrooms with basidia labeling their gills), karyogamy, meiosis, cell division, and dispersal and germination back to basidiospores." kind="diagram" longdesc="Seven numbered stages. (1) Germination: mycelia form; there are two mating types, plus and minus. (2) Plasmogamy: fusion between the plus and minus mating types forms a dikaryotic mycelium. (3) Mitosis: under the right environmental conditions, a basidiocarp forms; gills of the basidiocarp contain cells called basidia, shown in a photograph of two mushrooms. (4) Karyogamy: basidia form diploid nuclei, drawn as a one-nucleus cell labeled zygote (2n). (5) Meiosis: four haploid nuclei are formed in the basidium, drawn as an oval labeled basidium with four nuclei (1n). (6) Cell division: four basidiospores are formed, drawn as four separate one-nucleus cells. (7) Dispersal and germination: the basidiospores disperse and germinate into new mycelia." >}}
...
| Group | Characteristics | Examples | Medically Important Species |
| --- | --- | --- | --- |
| Ascomycota | Septate hyphae; ascus with ascospores in ascocarp; conidiospores | Cup fungi; edible mushrooms; morels; truffles; *Neurospora*; *Penicillium* | *Aspergillus* spp.; *Trichophyton* spp.; *Microsporum* spp.; *Epidermophyton* spp.; *Blastomyces dermatitidis*; *Histoplasma capsulatum* |
| Basidiomycota | Basidia produce basidiospores in a basidiocarp | Club fungi; rusts; stinkhorns; puffballs; mushrooms; *Cryptococcus neoformans*; *Amanita phalloides* | *Cryptococcus neoformans* |
| Microsporidia | Lack mitochondria, peroxisomes, centrioles; spores produce a polar tube | *Enterocytozoon bieneusi* | *Enterocytozoon bieneusi* |
| Zygomycota | Mainly saprophytes; coenocytic hyphae; haploid nuclei; zygospores | *Rhizopus stolonifer* | *Mucor* spp. |

{{< mediafigure src="microbiology/OSC_Microbio_05_03_TaxaTable" alt="Four images from the Image column of the table above: a purple-stained micrograph of branching filaments radiating from a dark central spore head, labeled Aspergillus niger; a photograph of two pale olive-green mushrooms growing among leaf litter, labeled Amanita phalloides; a pink- and blue-stained micrograph of scattered oval and rod-shaped cells, labeled Microsporidia (unidentified); and a micrograph of dark, textured fungal growth on a pale background, labeled Rhizopus sp." kind="photo" >}}
...
{{< multiplechoice question="Which group of fungi appears to be associated with the greatest number of human diseases?" answer="Ascomycota" hint="Compare how many medically important species are listed for each group in the table above." >}}
Basidiomycota
Ascomycota
Zygomycota
Microsporidia
...
The case continues in [Lichens](/life-health-sciences/microbiology/05-the-eukaryotes-of-microbiology/05-lichens/). The case began in [Unicellular Eukaryotic Parasites](/life-health-sciences/microbiology/05-the-eukaryotes-of-microbiology/01-unicellular-eukaryotic-parasites/).
{{< /callout >}}
...
{{< textin question="Although mushrooms and molds are macroscopic, many single-celled fungi and the spores of macroscopic fungi are ________, which is why fungi are studied within microbiology." answer="microscopic" hint="Use the opening paragraph's explanation for why fungi, despite some being macroscopic, belong to microbiology." >}}

{{< textin question="The general term for diseases caused by fungi is ________." answer="mycoses" accept="mycosis" hint="Look for the term defined in parentheses as 'illnesses caused by fungi.'" >}}

{{< textin question="Some fungi have proven medically useful because they can be used to produce ________." answer="antibiotics" accept="antibiotic" hint="Reread the last sentence of this section's second paragraph." >}}

### Describe the unique characteristics of fungi

{{< textin question="Nonseptate hyphae are also called ________." answer="coenocytic" accept="coenocytic hyphae" hint="Reread the first paragraph of Characteristics of Fungi." >}}

{{< textin question="Unicellular fungi are called ________." answer="yeasts" hint="Reread the paragraph just after the hyphae figure." >}}

{{< textin question="Hyphae can form a tangled network called a ________ and form the thallus (body) of fleshy fungi." answer="mycelium" accept="mycelia" hint="Reread the first paragraph of Characteristics of Fungi." >}}

{{< selfcheck question="Explain the benefit of research into the pathways involved in the synthesis of chitin in fungi." hint="This section does not evaluate research benefits directly; use what it says about chitin and antifungal drug targets." >}}
...
unlike the cellulose found in the cell walls of plants and many protists
some antifungal medications already target the chitin cell walls of fungi
{{< /selfcheck >}}

### Describe examples of asexual and sexual reproduction of fungi

{{< multiplechoice question="What is a dikaryotic cell?" answer="A cell with two distinct nuclei." hint="Look for the term introduced in the discussion of plasmogamy, the fusion of the + and – type gametes' cytoplasm." >}}
A cell that lacks a nucleus.
A cell with a single diploid nucleus.
A cell with two distinct nuclei.
A cell containing four haploid nuclei.
{{< /multiplechoice >}}

{{< textin question="Ascomycota may produce sexually produced ascospores as well as asexual spores called ________." answer="conidia" accept="conidium|conidiospores" hint="Reread the Ascomycota paragraph in Fungal Diversity." >}}

{{< sortbins question="Sort each reproductive spore type or characteristic under the fungal group it describes." hint="Match each reproductive structure or characteristic to the group described earlier in this section." >}}
{"bins":["Zygomycota","Ascomycota","Basidiomycota"],"items":[{"label":"Produces zygospores for sexual reproduction","bin":0},{"label":"Produces ascospores within an ascus","bin":1},{"label":"Produces basidiospores through budding","bin":2},{"label":"Uses sporangiospores for asexual reproduction","bin":0},{"label":"May have septate hyphae and cup-shaped ascocarps","bin":1},{"label":"Has basidia within fruiting bodies called basidiocarps","bin":2}]}
{{< /sortbins >}}

### Compare the major groups of fungi in this chapter, and give examples of each

{{< sortbins question="Sort each characteristic, example, or medically important species under the group described in the table above." hint="Match each characteristic, example, or medically important species to its group in the table above." >}}
{"bins":["Ascomycota","Basidiomycota","Microsporidia","Zygomycota"],"items":[{"label":"Includes cup fungi, edible mushrooms, morels, and truffles","bin":0},{"label":"Includes club fungi, rusts, stinkhorns, puffballs, and mushrooms","bin":1},{"label":"Lack mitochondria, peroxisomes, and centrioles","bin":2},{"label":"Includes the bread mold *Rhizopus stolonifer*","bin":3},{"label":"Medically important species include *Aspergillus*, *Trichophyton*, and *Histoplasma capsulatum*","bin":0},{"label":"The medically important species is *Cryptococcus neoformans*","bin":1},{"label":"Its example and medically important species is *Enterocytozoon bieneusi*","bin":2},{"label":"The medically important species is *Mucor* spp.","bin":3}]}
{{< /sortbins >}}

{{< multiplechoice question="Which ascomycete genus is noted in this section for its use in genetics research, because the spores produced by meiosis are kept inside the ascus in a row that reflects the cell divisions that produced them?" answer="*Neurospora crassa*" hint="Reread the second Ascomycota paragraph in Fungal Diversity." >}}
*Neurospora crassa*
*Aspergillus flavus*
*Penicillium*
*Candida albicans*
...
{{< multiplechoice question="Which fungal group described in this section is made up of obligate symbionts that promote plant growth by acting like an extended root system?" answer="Glomeromycota" hint="Reread the first paragraph of Fungal Diversity." >}}
Urediniomycetes
Ustilagomycetes
Chytridiomycetes
Glomeromycota
...
{{< multiplechoice question="Which of the following is the most common cause of human yeast infections?" answer="*Candida albicans*" hint="Reread the third Ascomycota paragraph in Fungal Diversity." >}}
*Candida albicans*
...
{{< multiplechoice question="Which of the following is an ascomycete fungus associated with bat droppings that can cause a respiratory infection if inhaled?" answer="*Histoplasma capsulatum*" hint="Reread the third Ascomycota paragraph in Fungal Diversity." >}}
*Candida albicans*
...
{{< multiplechoice question="Which genera of fungi are common dermatophytes (fungi that cause skin infections)?" answer="*Trichophyton*, *Microsporum*, and *Epidermophyton*" hint="Find the sentence naming three genera as common causes of athlete's foot, jock itch, and ringworm." >}}
*Aspergillus*, *Penicillium*, and *Neurospora*
*Trichophyton*, *Microsporum*, and *Epidermophyton*
*Cryptococcus*, *Candida*, and *Histoplasma*
*Rhizopus*, *Mucor*, and *Saccharomyces*
{{< /multiplechoice >}}

### Identify examples of toxin-producing fungi

{{< textin question="*Aspergillus flavus* produces a ________ that is both a toxin and the most potent known natural carcinogen." answer="aflatoxin" hint="Reread the second Ascomycota paragraph in Fungal Diversity." >}}

{{< multiplechoice question="Which basidiomycete mushroom produces toxins that have been used to study transcription?" answer="*Amanita phalloides*" hint="Reread the Basidiomycota paragraph in Fungal Diversity." >}}
*Agaricus campestris*
*Cryptococcus neoformans*
*Amanita phalloides*
...
{{< multiplechoice question="According to the summary, which of the following fungal groups is not identified as a producer of deadly toxins?" answer="Microsporidia" hint="Compare the summary's list of toxin-producing groups with the four groups discussed in this section." >}}
Microsporidia
Zygomycota
Ascomycota
Basidiomycota
...
{{< multiplechoice question="Which classification includes *Saccharomyces cerevisiae*, used with other *Saccharomyces* species for brewing beer?" answer="Ascomycota" hint="Reread the short paragraph on Saccharomyces yeasts in Fungal Diversity." >}}
Basidiomycota
Zygomycota
Microsporidia
Ascomycota
...
{{< multiplechoice question="Mushrooms are a type of which of the following?" answer="basidiocarp" hint="Reread the first sentences of the Basidiomycota paragraph in Fungal Diversity." >}}
conidia
ascus
polar tubule
basidiocarp
...
{{< mediafigure src="microbiology/OSC_Microbio_05_03_Hyphae_img" alt="Two drawings of tan, tubular fungal filaments on a lavender background, side by side. The left drawing, labeled A, shows branching filaments divided into segments by cross-walls, each segment containing a dot. The right drawing, labeled B, shows similar branching filaments with dots but no cross-walls dividing them into segments." kind="diagram" >}}
Two drawings of fungal filaments for comparison.
{{< /mediafigure >}}

{{< multiplechoice question="Which of the drawings shows septate hyphae?" answer="drawing (a)" hint="Compare the two drawings with the hyphae figure in Characteristics of Fungi." >}}
drawing (a)
drawing (b)
{{< /multiplechoice >}}

...
description: >-
  The general characteristics, feeding and reproductive strategies, and
  taxonomic scheme of unicellular eukaryotic parasites, with examples of the
  human infections they cause — adapted from OpenStax Microbiology, Section 5.1.
source_section: "5.1"
weight: 1
---
...
{{< mediafigure src="microbiology/OSC_Microbio_05_01_ringworm" alt="Two photographs of a ring-shaped rash on skin. In (a) the ring is grayish and scaly with a raised, uneven border on light brown skin. In (b) the ring is smaller and reddened, with a raised scaly border on lighter skin." kind="photo" eager="true" >}}
...
The case continues in [Parasitic Helminths](/life-health-sciences/microbiology/05-the-eukaryotes-of-microbiology/02-parasitic-helminths/).
{{< /callout >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_05_01_giardia" alt="Two scanning electron micrographs. In (a), many pear-shaped Giardia cells with trailing flagella are packed closely together. In (b), a single pear-shaped Giardia cell is shown with several long flagella trailing from its narrow end, and a scale bar marked 2 µm." kind="photo" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_05_01_Trophozoit" alt="A circular diagram of the Eimeria life cycle titled Eimeria Life Cycle, with an inset micrograph of several stained oocysts and a 30 µm scale bar." longdesc="The cycle begins with an oocyst shed in feces, which is non-infectious and unsporulated. Sporulation occurs outside the host, requiring several days and oxygen, and produces an infectious sporulated oocyst. The oocyst enters the gut when swallowed and releases sporocysts, which release sporozoites. The sporozoites invade gut cells and form trophozoites. Trophozoites undergo asexual schizogony to form a schizont, which releases merozoites. From there, merozoites either reinfect gut cells and repeat the trophozoite stage (the reinfective cycle) or undergo sexual gametogony to form male and female gametes. The gametes undergo syngamy to form a developing oocyst, which matures into a new unsporulated, non-infectious oocyst that is shed in feces, restarting the cycle; a gray arrow leads from the shed oocyst to the inset micrograph. Inside the ring of drawings, three colored arcs form an inner circle of arrows: a blue arc across the top labeled Environment sporogony, running from the upper left to the right; a green arc labeled Asexual schizogony, running down the right side to the bottom; and a red arc labeled Sexual gametogony, running up the left side back to the top. Between schizont and trophozoite, a single merozoite drawn on an arrow back to the trophozoite is labeled reinfective cycle." kind="diagram" >}}
...
Protozoans have a variety of unique organelles and sometimes lack organelles found in other cells. Some have **contractile vacuoles**, organelles that can be used to move water out of the cell for osmotic regulation (salt and water balance) (the diagram below). Mitochondria may be absent in parasites or altered to kinetoplastids (modified mitochondria) or hydrogenosomes (see [Unique Characteristics of Eukaryotic Cells](/life-health-sciences/microbiology/03-the-cell/04-unique-characteristics-of-eukaryotic-cells/) for more discussion of these structures).

{{< mediafigure src="microbiology/OSC_Microbio_05_01_locom" alt="Three labeled diagrams. (a) An oval Paramecium cell fringed with cilia, with a cytostome, a cytoproct, and a star-shaped contractile vacuole labeled inside. (b) An amoeba with irregular pseudopod extensions, its outer ectoplasm and inner endoplasm labeled, and a contractile vacuole inside. (c) An elongated Euglena cell with a single long flagellum, its outer ectoplasm and inner endoplasm labeled, and a contractile vacuole inside." kind="diagram" >}}
...
{{< multiplechoice question="What is the sequence of events in reproduction by schizogony, and what are the cells produced called?" answer="The nucleus divides multiple times before the cell divides into many smaller cells, producing merozoites." hint="Locate the sentence that defines schizogony, just after the discussion of the Eimeria life cycle." >}}
The nucleus divides multiple times before the cell divides into many smaller cells, producing merozoites.
Haploid gametes fuse to increase genetic diversity, producing offspring through syngamy.
Two cells attach to each other and exchange micronuclei before separating as genetically different individuals.
Diploid micronuclei undergo meiosis to produce eight haploid nuclei, and all but one degenerate.
{{< /multiplechoice >}}

## Taxonomy of Protists

The protists are a **polyphyletic** group, meaning they lack a shared evolutionary origin. Since the current taxonomy is based on evolutionary history (as determined by biochemistry, morphology, and genetics), protists are scattered across many different taxonomic groups within the domain Eukarya. Eukarya is currently divided into six supergroups that are further divided into subgroups, as illustrated in the tree diagram below. In this section, we will primarily be concerned with the supergroups Amoebozoa, Excavata, and Chromalveolata; these supergroups include many protozoans of clinical significance. The supergroups Opisthokonta and Rhizaria also include some protozoans, but few of clinical significance. In addition to protozoans, Opisthokonta also includes animals and fungi, some of which we will discuss in [Parasitic Helminths](/life-health-sciences/microbiology/05-the-eukaryotes-of-microbiology/02-parasitic-helminths/) and [Fungi](/life-health-sciences/microbiology/05-the-eukaryotes-of-microbiology/03-fungi/). Some examples of the Archaeplastida will be discussed in [Algae](/life-health-sciences/microbiology/05-the-eukaryotes-of-microbiology/04-algae/). The tree diagram and table below summarize the characteristics of each supergroup and subgroup and list representatives of each.

{{< mediafigure src="microbiology/OSC_Microbio_05_01_taxon" alt="A branching tree diagram titled Eukaryotic Supergroups: a common eukaryotic ancestor gives rise to five branches, the last of which splits again, for six labeled supergroups — Excavata, Chromalveolata, Rhizaria, Archaeplastida, Amoebozoa, and Opisthokonta — each further split into subgroups. Some branches are dashed to show evolutionary relationships that remain under debate." longdesc="A vertical stem from the common eukaryotic ancestor, at left, gives off five branches. Reading top to bottom: a dashed branch to Excavata, which splits into a pair, Diplomonads and Parabasalids, and a separate Euglenozoans. A dashed branch to Chromalveolata, which splits (along a dotted segment) into Alveolates — a pair, Dinoflagellates and Apicomplexans, plus Ciliates — and Stramenopiles — a three-way group of Diatoms, Golden algae, and Brown algae, plus Oomycetes. A dashed branch to Rhizaria, which splits into a pair, Cercozoans and Forams, and a separate Radiolarians. A solid branch to Archaeplastida, which gives off Red algae, then Chlorophytes (green algae), then a final pair, Charophytes (green algae) and Land plants. A last dashed branch splits (along a dotted segment) into Amoebozoa — Slime molds, Gymnamoebas, and Entamoebas from one point — and Opisthokonta — two pairs, Nucleariids with Fungi and Choanoflagellates with Animals. Each supergroup's members sit in a colored box with the supergroup's name printed vertically at its right edge." kind="diagram" >}}
...
| Supergroup | Subgroup | Distinguishing Features | Examples | Clinical Notes |
| --- | --- | --- | --- | --- |
| Excavata | Fornicata | Form cysts; pair of equal nuclei; no mitochondria; often parasitic; four free flagella | *Giardia lamblia* | Giardiasis |
| Excavata | Parabasalids | No mitochondria; four free flagella; one attached flagellum; no cysts; parasitic or symbiotic; basal bodies; kinetoplastids | *Trichomonas* | Trichomoniasis |
| Excavata | Euglenozoans | Photosynthetic or heterotrophic; flagella | *Euglena* | N/a |
| Excavata | Euglenozoans | Photosynthetic or heterotrophic; flagella | *Trypanosoma* | African sleeping sickness, Chagas disease |
| Excavata | Euglenozoans | Photosynthetic or heterotrophic; flagella | *Leishmania* | Leishmaniasis |
| Chromalveolata | Dinoflagellates | Cellulose theca; two dissimilar flagella | *Gonyaulax* | Red tides |
| Chromalveolata | Dinoflagellates | Cellulose theca; two dissimilar flagella | *Alexandrium* | Paralytic shellfish poisoning |
| Chromalveolata | Dinoflagellates | Cellulose theca; two dissimilar flagella | *Pfiesteria* | Harmful algal blooms |
| Chromalveolata | Apicomplexans | Intracellular parasite; apical organelles | *Plasmodium* | Malaria |
| Chromalveolata | Apicomplexans | Intracellular parasite; apical organelles | *Cryptosporidium* | Cryptosporidiosis |
| Chromalveolata | Apicomplexans | Intracellular parasite; apical organelles | *Theileria (Babesia)* | Babesiosis |
| Chromalveolata | Apicomplexans | Intracellular parasite; apical organelles | *Toxoplasma* | Toxoplasmosis |
| Chromalveolata | Ciliates | Cilia | *Balantidium* | Balantidiasis |
| Chromalveolata | Ciliates | Cilia | *Paramecium* | N/a |
| Chromalveolata | Ciliates | Cilia | *Stentor* | N/a |
| Chromalveolata | Öomycetes/peronosporomycetes | "Water molds"; generally diploid; cellulose cell walls | *Phytophthora* | Diseases in crops |
| Rhizaria | Foraminifera | Amoeboid; threadlike pseudopodia; calcium carbonate shells | *Astrolonche* | N/a |
| Rhizaria | Radiolaria | Amoeboid; threadlike pseudopodia; silica shells | *Actinomma* | N/a |
| Rhizaria | Cercozoa | Amoeboid; threadlike pseudopodia; complex shells; parasitic forms | *Spongospora subterranea* | Powdery scab (potato disease) |
| Rhizaria | Cercozoa | Amoeboid; threadlike pseudopodia; complex shells; parasitic forms | *Plasmodiophora brassicae* | Cabbage clubroot |
| Archaeplastida | Red algae | Chlorophyll a; phycoerythrin; phycocyanin; floridean starch; agar in cell walls | *Gelidium* | Source of agar |
| Archaeplastida | Red algae | Chlorophyll a; phycoerythrin; phycocyanin; floridean starch; agar in cell walls | *Gracilaria* | Source of agar |
| Archaeplastida | Chlorophytes | Chlorophyll a; chlorophyll b; cellulose cell walls; starch storage | *Acetabularia* | N/a |
| Archaeplastida | Chlorophytes | Chlorophyll a; chlorophyll b; cellulose cell walls; starch storage | *Ulva* | N/a |
| Amoebozoa | Slime molds | Plasmodial and cellular forms | *Dictyostelium* | N/a |
| Amoebozoa | Entamoebas | Trophozoites; form cysts | *Entamoeba* | Amoebiasis |
| Amoebozoa | Entamoebas | Trophozoites; form cysts | *Naegleria* | Primary amoebic meningoencephalitis |
| Amoebozoa | Entamoebas | Trophozoites; form cysts | *Acanthamoeba* | Keratitis, granulomatous amoebic encephalitis |
| Opisthokonta | Fungi | Chitin cell walls; unicellular or multicellular; often hyphae | Zygomycetes | Zygomycosis |
| Opisthokonta | Fungi | Chitin cell walls; unicellular or multicellular; often hyphae | Ascomycetes | Candidiasis |
| Opisthokonta | Fungi | Chitin cell walls; unicellular or multicellular; often hyphae | Basidiomycetes | Cryptococcosis |
| Opisthokonta | Fungi | Chitin cell walls; unicellular or multicellular; often hyphae | Microsporidia | Microsporidiosis |
| Opisthokonta | Animals | Multicellular heterotrophs; no cell walls | Nematoda | Trichinosis; hookworm and pinworm infections |
...
{{< sortbins question="Which supergroups contain the clinically significant protists? Sort each supergroup discussed in this section under whether it is described as including many clinically significant protists or only a few." hint="Reread the first paragraph of Taxonomy of Protists, before the tree diagram." >}}
{"bins":["Includes many clinically significant protists","Includes few or none"],"items":[{"label":"Amoebozoa","bin":0},{"label":"Opisthokonta","bin":1},{"label":"Excavata","bin":0},{"label":"Rhizaria","bin":1},{"label":"Chromalveolata","bin":0}]}
{{< /sortbins >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_05_01_slime" alt="Two photographs. (a) A light micrograph of the cellular slime mold Dictyostelium discoideum, showing individual amoeboid cells streaming together into an aggregation. (b) A brightly colored yellow, branching mass of the plasmodial slime mold Fuligo septica growing on bark." kind="photo" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_05_01_CellularLC" alt="A circular diagram titled Haploid and Asexual Reproduction, showing the Dictyostelium discoideum cellular slime mold life cycle numbered 1 through 10, with a photograph of a fruiting body." longdesc="Following the arrows from the upper right: a yellow mass labeled plasmodium has two small stalked knobs rising from it, one circled, and a gray arrow leads from the circle to a photograph of a tan, crusty mass on bark, beside note 10 (migration stops and the aggregate forms a fruiting body at the end of a stalk). An arrow leads down to a tall stalk topped by a sphere of spores (note 1: mature fruiting body generates spores), then through a box labeled Meiosis to the same body bursting open (note 2: mature fruiting body releases spores). Spores labeled mature spores (n) lead to an amoeba emerging from a spore coat (note 3: spore germinates), then to an amoeba whose nucleus is labeled (note 4: germination gives rise to amoeba, which divide to form more individual cells). An arrow leads up to two amoebas labeled fusion (note 5: two amoebas fuse to form a zygote). From this pair the path forks. One arrow leads down to a single cell labeled 2n (note 6: zygote grows and undergoes meiosis and multiple rounds of mitosis), then through a second Meiosis box to a cell releasing small amoebas (note 7: new haploid amoebas are released), whose curved arrow returns to the fusing pair. The other arrow leads up through a box labeled Fertilization to a starburst of amoebas streaming together (note 8: amoebas aggregate into a structure called a slug), then to a slug (note 9: slug migrates at a rate of 2 mm per hour), whose arrow leads back to the plasmodium." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_05_01_PlasmodiLC" alt="A circular diagram of a plasmodial slime mold life cycle, divided into a diploid upper half and a haploid lower half and numbered 1 through 7." longdesc="In the diploid half of the cycle: a feeding plasmodium grows into a mature plasmodium (a multinucleated free-flowing mass of protoplasm, which under dry conditions can also form sclerotia and revert), and the mature plasmodium begins sporangia formation (stage 1), producing a young sporangium. Meiosis restores the haploid condition (stage 2) as the mature sporangium releases spores (stage 3). In the haploid half of the cycle: spores labeled mature spores (n) germinate (stage 4), drawn as a cell with a labeled nucleus emerging from a spore coat, giving rise to cells that can convert between amoeboid and flagellated forms (stage 5): one arrow leads up to cells labeled amoeboid cells and another leads left to cells labeled flagellated gametes, with a double-headed arrow between the two forms. At the left, two flagellated gametes are drawn joined end to end for plasmogamy, the fusion of cytoplasm (stage 6); above the amoeboid cells, a larger amoeboid cell with two nuclei is drawn. Arrows from both lead up to a box labeled Fertilization on the line between the halves, and from it to a zygote (2n) in the diploid half, beside karyogamy, the fusion of nuclei (stage 7). The zygote then becomes a multinucleated feeding plasmodium, which grows into the mature plasmodium. The two halves are labeled Diploid (2n) and Haploid (n). In a dry habitat, the mature plasmodium can instead form dormant sclerotia." kind="diagram" >}}
...
The supergroup Chromalveolata is united by similar origins of its members' plastids and includes the apicomplexans, ciliates, diatoms, and dinoflagellates, among other groups (we will cover the diatoms and dinoflagellates in [Algae](/life-health-sciences/microbiology/05-the-eukaryotes-of-microbiology/04-algae/)). The apicomplexans are intra- or extracellular parasites that have an apical complex at one end of the cell. The apical complex is a concentration of organelles, vacuoles, and microtubules that allows the parasite to enter host cells (the images below). Apicomplexans have complex life cycles that include an infective sporozoite that undergoes schizogony to make many merozoites (see the example in the *Eimeria* life-cycle diagram above). Many are capable of infecting a variety of animal cells, from insects to livestock to humans, and their life cycles often depend on transmission between multiple hosts. The genus *Plasmodium* is an example of this group.

{{< mediafigure src="microbiology/OSC_Microbio_05_01_apical" alt="Two images. (a) A colored diagram of an elongated apicomplexan protist, with its apical complex and apical end labeled at one pointed tip. (b) A colorized transmission electron micrograph of an elongated Plasmodium sporozoite with a 1 µm scale bar." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_05_01_balan" alt="A light micrograph of a single oval Balantidium coli trophozoite covered in short, hair-like cilia, with a 10 µm scale bar." kind="photo" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_05_01_stentor" alt="A micrograph of two trumpet-shaped ciliates attached to debris by their narrow ends, each with a flared, cilia-fringed cup at the wide end; the upper cup is labeled cilia and the lower cup cytostome, with a 100 µm scale bar." kind="photo" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_05_01_watermold" alt="A photograph of a whitish, fuzzy oomycete mass labeled water mold growing over the body of an insect on a rock surface, with the insect labeled." kind="photo" >}}
...
Explore the procedures for detecting the presence of an apicomplexan in a public water supply, described in Cornell University's microscopy case study on detecting *Cryptosporidium* and *Giardia* (courses.cit.cornell.edu). This [video of a feeding Stentor](https://openstax.org/l/22feedstentor) shows the feeding of *Stentor*.
{{< /callout >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_05_01_Euglenozoa" alt="Two images. (a) A labeled diagram of an oval Euglena cell with a long flagellum, a photoreceptor, a nucleus with a nucleolus, green chloroplasts, a red eyespot labeled stigma, a contractile vacuole, and stored polysaccharides. (b) A micrograph of a Euglena cell with its stigma, pellicle bands, and contractile vacuole labeled, and a 25 µm scale bar." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_05_01_tryplife" alt="A circular diagram of the Trypanosoma brucei life cycle, split into Tsetse Fly Stages and Human Stages and numbered 1 through 6, with a small photograph of a tsetse fly." longdesc="Stage 1: a tsetse fly takes a blood meal and injects T. brucei into a human's bloodstream. Stage 2: T. brucei multiplies by binary fission in the human's blood, lymph, and spinal fluid. Stage 3: another tsetse fly takes a blood meal and ingests T. brucei from an infected human. Stage 4: in the fly's midgut, T. brucei multiplies by binary fission. Stage 5: T. brucei transforms into an infectious stage. Stage 6: T. brucei enters the fly's salivary gland and multiplies, ready to be injected into another human at the fly's next blood meal, restarting the cycle. Headings at the top place the Tsetse Fly Stages on the left and the Human Stages on the right. Each stage is illustrated with slender, wavy purple T. brucei cells, drawn in pairs where they multiply (stages 2, 4, and 6). The two blood-meal stages, 1 and 3, sit in the middle as boxed close-ups of a fly biting skin, each with an arrow down to a stained micrograph of a single T. brucei cell. Beside them, a drawing of a human torso shows the brain, lungs, liver, and intestines, with a large arrow leading from it up to the stage 1 box and another down to the stage 3 box; a photograph of a tsetse fly sits at the left of center." kind="diagram" >}}
...
{{< textin question="The plasma membrane of a protist is called the ________." answer="plasmalemma" hint="Reread the Characteristics of Protists paragraph on protozoan membranes and cytoplasm layers." >}}

{{< textin question="What are kinetoplastids?" answer="modified mitochondria" accept="modified mitochondrion" hint="Look for the parenthetical definition beside the term in the discussion of protozoan organelles." >}}

{{< mediafigure src="microbiology/OSC_Microbio_05_01_artconn_img" alt="A micrograph of an oval cell densely covered with short, hair-like projections over its entire surface, with a large, pale, rounded structure near the center of the cell." kind="photo" >}}
A protist used for the practice question below. (credit: modification of work by Richard Robinson)
{{< /mediafigure >}}

{{< multiplechoice question="The protist shown has which of the following?" answer="cilia" hint="Compare the pictured cell's surface with the locomotion diagram in Characteristics of Protists." >}}
pseudopodia
flagella
a shell
cilia
...
{{< selfcheck question="What is the function of the ciliate macronucleus?" hint="Reread the Chromalveolata paragraph on the micronucleus and macronucleus." >}}
...
becomes polyploid, holding multiple sets of duplicate chromosomes
a reduced set of metabolic genes
the diploid micronucleus, which is used for sexual reproduction by conjugation
{{< /selfcheck >}}

### Describe the general life cycles and modes of reproduction in unicellular eukaryotic parasites

{{< sortbins question="Sort each reproductive mechanism under whether protozoans use it for asexual or sexual reproduction." hint="Reread the Characteristics of Protists paragraph on reproductive mechanisms, just after the Eimeria life-cycle diagram." >}}
{"bins":["Asexual reproduction","Sexual reproduction"],"items":[{"label":"Binary fission","bin":0},{"label":"Syngamy (fusion of haploid gametes)","bin":1},{"label":"Budding","bin":0},{"label":"Conjugation (exchange of genetic material)","bin":1},{"label":"Schizogony (multiple nuclear divisions before cell division)","bin":0}]}
{{< /sortbins >}}

{{< textin question="The process by which a trophozoite becomes a cyst is called ________." answer="encystment" hint="Reread the Characteristics of Protists paragraph on trophozoites and cysts." >}}

{{< textin question="Cysts triggered by favorable environmental cues become active again through a process called ________." answer="excystment" hint="Reread the last sentence of the Characteristics of Protists paragraph on trophozoites and cysts." >}}

### Identify challenges associated with classifying unicellular eukaryotes

{{< selfcheck question="Protist taxonomy has changed greatly in recent years as relationships have been re-examined using newer approaches. How do newer approaches differ from older approaches?" hint="Compare the informal historical groupings named early in the section with the basis for the current taxonomy named at the start of the Taxonomy of Protists section." >}}
Historically, the protists were informally grouped into the "animal-like" protozoans, the "plant-like" algae, and the "fungus-like" protists such as water molds. Newer approaches classify protists using their evolutionary history, as determined by biochemistry, morphology, and genetics, which is why protists are now scattered across many different taxonomic groups within the domain Eukarya.
===CHECKS===
the protists were informally grouped
"animal-like" protozoans, the "plant-like" algae, and the "fungus-like" protists
newer approaches classify protists using their evolutionary history
determined by biochemistry, morphology, and genetics
{{< /selfcheck >}}

{{< textin question="The protists are described as a ________ group, meaning they lack a shared evolutionary origin." answer="polyphyletic" hint="Reread the first sentence of Taxonomy of Protists." >}}

{{< textin question="The notorious \"brain eating amoeba,\" *Naegleria fowleri*, is considered a distant relative of the Amoebozoa and is classified in the phylum ________." answer="Percolozoa" hint="Reread the last sentence of the first paragraph of the Amoebozoa subsection." >}}

### Explain the taxonomic scheme used for unicellular eukaryotes

{{< textin question="Eukarya is currently divided into six ________ that are further divided into subgroups." answer="supergroups" hint="Use the term introduced at the start of the Taxonomy of Protists section for these six major groups." >}}

{{< textin question="Animals belong to the same supergroup as the kingdom ________." answer="Fungi" accept="fungus" hint="Reread the Opisthokonta sentence in the first paragraph of Taxonomy of Protists." >}}

{{< sortbins question="Sort each subgroup under the supergroup the table above assigns it to." hint="Match each subgroup name to the supergroup row that lists it." >}}
{"bins":["Excavata","Chromalveolata","Rhizaria","Archaeplastida"],"items":[{"label":"Fornicata","bin":0},{"label":"Dinoflagellates","bin":1},{"label":"Foraminifera","bin":2},{"label":"Red algae","bin":3},{"label":"Parabasalids","bin":0},{"label":"Apicomplexans","bin":1},{"label":"Radiolaria","bin":2},{"label":"Chlorophytes","bin":3},{"label":"Euglenozoans","bin":0},{"label":"Ciliates","bin":1}]}
{{< /sortbins >}}

### Give examples of infections caused by unicellular eukaryotes

{{< multiplechoice question="Which genus includes the causative agent for malaria?" answer="*Plasmodium*" hint="Check the Clinical Notes column of the supergroup table." >}}
*Euglena*
*Paramecium*
*Plasmodium*
*Trypanosoma*
...
{{< multiplechoice question="Which protist is a concern because of its ability to contaminate water supplies and cause diarrheal illness?" answer="*Giardia lamblia*" hint="Reread the section's opening paragraph." >}}
*Plasmodium vivax*
*Toxoplasma gondii*
*Giardia lamblia*
*Trichomonas vaginalis*
...
{{< multiplechoice question="Aside from a risk of birth defects, what other effect might a toxoplasmosis infection have?" answer="It may alter infected humans' behavior and personality traits." hint="Look for the sentence about theorizing and evidence that follows the birth-defect risk in the Toxoplasma gondii discussion." >}}
It may alter infected humans' behavior and personality traits.
It may cause corneal inflammation and blindness.
It may cause vaginal discomfort, discharge, and pregnancy complications.
It may cause recurring fever that can be fatal.
{{< /multiplechoice >}}

{{< selfcheck question="What characteristics might make you think a protist could be pathogenic? Are certain nutritional characteristics, methods of locomotion, or morphological differences likely to be associated with the ability to cause disease?" hint="Reread the Amoebozoa, Chromalveolata, and Excavata subsections for what their pathogenic members have in common." >}}
Several of the pathogenic protists described in this section are parasites, such as the apicomplexans, intra- or extracellular parasites whose apical complex allows them to enter host cells. Others, including *Giardia lamblia*, *Cryptosporidium parvum*, and *Entamoeba histolytica*, form protective cysts that are shed in feces and can contaminate water supplies, allowing a new host to become infected. Still others, such as *Trypanosoma brucei* and *T. cruzi*, are spread by insect bites. The section does not connect a general nutritional or locomotor category to pathogenicity beyond these patterns.
===CHECKS===
parasites, such as the apicomplexans, intra- or extracellular parasites whose apical complex allows them to enter host cells
form protective cysts that are shed in feces and can contaminate water supplies
are spread by insect bites
{{< /selfcheck >}}

{{< sortbins question="Sort each genus or species under whether the table above lists it as causing human disease." hint="Use the table's Clinical Notes column; an entry of N/a means no disease is listed there." >}}
{"bins":["Causes disease listed in the table","No disease listed (N/a) in the table"],"items":[{"label":"Giardia lamblia","bin":0},{"label":"Euglena","bin":1},{"label":"Trichomonas","bin":0},{"label":"Paramecium","bin":1},{"label":"Plasmodium","bin":0},{"label":"Stentor","bin":1},{"label":"Entamoeba","bin":0},{"label":"Acetabularia","bin":1},{"label":"Trypanosoma","bin":0},{"label":"Dictyostelium","bin":1}]}
{{< /sortbins >}}

---

<small>This section is adapted from [Microbiology, Section 5.1: Unicellular Eukaryotic Parasites](https://openstax.org/books/microbiology/pages/5-1-unicellular-eukaryotic-parasites) by Nina Parker, Mark Schneegurt, Anh-Hue Thi Tu, Philip Lister, Brian M. Forster, and OpenStax, © OpenStax, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). Access the original for free at [openstax.org](https://openstax.org/details/books/microbiology). Changes: all 16 vendored figures are re-encoded as WebP with `kind` set explicitly after inspecting each image (correcting the media manifest's guess of "diagram" to "photo" for the ringworm figure); alts are rewritten from the served images rather than the source alt text, which is heavily typo-ridden in several places (most severely the *Eimeria* life-cycle alt: "Envronment," "occruing," "proess," "Oocsts realease sporocyts," "invate," "trphozoites," "sezual gametogon," "maerozoites," "gamets," "gamees," "mautres,"); the four life-cycle diagrams (*Eimeria*, the cellular and plasmodial slime molds, and *Trypanosoma brucei*) each carry a stage-by-stage `longdesc` walking the numbered or arrow-ordered stages the caption does not name; the two supergroup-and-example table images (`OSC_Microbio_05_01_groups1` and `groups2`), which carry no micrograph column, are transcribed as one combined Markdown table from the images (checked against PDF pages 173–174) rather than vendored, following the book's rule for a table image whose content a table can fully carry; the Clinical Focus box is rendered as a callout, its "Jump to the next Clinical Focus box" link replaced with a plain sentence naming that the case continues in Parasitic Helminths; the Link to Learning and Eye on Ethics boxes are rendered as callouts with their URLs kept and their closing discussion questions kept as unanswered prose; the section's four footnotes are rendered as inline parenthetical citations, with the two CDC citations' bare access URLs dropped (no DOI to keep) and the two journal citations' DOI-bearing details kept; both body Check Your Understanding notes are rendered as graded body items (a multiplechoice on the schizogony sequence and a sortbins on which supergroups are clinically significant) because one module passage fixes each whole answer; of the section's ten end-of-section exercises (2 Multiple Choice, 2 Fill in the Blank, 3 Short Answer, 3 Critical Thinking), all are used and none is omitted — the 2 Multiple Choice and 2 Fill in the Blank items are source-keyed; one Short Answer ("What are kinetoplastids?") converts to a textin keyed by the module's own parenthetical; one Short Answer (the toxoplasmosis question) converts to a multiplechoice keyed by the module's own sentence, its three distractors drawn from the module's own descriptions of other pathogens' effects; one Short Answer (the ciliate macronucleus question) and two Critical Thinking questions (the taxonomy-approaches question and the pathogenicity-characteristics question) remain self-checks with model answers and rubrics assembled only from this module's text, because their honest answers need several sentences assembled or ask the learner to speculate; the Critical Thinking Art Connection item is graded as a `mediafigure` + multiplechoice keyed from the image and is placed ahead of the ciliate-macronucleus Short Answer self-check, reversing their printed order, because that self-check's stem ("ciliate") shares the key's root (the pictured protist is covered in short hair-like projections, i.e., cilia), with an author-written caption and an alt that describes the projections without naming any of the four answer choices; 8 filler items (2 term-recall textins from the section's own defining sentences on reproduction, 2 on classification (the polyphyletic cloze, and a cloze from the Amoebozoa subsection's own sentence placing *Naegleria fowleri*, a distant relative of the Amoebozoa, in the phylum Percolozoa), 1 on the taxonomic-scheme vocabulary, 1 sortbins on reproductive mechanisms, and 2 sortbins built from the transcribed supergroup table) fill out three items per objective group; of this section's two Link to Learning URLs, the apicomplexan-detection-procedures link (`https://openstax.org/l/22detpreapicom`, redirecting to `https://courses.cit.cornell.edu/biomi290/microscopycases/crypto/index.htm`) is confirmed dead (404, checked September 15, 2026) and is no longer linked, replaced with a plain-text description naming Cornell University's *Cryptosporidium*/*Giardia* detection-procedures case study; the section's other Link to Learning URL, the feeding-*Stentor* video, is unaffected and stays linked; key terms are compiled from the module's 23 defined terms, all of which have Glossary appendix entries (the appendix's *holozoic* entry prints "phagoctytosis"; the bullet prints "phagocytosis", a one-word source typo); the misspelled phylum name "Ciliaphora" is corrected to "Ciliophora" (matching the book's own Glossary entry), the extraneous "a" in "is a considered a distant relative" is removed, and a missing closing parenthesis after "African sleeping sickness" is added — all three are one-word or single-character corrections, disclosed here rather than inline; the cross-reference to m58793 is rendered as a link to that module's actual title, "Unique Characteristics of Eukaryotic Cells" (the source's own link text names it "Unique Characteristics of Prokaryotic Cells," which is that module's neighboring section, not its own title — a suspected source defect); and cross-references to Sections 5.2–5.4 are rendered as absolute site-root links to their landing pages; the supergroup table's Parabasalids row ("no mitochondria" beside "kinetoplastids") and the Excavata paragraph's "modified mitochondria (kinetoplastids)" are kept as printed, with a visible Source note after the table, because the book's own Section 3.4 gives *Trichomonas* hydrogenosomes, not kinetoplasts (erratum 811, September 15, 2026).</small>

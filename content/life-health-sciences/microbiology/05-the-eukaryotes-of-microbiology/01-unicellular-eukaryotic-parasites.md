...
{{< sortbins question="Which supergroups contain the clinically significant protists? Sort each supergroup discussed in this section under whether it is described as including many clinically significant protists or only a few." hint="Reread the sentence just after the tree diagram and table that names which supergroups this section focuses on." >}}
...
{{< textin question="The plasma membrane of a protist is called the ________." answer="plasmalemma" hint="This is the same protective term used for the whole-cell membrane discussed at the start of the section." >}}
...
{{< selfcheck question="What is the function of the ciliate macronucleus?" hint="Compare what the section says about the macronucleus with what it says about the micronucleus." >}}
...
{{< multiplechoice question="The protist shown has which of the following?" answer="cilia" hint="Count how many short projections cover the entire cell surface, rather than looking for a single whip-like structure, lobed extensions, or a hard outer covering." >}}
pseudopodia
flagella
a shell
cilia
...
{{< sortbins question="Sort each reproductive mechanism under whether protozoans use it for asexual or sexual reproduction." hint="Match each term to the paragraph describing asexual mechanisms (binary fission, budding, schizogony) versus sexual ones (gamete fusion, conjugation)." >}}
...
{{< textin question="The process by which a trophozoite becomes a cyst is called ________." answer="encystment" hint="Use the term for turning INTO a protective cyst, not the term for emerging from one." >}}

{{< textin question="Cysts triggered by favorable environmental cues become active again through a process called ________." answer="excystment" hint="Use the term for emerging from a cyst, the opposite of the process in the item above." >}}
...
===CHECKS===
older approaches informally grouped protists by superficial resemblance
"animal-like" protozoans, "plant-like" algae, and "fungus-like" protists
newer approaches classify protists using their evolutionary history
determined by biochemistry, morphology, and genetics
{{< /selfcheck >}}

{{< textin question="The protists are described as a ________ group, meaning they lack a shared evolutionary origin." answer="polyphyletic" hint="Use the term for a group whose members do not share a single common ancestor." >}}

{{< textin question="Current taxonomy of protists is based on evolutionary history, determined by biochemistry, morphology, and ________." answer="genetics" hint="This is the field of evidence most associated with DNA and heredity, alongside biochemistry and morphology." >}}

### Explain the taxonomic scheme used for unicellular eukaryotes

{{< textin question="Animals belong to the same supergroup as the kingdom ________." answer="Fungi" hint="Look for the supergroup whose table row lists mushrooms, molds, and yeasts as one subgroup alongside Animals." >}}
...
{{< multiplechoice question="Which genus includes the causative agent for malaria?" answer="*Plasmodium*" hint="This apicomplexan genus is named directly in the Chromalveolata discussion of medically important genera." >}}
*Euglena*
*Paramecium*
*Plasmodium*
*Trypanosoma*
...
{{< multiplechoice question="Which protist is a concern because of its ability to contaminate water supplies and cause diarrheal illness?" answer="*Giardia lamblia*" hint="This Fornicata pathogen is named in the section's opening paragraph and again in the Excavata discussion." >}}
*Plasmodium vivax*
*Toxoplasma gondii*
*Giardia lamblia*
*Trichomonas vaginalis*
...
{{< selfcheck question="What characteristics might make you think a protist could be pathogenic? Are certain nutritional characteristics, methods of locomotion, or morphological differences likely to be associated with the ability to cause disease?" hint="Look for the patterns shared by the pathogenic protists named across this section, rather than a single stated rule." >}}
...
===CHECKS===
intracellular parasites, such as the apicomplexans, which use an apical complex to enter host cells
form protective cysts that are shed in feces and can contaminate water supplies
transmitted between hosts by the bite of an infected insect
{{< /selfcheck >}}

...
{{< selfcheck question="In an autoclave, how are temperatures above boiling achieved?" hint="Recall what replaces the air that is removed from an autoclave's chamber, and how that changes the interior pressure." >}}
...
{{< selfcheck question="How would the onset of spoilage compare between HTST-pasteurized and UHT-pasteurized milk?" hint="Compare how each type of pasteurized milk is packaged and stored after treatment." >}}
...
{{< selfcheck question="Why is boiling not used as a sterilization method in a clinical setting?" hint="This section names two separate reasons boiling is not considered a useful sterilization technique." >}}
...
{{< multiplechoice
  ...
  hint="Recall what this section says refrigeration does to microbial metabolism, as distinguished from what freezing can do to susceptible organisms."
>}}
...
{{< multiplechoice
  ...
  hint="Recall what happens to a food's water content, called its water activity, when solutes such as salts or sugars are added."
>}}
...
{{< selfcheck question="What are two advantages of ionizing radiation as a sterilization method?" hint="This section names one advantage related to packaging and a second related to heat-sensitive materials." >}}
...
{{< sortbins question="How does the effectiveness of ionizing radiation compare with that of nonionizing radiation? Sort each phrase under the type of radiation it describes." hint="Match each fact to the type of radiation defined at the start of the Radiation section (X-rays and gamma rays) or the UV-light example described afterward." >}}
...
{{< selfcheck question="Would membrane filtration with a 0.2-µm filter likely remove viruses from a solution? Explain." hint="Recall how the pore size used to remove bacteria compares with the average size of a bacterium, and what this section says about virus size." >}}
Membrane filters used to remove bacteria have an effective pore size of 0.2 µm, smaller than the average size of a bacterium (1 µm); this is why they are effective at removing bacteria from solutions. This section does not state how the size of viruses compares with a 0.2-µm pore, so it does not, by itself, establish whether membrane filtration at this pore size would remove viruses from a solution.
===CHECKS===
...
this section does not state how virus size compares with a 0.2-µm pore
{{< /selfcheck >}}

{{< selfcheck question="Name at least two common uses of HEPA filtration in clinical or laboratory settings." hint="This section names uses inside biological safety cabinets as well as uses in hospitals and surgical suites." >}}
...
| Autoclave | Typical settings: 121 °C for 15 minutes at 15 psi | Denatures proteins and alters membranes | Sterilization of microbiological media, heat-stable medical and laboratory equipment, and other heat-stable items |
| Pasteurization | 72 °C for 15 seconds (HTST) or 138 °C for ≥ 2 seconds (UHT) | Denatures proteins and alters membranes | Prevents spoilage of milk, apple juice, honey, and other ingestible liquids |
| **Cold** | | | |
...
| **Pressure** | | | |
| High-pressure processing | Exposure to pressures of 100–800 MPa | Denatures proteins and can cause cell lysis | Preservation of food |
...
| Nonionizing radiation | Exposure to ultraviolet light | Introduces thymine dimers, leading to mutations | Surface sterilization of laboratory materials, water purification |
| **Sonication** | | | |
...
| **Filtration** | | | |
| HEPA filtration | Use of HEPA filter with 0.3-µm pore size | Physically removes microbes from air | Laboratory biological safety cabinets, operating rooms, isolation units, heating and air conditioning systems, vacuum cleaners |
...
{{< multiplechoice
  ...
  answer="sonication"
  hint="Recall which method in this section forms bubbles inside the intracellular liquid due to rapid pressure changes."
>}}
microwaving
gamma irradiation
...
{{< multiplechoice
  ...
  hint="Distinguish the term for TIME from the term for the lowest killing TEMPERATURE defined earlier in this section."
>}}
D-value
thermal death point
thermal death time
...
{{< multiplechoice
  ...
  answer="filtration"
  hint="Recall which method in this section works by physically separating microbes from a sample rather than acting on them directly."
>}}
filtration
desiccation
lyophilization
...
{{< multiplechoice
  ...
  answer="True"
  hint="Recall which of the two forms of radiation in this section easily penetrates paper and plastic, and which does not penetrate cells or packaging at all."
>}}
True
False
{{< /multiplechoice >}}
...
{{< textin question="In an autoclave, the application of pressure to ________ is increased to allow it to achieve temperatures above the boiling point of water." answer="steam" hint="Name what fills the autoclave chamber, under increasing pressure, once air has been removed." >}}
...
{{< multiplechoice
  ...
  hint="Recall what this section says nonionizing radiation, such as UV light, can and cannot penetrate."
>}}
...
{{< selfcheck question="How does the addition of salt or sugar help preserve food?" hint="Recall what happens to the water inside microbial cells when solutes are added to food at very high concentrations." >}}
...
{{< selfcheck question="Which is more effective at killing microbes: autoclaving or freezing? Explain." hint="Compare what an autoclave's temperature can kill with what freezing can and cannot reliably kill." >}}

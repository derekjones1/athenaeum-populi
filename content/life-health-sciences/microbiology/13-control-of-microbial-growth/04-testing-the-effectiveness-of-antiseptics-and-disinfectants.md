...
description: >-
  The phenol coefficient and the disk-diffusion, use-dilution, and in-use
  tests used to measure the effectiveness of antiseptics and disinfectants
  — adapted from OpenStax Microbiology, Section 13.4.
source_section: "13.4"
weight: 4
---
...
{{< sortbins question="What are the differences between the three levels of disinfectant effectiveness? Sort each phrase under the germicide level it describes." hint="Reread the first paragraph of this section, or the first bullet of the Summary." >}}
{"bins":["High-level germicides","Intermediate-level germicides","Low-level germicides"],"items":[{"label":"Able to kill vegetative cells, fungi, viruses, and endospores","bin":0},{"label":"Less effective against endospores than an agent capable of achieving sterilization","bin":1},{"label":"Kill only vegetative cells and certain enveloped viruses","bin":2},{"label":"With extended use, can ultimately achieve sterilization","bin":0},{"label":"Ineffective against endospores","bin":2}]}
{{< /sortbins >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_13_04_Diskdiff" alt="(a) A drawing of a bacterial lawn on an agar plate labeled 'growth,' with five antimicrobial disks labeled ATB1–ATB5; a clear zone of inhibition of varying width surrounds each disk, and an icon beside the plate shows a ruler with a handle. (b) A photograph of two real agar plates, each hand-labeled with its bacterial species and crossed by a measuring strip; the Pseudomonas aeruginosa plate's four disks show only one zone of inhibition, the other three showing no clearing, while all four disks on the Staphylococcus aureus plate produce clear zones of different sizes." longdesc="Panel (a): a circular agar plate with a beige lawn of bacterial growth; a leader labeled 'growth' points to the lawn near the rim, and one labeled 'antimicrobial disk' points to disk ATB1. Five small tan disks are arranged on the plate (two upper, one center, two lower), labeled ATB1, ATB2, ATB3, ATB4, and ATB5; a lighter, clear ring surrounds each disk, its width varying from disk to disk, and a leader labeled 'zone of inhibition (no growth)' points to the ring around ATB4. Below the plate, a key spells out ATB1 through ATB5 as 'antimicrobial 1' through 'antimicrobial 5.' Beside the plate, a drawing of a ruler with a handle carries the instruction 'Use a ruler with a handle if calipers are unavailable'; the ruler is not laid across any zone. Panel (b): two photographed agar plates side by side. The left plate, hand-labeled for a lawn of *Pseudomonas aeruginosa*, has a metric measuring strip laid across its top and four antimicrobial disks; only the disk nearest the strip has a dark zone of inhibition around it, the other three disks showing no clearing at all. The right plate, hand-labeled for a lawn of *Staphylococcus aureus*, also has a measuring strip laid across it and four antimicrobial disks, each producing a dark zone of inhibition of a different size." kind="diagram" eager="true" >}}
...
{{< multiplechoice
  question="When comparing the activities of two disinfectants against the same microbe, using the disk-diffusion assay, and assuming both are water soluble and can easily diffuse in the agar, would a more effective disinfectant have a larger zone of inhibition or a smaller one?"
  answer="a larger zone of inhibition"
  hint="Reread the Disk-Diffusion Method paragraph."
>}}
...
{{< selfcheck question="Is the use-dilution test performed in a clinical setting? Why?" hint="Reread the second paragraph of the Use-Dilution Test subsection." >}}
The module introduces the use-dilution test among the "other methods … used for measuring the effectiveness of a chemical agent in clinical settings," but the performer it names is the manufacturer: disinfectant manufacturers perform use-dilution tests to validate the efficacy claims for their products, as designated by the EPA. The Association of Official Agricultural Chemists International (AOAC) requires a minimum of 59 of 60 replicates to show no growth, with repeatable results from different batches of disinfectant and on different days, before a product passes.
===CHECKS===
disinfectant manufacturers perform use-dilution tests to validate the efficacy claims for their products
as designated by the EPA
the AOAC requires a minimum of 59 of 60 replicates to show no growth before a product passes
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_13_04_InUseTest" alt="A diagram of the in-use test procedure: a flask of used disinfectant sends a 1 mL sample into a tube of 9 mL sterile broth containing a disinfectant-inactivating compound; ten drops (about 0.2 mL) of that mixture are plated onto each of two agar plates, one incubated at 37 °C for 3 days and the other at room temperature for 7 days." kind="diagram" >}}
...
{{< multiplechoice
  question="What does a positive in-use test indicate?"
  answer="The disinfectant solution is contaminated with viable microbial cells"
  hint="Reread the paragraph above the in-use test figure."
>}}
The disinfectant solution is contaminated with viable microbial cells
The disinfectant has about the same level of effectiveness as phenol
The chemical agent produced a large zone of inhibition in the disk-diffusion assay
The disinfectant passed the use-dilution test's replicate standard
{{< /multiplechoice >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_13_04_CRE" alt="A colorized scanning electron micrograph filling the frame with numerous pink-to-purple, oval-to-rod-shaped bacterial cells overlapping in a dense cluster." kind="photo" >}}
...
*The case began in [Controlling Microbial Growth](/life-health-sciences/microbiology/13-control-of-microbial-growth/01-controlling-microbial-growth/).*
{{< /callout >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_13_04_DuoScope" alt="A drawing of a duodenoscope inserted through a person's mouth, down the esophagus and through the stomach, to the duodenum. Inset: two photographs of the scope's tip showing its forceps elevator in the lowered, closed position and in the raised, open position." longdesc="Main drawing: a side view of a person's head, neck, and torso showing a duodenoscope's flexible tube entering through the mouth, coiling near a handle, then descending through the esophagus, through the stomach, and into the duodenum, each organ labeled; a circle drawn around the scope's tip in the duodenum sends a curved gray arrow up to the inset. Inset at right: two close-up photographs of the scope's tip, each with a pointer line labeled 'forceps elevator'; the left photo, labeled '(a) lowered/closed forceps elevator,' shows the small metal elevator flap lying flat; the right photo, labeled '(b) raised/open forceps elevator,' shows the same flap tilted upward, opening a gap beside it." kind="diagram" >}}
...
{{< textin question="If a chemical disinfectant is more effective than phenol, then its phenol coefficient would be ________ than 1.0." answer="greater" accept="higher|larger|bigger|more than 1|greater than 1|more than 1.0|greater than 1.0" hint="Reread the sentences near the end of the Phenol Coefficient subsection that compare formalin and chloramine with phenol." >}}

{{< textin question="Historically, the effectiveness of a chemical disinfectant was compared with that of phenol at killing ________ and *Salmonella enterica* serovar Typhi, and a phenol coefficient was calculated." answer="Staphylococcus aureus" accept="S. aureus" hint="Reread the third sentence of the Phenol Coefficient subsection." >}}

{{< textin question="If used for extended periods of time, ________ germicides may lead to sterility." answer="high-level" hint="Reread the first paragraph of this section." >}}

{{< multiplechoice
  question="The effectiveness of chemical disinfectants has historically been compared to that of which of the following?"
  answer="phenol"
  hint="Reread the first two sentences under this section's first subsection heading."
>}}
phenol
ethyl alcohol
bleach
...
{{< multiplechoice
  question="Which of the following refers to a germicide that can kill vegetative cells and certain enveloped viruses but not endospores?"
  answer="low-level germicide"
...
{{< selfcheck question="Why were chemical disinfectants once commonly compared with phenol?" hint="Reread the first four sentences of the Phenol Coefficient subsection." >}}
...
===CHECKS===
phenol was the first chemical agent used by Joseph Lister
Rideal and Walker established a protocol in 1903 to compare the effectiveness of other chemicals with that of phenol
calculated a phenol coefficient for each chemical tested
{{< /selfcheck >}}

{{< multiplechoice
  question="Why is length of exposure to a chemical disinfectant important for its activity?"
  answer="Longer exposure increases the disinfectant's efficacy"
  hint="Reread the second paragraph of this section."
>}}
Longer exposure increases the disinfectant's efficacy
Longer exposure decreases the disinfectant's efficacy
Higher concentration decreases the disinfectant's efficacy
Temperature and pH have no effect on the disinfectant's potency
{{< /multiplechoice >}}

### Compare and contrast the disk-diffusion, use-dilution, and in-use methods for testing the effectiveness of antiseptics, disinfectants, and sterilants

{{< textin question="In the disk-diffusion assay, a large zone of inhibition around a disk to which a chemical disinfectant has been applied indicates ________ of the test microbe to the chemical disinfectant." answer="susceptibility" accept="sensitivity" hint="Reread the Disk-Diffusion Method paragraph." >}}

{{< textin question="The use-dilution test determines the effectiveness of a disinfectant on a ________." answer="surface" accept="inanimate surface" hint="Reread the first two sentences of the Use-Dilution Test subsection." >}}

{{< textin question="In the use-dilution test, bacterial survival is demonstrated by the presence of ________ in the medium." answer="turbidity" hint="Reread the end of the first paragraph of the Use-Dilution Test subsection." >}}

{{< multiplechoice
  question="Which type of test is used to determine whether disinfectant solutions actively used in a clinical setting are being used correctly?"
  answer="in-use test"
  hint="Reread the paragraph that follows the Use-Dilution Test subsection."
>}}
...
{{< selfcheck question="What are some advantages of use-dilution and in-use tests compared with the disk-diffusion assay?" hint="Reread the Disk-Diffusion Method, Use-Dilution Test, and In-Use Test subsections." >}}

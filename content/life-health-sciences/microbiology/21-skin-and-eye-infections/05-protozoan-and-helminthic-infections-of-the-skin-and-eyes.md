...
{{< selfcheck question="How are Acanthamoeba infections acquired?" hint="The module names three separate portals of entry for this parasite — trace each one and what it can lead to." >}}
...
===CHECKS===
the eye is infected by amoeba in contaminated water or on contact lenses, causing Acanthamoeba keratitis
...
{{< selfcheck question="What preventative actions might you recommend to a patient traveling to a region where loiasis is endemic?" hint="The module says nothing about repellents or protective clothing — look only at how the parasite actually reaches a new host." >}}

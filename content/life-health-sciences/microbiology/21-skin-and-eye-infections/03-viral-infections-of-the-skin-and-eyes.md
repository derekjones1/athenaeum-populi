...
description: >-
  Papillomas (warts), oral herpes, roseola and fifth disease, and viral
  conjunctivitis and herpes keratitis — the viruses most associated with
  skin and eye infections and the major characteristics of each disease —
  adapted from OpenStax Microbiology, Section 21.3.
source_section: "21.3"
weight: 3
---
...
Infection by HSV-1 commonly manifests as cold sores or fever blisters, usually on or around the lips (shown below). HSV-1 is highly contagious, with some studies suggesting that up to 65% of the US population is infected; however, many infected individuals are asymptomatic (Wald, A., and Corey, L. "Persistence in the Population: Epidemiology, Transmission." In: A. Arvin, G. Campadelli-Fiume, E. Mocarski et al. *Human Herpesviruses: Biology, Therapy, and Immunoprophylaxis*. Cambridge: Cambridge University Press, 2007.). Moreover, the virus can be latent for long periods, residing in the trigeminal nerve ganglia between recurring bouts of symptoms. Recurrence can be triggered by stress or environmental conditions (systemic or affecting the skin). When lesions are present, they may blister, break open, and crust. The virus can be spread through direct contact, even when a patient is asymptomatic.

{{< mediafigure src="microbiology/OSC_Microbio_21_03_coldsore" alt="A raised, reddened sore with a crusted, whitish center sits at the edge of a person's mouth, marked by an arrow." kind="photo" >}}
...
They have similar presentations, but they are caused by different viruses.
They are both untreatable illnesses of adults.
{{< /multiplechoice >}}
...
| Roseola (roseola infantum, exanthem subitum) | Human herpesvirus 6 (HHV-6), human herpesvirus 7 (HHV-7) | Initial cold-like symptoms with high fever, followed by a macular or papular rash three to five days later | Spread by viral and respiratory secretions of infected individuals | Typically none; ganciclovir for immunocompromised patients |
...
- **Roseola** and **fifth disease** are common viral illnesses that cause skin rashes; roseola is caused by HHV-6 and HHV-7 while fifth disease is caused by parvovirus B19.
...
- **papillomas** — growth on the skin associated with infection by any of the human papilloma viruses (HPV); commonly known as a wart.
...
{{< multiplechoice
  question="Warts are caused by"
  answer="human papillomavirus."
  hint="This is the same virus family named at the start of this section's discussion of warts."
>}}
...
{{< textin
  question="An infection caused by herpes simplex virus that results in cold sores, most commonly on and around the lips, is known as ________."
  answer="oral herpes"
  hint="The module names this condition right after introducing HSV-1's usual route of transmission."
>}}

{{< multiplechoice
  question="Which disease is usually self-limiting but is most commonly treated with ganciclovir if medical treatment is needed?"
  answer="roseola"
  hint="This section names one illness for which ganciclovir is reserved for immunocompromised patients even though the disease usually resolves on its own."
>}}
roseola
oral herpes
papillomas
...
{{< selfcheck question="Compare and contrast bacterial and viral conjunctivitis." hint="The module names one clear difference in what the two infections discharge, and two things that make the viral form easy to spread and hard to treat with antibiotics." >}}
The two forms of conjunctivitis differ mainly in their discharge: viral conjunctivitis tends to produce a discharge that is more watery than the thick discharge associated with bacterial conjunctivitis. Like bacterial conjunctivitis, viral conjunctivitis causes inflammation of the conjunctiva, and the infection is contagious, spreading easily from one eye to the other or to other individuals through contact with eye discharge. Viral conjunctivitis is commonly associated with colds caused by adenoviruses. Antibiotic treatment of viral conjunctivitis is ineffective, and symptoms usually resolve without treatment within a week or two.
===CHECKS===
viral conjunctivitis produces a discharge that is more watery than the thick discharge of bacterial conjunctivitis
viral conjunctivitis is contagious and spreads through contact with eye discharge
viral conjunctivitis is commonly associated with colds caused by adenoviruses
antibiotic treatment is ineffective, and symptoms usually resolve without treatment within a week or two
{{< /selfcheck >}}

---

<small>This section is adapted from [Microbiology, Section 21.3: Viral Infections of the Skin and Eyes](https://openstax.org/books/microbiology/pages/21-3-viral-infections-of-the-skin-and-eyes) by Nina Parker, Mark Schneegurt, Anh-Hue Thi Tu, Philip Lister, Brian M. Forster, and OpenStax, © OpenStax, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). Access the original for free at [openstax.org](https://openstax.org/details/books/microbiology). Changes: all three of the module's photographic figures (warts, cold sore, roseola/fifth-disease) are re-encoded as WebP and rendered as mediafigures with `kind="photo"` after image inspection, each carrying an alt rewritten from the source's bare "photo of/photo depicts" alt to describe what is actually visible; the warts figure carries `eager="true"` as the page's first figure; the Disease Profile box's table image (`OSC_Microbio_21_03_DPViralSki`) is not vendored and is instead transcribed as a Markdown table inside the callout, read from the image and checked against the PDF page, per this book's Disease Profile rule; the vendored figure for the roseola/fifth-disease photo uses the manifest's actual stem, `OSC_Microbio_21_03_roseola5th`, which matches the module's own figure id; both of the module's footnotes (Wald & Corey; the CDC's "Fifth Disease" page) are rendered as inline parenthetical citations placed after the sentence they support, with authors, titles, and publication details kept verbatim and each footnote's bare access URL dropped; the two cross-references to *Urogenital System Infections* (HPV genital warts, HSV-2 genital herpes) name that section as plain text, since it is not yet an authored page; two one-character source typos are corrected in place with no inline note — the masculine ordinal indicator "º" in "39.4 ºC" is corrected to the degree sign "°C," and "parvovirus 19" (missing "B") is corrected to "parvovirus B19" in both places it appears, the Summary bullet on fifth disease and a Multiple Choice distractor; the module's five Multiple Choice items and one Fill in the Blank item are rendered exactly as keyed, in source order and source option order (the FIB as `textin`); the Short Answer question ("Compare and contrast bacterial and viral conjunctivitis") is rendered as a `selfcheck`, since no single module sentence fixes both a similarity and a difference between the two conditions; both of the module's body Check Your Understanding bullets are graded at their body position rather than left as self-checks — "What are the most common sites for the appearance of herpetic lesions?" as a `multiplechoice` keyed from "the lips, mouth, and face are the most common sites for HSV-1 infections," and "Identify at least one similarity and one difference between roseola and fifth disease" as a `multiplechoice` keyed from the section's opening sentence, "somewhat similar in terms of their presentation, but they are caused by different viruses"; a key-term recall `textin` for "oral herpes" fills the Practice block to the section's eight-item floor, since the source's own exercise set (five Multiple Choice, one Fill in the Blank, one Short Answer) supplies only seven; no source exercise, table, or Check Your Understanding bullet is omitted; key terms are compiled from the module's six `<term>` elements and the book's Glossary appendix, giving six distinct bullets, all from the Glossary (none sentence-derived); one bullet's headword, "papillomas," is the plural of the appendix's "papilloma" entry and is bolded lower-case per house style even though its defining sentence opens the Papillomas section and so prints capitalized in the body.</small>

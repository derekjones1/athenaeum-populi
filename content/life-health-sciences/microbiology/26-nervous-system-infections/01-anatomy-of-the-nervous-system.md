...
{{< mediafigure src="microbiology/OSC_Microbio_26_01_Meninges" kind="diagram" alt="Diagram of the layers around the brain, outermost to innermost: skin, a thin aponeurosis, a thin periosteum, bone, then the three meninges — dura mater (thick), arachnoid mater, and pia mater (thin, on the brain's surface) — with cerebrospinal fluid (CSF) filling the space the arachnoid maintains between the dura mater and the pia mater." longdesc="A head in profile, its brain visible, has an arrow leading from the top of the head to a large close-up circle, in which the layers over the brain are drawn as stepped blocks. From outside in, the blocks are labeled skin, a thin aponeurosis layer, a thin periosteum layer, and bone. Inside the bone, a brace labeled Meninges spans three layers: the dura mater (a blue layer just under the bone), the arachnoid mater (a tan layer below it), and the pia mater (a thin layer directly on the brain tissue, dipping into a fold of the brain's surface). Between the arachnoid mater and the pia mater, a web-filled layer is labeled subarachnoid space, with a second leader into the same layer labeled cerebrospinal fluid (CSF); a small blood vessel runs through it. Beneath the pia mater, the brain's surface is labeled brain tissue." >}}
...
{{< multiplechoice
  ...
  answer="microbiota"
  hint="See the Summary's sentence about the blood-brain barrier."
>}}
meninges
microbiota
cerebrospinal fluid

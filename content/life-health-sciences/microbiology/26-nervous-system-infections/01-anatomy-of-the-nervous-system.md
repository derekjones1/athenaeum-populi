...
description: >-
  The central and peripheral nervous systems, the meninges and
  cerebrospinal fluid, the blood-brain barrier and how pathogens breach
  it, and the cells of the nervous system, plus meningitis, encephalitis,
  and meningoencephalitis — adapted from OpenStax Microbiology, Section
  26.1.
source_section: "26.1"
weight: 1
---
...
*The case continues in [Acellular Diseases of the Nervous System](/life-health-sciences/microbiology/26-nervous-system-infections/03-acellular-diseases-of-the-nervous-system/).*
{{< /callout >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_26_01_NervSys" kind="diagram" eager="true" alt="Diagram of the nervous system. The central nervous system is made of the brain and spinal cord. The peripheral nervous system is labeled nerves, drawn in yellow branching from the spinal cord and running throughout the body; no ganglia are marked." >}}
The essential components of the human nervous system are shown in this illustration. The central nervous system (CNS) consists of the brain and spinal cord. It connects to the peripheral nervous system (PNS), a network of nerves that extends throughout the body.
{{< /mediafigure >}}

{{< mediafigure src="microbiology/OSC_Microbio_26_01_Meninges" kind="diagram" alt="Diagram of the layers around the brain, outermost to innermost: skin, a thin aponeurosis, a thin periosteum, bone, then the three meninges — dura mater (thick), arachnoid mater, and pia mater (thin, on the brain's surface) — with cerebrospinal fluid (CSF) filling the space the arachnoid maintains between the dura mater and the pia mater." longdesc="A wedge of scalp and skull is drawn cut away above a close-up circle of the brain's surface. From outside in, the wedge labels skin, a thin aponeurosis layer, a thin periosteum layer, and bone. Inside the bone, a brace labeled Meninges spans three layers: the dura mater (drawn thickest, just under the bone), the arachnoid mater (a thinner layer below it), and the pia mater (a thin layer directly on the brain tissue). Between the arachnoid mater and the pia mater, the subarachnoid space is shown filled with cerebrospinal fluid (CSF) and containing blood vessels." >}}
The layers of tissue surrounding the human brain include three meningeal membranes: the dura mater, arachnoid mater, and pia mater. (credit: modification of work by National Institutes of Health)
{{< /mediafigure >}}
...
View [this video about the blood-brain barrier](https://www.openstax.org/l/22bldbrbarr).
{{< /callout >}}
...
glial cells assist in the organization of neurons and provide a scaffold for some aspects of neuronal function
...
the presynaptic neuron's synaptic terminals contain vesicles filled with neurotransmitters
neurotransmitters diffuse across the synapse and bind to receptors on the postsynaptic cell, potentially initiating a response
{{< /selfcheck >}}
...
the brain tissues have limited space to expand within the inflexible bones of the skull
these forms of inflammation can lead to blindness, deafness, coma, and death
{{< /selfcheck >}}

{{< callout type="info" >}}
**Micro Connections.** *Guillain-Barré Syndrome*
...
{{< multiplechoice
  ...
  answer="dura mater"
  hint="It lies directly beneath the bones of the skull, above the other two meninges."
>}}
pia mater
arachnoid mater
dura mater
...
{{< multiplechoice
  question="Nerve cells form long projections called ________."
  answer="axons"
  hint="These are the projections that carry an electrochemical signal away from the soma, sometimes for up to a meter."
>}}
soma
axons
dendrites
...
{{< textin
  ...
  answer="axon"
  hint="This is the single elongated extension a soma produces, as distinct from its many short, branched dendrites."
>}}

{{< textin
  question="The ________ is filled with cerebrospinal fluid."
  answer="subarachnoid space"
  hint="This space sits between two of the three meninges — the one that produces CSF and the one that adheres directly to the brain's surface."
>}}
...
three meninges — the dura mater, arachnoid mater, and pia mater — lie beneath the skull
...
cranial capillaries have far fewer fenestra than other capillaries
cranial capillaries have far fewer pinocytotic vesicles than other capillaries
{{< /selfcheck >}}

{{< mediafigure src="microbiology/OSC_Microbio_26_01_ArtConnect_img" kind="diagram" alt="Drawing of a neuron. The large round region containing a darker purple circle is labeled A. A long projection from A is labeled B; this projection is wrapped in a segmented structure labeled E. A short, branched projection from A is labeled C. Fine terminal branches at the end of the long projection are labeled D." >}}
This neuron's structures are labeled A through E for identification in the exercises below.
{{< /mediafigure >}}
...
{{< selfcheck question="Identify the type of cell shown, as well as the following structures: axon, dendrite, myelin sheath, soma, and synapse." hint="Work from the cell body outward along the long projection to where it ends, then name the short branched projections separately." >}}
The cell pictured is a neuron. Structure A is the soma (cell body), which contains the nucleus and most of the cell's organelles. Structure C marks a dendrite, one of the many finely branched extensions from the soma. Structure B is the axon, the elongated extension along which electrochemical signals travel. Structure E is the myelin sheath, the insulating layer surrounding the axon, formed from the cell membranes of glial cells such as oligodendrocytes. Structure D marks the synapse, the junction at the end of the axon where it meets another cell.
===CHECKS===
the cell shown is a neuron
A is the soma, the cell body containing the nucleus and most organelles
C marks a dendrite, one of the finely branched extensions from the soma
B is the axon, along which electrochemical signals travel
E is the myelin sheath, formed from glial cells such as oligodendrocytes
D marks the synapse at the end of the axon
{{< /selfcheck >}}
...
{{< multiplechoice
  ...
  answer="microbiota"
  hint="This is the general term for the community of microorganisms normally living in or on a body site — the very thing this section says the CNS lacks."
>}}
meninges
microbiota
cerebrospinal fluid
...
{{< multiplechoice
  question="Pathogen gains entry by infecting peripheral white blood cells."
  answer="leukocyte-facilitated entry"
  hint="This is the Trojan-horse mechanism named for the blood cells a pathogen infects to ride directly into the CNS."
>}}
intercellular entry
transcellular entry
leukocyte-facilitated entry
...
{{< multiplechoice
  question="Pathogen passes between the cells of the blood-brain barrier."
  answer="intercellular entry"
  hint="This strategy is also called paracellular, and uses virulence factors, toxins, or inflammation to slip through the seams between barrier cells rather than through them."
>}}
intercellular entry
transcellular entry
leukocyte-facilitated entry

...
description: >-
  Meningococcal, pneumococcal, Haemophilus influenzae type b, and neonatal
  bacterial meningitis; tetanus and botulism caused by Clostridium species;
  listeriosis; and Hansen's disease (leprosy) — adapted from OpenStax
  Microbiology, Section 26.2.
source_section: "26.2"
weight: 2
---
...
Diagnosis of bacterial meningitis is best confirmed by analysis of CSF obtained by a lumbar puncture. Abnormal levels of polymorphonuclear neutrophils (PMNs) (> 10 PMNs/mm³), glucose (< 45 mg/dL), and protein (> 45 mg/dL) in the CSF are suggestive of bacterial meningitis (Popovic, T., et al. World Health Organization. "Laboratory Manual for the Diagnosis of Meningitis Caused by *Neisseria meningitidis*, *Streptococcus pneumoniae*, and *Haemophilus influenzae*." 1999.). Characteristics of specific forms of bacterial meningitis are detailed in the subsections that follow.
...
With the emergence of drug-resistant strains of *S. pneumoniae*, pneumococcal meningitis is typically treated with broad-spectrum antibiotics, such as levofloxacin, cefotaxime, penicillin, or other β-lactam antibiotics. The two available pneumococcal vaccines are described in [Bacterial Infections of the Respiratory Tract](/life-health-sciences/microbiology/22-respiratory-system-infections/02-bacterial-infections-of-the-respiratory-tract/).

{{< mediafigure src="microbiology/OSC_Microbio_26_02_Pneumococc" kind="photo" alt="(a) A fluorescence micrograph of bright green paired cocci scattered on a black background, with a 2-micrometer scale bar. (b) A photo of a dark red blood agar plate with a raised, moist, dark colony bordered by a lighter zone of clearing." >}}
...
Meningitis caused by *H. influenzae* is usually treated with doxycycline, fluoroquinolones, second- and third-generation cephalosporins, and carbapenems. The best means of preventing *H. influenzae* infection is with the use of the Hib polysaccharide conjugate vaccine. It is recommended that all children receive this vaccine at 2, 4, and 6 months of age, with a final booster dose at 12 to 15 months of age (US Centers for Disease Control and Prevention. "Meningococcal Disease, Disease Trends." 2015.).
...
Neonatal infection occurs as either early onset or late-onset disease. Early onset disease is defined as occurring in infants up to 7 days old. The infant initially becomes infected by *S. agalactiae* during childbirth, when the bacteria may be transferred from the vagina during birth. Incidence of early onset neonatal meningitis can be greatly reduced by giving intravenous antibiotics to a person giving birth.

Late-onset neonatal meningitis occurs in infants between 1 week and 3 months of age. Infants born to people with *S. agalactiae* in the urogenital tract have a higher risk of late-onset meningitis, but late-onset infections can be transmitted from several sources; often, the source of infection is unknown. Infants who are born prematurely (before 37 weeks of pregnancy) or to people who develop a fever also have a greater risk of contracting late-onset neonatal meningitis.
...
{{< selfcheck question="Which groups are most vulnerable to each of the bacterial meningitis diseases?" hint="Each of the four organism subsections above names its own typically affected age group — check each one in turn rather than only the last." >}}
Each organism has its own vulnerable group. *H. influenzae* meningitis primarily affects children 2 months through 5 years of age, before immunity develops by age five. *N. meningitidis* meningitis can infect people of any age, but its prevalence is highest among infants, adolescents, and young adults. *S. pneumoniae* has become the leading cause of meningitis in humans aged 2 months through adulthood. *S. agalactiae* (neonatal meningitis) mainly affects babies up to 3 months of age, in either an early-onset (up to 7 days old) or late-onset (1 week to 3 months) form.
===CHECKS===
H. influenzae meningitis primarily affects children 2 months through 5 years of age
N. meningitidis meningitis is most prevalent among infants, adolescents, and young adults
S. pneumoniae is the leading cause of meningitis in humans aged 2 months through adulthood
S. agalactiae (neonatal meningitis) mainly affects babies up to 3 months of age
{{< /selfcheck >}}

{{< selfcheck question="For which of the bacterial meningitis diseases are there vaccines presently available?" hint="See the treatment and prevention paragraphs of each of the four meningitis subsections above." >}}
Vaccines are described for three of the four: a serogroup A meningococcal conjugate vaccine (and a serogroup B meningococcal vaccine) for meningococcal meningitis, the Hib polysaccharide conjugate vaccine for *H. influenzae* type b meningitis, and two pneumococcal vaccines (described in the section on respiratory tract infections) for pneumococcal meningitis. This section does not describe a vaccine for neonatal meningitis caused by *S. agalactiae*.
===CHECKS===
a meningococcal conjugate vaccine for meningococcal meningitis
the Hib polysaccharide conjugate vaccine for H. influenzae type b meningitis
two pneumococcal vaccines for pneumococcal meningitis
no vaccine is described for neonatal meningitis caused by S. agalactiae
{{< /selfcheck >}}

{{< selfcheck question="Which organism can cause epidemic meningitis?" hint="See the second paragraph of the Meningococcal Meningitis subsection." >}}
*N. meningitidis* causes meningococcal meningitis, which was once the most common cause of meningitis epidemics in human populations. This is still the case in a swath of sub-Saharan Africa known as the meningitis belt, and outbreaks can still occur in communities, schools, colleges, prisons, and other populations where people are in close direct contact.
===CHECKS===
N. meningitidis causes meningococcal meningitis
once the most common cause of meningitis epidemics in human populations
still the case in a swath of sub-Saharan Africa known as the meningitis belt
{{< /selfcheck >}}
...
Intoxications occur when BoNT is produced outside the body and then introduced directly into the body through food (foodborne botulism), air (inhalation botulism), or a clinical procedure (iatrogenic botulism). Foodborne botulism, the most common of these forms, occurs when BoNT is produced in contaminated food and then ingested along with the food (recall [Case in Point: A Streak of Bad Potluck](/life-health-sciences/microbiology/13-control-of-microbial-growth/02-using-physical-methods-to-control-microorganisms/)). Inhalation botulism is rare because BoNT is unstable as an aerosol and does not occur in nature; however, it can be produced in the laboratory and was used (unsuccessfully) as a bioweapon by terrorists in Japan in the 1990s. A few cases of accidental inhalation botulism have also occurred. Iatrogenic botulism is also rare; it is associated with injections of BoNT used for cosmetic purposes (see the Micro Connections box on medicinal uses of botulinum toxin, below).
...
{{< selfcheck question="Why is botulism not treated with an antibiotic?" hint="See the Botulism subsection's opening sentence and its treatment paragraph." >}}
This section does not state directly why botulism is not treated with an antibiotic. It states that botulism is an illness caused by intoxication by BoNT, and that botulism is treated with an antitoxin specific for BoNT: if administered in time, the antitoxin stops the progression of paralysis, but it does not reverse it, and the patient must then slowly regain neurological function over weeks or months while hospitalized and supported on a ventilator.
===CHECKS===
botulism is an illness caused by intoxication by BoNT
botulism is treated with an antitoxin specific for BoNT
the antitoxin stops the progression of paralysis but does not reverse it
{{< /selfcheck >}}

{{< callout type="info" >}}
**Micro Connection.** *Medicinal Uses of Botulinum Toxin*
...
{{< mediafigure src="microbiology/OSC_Microbio_26_02_Listeria" kind="diagram" alt="(a) An electron micrograph of a single rod-shaped bacterial cell stained purple, with a 0.5-micrometer scale bar. (b) A seven-step diagram of the bacterium invading and moving between two adjacent host cells, from entering the first cell to spreading into the next." longdesc="(b) Step 1: L. monocytogenes enters a host cell inside a phagosome. Step 2: the pathogen escapes into the cytoplasm when the phagosome is lysed. Step 3: the pathogen reproduces, forming several rods. Step 4: the pathogen interacts with actin from the host cytoskeleton to grow a tail of actin filaments. Step 5: the actin tail pushes the pathogen through a finger-like protrusion of the host cell membrane into a neighboring cell. Step 6: the neighboring cell engulfs the protrusion, forming a new vesicle around the pathogen. Step 7: the cycle repeats as the pathogen escapes that vesicle." >}}
...
Internalins enable it to breach barriers including the blood-brain barrier.
Cold enrichment at 4 °C allows it to be recovered from CSF samples.
{{< /multiplechoice >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_26_02_Leprosy" kind="photo" alt="(a) A photo of the tip of a person's nose showing thickened, discolored, nodular skin around the nostril. (b) A micrograph of blue-stained tissue cells with small reddish-purple rod-shaped bacteria scattered among them, labeled M. leprae, with a 10-micrometer scale bar." >}}
...
{{< textin
  question="What prevents the progression from tuberculoid to lepromatous leprosy?"
  answer="cell-mediated cytotoxicity"
  accept="effective immune response|immune response"
  hint="The module states what holds the bacteria in check in tuberculoid lesions in the same sentence that says these lesions can persist for years or decades."
>}}
...
{{< callout type="info" >}}
**Disease Profile.** *Bacterial Infections of the Nervous System*

Despite the formidable defenses protecting the nervous system, a number of bacterial pathogens are known to cause serious infections of the CNS or PNS. Unfortunately, these infections are often serious and life threatening. The table below summarizes some important infections of the nervous system.
...
| Hansen's disease (leprosy) | *Mycobacterium leprae* | Hypopigmented skin, skin lesions, and nodules, loss of peripheral nerve function, loss of fingers, toes, and extremities | Inhalation, possibly transmissible from armadillos to humans | Dapsone, rifampin, clofazimine | None |
...
| Listeriosis | *Listeria monocytogenes* | Initial flu-like symptoms, sepsis and potentially fatal meningitis in susceptible individuals, miscarriage in pregnant people | Bacterium ingested with contaminated food or water | Ampicillin, gentamicin | None |
...
- **Hansen's disease** (**leprosy**) is caused by the intracellular parasite *Mycobacterium leprae*. Infections cause demyelination of neurons, resulting in decreased sensation in peripheral appendages and body sites. Treatment is with multi-drug antibiotic therapy, and there is no universally recognized vaccine.
...
- **neonatal meningitis** — meningitis caused by Group B streptococcus and occurring primarily in neonates (less than 2 months old). *(Source note: this section's own body defines neonatal meningitis as meningitis occurring in babies up to 3 months of age.)*
...
- **Botulism** — form of flaccid paralysis caused by the ingestion of a neurotoxin produced by *Clostridium botulinum*.
...
{{< textin
  ...
  hint="See the second paragraph of the Meningococcal Meningitis subsection."
>}}
...
{{< multiplechoice
  question="Which of the following organisms causes epidemic meningitis cases at college campuses?"
  answer="Neisseria meningitidis"
  hint="See the Micro Connection box on meningitis outbreaks at colleges."
>}}
Haemophilus influenzae type b
...
{{< multiplechoice
  question="Which of the following is the most common cause of neonatal meningitis?"
  answer="Streptococcus agalactiae"
  hint="See the opening sentence of the Neonatal Meningitis subsection."
>}}
...
{{< mediafigure src="microbiology/OSC_Microbio_26_02_ArtConnect_img" kind="photo" alt="A close-up photo of skin beside a person's closed eye, showing a smooth, pale, rounded patch much lighter than the darker surrounding skin." >}}
A skin lesion suspected of being tuberculoid leprosy. (credit: Centers for Disease Control and Prevention)
{{< /mediafigure >}}

{{< textin
  question="A physician suspects the lesion and pustule pictured here are indicative of tuberculoid leprosy. If the diagnosis is correct, what microorganism would be found in a skin biopsy?"
  answer="Mycobacterium leprae"
  accept="M. leprae"
  hint="One sentence early in the Hansen's Disease section names the exact bacterium that causes this disease."
>}}

### Compare the major characteristics of specific bacterial diseases affecting the nervous system

{{< textin
  question="Botulism prevents the release of the neurotransmitter ________."
  answer="acetylcholine"
  hint="See the Botulism subsection's paragraph on what happens once BoNT enters the bloodstream."
>}}
...
{{< textin
  ...
  answer="opisthotonos"
  accept="opisthotonus"
  hint="See the Tetanus subsection's paragraph on generalized tetanus."
>}}

{{< multiplechoice
  question="What sign/symptom would NOT be associated with infant botulism?"
  answer="stiff neck"
  hint="This section's own infant-botulism sentence lists that condition's own signs directly — check which of these four print there and which does not."
>}}
difficulty suckling
limp body
stiff neck
...
{{< multiplechoice
  question="Which of the following can NOT be prevented with a vaccine?"
  answer="listeriosis"
  hint="See the prevention sentences near the end of each disease's subsection, or the Disease Profile table's Vaccine column."
>}}
tetanus
pneumococcal meningitis
meningococcal meningitis
...
{{< multiplechoice
  ...
  hint="See the opening paragraphs of Clostridium-Associated Diseases, on the genus's two neurotoxins."
>}}

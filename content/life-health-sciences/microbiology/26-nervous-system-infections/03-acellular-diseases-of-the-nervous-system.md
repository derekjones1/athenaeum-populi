...
description: >-
  Arboviral encephalitis, Zika virus, rabies, poliomyelitis, and prion
  diseases such as Creutzfeldt-Jakob disease, with the barn-worker Clinical
  Focus case's Part 2 — adapted from OpenStax Microbiology, Section 26.3.
source_section: "26.3"
weight: 3
---
...
that far exceeds the numbers described for the others
{{< /selfcheck >}}
...
*Go back to the previous [Clinical Focus](/life-health-sciences/microbiology/26-nervous-system-infections/01-anatomy-of-the-nervous-system/) box (Anatomy of the Nervous System, Part 1). The case continues in [Fungal and Parasitic Diseases of the Nervous System](/life-health-sciences/microbiology/26-nervous-system-infections/04-fungal-and-parasitic-diseases-of-the-nervous-system/).*
{{< /callout >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_26_03_Zika" kind="diagram" alt="(a) An electron micrograph showing numerous small reddish-orange spheres scattered across a mottled purple, web-like cellular background, with a 100 nm scale bar. (b) Two side-by-side profile drawings of infant heads: at left, an infant with microcephaly, its head visibly smaller than a dashed outline showing typical size; at right, a normal infant with a larger, rounded head." >}}
...
{{< multiplechoice
  question="What are the signs and symptoms of Zika virus infection in adults?"
  answer="Fever, a slight rash, or conjunctivitis"
  hint="The second paragraph of this section opens with the general symptom list — read it before the sentence about pregnancy."
>}}
Hydrophobia, excessive salivation, and progressive paralysis
Asymptomatic in nearly all cases, with occasional mild nausea
Fever, a slight rash, or conjunctivitis
...
infections in pregnant people can adversely affect the developing fetus
fetal infections can result in brain damage, including the birth defect microcephaly
{{< /selfcheck >}}
...
{{< multiplechoice
  ...
  hint="The section names the exact route the virus takes through nerves, not the bloodstream — compare it with how poliovirus reaches the CNS."
>}}
...
To treat wild animals that are already infected with rabies virus.
...
works because rabies progresses slowly, giving the immune system time to respond
human rabies immune globulin provides passive immunity by neutralizing free viral particles
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_26_03_IronLung" kind="photo" alt="(a) A black-and-white photograph of a nurse adjusting a dial on the side of a large box-like machine; a patient's head protrudes from one end while the rest of their body lies enclosed inside. (b) A black-and-white photograph of two young children wearing leg braces, walking between parallel support bars while two nurses assist them, with a wall mirror reflecting the scene." >}}
...
{{< multiplechoice
  question="How is poliovirus transmitted?"
  answer="By the fecal-oral route or by aerosol or droplet transmission."
  hint="Named in the section's second sentence, right after 'highly contagious.'"
>}}
By the bite of an infected mosquito, the way arboviral encephalitis spreads.
By the fecal-oral route or by aerosol or droplet transmission.
By the bite of an infected mammal, the way rabies spreads.
Sexually, or via a blood transfusion, the way Zika virus can spread.
{{< /multiplechoice >}}

{{< sortbins question="Compare the pros and cons of each of the two polio vaccines." hint="Re-read the two paragraphs naming the Salk and Sabin vaccines — each fact below comes from one of them." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_26_03_Prioncycle" kind="diagram" alt="A looping flow diagram of green circles and red spiked shapes. Green circles labeled endogenous PrPC lead to a shape labeled interaction between PrPC and PrPSc. A boxed list names three ways PrPSc can arise: spontaneous generation, conversion of mutant PrP, or inoculation. Arrows continue through conversion of PrP into PrPSc to a larger cluster labeled accumulation of PrPSc, completing the cycle." longdesc="The diagram reads as a loop. At upper left, a cluster of green circles is labeled endogenous PrPC. An arrow leads right to where a single green circle sits beside a red spiked shape, labeled interaction between PrPC and PrPSc. A separate boxed list at the left names three routes by which PrPSc can arise — spontaneous generation of PrPSc, conversion of mutant PrP into PrPSc, and inoculation of PrPSc — with an arrow from this box leading to a red spiked shape below the interaction step. From the interaction step, an arrow curves down and to the left to a pair of red spiked shapes labeled conversion of PrP into PrPSc; from there one arrow leads up and left back to the single PrPSc, completing the cycle, and another leads down to a larger scatter of red spiked shapes labeled accumulation of PrPSc." >}}
...
Because prion-contaminated materials are potential sources of infection for clinical scientists and physicians, both a prion-safety publication from the World Health Organization and the [CDC](https://www.openstax.org/l/22CDCprion) provide information to inform, educate and minimize the risk of infections due to prions.
{{< /callout >}}

**Check Your Understanding**

{{< multiplechoice
  question="Do prions reproduce in the conventional sense?"
  answer="No — prions are infectious proteins that contain no nucleic acid, so they cannot replicate the way a virus or a cell does."
  hint="Focus on what prions are made of — and what they're missing that a virus or cell needs in order to replicate."
>}}
Yes — they replicate using their own DNA genome, the way a bacterium does.
Yes — they replicate using an RNA genome that is reverse-transcribed, the way a retrovirus does.
No — prions are infectious proteins that contain no nucleic acid, so they cannot replicate the way a virus or a cell does.
...
prions are typically transmitted through infected nervous system tissue, transplants, transfusions, or contaminated fomites
{{< /selfcheck >}}

{{< callout type="info" >}}
**Disease Profile.** *Acellular Infections of the Nervous System*
...
| Viral meningitis | HSV-1, HSV-2, varicella zoster virus, mumps virus, influenza virus, measles virus | Nausea, vomiting, photophobia, stiff neck, confusion, symptoms generally resolve within 7–10 days | Sequela of primary viral infection | Testing of oral, fecal, blood, or CSF samples | Varies depending on cause | Varies depending on cause |
| Zika virus infection | Zika virus | Fever, rash, conjunctivitis; in pregnant people, can cause fetal brain damage and microcephaly | Between humans by *Aedes* spp. mosquito vectors, also may be transmitted sexually or via blood transfusion | Zika virus RNA assay, Trioplex RT-PCR, Zika MAC-ELISA test | None | None |
{{< /callout >}}
...
{{< multiplechoice
  question="The rogue form of the prion protein is called ________."
  answer="PrPSc"
  hint="Named in the paragraph that first contrasts the normal and misfolded prion protein forms, right before the alpha-helix/beta-sheet comparison."
>}}
PrPC
14-3-3 protein
amyloid plaques
...
{{< textin
  ...
  hint="The prion disease named for the animals it affects, distinct from scrapie or mad cow disease."
>}}
...
{{< textin
  ...
  hint="The rogue prion's own folding pattern, contrasted with the normal form's mostly alpha-helix shape."
>}}
...
{{< multiplechoice
  question="Which of these is true of the Sabin but NOT the Salk polio vaccine?"
  answer="mimics the normal route of infection"
  hint="One vaccine is oral and mimics how the natural infection is acquired; the other is an injection."
>}}

...
{{< textin question="What is the name of the protein that assembles into a Z ring to initiate cytokinesis and cell division?" answer="FtsZ" hint="Name the protein that assembles into the Z ring, given a few sentences after binary fission is introduced." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_09_01_generation" alt="A table and branching diagram of exponential growth by binary fission: the table pairs generation numbers 0 through 3 with cell numbers 1, 2, 4, and 8; the diagram shows one cell branching into two, each of those into two more, and each of those into two more." longdesc="The table lists generation 0 with 1 cell, generation 1 with 2 cells, generation 2 with 4 cells, and generation 3 with 8 cells. The tree diagram beside it shows a single cell at the top with two arrows branching down to two cells (generation 1); each of those two cells has two arrows branching down to a total of four cells (generation 2); each of those four cells has two arrows branching down to a total of eight cells (generation 3)." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_09_01_chemostat" alt="A diagram of a chemostat: a covered vat of fluid with a central vertical shaft ending in a two-bladed impeller near the bottom, a curved arrow above the impeller showing it rotating, small bubbles near the impeller, a feed line entering the top on one side, and an effluent line leaving the top on the other side." longdesc="An arrow labeled feed enters the top left of the vat and points down into the fluid; an arrow labeled effluent leaves the top right of the vat pointing away. A vertical shaft runs down the center of the vat to a two-bladed impeller near the bottom, with a curved arrow above it indicating rotation, and small bubbles are drawn near the impeller." kind="diagram" >}}
...
{{< textin question="During which phase does growth occur at the fastest rate?" answer="log phase" accept="logarithmic phase|logarithmic growth phase|log growth phase|exponential growth phase" hint="Recall which phase is defined by exponential increase in cell number." >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_09_01_hemcy" alt="(a) A gloved hand holds a thick glass slide etched with a fine grid across its center. (b) A diagram of the grid: a magnified circle shows a bold-outlined square subdivided by fine lines into a 4×4 array of smaller squares, with red oval cells scattered inside and around it." longdesc="Panel (b)'s magnified circle shows the bold-outlined square used for counting, subdivided by fine gridlines into a 4×4 array of smaller squares. Ten red oval cells lie inside the bold square's border; four more cells are visible just outside it, in the neighboring squares shown for context, and are not part of the count." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_09_01_coulter" alt="(a) A diagram of a Coulter counter: a beaker of fluid holds a U-shaped glass tube with a small aperture high on its inner wall, just below the electrode leads; green dots representing cells are drawn moving from the beaker through the aperture into the tube, past a purple region marking the aperture, and up to electrode leads marked − and +, wired to an electronic counter box. (b) A photograph of a small glass Coulter counter aperture tube standing in a beaker." longdesc="In panel (a), the outer beaker holds the cell suspension, shown as scattered green dots. A U-shaped tube dips into the beaker and rises back out; a small aperture high on the tube's inner leg, just below the electrode leads, is marked by a purple circle. Curved arrows show cells being drawn from the beaker, through the aperture, and up into the tube. A lead marked − sits inside the tube above the aperture and a lead marked + sits in the outer beaker; both wires run to an electronic counter box with a numeric display and control buttons." kind="diagram" >}}
...
{{< multiplechoice
  ...
  hint="Recall what the module says must be done with counts from several squares before they yield a reliable measurement."
>}}
...
{{< mediafigure src="microbiology/OSC_Microbio_09_01_pourplate" alt="A four-step diagram of the pour plate method: mixing a bacterial sample with warm agar; pouring the sample onto a sterile plate; swirling the plate and letting it solidify; incubating the plate until colonies appear." longdesc="Step 1: a bacterial sample from a test tube is mixed with warm agar (45–50 °C). Step 2: the mixed sample is poured into an empty sterile Petri dish. Step 3: the dish is swirled to mix and left to solidify. Step 4: the solidified plate is incubated, shown with scattered round colonies growing across its surface." kind="diagram" >}}
...
{{< multiplechoice
  ...
  hint="Recall why the plate-count results are expressed as colony-forming units per milliliter rather than cells per milliliter."
>}}
...
{{< multiplechoice
  ...
  hint="Recall what the calibration curve plots and what it is then used to do for samples of similar conditions and density range."
>}}
...
{{< mediafigure src="microbiology/OSC_Microbio_09_05_filmdiag" alt="A five-stage diagram of biofilm formation on a surface, from a few scattered flagellated cells through small clusters, larger clusters, very large clusters with holes, to a large mature colony releasing free-swimming cells." longdesc="Stage 1, reversible attachment (seconds): a few flagellated cells sit loosely on the surface. Stage 2, irreversible attachment (seconds to minutes): small clusters of cells are attached to the surface. Stage 3, growth and cell division (hours, days): larger clusters cover more of the surface. Stage 4, production of EPS and formation of water channels (hours, days): very large mushroom-shaped clusters with visible internal openings. Stage 5, attachment of secondary colonizers and dispersion of microbes to new sites (days, months): from the large mature cluster, small flagellated cells are shown detaching and swimming away." kind="diagram" >}}
...
{{< textin question="What is the matrix of a biofilm composed of?" answer="extracellular polymeric substances" accept="EPS|extracellular polymeric substance" hint="Name the hydrated-gel substance secreted by the biofilm's organisms whose channels keep the biofilm hydrated and that shelters its cells from predation." >}}
...
{{< multiplechoice
  ...
  hint="Recall the sentence that defines quorum sensing itself, distinct from attachment, EPS's protective role, or gene exchange."
>}}
...
{{< multiplechoice
  ...
  hint="Recall the term the module uses interchangeably with generation time, and what that term is defined as."
>}}
...
{{< multiplechoice
  ...
  hint="Recall what the cell-division protein assembles into, a few sentences after binary fission is introduced, and what that structure is anchored to and pinches."
>}}
...
{{< multiplechoice
  ...
  answer="death phase"
  hint="Recall which phase the module names for the onset of sporulation, as nutrients are exhausted and toxic waste accumulates."
>}}
death phase
lag phase
log phase
...
{{< multiplechoice
  ...
  answer="Lag phase"
  hint="Recall which phase involves cells gearing up metabolically, synthesizing proteins needed to grow in the new medium, before cell numbers change."
>}}
Lag phase
Log phase
Stationary phase
...
{{< multiplechoice
  ...
  answer="Log phase"
  hint="Recall which phase is defined by cells actively dividing and increasing exponentially."
>}}
Lag phase
Log phase
Stationary phase
...
{{< multiplechoice
  ...
  hint="Recall which method gives a count of colony-forming units from a solid sample, rather than depending on a liquid suspension's turbidity or a calibrated slide."
>}}
...
{{< multiplechoice
  ...
  hint="Recall the two calibrated-slide devices named for counting cells directly under a light microscope, one of them used for red blood cells."
>}}
...
{{< textin question="The ________ method allows direct count of total cells growing on solid medium." answer="plate count" hint="Name the method that counts colonies formed on solid medium, distinct from the calibrated-slide or electronic counting methods." >}}

{{< textin question="A statistical estimate of the number of live cells in a liquid is usually done by ________." answer="most probable number" accept="MPN" hint="Name the statistical procedure used for dilute water and food samples that evaluates growth by turbidity or color change across a series of tubes." >}}
...
{{< multiplechoice
  ...
  hint="Recall the two products of cell metabolism the module names as newer, fast, indirect ways of measuring live cells, alongside protein and nucleic acid biosynthesis and oxygen consumption."
>}}
...
{{< multiplechoice
  ...
  hint="Recall the process in which new cells split from the parent filament and float away, common in cyanobacteria and Actinomycetes."
>}}
budding
mitosis
fragmentation
...
{{< multiplechoice
  ...
  answer="budding"
  hint="Recall the process most common in yeast that is described in contrast with fragmentation."
>}}
fragmentation
binary fission
...
{{< textin question="In *Actinomyces*, elongated cells within ________ divide simultaneously to form spores that give rise to new colonies." answer="aerial filaments" accept="aerial filament" hint="Name the structures Actinomyces forms in response to environmental signals, probably related to low nutrient availability." >}}
...
{{< textin question="EPS is a hydrated gel composed primarily of ________." answer="polysaccharides" accept="polysaccharide" hint="Name the primary macromolecule class of the extracellular matrix, alongside the proteins, nucleic acids, and lipids it also contains." >}}
...
{{< multiplechoice
  ...
  hint="Recall which layer of a biofilm the module describes as metabolically inactive, and why that would make antibiotics that disrupt metabolic activities less effective."
>}}
...
{{< multiplechoice
  ...
  hint="Recall that autoinducers act by binding a specific receptor, which then triggers a signaling cascade — they do not act on DNA directly."
>}}
...
{{< multiplechoice
  ...
  hint="Recall the two adjectives the module uses together to describe autoinducers when quorum sensing is first defined."
>}}

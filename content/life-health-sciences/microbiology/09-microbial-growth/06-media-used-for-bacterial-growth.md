...
description: >-
  How microbiologists classify culture media by chemical composition and
  function — all-purpose, enriched, chemically defined, complex, selective,
  differential, and enrichment media — illustrated by a MacConkey agar plate
  and a food-poisoning case that uses these distinctions to identify a
  toxin-producing organism — adapted from OpenStax Microbiology, Section 9.6.
source_section: "9.6"
weight: 6
---
...
{{< mediafigure src="microbiology/OSC_Microbio_09_05_MacMsa" alt="A light brown agar plate. Two streaks on the plate are bright pink and two streaks are beige." kind="photo" eager="true" >}}
...
{"bins": ["Chemically defined", "Complex"],
 "items": [
  ...
  {"label": "Contains extracts and digests of yeasts, meat, or plants", "bin": 1},
  {"label": "All individual chemical components are identified and the exact amount of each is known, as in EZ medium", "bin": 0},
  {"label": "The precise chemical composition of the medium is not known", "bin": 1},
  {"label": "Amounts of individual components are undetermined and variable", "bin": 1},
...
{"bins": ["Selective media", "Enrichment culture"],
 "items": [
  ...
  {"label": "Fosters the preferential growth of a desired microorganism that represents only a fraction of the organisms present in an inoculum", "bin": 1},
  {"label": "Contains bile salts and crystal violet that interfere with the growth of many gram-positive bacteria", "bin": 0},
  {"label": "Favors the growth of gram-negative bacteria, particularly the Enterobacteriaceae", "bin": 0},
  {"label": "Uses sequential subculturing in a medium that supplies carbon only as crude oil, to favor oil-eating bacteria", "bin": 1}]}
{{< /sortbins >}}

{{< callout type="info" >}}
**Link to Learning**

Compare the composition of [EZ medium](https://openstax.org/l/22EZMedium) with that of sheep blood agar, described in the American Society for Microbiology's blood agar protocol (asm.org).
{{< /callout >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_09_05_saureus" alt="A micrograph of clusters of purple spheres." kind="photo" >}}

...
description: >-
  How salinity, atmospheric pressure, water availability, and light shape
  microbial growth, from halophiles and barophiles to the accessory pigments
  that power phototrophic bacteria — adapted from OpenStax Microbiology,
  Section 9.5.
source_section: "9.5"
weight: 5
---
...
{{< mediafigure src="microbiology/OSC_Microbio_09_05_saltlake" alt="A satellite photo of a lake split by a straight causeway into a teal-green western half and a deep purple eastern half, both rimmed by white salt flats and tan and brown land." kind="photo" eager="true" >}}
...
Microorganisms depend on available water to grow. Available moisture is measured as water activity (a<sub>w</sub>), which is the ratio of the vapor pressure of the medium of interest to the vapor pressure of pure distilled water; therefore, the a<sub>w</sub> of water is equal to 1.0. Bacteria require high a<sub>w</sub> (0.97–0.99), whereas fungi can tolerate drier environments; for example, the range of a<sub>w</sub> for growth of *Aspergillus* spp. is 0.8–0.75. Decreasing the water content of foods by drying, as in jerky, or through freeze-drying or by increasing osmotic pressure, as in brine and jams, are common methods of preventing spoilage.
...
bacteriorhodopsin ... used by the archaea of the class Halobacteria
...
halotolerant organisms grow in the presence of high salt without requiring it
halotolerant pathogens survive and multiply in salty food
most likely a halophile or a halotolerant organism
{{< /selfcheck >}}

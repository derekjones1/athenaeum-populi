...
description: >-
  How pH affects the structure of proteins, DNA, and lipids and the energy
  production that depends on the H⁺ gradient, and the three pH-adaptive
  categories of microbes — acidophiles, neutrophiles, and alkaliphiles — with
  examples of the organisms and environments for each — adapted from OpenStax
  Microbiology, Section 9.3.
source_section: "9.3"
weight: 3
---
...
Yogurt, pickles, sauerkraut, and lime-seasoned dishes all owe their tangy taste to a high acid content (see the photos below). Recall that acidity is a function of the concentration of hydrogen ions [H⁺] and is measured as pH. Environments with pH values below 7.0 are considered acidic, whereas those with pH values above 7.0 are considered basic. Extreme pH affects the structure of all macromolecules. The hydrogen bonds holding together strands of DNA break up at high pH. Lipids are hydrolyzed by an extremely basic pH. The proton motive force responsible for production of ATP in cellular respiration depends on the concentration gradient of H⁺ across the plasma membrane (see [Cellular Respiration](/life-health-sciences/microbiology/08-microbial-metabolism/03-cellular-respiration/)). If H⁺ ions are neutralized by hydroxide ions, the concentration gradient collapses and impairs energy production. But the component most sensitive to pH in the cell is its workhorse, the protein. Moderate changes in pH modify the ionization of amino-acid functional groups and disrupt hydrogen bonding, which, in turn, promotes changes in the folding of the molecule, promoting denaturation and destroying activity.

{{< mediafigure src="microbiology/OSC_Microbio_09_03_yogurt" alt="Four food photos in a row: a bowl of yogurt topped with strawberry halves; open mason jars of pickled cucumbers; two store jars labeled Red Cabbage with Apples and German Style Sauerkraut; and a plate of pico de gallo salsa topped with a lime wedge." kind="photo" eager="true" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_09_03_pH" alt="A line graph with pH from 0 to 12 on the x-axis and growth rate (no numeric scale) on the y-axis. Three separate bell-shaped curves are plotted, none overlapping in height at their peaks: a blue curve labeled acidophile rises from pH 1, peaks around pH 3–4, and falls back to zero by about pH 5.5; a green curve labeled neutrophile rises from about pH 5.5, peaks at pH 7, and falls back to zero by about pH 8.5; and a red curve labeled alkaliphile rises from about pH 7.5, peaks around pH 9–10, and falls back to zero by about pH 11.5." longdesc="The x-axis is labeled pH and is marked in single units from 0 to 12; the y-axis is labeled growth rate and carries no numeric scale, only an upward arrow. Three triangular, bell-like curves are drawn left to right. The leftmost curve, labeled acidophile, starts at zero at pH 1, rises in a straight line to a rounded peak between pH 3 and 4, and descends in a straight line back to zero at about pH 5.5. The middle curve, labeled neutrophile, starts at zero at about pH 5.5, rises to a rounded peak at pH 7, and descends back to zero at about pH 8.5; its rising edge meets the acidophile curve's falling edge at a single point on the baseline, pH 5.5 at a growth rate of zero, and the two curves do not otherwise overlap. The rightmost curve, labeled alkaliphile, starts at zero at about pH 7.5, rises to a rounded peak between pH 9 and 10, and descends back to zero at about pH 11.5, its rising edge crossing the neutrophile curve's falling edge between pH 7.5 and 8.5." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_09_03_natronL" alt="An aerial photo of a lake with patches of deep red water, pale mineral crusts and white ring-shaped salt deposits scattered across the water's surface and along the shoreline, and green vegetation visible at one edge." kind="photo" >}}
...
{{< selfcheck question="What effect do extremes of pH have on proteins?" hint="Combine the opening paragraph's sentence naming the cell's most pH-sensitive macromolecule with its following sentence describing exactly what changes in pH do to that molecule's ionization, bonding, folding, and activity." >}}
Proteins are the component of the cell most sensitive to pH. Moderate changes in pH modify the ionization of amino-acid functional groups and disrupt hydrogen bonding, which, in turn, promotes changes in the folding of the molecule, promoting denaturation and destroying activity.
===CHECKS===
Proteins are the component of the cell most sensitive to pH
modify the ionization of amino-acid functional groups
disrupt hydrogen bonding
promotes changes in the folding of the molecule
promoting denaturation and destroying activity
{{< /selfcheck >}}

{{< selfcheck question="What pH-adaptive type of bacteria would most human pathogens be?" hint="Combine the sentence naming most familiar bacteria as neutrophiles with the Micro Connection's explanation of how a pathogen that survives stomach acid, Helicobacter pylori, is still a neutrophile underneath." >}}
Most familiar bacteria, including common pathogens like *Escherichia coli* and *Salmonella* spp., are neutrophiles, growing optimally at a pH within one or two pH units of the neutral pH of 7. Even *Helicobacter pylori*, which survives the low pH of the stomach, is a neutrophile — it creates a nearly neutral microenvironment for itself by producing the enzyme urease, which breaks down urea to form ammonium ions that raise the pH of its immediate surroundings.
===CHECKS===
Most familiar bacteria ... are neutrophiles, growing optimally at a pH within one or two pH units of the neutral pH of 7
Helicobacter pylori, which survives the low pH of the stomach, is a neutrophile
creates a nearly neutral microenvironment for itself by producing the enzyme urease
breaks down urea to form ammonium ions that raise the pH of its immediate surroundings
{{< /selfcheck >}}
...
{{< textin
  question="Which macromolecule in the cell is most sensitive to changes in pH?"
  answer="protein"
  hint="Recall the cell's 'workhorse' macromolecule named right after the paragraph's discussion of how extreme pH affects DNA and lipids."
>}}

{{< selfcheck question="Which metabolic process in the bacterial cell is particularly challenging at high pH?" hint="Combine the sentence naming the process the proton motive force powers with the sentence on what happens to the H⁺ gradient when hydroxide ions neutralize H⁺ — and note that hydroxide ions become more abundant as pH rises." >}}
The proton motive force responsible for production of ATP in cellular respiration depends on the concentration gradient of H⁺ across the plasma membrane. At high pH, hydroxide ions are more abundant and neutralize that H⁺; if H⁺ ions are neutralized by hydroxide ions, the concentration gradient collapses and impairs energy production. Cellular respiration is therefore the process most challenged by high pH.
===CHECKS===
The proton motive force responsible for production of ATP in cellular respiration depends on the concentration gradient of H⁺ across the plasma membrane
At high pH, hydroxide ions are more abundant and neutralize that H⁺
the concentration gradient collapses and impairs energy production
Cellular respiration is therefore the process most challenged by high pH
{{< /selfcheck >}}

{{< textin
  question="The ________ is the most favorable pH for the growth of an organism."
  answer="optimum growth pH"
  hint="Name the defined term introduced in the same sentence that also names the minimum and maximum growth pH."
>}}

### Identify and describe the different categories of microbes with pH requirements for growth: acidophiles, neutrophiles, and alkaliphiles

{{< selfcheck question="People who use proton pump inhibitors or antacids are more prone to infections of the gastrointestinal tract. Can you explain the observation in light of what you have learned?" hint="Combine the sentence stating that most familiar bacteria are neutrophiles that do not fare well in stomach acid with what a drug that raises stomach pH would remove." >}}
Proton pump inhibitors and antacids raise the pH of the stomach, making it less acidic. Most familiar bacteria are neutrophiles and do not fare well in the acidic pH of the stomach, so when antacids or proton pump inhibitors reduce that acidity, neutrophile pathogens that would otherwise be killed or suppressed by stomach acid can survive and cause gastrointestinal infections.
===CHECKS===
raise the pH of the stomach, making it less acidic
Most familiar bacteria are neutrophiles and do not fare well in the acidic pH of the stomach
neutrophile pathogens that would otherwise be killed or suppressed by stomach acid can survive
{{< /selfcheck >}}

{{< textin
  question="A bacterium that thrives in a soda lake where the average pH is 10.5 can be classified as a(n) ________."
  answer="alkaliphile"
  hint="Recall the category of pH-adaptive microbe that grows best between pH 8.0 and 10.5 — a soda lake at pH 10.5 falls within that range."
>}}

{{< multiplechoice
  question="Bacteria that grow in mine drainage at pH 1–2 are probably which of the following?"
  answer="acidophiles"
  hint="Recall which pH-adaptive category grows optimally at pH values well below 5.55 — mine drainage this acidic matches it."
>}}
alkaliphiles
acidophiles
neutrophiles
...
{{< multiplechoice
  question="Bacteria isolated from Lake Natron, where the water pH is close to 10, are which of the following?"
  answer="alkaliphiles"
  hint="Recall which category's optimal range of 8.0–10.5 includes a soda lake's water pH near 10, and this section's own soda-lake example."
>}}
alkaliphiles
...
{{< multiplechoice
  question="In which environment are you most likely to encounter an acidophile?"
  answer="a hot vent at pH 1.5"
  hint="Recall the pH range in which acidophiles grow optimally (well below 5.55) and pick the only listed environment that falls within it."
>}}

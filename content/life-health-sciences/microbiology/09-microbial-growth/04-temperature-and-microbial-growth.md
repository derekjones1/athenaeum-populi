...
description: >-
  How minimum, optimum, and maximum growth temperature define the psychrophile,
  psychrotroph, mesophile, thermophile, and hyperthermophile categories, and
  the membrane, protein, and DNA adaptations that let microbes thrive from
  Antarctic lakes to hydrothermal vents — adapted from OpenStax Microbiology,
  Section 9.4.
source_section: "9.4"
weight: 4
---
...
The case began in [How Microbes Grow](/life-health-sciences/microbiology/09-microbial-growth/01-how-microbes-grow/).
{{< /callout >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_09_04_blacksmoke" alt="An underwater photo of a hydrothermal vent chimney billowing a dark, mineral-laden plume from its top, with clusters of red tubeworms and pale organisms encrusting the rock around its base and scientific sampling instruments positioned nearby." kind="photo" eager="true" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_09_04_tempcurve" alt="A line graph of bacterial growth rate against temperature in °C, showing four skewed bell-shaped curves in a row: psychrophiles peaking near 10 °C, mesophiles peaking near 37 °C, thermophiles peaking near 67 °C, and hyperthermophiles peaking near 93 °C, each curve rising gradually and falling sharply past its peak." longdesc="Four skewed bell-shaped curves are plotted left to right along the temperature axis, which is marked in 10 °C steps from −10 to 110. Each curve rises gently from a baseline of zero growth and falls steeply after its peak. The psychrophile curve rises from about −5 °C, peaks near 10 °C, and returns to zero by about 20 °C. The mesophile curve rises from about 15 °C, peaks near 37 °C, and returns to zero by about 45 °C. The thermophile curve rises from about 45 °C, peaks near 67 °C, and returns to zero by about 80 °C. The hyperthermophile curve rises from about 65 °C, peaks near 93 °C, and returns to zero by about 105 °C. Each successive curve's rising limb overlaps the falling limb of the curve before it. The thermophile curve reaches the highest peak of the four; the mesophile and hyperthermophile curves peak lower than the thermophile curve and about level with each other; the psychrophile curve peaks distinctly lower than all three." kind="diagram" >}}
...
Their DNA sequences show a higher proportion of guanine–cytosine bases, which are held together by three hydrogen bonds.
Additional secondary structures, ionic and covalent bonds, and the replacement of key amino acids to stabilize protein folding.
{{< /multiplechoice >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_09_04_algalbloom" alt="A satellite photo of Lake Erie's shoreline: patchwork brown and green farm fields occupy the upper portion of the image, and bright green swirling algal bloom patterns spread across a wide arc of the darker blue lake water below, with a scale bar and north arrow in the lower right." kind="photo" >}}
...
the samples retrieved from the lake showed abundant microbial life
psychrophiles ... are important decomposers in cold climates
{{< /selfcheck >}}

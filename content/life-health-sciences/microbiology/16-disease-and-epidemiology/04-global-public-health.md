...
{{< mediafigure src="microbiology/OSC_Microbio_16_04_SARS" alt="A map of China and neighboring regions with red arrows tracing the international spread of SARS from Guangdong Province, China, and the nearby Metropole Hotel in Hong Kong (195 cases, with no arrow of its own) to four other affected areas: Vietnam (58 cases), Singapore (71 cases), a shared label for Canada (29 cases) and the United States (1 case), and Ireland (1 case)." longdesc="An icon for the Metropole Hotel sits beside Guangdong Province as the outbreak's starting point, with the adjacent Hong Kong box (195 cases) simply naming the local cluster there — no arrow connects to it. A red arrow runs from the Guangdong Province label east to the hotel icon, and from the hotel four more red arrows (the legend at lower left defines a red arrow as 'Flow of SARS') fan out to four destinations: one points northwest to Ireland (1 case); one points northeast to a shared box for Canada (29 cases) and the United States (1 case); one points south to Vietnam (58 cases); and one points further south to Singapore (71 cases). Beneath the legend, a scale bar reads 0 to 800 kilometers and 0 to 800 miles." kind="diagram" >}}
...
{{< textin question="The ________ collects data and conducts epidemiologic studies at the global level." answer="WHO" accept="World Health Organization|World Health Organisation" hint="See the opening sentence of this section's first subsection." >}}
...
the section states that managing an epidemic at its source is far easier than fighting it on many fronts
a much faster crossing would be expected to make spread between Europe and the Americas easier, not harder
{{< /selfcheck >}}

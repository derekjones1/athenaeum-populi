...
description: >-
  How the World Health Organization, the CDC, and other agencies coordinate
  international disease monitoring and response, and how an emerging or
  reemerging infectious disease is identified — with the Ebola and SARS
  outbreaks as examples — adapted from OpenStax Microbiology, Section 16.4.
source_section: "16.4"
weight: 4
---
...
the CDC carries out international monitoring and public health efforts
the European Union's Health Security Committee monitors disease outbreaks and coordinates with WHO
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_16_04_SFTS" alt="Bar graph titled Known Human Cases of Ebola Virus Disease Worldwide, 1976–2015, with a broken case-count axis running from 0 to 30,000 against two-year periods. Cases: 604 in 1976–77; 34 in 1978–79; 0 in 1980–87, 1992–93, and 1998–99; 3 in 1988–89; 4 in 1990–91; 368 in 1994–95; 100 in 1996–97; 547 in 2000–01; 178 in 2002–03; 18 in 2004–05; 413 in 2006–07; 38 in 2008–09; 1 in 2010–11; 53 in 2012–13; and 28,718 in 2014–15." kind="diagram" eager="true" >}}
...
{{< callout type="info" >}}
**Micro Connection.** *SARS Outbreak and Identification*
...
{{< mediafigure src="microbiology/OSC_Microbio_16_04_SARS" alt="A map of China and neighboring regions with red arrows tracing the international spread of SARS from Guangdong Province, China, and the nearby Metropole Hotel in Hong Kong, to six affected areas: Hong Kong (195 cases), Vietnam (58 cases), Singapore (71 cases), a shared label for Canada (29 cases) and the United States (1 case), and Ireland (1 case)." longdesc="An icon for the Metropole Hotel sits beside Guangdong Province as the outbreak's starting point. From there, arrows labeled 'Flow of SARS' fan out: one points northwest to Ireland (1 case); one points northeast to a shared box for Canada (29 cases) and the United States (1 case); one points to the adjacent box for Hong Kong (195 cases); one points south to Vietnam (58 cases); and one points further south to Singapore (71 cases). A scale bar in the lower left reads 0 to 800 kilometers and 0 to 800 miles." kind="diagram" >}}
...
{{< textin question="The ________ collects data and conducts epidemiologic studies at the global level." answer="WHO" accept="World Health Organization" hint="This is the same United Nations agency introduced at the start of this section." >}}
...
Monitors disease outbreaks among the European Union's member countries
Funds three billion dollars of WHO's biennial budget through voluntary contributions
{{< /multiplechoice >}}

{{< selfcheck question="An Atlantic crossing by boat from England to New England took 60–80 days in the 18th century. In the late 19th century the voyage took less than a week. How do you think these time differences for travel might have impacted the spread of infectious diseases from Europe to the Americas, or vice versa?" hint="Think about how a voyage's length compares to how long a sick passenger stays contagious, then apply this section's own sentences about how fast transportation spreads an outbreak." >}}
This section does not discuss ocean-crossing times directly, but its own sentences support an inference: a 60–80 day 18th-century crossing was long enough that an infected passenger would likely recover, die, or no longer be contagious before reaching the other shore, limiting how many new outbreaks a slow crossing could seed abroad. A voyage of less than a week in the late 19th century was short enough that an infected, still-contagious passenger could arrive before the disease ran its course, and this section states that "the global nature of transportation means that an outbreak anywhere can spread quickly to every corner of the planet" and that "managing an epidemic in one location—its source—is far easier than fighting it on many fronts," so a much faster crossing would be expected to make transatlantic spread easier, not harder. Reasoning about specific travel times this way goes beyond what the section states directly, so it is offered here as an inference from those two sentences rather than a claim the section itself makes.
===CHECKS===
a 60–80 day crossing was long enough for an infected passenger to recover, die, or stop being contagious before arrival
a voyage of less than a week was short enough that an infected, still-contagious passenger could arrive before the disease ran its course
...
this reasoning about travel time is flagged as an inference beyond what the section states directly
{{< /selfcheck >}}
...
{{< multiplechoice
  ...
  answer="Tuberculosis"
  hint="Three of these four diseases are recent arrivals or recent surges; one has been a known human disease for a very long time."
>}}
...
{{< textin question="A disease that is increasing in frequency after a previous period of decline is called a ________." answer="reemerging infectious disease" accept="reemerging disease" hint="This is the term this section defines right after 'emerging infectious diseases.'" >}}

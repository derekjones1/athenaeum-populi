...
description: >-
  How epidemiologists measure disease in a population — prevalence versus
  incidence, sporadic, endemic, epidemic, and pandemic disease, Koch's
  postulates and their modern molecular form, and how the CDC tracks
  notifiable diseases — adapted from OpenStax Microbiology, Section 16.1.
source_section: "16.1"
weight: 1
---
...
{{< mediafigure src="microbiology/OSC_Microbio_16_01_IncPrev" alt="A line graph titled 'HIV Prevalence and Incidence in the U.S., 1980-2010,' with cases (0 to 1,200,000) on the y-axis and year (1980 to 2010) on the x-axis. The red 'Active HIV/AIDS Infections' line starts near 0 in 1980, rises steadily to about 750,000 by 1990, plateaus through about 1996, then rises again to about 1,200,000 by 2010. The blue 'New HIV Infections' line rises from about 50,000 in 1980 to a peak near 140,000 around 1984-1985, falls back to about 50,000-60,000 by 1990, and stays roughly level near that range through 2010." kind="diagram" eager="true" >}}
...
Incidence and prevalence both count only the new cases of a disease, but over different lengths of time.
Incidence measures the number of deaths from a disease; prevalence measures the total number of illness cases.
{{< /multiplechoice >}}

{{< selfcheck question="Describe how morbidity and mortality rates are expressed." hint="Give each rate's two possible forms: a count against a standard population size, or a percentage." >}}
...
===CHECKS===
the morbidity rate can be expressed as the number of diseased individuals out of a standard number of individuals in the population, such as 100,000
or as a percent of the population
a mortality rate can be expressed as the percentage of the population that has died from a disease
or as the number of deaths per 100,000 persons
{{< /selfcheck >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_16_01_Flu2" alt="A line graph titled 'Percentage of All Deaths Due to Influenza and Pneumonia,' with percent (4-12) on the y-axis and years 2004-2008 on the x-axis. A black 'seasonal baseline' curve and a blue 'epidemic threshold' curve, running about half a point above it, both rise and fall yearly, the baseline ranging from about 5.3% at its lowest trough to about 7.7% at its highest peak. A jagged red 'actual mortality' line follows the same wave but crosses above the epidemic threshold at sharp peaks near the start of 2004, in early 2005, and again in early 2008, when it rises above 8%." kind="diagram" >}}
...
An endemic disease occurs on a worldwide scale; an epidemic disease occurs within only one geographic region.
Endemic and epidemic diseases are distinguished only by their geographic scope, not by how many cases occur.
{{< /multiplechoice >}}
...
*The case continues in [Tracking Infectious Diseases](/life-health-sciences/microbiology/16-disease-and-epidemiology/02-tracking-infectious-diseases/).*
{{< /callout >}}
...
Robert Koch was the first scientist to specifically demonstrate the causative agent of a disease (anthrax) in the late 1800s. Koch developed four criteria, now known as Koch's postulates, which had to be met in order to positively link a disease with a pathogenic microbe. Without Koch's postulates, the Golden Age of Microbiology would not have occurred. Between 1876 and 1905, many common diseases were linked with their etiologic agents, including cholera, diphtheria, gonorrhea, meningitis, plague, syphilis, tetanus, and tuberculosis. Today, we use the molecular Koch's postulates, a variation of Koch's original postulates that can be used to establish a link between the disease state and virulence traits unique to a pathogenic strain of a microbe. Koch's original postulates and molecular Koch's postulates were described in more detail in [How Pathogens Cause Disease](/life-health-sciences/microbiology/15-microbial-mechanisms-of-pathogenicity/02-how-pathogens-cause-disease/).

**Check Your Understanding**

{{< selfcheck question="List some challenges to determining the causative agent of a disease outbreak." hint="Name the difficulty with proving causation, then the difficulty with detecting the pathogen itself, then the difficulty with its signs and symptoms." >}}
...
controlled experiments are needed to eliminate other possible causes
pathogens are also typically difficult to detect when there is no immediate clue as to what is causing the outbreak
signs and symptoms of disease are commonly nonspecific
{{< /selfcheck >}}
...
{{< selfcheck question="Describe how health agencies obtain data about the incidence of diseases of public health importance." hint="Name the reporting requirement first, then the CDC's own surveillance system and its publication." >}}
...
===CHECKS===
the CDC oversees the National Notifiable Disease Surveillance System (NNDSS) in cooperation with regional, state, and territorial public health departments
a physician treating a patient with a notifiable disease is legally required to submit a report on the case
the resulting data is used to inform health-care providers and the public about possible risks
...
minus the number of cases that are no longer active
...
if only a portion of the individuals in that area are susceptible, additional criteria may be required
intravenous drug use, owning particular pets, or membership in an institution, such as a college
{{< /selfcheck >}}

### Distinguish the characteristics of sporadic, endemic, epidemic, and pandemic diseases

{{< multiplechoice
  question="Which term matches this description: 'a disease found occasionally in a region with cases occurring mainly in isolation from each other'?"
  answer="sporadic disease"
  hint="This disease pattern has no constant presence and no large-scale surge."
>}}
sporadic disease
endemic disease
pandemic disease
...
{{< multiplechoice
  question="Which term matches this description: 'a disease found regularly in a region'?"
  answer="endemic disease"
  hint="This disease pattern is a constant, steady presence, not an occasional or sudden one."
>}}
sporadic disease
endemic disease
pandemic disease
...
{{< multiplechoice
  question="Which term matches this description: 'a disease in higher than expected numbers around the world'?"
  answer="pandemic disease"
  hint="This disease pattern's scale is worldwide, not just regional."
>}}
sporadic disease
endemic disease
pandemic disease
...
{{< multiplechoice
  question="Which term describes an illness with a higher-than-expected incidence in a given period within a given population?"
  answer="epidemic disease"
  hint="This disease pattern is regional and short-lived, unlike the worldwide pattern or the constant, low-level one."
>}}
sporadic disease
endemic disease
epidemic disease
...
{{< textin
  question="Which scientist was the first to specifically demonstrate the causative agent of a disease (anthrax), in the late 1800s?"
  answer="Robert Koch"
  accept="Koch"
  hint="This scientist's four criteria for linking a disease to a pathogen are named after him."
>}}
...
{{< multiplechoice
  ...
  hint="The molecular version links the disease to specific traits of a strain, not to the microbe as a whole."
>}}
...
They are used only when a microbe cannot be cultured, and otherwise duplicate Koch's original postulates exactly.
They replace the need for a controlled experiment when establishing causation.
{{< /multiplechoice >}}

### Explain the relationship between epidemiology and public health

{{< multiplechoice
  question="The ________ collects data and conducts epidemiologic studies in the United States."
  answer="Centers for Disease Control and Prevention (CDC)"
  hint="This is the agency of the Department of Health and Human Services that oversees the National Notifiable Disease Surveillance System."
>}}
...
{{< selfcheck question="In what publication would you find data on emerging/reemerging diseases in the United States?" hint="Name the CDC's own weekly publication and what it reports on." >}}
...
===CHECKS===
the CDC publishes the Morbidity and Mortality Weekly Report (MMWR)
updates on public health issues and the latest data pertaining to notifiable diseases
{{< /selfcheck >}}

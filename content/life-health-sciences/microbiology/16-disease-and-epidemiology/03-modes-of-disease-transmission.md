...
description: >-
  How pathogens persist in living and nonliving reservoirs and carriers, then
  spread by direct and indirect contact, by vehicles such as water, food, and
  air, and by mechanical and biological arthropod vectors — plus why
  quarantine and health-care settings shape the risk of nosocomial infection
  — adapted from OpenStax Microbiology, Section 16.3.
source_section: "16.3"
weight: 3
---
...
George Soper, the sanitary engineer who traced the typhoid outbreak to Mary Mallon, gives an account of his investigation, an example of descriptive epidemiology, in ["The Curious Career of Typhoid Mary."](https://openstax.org/l/22geosopcurtyp)
{{< /callout >}}

**Check Your Understanding**

{{< sortbins question="List some nonliving reservoirs for pathogens by sorting each example under the kind of reservoir it is." hint="Reread the first paragraph of Reservoirs and Carriers and the paragraph on zoonotic diseases." >}}
{"bins":["Nonliving","Living"],"items":[{"label":"Soil","bin":0},{"label":"A human who is not showing symptoms of the disease","bin":1},{"label":"Water in the environment","bin":0},{"label":"An animal in a zoonotic disease","bin":1}]}
{{< /sortbins >}}

{{< sortbins question="Explain the difference between a passive carrier and an active carrier by sorting each description under the carrier it describes." hint="Reread the fourth and fifth paragraphs of Reservoirs and Carriers." >}}
{"bins":["Passive","Active"],"items":[{"label":"Contaminated with the pathogen but not itself infected","bin":0},{"label":"An infected individual who can transmit the disease to others","bin":1},{"label":"Can transmit the pathogen without ever becoming infected, as when a health-care worker fails to wash their hands","bin":0},{"label":"May transmit disease during the incubation period, before signs or symptoms appear","bin":1},{"label":"May transmit disease during the period of convalescence, after symptoms have subsided","bin":1}]}
{{< /sortbins >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_16_03_Indirect" alt="Three photos: a hand turning an ornate brass doorknob; a striped towel hanging from a hook below a metal sign reading TOWEL; and the needle end of a syringe, with a droplet at its tip." kind="photo" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_16_03_Food" alt="Photo of a cafeteria food line with a glass sneeze guard mounted above open trays of salad and other prepared food." kind="photo" >}}
Food is an important vehicle of transmission for pathogens, especially of the gastrointestinal and upper respiratory systems. Notice the glass shield above the food trays, designed to prevent pathogens ejected in coughs and sneezes from entering the food. (credit: Fort George G. Meade Public Affairs Office)
{{< /mediafigure >}}
...
The case began in [The Language of Epidemiologists](/life-health-sciences/microbiology/16-disease-and-epidemiology/01-the-language-of-epidemiologists/).
{{< /callout >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_16_03_Vector" alt="Two drawn panels, each a numbered three-step cartoon. (a) A fly at a picnic table: it picks up a pathogen from fecal matter, carries it to a plate of food, and a person eating the food falls ill. (b) A sleeping woman with her liver highlighted: an infected mosquito bites her, the infection spreads through her body into her red blood cells, and a second mosquito biting her may now carry the infection onward." longdesc="Panel (a), captioned 'A mechanical vector carries a pathogen on its body from one host to another, not as an infection': step 1, a fly picks up a pathogen from a pile of fecal matter on the ground beside the picnic table and carries it on its body; step 2, the fly transfers the pathogen to a plate of food on the table; step 3, a person eats the contaminated food and gets sick. Panel (b), captioned 'A biological vector carries a pathogen from one host to another after becoming infected itself': step 1, a circled close-up at top left shows an infected mosquito biting an uninfected, sleeping woman, joined by a callout arrow to the bite site on her upper arm, where small blue droplets (the pathogen) appear; an arrow runs from there down her arm to her highlighted liver. Step 2: an arrow leads from the liver up to a circled three-stage cycle — a red blood cell, a pale round cell, and a red cell bursting with blue droplets, joined by curved arrows — showing the infection spreading into her red blood cells, and another arrow carries blue droplets from the liver down to her wrist. Step 3: an arrow leads from her wrist to a circled close-up at right of a second mosquito biting there, which may now transmit the infection to another person." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_16_03_VectorTab" alt="The table above, as printed in the source, with a small photograph of the living vector inset beside each of its rows: a black fly, a flea, a kissing bug, a louse, a mite, a mosquito, a sand fly, a tick, and a tsetse fly." kind="photo" >}}
...
{{< selfcheck question="Describe how diseases can be transmitted through the air." hint="Reread the second and third paragraphs of Vehicle Transmission." >}}
Dust and fine particles known as aerosols can float in the air and carry pathogens, facilitating the airborne transmission of disease — for example, dried particles of mouse feces, urine, and saliva are the dominant mode of transmission of hantavirus to humans. Although droplet transmission over short distances (one meter or less) is considered contact transmission, longer-distance transmission of droplets through the air is considered vehicle (airborne) transmission; fine mucus droplets from coughs or sneezes can remain suspended and travel considerable distances, sometimes desiccating into a droplet nucleus, and air temperature and humidity can affect how well airborne transmission works. Tuberculosis is a disease often transmitted this way, requiring as few as 10 microbes to start a new infection.
===CHECKS===
aerosols can float in the air and carry pathogens, facilitating the airborne transmission of disease
droplet transmission over short distances is considered contact transmission
longer-distance transmission of droplets through the air is considered vehicle (airborne) transmission
{{< /selfcheck >}}

{{< sortbins question="Explain the difference between a mechanical vector and a biological vector by sorting each description under the vector it describes." hint="Reread the first two paragraphs of Vector Transmission and the figure that follows them." >}}
{"bins":["Mechanical","Biological"],"items":[{"label":"Carries the pathogen on its body without becoming infected itself","bin":0},{"label":"The pathogen reproduces inside the animal before it is transmitted onward","bin":1},{"label":"A fly landing on feces and later on food, as in the figure above, is an example","bin":0},{"label":"A mosquito that must first become infected before it can pass on the pathogen, as in the figure above, is an example","bin":1}]}
{{< /sortbins >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_16_03_Mosquito" alt="A micrograph, a photo, and a US map. The micrograph shows several small round Zika virus particles inside cell tissue, with a 100 nm scale bar. The photo, labeled Aedes aegypti, shows a mosquito feeding on skin. The map shades the southern and eastern US by mosquito range, using separate colors for Aedes aegypti, Aedes albopictus, and areas where both occur." longdesc="Three panels. Top left: a micrograph of purple-stained cell tissue with several small, round, reddish-orange particles; an arrow labeled 'Zika virus' points to two of them, and a scale bar reads 100 nm. Bottom left: a close-up photo labeled 'Aedes aegypti' of a mosquito feeding on skin. Right: a map of the 48 contiguous states plus Hawaii and Puerto Rico, shaded by a three-part legend — blue for Aedes aegypti, tan for Aedes albopictus, and teal for both. Teal covers the southern tier from California, southern Arizona, and southern New Mexico through Texas, Oklahoma, Arkansas, the Gulf states, Tennessee, Kentucky, and the Carolinas, and runs north along the Atlantic coast through Virginia, Maryland, Delaware, and New Jersey. A blue band for A. aegypti alone crosses northern Arizona and New Mexico, just touching Utah's southern edge, and Puerto Rico is blue. Tan for A. albopictus alone lies north of the teal: from Kansas and eastern Nebraska through Iowa and the southwest corner of Minnesota, Missouri, Illinois, Indiana, and Ohio into Pennsylvania, New York, and New England, with a thin tan fringe along the teal's inland edge in California; Wisconsin, Michigan, the Dakotas, and the northwestern states are unshaded. Hawaii's islands are tan, with a thin teal strip along the Big Island's western coast." kind="diagram" >}}
...
{{< selfcheck question="Give some reasons why HAIs occur." hint="Reread the second and third paragraphs of this subsection." >}}
HAIs are often connected with surgery or other invasive procedures that provide the pathogen with access to the portal of infection. Patients suffering from primary disease are often afflicted with compromised immunity and are more susceptible to secondary infection and opportunistic pathogens. Many HAIs also occur when pathogens are introduced to patients' bodies through contaminated surgical or medical equipment, such as catheters and respiratory ventilators.
===CHECKS===
surgery or other invasive procedures that provide the pathogen with access to the portal of infection
patients ... are often afflicted with compromised immunity and are more susceptible to secondary infection
pathogens are introduced to patients' bodies through contaminated surgical or medical equipment, such as catheters and respiratory ventilators
{{< /selfcheck >}}
...
{{< textin question="A living host or nonliving site in which a pathogenic organism can survive or multiply is called a ________." answer="reservoir" hint="Reread the first paragraph of this section's first subsection." >}}

{{< textin question="Active carriers who do not present signs or symptoms of disease despite infection are called ________." answer="asymptomatic carriers" hint="Reread the fifth paragraph of Reservoirs and Carriers." >}}

{{< textin question="The preferred host organism for a parasite, in which the parasite reaches sexual maturity, is called the ________." answer="definitive host" hint="Reread the last paragraph of Reservoirs and Carriers." >}}

### Compare contact, vector, and vehicle modes of transmission

{{< multiplechoice
  question="A mosquito bites a person who subsequently develops a fever and abdominal rash. What type of transmission would this be?"
  answer="biological vector transmission"
  hint="Reread the Vector Transmission paragraphs and the figure that contrasts two kinds of vector."
>}}
...
{{< multiplechoice
  question="Cattle are allowed to pasture in a field that contains the farmhouse well, and the farmer's family becomes ill with a gastrointestinal pathogen after drinking the water. What type of transmission of infectious agents would this be?"
  answer="vehicle transmission"
  hint="Reread the first paragraph of the subsection that follows Contact Transmission."
>}}
biological vector transmission
direct contact transmission
...
{{< multiplechoice
  question="A blanket from a child with chickenpox is likely to be contaminated with the virus that causes chickenpox (Varicella-zoster virus). What is the blanket called?"
  answer="fomite"
  hint="Reread the Contact Transmission paragraph on indirect contact transmission."
>}}
fomite
host
pathogen
...
{{< multiplechoice
  question="Differentiate between droplet vehicle transmission and airborne transmission."
  answer="Droplet transmission over short distances is considered contact transmission, while longer-distance transmission of droplets through the air is considered vehicle (airborne) transmission."
  hint="Reread the third paragraph of Vehicle Transmission."
>}}
Droplet transmission over long distances is considered contact transmission, while short-distance transmission of droplets through the air is considered vehicle (airborne) transmission.
Droplet transmission over short distances is considered contact transmission, while longer-distance transmission of droplets through the air is considered vehicle (airborne) transmission.
Droplet transmission involves inanimate objects called fomites, while airborne transmission involves physical contact between two individuals.
Droplet transmission is transmission through vehicles such as water and food, while airborne transmission requires contact between mucous membranes.
{{< /multiplechoice >}}

{{< selfcheck question="Many people find that they become ill with a cold after traveling by airplane. The air circulation systems of commercial aircraft use HEPA filters that should remove any infectious agents that pass through them. What are the possible reasons for increased incidence of colds after flights?" hint="Reread the Reservoirs and Carriers paragraph on active carriers and the Contact Transmission paragraphs." >}}
A HEPA filter is designed to clean the cabin's general circulating air, which addresses airborne transmission, but this section describes several other routes that do not depend on that shared air supply. First, an active carrier may transmit a disease during the incubation period, before showing any signs or symptoms, so a passenger could already have been contagious before ever boarding. Second, this section defines direct droplet transmission as transmission of a pathogen to a new host over distances of one meter or less — closer than the filtered cabin air a HEPA system cleans, so a nearby passenger's own cough or sneeze can reach another passenger directly. Third, indirect contact transmission involves inanimate objects called fomites that become contaminated by pathogens from an infected individual or reservoir; this section's own fomite examples are ordinary shared objects such as a doorknob or a towel, so a comparably shared surface aboard a crowded aircraft could plausibly act as a fomite the same way, though the module does not itself discuss airplane surfaces and this last step is an inference beyond what it states directly.
===CHECKS===
an active carrier may transmit a disease during the incubation period, before showing any signs or symptoms
direct droplet transmission... transmission of a pathogen to a new host over distances of one meter or less
...
{{< textin question="A ________ is an animal that can transfer infectious pathogens from one host to another." answer="vector" hint="Reread the first sentence of the subsection that follows the Clinical Focus Resolution." >}}

{{< multiplechoice
  question="Which is the most common type of biological vector of human disease?"
  answer="arthropods"
  hint="Reread the second paragraph of the subsection that follows the Clinical Focus Resolution."
>}}
viruses
bacteria
mammals
...
{{< multiplechoice
  question="According to the table of arthropod vectors above, which vector transmits the pathogen that causes Lyme disease?"
  answer="Tick"
  hint="Find the Lyme disease row of the table of arthropod vectors."
>}}
Flea
Mosquito
Tick
...
{{< textin question="A patient in the hospital with a urinary catheter develops a bladder infection. This is an example of a(n) ________ infection." answer="nosocomial" accept="healthcare-associated|health-care-associated|HAI|hospital-acquired|nosocomial infection|healthcare-associated infection" hint="Reread the second paragraph of this section's last subsection." >}}

{{< multiplechoice
  question="According to this section, what percentage of the 2011 HAIs in United States hospitals were urinary tract infections?"
  answer="About 13%"
  hint="Reread the third paragraph of this section's last subsection."
>}}
About 22%
About 13%
About 10%
...
{{< multiplechoice
  question="According to this section, what must be true for an infection to be officially classified as an HAI?"
  answer="The patient must have been admitted to the health-care facility for a reason other than the infection"
  hint="Reread the second paragraph of this section's last subsection."
>}}
The patient must have been admitted to the health-care facility for a reason other than the infection
The infection must have been acquired through surgery or another invasive procedure
The patient's immune system must already be compromised by an underlying disease
{{< /multiplechoice >}}

---

<small>This section is adapted from [Microbiology, Section 16.3: Modes of Disease Transmission](https://openstax.org/books/microbiology/pages/16-3-modes-of-disease-transmission) by Nina Parker, Mark Schneegurt, Anh-Hue Thi Tu, Philip Lister, Brian M. Forster, and OpenStax, © OpenStax, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). Access the original for free at [openstax.org](https://openstax.org/details/books/microbiology). Changes: all seven source figures are re-encoded as WebP and rendered as mediafigures; the media manifest guesses `kind="photo"` for all seven (every source file is a JPEG), which is correct for five of them (Contact, Indirect, Food, Isolate, and the VectorTab image, which is kept for its per-vector photo insets exactly as the chapter-2 stain tables were) but wrong for the Vector and Mosquito figures, which are explicit `kind="diagram"` because each is a genuinely drawn cartoon (Vector) or contains a genuinely drawn, labeled map (Mosquito); longdescs are added for the Vector and Mosquito figures because each is a multi-panel or multi-labeled diagram whose caption does not name every step or region. The `OSC_Microbio_16_03_VectorTab` figure is a table printed as an image with no CNXML `<table summary=…>` markup; its sixteen rows are transcribed as a Markdown table, checked against the PDF page and the image (correcting the source alt's "Moquito," "Cutex," "Rickettsi rickettsia," and "sleepting sickness" spellings, none of which reach the page since the table is transcribed from the image, not the alt), and the vendored figure is kept immediately after it for its photo of each vector. Of the source's nine footnotes, all are rendered as inline parenthetical citations after the sentences they support, with every bare access URL dropped and the rest of each citation kept verbatim; none carries a DOI. The link to "Eye on Ethics: Typhoid Mary" (m58933) is rendered as an absolute site-root link to section 24.3, which carries that box; the two links to "Controlling Microbial Growth" (m58853) and "Control of Microbial Growth" (m58852) are rendered as absolute site-root links because both already exist (chapter 13's section 13.1 and its chapter landing, respectively). The Clinical Focus box (Resolution, this chapter's turducken *Salmonella* case) keeps its title and document order; its closing "go back to the previous Clinical Focus box" link is replaced with "The case began in The Language of Epidemiologists," an absolute site-root link to 16.1. The five Check Your Understanding bullets (two per box in the first two boxes, one in the third) are rendered at their note positions: the nonliving/living-reservoir and passive/active-carrier bullets, and the mechanical/biological-vector bullet, are graded as `sortbins` built from this module's own defining and example sentences, each keeping its source question with a sorting instruction appended (bins are the classification word alone); the air-transmission and HAI-reasons bullets stay self-checks because each needs several of this module's sentences assembled into one answer. Of the module's eight source exercises, each is placed under the objective it tests, which changes the printed order: the first Multiple Choice (the most common type of biological vector) follows the other three, under the third objective; the Short Answer and Critical Thinking questions sit under the second objective, ahead of both Fill in the Blank items; and the ________-vector Fill in the Blank precedes the nosocomial one and sits above the "most common type of biological vector" multiple choice, reversing both printed orders, so that no item directly above a text-entry blank prints its key. All four Multiple Choice keep their source options and keys; the ________-vector item keeps its one-word key as a plain `textin`; the nosocomial/healthcare-associated key is graded as a `textin` keyed nosocomial that also accepts healthcare-associated (and the module's health-care-associated spelling), HAI, and hospital-acquired, with or without the word "infection"; the unkeyed Short Answer question (differentiate droplet vehicle transmission from airborne transmission) is graded as a `multiplechoice` keyed by this module's own sentence that calls short-distance droplet transmission contact transmission and longer-distance droplet transmission through the air vehicle transmission, with three distractors built from this module's own phrases (the reversed distances, fomite-based indirect contact against physical contact, and water/food vehicles against mucous-membrane contact); the unkeyed Critical Thinking question (colds after air travel despite HEPA filters) stays a `selfcheck` because the honest answer synthesizes several of this module's sentences about incubation-period carriers, droplet distance, and fomites, none of which the module states as a single fixing sentence. Three filler multiple choices (one keyed from the vector-to-disease table and two built from this module's own HAI statistics and classification sentences), two key-term `textin` recall items (reservoir, definitive host), and one `textin` cloze of this module's asymptomatic-carrier sentence round out the Practice floor. Key terms are compiled from the module's 20 defined terms and the book's Glossary appendix; 16 are taken from the glossary, and 4 are sentence-derived (vertical direct contact transmission, horizontal direct contact transmission, quarantined, and nosocomial infections all lack a matching glossary entry); the Key terms block lower-cases the bold headword for "contact transmission," "vertical direct contact transmission," "indirect contact transmission," "mechanical transmission," and "biological transmission" because none is a proper noun, even though each is capitalized in the body at its sentence-initial defining occurrence, which is transcribed as printed. No source item was dropped. The source alt for the vector table also lists a cat flea, *Bartonella henselae*, cat-scratch disease row that the printed table does not carry; the transcription follows the image.</small>

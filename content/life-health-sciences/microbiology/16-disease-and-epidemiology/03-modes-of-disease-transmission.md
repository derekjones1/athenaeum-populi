...
{{< multiplechoice
  ...
  hint="Recall which vector-transmission type requires the pathogen to reproduce inside the vector before the bite can pass on an infection."
>}}
...
{{< multiplechoice
  ...
  hint="Recall which transmission type this section names for a pathogen carried by a contaminated substance such as water."
>}}
biological vector transmission
direct contact transmission
...
{{< multiplechoice
  ...
  answer="fomite"
  hint="Recall this section's term for an inanimate object that becomes contaminated by pathogens from an infected individual."
>}}
fomite
host
pathogen
...
{{< multiplechoice
  ...
  answer="About 13%"
  hint="Recall the one percentage in this section's HAI statistics that is not shared by another category."
>}}
About 22%
About 13%
About 10%
...
{{< multiplechoice
  ...
  hint="Recall the one requirement this section states as necessary for the HAI classification, as distinct from what it says HAIs are merely often connected with."
>}}

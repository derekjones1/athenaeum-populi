...
{{< sortbins question="Sort each example of a reservoir for pathogens by whether it is a living or a nonliving reservoir." hint="Recall which examples this subsection gives for organisms that themselves harbor a pathogen versus inanimate sites that do." >}}
...
{{< sortbins question="Sort each description under whether it applies to a passive carrier or an active carrier." hint="Recall which type of carrier is described as infected and which is only contaminated." >}}
...
{{< selfcheck question="Describe how diseases can be transmitted through the air." hint="Recall both the fine-particle mechanism this subsection names and the distance threshold that separates it from droplet transmission." >}}
...
{{< sortbins question="Sort each description under whether it distinguishes a mechanical vector or a biological vector." hint="Recall which kind of vector the pathogen reproduces inside, and which kind merely carries it on its body." >}}
...
{{< selfcheck question="Give some reasons why HAIs occur." hint="Recall what this subsection says about how patients' bodies are exposed to pathogens in a health-care setting and what makes those patients especially susceptible." >}}
...
{{< textin question="A living host or nonliving site in which a pathogenic organism can survive or multiply is called a ________." answer="reservoir" hint="This is the general term this subsection uses for where a pathogen persists between infections." >}}

{{< textin question="An individual who is contaminated with a pathogen and can mechanically transmit it to another host, without being infected, is called a ________." answer="passive carrier" hint="Recall the term for a carrier who is contaminated but not infected, unlike the carrier type discussed right after it." >}}

{{< textin question="The preferred host organism for a parasite, in which the parasite reaches sexual maturity, is called the ________." answer="definitive host" hint="This is the host type paired in this subsection with a host where the parasite only goes through immature stages." >}}
...
{{< multiplechoice
  ...
  answer="Droplet transmission occurs over a distance of one meter or less, while longer-distance transmission of the same droplets through the air is considered vehicle (airborne) transmission."
  hint="Recall the specific distance this section uses to separate the two."
>}}
Droplet transmission occurs over a distance of one meter or less, while longer-distance transmission of the same droplets through the air is considered vehicle (airborne) transmission.
Droplet transmission occurs over distances greater than one meter, while vehicle (airborne) transmission occurs at one meter or less.
Droplet transmission spreads pathogens through contaminated water or food, while vehicle (airborne) transmission spreads pathogens only through direct skin contact.
Droplet and vehicle (airborne) transmission both refer only to pathogens carried on contaminated fomites such as doorknobs and towels.
{{< /multiplechoice >}}

{{< selfcheck question="Many people find that they become ill with a cold after traveling by airplane. The air circulation systems of commercial aircraft use HEPA filters that should remove any infectious agents that pass through them. What are the possible reasons for increased incidence of colds after flights?" hint="Recall which transmission routes this section describes that a cabin's air-filtration system would not address at all." >}}
...
{{< textin question="A ________ is an animal that can transfer infectious pathogens from one host to another." answer="vector" hint="This is the general term for such an animal, broader than the mechanical/biological distinction discussed above." >}}

{{< multiplechoice
  question="Which is the most common type of biological vector of human disease?"
  answer="arthropods"
  hint="Recall which group of animals dominates the table of vectors and pathogens above."
>}}
viruses
bacteria
mammals
...
{{< multiplechoice
  ...
  answer="Tick"
  hint="Recall which arthropod's table row lists Borrelia species as its pathogen and Lyme disease as the resulting illness."
>}}
Flea
Mosquito
Tick
...
{{< multiplechoice
  ...
  answer="About 13%"
  hint="Reread the HAI statistics paragraph of the Healthcare-Associated (Nosocomial) Infections discussion."
>}}
About 22%
About 13%
About 10%
...
{{< multiplechoice
  ...
  hint="Reread the second paragraph of the Healthcare-Associated (Nosocomial) Infections discussion."
>}}

...
{{< selfcheck question="Describe the most abundant elements in nature." hint="Name all six macronutrient elements, in the order this section lists them." >}}
...
{{< selfcheck question="What are the differences between organic and inorganic molecules?" hint="State which of the two contains carbon, then note the one exception this section names." >}}
...
{{< selfcheck question="We say that life is carbon based. What makes carbon so suitable to be part of all the macromolecules of living organisms?" hint="Combine carbon's electron and bonding count with what that count lets carbon atoms build." >}}
...
{{< textin question="Dehydration synthesis links monomers together and, as a byproduct, forms molecules of ________." answer="water" accept="H2O" hint="The paragraph introducing dehydration synthesis names exactly one small molecule released alongside the new monomer-to-monomer bond." >}}
...
{{< multiplechoice question="Why are carbon, nitrogen, oxygen, and hydrogen the most abundant elements in living matter and, therefore, considered macronutrients?" answer="They have low atomic numbers and are light elements capable of forming strong bonds with other atoms." hint="Look for the sentence that gives a shared atomic property of these four elements, not a fact about only one of them." >}}
...
{{< textin question="Each carbon atom can bind to another one, producing a ________ that can be straight, branched, or ring shaped." answer="carbon skeleton" hint="This is the section's own term for a chain of bonded carbon atoms." >}}

{{< textin question="A molecule that is part of living matter and contains carbon is called a ________." answer="biomolecule" hint="This is the general term the section gives to any carbon-containing molecule found in living matter, distinct from an inorganic compound." >}}

### Explain the concept of isomerism

{{< multiplechoice question="Which of the following is the name for molecules whose structures are nonsuperimposable mirror images?" answer="enantiomers" hint="This type of stereoisomer is the one Pasteur first observed rotating polarized light in opposite directions." >}}
structural isomers
monomers
polymers
enantiomers
...
{{< multiplechoice question="Two molecules containing the same types and numbers of atoms but different bonding sequences are called enantiomers." answer="False" hint="Compare this statement against the section's separate definitions of the isomer type built on bonding sequence and the isomer type built on mirror-image spatial arrangement." >}}
True
False
{{< /multiplechoice >}}
...
{{< textin question="The property by which enantiomers' structures are nonsuperimposable mirror images of each other is called ________." answer="chirality" hint="This property, not the molecules themselves, is what the section names right after introducing enantiomers." >}}
...
{{< multiplechoice question="Identify the functional group depicted in structural formula A." answer="Hydroxyl" hint="Match the atoms bonded to the carbon in formula A against the table's one-oxygen, one-hydrogen entry." >}}
Ether
Hydroxyl
Methyl
Carbonyl
...
{{< multiplechoice question="Identify the functional group depicted in structural formula B." answer="Carboxylic acid" hint="Formula B's carbon carries both a double-bonded oxygen and a hydroxyl group; match that combination in the table." >}}
Carbonyl
Aldehyde
Carboxylic acid
Ester
...
{{< multiplechoice question="Identify the functional group depicted in structural formula C." answer="Amino" hint="Formula C's nitrogen is bonded only to an R group and two hydrogens; match that against the table's nitrogen-only entry." >}}
Amide
Sulfhydryl
Methyl
Amino
...
{{< sortbins question="Sort each function of macromolecules under the class of macromolecule the section's table assigns it to." hint="Match each phrase to the single row of the table that states it; several functions, such as energy storage, are intentionally left out because more than one row shares them." >}}

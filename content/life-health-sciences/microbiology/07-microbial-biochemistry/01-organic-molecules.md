...
description: >-
  The elements, isomers, functional groups, and macromolecules that make up
  organic molecules, and how monomers link into polymers by dehydration
  synthesis — adapted from OpenStax Microbiology, Section 7.1.
source_section: "7.1"
weight: 1
---
...
The case continues in [Lipids](/life-health-sciences/microbiology/07-microbial-biochemistry/03-lipids/).
{{< /callout >}}
...
{{< selfcheck question="Describe the most abundant elements in nature." hint="Reread the first paragraph of the Elements in Living Cells subsection." >}}
...
{{< selfcheck question="What are the differences between organic and inorganic molecules?" hint="Reread the third paragraph of the Elements in Living Cells subsection." >}}
...
Carbon oxides and carbonates are exceptions
...
{{< mediafigure src="microbiology/OSC_Microbio_07_01_methane" alt="A methane molecule drawn with a central carbon atom bonded to four hydrogen atoms, one above, one below, and one to each side." kind="diagram" >}}
...
{{< mediafigure src="microbiology/OSC_Microbio_07_01_monoglucos" alt="Two pairs of mirror-image structural formulas, each pair separated by a dashed line labeled mirror. D-glucose and L-glucose are six-carbon chains whose hydroxyl groups sit on opposite sides at every carbon below the top, double-bonded oxygen. D-alanine and L-alanine are three-carbon chains whose amino groups sit on opposite sides of the chain." kind="diagram" >}}
...
{{< selfcheck question="We say that life is carbon based. What makes carbon so suitable to be part of all the macromolecules of living organisms?" hint="Reread the first two paragraphs of the Organic Molecules and Isomerism subsection." >}}
...
===CHECKS===
four valence electrons in its outer orbitals
four single covalent bonds with up to four other atoms at the same time
carbon atoms can bind together in large numbers to produce a chain or carbon skeleton
...
| --- | --- | --- |
| Aldehyde | R—C(=O)—H | Carbohydrates |
| Amide | R—C(=O)—N(H)—R′ | Proteins |
| Amino | R—NH₂ | Amino acids, proteins |
| Carbonyl | R—C(=O)—R′ | Ketones, aldehydes, carboxylic acids, amides |
| Carboxylic acid | R—C(=O)—O—H | Amino acids, proteins, fatty acids |
| Ester | R—C(=O)—O—R′ | Lipids, nucleic acids |
| Ether | R—O—R′ | Disaccharides, polysaccharides, lipids |
| Hydroxyl | R—O—H | Alcohols, monosaccharides, amino acids, nucleic acids |
| Ketone | R—C(=O)—R′ | Carbohydrates |
| Methyl | R—CH₃ | Methylated compounds such as methyl alcohols and methyl esters |
| Phosphate | R—PO₃H₂ | Nucleic acids, phospholipids, ATP |
| Sulfhydryl | R—S—H | Amino acids, proteins |

{{< mediafigure src="microbiology/OSC_Microbio_07_01_TBLcomFun" alt="A colored chart repeating the table above with each functional group's atoms in pink and its R groups in black; ketone and aldehyde additionally highlight their shared carbonyl portion in blue." kind="diagram" >}}
...
{{< textin question="What is the byproduct of a dehydration synthesis reaction?" answer="water" accept="H2O|water molecule" hint="Reread the paragraph that introduces dehydration synthesis near the end of the section." >}}
...
{{< multiplechoice question="Which of these elements is *not* a micronutrient?" answer="C" hint="Compare each symbol against the six macronutrients and the list of micronutrient examples." >}}
C
Ca
Co
Cu
...
{{< multiplechoice question="Why are carbon, nitrogen, oxygen, and hydrogen the most abundant elements in living matter and, therefore, considered macronutrients?" answer="They have low atomic numbers and are light elements capable of forming strong bonds with other atoms." hint="Reread the second paragraph of the Elements in Living Cells subsection." >}}
They are needed by cells only in very small amounts.
They have low atomic numbers and are light elements capable of forming strong bonds with other atoms.
They each form exactly four covalent bonds with other atoms.
They make up about 1%–1.5% of the dry weight of cells.
{{< /multiplechoice >}}

{{< textin question="Each carbon atom can bind to another one, producing a ________ that can be straight, branched, or ring shaped." answer="carbon skeleton" accept="chain|carbon chain" hint="Reread the second paragraph of the Organic Molecules and Isomerism subsection." >}}

{{< textin question="The organic molecules in organisms are called ________ because they are part of living matter." answer="biomolecules" accept="bio-molecules" hint="Reread the first paragraph of the Organic Molecules and Isomerism subsection." >}}

### Explain the concept of isomerism

{{< textin question="Isomers that differ in the bonding sequence of their atoms, though their molecular formulas are identical, are called ________." answer="structural isomers" hint="This is the isomer type the glucose, galactose, and fructose example illustrates." >}}

{{< textin question="The property of stereoisomer molecules by which their structures are nonsuperimposable mirror images is called ________." answer="chirality" hint="Reread the stereoisomer paragraph of the Organic Molecules and Isomerism subsection." >}}

{{< multiplechoice question="Which of the following is the name for molecules whose structures are nonsuperimposable mirror images?" answer="enantiomers" hint="Reread the stereoisomer paragraph of the Organic Molecules and Isomerism subsection." >}}
structural isomers
monomers
polymers
enantiomers
...
{{< multiplechoice question="Two molecules containing the same types and numbers of atoms but different bonding sequences are called enantiomers." answer="False" hint="Reread the isomer definitions in the Organic Molecules and Isomerism subsection." >}}
True
False
{{< /multiplechoice >}}
...
{{< multiplechoice question="Identify the functional group depicted in structural formula A." answer="Hydroxyl" hint="Compare formula A with the Functional Group column of the table in the Biologically Significant Functional Groups subsection." >}}
Ether
Hydroxyl
Methyl
Carbonyl
...
{{< multiplechoice question="Identify the functional group depicted in structural formula B." answer="Carboxylic acid" hint="Compare formula B with the Functional Group column of the table in the Biologically Significant Functional Groups subsection." >}}
Carbonyl
Aldehyde
Carboxylic acid
Ester
...
{{< multiplechoice question="Identify the functional group depicted in structural formula C." answer="Amino" hint="Compare formula C with the Functional Group column of the table in the Biologically Significant Functional Groups subsection." >}}
Amide
Sulfhydryl
Methyl
Amino
...
{{< multiplechoice question="Aldehydes, amides, carboxylic acids, esters, and ketones all contain carbonyl groups." answer="True" hint="Check each of the five named compound classes against the table's own carbonyl-containing formulas." >}}
True
False
{{< /multiplechoice >}}
...
{{< selfcheck question="(a) Identify three major functional groups in this molecule that each comprise two simpler functional groups. (b) Name the two simpler functional groups composing each of the major functional groups identified in (a)." hint="Reread the first paragraph and the table of the Biologically Significant Functional Groups subsection." >}}
...
===CHECKS===
two amide bonds
one carboxylic acid group attached to the five-membered ring
the carbonyl group as one of the two simpler groups shared by all three
the carboxylic acid as this same carbonyl group joined with a hydroxyl group
{{< /selfcheck >}}

### Describe the role of functional groups in synthesizing polymers

{{< textin question="Functional groups combine with a carbon backbone to form molecules that are typically large, so they are called ________." answer="macromolecules" accept="macro-molecules" hint="Reread the first paragraph under the section's last subheading." >}}

{{< textin question="Cells and cell structures include four main groups of carbon-containing macromolecules: ________, proteins, lipids, and nucleic acids." answer="polysaccharides" accept="carbohydrates" hint="Reread the first paragraph under the section's last subheading." >}}

{{< sortbins question="Sort each function under the group the section's function table assigns it to." hint="Reread the two-column table of functions near the end of the section." >}}
{"bins":["Carbohydrates","Lipids","Nucleic acids","Proteins"],"items":[{"label":"Serve as a source of food","bin":0},{"label":"Provide insulation","bin":1},{"label":"Store and transfer genetic information","bin":2},{"label":"Function as enzymes","bin":3},{"label":"Provide structural support in plants, fungal cell walls, and insect exoskeletons","bin":0},{"label":"Function as hormones and pigments","bin":1},{"label":"Provide structural support in the cytoskeleton and extracellular matrix","bin":3}]}
{{< /sortbins >}}

---

<small>This section is adapted from [Microbiology, Section 7.1: Organic Molecules](https://openstax.org/books/microbiology/pages/7-1-organic-molecules) by Nina Parker, Mark Schneegurt, Anh-Hue Thi Tu, Philip Lister, Brian M. Forster, and OpenStax, © OpenStax, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). Access the original for free at [openstax.org](https://openstax.org/details/books/microbiology). Changes: all eight figures (the six in the body plus the two exercise figures) are re-encoded as WebP and rendered as mediafigures with explicit `kind="diagram"` (the manifest's JPEG-based guess of "photo" is wrong for every one of this section's drawn structural formulas and the ball-and-stick common-molecules figure), and their alts are rewritten from the source's incomplete or malformed originals, described at the atom level so no alt names the functional-group answer of a paired item (the commonMol alt repeated its own text twice verbatim, an upstream defect); the Clinical Focus box is rendered as a callout, its "Jump to the next Clinical Focus box" link replaced by a Markdown link naming the section the case continues in; the functional-group table (a rendered image upstream) is transcribed as a Markdown table from the image, checked against the PDF page, with the vendored image kept immediately after it because a checker cannot verify a transcribed chemical formula without the source figure beside it; the table's own footnote ("Functional groups are represented in pink...") is folded into the kept figure's caption since the Markdown table cannot show color; the dehydration-synthesis equation is rendered as a plain-text line with the Unicode arrow; the CALS table of macromolecule functions is transcribed from its cells (its `summary` attribute misspells "storage" as "torage," a source defect that is not copied) and given one sort-bins activity under the objective it serves; all four `<link document="m58946">` targets are Appendix A, named four times in plain text because that appendix is not authored; `<link document="m58834">` (*Biochemistry of the Genome*, the chapter 10 introduction) is likewise plain text; same-module figure and table cross-references are rendered as describing prose; Check Your Understanding questions are rendered as body items, one of four graded from this module's own sentence (the dehydration-synthesis byproduct) and three left as self-checks because their honest answers assemble several of the module's own sentences; of the source's two unkeyed Short Answer questions, one ("why are C, N, O, and H the most abundant elements...") is graded as a multiple choice from this module's own atomic-number sentence, and the other (the three-formula functional-group identification, `OSC_Microbio_07_01_matching_img`) becomes three multiple-choice items, one per lettered formula, keyed from the image and the functional-group table; the unkeyed Critical Thinking question (the penicillin G figure, `OSC_Microbio_07_01_fungroup_img`) stays a self-check because the module's text and table can fix only the shared carbonyl component of its three functional groups, not the nitrogen-bearing side of its two amide bonds, and the model answer says so and stops; the two source Multiple Choice and two True/False items are adapted into Practice unchanged, and in the isomerism group the structural-isomers and chirality clozes are placed ahead of the source enantiomers Multiple Choice, whose options print "structural isomers"; key terms are compiled from the module's 17 defined terms and the book's Glossary appendix, with the glossary's own "assembled from of individual units" corrected to "assembled from individual units" for the macromolecule definition (a one-word source defect) and no definitions needed a sentence-derived fallback; six cloze `textin` items (carbon skeleton, biomolecules, and structural isomers from body or summary sentences; chirality from its Key terms definition; polysaccharides and macromolecule from the Macromolecules subsection — the polysaccharides cloze replaced a monomers cloze whose key the source enantiomers Multiple Choice prints among its options) and one table-based `sortbins` fill out the objective-1, objective-2, and (entirely) objective-4 Practice groups, none of which the source's own exercise set reaches; no source exercise was omitted.</small>

...
{{< multiplechoice question="Explain why fatty acids with hydrocarbon chains that contain only single bonds are called saturated fatty acids." answer="They have the greatest number of hydrogen atoms possible, so they are “saturated” with hydrogen." hint="Compare how many hydrogen atoms a fully single-bonded carbon chain can hold versus a chain with a double bond." >}}
...
{{< selfcheck question="How is the amphipathic nature of phospholipids significant?" hint="Think about what happens to the polar heads and the nonpolar tails when phospholipids are placed in water." >}}
...
{{< sortbins question="How are isoprenoids used in technology? Sort each example below under the technological use it illustrates." hint="The module names one pharmaceutical, two pigments, and four fragrances among these examples." >}}
...
{{< multiplechoice question="Which of the following describes lipids?" answer="all of the above" hint="Look back at how the section introduces the many roles lipids play." >}}
...
{{< multiplechoice question="Lipids are a naturally occurring group of substances that are not soluble in water but are freely soluble in organic solvents." answer="True" hint="Compare this statement with how the section describes the hydrophobic, nonpolar nature of lipids." >}}
True
False
{{< /multiplechoice >}}

{{< textin question="Lipids are composed mainly of carbon and hydrogen, but they can also contain oxygen, nitrogen, sulfur, and __________." answer="phosphorous" accept="phosphorus" hint="Named for the same element found in a phosphate group." >}}

### Describe the unique characteristics and diverse structures of lipids

{{< multiplechoice question="Fatty acids having no double bonds are called “unsaturated.”" answer="False" hint="Compare this name with the term the section uses for a hydrocarbon chain that has the greatest number of hydrogen atoms possible." >}}
True
False
{{< /multiplechoice >}}

{{< multiplechoice question="Which of the following, together with saturated fatty acids, forms the esters found in waxes?" answer="alcohols" hint="An ester bond forms between a fatty acid and this other class of organic molecule." >}}
hydrocarbons
isoprenoids
alcohols
carbohydrates
...
{{< textin question="Cholesterol is the most common member of the __________ group, found in animal tissues; it has a tetracyclic carbon ring system with a double bond in one of the rings and one free hydroxyl group." answer="steroid" accept="sterol" hint="This lipid category is defined by its four-ring carbon skeleton; the section names it just before it introduces the OH-bearing subgroup." >}}

### Compare and contrast triacylglycerides (triglycerides) and phospholipids.

{{< multiplechoice question="Molecules bearing both polar and nonpolar groups are said to be which of the following?" answer="amphipathic" hint="This is the same word the section uses for phospholipids, which have both a polar head and nonpolar tails." >}}
hydrophilic
amphipathic
hydrophobic
polyfunctional
...
{{< selfcheck question="Describe the structure of a typical phospholipid. Are these molecules polar or nonpolar?" hint="Think about what occupies the third binding position on the glycerol backbone, and what charge it carries." >}}

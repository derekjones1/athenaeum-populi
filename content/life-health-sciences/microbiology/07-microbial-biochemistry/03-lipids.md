...
title: Lipids
description: >-
  The chemical composition and diverse structures of lipids — fatty acids
  and triacylglycerides, the amphipathic phospholipids that build micelles
  and lipid bilayers, and the isoprenoids, steroids, and sterols — adapted
  from OpenStax Microbiology, Section 7.3.
source_section: "7.3"
weight: 3
---
...
{{< mediafigure src="microbiology/OSC_Microbio_07_03_trygly" kind="diagram" eager="true" alt="A diagram of dehydration synthesis. On the left, a three-carbon glycerol backbone has an −OH group on each carbon, with the H atom of each −OH highlighted, beside three fatty acid chains, each a long carbon chain ending in a carbon bonded to a double-bonded O and a highlighted −OH. On the right, an arrow leads to the product: a triglyceride in which each fatty acid's end carbon now bonds through an O to a carbon of the glycerol backbone, with three water molecules shown released to the side." >}}
Triglycerides are composed of a glycerol molecule attached to three fatty acids by a dehydration synthesis reaction.
{{< /mediafigure >}}

**Check Your Understanding**

{{< multiplechoice question="Explain why fatty acids with hydrocarbon chains that contain only single bonds are called saturated fatty acids." answer="They have the greatest number of hydrogen atoms possible, so they are “saturated” with hydrogen." hint="Reread the first paragraph of the Fatty Acids and Triacylglycerides subsection." >}}
They have hydrocarbon chains with at least one double bond.
They have the greatest number of hydrogen atoms possible, so they are “saturated” with hydrogen.
They have a rigid bend in their carbon skeleton caused by a double bond.
{{< /multiplechoice >}}
...
{{< selfcheck question="How is the amphipathic nature of phospholipids significant?" hint="Reread the last two paragraphs of the Phospholipids and Biological Membranes subsection." >}}
...
===CHECKS===
enables phospholipids to form uniquely functional structures in aqueous environments
the polar heads are strongly attracted to water molecules, while the nonpolar tails are not
the tails are strongly attracted to one another, forming stable large-scale assemblies such as micelles and lipid-bilayer sheets
these bilayer sheets are the structural basis of the cell membranes of nearly all organisms
{{< /selfcheck >}}
...
This [video](https://openstax.org/l/22liposomes) provides additional information about phospholipids and liposomes.
{{< /callout >}}

**Check Your Understanding**

{{< sortbins question="How are isoprenoids used in technology? Sort each example below under the technological use it illustrates." hint="Reread the first paragraph under the section's third subheading." >}}
{"bins": ["Pharmaceuticals", "Pigments", "Fragrances"],
 "items": [
  {"label": "Capsaicin", "bin": 0},
  {"label": "Beta carotene", "bin": 1},
  {"label": "Menthol", "bin": 2},
  {"label": "Xanthophylls", "bin": 1},
  {"label": "Camphor", "bin": 2},
  {"label": "Limonene", "bin": 2},
  {"label": "Pinene", "bin": 2}]}
{{< /sortbins >}}
...
*The case continues in [Using Biochemistry to Identify Microorganisms](/life-health-sciences/microbiology/07-microbial-biochemistry/05-using-biochemistry-to-identify-microorganisms/). The case began in [Organic Molecules](/life-health-sciences/microbiology/07-microbial-biochemistry/01-organic-molecules/).*
{{< /callout >}}
...
{{< multiplechoice question="Which of the following describes lipids?" answer="all of the above" hint="Reread the section's opening paragraph, before the first subheading." >}}
...
{{< multiplechoice question="Lipids are a naturally occurring group of substances that are not soluble in water but are freely soluble in organic solvents." answer="True" hint="Reread the section's opening paragraph and the first paragraph of the Fatty Acids and Triacylglycerides subsection." >}}
True
False
{{< /multiplechoice >}}

{{< textin question="Lipids are composed mainly of carbon and hydrogen, but they can also contain oxygen, nitrogen, sulfur, and __________." answer="phosphorous" accept="phosphorus|P" hint="Reread the section's opening sentence." >}}

### Describe the unique characteristics and diverse structures of lipids

{{< multiplechoice question="Fatty acids having no double bonds are called “unsaturated.”" answer="False" hint="Reread the first paragraph of the Fatty Acids and Triacylglycerides subsection." >}}
True
False
{{< /multiplechoice >}}

{{< multiplechoice question="Which of the following, together with saturated fatty acids, forms the esters found in waxes?" answer="alcohols" hint="Reread the sentences on waxes and sebum in the first paragraph under the section's third subheading." >}}
hydrocarbons
hopanoids
alcohols
carbohydrates
...
{{< textin question="Cholesterol is the most common member of the __________ group, found in animal tissues; it has a tetracyclic carbon ring system with a double bond in one of the rings and one free hydroxyl group." answer="steroid" accept="sterol" hint="Reread the paragraph after the isoprenoid diagram." >}}

### Compare and contrast triacylglycerides (triglycerides) and phospholipids.

{{< multiplechoice question="Molecules bearing both polar and nonpolar groups are said to be which of the following?" answer="amphipathic" hint="Reread the paragraph after the phospholipid diagram." >}}
hydrophilic
amphipathic
hydrophobic
polyfunctional
...
{{< multiplechoice question="A triglyceride is formed by joining three glycerol molecules to a fatty acid backbone in a dehydration reaction." answer="False" hint="Compare this description with how the section says fatty acids and glycerol are joined to build a triglyceride." >}}
True
False
{{< /multiplechoice >}}

{{< selfcheck question="Describe the structure of a typical phospholipid. Are these molecules polar or nonpolar?" hint="Reread the first two paragraphs of the Phospholipids and Biological Membranes subsection." >}}
...
===CHECKS===
two fatty acid chains linked to a glycerol backbone, with a modified phosphate group in place of a third fatty acid
the phosphate group is negatively charged and therefore hydrophilic, forming the molecule's polar head
the two fatty acid chains are hydrophobic and form its nonpolar tails
it is amphipathic — neither purely polar nor purely nonpolar
{{< /selfcheck >}}

### Describe how phospholipids are used to construct biological membranes.

{{< selfcheck question="Microorganisms can thrive under many different conditions, including high-temperature environments such as hot springs. To function properly, cell membranes have to be in a fluid state. How do you expect the fatty acid content (saturated versus unsaturated) of bacteria living in high-temperature environments might compare with that of bacteria living in more moderate temperatures?" hint="Review what the section says about which fatty acid type keeps a lipid solid and which keeps it liquid." >}}
The section gives the facts this comparison rests on: lipids containing saturated fatty acids are solids at room temperature, whereas lipids containing unsaturated fatty acids are liquids, because saturated fatty acids have a straight, flexible carbon backbone and unsaturated fatty acids have "kinks" where each double bond causes a rigid bend of the carbon skeleton. The question adds that cell membranes have to be in a fluid state to function properly. The section itself does not say how the fatty acid content of bacteria from high-temperature environments compares with that of bacteria from moderate temperatures; an answer reasons from these facts about which kind of fatty acid makes a lipid solid and which keeps it liquid.
===CHECKS===
lipids containing saturated fatty acids are solids at room temperature, while lipids containing unsaturated fatty acids are liquids
saturated fatty acids have a straight, flexible backbone, and unsaturated fatty acids have kinks from their double bonds
cell membranes have to be in a fluid state to function properly
{{< /selfcheck >}}

{{< textin question="The simplest of the large-scale phospholipid assemblies that form in aqueous environments are __________, spherical assemblies containing a hydrophobic interior of phospholipid tails and an outer surface of polar head groups." answer="micelles" hint="Reread the last paragraph of the Phospholipids and Biological Membranes subsection." >}}

{{< textin question="Larger and more complex phospholipid structures are created from lipid-bilayer sheets, or __________, which are large, two-dimensional assemblies of phospholipids congregated tail to tail." answer="unit membranes" hint="Reread the last paragraph of the Phospholipids and Biological Membranes subsection." >}}

---

<small>This section is adapted from [Microbiology, Section 7.3: Lipids](https://openstax.org/books/microbiology/pages/7-3-lipids) by Nina Parker, Mark Schneegurt, Anh-Hue Thi Tu, Philip Lister, Brian M. Forster, and OpenStax, © OpenStax, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). Access the original for free at [openstax.org](https://openstax.org/details/books/microbiology). Changes: all five figures are re-encoded as WebP and rendered as mediafigures with explicit `kind="diagram"` on every one, overriding the media manifest's file-extension guess of "photo" for all five (they are drawn structural formulas and schematic diagrams, not photographs); alts are rewritten from the served images rather than reused verbatim — the micelle/lipid-bilayer figure's source alt misspelled "bilayer" as "bilyaer" and described its three structures out of the order the artwork draws them (both source-alt defects), and the isoprenoid figure's source alt misspelled "isoprene" as "Isophrene" and ran "Menthol is" together as "Menthol i s"; the sterols figure's alt is extended to note the hydroxyl (OH) group cholesterol carries, which the artwork shows but the source alt omitted; eight same-module figure cross-references (`<link target-id>`) are rendered as describing phrases ("see the diagram below," "the diagram above," "shown above"); the Link to Learning box keeps its title, its URL, and its own "video" anchor text; the Clinical Focus *Part 2* box's "Jump to the next / Go back to the previous Clinical Focus box" links are replaced with a plain-text sentence naming that the case continues in Using Biochemistry to Identify Microorganisms and began in Organic Molecules; of the section's three body Check Your Understanding bullets, the first ("why are fatty acids with only single bonds called saturated") is graded as a multiple choice from the module's own explanatory sentence, the second (the significance of phospholipids' amphipathic nature) remains a self-check because its honest answer assembles several of the module's sentences, and the third (how isoprenoids are used in technology) is graded as a sort-into-bins item whose three bins (pharmaceuticals, pigments, fragrances) and seven items are the module's own single sentence naming isoprenoid technological uses and examples; the two source Multiple Choice and three True/False items (the True/False items rendered as two-option multiple choice, `True` then `False`) keep the source's own keys and option order; of the section's two Fill in the Blank items, each has more blanks than a single field can hold, so each keeps only its most central blank as the graded item and prints the source's other keyed word(s) directly in the stem as given text (a response-mode adaptation, disclosed here and in the ledger) — the cholesterol item keeps "double bond" and "hydroxyl group" in the stem and blanks "steroid" as a `textin`; the wax-ester item keeps "fatty acids" in the stem but its blank ("alcohols") is instead rendered as a `multiplechoice`, with hydrocarbons, hopanoids, and carbohydrates as distractors drawn from the module's own vocabulary, because the module's own prose never states the word "alcohols" outside this exercise's own solution and a blind solver cannot recover a word the page never prints; the unkeyed Short Answer question (describing a typical phospholipid's structure) remains a self-check, because its honest answer both assembles several of the module's sentences and would otherwise duplicate the "amphipathic" multiple choice built from the same module fact; the unkeyed Critical Thinking question (fatty acid content of bacteria at different temperatures) remains a self-check, because answering the comparison it asks for needs an inference — how ambient temperature and fatty acid saturation interact to keep a membrane fluid — that the module states only the underlying facts for and never draws itself; its model answer gives those facts and stops, and its rubric checks only them, rather than drawing the high-temperature comparison the module never makes; two filler `textin` items (from the module's own micelle and lipid-bilayer/unit-membrane sentences) and one cloze `textin` (from the module's own composition sentence) round out three Practice groups that the section's own exercise set does not reach past two items on its own; no source exercise was omitted; key terms are compiled from the module's 17 defined terms and the book's Glossary appendix (the hyphenated body term "lipid-bilayer" takes the appendix's "lipid bilayer" entry); the module's own "phosphorous" (for the element more commonly spelled "phosphorus") is printed as the module prints it, both here and in the composition cloze, since the module uses this spelling consistently rather than as an isolated slip.</small>

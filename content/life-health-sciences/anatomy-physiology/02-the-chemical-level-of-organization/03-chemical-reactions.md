...
description: >-
  Kinetic and potential energy, the four forms of energy central to human
  functioning, the three basic types of chemical reactions, and the factors
  that influence how fast a reaction proceeds — adapted from OpenStax
  Anatomy and Physiology 2e, Section 2.3.
source_section: "2.3"
weight: 3
---
...
{{< textin
  question="The form of energy that matter possesses because of its motion is called ________."
  answer="kinetic energy"
  hint="Building a brick wall requires this kind of energy — the energy of the bricks' own motion as you lift and place them."
>}}
...
{{< textin
  question="The form of potential energy that is stored in and released from chemical bonds is called ________."
  answer="chemical energy"
  hint="This is the form of energy your body converts from the food you eat into fuel your muscle cells can use."
>}}
...
{{< selfcheck question="AB + CD → AD + BE. Is this a legitimate example of an exchange reaction? Why or why not?" hint="Compare the atoms on each side of the arrow with the atoms in AB, CD, AD, and BE — does an atom appear on one side that was never present on the other?" >}}
...
===CHECKS===
an exchange reaction might instead be AB + CD → AC + BD or AB + CD → AD + BC
the components of the reactants are identical to the components of the products
a component present among the reactants cannot disappear
a component not present in the reactants cannot suddenly appear in the products
{{< /selfcheck >}}
...
{{< selfcheck question="When you do a load of laundry, why do you not just drop a bar of soap into the washing machine? In other words, why is laundry detergent sold as a liquid or powder?" hint="Think about what happens to the surface area of a solid when it is broken into a powder or dissolved into a liquid." >}}
...
===CHECKS===
the greater the surface area of the reactants, the more quickly and easily they will interact
it takes energy to separate particles of a substance
powder and liquid laundry detergents have relatively more surface area per unit
they can quickly dissolve into their reactive components when added to the water
{{< /selfcheck >}}

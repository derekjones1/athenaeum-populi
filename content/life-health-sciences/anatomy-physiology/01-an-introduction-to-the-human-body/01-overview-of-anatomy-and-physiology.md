...
description: >-
  What anatomy and physiology each study, the four areas of anatomical
  specialization — gross, microscopic, regional, and systemic — and why the
  two disciplines are best studied together — adapted from OpenStax Anatomy
  and Physiology 2e, Section 1.1.
source_section: "1.1"
weight: 1
---
...
Like most scientific disciplines, anatomy has areas of specialization. **Gross anatomy** is the study of the larger structures of the body, those visible without the aid of magnification (see the figure below, panel a). Macro- means “large,” thus, gross anatomy is also referred to as macroscopic anatomy. In contrast, micro- means “small,” and **microscopic anatomy** is the study of structures that can be observed only with the use of a microscope or other magnification devices (panel b). Microscopic anatomy includes cytology, the study of cells and histology, the study of tissues. As the technology of microscopes has advanced, anatomists have been able to observe smaller and smaller structures of the body, from slices of large structures like the heart, to the three-dimensional structures of large molecules in the body.

{{< mediafigure src="anatomy-physiology/01_01ab_Gross_and_Microscopic_Anatomy" kind="photo" eager="true" alt="Photo A shows an entire human brain, its surface deeply folded and lumpy. Photo B is a purple-stained micrograph of brain tissue, with two arrows labeled 'Neuron cells' pointing to two roughly diamond-shaped cells with dark nuclei, surrounded by a lighter-colored web of smaller cells and fiber strands." >}}
(a) Gross anatomy considers large structures such as the brain. (b) Microscopic anatomy can deal with the same structures, though at a different scale. This is a micrograph of nerve cells from the brain. LM × 1600. (credit a: University of Wisconsin and Michigan State Comparative Mammalian Brain Collections/BrainMuseum.org; credit b: Micrograph provided by the Regents of University of Michigan Medical School © 2012)
{{< /mediafigure >}}
...
{{< multiplechoice
  ...
  hint="This scientist is studying how the body works during a specific activity, not the structures that make it up."
>}}
...
{{< textin
  question="The study of the larger structures of the body, those visible without the aid of magnification, is called ________."
  answer="gross anatomy"
  accept="macroscopic anatomy"
  hint="This kind of study covers structures large enough to see with the unaided eye — no magnification needed."
>}}

{{< textin
  question="The study of structures that can be observed only with the use of a microscope or other magnification device is called ________."
  answer="microscopic anatomy"
  hint="This branch of study includes cytology, the study of cells, and histology, the study of tissues."
>}}

{{< textin
  question="The study of the interrelationships of all of the structures in one specific body region, such as the abdomen, is called ________."
  answer="regional anatomy"
  hint="This approach considers everything in one place — muscles, nerves, blood vessels — working together, rather than one body system at a time."
>}}

{{< textin
  question="The study of the structures that make up one discrete body system, a group of structures that work together to perform a unique body function, is called ________."
  answer="systemic anatomy"
  hint="A study of the muscular system taken this way would consider all of the skeletal muscles of the body."
>}}

### Discuss the fundamental relationship between anatomy and physiology

{{< selfcheck question="Name at least three reasons to study anatomy and physiology." hint="Think beyond a health career alone — about the choices, understanding, and roles this knowledge supports in everyday life." >}}
...
===CHECKS===
essential for any career in the health professions
can help you make choices that promote your health
respond appropriately to signs of illness
make sense of health-related news
...
she has experienced her heart beating every moment of her life
has probably felt her pulse
has at least a basic understanding of the role of the heart in pumping blood throughout her body
this understanding of the heart's function (physiology) would support her study of the heart's form (anatomy)
{{< /selfcheck >}}

{{< textin
  question="The state of steady internal conditions that living things maintain is called ________."
  answer="homeostasis"
  accept="homoeostasis"
  hint="Much of the study of physiology centers on the body's tendency toward this steady state."
>}}

---

<small>This section is adapted from [Anatomy and Physiology 2e, Section 1.1: Overview of Anatomy and Physiology](https://openstax.org/books/anatomy-and-physiology-2e/pages/1-1-overview-of-anatomy-and-physiology) by J. Gordon Betts, Peter Desaix, Eddie Johnson, Jody E. Johnson, Oksana Korol, Dean Kruse, Brandon Poe, James A. Wise, Mark Womble, Kelly A. Young, and OpenStax, © OpenStax, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). Access the original for free at [openstax.org](https://openstax.org/details/books/anatomy-and-physiology-2e). Changes: the two source cross-references to "Figure 1.2 (a)" and "(b)" replaced with a plain description of the figure's position on the page; the figure re-encoded as WebP; its `kind` set explicitly to "photo" (both panels are photographs); its alt rewritten from the source's to describe both panels plainly and name the "Neuron cells" label the source alt omitted; both Review Questions and both Critical Thinking Questions adapted into the closing interactive Practice block (multiple choice and self-check respectively), using all four of the module's keyed exercises; rubric checkpoints added to each self-check, decomposing its model answer (the source solution) into check-off clauses with no new claims; five key-term recall items (gross anatomy, microscopic anatomy, regional anatomy, systemic anatomy, homeostasis) added from the module's glossary, which lists seven terms in full under Key terms; the two headline terms, anatomy and physiology, are not recall items because every other item's options and hints necessarily print those words, so a recall key would be leaked by its siblings.</small>

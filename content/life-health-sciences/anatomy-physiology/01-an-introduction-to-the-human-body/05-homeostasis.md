...
title: Homeostasis
description: >-
  Set points and normal ranges, and how negative and positive feedback loops
  keep the body's physiological state within a survivable range — adapted
  from OpenStax Anatomy and Physiology 2e, Section 1.5.
source_section: "1.5"
weight: 5
---
...
Water concentration in the body is critical for proper functioning. A person's body retains very tight control on water levels without conscious control by the person. Watch [a video about water concentration in the body](http://openstax.org/l/H2Ocon) to learn more. Which organ has primary control over the amount of water in the body?
{{< /callout >}}
...
Childbirth at full term is an example of a situation in which the maintenance of the existing body state is not desired. Enormous changes in a person's body are required to expel the baby at the end of pregnancy. And the events of childbirth, once begun, must progress rapidly to a conclusion or the life of a person giving birth and the baby are at risk. The extreme muscular work of labor and delivery are the result of a positive feedback system, illustrated below.

{{< mediafigure src="anatomy-physiology/106_Pregnancy-Positive_Feedback" kind="diagram" alt="A positive feedback loop diagram: an infant lying head-down inside a cross-sectioned uterus, encircled by five labeled steps connected by curved arrows that cycle back to the start, from the head pushing against the cervix through nerve, brain, and hormone signals to stronger uterine contractions." longdesc="Five labeled steps arranged clockwise around the central image of the infant in the uterus, each connected to the next by a curved arrow, the last arrow returning to the first: Head of baby pushes against cervix; Nerve impulses from cervix transmitted to brain; Brain stimulates pituitary gland to secrete oxytocin; Oxytocin carried in bloodstream to uterus; Oxytocin stimulates uterine contractions and pushes baby toward cervix — and the cycle repeats, with the contractions growing stronger and more frequent as the head presses harder against the cervix, until birth ends the loop." >}}
...
{{< textin
  question="The feedback-system component that monitors a physiological value and reports it to the control center is called the ________."
  answer="sensor"
  accept="receptor"
  hint="This component detects the changing value, before the control center does anything with it."
>}}
...
the control center would in turn activate an effector
...
this would reduce blood flow to your skin, and shunt blood returning from your limbs into a network of deep veins
the heat-gain center would increase your muscle contraction, causing you to shiver
this increases the energy consumption of skeletal muscle and generates more heat
your body would also produce thyroid hormone and epinephrine, chemicals that promote increased metabolism and heat production
{{< /selfcheck >}}

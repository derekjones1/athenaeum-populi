...
description: >-
  How pollen reaches the stigma by self- or cross-pollination and the animal,
  wind, and water agents that carry it, then how double fertilization gives
  rise to the zygote and endosperm, the developing seed, and the fruit that
  disperses it — adapted from OpenStax Biology 2e, Section 32.2.
source_section: "32.2"
weight: 2
---
...
{{< callout type="info" >}}
**Link to Learning.** Explore [this interactive lesson on self-pollination and cross-pollination](https://openstax.org/l/pollination).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_32_02_01" kind="photo" eager="true" alt="A close-up photo of a bee whose body and legs are thickly coated in dusty yellow pollen grains." >}}
...
{{< mediafigure src="biology/Figure_32_02_03" kind="photo" alt="A hummingbird hovering in flight beside a cluster of small purple tubular flowers, its long thin beak inserted into one blossom to drink nectar." >}}
...
{{< mediafigure src="biology/Figure_32_02_04" kind="photo" alt="A person's arm, in a red sleeve, reaching into green pine branches and releasing a visible cloud of pale pollen dust into the air." >}}
...
{{< mediafigure src="biology/Figure_32_02_06" kind="photo" alt="A close-up photo of a pink orchid flower whose furry, dark brown and yellow center mimics the shape of a bee." >}}
...
{{< mediafigure src="biology/Figure_32_02_07" kind="diagram" alt="A four-panel diagram tracing double fertilization: a pollen grain adhering to the stigma, its pollen tube growing down through the style and ovary to an ovule's micropyle, and the ovule's embryo sac — egg, synergids, polar nuclei, sperm nuclei, and antipodals — where one sperm fertilizes the egg and the other fuses with the polar nuclei." longdesc="Four panels run left to right, the first three drawn as the same pear-shaped pistil, the fourth a separate egg-shaped embryo sac. Panel 1 is labeled 'Stigma' at its two-lobed top, 'Pollen grain' pointing to a small pink oval resting on the stigma, 'Style' pointing to the narrow neck below it, and 'Ovary' bracketing the bulbous base holding six pale ovules in three pairs; its caption reads 'The pollen grain adheres to the stigma, which contains two cells: a generative cell and a tube cell.' A black arrow leads to panel 2, labeled 'Pollen tube' (a pink tube now growing down through the style) and 'Sperm' (two small blue dots partway down the tube); its caption reads 'The pollen tube cell grows into the style. The generative cell travels inside the pollen tube. It divides to form two sperm.' A second black arrow leads to panel 3, labeled 'Ovules' (pointing into the ovary), 'Egg,' and 'Polar nuclei' (small dots at the base of the tube inside one ovule); its caption reads 'The pollen tube penetrates an opening in the ovule called a micropyle.' A curved gray arrow leads from panel 3's ovule into panel 4, the embryo sac, labeled 'Micropyle' (the reddish opening at top), 'Egg' (an orange oval beside it), 'Synergids' (two small structures flanking the egg), 'Polar nuclei' (a large central purple circle), 'Sperm nuclei' (two small blue dots), 'Antipodals' (three green dots at the bottom), and 'Embryo sac' naming the whole circle; its caption reads 'One of the sperm fertilizes the egg to form the diploid zygote. The other sperm fertilizes two polar nuclei to form the triploid endosperm, which will become a food source for the growing embryo.'" >}}
...
After fertilization, the zygote divides to form two cells: the upper cell, or terminal cell, and the lower, or basal, cell. The division of the basal cell gives rise to the **suspensor**, which eventually makes connection with the maternal tissue. The suspensor provides a route for nutrition to be transported from the mother plant to the growing embryo. The terminal cell also divides, giving rise to a globular-shaped proembryo (a). In dicots (eudicots), the developing embryo has a heart shape, due to the presence of the two rudimentary **cotyledons** (b). In non-endospermic dicots, such as *Capsella bursa*, the endosperm develops initially, but is then digested, and the food reserves are moved into the two cotyledons. As the embryo and cotyledons enlarge, they run out of room inside the developing seed, and are forced to bend (c). Ultimately, the embryo and cotyledons fill the seed (d), and the seed is ready for dispersal. Embryonic development is suspended after some time, and growth is resumed only when the seed germinates. The developing seedling will rely on the food reserves stored in the cotyledons until the first set of leaves begin photosynthesis.

{{< mediafigure src="biology/Figure_32_02_08abcd_a" kind="photo" alt="Four labeled light micrographs (a–d) tracing embryo development in a shepherd's-purse seed: a small globular proembryo atop its suspensor inside the ovule, the embryo enlarging into a heart shape with two cotyledon lobes, the cotyledons elongating and bending to fit the seed, and the mature embryo filling the seed with its root and shoot meristems formed." longdesc="Four micrographs of a shepherd's-purse ovule are arranged in a 2×2 grid, labeled (a)–(d), each with its own scale bar. (a) (scale 25 µm) shows a slender proembryo growing atop its suspensor, with the suspensor's basal cell at the bottom, inside the surrounding ovule tissue. (b) (scale 50 µm) shows the embryo enlarged into a small forked mass labeled 'Cotyledons' at its top, above the 'Embryo' proper, still attached to its 'Suspensor' and 'Basal cell' below. (c) (scale 100 µm) shows the embryo grown heart-shaped, its two 'Cotyledons' curving around a central dark 'Embryonic axis,' surrounded by paler 'Endosperm' tissue. (d) (scale 100 µm) shows the mature embryo filling the seed, its two elongated 'Cotyledons' folded alongside each other, a 'Root meristem' at the base, a 'Shoot meristem' at the top between the two cotyledons, and a 'Seed coat' surrounding the whole seed." >}}
...
{{< mediafigure src="biology/Figure_32_02_09" kind="diagram" alt="A side-by-side diagram of a dicot bean seed and a monocot corn seed in cross-section, each labeled with its seed coat, cotyledon(s), and embryo parts (epicotyl, hypocotyl, radicle); the corn kernel additionally shows the pale endosperm filling its upper half, which the bean lacks." longdesc="Two labeled seed cross-sections sit side by side, 'Bean seed (dicot)' at left and 'Corn seed (monocot)' at right, each bracketed 'Embryo.' Between them, five shared labels each send one line to the bean and a second line to the corn: 'Epicotyl' (a small nub near the top of the bean's two lobes; the corn's is drawn in the lower part of its single cotyledon), 'Hypocotyl,' 'Radicle,' 'Cotyledon' (the bulk of the bean's two rounded green lobes; the corn's single, larger orange cotyledon, or scutellum), and 'Seed coat' (the thin outer layer of each seed). An 'Endosperm' label, with no counterpart on the bean, points to the pale tissue filling the upper half of the corn kernel." >}}
...
{{< mediafigure src="biology/Figure_32_02_10" kind="diagram" alt="An illustration of a germinating monocot grass seed: a short, thick, blunt coleoptile curves down and left from the kernel, a long radicle extends downward and ends in a small yellow coleorhiza tip, and two shorter adventitious roots emerge alongside it." longdesc="A germinating monocot grass seed is drawn as a tan kernel at upper left. From its underside a short, thick, blunt pale-green coleoptile curves down and to the left, its rounded tip paler. Two thinner adventitious roots, bracketed together, leave the same point: one arcs up and to the right and hooks down, the other hangs straight down, each with a pale yellow tip. A longer radicle extends straight down from the kernel, ending in a small yellow-tipped coleorhiza." >}}
...
{{< textin
  question="The transfer of pollen from the anther of one flower to the stigma of a different flower is called ________."
  answer="cross-pollination"
  accept="out-crossing|outcrossing"
  hint="Because it draws genetic material from two different plants, this method produces greater genetic diversity than the alternative."
>}}
...
{{< multiplechoice
  question="Cross-pollination requires pollinating agents such as water, wind, or animals, and increases ________."
  answer="genetic diversity"
  hint="Because the male and female gametes come from two different plants rather than one, offspring inherit a broader mix of alleles."
>}}
genetic diversity
seed dormancy
fruit development
...
{{< multiplechoice
  ...
  answer="seed"
  hint="This structure directly develops from the mature ovule and contains a coat, cotyledons, endosperm, and a single embryo."
>}}
fruit
seed
endosperm
...
{{< multiplechoice
  question="The ________ is the outermost covering of a fruit."
  answer="exocarp"
  hint="This is one of three fruit-wall layers — together called the pericarp — and it sits farthest from the seed, with the mesocarp and endocarp beneath it."
>}}
endocarp
pericarp
exocarp
...
dormancy allows seeds to tide over unfavorable conditions and germinate on return to favorable conditions
...
fruits dispersed by water are light and buoyant, giving them the ability to float, as in coconuts
animals and birds eat fruits and disperse their seeds by leaving droppings at distant locations, and some fruits stick to animals' bodies and are carried to new locations
people also contribute to seed dispersal when they carry fruits to new places
{{< /selfcheck >}}
...
{{< multiplechoice
  ...
  answer="endosperm"
  hint="This triploid tissue results when the second sperm cell fuses with the two polar nuclei, and it nourishes the developing embryo."
>}}
an ovule
endosperm
a cotyledon
...
{{< textin
  question="The two fertilization events of angiosperms — one sperm fusing with the egg to form the zygote, the other fusing with the polar nuclei to form the endosperm — are together called ________."

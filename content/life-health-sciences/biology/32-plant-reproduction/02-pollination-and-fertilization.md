...
{{< mediafigure src="biology/Figure_32_02_08abcd_a" kind="photo" alt="Four labeled light micrographs (a–d) tracing embryo development in a shepherd's-purse seed: a small globular proembryo atop its suspensor inside the ovule, the embryo enlarging into a heart shape with two cotyledon lobes, the cotyledons elongating and bending to fit the seed, and the mature embryo filling the seed with its root and shoot meristems formed." longdesc="Four micrographs of a shepherd's-purse ovule are arranged in a 2×2 grid, labeled (a)–(d), each with its own scale bar. (a) (scale 25 µm) shows a small, round, dark 'Proembryo' growing atop its 'Suspensor,' a short column of cells, with the suspensor's basal cell at the bottom, inside the surrounding ovule tissue. (b) (scale 50 µm) shows the embryo enlarged into a small forked mass labeled 'Cotyledons' at its top, above the 'Embryo' proper, still attached to its 'Suspensor' and 'Basal cell' below. (c) (scale 100 µm) shows the embryo grown long and bent over: a dark column labeled 'Embryonic axis' rises along the left side, and its two 'Cotyledons' arch over the top and down to the right, with paler 'Endosperm' tissue above and beside them. (d) (scale 100 µm) shows the mature embryo filling the seed, its two elongated 'Cotyledons' folded alongside each other, a 'Root meristem' at the base, a 'Shoot meristem' at the top between the two cotyledons, and a 'Seed coat' surrounding the whole seed." >}}
...
{{< textin
  ...
  hint="Read the paragraph that contrasts the two pollination methods, just after self-pollination is defined."
>}}
...
{{< multiplechoice
  ...
  hint="Reread the Section Summary sentence about pollinating agents, or the paragraph contrasting self- and cross-pollination."
>}}
genetic diversity
seed dormancy
fruit development
...
{{< multiplechoice
  ...
  answer="exocarp"
  hint="Look at the sentence in Development of Fruit and Fruit Types that names the three parts of a fruit."
>}}
endocarp
pericarp
exocarp

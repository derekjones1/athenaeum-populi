...
description: >-
  The two-stage alternation of generations that structures plant sexual
  reproduction, from the whorls of a complete flower and the formation of
  pollen and the embryo sac in angiosperms to the separate male and female
  cones of gymnosperms — adapted from OpenStax Biology 2e, Section 32.1.
source_section: "32.1"
weight: 1
---
...
{{< mediafigure src="biology/Figure_37_01_01" kind="diagram" eager="true" alt="A two-tier flow diagram: a yellow 1n band on top, a green 2n band below. A dark-green Microsporophyte (left) and Megasporophyte (right) each send a Meiosis arrow up to Microspores and a Megaspore. Mitosis arrows lead to an oval Microgametophyte and a larger oval Megagametophyte, both full of small circles. A Sperm line and an Egg circle meet at Fusion, forming two dots labeled Zygote, with Mitosis arrows curving back down into both sporophytes." longdesc="Reading left to right, top (1n, haploid) to bottom (2n, diploid): the diploid Microsporophyte (dark green oval, lower left, a small cluster at its left end circled and labeled Microsporangium) sends a curved line up into the 1n band, where it splits at the Meiosis label into four arrows ending at four small circles labeled Microspores; a Mitosis arrow leads from one of them right to an oval Microgametophyte packed with small circles. An arrow leads from the microgametophyte down to a small circle with a squiggly tail marked Sperm. Mirroring this on the right, the diploid Megasporophyte (dark green oval, lower right, a small cluster at its right end circled and labeled Megasporangium) sends a curved line up that splits at the Meiosis label into four arrows, ending at one large circle and three tiny ones, labeled Megaspore; a Mitosis arrow leads from the large one left to a larger oval Megagametophyte, and an arrow leads from it down to a circle marked Egg. Lines from the sperm and the egg cross at the label Fusion, and two arrows lead on to two green dots labeled Zygote, just below the boundary, in the 2n band. Two Mitosis arrows lead from the zygote back down into the Microsporophyte (left) and the Megasporophyte (right), closing the cycle." >}}
...
{{< mediafigure src="biology/Figure_32_01_02" kind="diagram" alt="A yellow, trumpet-shaped flower at top with a green carpel and a stamen boxed in black, labeled Petal and Sepal on the outer parts and Androecium pointing to the boxed stamen structures; a line labeled Perianth brackets the petals and sepals together. Gray arrows lead from the boxed carpel and boxed stamen down to two enlarged panels below: a green vase-shaped Gynoecium (carpels) drawing labeled Stigma, Style, Ovary, and Ovules (megasporangia), and a green Androecium (stamens) drawing labeled Filament, Anther, Microsporangia, and Pollen grain." longdesc="At the top, a whole yellow flower is drawn with a central green carpel and one stamen, each outlined by a black box. Lines from the flower point to Petal (the yellow lobe) and Sepal (the green base); a bracket labeled Perianth spans Corolla (composed of petals) and Calyx (composed of sepals); two lines from the label Androecium point to two of the stamens, one of them boxed. A gray arrow leads down-left from the boxed carpel to the bottom-left panel, Gynoecium (carpels): a vase-shaped green drawing labeled, top to bottom, Stigma (the tip), Style (the narrow neck), and Ovules (megasporangia) (oval shapes inside), with a bracket labeling the whole lower bulb Ovary. A second gray arrow leads down-right from the boxed stamen to the bottom-right panel, Androecium (stamens): a green filament topped by a yellow anther, labeled Filament (the stalk), Anther (a bracket around the yellow lobe), Microsporangia (two lines to two of the anther's yellow lobes), and Pollen grain (a line to one of the orange spheres packed inside a cut-open lobe; a few more lie outside the anther)." >}}
...
{{< selfcheck question="If the anther is missing, what type of reproductive structure will the flower be unable to produce? What term is used to describe an incomplete flower lacking the androecium? What term describes an incomplete flower lacking a gynoecium?" hint="The figure's Androecium panel shows what the anther holds; the paragraph right after the figure names the two types of incomplete flower." >}}
...
{{< mediafigure src="biology/Figure_32_01_03" kind="diagram" alt="A hand-colored botanical illustration of a corn plant, roots to tassel. Lines label Staminate flowers at the feathery tassel on top, Carpellate flowers at the silk-topped immature ear partway down the stem, Stem and root at the base, Corn kernels at two loose kernels drawn beside the base of the stem (the husked mature ear at the right carries no label), Silk (stigma) at strands hanging from the ear, and Ovary at small pod-like shapes near the stem base." >}}
...
{{< mediafigure src="biology/Figure_32_01_04ab" kind="diagram" alt="Top: two yellow trumpet-flower line drawings side by side, alike except that each has a green gynoecium bulging above or below the petals; lines label Petals, Sepals, and Gynoecium on each. Bottom: two photographs, (a) a red-orange lily blossom growing among grass with its gynoecium held above the petals, and (b) three red fuchsia blossoms hanging downward with their gynoecium swelling below the petals." longdesc="Two labeled line drawings of a generic flower sit above two photographs. In the left drawing, the green gynoecium bulges above where the petals attach, matching (a) below it; in the right drawing, the gynoecium bulges below the petals, matching (b). Both drawings carry the same three labels — Petals (the yellow lobes), Sepals (the green base), and Gynoecium (the swollen green structure) — pointing to the corresponding part in each. Below them, photo (a) shows an orange-red lily in a grassy field, its petals spread wide with the gynoecium visible rising from the flower's center; photo (b) shows fuchsia flowers hanging point-down from a stem — two open, with the swollen ovary near the stem and narrow petals trailing below, and a closed bud beside them with smaller buds above." >}}
...
{{< mediafigure src="biology/Figure_37_01_02" kind="diagram" alt="Two four-lobed, clover-shaped anther cross sections stacked, joined by a downward arrow. Top (immature): four separate lobes, each with a yellow center ringed in orange; labels mark two lobes Pollen sacs (microsporangia), and on one lobe Microspore mother cells points to the ring of small cells, Tapetum to the center (apparently swapped). Bottom (mature): the lobes have fused into two yellow chambers of oval grains, labeled Pollen grains, split open at the left and right sides. Micrograph (b) shows a similar four-lobed section with dark clustered grains, one lobe labeled Microsporangium." longdesc="Panel (a), top: an immature anther in cross section is a four-lobed, clover-shaped cluster of green tissue. Each of the four lobes holds a yellow center edged by a ring of small cells, with an orange band outside that. A line from the label Pollen sacs (microsporangia) points to two of the four lobes (the left pair). On a third lobe (lower right), two lines from Microspore mother cells end on the ring of small cells (one of them just inside the orange band), and a line from Tapetum ends inside the yellow center; as drawn these lines appear swapped, since the section's text describes the tapetum as an inner layer of cells nourishing the microspores, with the mother cells within it. A small pale circle of tissue sits at the very center of the cross, between the four lobes, unlabeled. A black arrow points down to panel (a), bottom: the mature anther, where each pair of adjacent lobes has fused and split open, leaving two large yellow chambers full of small oval pollen grains — two lines from Pollen grains point into the left chamber — with the wall split open at the middle of the left and right sides, a few grains escaping through each gap. Panel (b), to the right: a micrograph of a similar four-lobed cross section, each lobe packed with dark-stained grains, with an arrow pointing to one lobe labeled Microsporangium." >}}
...
{{< mediafigure src="biology/Figure_32_01_07" kind="diagram" alt="An egg-shaped diagram of the embryo sac, labeled Chalazal end at the broad, rounded top and Micropylar end at the narrower bottom, where the wall has a small notch. Near the top, three green Antipodal cells cluster together. Below them, a purple Central cell holds two small dots labeled Polar nuclei. Near the bottom, two pink Synergid cells sit beside one yellow Egg cell." longdesc="Reading from the chalazal end (top) to the micropylar end (bottom): at the top, three green Antipodal cells cluster together, with three lines converging on the label Antipodals. Below them, a large purple Central cell fills the middle of the sac; two small dots inside it are labeled Polar nuclei, and a separate line from the label Central cell (at lower left) points to the same purple cell. Near the bottom, two pink Synergid cells sit side by side, with one yellow Egg cell between and just below them, next to a small notch in the wall at the bottom; a line points to each synergid and another to the egg cell." >}}
...
{{< mediafigure src="biology/Figure_32_01_08" kind="diagram" alt="A life cycle in three green panels linked by gray block arrows, beside two photographs. Top panel: a conifer tree labeled Sporophyte (2n) (mature tree), with arrows to drawings of a female cone and a male cone. An arrow leads down to a cutaway cone-scale panel labeled Pollen grain, Pollen tube, Ovule, Scale, Megaspore (1n), Generative (sperm) nuclei (1n), and Tube nucleus. Another arrow leads left to seven ovals labeled Seeds (2n). Beside the diagram, photographs are labeled Female cone and Male cone." longdesc="Three pale-green panels are linked by gray block arrows, with two photographs alongside. The top panel, spanning the width, is labeled Sporophyte (2n) (mature tree) and shows a conifer tree; two black arrows lead right from it, one to a drawing of a closed brown cone captioned 'Female cones grow in the upper branches where they may be fertilized by pollen blown on the wind from the male cones,' the other to a drawing of a slender tan cone captioned 'Male cones grow in the lower branches.' A gray block arrow points down from the top panel to the bottom-middle panel, a cutaway drawing of a cone scale labeled Pollen grain, Pollen tube, and Ovule at the top, Scale at the right, and Megaspore (1n), Generative (sperm) nuclei (1n), and Tube nucleus at the bottom, captioned 'A pollen tube forms, allowing the pollen to migrate toward the female gametophyte. Upon fertilization, a diploid zygote forms.' A second gray block arrow points left from that panel to the bottom-left panel, labeled Seeds (2n), showing seven oval seed shapes, captioned 'Seeds are dispersed and grow into mature trees.' To the right of the diagram, two separate photographs show an actual Female cone (large, brown, and closed) above an actual Male cone (slender and upright, curving slightly, a column of small brownish scales on a needle-bearing twig)." >}}
...
{{< mediafigure src="biology/Figure_32_01_10ab" kind="photo" alt="Two side-by-side photographs: (a) a broad weeping tree in fresh pale-green spring leaf on a lawn, its long drooping branches held up on metal props, and (b) a pine with a wind-shaped crown on a rocky slope in warm low sunlight." >}}
...
{{< callout type="info" >}}
**Link to Learning.** View [an animation of the double fertilization process of angiosperms](https://www.openstax.org/l/angiosperms).
{{< /callout >}}
...
the gametophyte stage begins when meiosis produces haploid spores
spores divide by cell division to form haploid plant structures, some of which form sex cells
fertilization, the joining of haploid sex cells, begins the diploid sporophyte stage
meiosis in the sporophyte forms spores again, in a process called alternation of generations
{{< /selfcheck >}}

### Compare and contrast male and female gametophytes and explain how they form in angiosperms

{{< multiplechoice
  question="In a plant's male reproductive organs, development of pollen takes place in a structure known as the ________."
  answer="microsporangium"
  hint="Reread the opening paragraph of Male Gametophyte (The Pollen Grain)."
>}}
stamen
microsporangium
anther
...
the carpel is the female reproductive organ, and the ovary is the swollen base of the carpel where ovules are found
not all flowers have every one of the four parts
{{< /selfcheck >}}
...
{{< multiplechoice
  question="The stamen consists of a long stalk called the filament that supports the ________."
  answer="anther"
  hint="Reread the Summary sentence on what the stamens are made of."
>}}
stigma
sepal
style
...
{{< multiplechoice
  question="The ________ are collectively called the calyx."
  answer="sepals"
  hint="Reread the opening paragraph of Flower Structure, which walks the whorls from the outside in."
>}}
sepals
petals
tepals
...
the corolla is the second whorl, made of brightly colored petals
the androecium is the male reproductive structure, with stamens bearing anthers on a filament
...
if any of the four parts is missing, it is known as incomplete
those that contain only an androecium are known as staminate flowers, and those that have only carpels are known as carpellate
male and female flowers on the same plant is monoecious, while separate plants is dioecious
{{< /selfcheck >}}
...
{{< textin
  question="In a gymnosperm, the female gametophyte is contained within a structure called the ________."
  answer="archegonium"
  accept="archegonia"
  hint="Reread the last sentence of the gymnosperm Female Gametophyte paragraph."
>}}

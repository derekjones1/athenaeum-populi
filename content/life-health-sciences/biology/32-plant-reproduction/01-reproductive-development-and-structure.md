...
{{< selfcheck question="If the anther is missing, what type of reproductive structure will the flower be unable to produce? What term is used to describe an incomplete flower lacking the androecium? What term describes an incomplete flower lacking a gynoecium?" hint="Work through the definitions of staminate and carpellate flowers from what each whorl actually is missing." >}}
...
{{< mediafigure src="biology/Figure_32_01_07" kind="diagram" alt="An egg-shaped diagram of the embryo sac, labeled Chalazal end at the narrow top and Micropylar end at the narrow bottom. Near the top, three green Antipodal cells cluster together. Below them, a purple Central cell holds two small dots labeled Polar nuclei. Near the bottom, two pink Synergid cells sit beside one yellow Egg cell." longdesc="Reading from the chalazal end (top) to the micropylar end (bottom): at the top, three green Antipodal cells cluster together, with three lines converging on the label Antipodals. Below them, a large purple Central cell fills the middle of the sac; two small dots inside it are labeled Polar nuclei, and a separate line from the label Central cell (at lower left) points to the same purple cell. Near the bottom, two pink Synergid cells sit side by side next to one yellow Egg cell; a line points to each synergid and another to the egg cell." >}}
...
{{< multiplechoice
  ...
  hint="This tissue lies inside the anther, where the microspore mother cells actually divide by meiosis — not the anther itself, which houses it."
>}}
stamen
microsporangium
anther
...
{{< multiplechoice
  ...
  answer="stigma"
  hint="This is the flat structure at the top of the carpel, reached before the pollen tube grows down through the narrow neck beneath it."
>}}
stigma
style
ovule
...
{{< multiplechoice
  ...
  answer="anther"
  hint="This structure sits atop the filament and holds the microsporangia, or pollen sacs — it is not part of the gynoecium at all."
>}}
stigma
sepal
style
...
{{< multiplechoice
  ...
  answer="sepals"
  hint="These are the outermost, usually green, leafy structures that protect the unopened bud."
>}}
sepals
petals
tepals
...
{{< textin
  question="The tissue that gives rise to the microspores, or pollen grain, is called the ________."
  answer="microsporangium"
  accept="microsporangia"
  hint="In a male gymnosperm cone, this tissue lies within the microsporophylls, where microsporocytes divide by meiosis into four haploid microspores."
>}}
...
{{< textin
  ...
  hint="In a female gymnosperm cone, this tissue lies within the megasporophylls, where a megaspore mother cell divides by meiosis into four haploid megaspores."
>}}

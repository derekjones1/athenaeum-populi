---
title: "Knowledge Check: Unit 8 — Chapters 44–47"
description: >-
  A cumulative self-test on Unit 8, Ecology — ecology and the biosphere,
  population and community ecology, ecosystems, and conservation biology
  and biodiversity — with every question written from the chapters' own
  text in OpenStax Biology 2e.
source_chapters: "44-47"
weight: 55
---

{{< callout type="info" >}}
  **Test yourself on Unit 8: Ecology (Chapters 44–47).** Every question below was written from
...
{{< multiplechoice
  question="The Karner blue butterfly (*Lycaeides melissa samuelis*) is a specialist because its females will only oviposit (lay eggs) on which plant?"
  answer="wild lupine"
>}}
milkweeds
aspen
...
A population's area may have natural or artificial boundaries. Natural boundaries might be rivers, mountains, or deserts, while artificial boundaries may be mowed grass, manmade structures, or roads.
===CHECKS===
natural boundaries might be rivers, mountains, or deserts
artificial boundaries may be mowed grass, manmade structures, or roads
{{< /selfcheck >}}

### 44.2 Biogeography

{{< textin
  question="Estivation allows animals to survive the hostile conditions of a hot, dry climate; the corresponding adaptation that enables animals to survive cold conditions is called ________."
  answer="hibernation"
>}}

{{< multiplechoice
  question="Which abiotic factor does the jack pine (*Pinus banksiana*) require in order for its seed cones to open?"
  answer="fire"
>}}
fire
wind
...
{{< selfcheck question="How do marine organisms address the challenge of living in water with a higher solute concentration than their own bodies, and what specific adaptation does the marine iguana (*Amblyrhynchus cristatus*) use?" >}}
Marine organisms are surrounded by water with a higher solute concentration than the organism and are in danger of losing water to the environment because of osmosis. They have morphological and physiological adaptations to retain water and release solutes into the environment. For example, marine iguanas sneeze out water vapor that is high in salt in order to maintain solute concentrations within an acceptable range while swimming in the ocean and eating marine plants.
===CHECKS===
marine organisms are surrounded by water with a higher solute concentration than the organism
they are in danger of losing water to the environment because of osmosis
marine iguanas sneeze out water vapor that is high in salt to maintain solute concentrations within an acceptable range
{{< /selfcheck >}}

### 44.3 Terrestrial Biomes

{{< multiplechoice
  question="Which terrestrial biome's vegetation is characterized by adaptations such as deep roots, reduced foliage, and water-storing stems that conserve water?"
  answer="subtropical deserts"
>}}
...
Because of the moderate annual rainfall and temperatures, deciduous trees are the dominant plant in temperate forests. Deciduous trees lose their leaves each fall and remain leafless in the winter, so no photosynthesis occurs in the deciduous trees during the dormant winter period. Because of this dormant period, the net primary productivity of temperate forests is less than that of tropical wet forests.
===CHECKS===
deciduous trees are the dominant plant in temperate forests because of the moderate annual rainfall and temperatures
deciduous trees lose their leaves each fall and remain leafless in the winter
no photosynthesis occurs in the deciduous trees during the dormant winter period
the net primary productivity of temperate forests is less than that of tropical wet forests
{{< /selfcheck >}}
...
{{< multiplechoice
  question="What is the name for the phenomenon in which rising ocean temperatures cause coral reefs to lose their symbiotic, food-producing algae and much of their color?"
  answer="bleaching"
>}}
algal bloom
bleaching
...
{{< textin
  question="The study of the effects of climatic conditions on the timing of periodic life-cycle events, such as flowering in plants or migration in birds, is called ________."
  answer="phenology"
>}}
...
{{< multiplechoice
  question="Which limitation of the mark and recapture method would cause scientists to underestimate a population's size?"
...
A large population size results in a higher birth rate because more potentially reproductive individuals are present. A large population size can also result in a higher death rate because of competition, disease, and the accumulation of waste. A higher population density or a clumped dispersion pattern results in more potential reproductive encounters between individuals, which can increase birth rate.
===CHECKS===
a large population size results in a higher birth rate because more potentially reproductive individuals are present
a large population size can also result in a higher death rate because of competition, disease, and the accumulation of waste
a higher population density or a clumped dispersion pattern results in more potential reproductive encounters between individuals, which can increase birth rate
{{< /selfcheck >}}
...
===CHECKS===
organisms that reproduce at an early age have a greater chance of producing offspring
this is usually at the expense of their growth and the maintenance of their health
organisms that start reproducing later in life often have greater fecundity or are better able to provide parental care
they risk that they will not survive to reproductive age
{{< /selfcheck >}}
...
{{< multiplechoice
  question="What happens to population growth when the number of individuals in a population exceeds its carrying capacity?"
  answer="the population undergoes a decline"
>}}
the population continues to grow at its maximal rate
the population undergoes a decline
the population's growth levels off with little change in size
{{< /multiplechoice >}}

{{< selfcheck question="How does population size behave in real-world logistic growth examples like sheep and harbor seals, compared to the idealized S-shaped curve?" >}}
...
===CHECKS===
the population size exceeds the carrying capacity for short periods of time and then falls below the carrying capacity afterward
this fluctuation continues to occur as the population oscillates around its carrying capacity
even with this oscillation, the logistic model is confirmed
{{< /selfcheck >}}

### 45.4 Population Dynamics and Regulation

{{< selfcheck question="Why have many population biologists abandoned or modified r- and K-selection theory?" >}}
Over the years, several studies attempted to confirm the theory, but these attempts have largely failed. Many species were identified that did not follow the theory's predictions. Furthermore, the theory ignored the age-specific mortality of the populations, which scientists now know is very important.
===CHECKS===
several studies attempted to confirm the theory, but these attempts largely failed
many species were identified that did not follow the theory's predictions
the theory ignored the age-specific mortality of populations, which scientists now know is very important
{{< /selfcheck >}}

{{< multiplechoice
  question="In a study of the giant intestinal roundworm (*Ascaris lumbricoides*), denser parasite populations exhibited ________."
  answer="lower fecundity, containing fewer eggs"
>}}
higher fecundity, containing more eggs
fecundity unaffected by population density
lower fecundity, containing fewer eggs
{{< /multiplechoice >}}
...
{{< multiplechoice
  question="Long-term exponential human population growth carries the potential risks of ________."
...
{{< multiplechoice
  question="Age structure allows better prediction of population growth and also lets scientists associate that growth with ________."
  answer="the region's level of economic development"
>}}
the region's biotic potential
the region's level of economic development
the region's carrying capacity
{{< /multiplechoice >}}

{{< selfcheck question="How have countries attempted to address the environmental effects of population growth, and what has limited these efforts?" >}}
Many countries have attempted to reduce the human impact on climate change by reducing their emission of the greenhouse gas carbon dioxide. However, these treaties have not been ratified by every country. The role of human activity in causing climate change has become a hotly debated socio-political issue in some countries, including the United States.
===CHECKS===
many countries have attempted to reduce their emission of the greenhouse gas carbon dioxide to address climate change
these treaties have not been ratified by every country
the role of human activity in causing climate change is a hotly debated socio-political issue in some countries, including the United States
{{< /selfcheck >}}
...
{{< selfcheck question="How do foundation species like corals physically modify their environment to benefit other organisms?" >}}
Foundation species may physically modify the environment to produce and maintain habitats that benefit the other organisms that use them. Corals themselves are not photosynthetic, but harbor symbionts within their body tissues (dinoflagellates called zooxanthellae) that perform photosynthesis. The exoskeletons of living and dead coral make up most of the reef structure, which protects many other species from waves and ocean currents.
===CHECKS===
foundation species may physically modify the environment to produce and maintain habitats that benefit other organisms
corals harbor symbionts called zooxanthellae within their body tissues that perform photosynthesis
the exoskeletons of living and dead coral make up most of the reef structure, protecting other species from waves and ocean currents
{{< /selfcheck >}}
...
during operant conditioning, the behavioral response is modified by its consequences, with regards to its form, strength, or frequency
{{< /selfcheck >}}

{{< multiplechoice
  question="E.O. Wilson defined sociobiology as ________."
  answer="the extension of population biology and evolutionary theory to social organization"
>}}
the belief that all behaviors are hardwired into our genes
the "nature versus nurture" debate of genetics versus environment
...
{{< multiplechoice
  question="Which trophic level's organisms are usually carnivores that eat the primary consumers of a food chain?"
...
{{< multiplechoice
  question="Which substance, used in coolant liquids in the United States until its use was banned in 1979, is known to biomagnify in aquatic food webs?"
  answer="PCBs"
>}}
DDT
mercury
...
{{< textin
  question="The area of the Earth where water movement and storage occurs, including rivers, lakes, oceans, groundwater, and ice, is called the ________."
  answer="hydrosphere"
>}}
...
One hypothesis is that ecosystems in the tropics are older, and greater age provides more time for speciation. Another possible explanation is that the tropics receive more direct energy from the sun than temperate and polar regions. A third hypothesis is that greater habitat heterogeneity, or number of ecological niches, in the tropics provides more opportunities for coevolution and specialization, promoting speciation.
===CHECKS===
ecosystems in the tropics are older, and greater age provides more time for speciation
the tropics receive more direct energy from the sun than temperate and polar regions
greater habitat heterogeneity, or number of ecological niches, in the tropics provides more opportunities for coevolution and specialization
{{< /selfcheck >}}

### 47.2 The Importance of Biodiversity to Human Life

{{< multiplechoice
  question="It is estimated that, at one time, what percentage of modern drugs contained at least one plant extract?"
  answer="25 percent"
>}}
10 percent
25 percent
...
{{< multiplechoice
  question="Aquatic resources provide the main source of animal protein for about how many people worldwide?"
  answer="1 billion"
>}}
1 million
1 billion
...
{{< selfcheck question="According to entomologist E. O. Wilson, why do city environments harm human well-being, and what does this suggest about biodiversity's value to humans?" >}}
Wilson argues that human evolutionary history has adapted humans to live in a natural environment, and that city environments generate psychological stressors that affect human health and well-being; this suggests humans benefit psychologically from living in a biodiverse world.
===CHECKS===
human evolutionary history has adapted humans to live in a natural environment
city environments generate psychological stressors that affect human health and well-being
humans benefit psychologically from living in a biodiverse world
{{< /selfcheck >}}

### 47.3 Threats to Biodiversity

{{< multiplechoice
  question="About what percentage of the timber imported into the United States is estimated to be potentially illegally logged?"
  answer="10 percent"
>}}
91 percent
2.4 percent
...
{{< selfcheck question="According to the theory of island biogeography, why do islands farther from the mainland, and islands that are smaller, tend to support fewer species?" >}}
Islands farther from a mainland are harder to get to, so migration is lower and the equilibrium number of species is lower. Smaller islands are also harder to find, so their immigration rates for new species are typically lower, and because they are less geographically diverse they have fewer niches to promote speciation; smaller islands also support smaller populations, so the probability of extinction is higher.
===CHECKS===

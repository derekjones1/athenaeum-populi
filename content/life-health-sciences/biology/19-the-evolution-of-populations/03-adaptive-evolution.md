...
description: >-
  How stabilizing, directional, diversifying, frequency-dependent, and sexual
  selection each pull a population's phenotypes in a different direction, and
  why natural selection can never produce a perfect organism — adapted from
  OpenStax Biology 2e, Section 19.3.
source_section: "19.3"
weight: 3
---
...
{{< callout type="info" >}}
**Link to Learning.** In science, we sometimes believe some things are true, and then new information becomes available that changes our understanding. The peppered moth story is an example: some scientists recently have questioned the facts behind the selection toward darker moths. Read [an article on new evidence questioning the peppered moth story](https://openstax.org/l/peppered_moths) to learn more.
{{< /callout >}}

## Diversifying Selection

Sometimes two or more distinct phenotypes can each have their advantages for natural selection, while the intermediate phenotypes are, on average, less fit. Scientists call this **diversifying selection** (see the figure below). We see this in many animal populations that have multiple male forms. Large, dominant alpha males use brute force to obtain mates, while small males can sneak in for furtive copulations with the females in an alpha male's territory. In this case, both the alpha males and the "sneaking" males will be selected for, but medium-sized males, who can't overtake the alpha males and are too big to sneak copulations, are selected against. Diversifying selection can also occur when environmental changes favor individuals on either end of the phenotypic spectrum. Imagine a mouse population living at the beach where there is light-colored sand interspersed with patches of tall grass. In this scenario, light-colored mice that blend in with the sand would be favored, as well as dark-colored mice that can hide in the grass. Medium-colored mice, alternatively would not blend in with either the grass or the sand, and thus predators would most likely eat them. The result of this type of selection is increased genetic variability as the population becomes more diverse.

{{< mediafigure src="biology/Figure_19_03_01" alt="Three vertically stacked graphs, each overlaying two bell-curve distributions to illustrate one type of natural selection. (a) Stabilizing selection: a robin clutch-size distribution narrows after selection around the same average. (b) Directional selection: a peppered-moth color distribution shifts to a new peak as the environment changes. (c) Diversifying selection: a rabbit coat-color distribution splits into two peaks flanking the original average, which becomes rare." longdesc="Panel (a), Stabilizing selection: a wide, short blue curve labeled 'Original population' is overlaid by a narrower, taller red curve labeled 'Population after natural selection,' both peaking at the same center; a bird's nest holding pale blue eggs sits at that shared peak, illustrating a robin's typical clutch size. Panel (b), Directional selection: a blue curve labeled 'Original population' sits at left and a red curve labeled 'Population after natural selection' sits at right, the two overlapping only slightly in the middle; a light, mottled peppered moth sits under the left curve's peak and a solid dark peppered moth sits under the right curve's peak. Panel (c), Diversifying selection: a single wide blue curve labeled 'Original population' spans the middle, and a red curve labeled 'Population after natural selection' has two peaks straddling it with a dip in the middle; a dark rabbit sits at the left peak, a white rabbit sits in the middle dip, and a gray-and-white (Himalayan) rabbit sits at the right peak." kind="diagram" eager="true" >}}
...
{{< selfcheck question="In recent years, factories have become cleaner, and release less soot into the environment. What impact do you think this has had on the distribution of moth color in the population?" hint="Think about which color moth is now better camouflaged now that the trees are lighter again." >}}
...
Males and females of certain species are often quite different from one another in ways beyond the reproductive organs. Males are often larger, for example, and display many elaborate colors and adornments, like the peacock's tail, while females tend to be smaller and duller in decoration. We call such differences **sexual dimorphisms** (see the figure below), which arise in many populations, particularly animal populations, where there is more variability in the male's reproductive success than that of the females. That is, some males—often the bigger, stronger, or more decorated males—obtain the vast majority of the total matings, while others receive none. This can occur because the males are better at fighting off other males, or because females will choose to mate with the bigger or more decorated males. In either case, this variation in reproductive success generates a strong selection pressure among males to obtain those matings, resulting in the evolution of bigger body size and elaborate ornaments to attract the females' attention. Females, however, tend to achieve a handful of selected matings; therefore, they are more likely to select more desirable males.

Sexual dimorphism varies widely among species, and some species are even sex-role reversed. In such cases, females tend to have a greater variability in their reproductive success than males and are correspondingly selected for the bigger body size and elaborate traits usually characteristic of males.

{{< mediafigure src="biology/Figure_19_03_03abc" alt="The photo on the left (a) shows a peacock with a bright blue body and flared tail feathers standing next to a brown, drab peahen. The middle photo (b) shows a large female spider sitting on a web beside its much smaller male counterpart. The photo on the right (c) shows a brightly colored male wood duck swimming next to a drab brown female." kind="photo" >}}
...
{{< callout type="info" >}}
**Link to Learning.** In 1915, biologist Ronald Fisher proposed another model of sexual selection: the [Fisherian runaway model](https://openstax.org/l/sexual_select), which suggests that selection of certain traits is a result of sexual preference.
{{< /callout >}}
...
Natural selection is a driving force in evolution and can generate populations that are better adapted to survive and successfully reproduce in their environments. However, natural selection cannot produce the perfect organism. Natural selection can only select on existing variation in the population. It does not create anything from scratch. Thus, it is limited by a population's existing genetic variability and whatever new alleles arise through mutation and gene flow.
...
Because natural selection acts to increase the frequency of beneficial alleles and traits while decreasing the frequency of deleterious qualities, it is adaptive evolution. Natural selection acts at the individual level, selecting for those that have a higher overall fitness compared to the rest of the population. If the fit phenotypes are those that are similar, natural selection will result in stabilizing selection, and an overall decrease in the population's variation. Directional selection works to shift a population's variability toward a new, fit phenotype, as environmental conditions change. In contrast, diversifying selection results in increased genetic variability by selecting for two or more distinct phenotypes.

Other types of selection include frequency-dependent selection, in which individuals with either common (positive frequency-dependent selection) or rare (negative frequency-dependent selection) are selected. Finally, sexual selection results from one sex having more variability in the reproductive success than the other. As a result, males and females experience different selective pressures, which can often lead to the evolution of phenotypic differences, or sexual dimorphisms, between the two.
...
{{< multiplechoice
  question="The good genes hypothesis is a theory that explains what?"
  answer="why individuals of one sex develop impressive ornamental traits"
  hint="Think about what an impressive ornament like a peacock's tail is supposed to signal to a potential mate."
>}}
...
{{< selfcheck question="Give an example of a trait that may have evolved as a result of the handicap principle and explain your reasoning." hint="Think of a trait that is costly to survival but still an honest signal of quality, like the peacock's tail discussed in this section." >}}
...
the tail makes the males more visible to predators and less able to escape
only the most fit males should be able to survive with it
...
{{< textin
  ...
  hint="It is what actually predicts whether an individual's genes make it into the next generation — not fitness measured in isolation."
>}}
...
individuals can become more or less related

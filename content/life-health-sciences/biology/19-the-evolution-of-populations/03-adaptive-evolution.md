...
{{< mediafigure src="biology/Figure_19_03_01" alt="Three vertically stacked graphs, each overlaying two bell-curve distributions to illustrate one type of natural selection. (a) Stabilizing selection: a robin clutch-size distribution narrows after selection around the same average. (b) Directional selection: a peppered-moth color distribution shifts to a new peak as the environment changes. (c) Diversifying selection: a rabbit coat-color distribution splits into two peaks flanking the original average, which becomes rare." longdesc="Panel (a), Stabilizing selection: a wide, short blue curve labeled 'Original population' is overlaid by a narrower, taller red curve labeled 'Population after natural selection,' both peaking at the same center; a bird's nest holding pale blue eggs sits at that shared peak, illustrating a robin's typical clutch size. Panel (b), Directional selection: a blue curve labeled 'Original population' sits at left and a red curve labeled 'Population after natural selection' sits at right, the two overlapping broadly in the middle, where they cross at about three-quarters of their peak height; a light, mottled peppered moth sits under the left curve's peak and a solid dark peppered moth sits under the right curve's peak. Panel (c), Diversifying selection: a single wide blue curve labeled 'Original population' spans the middle, and a red curve labeled 'Population after natural selection' has two peaks straddling it with a dip in the middle; a dark rabbit sits at the left peak, a white rabbit sits in the middle dip, and a gray-and-white (Himalayan) rabbit sits at the right peak. A text block beside each panel explains it: (a) robins typically lay four eggs, an example of stabilizing selection, since larger clutches may result in malnourished chicks and smaller clutches in no viable offspring; (b) light-colored peppered moths are better camouflaged against a pristine environment and dark-colored ones against a sooty environment, so as the Industrial Revolution progressed in nineteenth-century England the moth population's color shifted from light to dark; (c) in a hypothetical population, gray and Himalayan rabbits blend with a rocky environment better than white rabbits, resulting in diversifying selection." kind="diagram" eager="true" >}}
...
{{< multiplechoice
  ...
  hint="Reread the Sexual Selection paragraph that introduces the hypotheses explaining why a mate would choose one individual over another."
>}}
...
{{< multiplechoice
  ...
  hint="Compare what each type of selection does to the spread of phenotypes, using the three-panel selection figure and the subsections around it."
>}}
stabilizing selection
directional selection
diversifying selection

...
description: >-
  How a neuron's charged membrane creates a resting potential, fires and
  propagates an action potential, and passes that signal on at chemical and
  electrical synapses, closing with how synapses strengthen and weaken
  through long-term potentiation and long-term depression — adapted from
  OpenStax Biology 2e, Section 35.2.
source_section: "35.2"
weight: 2
---
...
The lipid bilayer membrane that surrounds a neuron is impermeable to charged molecules or ions. To enter or exit the neuron, ions must pass through special proteins called ion channels that span the membrane. Ion channels have different configurations: open, closed, and inactive, as illustrated below. Some ion channels need to be activated in order to open and allow ions to pass into or out of the cell. These ion channels are sensitive to the environment and can change their shape accordingly. Ion channels that change their structure in response to voltage changes are called voltage-gated ion channels. Voltage-gated ion channels regulate the relative concentrations of different ions inside and outside the cell. The difference in total charge between the inside and outside of the cell is called the **membrane potential**.

{{< mediafigure src="biology/Figure_35_02_01" kind="diagram" eager="true" alt="Three side-by-side cross-sections of the same teal channel protein embedded in a phospholipid bilayer, dark-blue Na⁺ ions scattered above it in the extracellular fluid and a short tethered loop hanging into the cytoplasm below; each panel is captioned Closed, Open, and Inactivated." longdesc="Titled 'Voltage-gated Na⁺ Channels.' Three panels show the same channel protein spanning the membrane, 'Outside cell' labeled at top and 'Cytoplasm' at bottom, with dark-blue Na⁺ ions scattered in the extracellular fluid above; a small ball on a short tether hangs from the channel's cytoplasmic side. Panel 1, captioned 'Closed: At the resting potential, the channel is closed' — the channel's two paddle-like halves bulge together, blocking the pore, its lower flaps lie flat, and no Na⁺ is in the cytoplasm. Panel 2, captioned 'Open: In response to a nerve impulse, the gate opens and Na⁺ enters the cell' — the two halves have separated and the lower flaps tilt upward; a dashed arrow runs from the fluid above down through the open pore into the cytoplasm, one Na⁺ ion sits in the pore on its path, and three have reached the cytoplasm. Panel 3, captioned 'Inactivated: For a brief period following activation, the channel does not open in response to a new signal' — the halves stay apart and the flaps stay tilted as in panel 2, but the tethered ball has swung up to plug the pore from the cytoplasmic side; fewer Na⁺ ions remain above and five sit in the cytoplasm below." >}}
...
{{< mediafigure src="biology/Figure_35_02_02" kind="diagram" alt="Three stacked cross-sections of the same membrane segment, each with a K⁺ channel, a Na⁺/K⁺ transporter, and a Na⁺ channel between purple Na⁺ ions and yellow K⁺ ions (Na⁺ mostly outside and K⁺ inside in (a) and (b), the reverse in (c)), wired to a voltmeter dial reading from −80 to +40 millivolts; the panels are labeled (a) Resting potential, (b) Depolarization, and (c) Hyperpolarization." longdesc="Three stacked panels labeled (a) Resting potential, (b) Depolarization, and (c) Hyperpolarization show the same stretch of membrane with, left to right, a K⁺ channel (orange), a Na⁺/K⁺ transporter (teal, labeled with ATP and ADP), and a Na⁺ channel (purple), plus a voltmeter with a needle sweeping a −80 mV to +40 mV dial, wired into the cytoplasm; 'Extracellular fluid' and 'Cytoplasm' label the two sides in panel (a). Panel (a): the needle points to the left side of the dial, near −80 mV; purple Na⁺ ions cluster in the extracellular fluid above and yellow K⁺ ions cluster in the cytoplasm below; at the transporter, one arrow carries a K⁺ ion from outside down through it into the cytoplasm and a second carries a Na⁺ ion from the cytoplasm up through it to the outside, while a curved arrow turns ATP into ADP beneath it. Its printed caption reads: 'At the resting potential, all voltage-gated Na⁺ channels and most voltage-gated K⁺ channels are closed. The Na⁺/K⁺ transporter pumps K⁺ ions into the cell and Na⁺ ions out.' Panel (b): the needle has swung right, past 0 mV toward +40 mV; an arrow runs from a Na⁺ ion outside down through the Na⁺ channel into the cytoplasm, and a few Na⁺ ions now sit in the cytoplasm. Its printed caption reads: 'In response to a depolarization, some Na⁺ channels open, allowing Na⁺ ions to enter the cell. The membrane starts to depolarize (the charge across the membrane lessens). If the threshold of excitation is reached, all the Na⁺ channels open.' Panel (c): the needle has swung back left, slightly lower on the dial than in panel (a); an arrow runs from the cytoplasm up through the K⁺ channel to the outside, and the drawing now shows yellow K⁺ ions mostly in the extracellular fluid and purple Na⁺ ions mostly in the cytoplasm. Its printed caption reads: 'At the peak action potential, Na⁺ channels close while K⁺ channels open. K⁺ leaves the cell, and the membrane eventually becomes hyperpolarized.'" >}}
...
they have no effect on depolarization
{{< /selfcheck >}}

{{< mediafigure src="biology/Figure_35_02_04" kind="diagram" alt="A neuron diagram above three horizontal color-coded bars representing the axon membrane at three successive moments, each bar divided into labeled zones (Depolarized, Repolarizing, Resting) that shift rightward from bar to bar beneath a rightward arrow labeled 'Direction of travel of action potential.'" longdesc="A neuron (soma, dendrites, axon, axon terminal) sits above a rightward arrow labeled 'Direction of travel of action potential.' Below are three stacked bars representing the axon membrane at three moments, each divided into color-coded zones with plus and minus signs marking depolarized (charge reversed) versus resting charge. Bar (a), captioned 'In response to a signal, the soma end of the axon becomes depolarized': a green 'Depolarized' zone at the left end, about a quarter of the bar, carries plus signs and curved arrows spreading out from its center to the left and to the right; the rest of the bar is an unlabeled peach zone with minus signs. Bar (b), captioned 'The depolarization spreads down the axon. Meanwhile, the first part of the membrane repolarizes. Because Na⁺ channels are inactivated and additional K⁺ channels have opened, the membrane cannot depolarize again': left third blue 'Repolarizing,' middle third green 'Depolarized,' right third peach 'Resting.' Bar (c), captioned 'The action potential continues to travel down the axon': peach 'Resting' at the left, then blue 'Repolarizing,' then green 'Depolarized' with its outward curved arrows, and a narrow unlabeled peach strip at the right end." >}}
...
Watch [a video overview of the action potential](https://openstax.org/l/actionpotential).
{{< /callout >}}

### Myelin and the Propagation of the Action Potential

For an action potential to communicate information to another neuron, it must travel along the axon and reach the axon terminals where it can initiate neurotransmitter release. The speed of conduction of an action potential along an axon is influenced by both the diameter of the axon and the axon's resistance to current leak. Myelin acts as an insulator that prevents current from leaving the axon; this increases the speed of action potential conduction. In demyelinating diseases like multiple sclerosis, action potential conduction slows because current leaks from previously insulated axon areas. The nodes of Ranvier, illustrated below, are gaps in the myelin sheath along the axon. These unmyelinated spaces are about one micrometer long and contain voltage-gated Na⁺ and K⁺ channels. Flow of ions through these channels, particularly the Na⁺ channels, regenerates the action potential over and over again along the axon. This 'jumping' of the action potential from one node to the next is called **saltatory conduction**. If nodes of Ranvier were not present along an axon, the action potential would propagate very slowly since Na⁺ and K⁺ channels would have to continuously regenerate action potentials at every point along the axon instead of at specific points. Nodes of Ranvier also save energy for the neuron since the channels only need to be present at the nodes and not along the entire axon.

{{< mediafigure src="biology/Figure_35_02_05" kind="diagram" alt="A horizontal axon shown as three myelin-wrapped cylindrical segments with two bare gaps between them, the gaps labeled Nodes of Ranvier and marked with opposite plus/minus charge patterns on either side of a rightward arrow." longdesc="A horizontal axon runs through three cylindrical myelin-covered segments with two bare gaps between them. Left to right: the bare axon entering at the far left, labeled 'Axon,' the first myelin-covered segment, then the first bare gap, marked '−−−' outside and '+++' inside and labeled 'Depolarized membrane,' a middle myelin-covered segment with a gray arrow running from the first gap right through it to the next gap, a second bare gap marked the opposite way, '+++' outside and '−−−' inside, labeled 'Membrane at resting potential,' and finally a third myelin-covered segment labeled 'Myelin sheath.' The label 'Nodes of Ranvier' sits above the middle segment with a call-out line to each gap." >}}
...
When an action potential reaches the axon terminal it depolarizes the membrane and opens voltage-gated Na⁺ channels. Na⁺ ions enter the cell, further depolarizing the presynaptic membrane. This depolarization causes voltage-gated Ca²⁺ channels to open. Calcium ions entering the cell initiate a signaling cascade that causes small membrane-bound vesicles, called **synaptic vesicles**, containing neurotransmitter molecules to fuse with the presynaptic membrane. Synaptic vesicles are shown below, in an image from a scanning electron microscope.

{{< mediafigure src="biology/Figure_B35_02_05" kind="photo" alt="A pseudocolored scanning electron micrograph of a round, textured green axon terminal sliced open to reveal a tightly packed cluster of small blue and orange spherical vesicles inside; a smaller second terminal with a similar cluster is visible at lower right." >}}
...
Fusion of a vesicle with the presynaptic membrane causes neurotransmitter to be released into the **synaptic cleft**, the extracellular space between the presynaptic and postsynaptic membranes, illustrated below. The neurotransmitter diffuses across the synaptic cleft and binds to receptor proteins on the postsynaptic membrane.

{{< mediafigure src="biology/Figure_35_02_07" kind="diagram" alt="An axon terminal bulb sits above a narrow synaptic cleft and the postsynaptic membrane below; six numbered callouts trace an action potential arriving, calcium entering, vesicles releasing their contents, and neurotransmitter crossing the cleft (1 to 4), with two boxed close-up insets beneath (5 and 6) showing a ligand-gated channel opening and then closing as neurotransmitter is cleared." longdesc="At upper left, a small drawing of a whole neuron shows the myelinated axon of a second neuron ending on its dendrites; a small box marks that contact, and a large gray arrow leads from the box to an enlarged view at upper right. There, the axon labeled 'Presynaptic neuron' widens into a bulb-shaped axon terminal (labeled 'Axon terminal') filled with round, green-dotted vesicles labeled 'Synaptic vesicles'; a bracketed thin gap below it, labeled 'Synaptic cleft,' separates it from the 'Postsynaptic neuron' beneath. Four numbered captions describe the sequence: ① 'Action potential arrives at axon terminal,' with four arrows running down the axon into the terminal. ② 'Voltage-gated Ca²⁺ channels open and Ca²⁺ enters the axon terminal,' pointing to one of two pink channels in the terminal's lower membrane, each with a Ca²⁺ label and an arrow running up through it into the terminal. ③ 'Ca²⁺ entry causes neurotransmitter-containing synaptic vesicles to release their contents by exocytosis,' pointing to a vesicle near the terminal's lower edge, where other vesicles open onto the cleft and green neurotransmitter dots spill out. ④ 'Neurotransmitter diffuses across the synaptic cleft and binds to ligand-gated ion channels on the postsynaptic membrane,' pointing to a boxed teal channel on the postsynaptic membrane with a green dot bound to it. A second box at the right of the cleft holds a purple transporter in the presynaptic membrane and a postsynaptic channel, with three small arrows running from the channel: one up to the transporter, one to a split green dot, and one away. Two boxed insets below, each fed by a gray arrow from one of these boxes: inset ⑤, at left, from the left box, 'Binding of neurotransmitter opens ligand-gated ion channels, resulting in graded potentials' — a membrane cross-section in which a green 'Neurotransmitter' dot sits on an 'Open ligand-gated ion channel,' two arrows labeled 'Ion movement' run through the channel, one up and one down, and plus and minus signs along both faces of the membrane flip on either side of the channel under a bracket labeled 'Localized membrane potential,' with 'Graded potential' at its right end and 'Cytoplasm' below. Inset ⑥, at right, from the right box, 'Reuptake by the presynaptic neuron, enzymatic degradation, and diffusion reduce neurotransmitter levels, terminating the signal' — the 'Presynaptic neuron' membrane at top holds a purple transporter drawing a green neurotransmitter up into it ('Reuptake by presynaptic neuron'), a split green dot is labeled 'Enzymatic degradation,' a whole green dot is labeled 'Diffusion away from synapse,' and the 'Postsynaptic neuron' membrane at bottom holds a 'Closed ligand-gated ion channel.'" >}}
Communication at chemical synapses requires release of neurotransmitters. When the presynaptic membrane is depolarized, voltage-gated Ca²⁺ channels open and allow Ca²⁺ to enter the cell. The calcium entry causes synaptic vesicles to fuse with the membrane and release neurotransmitter molecules into the synaptic cleft. The neurotransmitter diffuses across the synaptic cleft and binds to ligand-gated ion channels in the postsynaptic membrane, resulting in a localized depolarization or hyperpolarization of the postsynaptic neuron.
{{< /mediafigure >}}

The binding of a specific neurotransmitter causes particular ion channels, in this case ligand-gated channels, on the postsynaptic membrane to open. Neurotransmitters can either have excitatory or inhibitory effects on the postsynaptic membrane. For example, when acetylcholine is released at the synapse between a nerve and muscle (called the neuromuscular junction) by a presynaptic neuron, it causes postsynaptic Na⁺ channels to open. Na⁺ enters the postsynaptic cell and causes the postsynaptic membrane to depolarize. This depolarization is called an **excitatory postsynaptic potential (EPSP)** and makes the postsynaptic neuron more likely to fire an action potential. Release of neurotransmitter at inhibitory synapses causes **inhibitory postsynaptic potentials (IPSPs)**, a hyperpolarization of the postsynaptic membrane. *(Source note: the source says "presynaptic"; the term itself, the parallel EPSP sentence before it, and this page's key term all place the potential on the postsynaptic membrane.)* For example, when the neurotransmitter GABA (gamma-aminobutyric acid) is released from a presynaptic neuron, it binds to and opens Cl⁻ channels. Cl⁻ ions enter the cell and hyperpolarizes the membrane, making the neuron less likely to fire an action potential.
...
Sometimes a single EPSP is strong enough to induce an action potential in the postsynaptic neuron, but often multiple presynaptic inputs must create EPSPs around the same time for the postsynaptic neuron to be sufficiently depolarized to fire an action potential. This process is called **summation** and occurs at the axon hillock, illustrated below. Additionally, one neuron often has inputs from many presynaptic neurons—some excitatory and some inhibitory—so IPSPs can cancel out EPSPs and vice versa. It is the net change in postsynaptic membrane voltage that determines whether the postsynaptic cell has reached its threshold of excitation needed to fire an action potential. Together, synaptic summation and the threshold for excitation act as a filter so that random "noise" in the system is not transmitted as important information.

{{< mediafigure src="biology/Figure_B35_02_07" kind="diagram" alt="A small neuron with its axon hillock boxed in red sits above a line graph of membrane potential against time, showing green and pink segments stepping up toward a threshold line before a sharp spike and a return to baseline." longdesc="A small neuron diagram at top labels its 'Axon hillock' and marks it with a small red box, with a gray callout arrow from the box down to a line graph titled 'Summation of membrane potentials at the axon hillock.' The graph's y-axis, 'Membrane potential (mV),' is marked at −70, −10, and 30; the x-axis is 'Time.' A solid 'Threshold of activation' gridline runs at −10, in the same style as the gridlines at −70 and 30. Starting flat at −70, the curve rises in two green steps (legend: EPSPs) to a plateau, dips in a pink segment (legend: IPSPs), drifts slightly lower in yellow, rises again in green to a second plateau slightly lower than the first, dips again in pink, then rises a final time in green up to the threshold line, where a yellow spike shoots up above 30, falls sharply past −70 into a trough below it, and gradually climbs back to a flat −70 baseline." >}}
...
{{< mediafigure src="biology/Figure_B35_02_09" kind="diagram" alt="A line illustration of a person seated in a wheelchair, a curved arrow running from their head to a desktop computer screen, labeled 'Neural signals travel to computer.'" >}}
...
Watch [this video, in which a paralyzed woman uses a brain-controlled robotic arm to bring a drink to her mouth, among other images of brain-computer interface technology in action](https://openstax.org/l/paralyzation).
{{< /callout >}}
...
**Long-term potentiation (LTP)** is a persistent strengthening of a synaptic connection. LTP is based on the Hebbian principle: cells that fire together wire together. There are various mechanisms, none fully understood, behind the synaptic strengthening seen with LTP. One known mechanism involves a type of postsynaptic glutamate receptor, called NMDA (N-Methyl-D-aspartate) receptors, shown below. These receptors are normally blocked by magnesium ions; however, when the postsynaptic neuron is depolarized by multiple presynaptic inputs in quick succession (either from one neuron or multiple neurons), the magnesium ions are forced out allowing Ca²⁺ ions to pass into the postsynaptic cell. Next, Ca²⁺ ions entering the cell initiate a signaling cascade that causes a different type of glutamate receptor, called AMPA (α-amino-3-hydroxy-5-methyl-4-isoxazolepropionic acid) receptors, to be inserted into the postsynaptic membrane, since activated AMPA receptors allow positive ions to enter the cell. So, the next time glutamate is released from the presynaptic membrane, it will have a larger excitatory effect (EPSP) on the postsynaptic cell because the binding of glutamate to these AMPA receptors will allow more positive ions into the cell. The insertion of additional AMPA receptors strengthens the synapse and means that the postsynaptic neuron is more likely to fire in response to presynaptic neurotransmitter release. Some drugs of abuse co-opt the LTP pathway, and this synaptic strengthening can lead to addiction.

### Long-term Depression (LTD)

**Long-term depression (LTD)** is essentially the reverse of LTP: it is a long-term weakening of a synaptic connection. One mechanism known to cause LTD also involves AMPA receptors. In this situation, calcium that enters through NMDA receptors initiates a different signaling cascade, which results in the removal of AMPA receptors from the postsynaptic membrane, illustrated below. The decrease in AMPA receptors in the membrane makes the postsynaptic neuron less responsive to glutamate released from the presynaptic neuron. While it may seem counterintuitive, LTD may be just as important for learning and memory as LTP. The weakening and pruning of unused synapses allows for unimportant connections to be lost and makes the synapses that have undergone LTP that much stronger by comparison.

{{< mediafigure src="biology/Figure_35_02_10" kind="diagram" alt="Three side-by-side cross-sections of a synapse, each with a presynaptic terminal full of round vesicles above and a postsynaptic terminal below containing a teal NMDA receptor and, in the second and third panels, a green AMPA receptor moving into or out of the membrane; gray arrows labeled LTP and LTD connect the panels left to right." longdesc="Three side-by-side synapse cross-sections, each showing a bulb-shaped 'Presynaptic terminal' above containing round vesicles (green-dotted, labeled Glutamate or Glu) and a 'Postsynaptic terminal' below with an embedded teal NMDA receptor, through which an arrow carries a purple dot from the cleft down into the cytoplasm, where purple Ca²⁺ dots gather; a gray arrow labeled 'LTP' connects panel 1 to panel 2, and a second gray arrow labeled 'LTD' connects panel 2 to panel 3. Panel 1's boxed caption: 'The NMDA receptor is activated by glutamate binding, but only after depolarization removes inhibitory Mg²⁺. Once the Mg²⁺ is removed, Ca²⁺ can enter the cell' — here a vesicle opens onto the cleft and green glutamate dots spill toward the receptor, and a curved arrow carries a blue dot from the top of the NMDA receptor up and away to a small group of blue dots labeled 'Mg²⁺.' Panel 2's boxed caption: 'Some AMPA receptors are present in the membrane initially. In response to an increase in intracellular Ca²⁺, more are inserted' — a curved arrow runs from the Ca²⁺ dots to a vesicle below the membrane carrying a green AMPA receptor, and a second arrow runs from that vesicle up to a green receptor in the postsynaptic membrane labeled 'AMPA receptor,' to the right of the NMDA receptor. Panel 3's boxed caption: 'Low-frequency stimulation results in a different Ca²⁺-signaling cascade. AMPA receptor is removed from the membrane, and as a result, the nerve cell becomes less responsive to glutamate' — no AMPA receptor remains in the membrane; a curved arrow runs from the membrane down to a vesicle inside the cell carrying the AMPA receptor." >}}
...
{{< multiplechoice
  question="Which of the following molecules is not involved in the maintenance of the resting membrane potential?"
  answer="calcium cations"
  hint="Check each option against the Resting Membrane Potential discussion of what creates and maintains the charge difference."
>}}
potassium cations
ATP
...
{{< textin
  question="The action potential is then propagated along a myelinated axon to the ________."
  answer="axon terminals"
  accept="terminals"
  hint="This is the fourth sentence of the Summary; the first sentence of the propagation discussion names the same destination."
>}}
...
nicotine exposure causes long-term potentiation of neurons in the amygdala and activates reward centers of the brain
as nicotine exposure continues, long-term potentiation reinforces the activation of the reward pathways in response to nicotine consumption
{{< /selfcheck >}}
...
<small>This section is adapted from [Biology 2e, Section 35.2: How Neurons Communicate](https://openstax.org/books/biology-2e/pages/35-2-how-neurons-communicate) by Mary Ann Clark, Jung Choi, Matthew Douglas, and OpenStax, © OpenStax, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). Access the original for free at [openstax.org](https://openstax.org/details/books/biology-2e). Changes: figures re-encoded as WebP; six figures re-kinded from the manifest's file-extension "photo" guess to "diagram" (Figure_35_02_01, Figure_35_02_02, Figure_35_02_05, Figure_35_02_07, Figure_35_02_10, and Figure_B35_02_07 are all hand-drawn schematics or line graphs, none a captured photograph), and Figure_B35_02_05 from "diagram" to "photo" (an actual scanning electron micrograph); alts rewritten from the manifest's narrated, walk-through-style source text to plain visual descriptions, with the walk-through moved into a longdesc; a longdesc added to every diagram whose meaning is not carried by its one-line caption — the ion-channel state figure, the resting/depolarization/hyperpolarization triptych, the action-potential graph (Visual Connection), the axon-propagation triptych, the nodes-of-Ranvier diagram, the synaptic-transmission diagram, the axon-hillock summation graph, and the LTP/LTD diagram — transcribing each drawing's own printed sub-captions and counting its panels, numbered steps, or curve segments; the three Link to Learning notes rendered as callouts with descriptive link text in place of the source's "This video" anchors and the print edition's generic "Access multimedia content" text, external URLs kept as printed; the Everyday Connection note rendered as a callout with its bold name and italic title, its figure and all three paragraphs kept inside the box as printed; in-text pointers to figures ("Figure 35.9" through "Figure 35.18") replaced with "shown below," "illustrated below," or "above and below," since Hugo does not number figures; the note wrapping the action-potential Visual Connection (potassium channel blockers) rendered as its figure followed by a self-check, since the source keys it as prose rather than a lettered choice, kept in the body; the end-of-section Review Questions and Critical Thinking Questions adapted into the closing interactive Practice block (multiple choice and self-check respectively), the fourth Review Question (the molecule not involved in the resting membrane potential) placed first, in the resting-potential objective's group, ahead of the three that serve later objectives; rubric checkpoints added to each self-check, decomposing its model answer (the source solution) into check-off clauses with no new claims; thirteen key-term recall items added from the glossary, covering every glossary term but threshold of excitation, which the source's first Review Question already asks; two summary-derived textin clozes, one in the first objective's group (blanking "ion channels" from the closing summary's sentence "Voltage-gated ion channels control the movement of ions into and out of a neuron") and one in the second (blanking "axon terminals" from "The action potential is then propagated along a myelinated axon to the axon terminals"); ion and charge notation set as Unicode sub/superscripts (Na⁺, K⁺, Cl⁻, Ca²⁺, Mg²⁺) and negative millivolt values set with a Unicode minus sign, in place of the source's plain hyphens, per house notation; both source tables (ion concentrations, neurotransmitter function and location) kept as Markdown tables, since their columns are quantities and examples rather than categories and so are not sortbins material. The synaptic-transmission figure's own printed step 6 reads "presynapic"; the artwork is unchanged and the longdesc spells it "presynaptic". One word is corrected with a visible Source note: an IPSP hyperpolarizes the postsynaptic membrane, as the term and the page's key term say, not the presynaptic one (erratum 443).</small>

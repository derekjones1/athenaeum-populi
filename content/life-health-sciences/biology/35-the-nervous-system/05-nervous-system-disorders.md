...
description: >-
  The symptoms, causes, and treatments of several nervous system disorders —
  Alzheimer's and Parkinson's disease, autism spectrum disorder and ADHD,
  schizophrenia and major depression, epilepsy, and stroke — adapted from
  OpenStax Biology 2e, Section 35.5.
source_section: "35.5"
weight: 5
---
...
{{< callout type="info" >}}
**Link to Learning.** Visit [a collection of video links about genetics and Alzheimer's disease](https://openstax.org/l/alzheimers).
{{< /callout >}}
...
Like Alzheimer's disease, **Parkinson's disease** is a neurodegenerative disease. It was first characterized by James Parkinson in 1817. Each year, 50,000-60,000 people in the United States are diagnosed with the disease. Parkinson's disease causes the loss of dopamine neurons in the substantia nigra, a midbrain structure that regulates movement. Loss of these neurons causes many symptoms including tremor (shaking of fingers or a limb), slowed movement, speech changes, balance and posture problems, and rigid muscles. The combination of these symptoms often causes a characteristic slow hunched shuffling walk, illustrated below. Patients with Parkinson's disease can also exhibit psychological symptoms, such as dementia or emotional problems.
...
{{< callout type="info" >}}
**Link to Learning.** Watch [a video discussing possible reasons for the recent increase in autism diagnoses](https://openstax.org/l/autism).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_35_05_03" kind="diagram" alt="A horizontal bar chart with five bars of different colors and lengths, each labeled with a patient group and a percentage, showing how many people with ADHD also have each combination of other neurological or psychiatric disorders." longdesc="The chart lists five left-aligned bars from top to bottom, each a different color and each printing its own label and percentage: an orange 'ADHD Alone' bar at 49%, the longest of the five; a blue-gray 'ADHD +Conduct disorder' bar at 7%, the shortest; a red 'ADHD + Depression' bar at 11%; a teal 'ADHD + Anxiety disorder' bar also at 11%, the same length as the depression bar; and a green 'ADHD + Combined disorders (depression, anxiety and conduct)' bar at 24%, the second-longest bar." >}}
Many people with ADHD have one or more other neurological disorders. (credit "chart design and illustration": modification of work by Leigh Coriale; credit "data": Drs. Biederman and Faraone, Massachusetts General Hospital).
{{< /mediafigure >}}

{{< callout type="info" >}}
**Career Connection.** *Neurologist.* Neurologists are physicians who specialize in disorders of the nervous system. They diagnose and treat disorders such as epilepsy, stroke, dementia, nervous system injuries, Parkinson's disease, sleep disorders, and multiple sclerosis. Neurologists are medical doctors who have attended college, medical school, and completed three to four years of neurology residency.
...
{{< callout type="info" >}}
**Link to Learning.** Visit [a website demonstrating the tests a neurologist uses to identify damaged regions of the nervous system](https://openstax.org/l/neurologic_exam).
{{< /callout >}}
...
difficulties planning or executing tasks
poor judgment
personality changes
{{< /selfcheck >}}
...
MAO inhibitor drugs inhibit the breakdown of certain neurotransmitters in the synaptic cleft

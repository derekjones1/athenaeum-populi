...
description: >-
  The structural components of a neuron, the four main types of neurons
  distinguished by the placement of their axons and dendrites, and the
  distinct support functions of the nervous system's glial cells — adapted
  from OpenStax Biology 2e, Section 35.1.
source_section: "35.1"
weight: 1
---
...
{{< callout type="info" >}}
**Link to Learning.** Watch [a video of biologist Mark Kirschner discussing the “flipping” phenomenon of vertebrate evolution](https://www.openstax.org/l/vertebrate_evol).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_B35_01_02" kind="diagram" alt="Three drawings of different neuron shapes. (a) A pyramidal cell: a tall, narrow soma with one long unbranched process reaching up and another reaching down, and short, bushy dendrites near the soma. (b) A Purkinje cell: a dense, feathery fan of branching that fills most of the frame above a single trunk. (c) Olfactory neurons: several cells seated in a row of epithelial cells at the base, each with short dendrites below and a thin axon rising to one of two dashed circles, where they meet the branched endings of two upper neurons whose axons run off the top." >}}
...
{{< callout type="info" >}}
**Link to Learning.** Watch [a video with more information about neurogenesis](https://openstax.org/l/neurogenesis).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_35_01_07" kind="photo" alt="(a) A dense mesh of irregularly shaped green astrocytes, their processes overlapping across the frame, with a 10 µm scale bar at lower right. (b) A single round green oligodendrocyte with fine, radiating branched extensions against a dark background, also with a 10 µm scale bar." >}}
...
they are unique because they contain dendrites, which can receive signals from other neurons
...
without myelin, signal transmission can slow down and degrade over time
...
since the axon has multiple terminals it can send the signal to several other cells at once

...
description: >-
  The autonomic nervous system's sympathetic and parasympathetic divisions
  and the sensory-somatic nervous system's cranial and spinal nerves, which
  together relay signals between the central nervous system and the rest of
  the body — adapted from OpenStax Biology 2e, Section 35.4.
source_section: "35.4"
weight: 4
---
...
{{< mediafigure src="biology/Figure_35_04_01f" kind="diagram" eager="true" alt="A two-column diagram titled 'Autonomic Nervous System,' a blue panel labeled Parasympathetic on the left and an orange panel labeled Sympathetic on the right, each showing a preganglionic neuron connecting to a postganglionic neuron that reaches a target organ, with labeled boxes at each synapse and an outcome box at the bottom of each column." longdesc="The figure is titled 'Autonomic Nervous System' and divided into two vertical panels. The left, shaded blue and labeled 'Parasympathetic': a preganglionic neuron near the top, labeled 'Preganglionic neuron: soma is usually in the brainstem or sacral (toward the bottom) spinal cord,' sends a long axon down most of the panel to a synapse, labeled by a box reading 'Neurotransmitter released from the preganglionic synapse: acetylcholine,' with a second neuron low in the panel labeled 'Postganglionic neuron: soma is usually in a ganglion near the target organ,' whose short axon ends at a synapse labeled by a box reading 'Neurotransmitters released from postganglionic synapse: acetylcholine or nitric oxide,' just above an oval labeled 'Target organ'; a gray arrow leads from the oval down to a box reading '\"Rest and digest\" response is activated.' The right panel, shaded orange and labeled 'Sympathetic,' has the same parts in different proportions: a preganglionic neuron labeled 'soma is usually in the spine' sends only a short axon to a synapse high in the panel, which shares the single central 'acetylcholine' box with the parasympathetic pathway (one leader line runs to each synapse); the postganglionic neuron, labeled 'soma is in a sympathetic ganglion, located next to the spinal cord,' then sends a long axon down most of the panel to a synapse labeled 'Neurotransmitters released from postganglionic synapse: norepinephrine,' above its own 'Target organ' oval, and a gray arrow leads down to a final box reading '\"Fight or flight\" response is activated.'" >}}
...
{{< mediafigure src="biology/Figure_B35_04_02" kind="diagram" alt="A front view of a human body with the head, neck, and spine drawn in cutaway, with two vertical columns of text labels connected by lines: 'Parasympathetic Nervous System' labels on the left pointing to the head and lower spine, and 'Sympathetic Nervous System' labels on the right pointing to the chain of ganglia along the spine, with a bracket linking several of the right-hand labels to a 'Solar plexus' label near the abdomen and a 'Sacral' label at the base of the spine." longdesc="Titled with 'Parasympathetic Nervous System' above the left column and 'Sympathetic Nervous System' above the right column, the figure shows a front-facing human silhouette with the brain, brainstem, and spinal cord drawn down its center. A chain of small yellow ganglia runs down the right side of the spinal cord from the neck to the lower back. On the left, the parasympathetic labels, top to bottom: a line from the brain leads to 'Constricts pupil'; a line from the brainstem leads to 'Stimulates salivation'; a single line from the lower brainstem feeds a vertical bar that branches to 'Slows heart rate,' 'Constricts bronchi,' 'Stimulates digestion,' and 'Stimulates bile secretion'; and a line from the bottom of the spinal cord leads to 'Causes bladder to contract.' That bottom stretch of the cord is enclosed by a bracket on its right labeled 'Sacral.' On the right, the sympathetic labels, top to bottom: lines from the two highest ganglia lead to 'Dilates pupil' and 'Inhibits salivation'; one bracket gathering four upper-chest segments of the cord and chain leads to both 'Increases heart rate' and 'Dilates bronchi'; two brackets gathering the next eight segments join into one line that passes the label 'Solar plexus' and branches to 'Inhibits digestion,' 'Stimulates the breakdown of glycogen,' and 'Stimulates secretion of adrenaline and noradrenaline'; and a bracket gathering the next few segments, still above the sacral bracket, leads to 'Inhibits contraction of bladder.'" >}}
...
{{< mediafigure src="biology/Figure_35_04_04" kind="diagram" alt="A labeled cross-section of the spinal cord, a butterfly-shaped purple region of gray matter surrounded by pale white matter, with a spinal nerve and its dorsal and ventral roots emerging from each side and a title reading 'Cross Section of Spinal Cord' beneath it." longdesc="Labels point to the following structures. At upper left, 'Gray matter' marks the purple butterfly-shaped center; at top center, 'White matter' marks the paler tissue surrounding it. The same roots, ganglion, and dots are drawn on both sides of the cord; the labels point to one side or the other. At upper right, 'Dorsal root' marks the yellow nerve bundle entering the upper back of the cord, 'Dorsal root ganglion' the swelling on that root just outside the cord, and 'Sensory neuron soma' a blue dot within that ganglion. At lower left, 'Motor neuron soma' marks a red dot within the gray matter's lower horn. At lower right, 'Ventral root' marks the nerve bundle leaving the underside of the cord, and 'Spinal nerve' marks the point where the dorsal and ventral roots merge into a single nerve. A red line traces the motor pathway from the gray matter out through the ventral root, and a blue line traces the sensory pathway from the sensory neuron soma into the dorsal root and gray matter." >}}
...
sympathetic neuron cell bodies are located in sympathetic ganglia; parasympathetic neuron cell bodies are in the brainstem and sacral spinal cord
sympathetic activation increases heart rate and blood pressure and decreases digestion and blood flow to the skin
...
finding money to pay student loans or being nervous before a test still activates the sympathetic nervous system
these situations do not require the fight-or-flight response to survive
{{< /selfcheck >}}

{{< textin
  question="The division of the autonomic nervous system that regulates visceral functions during rest and digestion is called the ________."
  answer="parasympathetic nervous system"
  accept="parasympathetic|parasympathetic system|parasympathetic division|parasympathetic branch"
  hint="See the second of the two subsections under Autonomic Nervous System."
>}}

{{< textin
  question="The division of the autonomic nervous system activated during stressful \"fight or flight\" situations is called the ________."
  answer="sympathetic nervous system"
  accept="sympathetic|sympathetic system|sympathetic division|sympathetic branch"
...
the signal is relayed to the spinal cord and sent to a motor neuron
the motor neuron produces acetylcholine to contract the muscle that pulls the person away from the hot object
connecting the sensory and motor neurons in the spinal cord instead of the brain lets the body respond faster
{{< /selfcheck >}}

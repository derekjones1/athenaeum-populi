...
description: >-
  The meninges and cerebrospinal fluid that protect the brain and spinal
  cord, the cerebral cortex's four lobes and the basal ganglia, thalamus,
  hypothalamus, limbic system, cerebellum, and brainstem beneath them, and
  the spinal cord's structure and role in relaying signals and controlling
  reflexes — adapted from OpenStax Biology 2e, Section 35.3.
source_section: "35.3"
weight: 3
---
...
{{< callout type="info" >}}
**Link to Learning.** View [this video](https://openstax.org/l/split-brain) to learn more about split-brain patients.
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_35_03_04" kind="diagram" alt="A fan-shaped diagram of the motor cortex's right hemisphere, divided into 21 colored segments arranged in an arc, each segment labeled with the body part or function its neurons control, running from the toes at one end up through the leg, trunk, and arm to the face and mouth at the other end." longdesc="Twenty-one labeled segments arc from the lower left end of the strip to the lower right end. In order: Toes, Ankles, Knees, Hips, Trunk, Shoulders, Elbows, and Wrists climb up the left side toward the top of the arc; Hands, Fingers, and Thumbs continue near the top; descending the right side: Neck, Eyebrows and eyelids, Eyeballs, Face, Lips, Jaw, Tongue, Salivation, Chewing, and Swallowing. 'Cerebral cortex' labels the plain tan region inside the curve of the arc, and 'Motor cortex (right hemisphere)' labels the diagram as a whole at lower left." >}}
...
{{< selfcheck question="What methods can be used to determine the function of a particular brain region?" hint="Re-read the paragraph earlier in this section describing how scientists study which brain areas do what." >}}
...
===CHECKS===
scientists can look at patients who have damage in that brain area and see what symptoms they exhibit
researchers can disable the brain structure temporarily using transcranial magnetic stimulation
they can disable or remove the area in an animal model
...
and motor commands from the brain to the body through its connections with peripheral nerves

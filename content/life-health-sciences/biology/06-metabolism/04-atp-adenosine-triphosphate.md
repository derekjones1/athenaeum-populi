...
description: >-
  ATP's role as the cell's energy currency, how ATP hydrolysis releases free
  energy while ATP formation requires it, and how energy coupling lets that
  released energy power cellular work such as the sodium-potassium pump —
  adapted from OpenStax Biology 2e, Section 6.4.
source_section: "6.4"
weight: 4
---
...
{{< selfcheck question="One ATP molecule's hydrolysis releases 7.3 kcal/mol of energy (ΔG = −7.3 kcal/mol of energy). If it takes 2.1 kcal/mol of energy to move one Na⁺ across the membrane (ΔG = +2.1 kcal/mol of energy), how many sodium ions could one ATP molecule's hydrolysis move?" hint="Reread the energy-coupling paragraph above, and the previous section's account of what a negative ΔG means." >}}
...
{{< callout type="info" >}}
**Link to Learning.** See [an animation of the ATP-producing glycolysis process](https://openstax.org/l/glycolysis_stgs) at this site.
{{< /callout >}}
...
{{< textin
  question="The molecule that serves as the cell's main energy currency — a nucleoside bonded to three phosphate groups — is commonly known by its three-letter abbreviation ________."
  answer="ATP"
  accept="adenosine triphosphate"
...
{{< multiplechoice
  ...
  answer="sucrose"
  hint="Reread the section's opening paragraph, and the Energy and Metabolism section's discussion of energy stored in sugars."
>}}
sucrose
ATP
glucose
...
{{< textin
  ...
  accept="primary energy currency|energy-supplying molecule"
  hint="Reread the summary's opening sentence."
>}}
...
{{< multiplechoice
  question="The energy released by the hydrolysis of ATP is ________."
  answer="providing energy to coupled reactions"
  hint="Reread the two paragraphs that follow the ATP-formation equation."
>}}
...
{{< textin
  ...
  hint="Reread the first paragraph after the ATP structure figure."
>}}

{{< textin
  question="The strategy by which the energy released from one reaction — such as ATP hydrolysis — is used to drive a second, energy-requiring reaction is called ________."
  answer="energy coupling"
  hint="Reread the paragraph that opens by calling ATP a highly unstable molecule."
>}}

{{< selfcheck question="Do you think that the E<sub>A</sub> for ATP hydrolysis is relatively low or high? Explain your reasoning." hint="Reread the paragraph that opens by calling ATP a highly unstable molecule." >}}

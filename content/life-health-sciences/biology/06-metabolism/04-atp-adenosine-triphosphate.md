...
{{< textin
  ...
  hint="Its full chemical name describes a nucleoside bonded to three phosphate groups; almost everyone uses the short form instead."
>}}

{{< multiplechoice
  question="Which of the following molecules is likely to have the most potential energy?"
  answer="sucrose"
  hint="ATP is built for a quick, small burst of energy release, not for storing a large reserve of chemical energy — ask which molecule holds the most total energy in its bonds."
>}}
sucrose
ATP
glucose
...
{{< multiplechoice
  ...
  hint="Ask what the cell actually does with the free energy released by hydrolysis, rather than where in the molecule it was stored or how much of it there was."
>}}
...
{{< textin
  ...
  hint="The sodium-potassium pump uses this strategy: the exergonic breakdown of ATP powers the pump's energy-requiring conformational change."
>}}

...
description: >-
  Entropy and the first and second laws of thermodynamics, which govern how
  living systems transfer energy and why every energy transfer produces some
  unusable heat — adapted from OpenStax Biology 2e, Section 6.3.
source_section: "6.3"
weight: 3
---
...
{{< mediafigure src="biology/Figure_06_02_01" kind="diagram" alt="A labeled diagram of two side-by-side energy transformations, each two photographs joined by an arrow. On the left, a photo of a sprinkle-covered ice cream cone labeled Chemical energy points to a photo of two boys on bicycles labeled Kinetic energy. On the right, a photo of the sun in a blue sky labeled Light energy points to a photo of a leaf on a branch labeled Chemical energy." eager="true" >}}

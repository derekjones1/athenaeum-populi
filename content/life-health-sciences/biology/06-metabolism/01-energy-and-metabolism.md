...
description: >-
  How stepwise chemical reactions build and break down complex molecules
  through anabolic and catabolic metabolic pathways, and how cells capture
  and spend that energy as ATP — adapted from OpenStax Biology 2e, Section
  6.1.
source_section: "6.1"
weight: 1
---
...
{{< mediafigure src="biology/Figure_06_01_02" kind="photo" alt="The photo on the left shows acorns growing on an oak tree. The photo on the right shows a squirrel eating." >}}
...
body cells break down sugars to provide ATP to do the work necessary for exercise
muscle cells must repair muscle tissue damaged by exercise by building new muscle
{{< /selfcheck >}}
...
human motion is produced by muscle contraction
cells need energy to perform digestion

...
{{< mediafigure src="biology/Figure_B06_03_05abcd_new" kind="photo" alt="Four photographs, arranged two by two and labeled (a) through (d): (a) a wooden compost bin filled with decomposing plant matter and small seedlings growing from it; (b) a chick partway out of a cracked, speckled egg, surrounded by other unhatched eggs; (c) an aerial view of sand raked into a large spiral pattern, with one small figure standing at the far left edge, on plain sand outside the spiral; (d) people rolling down a grassy hillside inside large clear inflatable balls." >}}

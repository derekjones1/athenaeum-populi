...
{{< mediafigure src="biology/Figure_B17_01_05" kind="diagram" alt="Three-step diagram of Southern blotting: an agarose gel with DNA fragments separated into lanes by electrophoresis, a transfer setup stacking the gel, a nylon membrane, filter paper, and paper towels over a transfer-buffer reservoir, and the resulting membrane with a labeled probe bound to bands at the positions matching the sequence of interest." longdesc="Step 1, labeled “Electrophoresis is used to separate DNA fragments by size,” shows a gel box with a black gel holding several lanes; the DNA appears as a smear because there are too many fragments to resolve into distinct bands. Step 2, labeled “The DNA is transferred from the agarose gel to a nylon membrane,” shows the transfer stack in cross-section: paper towels on top, then a nylon membrane, then the agarose gel, then filter paper, resting on a bridge over a container labeled “Transfer buffer,” with an arrow showing buffer wicking upward through the stack. Step 3, labeled “The membrane is bathed in a solution containing a probe … labeled with a fluorescent dye so that the location of DNA fragments to which it hybridizes can be visualized,” shows the membrane alone with a few short dark bands at the positions where the probe has bound." >}}
...
{{< mediafigure src="biology/Figure_17_01_06" kind="diagram" alt="Four-stage flow diagram of molecular cloning into a plasmid vector: a circular strand of foreign DNA and a circular plasmid carrying a lacZ gene and an ampicillin-resistance gene are each cut by the same restriction enzyme; the cut fragments join by their complementary sticky ends and are sealed by ligase into a recombinant plasmid; the plasmid is taken up by bacteria; and the bacteria are grown on a plate, where colonies with the foreign-DNA insert appear white and colonies without it appear blue." longdesc="Row 1: a tangled loop labeled “Foreign DNA” beside a circular “Plasmid” map showing a restriction site inside a lacZ gene next to an ampicillin-resistance gene; an arrow notes the foreign DNA and plasmid are cut with the same restriction enzyme, which recognizes a restriction site located within the lacZ gene, a gene necessary for metabolizing lactose. Row 2: both molecules now show matching single-stranded sticky-end overhangs (each cut end reads GATCC over G, or G over CCTAG; the full GGATCC/CCTAGG site re-forms only after ligation); text notes the restriction enzyme creates sticky ends that let the foreign DNA and cloning vector anneal, and that an enzyme called ligase glues the annealed fragments together. Row 3: a joined circular plasmid, labeled “Bacteria (may take up plasmid with or without the insert, or may not take up plasmid at all),” with text explaining the ligated cloning vector is transformed into a bacterial host strain that is ampicillin-sensitive and is missing the lacZ gene from its genome. Row 4: a plate of bacterial colonies on orange agar, most of the dotted colonies blue and several white, with call-outs reading “Bacterial genome is missing the lacZ gene,” “Blue colonies have plasmids without insert,” and “White colonies have plasmids with the foreign insert”; text explains that bacteria are grown on media containing ampicillin and X-gal, that ampicillin kills bacteria without the plasmid, that plasmids lacking the insert have an intact lacZ gene and metabolize X-gal to release a dye that turns the colony blue, and that plasmids with the insert have a disrupted lacZ gene and produce white colonies." >}}
...
{{< multiplechoice
  ...
  hint="Degraded foreign DNA cannot anneal into the plasmid's cut site, so think about which colonies form when the plasmid recircularizes with no insert."
>}}
...
{{< mediafigure src="biology/Figure_17_01_07" kind="diagram" alt="Flow diagram of somatic cell nuclear transfer used to clone Dolly the sheep, running from a Scottish Blackface cytoplasmic donor and a Finn-Dorset nuclear donor, through enucleation and cell fusion, to a blastocyst implanted in a surrogate ewe that gave birth to Dolly." longdesc="At top left, a Scottish Blackface sheep labeled “Cytoplasmic donor,” with an arrow labeled “Enucleation” leading to a large egg cell shown with its nucleus being removed. At top right, a Finn-Dorset sheep labeled “Nuclear donor,” with an arrow labeled “Mammary cells” leading to a dish of cells. Arrows from both the enucleated egg and the mammary cell converge on a single cell, labeled “Direct current pulse,” showing the nuclear transfer and fusion step. An arrow from that fused cell leads down to a “Blastocyst,” drawn as a sphere with an inner cluster of cells on one side, then to a Scottish Blackface “Surrogate ewe,” and finally to a small lamb labeled “Dolly.”" >}}
...
{{< selfcheck question="Do you think Dolly was a Finn-Dorset or a Scottish Blackface sheep?" hint="The figure labels which sheep supplied the nucleus and which one supplied only the egg's cytoplasm and the surrogate womb — think about which one carries the genetic information." >}}
...
{{< mediafigure src="biology/Figure_17_01_08" kind="diagram" alt="Diagram titled “Gene therapy using an adenovirus vector,” showing a virus particle loaded with a new gene binding to and entering a human cell, then releasing its DNA into the nucleus so the cell manufactures the therapeutic protein." longdesc="At upper left, a spiked viral particle labeled with three DNA segments above it — “Viral DNA,” “New Gene,” and “Viral DNA” — with an arrow labeled “Modified DNA injected into vector” pointing into the particle. An arrow labeled “Vector binds to cell membrane” leads to the particle attached to a large pink cell surface. The next arrow, “Vector is packaged in vesicle,” shows the particle enclosed in a bubble inside the cell. “Vesicle breaks down releasing vector” shows the particle free in the cytoplasm. An inset at upper right zooms in on the same steps, labeling the particle “Vector (adenovirus)” beside the cell surface and a “New gene” arrow pointing toward the nucleus. The next step, “Vector injects new gene into nucleus,” shows the particle at the nuclear envelope releasing its DNA inside. The final step, “Cell makes protein using new gene,” shows a short strand of DNA in the cytoplasm beside newly made protein molecules." >}}
...
{{< selfcheck question="Describe the process of Southern blotting." hint="Think about what happens to DNA fragments after they're separated on a gel — where do they go next, and what identifies the sequence of interest?" >}}
...
{{< textin
  ...
  answer="lysis buffer"
  hint="The section notes that the first word of this term literally means “to split.”"
>}}
...
{{< textin
  ...
  answer="probe"
  hint="Southern and Northern blotting both bind one of these to the nylon membrane after the DNA or RNA has been transferred."
>}}
...
{{< multiplechoice
  ...
  hint="A GMO is defined by what happened to its DNA, not by which specific laboratory method did it — look for the broadest description among the options."
>}}
...
{{< selfcheck question="A researcher wants to study cancer cells from a patient with breast cancer. Is cloning the cancer cells an option?" hint="Think about which kind of cloning applies to growing more copies of an existing cell type, as opposed to copying a whole multicellular organism." >}}
...
{{< textin
  ...
  accept="recombinant DNA molecule"
  hint="This term also names the molecule as a whole, before it has been introduced into a bacterial host."
>}}
...
{{< multiplechoice
  ...
  hint="The section's example uses a virus vector to deliver a corrective gene into diseased cells, aiming at a disease outcome rather than naming a laboratory technique."
>}}
...
{{< multiplechoice
  ...
  hint="The insulin gene is placed in a plasmid and expressed in a bacterial host — think about what category of molecule the resulting insulin belongs to."
>}}
is of pig origin
...
{{< multiplechoice
  ...
  hint="*Bacillus thuringiensis* is the source organism, and organic farmers use its toxin as a pest-control product — think about what kind of substance that makes it."
>}}
...
{{< multiplechoice
  ...
  hint="The section credits this tomato with a longer shelf life from slowed rotting, plus an additional modification for one other trait — and says how its time on the market ended."
>}}
...
{{< selfcheck question="How would a scientist introduce a gene for herbicide resistance into a plant?" hint="The section names a specific bacterial plasmid system used to move DNA fragments into plant genomes — trace the steps from gene to transformed cell." >}}
...
{{< selfcheck question="If you had a chance to get your genome sequenced, what are some questions you might be able to have answered about yourself?" hint="The section's genetic-testing paragraph names two kinds of information doctors can learn from a person's genes — disease risk for the individual, and risk of passing a gene to offspring." >}}

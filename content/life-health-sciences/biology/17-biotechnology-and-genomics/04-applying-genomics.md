...
{{< textin
  question="Evaluating drug effectiveness and safety on the basis of information from an individual's genomic sequence is called ________."
  answer="pharmacogenomics"
  accept="toxicogenomics"
  hint="This term opens the section that follows disease-risk prediction, and it is the study of drug interactions with the genome or proteome."
>}}
...
{{< textin
  ...
  accept="drug interaction"
  hint="This is the same kind of interaction pharmacogenomics evaluates for effectiveness and safety before a drug reaches human trials."
>}}

{{< selfcheck question="How can genomics be used to predict disease risk and treatment options?" hint="Think about what a person's own DNA sequence uniquely tells a medical professional, beyond a population-wide average." >}}
...
{{< multiplechoice
  ...
  hint="The section's own subsection on this topic describes screening currently healthy individuals by genome analysis."
>}}
...
{{< textin
  question="A phenotypic characteristic caused by two or more genes is called ________."
  answer="polygenic"
  hint="The prefix “poly-” means “many”; this is the section's word for a multi-factored trait like heart disease."
>}}
...
{{< textin
  ...
  answer="metagenomics"
  hint="This approach replaced the older practice of studying one isolated species at a time."
>}}
...
{{< multiplechoice
  ...
  hint="Check whether the section supports every listed use — new hybrids, disease resistance, yield — or only some of them."
>}}
...
{{< selfcheck question="Explain why metagenomics is probably the most revolutionary application of genomics." hint="Think about what studying microorganisms in pure culture leaves out, and what studying them in their environmental niche captures instead." >}}

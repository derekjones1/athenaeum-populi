...
description: >-
  How genomics is applied to individual disease-risk prediction,
  pharmacogenomics, microbial metagenomics, biofuel development, mitochondrial
  genealogy and forensics, and agriculture — adapted from OpenStax Biology
  2e, Section 17.4.
source_section: "17.4"
weight: 4
---
...
genetic screening may be useful, it is expensive and may cause needless worry
people with certain risk factors may never develop the disease, and preventative treatments may do more harm than good
{{< /selfcheck >}}
...
{{< mediafigure src="biology/Figure_B17_06_01" kind="diagram" alt="Flow diagram. Three circles with a differently colored arc each sit at top; an arrow points down to three side-by-side clusters of short colored bars; a second arrow points down to three single, longer colored bars." longdesc="Three blue circles (genomic DNA molecules), each carrying one colored arc — red (top circle), purple (lower-left circle), and green (right circle) — with lines from each arc to the label “Each color represents DNA from a different species,” and a caption reading “All the genomic DNA from a particular environment is cut into fragments and ligated into a cloning vector.” A single arrow points down to three side-by-side clusters of short, staggered, overlapping bars in matching colors — seven purple at the left, five green in the middle, six red at the right — captioned “The fragments are sequenced, and regions of overlap are used to determine the genomic sequences.” A second single arrow, in the middle, points down to a bottom row of three long bars, purple, green, and red, one under each cluster, representing the reconstructed genomic sequence determined for each species." >}}
...
{{< textin
  question="Medical professionals can use personal genome sequence information to prescribe medications that will be most effective and least toxic on the basis of the individual patient's ________."
  answer="genotype"
  hint="Reread the section's second subsection."
>}}

{{< textin
  question="According to the section summary, before conducting clinical trials, researchers apply genomics to study ________."
  answer="drug interactions"
  hint="Reread the Summary's second sentence."
>}}

{{< selfcheck question="How can genomics be used to predict disease risk and treatment options?" hint="Reread the section's first two subsections." >}}
...
used for personalized medicine and treatment options
{{< /selfcheck >}}

{{< multiplechoice
  question="Genomics can be used on a personal level to:"
  answer="predict genetic diseases that a person may have inherited"
...
{{< textin
  question="The study of the collective genomes of multiple species that grow and interact together in an environmental niche is called ________."
  answer="metagenomics"
  hint="Reread the section's third subsection."
>}}

{{< textin
  question="Growth of a single cell type in the laboratory is called ________."
  answer="pure culture"
  hint="Reread the first sentences of the section's third subsection."
>}}

{{< multiplechoice
  question="Genomics can be used in agriculture to:"
  answer="all of the above"
  hint="Reread Genomics in Agriculture."
>}}
...
{{< selfcheck question="Explain why metagenomics is probably the most revolutionary application of genomics." hint="Reread the section's third subsection." >}}

...
description: >-
  How proteomics, metabolomics, and systems biology extend genomic analysis
  to a cell's actual proteins and metabolites, and how protein biomarkers
  and protein signatures are used in cancer detection — adapted from
  OpenStax Biology 2e, Section 17.5.
source_section: "17.5"
weight: 5
---
...
based on the interactions within the system
genomic- and proteomic-scale analyses are part of systems biology
researchers compare protein profiles between cells and identify proteins and genes involved in disease processes
{{< /selfcheck >}}
...
when a disease does occur, it can be used to develop a personalized treatment plan
{{< /selfcheck >}}

...
description: >-
  Genetic maps and physical maps, the markers and mapping methods used to
  build them (linkage analysis; RFLP, VNTR, microsatellite, and SNP markers;
  cytogenetic, radiation hybrid, and sequence mapping), and how the two map
  types combine to guide genome research — adapted from OpenStax Biology 2e,
  Section 17.2.
source_section: "17.2"
weight: 2
---
...
Go to [a web page comparing many organisms' gene sequences to the human insulin receptor gene](https://openstax.org/l/GeneINSR) to test the hypothesis.
...
{{< callout type="info" >}}
**Link to Learning.** Online Mendelian Inheritance in Man (OMIM) is a searchable online catalog of human genes and genetic disorders. This website shows genome mapping information, and also details the history and research of each trait and disorder. [Search OMIM for traits (such as handedness) and genetic disorders (such as diabetes)](https://openstax.org/l/OMIM).
{{< /callout >}}

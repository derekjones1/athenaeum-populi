---
title: Biology
description: A complete introductory biology course — the chemistry of life, cell structure and metabolism, genetics, evolution, the diversity of life, plant and animal form and function, and ecology — with interactive practice on every page.
...
ecology of the whole planet. This book is the two-semester majors course:
...
This book is adapted from **OpenStax Biology 2e** by Mary Ann Clark, Jung
Choi, Matthew Douglas, and OpenStax, © OpenStax, licensed under
[CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/).
Access the original for free at
[openstax.org](https://openstax.org/details/books/biology-2e). Every section

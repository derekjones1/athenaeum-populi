...
description: >-
  The fluid mosaic model of the plasma membrane and the roles its
  phospholipids, proteins, and carbohydrates play in the membrane's
  structure and fluidity — adapted from OpenStax Biology 2e, Section 5.1.
source_section: "5.1"
weight: 1
---
...
The explanation, the **fluid mosaic model**, has evolved somewhat over time, but it still best accounts for plasma membrane structure and function as we now understand them. The fluid mosaic model describes the plasma membrane structure as a mosaic of components—including phospholipids, cholesterol, proteins, and carbohydrates—that gives the membrane a fluid character. Plasma membranes range from 5 to 10 nm in thickness. For comparison, human red blood cells, visible via light microscopy, are approximately 8 µm wide, or approximately 1,000 times wider than a plasma membrane. The membrane does look a bit like a sandwich (below).

{{< mediafigure src="biology/Figure_05_01_01-52bf" kind="diagram" alt="A cross-section of the plasma membrane in the fluid mosaic model: a phospholipid bilayer with integral proteins spanning it, a peripheral protein attached to the inner face only, cholesterol between the phospholipid tails, and a glycoprotein and glycolipids carrying carbohydrate chains on the membrane's outer face." longdesc="A curved slab of membrane is drawn as a phospholipid bilayer — two rows of round white heads with wavy yellow tails between them — with fibers crossing the space above it and a mesh of gold filaments below it. Eight labels. Integral Protein: one of several blue proteins that span the full thickness of the bilayer; at the right, two of them sit pressed side by side. No protein channel or pore is labeled. Peripheral Protein: a small blue protein attached only to the inner face of the membrane, without crossing it. Cholesterol: two circled orange ring clusters among the tails (a third, unlabeled, sits farther right). Glycolipid: two circled chains of green hexagons, each set diagonally in the outer layer of the bilayer with its lower end among the tails. Glycoprotein: a circled blue protein dome on the outer surface carrying a branched green carbohydrate chain. Carbohydrate: a similar branched green chain on a cluster of proteins at the right of the outer surface. Phospholipid Bilayer: a bracket at the right spanning the two layers. A tall, curved, unlabeled blue protein also projects from the outer surface." eager="true" >}}
...
The membrane's main fabric comprises amphiphilic, phospholipid molecules. The **hydrophilic** or "water-loving" areas of these molecules (which look like a collection of balls in an artist's rendition of the model) (above) are in contact with the aqueous fluid both inside and outside the cell. **Hydrophobic**, or water-hating molecules, tend to be non-polar. They interact with other non-polar molecules in chemical reactions, but generally do not interact with polar molecules. When placed in water, hydrophobic molecules tend to form a ball or cluster. The phospholipids' hydrophilic regions form hydrogen bonds with water and other polar molecules on both the cell's exterior and interior. Thus, the membrane surfaces that face the cell's interior and exterior are hydrophilic. In contrast, the cell membrane's interior is hydrophobic and will not interact with water. Therefore, phospholipids form an excellent two-layer cell membrane that separates fluid within the cell from the fluid outside the cell.

A phospholipid molecule (below) consists of a three-carbon glycerol backbone with two fatty acid molecules attached to carbons 1 and 2, and a phosphate-containing group attached to the third carbon. This arrangement gives the overall molecule a head area (the phosphate-containing group), which has a polar character or negative charge, and a tail area (the fatty acids), which has no charge. The head can form hydrogen bonds, but the tail cannot. Scientists call a molecule with a positively or negatively charged area and an uncharged, or non-polar, area **amphiphilic** or "dual-loving."

{{< mediafigure src="biology/Figure_05_01_02" kind="diagram" alt="A phospholipid shown three ways: (a) a structural formula — a phosphate group linked to a three-carbon glycerol backbone, with two fatty acid chains attached, one saturated (straight) and one unsaturated (kinked); (b) a space-filling ball-and-stick model of the same molecule with its phosphate, glycerol, and fatty acids labeled; (c) the simplified symbol used for a phospholipid elsewhere in this chapter, a circle above two tails." longdesc="Three panels labeled (a), (b), and (c), side by side. Beside panel (a), vertical labels at the far left read Hydrophilic head (next to its upper, circular part) and Hydrophobic tails (next to its lower part). (a) Structural formula: inside a large pink circle, a phosphate group (R–O–P, with =O and O⁻ on the phosphorus) is linked through an oxygen to the right-hand CH₂ of a three-carbon glycerol backbone (CH₂–CH–CH₂); the other two carbons, the left CH₂ and the middle CH, are each linked through an oxygen to a carbonyl carbon (C=O) that begins a fatty acid tail. Below the circle, the left tail is a straight zigzag chain labeled Saturated fatty acid, and the right tail has a double bond and a bend partway along it and is labeled Unsaturated fatty acid. (b) Space-filling model: a rendering of the same molecule in spheres, with a small group at the very top, red oxygen spheres below it, and two chains of spheres labeled Fatty acids extending downward, the right chain bent. Labels Phosphate and Glycerol sit between panels (a) and (b), their lines connecting the phosphate and glycerol parts of the structural formula to the matching parts of the model. (c) Phospholipid symbol: a single circle labeled Hydrophilic head sitting atop two long, slightly splayed tails labeled Hydrophobic tails — the simplified icon used to represent a phospholipid elsewhere in this book." >}}
...
This characteristic is vital to the plasma membrane's structure because, in water, phospholipids arrange themselves with their hydrophobic tails facing each other and their hydrophilic heads facing out. In this way, they form a lipid bilayer—a double layered phospholipid barrier that separates the water and other materials on one side from the water and other materials on the other side. Phospholipids heated in an aqueous solution usually spontaneously form small spheres or droplets (micelles or liposomes), with their hydrophilic heads forming the exterior and their hydrophobic tails on the inside (below).

{{< mediafigure src="biology/Figure_05_01_03-f9be" kind="diagram" alt="Three lipid arrangements in water, each labeled: a hollow lipid-bilayer sphere cut in half, its cut face a ring of two concentric layers of polar heads and tails around a hollow center, a smaller single-layer lipid sphere with only one layer of heads and tails, and a flat lipid-bilayer sheet with tails sandwiched between two rows of heads." longdesc="Three drawn structures. Lipid-bilayer sphere (top left): a large hollow sphere cut in half and seen at an angle, its cut face showing an outer ring of polar heads with thin tails pointing inward, and an inner ring with the same anatomy reversed — its polar heads face the sphere's hollow core and its tails point outward toward the tails of the outer ring, so the two tail layers meet in the middle. Single-layer lipid sphere (top right, smaller): the same half-sphere cutaway but with only one layer — heads on the outside, tails converging toward the sphere's solid center. Lipid-bilayer sheet (bottom): a flat, elongated structure with a row of heads along the top edge and another along the bottom edge, and the tails filling the space between them, meeting in the middle." >}}
...
Proteins comprise the plasma membranes' second major component. **Integral proteins**, or integrins, as their name suggests, integrate completely into the membrane structure, and their hydrophobic membrane-spanning regions interact with the phospholipid bilayer's hydrophobic region (above). Single-pass integral membrane proteins usually have a hydrophobic transmembrane segment that consists of 20–25 amino acids. Some span only part of the membrane—associating with a single layer—while others stretch from one side to the other, and are exposed on either side. Up to 12 single protein segments comprise some complex proteins, which are extensively folded and embedded in the membrane (below). This protein type has a hydrophilic region or regions, and one or several mildly hydrophobic regions. This arrangement of protein regions orients the protein alongside the phospholipids, with the protein's hydrophobic region adjacent to the phospholipids' tails and the protein's hydrophilic region or regions protruding from the membrane and in contact with the cytosol or extracellular fluid.

{{< mediafigure src="biology/Figure_05_01_04-8e5f" kind="diagram" alt="The left part of this illustration shows an integral membrane protein with a single alpha-helix that spans the membrane. The middle part shows a protein with several alpha-helices spanning the membrane. The right part shows a protein with two beta-sheets spanning the membrane." >}}
...
{{< callout type="info" >}}
**Link to Learning.** View [animations of the membrane's fluidity and mosaic quality](https://openstax.org/l/biological_memb).
{{< /callout >}}
...
{{< callout type="info" >}}
**Career Connection.** *Immunologist.* The variations in peripheral proteins and carbohydrates that affect a cell's recognition sites are of prime interest in immunology. In developing vaccines, researchers have been able to conquer many infectious diseases, such as smallpox, polio, diphtheria, and tetanus.
...
{{< textin
  question="The name given to the plasma membrane's structure — a shifting arrangement of phospholipids, cholesterol, proteins, and carbohydrates that keeps the membrane flexible rather than rigid — is the ________ ________ ________."
  answer="fluid mosaic model"
  hint="Reread the second paragraph of the section's first subsection."
>}}

{{< selfcheck question="Why do phospholipids tend to spontaneously orient themselves into something resembling a membrane?" hint="Reread the Phospholipids subsection and its lipid-arrangement figure." >}}
...
{{< multiplechoice
  ...
  answer="protein"
  hint="Reread the table of plasma membrane components at the end of Membrane Fluidity."
>}}
protein
cholesterol
carbohydrate
...
{{< multiplechoice
  ...
  answer="identification of the cell"
  hint="Reread the Carbohydrates subsection."
>}}
...
{{< textin
  ...
  answer="integral"
  accept="integral protein|integral membrane protein|integrin"
  hint="Reread the first paragraph of the Proteins subsection."
>}}

{{< textin
  question="A protein located at the plasma membrane's surface, on either its exterior or its interior side, is called a(n) ________ protein."
  answer="peripheral"
  accept="peripheral protein|peripheral membrane protein"
  hint="Reread the paragraph that follows the integral-protein figure."
>}}

{{< selfcheck question="How can a cell use an extracellular peripheral protein as the receptor to transmit a signal into the cell?" hint="Reread the Proteins subsection and the table of plasma membrane components." >}}
...
{{< multiplechoice
  ...
  hint="Reread the second and third paragraphs of Membrane Fluidity."
>}}
its head
cholesterol
...
{{< multiplechoice
  question="A scientist compares the plasma membrane composition of an animal from the Mediterranean coast with one from the Mojave Desert. Which hypothesis is most likely to be correct?"
  answer="The cells from the Mojave Desert animal will have a higher cholesterol concentration in the plasma membranes."
  hint="Reread the last paragraph of Membrane Fluidity."
>}}
...
{{< selfcheck question="Why is it advantageous for the cell membrane to be fluid in nature?" hint="Reread the opening paragraph of Membrane Fluidity." >}}

...
description: >-
  ...
  and exocytosis, the two directions cells use to move large particles and
  bulk material across the plasma membrane — adapted from OpenStax Biology
  2e, Section 5.4.
source_section: "5.4"
weight: 4
---
...
See receptor-mediated endocytosis in action, and click on [different parts of an interactive endocytosis animation](https://openstax.org/l/endocytosis) for a focused animation.
{{< /callout >}}
...
ions must be transported by carrier proteins or ion channels
{{< /selfcheck >}}

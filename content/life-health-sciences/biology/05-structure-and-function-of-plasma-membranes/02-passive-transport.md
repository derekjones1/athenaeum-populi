...
description: >-
  How simple diffusion, facilitated transport, and osmosis move substances
  across the plasma membrane without expending cellular energy, and how a
  cell's tonicity relative to its surroundings determines whether water
  enters, leaves, or stays in balance — adapted from OpenStax Biology 2e,
  Section 5.2.
source_section: "5.2"
weight: 2
---
...
**Diffusion** is a passive process of transport. A single substance moves from a high concentration to a low concentration area until the concentration is equal across a space. You are familiar with diffusion of substances through the air. For example, think about someone opening a bottle of ammonia in a room filled with people. The ammonia gas is at its highest concentration in the bottle. Its lowest concentration is at the room's edges. The ammonia vapor will diffuse, or spread away, from the bottle, and gradually, increasingly more people will smell the ammonia as it spreads. Materials move within the cell's cytosol by diffusion, and certain materials move through the plasma membrane by diffusion (below). Diffusion expends no energy. On the contrary, concentration gradients are a form of potential energy, which dissipates as the gradient is eliminated.

{{< mediafigure src="biology/Figure_05_02_02-9936" kind="diagram" alt="A three-part diagram of a lipid bilayer separating extracellular fluid, crowded with small hexagonal particles, from the cytoplasm below, which starts empty; over time (left to right) the particles diffuse across the membrane until they are equally dense on both sides." >}}
...
The integral proteins involved in facilitated transport are **transport proteins**, and they function as either channels for the material or carriers. In both cases, they are transmembrane proteins. Channels are specific for the transported substance. **Channel proteins** have hydrophilic domains exposed to the intracellular and extracellular fluids. In addition, they have a hydrophilic channel through their core that provides a hydrated opening through the membrane layers (below). Passage through the channel allows polar compounds to avoid the plasma membrane's nonpolar central layer that would otherwise slow or prevent their entry into the cell. **Aquaporins** are channel proteins that allow water to pass through the membrane at a very high rate.

{{< mediafigure src="biology/Figure_05_02_04-fcc1" kind="diagram" alt="A diagram titled Gated Channel Protein showing two copies of the same channel protein embedded in the membrane: on the left, labeled Gate Closed, the channel's interior pinches shut and no ions cross; on the right, labeled Gate Opened, the channel is open and an arrow shows ions passing through from the extracellular fluid into the cytoplasm." longdesc="Two copies of a purple, vase-shaped channel protein sit side by side in the gray-and-gold phospholipid bilayer. The left copy, labeled Gate Closed, has its central channel pinched shut, with two leader lines pointing to the closure. The right copy, labeled Gate Opened, has an open central channel with a white upward arrow drawn through it. Above the open channel, blue circles (ions) sit in the extracellular fluid; below both proteins, a scattered field of blue and orange circles (two ion types) fills the cytoplasm, with more blue circles clustered directly beneath the open channel than the closed one." >}}
...
Osmosis is a special case of diffusion. Water, like other substances, moves from an area of high concentration of free water molecules to one of low free water molecule concentration. An obvious question is what makes water move at all? Imagine a beaker with a semipermeable membrane separating the two sides or halves (below). On both sides of the membrane the water level is the same, but there are different dissolved substance concentrations, or **solute**, that cannot cross the membrane (otherwise the solute crossing the membrane would balance concentrations on each side). If the solution's volume on both sides of the membrane is the same, but the solute's concentrations are different, then there are different amounts of water, the solvent, on either side of the membrane.

{{< mediafigure src="biology/Figure_05_02_06-d985" kind="diagram" alt="Two side-by-side beakers, each split down the middle by a red dashed semipermeable membrane. In the left beaker the liquid level is the same on both sides, with purple solute particles concentrated on the right half and almost none on the left. In the right beaker, after time has passed, the liquid level has risen on the solute side and dropped on the particle-free side, while the same number of solute particles now occupies the larger volume." >}}
...
{{< mediafigure src="biology/Figure_05_02_07" kind="diagram" alt="A diagram titled Tonicity with three panels of a red blood cell: in a hypotonic solution the cell is bloated and lysed, with fragments tearing away; in an isotonic solution the cell keeps its normal disc shape; in a hypertonic solution the cell is shriveled with a spiky, crenated outline. Blue arrows show water (H₂O) moving into the cell in the first panel, both into and out of it in the second, and out of it in the third." >}}
...
{{< callout type="info" >}}
**Link to Learning.** Watch [a video illustrating the diffusion process in solutions](https://openstax.org/l/dispersion).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_05_02_09" kind="photo" alt="Two potted plants side by side: the one on the left is wilted, with its stems drooping and leaves shriveled and drying; the one on the right stands upright and full, with broad, soft green leaves." >}}
...
Tonicity is a concern for all living things. For example, paramecia and amoebas, which are protists that lack cell walls, have contractile vacuoles. This vesicle collects excess water from the cell and pumps it out, keeping the cell from lysing as it takes on water from its environment (below).

{{< mediafigure src="biology/Figure_05_02_10" kind="photo" alt="A bright-field light micrograph of an oval-shaped, single-celled organism, with two contractile vacuoles visible as small round structures near its two ends, indicated by leader lines; a scale bar reads 25 µm." >}}

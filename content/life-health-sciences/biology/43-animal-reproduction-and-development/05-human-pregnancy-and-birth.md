...
description: >-
  How a fertilized egg develops through the three trimesters of human
  gestation, the hormonal signals that trigger labor and its three stages,
  common methods of contraception and their failure rates, and the causes
  of infertility and assisted reproductive technologies such as IVF —
  adapted from OpenStax Biology 2e, Section 43.5.
source_section: "43.5"
weight: 5
---
...
{{< mediafigure src="biology/Figure_43_07_03" kind="photo" alt="A specimen jar shows a round, pale placenta at the top and a curled second-trimester fetus with long arms and legs beneath it, connected by a thin cord." >}}
...
Visit [an interactive tool tracing the stages of human fetal development](https://openstax.org/l/embryo_fetus).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_43_07_05" kind="photo" alt="A black-and-white micrograph shows a rounded egg cell with a thin glass needle inserted into it from the right, injecting sperm; a smaller cell cluster sits at the upper left, and a 25 µm scale bar appears in the lower right corner." >}}
...
the second trimester continues the development of all of the organs and systems established during the first trimester
the placenta takes over the production of estrogen and high levels of progesterone and handles the nutrient and waste requirements of the fetus

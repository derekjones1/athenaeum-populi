...
description: >-
  How animals reproduce asexually through fission, budding, fragmentation,
  and parthenogenesis and sexually through the combination of two
  individuals' genetic material, and how an individual's sex is determined
  by chromosomes or by environmental factors such as incubation temperature
  — adapted from OpenStax Biology 2e, Section 43.1.
source_section: "43.1"
weight: 1
---
...
{{< mediafigure src="biology/Figure_43_01_01" kind="photo" eager="true" alt="A close-up of many small, cup-shaped coral polyps clustered together, each fringed with short translucent tentacles surrounding a central mouth." >}}
...
Watch [a video of a hydra budding](https://www.openstax.org/l/budding_hydra).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_43_01_03" kind="diagram" alt="A colorful illustration of a sea star with one very long arm bent to the side and four short, stubby arms clustered near the body." >}}
...
that may better enable them to survive changes in the environment
and assist in the survival of the species
{{< /selfcheck >}}

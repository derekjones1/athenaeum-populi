...
{{< multiplechoice
  ...
  hint="This structure is coiled inside the testes and its walls are lined by the developing sperm cells themselves — it is not one of the three accessory glands that add fluid to semen."
>}}
scrotum
seminal vesicles
...
{{< multiplechoice
  ...
  answer="clitoris"
  hint="The section's opening paragraph says the tissue that produces the penis in males produces one specific structure in females — not the tissue that becomes the scrotum, and not an internal duct."
>}}
clitoris
labia majora
...
{{< multiplechoice
  ...
  hint="Every stage after the first meiotic division carries only half of each chromosome pair — find the one stage in this list that meiosis has not yet touched."
>}}
...
{{< textin
  ...
  hint="This term shares its root with the word for sperm, and it takes place in the wall of the seminiferous tubules."
>}}

{{< textin
  question="The process of producing haploid eggs is called ________."
  answer="oogenesis"
  hint="This term shares its root with the word for egg, and it begins before birth but pauses until puberty."
>}}

{{< selfcheck question="Compare spermatogenesis and oogenesis as to timing of the processes and the number and type of cells finally produced." hint="Contrast when each process starts and pauses, then contrast how many functional gametes each process yields from one starting cell." >}}
...
oogenesis continues again at adolescence in batches of oogonia with each menstrual cycle, producing a primary oocyte and a polar body with 23 chromosomes

...
description: >-
  How the three germ layers differentiate into organs through organogenesis,
  with a close look at neural tube and somite formation, and how vertebrate
  bodies establish their lateral-medial, dorsal-ventral, and
  anterior-posterior axes — adapted from OpenStax Biology 2e, Section 43.7.
source_section: "43.7"
weight: 7
---
...
{{< mediafigure src="biology/Figure_43_06_02" kind="photo" alt="Embryo resembles a segmented earthworm with a bulging head." >}}
...
during differentiation, the embryonic stem cells express a specific set of genes that determines their ultimate fate as a cell type
cells in the ectoderm express genes specific to skin cells and differentiate into epidermal cells
...
the dorsal cells are genetically programmed to form the notochord and define the axis

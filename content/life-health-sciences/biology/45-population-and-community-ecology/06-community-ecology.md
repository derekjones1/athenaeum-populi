...
description: >-
  How predator-prey cycles, defenses against predation and herbivory,
  competitive exclusion, and symbiotic relationships such as commensalism,
  mutualism, and parasitism shape a community, and how foundation species,
  keystone species, and succession describe its structure and change over
  time — adapted from OpenStax Biology 2e, Section 45.6.
source_section: "45.6"
weight: 6
---
...
{{< mediafigure src="biology/Figure_45_06_01" kind="diagram" eager="true" alt="A line chart titled 'Predator-prey Dynamics' plotting thousands of animals against time in years from 1845 to about 1935, with a red-shaded curve for hare and a pale blue-shaded curve for lynx. The hare curve repeatedly climbs from a low trough to a sharp peak and drops again; the lynx curve rises and falls on the same rhythm, a little behind the hare curve; it usually peaks lower, but rises above the hare curve where the hare falls away first." longdesc="The chart's y-axis is labeled 'Thousands of animals' and is marked only at 50 and 100, with gridlines there; the plot's bottom edge sits near 17 and its top just over 140; the x-axis is labeled 'Time (years)' and is marked at 1845, 1865, 1885, 1905, and 1925, extending to roughly 1935. A legend in the upper right marks the red-filled curve 'Hare (red)' and the pale blue-filled curve 'Lynx (blue).' Both curves rise and fall together across the plotted span: each time the hare curve climbs from a low trough near the bottom of the chart to a peak — the tallest peaks, just before 1865 and at about 1886, reach close to the top of the chart — then drops steeply back down; the lynx curve follows the same up-and-down rhythm a little later than the hare curve and usually peaks lower, so the red hare curve is visible above the blue lynx curve through most of each cycle; where the hare falls away first, the pale blue lynx area shows above it, as at the start in 1845, just after 1865, just after 1905, around 1925, and at the right edge." >}}
...
{{< mediafigure src="biology/Figure_45_06_02abcd" kind="photo" alt="Photo (a) shows the long, sharp thorns of a honey locust tree. Photo (b) shows a turtle perched on a log, its long neck and head extending out from its large shell. Photo (c) shows the pink, bell-shaped flowers of a foxglove. Photo (d) shows a millipede curled into a ball." >}}
...
{{< mediafigure src="biology/Figure_45_06_03-a5a9" kind="photo" alt="Photo (a) shows a green walking stick insect that resembles the stem on which it sits. Photo (b) shows a green chameleon that resembles a leaf." >}}
...
{{< mediafigure src="biology/Figure_45_06_04ab" kind="photo" alt="Photo (a) shows a bright red frog sitting on a leaf. Photo (b) shows a skunk, whose body is covered in black fur, but has two prominent white stripes extending down its back and tail." >}}
...
{{< mediafigure src="biology/Figure_45_06_05-5e19" kind="photo" alt="Photos (a) and (b) show virtually identical looking insects. Both have smooth black faces and legs, but their bodies are covered in a white, fuzzy-looking material." >}}
...
{{< mediafigure src="biology/Figure_45_06_06" kind="photo" alt="Eight mounted butterfly specimens arranged as four pairs; within each pair the two butterflies are nearly identical in color and banding pattern, though the pattern differs from one pair to the next." >}}
...
Go to [this website of stunning mimicry examples](https://openstax.org/l/find_the_mimic) to view stunning examples of mimicry.
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_45_06_08" kind="photo" alt="Photo shows a yellow bird building a nest in a tree." >}}
...
{{< mediafigure src="biology/Figure_45_06_09-df2c" kind="photo" alt="Photo (a) shows yellow termites, and photo (b) shows a tree covered with lichen; the tree's bark appears covered in a mossy, fuzzy substance." >}}
...
{{< mediafigure src="biology/Figure_B45_06_09ab" kind="diagram" alt="A numbered life-cycle diagram titled 'Tapeworm (Taenia) Infection,' with six numbered steps connected by paired blue and red arrows that run from a feces icon, up through a pig icon and a human figure, and back down again. A black-background photograph of several long, ribbon-like preserved tapeworm segments with a scale bar sits at lower right, outside the numbered cycle." longdesc="The cycle has six steps, each numbered in a small colored circle beside its text, joined by blue and red arrows that run in parallel pairs from step 1 through the muscle icon; no legend explains the two colors. Step 1, at the bottom in a boxed icon of a round tapeworm egg beside a rectangular tapeworm segment, reads 'Eggs or tapeworm segments in feces are passed into the environment.' Two arrows lead up to step 2, set beside an outline of a pig, reading 'Eggs or segments are ingested by pigs or humans.' Arrows continue upward to step 3, a circular hatching-embryo icon, reading 'Tapeworm embryos hatch, penetrate the intestinal wall, and circulate to musculature in pigs or humans,' which leads to an oval muscle-tissue icon showing an embedded larva, labeled 'Embryos develop into larvae in muscles of pigs or humans.' From there, one blue arrow leads to a human figure at the upper right whose brain, throat, lungs, and digestive tract are highlighted, labeled 'Cysts may develop in any organ, and are most common in subcutaneous tissue as well as in the brain and eyes'; beside that figure, a second small muscle-tissue icon (matching the larva icon at the left) sends three red arrows fanning out into the figure — one toward the mouth/face, one up into the highlighted brain, and one down to the shoulder — showing where the text's three cyst sites lie. A second blue arrow leads down to a central human figure with the same organs highlighted, marking step 4, 'Humans acquire the infection by ingesting raw or undercooked meat from an infected animal host.' Two black lines lead from that figure's intestine: one marks step 5, 'The tapeworm attaches itself to the intestine via hooks on the scolex,' with a separate hook-and-sucker icon labeled 'Scolex' drawn to the right of the figure; the other leads down to step 6, below the figure, which reads 'Adults in small intestine' beside a coiled strip of tapeworm segments ending in one detached oval segment, and a blue arrow leads from the bottom of the central figure back down to the step 1 box, closing the cycle. Outside the numbered cycle, at lower right, is a black-background photograph of several long, pale, ribbon-like preserved tapeworm specimens laid out beside a measuring scale bar." >}}
...
{{< mediafigure src="biology/Figure_45_06_11" kind="photo" alt="Photo shows pink brain-like coral and long, finger-like coral growing on a reef. Fish swim among the coral." >}}
...
{{< mediafigure src="biology/Figure_45_06_12" kind="diagram" alt="A shaded map of North and South America keyed to a nine-class legend for the number of mammal species per square kilometer; shading is lightest across most of North America, darkens southward through Mexico and Central America, and is darkest across northern South America and the Amazon basin." longdesc="The map's legend, titled 'Number of mammal species per sq km,' lists nine shaded classes from lightest to darkest: 0, 1–23, 24–42, 43–60, 61–93, 94–128, 129–154, 155–178, and 179–228. On the map, Alaska, Canada, and the eastern United States are shaded in the light classes (about 1–60), lightest on the Arctic islands; shading darkens through the western United States (about 61–93) into Mexico (about 94–128), and Central America darkens further southward, to about 129–178 near Panama. Northern South America and the Amazon basin carry the darkest shading (155–228 species per square kilometer, the darkest class concentrated in the northeast), with shading lightening again toward the southern tip of South America. A north-pointing arrow and a 500 km scale bar sit at the left, above the legend." >}}
...
{{< mediafigure src="biology/Figure_45_06_13" kind="photo" alt="Photo shows a purple, mauve-ridged sea star resting among rocks, with clusters of dark mussels nearby." >}}
...
{{< mediafigure src="biology/Figure_45_06_14" kind="photo" alt="Photo (a) shows purple loosestrife, a tall, thin purple flower. Photo (b) shows many tiny zebra mussels attached to a manmade object in a lake. Photo (c) shows buckthorn, a bushy plant with glossy leaves and clusters of dark berries. Photo (d) shows garlic mustard, a small plant with white flowers. Photo (e) shows an emerald ash borer, a slender, metallic-green beetle. Photo (f) shows a starling." >}}
...
{{< mediafigure src="biology/Figure_45_06_15" kind="photo" alt="Photo shows a succulent plant growing directly out of bare, dark volcanic rock." >}}
...
{{< multiplechoice question="Besides direct predation, what density-dependent factor does the section suggest may also drive the snowshoe hare population's cycling?" answer="lower fecundity caused by crowding when the hare population is too dense" hint="Reread the paragraph after the lynx and snowshoe hare graph." >}}
lower fecundity caused by crowding when the hare population is too dense
increased disease transmission among crowded hares
reduced growth of the hares' food plants
greater hunting efficiency by lynx at high hare density
{{< /multiplechoice >}}

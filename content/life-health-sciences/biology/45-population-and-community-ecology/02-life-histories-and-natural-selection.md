...
description: >-
  How energy budgets shape the tradeoff between fecundity and parental care,
  why species reproduce early or late in life, and how semelparity and
  iteroparity describe single versus repeated reproductive events — adapted
  from OpenStax Biology 2e, Section 45.2.
source_section: "45.2"
weight: 2
---
...
Play this [interactive PBS evolution-based mating game](https://openstax.org/l/mating_game) to learn more about reproductive strategies.
{{< /callout >}}
...
most of their energy budget is used in the formation of seeds or offspring, leaving little for parental care
the sheer number of offspring would make individual parental care impossible
{{< /selfcheck >}}
...
animals that mature earliest reproduce the most times, so more of the next generation carries their early maturation genes
a species that reproduces late will only generate offspring from parents that survived in their habitats
this increases the likelihood the next generation is well-adapted to its environment
{{< /selfcheck >}}

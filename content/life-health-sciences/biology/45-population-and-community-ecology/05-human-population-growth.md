...
{{< textin
  ...
  answer="exponential"
  hint="The section's opening paragraphs name this growth pattern more than once — it describes a rate that keeps accelerating rather than staying level."
>}}
...
{{< multiplechoice
  ...
  hint="Three of the four options are things the section credits with expanding what the environment can support, whether through technology passed to new generations, domesticated food sources, or farming methods; the remaining option describes consuming resources rather than expanding the environment's capacity to support them."
>}}
agriculture

...
description: >-
  How human population growth remains exponential even though it falls far
  below humanity's biotic potential, how humans have expanded Earth's
  carrying capacity, what age structure reveals about a country's economic
  development, and the long-term risks of unchecked growth — adapted from
  OpenStax Biology 2e, Section 45.5.
source_section: "45.5"
weight: 5
---
...
{{< mediafigure src="biology/Figure_45_05_01" kind="diagram" eager="true" alt="Line graph of six colored curves plotting estimated world population in thousands against year, from 1000 to just past 2000. Only the World curve starts at 1000, rising slowly and nearly flat until about 1800; the five regional curves begin around 1750. All then curve upward, with the World curve rising highest and steepest by 2000." longdesc="The x-axis runs from 1000 to a little past 2000, labeled at 1000, 1200, 1400, 1600, 1800, and 2000; the y-axis, labeled 'Estimated population (in thousands),' runs from 0 to 7,000,000. Six curves are plotted, listed top to bottom in the legend: World (dark blue), Africa (red), Asia (yellow), Europe (light blue), Latin America (purple), and Northern America (maroon). Only the World curve is drawn from 1000; it rises slowly, nearly flat, from about 300,000 thousand to about 1,000,000 thousand by 1800. The five regional curves begin around 1750, Asia at about 500,000 thousand and the other four lower. All curves bend upward after about 1800; the World curve rises steepest, reaching about 6,600,000 thousand by 2000. The Asia curve climbs to about 4,000,000 thousand by 2000, well above the other four regional curves, which stay under roughly 1,000,000 thousand. The Europe curve flattens out again near the end of the graph while the other curves are still climbing." >}}
...
{{< mediafigure src="biology/Figure_45_05_02" kind="diagram" alt="Horizontal bar graph of nine bars, each labeled with a population milestone and the year it was reached, from 1 billion in 1800 to a projected 9 billion in 2054, plotted against years needed to reach that milestone. The first bar is cut off by a scale break in the axis; the remaining bars shorten sharply and then lengthen again toward the later, projected milestones." longdesc="Nine horizontal bars are stacked top to bottom, each labeled at left with a population milestone and year: '1 billion: 1800,' '2 billion: 1930,' '3 billion: 1960,' '4 billion: 1975,' '5 billion: 1987,' '6 billion: 1999,' '7 billion: 2012,' '8 billion: 2028,' and '9 billion: 2054.' The x-axis, labeled 'Years,' is labeled every 20 years from 0 to 140, with a diagonal break mark past 140. The first bar ('1 billion: 1800') is the longest, runs through a matching break mark to the plot's right edge, and carries no year-count number. The second bar ('2 billion: 1930') is almost as long and is labeled 130. The remaining seven bars are much shorter, shrinking and then lengthening again, each labeled with its own year count: 30 (3 billion, 1960), 15 (4 billion, 1975), 12 (5 billion, 1987), 12 (6 billion, 1999), 13 (7 billion, 2012), 16 (8 billion, 2028), and 26 (9 billion, 2054). Below the axis is printed 'Source: Population Reference Bureau.'" >}}
...
Click through [this video of how human populations have changed over time](https://openstax.org/l/human_growth).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_45_05_03" kind="diagram" alt="Four age structure diagrams, each split into a blue Male half and a pink Female half, plotted against a shared Age axis with gridlines at 15 and 65. The first two panels narrow steadily from a wide base to a point at the top; the third is rounded at the top; the fourth panel's shape is left for the reader to interpret." longdesc="Four bell- or pyramid-shaped outlines are shown side by side under the title 'Age Structure Diagrams,' each split down the middle into a blue left half labeled 'Male' and a pink right half labeled 'Female' (the Male/Female labels are printed only on the first panel). A shared y-axis at the far left, labeled 'Age,' carries two dotted horizontal gridlines at 15 and 65. Panel 1, 'Stage 1: Rapid growth,' is wide at the base and narrows rapidly, its sides curving inward, to a sharp point above the 65 line, so the shape is widest below the 15 line and only a thin spike rises past 65. Panel 2, 'Stage 2: Slow growth,' is a straight-sided triangle that narrows steadily from base to a point at the top. Panel 3, 'Stage 3: Stable,' has straight lower sides that curve inward and round off at the top, wider through the middle than panel 2. Panel 4, 'Stage 4: ?,' starts narrower than panel 3 at the base, widens to about panel 3's base width by the middle of the shape, then narrows to a rounded top; its outline bulges outward around the middle instead of tapering steadily like the first two panels." >}}
...
{{< mediafigure src="biology/Figure_45_05_04" kind="diagram" alt="World map shaded by percent population growth in five bands from about 0% to 3%+. Much of Africa, the Middle East, and parts of Asia are shaded in the higher-growth bands; North America, Australia, Japan, and most of Europe are shaded in the lowest bands." longdesc="A world map is shaded by a five-band legend, 'Percent Growth in Population,' reading left to right: −0% (dark red), 0%–1% (gray), 1% (purple), 2% (yellow), and 3%+ (pale cream). Eastern Europe, Northern Asia, Greenland, and South Africa are shaded −0%. The United States, Canada, the southern part of South America, China, Japan, western Europe, and Australia are shaded 0%–1%. Mexico, the northern part of South America, and parts of Africa, the Middle East, and Asia are shaded 1%. Most of Africa and parts of the Middle East and Asia are shaded 2%. A few parts of Africa, and a strip of the southern Arabian Peninsula, are shaded 3%+." >}}
...
Watch [this data visualization](https://openstax.org/l/populations) and watch the human population growth over time.
{{< /callout >}}
...
{{< textin
  question="The world's human population is growing at a(n) ________ rate."
  answer="exponential"
...
resources would have to be such that the environment would support this growth
neither of these two conditions exists, yet the population is still growing exponentially
{{< /selfcheck >}}

### Explain how humans have expanded the carrying capacity of their habitat

{{< multiplechoice
  question="Which of the following is not a way that humans have increased the carrying capacity of the environment?"
  answer="using large amounts of natural resources"
  hint="Reread the section's first subsection, on how humans have expanded the carrying capacity of their environment, and check each option against it."
>}}
agriculture
...
public health, sanitation, antibiotics, and vaccines have decreased the ability of infectious disease to limit population growth
infectious disease influence on human population growth is becoming less significant
{{< /selfcheck >}}
...
slower growing populations have a lower percentage of these individuals
countries with zero population growth have an even lower percentage of these individuals
a high proportion of older individuals is seen mostly in countries with zero growth, and a low proportion is most common in rapidly growing countries
{{< /selfcheck >}}
...
these resources are usually taken at the expense of the environment and the organisms that rely on them, such as habitat destruction for human development and water rerouting for irrigation
the continued use of fossil fuels also contributes to climate change
changing climates mean certain species can no longer survive in some areas
{{< /selfcheck >}}

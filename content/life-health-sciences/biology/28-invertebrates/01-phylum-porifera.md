...
description: >-
  The sponges of phylum Porifera as the simplest multicellular animals, with
  their body plan, specialized cell types, and how they feed, exchange
  gases, reproduce, and move without true tissues or organs — adapted from
  OpenStax Biology 2e, Section 28.1.
source_section: "28.1"
weight: 1
---
...
We will start our investigation with the simplest of all the invertebrates—animals sometimes classified within the clade Parazoa ("beside the animals"). This clade currently includes only the phylum Placozoa (containing a single species, *Trichoplax adhaerens*), and the phylum **Porifera**, containing the more familiar sponges (pictured below). The split between the Parazoa and the Eumetazoa (all animal clades above Parazoa) likely took place over a billion years ago.
...
{{< mediafigure src="biology/Figure_28_01_01" kind="photo" eager="true" alt="A close-up underwater photo of several rounded, bumpy yellow sponges clustered on a gray rock, dark circular openings dotting their surfaces, with a frond of green algae draped beside them." >}}
...
Watch [a video of water moving through the sponge body](https://www.openstax.org/l/filter_sponges).
{{< /callout >}}
...
Use the [Interactive Sponge Guide](https://openstax.org/l/id_sponges) to identify species of sponges based on their external form, mineral skeleton, fiber, and skeletal architecture.
{{< /callout >}}
...
Watch this [BBC video showing sponges along the Cayman Wall during a submersible dive](https://openstax.org/l/sea_sponges).
{{< /callout >}}
...
porocytes form ostia and act as valves to regulate the flow of water into the spongocoel
choanocytes always line some space through which water flows
...
food particles are caught by the collar of the choanocyte and brought into the cell by phagocytosis
digestion takes place within cells rather than outside of cells, unlike in other animals
the organism can feed only on particles smaller than the cells themselves
{{< /selfcheck >}}

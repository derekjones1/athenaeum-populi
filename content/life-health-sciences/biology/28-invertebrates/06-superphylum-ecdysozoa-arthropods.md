...
description: >-
  Phylum Arthropoda's subphyla — Chelicerata, Myriapoda, Crustacea, and
  Hexapoda, alongside the extinct Trilobita — compared by their appendages,
  respiratory structures, and cuticle, and the reasons this molting,
  exoskeleton-bearing phylum dominates animal diversity — adapted from
  OpenStax Biology 2e, Section 28.6.
source_section: "28.6"
weight: 6
---
...
The principal characteristics of all the animals in this phylum are the structural and functional segmentation of the body and the presence of jointed appendages. Arthropods have an exoskeleton made principally of chitin—a waterproof, tough polysaccharide composed of N-acetylglucosamine. Phylum Arthropoda is the most speciose clade in the animal world (see the table below), and insects form the single largest class within this phylum. For comparison, refer to the approximate numbers of species in the phyla listed below.
...
Phylum Arthropoda includes animals that have been successful in colonizing terrestrial, aquatic, and aerial habitats. This phylum is further classified into five subphyla: Trilobita (trilobites, all extinct), Chelicerata (horseshoe crabs, spiders, scorpions, ticks, mites, and daddy longlegs or harvestmen), Myriapoda (millipedes, centipedes, and their relatives), Crustacea (crabs, lobsters, crayfish, isopods, barnacles, and some zooplankton), and Hexapoda (insects and their six-legged relatives). Trilobites, an extinct group of arthropods found chiefly during the Cambrian Era (about 500 million years ago), are probably most closely related to the Chelicerata. These are identified based on their fossils; they were quite diverse and radiated significantly into thousands of species before their complete extinction at the end of the Permian about 252 million years ago. *(Source note: the source says 240; the Permian ended about 252 million years ago (International Commission on Stratigraphy chart).)*

{{< mediafigure src="biology/Figure_28_04_04" kind="photo" eager="true" alt="A fossilized trilobite pressed into rock, its rounded front end and body ridged with fine, evenly spaced transverse segments running its length." >}}
A trilobite. Trilobites, like the one in this fossil, are an extinct group of arthropods. Their name "trilobite" refers to the *three longitudinal lobes* making up the body: right pleural lobe, axial lobe, and left pleural lobe (credit: Kevin Walsh).
{{< /mediafigure >}}
...
In contrast, aquatic crustaceans utilize gills, terrestrial chelicerates employ book lungs, and aquatic chelicerates use book gills. The book lungs of arachnids (scorpions, spiders, ticks, and mites) contain a vertical stack of hemocoel wall tissue that somewhat resembles the pages of a book. Between each of the "pages" of tissue is an air space. This allows both sides of the tissue to be in contact with the air at all times, greatly increasing the efficiency of gas exchange. The gills of crustaceans are filamentous structures that exchange gases with the surrounding water.

{{< mediafigure src="biology/Figure_28_04_05" kind="diagram" alt="Two panels side by side: (a) a labeled line drawing of an arachnid's internal circulatory system in side view, and (b) a photograph of a horseshoe crab held upside-down, exposing a stack of gill plates near its tail." longdesc="Panel (a) draws the internal circulatory system of an arachnid in side view. From left to right, labels point to: Cephalothorax, naming the front body region with the walking legs and eyes; Aorta, naming the vessel that arches up from the cephalothorax; Heart, naming the long tube running along the top of the arching body; Abdomen, naming the tapering rear body region the heart runs through; and Book lung, naming the feathery, comb-like structure that sits beneath the heart near the cephalothorax–abdomen junction. Panel (b) is a photograph of a horseshoe crab held upside-down; a single label, Book gills, points with two lines to a stack of thin plates visible near the base of the tail." >}}
Arthropod respiratory structures. The book lungs of (a) arachnids are made up of alternating air pockets and hemocoel tissue shaped like a stack of books (hence the name, "book lung"). The book gills of (b) chelicerates, horseshoe crabs, are similar to book lungs but are external so that gas exchange can occur with the surrounding water. (credit a: modification of work by Ryan Wilson based on original work by John Henry Comstock; credit b: modification of work by Angel Schatz)
{{< /mediafigure >}}
...
The body of chelicerates is divided into two tagmata: prosoma and opisthosoma, which are basically the equivalents of a *cephalothorax* (usually smaller) and an *abdomen* (usually larger). A distinct "head" tagma is not usually discernible. The phylum derives its name from the first pair of appendages: the **chelicerae**, which serve as specialized clawlike or fanglike mouthparts. We should note here that chelicerae are actually *modified legs*, but they are not the exact serial equivalent of mandibles, which are the modified leglike chewing mouthparts of insects and crustaceans: The chelicerae are borne on the *first segment* making up the prosoma, whereas the mandibles are embryonically on the *fourth segment* of the mandibulate head. The chelicerates have secondarily lost their antennae and hence do not have them. Some of the functions of the antennae (such as touch) are now performed by the second pair of appendages— the **pedipalps**, which may also be used for general sensing the environment as well as the manipulation of food. In some species, such as sea spiders, an additional pair of derived leg appendages, called **ovigers**, is present between the chelicerae and pedipalps. Ovigers are used for grooming and by males to carry eggs. In spiders, the chelicerae are often modified and terminate in fangs that inject venom into their prey before feeding.

{{< mediafigure src="biology/Figure_B28_07_07" kind="photo" alt="A glossy black scorpion on rock and soil, a red circle drawn around a small pair of clawlike mouthparts just beneath its head." >}}
Chelicerae (circled) are well developed in the scorpion. (credit: Kevin Walsh)
{{< /mediafigure >}}
...
{{< mediafigure src="biology/Figure_28_04_13" kind="photo" alt="A gray and tan trapdoor spider with long, hairy legs, standing on moss and gravel among small blades of grass." >}}
Spider. The trapdoor spider, like all spiders, is a member of the subphylum Chelicerata. (credit: Marshal Hedin)
{{< /mediafigure >}}
...
{{< callout type="info" >}}
**Link to Learning.** Visit [this site](https://openstax.org/l/arthropodstory) to click through a lesson on arthropods, including interactive habitat maps, and more.
{{< /callout >}}
...
Myriapods are typically found in moist soils, decaying biological material, and leaf litter. Subphylum Myriapoda is divided into four classes: Chilopoda, Symphyla, Diplopoda, and Pauropoda. Centipedes like *Scutigera coleoptrata* are classified as chilopods. These animals bear one pair of legs per segment, mandibles as mouthparts, and are somewhat dorsoventrally flattened. All centipedes are predators, and the legs in the first segment are modified to form forcipules (poison claws) that deliver poison to prey. Symphyla are similar to centipedes, but lack the poison claws and are vegetarian. Millipedes bear two pairs of legs per diplosegment—a feature that results from the embryonic fusion of adjacent pairs of body segments. These arthropods are usually rounder in cross-section than centipedes, and are herbivores or detritivores. Millipedes have two pairs of legs per segment, positioned under the body, as compared to centipedes, who have one pair per segment, positioned laterally to the body. Millipedes feed on decomposing plant material, while centipedes are predatory and eat insects that they kill with their venom. The Pauropods are similar to millipedes, but have fewer segments.

{{< mediafigure src="biology/Figure_B28_07_03_04" kind="photo" alt="Two side-by-side photos: (a) a slender, tan centipede with long, banded legs splayed along its body, and (b) a dark, glossy millipede with reddish-brown leg bands, coiled on a leaf." >}}
Myriapods. The centipede *Scutigera coleoptrata* (a) has up to 15 pairs of legs. The North American millipede *Narceus americanus* (b) bears many legs, although not a thousand, as its name might suggest. (credit a: modification of work by Bruce Marlin; credit b: modification of work by Cory Zanker)
{{< /mediafigure >}}

## Subphylum Crustacea

Crustaceans are the most dominant aquatic (both freshwater and marine) arthropods, with the total number of marine crustaceans standing at about 70,000 species. Krill, shrimp, lobsters, crabs, and crayfish are examples of crustaceans. However, there are also a number of terrestrial crustacean species as well: Terrestrial species like the wood lice (*Armadillidium* spp.), also called pill bugs, roly-polies, potato bugs, or isopods, are also crustaceans. Nonetheless, the number of terrestrial species in this subphylum is relatively low.

{{< mediafigure src="biology/Figure_B28_07_05abc" kind="photo" alt="Three photographs side by side: (a) a dark, mottled crab standing on a rock; (b) a bright red shrimp-like crustacean clinging to green rope in blue water; (c) a dark, oval pill bug walking on light-colored gravel." >}}
Crustaceans. The (a) crab and (b) shrimp krill are both aquatic crustaceans. The pill bug *Armadillidium* is a terrestrial crustacean. (credit a: modification of work by William Warby; credit b: modification of work by Jon Sullivan credit c: modification of work by Franco Folini. [https://commons.wikimedia.org/w/index.php?curid=789616](https://openstax.org/l/pillbug))
{{< /mediafigure >}}
...
{{< mediafigure src="biology/Figure_28_04_09" kind="diagram" alt="Two labeled line drawings side by side: (a) a stout, feathered, two-branched crustacean leg, and (b) a single-branched insect leg divided into segments labeled Body, Coxa, Trochanter, Femur, Tibia, and Tarsus." longdesc="Panel (a), captioned 'Biramous appendage (crayfish leg),' shows an unlabeled two-branched leg: a stout, bristled base splits into two long, feathered branches. Panel (b), captioned 'Uniramous appendage (insect leg),' shows a single-branched leg with six labels running from the body outward: Body, at the small stub where the leg attaches; Coxa, the rounded segment just beyond it; Trochanter, a smaller round segment above the coxa; Femur, the long oval segment above the trochanter; Tibia, a long, narrow segment running parallel to the femur on the leg's other side; and Tarsus, the short, jointed segments at the leg's far end." >}}
Arthropod appendages. Arthropods may have (a) biramous (two-branched) appendages or (b) uniramous (one-branched) appendages. (credit b: modification of work by Nicholas W. Beeson)
{{< /mediafigure >}}

In most crustaceans, the head and thorax is fused to form a **cephalothorax**, which is covered by a plate called the **carapace**, thus producing a body plan comprising two tagmata: **cephalothorax** and **abdomen**. Crustaceans have a chitinous exoskeleton that is shed by molting and ecdysis whenever the animal requires an increase in size or the next stage of development. The exoskeletons of many aquatic species are also infused with calcium carbonate, which makes them even stronger than those of other arthropods. Crustaceans have an open circulatory system where blood is pumped into the hemocoel by the dorsally located heart. Hemocyanin is the major respiratory pigment present in crustaceans, but hemoglobin is found in a few species and both are dissolved in the hemolymph rather than carried in cells.

{{< mediafigure src="biology/Figure_28_04_10" kind="diagram" alt="A line drawing of a crayfish in side view, its front cephalothorax region outlined in yellow and a red, branching vessel network with an oval structure running along its back." longdesc="Two labels point to the crayfish's dorsal side, left to right: Carapace, naming the yellow-shaded band that arches over the front cephalothorax region, and Heart, naming the oval red structure just behind it, from which branching red vessels extend forward into the head and backward along the length of the segmented abdomen." >}}
Crustacean anatomy. The crayfish is an example of a crustacean. It has a carapace around the cephalothorax and the heart in the dorsal thorax area. (credit: Jane Whitney)
{{< /mediafigure >}}
...
Larval stages—nauplius or zoea—are seen in the early development of aquatic crustaceans. A cypris larva is also seen in the early development of barnacles.

{{< mediafigure src="biology/Figure_28_04_11abc" kind="photo" alt="Three black-and-white micrographs side by side: (a) a teardrop-shaped larva with frilly, tentacle-like arms; (b) a smooth, clam-shaped larva; and (c) a larva with a large plated head shield and a long, tapering, segmented tail." >}}
Crustacean larvae. All crustaceans go through different larval stages. Shown are (a) the nauplius larval stage of a tadpole shrimp, (b) the cypris larval stage of a barnacle, and (c) the zoea larval stage of a green crab. (credit a: modification of work by USGS; credit b: modification of work by Mª. C. Mingorance Rodríguez; credit c: modification of work by B. Kimmel based on original work by Ernst Haeckel)
{{< /mediafigure >}}
...
The insects comprise the largest clade of arthropods in terms of species diversity as well as in terms of biomass—at least in terrestrial habitats.
...
{{< mediafigure src="biology/Figure_28_04_06" kind="diagram" alt="A labeled side-view illustration of a bee's internal anatomy, showing a segmented dorsal tube, a curving digestive tract, a nerve chain, and paired tracheal openings running the length of the head, thorax, and abdomen." longdesc="Two bracket labels along the top mark body regions: 'Abdomen' spans the rear two-thirds of the body, and 'Thorax' spans the narrower middle segment just ahead of it. To the right of the thorax bracket, three more labels point into the head: 'Head,' 'Cerebral ganglia,' and 'Antenna.' Below the top brackets, 'Ovary' points to a structure inside the front of the abdomen, and 'Hearts' and 'Dorsal blood vessel' both point to the segmented tube running along the top of the thorax and abdomen. Along the bottom of the body, nine labels run left to right, from the rear of the abdomen toward the head: 'Anus,' 'Intestine,' 'Spiracles,' 'Stomach,' 'Crop,' 'Nerve cord,' 'Trachea,' 'Pharynx,' and 'Mouth.'" >}}
Insect anatomy. In this basic anatomy of a hexapod insect, note that insects have a well-developed digestive system (yellow), a respiratory system (blue), a circulatory system (red), and a nervous system (purple). Note the multiple "hearts" and the segmental ganglia.
{{< /mediafigure >}}
...
{{< multiplechoice
  ...
  answer="ecdysozoans"
  hint="Crustacea is one of the subphyla this section places inside Arthropoda, and this section opens by placing Arthropoda inside the superphylum whose members periodically molt and undergo ecdysis."
>}}
ecdysozoans
nematodes
arachnids
...
{{< multiplechoice
  question="Flies are_______."
  answer="hexapods"
  hint="Flies have six legs and a body organized into head, thorax, and abdomen — the trait this subphylum's name describes."
>}}
chelicerates
hexapods
arachnids
...
arthropod segmentation is more specialized with major organs concentrated in body tagma
annelid segmentation is usually more uniform with the intestine extending through most segments
{{< /selfcheck >}}
...
damage to food crops; transmit disease to agricultural workers
contaminate/spoil food; destroy buildings storing food crops
{{< /selfcheck >}}
...
Parasite of vertebrate hosts
Pollinator of flowering plants
{{< /multiplechoice >}}
...
the Crustacea, mostly marine mandibulates
the Chelicerata, including the spiders and scorpions and their kin
{{< /selfcheck >}}

{{< textin
  question="The phylum of animals with jointed appendages is called ________."
  answer="Arthropoda"
  hint="This is the taxonomic phylum whose name literally means 'jointed feet.'"
>}}
...
{{< textin
  question="The crustacean larval stage seen in the early development of barnacles is called the ________ stage."
  answer="cypris"
  accept="cyprids|cypris larva|cypris larvae"
  hint="This stage's larva has a smooth, clam-like shape."
>}}

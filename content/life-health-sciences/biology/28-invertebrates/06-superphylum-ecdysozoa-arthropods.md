...
{{< mediafigure src="biology/Figure_28_04_05" kind="diagram" alt="Two panels side by side: (a) a labeled line drawing of an arachnid's internal circulatory system in side view, and (b) a photograph of a horseshoe crab held upside-down, exposing a stack of gill plates under the spiny rear section of its shell." longdesc="Panel (a) draws the internal circulatory system of an arachnid in side view. From left to right, labels point to: Cephalothorax, naming the front body region with the eyes and the cut-off stubs of the walking legs; Aorta, naming the narrow vessel at the waist that joins the heart to the branching vessels of the cephalothorax; Heart, naming the long tube running along the top of the arching body; Abdomen, naming the large, rounded rear body region the heart runs through; and Book lung, naming the feathery, comb-like structure that sits beneath the heart near the cephalothorax–abdomen junction. Panel (b) is a photograph of a horseshoe crab held upside-down; a single label, Book gills, points with two lines to a stack of thin, overlapping plates under the spiny-edged rear section of the shell; the tail itself is out of the frame." >}}
...
{{< mediafigure src="biology/Figure_28_04_09" kind="diagram" alt="Two labeled line drawings side by side: (a) a stout, feathered, two-branched crustacean leg, and (b) a single-branched insect leg divided into segments labeled Body, Coxa, Trochanter, Femur, Tibia, and Tarsus." longdesc="Panel (a), captioned 'Biramous appendage (crayfish leg),' shows an unlabeled two-branched leg: a stout, bristled base splits into two long, feathered branches. Panel (b), captioned 'Uniramous appendage (insect leg),' shows a single-branched leg with six labels running from the body outward: Body, at a curved line marking the body wall where the leg attaches; Coxa, the rounded segment just beyond it; Trochanter, a smaller round segment above the coxa; Femur, the long oval segment angling up and to the right from the trochanter; Tibia, a long, narrow segment hanging straight down from the femur's far end, so the two form an upside-down V; and Tarsus, the short, jointed segments at the bottom of the tibia, the leg's far end." >}}
...
{{< mediafigure src="biology/Figure_28_04_06" kind="diagram" alt="A labeled side-view illustration of a bee's internal anatomy, showing a segmented dorsal tube, a curving digestive tract, a nerve chain, and paired tracheal openings running the length of the head, thorax, and abdomen." longdesc="Two bracket labels along the top mark body regions: 'Abdomen' spans the rear part of the body, a little under half its length, and 'Thorax' spans the narrower middle segment just ahead of it. To the right of the thorax bracket, three more labels point into the head: 'Head,' 'Cerebral ganglia' (a purple cluster), and 'Antenna' (two lines, one to each antenna). Below the top brackets, 'Ovary' points to a green structure in the middle of the abdomen, just under the red dorsal vessel; 'Hearts' points with two lines to two swellings on the red vessel over the abdomen; and 'Dorsal blood vessel' points to the red vessel running over the thorax. Just below the red vessel, a blue tracheal tube runs the length of the body with side branches down to the openings. Along the bottom of the body, nine labels run left to right, from the rear of the abdomen toward the head: 'Anus,' 'Intestine,' 'Spiracles' (three lines to three blue openings), 'Stomach,' 'Crop,' 'Nerve cord,' 'Trachea,' 'Pharynx,' and 'Mouth.'" >}}
...
{{< multiplechoice
  ...
  answer="hexapods"
  hint="Look at the last subphylum the section covers, where a sentence lists the common insects we meet every day."
>}}
chelicerates
hexapods
arachnids

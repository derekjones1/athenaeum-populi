...
{{< textin
  ...
  answer="Nemertea"
  hint="This phylum also goes by the colloquial name proboscis worms, and includes an estimated 900 mostly marine, benthic species."
>}}
...
{{< textin
  ...
  answer="corona"
  accept="coronae"
  hint="This structure's rotating appearance under the microscope is how the whole phylum, the 'wheel-bearers,' got its common name."
>}}
...
{{< textin
  question="A nemertean's rhynchocoel extends from the head to nearly two-thirds of the length of the ________."
  answer="gut"
  accept="digestive tract"
...
{{< selfcheck question="How does hydrostatic pressure in the rhynchocoel let a nemertean extend and retract its proboscis?" hint="One muscle produces the outward push; a separate, differently attached muscle produces the pull back in." >}}
...
===CHECKS===
extended by hydrostatic pressure from contraction of muscle of the rhynchocoel
...
{{< selfcheck question="How does the tapeworm body plan support widespread dissemination of the parasite?" hint="Think about what a proglottid is, and what happens once one is mature and full of fertilized eggs." >}}
...
{{< textin
  ...
  answer="digestive"
  hint="This tapeworm lacks the organ system entirely — instead it absorbs food already broken down by its host, directly through its body wall."
>}}

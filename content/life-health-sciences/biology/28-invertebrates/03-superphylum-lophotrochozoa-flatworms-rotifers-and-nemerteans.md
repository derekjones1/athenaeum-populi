...
description: >-
  Flatworms, rotifers, and nemerteans as triploblastic, bilaterally symmetrical
  lophotrochozoan protostomes spanning the acoelomate, pseudocoelomate, and
  eucoelomate body plans, tracing flatworm parasitism, rotifer feeding
  anatomy, and the nemertean proboscis and rhynchocoel — adapted from OpenStax
  Biology 2e, Section 28.3.
source_section: "28.3"
weight: 3
---
...
The Platyhelminthes consist of two monophyletic lineages: the Catenulida and the Rhabditophora. The Catenulida, or "chain worms," is a small clade of just over 100 species. These worms typically reproduce asexually by budding. However, the offspring do not fully detach from the parents and the formation resembles a chain in appearance. All of the flatworms discussed here are part of the Rhabditophora ("rhabdite bearers"). **Rhabdites** are rodlike structures discharged in the mucus produced by some free-living flatworms; they likely serve in both defense and to provide traction for ciliary gliding along the substrate. Unlike free-living flatworms, many species of trematodes and cestodes are parasitic, including important parasites of humans.

{{< mediafigure src="biology/Figure_B28_03_01" kind="photo" eager="true" alt="Two photographed flatworms side by side: at left, a pale blue, tapering flatworm with a white-edged dark stripe down its length that turns orange near the tail, curled over coral rubble; at right, a broad, flat black flatworm evenly covered in small orange-yellow spots, resting on similar coral rubble." >}}
Flatworms exhibit significant diversity. (a) A blue Pseudoceros flatworm (*Pseudoceros bifurcus*); (b) gold speckled flatworm (*Thysanozoon nigropapillosum*). (credit a: modification of work by Stephen Childs; b: modification of work by Pril Fish.)
{{< /mediafigure >}}
...
{{< mediafigure src="biology/Figure_28_03_01" kind="diagram" alt="A labeled diagram of a flatworm's digestive, nervous, and excretory systems, with an inset zooming in on one flame cell and its tubule." longdesc="The worm-shaped body is oriented head to the left, tail to the right. At the head: two black eyespots ('Eyespot'), each set in a yellow swelling, the two swellings labeled 'Cerebral ganglia.' Two yellow longitudinal nerve cords (labeled 'Longitudinal nerve cords') run from the ganglia along both sides of the body to the tail, joined across the body by evenly spaced yellow rungs, one labeled 'Transverse nerve'; tiny orange strands at the body's margin are labeled 'Peripheral nerves.' A red digestive cavity with many short lateral branches fills the body; its broad central trunk is labeled 'Intestine,' and a narrower red tube, labeled 'Pharynx,' runs back from the middle of the body toward the tail, its free tip labeled 'Mouth and anus.' Down each side of the body, outside the nerve cords, runs a tangled gray-green mesh labeled 'Excretory canal.' A small boxed region partway down the body has an arrow pointing to an enlarged inset below: a green flame cell with a labeled nucleus and cilia narrows into a red tube cell and tubule that leads to an excretory pore at the bottom." >}}
...
{{< mediafigure src="biology/Figure_B28_03_08" kind="diagram" alt="A seven-step circular flow diagram of the tapeworm life cycle, running clockwise from eggs passed in human feces, through an intermediate cattle-or-pig host, to larvae in muscle, to a human host, and back to eggs passed in feces." longdesc="The cycle runs clockwise, starting at the bottom. Step 1, a box at bottom center: a round egg and two rectangular proglottids labeled T. saginata and T. solium, captioned that eggs and proglottids in feces are passed into the environment. A red arrow curves up and left to step 2, at left: drawings of a cow and a pig, captioned that cattle (T. saginata) and pigs (T. solium) become infected by ingesting vegetation contaminated by eggs or proglottids. A red arrow continues up to step 3, upper left: a small embryo circle, captioned that embryos penetrate the intestinal wall and circulate to musculature. A red arrow continues up and right to step 4, top center: a cross-section of muscle tissue, captioned that embryos develop into larvae in muscle. A blue arrow turns down and right to step 5, beside the head of a human silhouette, captioned that humans are infected by ingesting raw or undercooked meat, with the arrow entering the figure's mouth. Inside the figure, a green esophagus leads to the stomach and the coiled intestines. Two boxes at right are joined to the intestines by thin lines, not arrows: step 6, drawings of T. saginata and T. solium scolices, captioned that the scolex attaches to the intestine; and below it step 7, a long tapeworm whose segments grow larger along its length, with one detached segment, captioned that proglottids form. A blue arrow leads from the bottom of the human figure down and left to step 1's box, closing the loop." >}}
...
The rotifers ("wheel-bearer") belong to a group of microscopic (about 100 µm to 2 mm) mostly aquatic animals that get their name from the **corona**—a pair of ciliated feeding structures that appear to rotate when viewed under the light microscope (pictured below). Although their taxonomic status is currently in flux, one treatment places the rotifers in three classes: Bdelloidea, Monogononta, and Seisonidea. In addition, the parasitic "spiny headed worms" currently in phylum Acanthocephala, appear to be modified rotifers and will probably be placed into the group in the near future. Undoubtedly the rotifers will continue to be revised as more phylogenetic evidence becomes available.
...
{{< mediafigure src="biology/Figure_28_03_04ab" kind="photo" alt="Two micrographs of rotifers: (a) a black-and-white scanning electron micrograph showing several long, tube-shaped Bdelloidea rotifers with fringed coronas, surrounded by smaller, separate jaw structures from their mastaxes; (b) a color light micrograph of a single shorter, wider Monogononta rotifer, its smaller fringed corona and internal organs visible through its translucent body, with a 100 µm scale bar." >}}
Rotifers. Shown are examples from two of the three classes of rotifer. (a) Species from the class Bdelloidea are characterized by a large corona. The whole animals in the center of this scanning electron micrograph are shown surrounded by several sets of jaws from the mastax of rotifers. (b) *Polyarthra*, from the largest rotifer class Monogononta, has a smaller corona than bdelloid rotifers, and a single gonad, which give the class its name. (credit a: modification of work by Diego Fontaneto; credit b: modification of work by U.S. EPA; scale-bar data from Cory Zanker)
{{< /mediafigure >}}

Rotifers are commonly found in freshwater and some saltwater environments throughout the world. As filter feeders, they will eat dead material, algae, and other microscopic living organisms, and are therefore very important components of aquatic food webs. A rotifer's food is directed toward the mouth by the current created from the movement of the coronal cilia. The food particles enter the mouth and travel first to the **mastax**—a muscular pharynx with toothy jaw-like structures. Examples of the jaws of various rotifers are seen in the micrograph above. Masticated food passes near digestive and salivary glands, into the stomach, and then to the intestines. Digestive and excretory wastes are collected in a cloacal bladder before being released out the anus.

{{< callout type="info" >}}
**Link to Learning.** Watch this [video of rotifers feeding](https://openstax.org/l/rotifers).
{{< /callout >}}

About 2,200 species of rotifers have been identified. The illustration below shows the anatomy of a rotifer belonging to class Bdelloidea. Some rotifers are dioecious organisms and exhibit sexual dimorphism (males and females have different forms). In many dioecious species, males are short-lived and smaller with no digestive system and a single testis. Many rotifer species exhibit haplodiploidy, a method of sex determination in which a fertilized egg develops into a female and an unfertilized egg develops into a male. However, reproduction in the bdelloid rotifers is exclusively parthenogenetic and appears to have been so for millions of years: Thus, all bdelloid rotifers and their progeny are female! The bdelloids may compensate for this genetic insularity by borrowing genes from the DNA of other species. Up to 10% of a bdelloid genome comprises genes imported from related species. Some rotifer eggs are capable of extended dormancy for protection during harsh environmental conditions.

{{< mediafigure src="biology/Figure_B28_03_09" kind="diagram" alt="A labeled diagram of a bdelloid rotifer's internal anatomy, oriented head up: a fringed green corona and central mouth at the top, internal organs down the elongated body, and a two-toed foot at the base." longdesc="From top to bottom: 'Mouth' labels the top of a short central duct between the corona's lobes. 'Corona' labels the two green, cilia-fringed lobes at the head that flank the mouth. Below the corona, 'Cerebral ganglion' labels a small blue structure, and 'Mastax' labels a cluster of tan, jaw-like structures directly below it on the midline. 'Digestive gland' labels a pair of red-orange lobes flanking the lower part of the mastax. The body's long central column is labeled 'Stomach,' surrounded by a lighter blue layer labeled 'Pseudocoel.' Below the stomach, the column narrows and is labeled 'Intestine,' ending at an 'Anus' near the base of the trunk. At the bottom of the body, 'Foot' labels a short segmented stalk, and 'Toe' labels its two projecting tips." >}}
A bdelloid rotifer. This illustration shows the anatomy of a bdelloid rotifer.
{{< /mediafigure >}}
...
Nemerteans vary in size from 1 cm to several meters. They show bilateral symmetry and remarkable contractile properties. Because of their contractility, they can change their morphological presentation in response to environmental cues. Animals in phylum Nemertea are soft and unsegmented animals, with a morphology like a flattened tube (pictured below).

{{< mediafigure src="biology/Figure_28_03_06" kind="photo" alt="An underwater photograph of a pale pinkish, intestine-like proboscis worm coiled and overlapping itself on a muddy, dimly lit sea floor, its surface twisted in places, with a pale fish and thin strands of debris nearby." >}}
A proboscis worm. The proboscis worm (*Parborlasia corrugatus*) is a scavenger that combs the sea floor for food. The species is a member of the phylum Nemertea. The specimen shown here was photographed in the Ross Sea, Antarctica. (credit: Henry Kaiser, National Science Foundation)
{{< /mediafigure >}}

A unique characteristic of this phylum is the presence of an eversible proboscis enclosed in a pocket called a **rhynchocoel** (not part of the animal's actual coelom). The proboscis is located dorsal to the gut and serves as a harpoon or tentacle for food capture. In some species it is ornamented with barbs. The rhynchocoel is a fluid-filled cavity that extends from the head to nearly two-thirds of the length of the gut in these animals (pictured below). The proboscis may be extended by hydrostatic pressure generated by contraction of muscle of the rhynchocoel and retracted by a retractor muscle attached to the rear wall of the rhynchocoel.

{{< mediafigure src="biology/Figure_28_03_07" kind="diagram" alt="A labeled diagram of a nemertean worm's anatomy seen from above, head at left with fringed sensory papillae, a proboscis running back through the body from the front tip between the paired cerebral ganglia, and the stomach, rhynchocoel, and intestine running the length of the body to an anus at the right end." longdesc="Left to right: the worm's blunt anterior tip bears a small fringe labeled 'Sensory papillae.' Just behind it lie two small, rounded teal lobes, one on each side of the midline, one labeled 'Cerebral ganglion'; from them two teal cords run back along both sides of the body to the tail, the lower one labeled 'Lateral nerve cord.' A long orange tube labeled 'Proboscis' starts at the front tip, passes between the two ganglia, and runs back, coiling, through a pale blue channel labeled 'Rhynchocoel' along the body's midline. Around the front of that channel lies a broad purple oval labeled 'Stomach'; 'Mouth' labels an opening at the stomach's front end. Behind the stomach, the digestive tube continues as the 'Intestine,' drawn with many short side pouches, toward the tapering posterior end, ending at the 'Anus' at the worm's right-hand tip." >}}
The anatomy of a Nemertean is shown.
{{< /mediafigure >}}

{{< callout type="info" >}}
**Link to Learning.** Watch this [video of a nemertean attacking a polychaete with its proboscis](https://www.openstax.org/l/nemertean).
{{< /callout >}}
...
- **schizocoelom** — coelom formed by groups of cells that split from the mesodermal layer.
...
{{< textin
  question="Ribbon worms also bear a specialized ________ enclosed within a rhynchocoel."
  answer="proboscis"
  accept="proboscides"
  hint="Look at the Summary's paragraph on the third phylum."
>}}

{{< textin
  question="The phylum of dorsoventrally flattened protostomes commonly known by the colloquial name ribbon worms is phylum ________."
  answer="Nemertea"
  hint="Look at the opening paragraph on the last of the three phyla this section covers."
>}}

{{< textin
  question="The pair of ciliated feeding structures on a rotifer's head that appear to rotate under a light microscope is called the ________."
  answer="corona"
  accept="coronae"
  hint="Look at the opening paragraph of Phylum Rotifera."
>}}

{{< textin
  question="The muscular pharynx with toothy jaw-like structures, unique to rotifers, where food goes first after it enters the mouth, is called the ________."
  answer="mastax"
  hint="Reread Phylum Rotifera, on the path food takes after it enters the mouth."
>}}

### Identify an important extracoelomic cavity found in Nemertea

{{< textin
  question="A nemertean's rhynchocoel extends from the head to nearly two-thirds of the length of the ________ (an organ, not the whole body)."
  answer="gut"
  accept="digestive tract|intestine"
  hint="Look at the Morphology paragraph that introduces the rhynchocoel, and at the nemertean anatomy figure."
>}}

{{< multiplechoice
  question="The rhynchocoel is a ________."
  answer="fluid-filled cavity"
  hint="Look at the Morphology paragraph on the proboscis and the nemertean anatomy figure."
>}}
circulatory system
fluid-filled cavity
...
{{< selfcheck question="How does a nemertean extend the eversible organ housed in its rhynchocoel, and how does it retract it?" hint="Look at the Morphology paragraph that introduces the rhynchocoel." >}}
The proboscis is extended by hydrostatic pressure generated by contraction of muscle of the rhynchocoel, and retracted by a retractor muscle attached to the rear wall of the rhynchocoel.
===CHECKS===
extended by hydrostatic pressure generated by contraction of muscle of the rhynchocoel
retracted by a retractor muscle attached to the rear wall of the rhynchocoel
{{< /selfcheck >}}
...
{{< multiplechoice
  ...
  answer="monogeneans"
  hint="Look at the Diversity of Flatworms subsection's account of the traditional flatworm groups."
>}}
monogeneans
trematodes
cestodes
...
{{< selfcheck question="How does the tapeworm body plan support widespread dissemination of the parasite?" hint="Look at the Diversity of Flatworms paragraphs on the cestodes." >}}
...
===CHECKS===
the tapeworm body is made of small subunits called proglottids
each proglottid has a sexually mature reproductive system that can cross-fertilize within a single tapeworm
proglottids containing fertilized eggs break off and are transported to the environment to find a new host
each segment of a tapeworm's body is capable of infecting new hosts
{{< /selfcheck >}}

{{< textin
  question="Cestodes, or tapeworms, infect the ________ systems of their primary vertebrate hosts."
  answer="digestive"
  accept="intestinal|alimentary"
  hint="Look at the Summary's paragraph on flatworms."
>}}

{{< multiplechoice
  question="This traditional flatworm group has complex life cycles that involve a primary host, where sexual reproduction takes place, and a molluscan secondary host, where asexual reproduction occurs."
  answer="trematodes"
  hint="Compare the life cycle in the question with the Diversity of Flatworms subsection's account of each traditional group."
>}}
turbellarians
monogeneans
cestodes
...
<small>This section is adapted from [Biology 2e, Section 28.3: Superphylum Lophotrochozoa: Flatworms, Rotifers, and Nemerteans](https://openstax.org/books/biology-2e/pages/28-3-superphylum-lophotrochozoa-flatworms-rotifers-and-nemerteans) by Mary Ann Clark, Jung Choi, Matthew Douglas, and OpenStax, © OpenStax, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). Access the original for free at [openstax.org](https://openstax.org/details/books/biology-2e). Changes: figures re-encoded as WebP with a plain descriptive alt written from each image rather than reusing the source's own print-figure-style alt text; three figures re-kinded after inspection — Figure_28_03_01 and Figure_28_03_07 from the manifest's file-extension "photo" guess to "diagram" (both are labeled anatomical line drawings, not photographs), and Figure_B28_03_01 from "diagram" to "photo" (two actual underwater photographs of flatworms); a longdesc added to the four labeled diagrams (Figure_28_03_01, Figure_B28_03_08, Figure_B28_03_09, Figure_28_03_07) whose labels, arrows, and step numbering are not carried by their one- or two-line captions, the tapeworm life cycle's seven numbered steps confirmed running clockwise; the two Link to Learning notes rendered as callouts with their video links kept; the module's own Key Terms glossary entry for schizocoelom, printed "coelom formed by groups of cells that split from the endodermal layer," corrected to "mesodermal layer" because the section's own explanation states plainly that "the forming body cavity splits the mesoderm"; the end-of-section Review Questions and Critical Thinking Question adapted into the closing interactive Practice block (multiple choice and self-check respectively); a rubric added to each self-check, decomposing its model answer (the source solution) into check-off clauses with no new claims; three key-term recall items (corona, mastax, Nemertea) added from the glossary; one cloze recall of "gut" built from the Morphology sentence that gives the rhynchocoel's extent; three summary-sourced items added to fill out the Practice floor — a cloze recall of "proboscis" and a cloze recall of "digestive" (systems), both blanking a single content phrase of a Summary sentence (the proboscis sentence's opening "These ribbon-shaped animals" given as "Ribbon worms" so it reads on its own), and a select-the-term multiple choice built from the flatworm Summary paragraph with its three distractors drawn from the module's own flatworm class names; one locally written self-check (how a nemertean extends and retracts its proboscis), built strictly from the Morphology section's own sentence, added because the Nemertea extracoelomic-cavity objective has only one source exercise; the Review Questions are placed under the objectives they test, so the rhynchocoel question, second in the source, comes before the monogenean question.</small>

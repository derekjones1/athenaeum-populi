...
{{< mediafigure src="biology/Figure_28_03_01" kind="diagram" alt="A labeled diagram of a flatworm's digestive, nervous, and excretory systems, with an inset zooming in on one flame cell and its tubule." longdesc="The worm-shaped body is oriented head to the left, tail to the right. At the head: two black eyespots with cerebral ganglia labeled beneath them, and two longitudinal nerve cords running the length of the body from the ganglia, joined by transverse peripheral nerves at intervals (labeled 'Transverse nerve' near the front and 'Peripheral nerves' further back). A branching digestive cavity, labeled 'Pharynx' near the mouth and 'Intestine' toward the tail, extends the length of the body from a central mouth opening on the underside, labeled 'Mouth and anus,' with many lateral branches. Down each side of the body runs a mesh-like structure labeled 'Excretory canal.' A small boxed region partway down the body has an arrow pointing to an enlarged inset below: a green flame cell with a labeled nucleus and cilia narrows into a red tube cell and tubule that leads to an excretory pore at the bottom." >}}
...
{{< mediafigure src="biology/Figure_B28_03_08" kind="diagram" alt="A seven-step circular flow diagram of the tapeworm life cycle, running clockwise from eggs passed in human feces, through an intermediate cattle-or-pig host, to larvae in muscle, to a human host, and back to eggs passed in feces." longdesc="The cycle runs clockwise, starting at the bottom. Step 1, bottom center: eggs and T. saginata and T. solium proglottids are drawn passing from human feces into the environment. A red arrow curves up and left to step 2, at left: drawings of a cow and a pig, captioned that cattle (T. saginata) and pigs (T. solium) become infected by ingesting vegetation contaminated by eggs or proglottids. A red arrow continues up to step 3, upper left: a small embryo circle, captioned that embryos penetrate the intestinal wall and circulate to musculature. A red arrow continues up and right to step 4, top center: a cross-section of muscle tissue, captioned that embryos develop into larvae in muscle. A blue arrow turns down and right to step 5, beside the head of a human silhouette, captioned that humans are infected by ingesting raw or undercooked meat, with the arrow entering the figure's mouth. The cycle continues down through the human figure's outlined esophagus, stomach, and intestines to step 6, at right beside the torso: boxed drawings of T. saginata and T. solium scolices, captioned that the scolex attaches to the intestine. A blue arrow continues down to step 7, bottom right: a drawing of a segmented tapeworm body, captioned that proglottids form — closing the loop back to step 1 at bottom center." >}}
...
{{< mediafigure src="biology/Figure_28_03_07" kind="diagram" alt="A labeled diagram of a nemertean worm's anatomy in side view, head at left with fringed sensory papillae, a proboscis running through the body from near the cerebral ganglion, and the stomach, rhynchocoel, and intestine running the length of the body to an anus at the right end." longdesc="Left to right: the worm's blunt anterior end bears fringed 'Sensory papillae.' Just behind it, 'Cerebral ganglion' labels a small rounded structure, with 'Lateral nerve cord' labeling a line running below it along the body's underside. 'Mouth' labels an opening a short distance further back on the upper side. From near the cerebral ganglion, a long tube labeled 'Proboscis' runs rearward through a labeled 'Rhynchocoel' passage inside the body. Below the proboscis, 'Stomach' labels the forward part of a central digestive tube, which continues as the 'Intestine' toward the tapering posterior end, ending at the 'Anus' at the worm's right-hand tip." >}}
...
{{< multiplechoice
  ...
  hint="This pocket houses the eversible proboscis and runs from the head to nearly two-thirds of the length of the gut — pressure generated inside it by muscle contraction is what pushes the proboscis out."
>}}
circulatory system
fluid-filled cavity
...
{{< textin
  question="The pocket enclosing a nemertean's eversible proboscis, which is not part of the animal's actual coelom, is called the ________."
  answer="rhynchocoel"
  hint="Contraction of this structure's own muscle generates the hydrostatic pressure that everts the proboscis; a separate retractor muscle pulls the proboscis back in."
>}}
...
{{< multiplechoice
  ...
  answer="monogeneans"
  hint="This group has a simple life cycle: a free-swimming larva attaches to a fish and transforms into the ectoparasitic adult, usually on just one, very specific host."
>}}
monogeneans
trematodes
cestodes
...
{{< multiplechoice
  ...
  answer="trematodes"
  hint="Rule out the group that lives only on the outside of fish, the group whose secondary host is usually vertebrate muscle tissue rather than a mollusk, and the group that is not parasitic at all."
>}}
turbellarians
monogeneans
cestodes

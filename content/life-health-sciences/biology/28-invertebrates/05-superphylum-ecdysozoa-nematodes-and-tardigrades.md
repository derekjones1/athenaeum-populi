...
{{< mediafigure src="biology/Figure_28_04_01ab" kind="diagram" eager="true" alt="(a) A scanning electron micrograph shows a curved, worm-shaped nematode lying beside a smooth, capsule-shaped nematode egg on a fibrous background, with a 25 µm scale bar. (b) A schematic side view shows the nematode as a tapered tube, wide at the head and narrowing to a point at the tail, with labeled lines pointing into the body." longdesc="Panel (b) is a schematic profile of a nematode as a long tapered tube, blunt at the head end and drawn to a point at the tail. Four labels sit above the body, each with a line pointing down into it, left to right: Head ganglia, pointing to a rounded swelling just behind the mouth; Cuticle, pointing to the outer body wall a short distance further back; Dorsal nerve, pointing to a line running along the top of the tube; and Testis, pointing to a coiled structure filling much of the body toward the tail. Five labels sit below the body, each with a line pointing up into it, left to right: Mouth, at the very tip of the head; Pharynx, pointing to a bulb just behind the mouth; Intestine, pointing to the long central tube running the length of the body; Ventral nerve, pointing to a line running along the bottom of the tube; and Anus, pointing to the tail tip." >}}
...
{{< mediafigure src="biology/Figure_28_04_03" kind="diagram" alt="(a) A photo shows a thin white guinea worm emerging from a blister on a person's ankle, wound around a small stick. (b) A diagram of six numbered steps traces the guinea worm's life cycle between a human host and water-dwelling copepods." longdesc="Panel (b) follows six numbered steps joined by arrows. (1) A blue arrow shows a human drinking a glass of unfiltered water containing copepods carrying L3 larvae. (2) Inside the human figure, a green path leads to an inset showing male and female worms coiled in the intestine, where larvae released from the dying copepods have penetrated the stomach and intestinal wall, matured, and reproduced. (3) A dashed red line runs down the leg to the ankle, marking the path of a fertilized female worm that migrates to the surface of the skin and causes a blister; a blue arrow then leads from the ankle to the water below. (4) A blue arrow leads from the blistered foot into the water, where the emerging female worm — surfacing about a year after infection — releases L1 larvae into the water. (5) A red arrow rising from an inset of L1 larvae in the water points up to a copepod, which consumes the larvae. (6) A red arrow leads from an inset of a coiled larva, labeled as undergoing two molts inside the copepod to become an L3 larva, back to the drinking-water icon, closing the cycle at step 1." >}}
...
{{< multiplechoice
  ...
  answer="chitin"
  hint="This polymer, combined with collagen, forms the protective armor outside the epidermis."
>}}
glucose
skin cells
chitin
...
{{< multiplechoice
  question="According to the section, what is the biggest asset that helps researchers observe and monitor changes within a living C. elegans with ease?"
  answer="its transparency"
  hint="Researchers can see straight through this worm to every cell inside it."
>}}
its transparency
its large body size
its slow growth
its many chromosomes
{{< /multiplechoice >}}
...
{{< textin
  ...
  answer="free-living"
  hint="This is the opposite of the parasitic lifestyle that the section contrasts it with in the same sentence."
>}}
...
{{< multiplechoice
  ...
  hint="Picture the animal's overall shape and its legs, not its internal organs or its resistance to harsh conditions."
>}}

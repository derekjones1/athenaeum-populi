...
description: >-
  The molting cuticle that unites the superphylum Ecdysozoa, the nematode
  body plan and its parasitic and free-living forms — including the model
  organism *Caenorhabditis elegans* — and the tardigrades' cryptobiosis
  — adapted from OpenStax Biology 2e, Section 28.5.
source_section: "28.5"
weight: 5
---
...
In 1914, N.A. Cobb said, "In short, if all the matter in the universe except the nematodes were swept away, our world would still be dimly recognizable, and if, as disembodied spirits, we could then investigate it, we should find its mountains, hills, vales, rivers, lakes and oceans represented by a thin film of nematodes..." To paraphrase Cobb, nematodes are so abundant that if all the non-nematode matter of the biosphere were removed, there would still remain a shadow of the former world outlined by nematodes! The phylum Nematoda includes more than 28,000 species with an estimated 16,000 being parasitic in nature. However, nematologists believe there may be over one million unclassified species.
...
The cylindrical body form of the nematodes is seen below. These animals have a complete digestive system with a distinct mouth and anus, whereas only one opening is present in the digestive tract of flatworms. The mouth opens into a muscular pharynx and intestine, which leads to a rectum and anal opening at the posterior end. The epidermis can be either a single layer of cells or a **syncytium**—a multinucleated tissue that in this case is formed by the fusion of many single cells. The cuticle of nematodes is rich in collagen and a polymer called **chitin**, which forms a protective armor outside the epidermis. The cuticle extends into both ends of the digestive tract, the pharynx, and rectum. In the head, an anterior mouth opening is composed of three (or six) "lips" as well as teeth derived from the cuticle (in some species). Some nematodes may present other modifications of the cuticle such as rings, head shields, or warts. These external rings, however, do not reflect *true* internal body segmentation, which as we have seen is a hallmark of phylum Annelida. The attachment of the muscles of nematodes differs from that of most animals: they have a longitudinal layer only, and their direct attachment to the dorsal and ventral nerve cords creates a strong muscular contraction that results in a whiplike, almost spastic, body movement.

{{< mediafigure src="biology/Figure_28_04_01ab" kind="diagram" eager="true" alt="(a) A scanning electron micrograph shows a curved, worm-shaped nematode lying beside a smooth, capsule-shaped nematode egg on a fibrous background, with a 25 µm scale bar. (b) A schematic side view shows the nematode as a tapered tube, wide at the head and narrowing to a point at the tail, with labeled lines pointing into the body." longdesc="Panel (b) is a schematic profile of a nematode as a long tapered tube, blunt at the head end and drawn to a point at the tail. Four labels sit above the body, each with a line pointing down into it, left to right: Head ganglia, pointing to a blue ring that encircles the gut just behind a first green bulb at the mouth; Cuticle, pointing to the outer body wall a short distance further back; Dorsal nerve, pointing to a line running along the top of the tube; and Testis, pointing to a long, straight yellow band lying inside the intestine's purple outline. Five labels sit below the body, each with a line pointing up into it, left to right: Mouth, at the very tip of the head; Pharynx, pointing to a second green bulb just behind the blue ring; Intestine, pointing to the long purple tube that runs from the pharynx about three-quarters of the way along the body; Ventral nerve, pointing to a line running along the bottom of the tube; and Anus, pointing to the rear end of the intestine, well ahead of the tail, which continues past it as a long, slender point." >}}
...
{{< mediafigure src="biology/Figure_28_04_02ab" kind="diagram" alt="(a) A light micrograph shows a group of transparent, thread-like C. elegans roundworms scattered across an orange-tinted field, with a 200 µm scale bar. (b) A diagram shows the C. elegans life cycle arranged around a circle, with an inner shortcut through a diapausing stage, next to a note on a hexosamine-cycling insulin-signaling experiment." longdesc="Panel (b) arranges six life-cycle stages clockwise around a large circle, the Egg marked with an egg icon and each later stage with a worm icon that grows larger from L1 to Adult: Egg at the top; L1 (12 hrs) at upper right; L2 (7 hrs) at lower right; L3 (7 hrs) at the bottom; L4 (9 hrs) at lower left; and Adult at upper left. Arrowheads on the circle point clockwise from Egg to L1, from L1 down to L2, from L4 up to Adult, and from Adult back to Egg; the bottom stretch from L2 through L3 to L4 carries no arrowhead. A shorter inner arc cuts across the lower half of the circle, bowing up toward its center and bypassing L3: one arrow runs from L2 inward to a 'Dauer' stage shown between L2 and L4, and a second arrow runs from Dauer onward to L4, showing the alternate diapausing route stressed larvae take instead of continuing straight to L3. To the right of the circle, a text panel headed 'Hexosamine cycling modulates insulin signaling in C. elegans' notes that an *ogt-1* knockout makes the dauer stage insulin hypersensitive (down arrow) and an *oga-1* knockout makes it insulin resistant (up arrow)." >}}
*Caenorhabditis elegans*. (a) This light micrograph shows the bodies of a group of roundworms. These hermaphrodites consist of exactly 959 cells. (b) The life cycle of *C*. *elegans* has four juvenile stages (L1 through L4) and an adult stage. Under ideal conditions, the nematode spends a set amount of time at each juvenile stage, but under stressful conditions, it may enter a *dauer sta*te that does not age significantly and is somewhat analogous to the diapausing state of some insects. (credit a: modification of work by "snickclunk"/Flickr: credit b: modification of work by NIDDK, NIH; scale-bar data from Matt Russell)
{{< /mediafigure >}}
{{< /callout >}}

### Parasitic Nematodes

A number of common parasitic nematodes serve as prime examples of parasitism (endoparasitism). These economically and medically important animals exhibit complex life cycles that often involve multiple hosts, and they can have significant medical and veterinary impacts. Here is a partial list of nasty nematodes: Humans may become infected by *Dracunculus medinensis*, known as guinea worms, when they drink unfiltered water containing copepods (pictured below), an intermediate crustacean host. Hookworms, such as *Ancylostoma* and *Necator*, infest the intestines and feed on the blood of mammals, especially of dogs, cats, and humans. Trichina worms (*Trichinella*) are the causal organism of trichinosis in humans, often resulting from the consumption of undercooked pork; *Trichinella* can infect other mammalian hosts as well. *Ascaris*, a large intestinal roundworm, steals nutrition from its human host and may create physical blockage of the intestines. The filarial worms, such as *Dirofilaria* and *Wuchereria*, are commonly vectored by mosquitoes, which pass the infective agents among mammals through their blood-sucking activity. One species, *Wuchereria bancrofti*, infects the lymph nodes of over 120 million people worldwide, usually producing a non-lethal but deforming condition called *elephantiasis*. In this disease, parts of the body often swell to gigantic proportions due to obstruction of lymphatic drainage, inflammation of lymphatic tissues, and resulting edema. *Dirofilaria immitis*, a blood-infective parasite, is the notorious dog heartworm species.

{{< mediafigure src="biology/Figure_28_04_03" kind="diagram" alt="(a) A photo shows a thin white guinea worm emerging from a blister on a person's ankle, wound around a small stick. (b) A diagram of six numbered steps traces the guinea worm's life cycle between a human host and water-dwelling copepods." longdesc="Panel (b) follows six numbered steps joined by arrows. (1) A blue arrow shows a human drinking a glass of unfiltered water containing copepods carrying L3 larvae. (2) Inside the human figure, the digestive tract is drawn in color, and a line runs from the intestine to a boxed inset of a small male worm (♂) and a large, tangled female worm (♀), where larvae released from the dying copepods have penetrated the stomach and intestinal wall, matured, and reproduced. (3) A dashed red line runs down one leg to the ankle, marking the path of a fertilized female worm that migrates to the surface of the skin and causes a blister. (4) A single blue arrow leads from that ankle to a separate drawing of a foot standing in water, with a small blister near the ankle; a circular inset beside the foot shows L1 larvae released into the water from the emerging female worm, which surfaces about a year after infection. (5) A red arrow rises from the foot to a circular inset of small copepods in the water, captioned 'L1 larvae are consumed by a copepod'; lines join that inset to a large copepod drawn above it. (6) A circular inset of a coiled larva, joined by lines to the large copepod, is captioned as undergoing two molts in the copepod to become an L3 larva, and a red arrow leads from the copepod back to the drinking-water glass, closing the cycle at step 1." >}}
Life cycle of the guinea worm. The guinea worm *Dracunculus medinensis* infected about 3.5 million people a year in the mid-1980s, mostly in Africa, before a global eradication campaign reduced it to fewer than thirty human cases a year. *(Source note: the source says "infects about 3.5 million people annually"; that is the 1986 estimate that launched the eradication program, and the Carter Center has reported under thirty human cases a year since 2020.)* (a) Here, the worm is wrapped around a stick so it can be slowly extracted. (b) Infection occurs when people consume water contaminated by infected copepods, but this can easily be prevented by simple filtration systems. (credit: modification of work by CDC)
{{< /mediafigure >}}

## Phylum Tardigrada

The tardigrades ("slow-steppers") comprise a phylum of inconspicuous little animals living in marine, freshwater, or damp terrestrial environments throughout the world. They are commonly called "water bears" because of their plump bodies and the large claws on their stubby legs. There are over 1,000 species, most of which are less than 1 mm in length. A chitinous cuticle covers the body surface and may be divided into plates (pictured below). Tardigrades are known for their ability to enter a state called **cryptobiosis**, which provides them with resistance to multiple environmental challenges, including desiccation, very low temperatures, vacuum, high pressure, and radiation. They can suspend their metabolic activity for years, and survive the loss of up to 99% of their water content. Their remarkable resistance has recently been attributed to unique proteins that replace water in their cells and protect their internal cell structure and their DNA from damage.

{{< mediafigure src="biology/Figure_B28_05_04" kind="photo" alt="A false-color scanning electron micrograph shows a plump, segmented tardigrade with four pairs of stubby, clawed legs, its cuticle divided into overlapping plates." >}}
Scanning electronmicrograph of *Milnesium tardigradum*. (credit: Schokraie E, Warnken U, Hotz-Wagenblatt A, Grohme MA, Hengherr S, et al. (2012) - [commons.wikimedia.org](https://commons.wikimedia.org/w/index.php?curid=22716809))
{{< /mediafigure >}}
...
{{< multiplechoice
  ...
  answer="chitin"
  hint="Look at the first sentence of the Section Summary and the Morphology subsection's description of the cuticle."
>}}
glucose
skin cells
chitin
...
in addition to species that reproduce parthenogenetically
*Caenorhabditis elegans* has a self-fertilizing hermaphrodite sex and a pure male sex
{{< /selfcheck >}}
...
it is so small that large numbers can be raised in Petri dishes
it reproduces rapidly
it is transparent so every cell can be seen under the microscope
before it dies, it shows signs of aging that may provide clues to the aging process
{{< /selfcheck >}}

{{< textin
  question="The nematode C. elegans, used since 1963 as a model system by scientists worldwide, was brought into the focus of mainstream biological research by Dr. ________."
  answer="Sydney Brenner"
  accept="Brenner"
  hint="Look at the opening paragraph of the C. elegans feature."
>}}

{{< textin
  question="The phylum Nematoda includes ________ species like Caenorhabditis elegans, as well as many endoparasitic species such as Ascaris."
  answer="free-living"
  hint="Look at the first paragraph of the Phylum Nematoda subsection."
>}}
...
following a catastrophic event, tardigrades are likely to be among the few surviving species
they can function as a pioneer species that moves into a vacated habitat
once the tardigrade population has expanded, predators that use tardigrades as a food source are able to return
this pattern continues up the food web until the ecosystem is restored
{{< /selfcheck >}}
...
{{< multiplechoice
  question="According to the section, tardigrades are commonly called “water bears” because of what feature?"
  answer="their plump bodies and the large claws on their stubby legs"

...
description: >-
  The echinoderms and chordates of superphylum Deuterostomia, tracing the
  shared embryonic development that unites the two clades and the sea
  star's pentaradial body plan and water vascular system that define the
  echinoderms — adapted from OpenStax Biology 2e, Section 28.7.
source_section: "28.7"
weight: 7
---
...
There are a series of other developmental characteristics that differ between protostomes and deuterostomes, including the type of early cleavage (embryonic cell division) and the mode of formation of the coelom of the embryo: protostomes typically exhibit spiral mosaic cleavage whereas deuterostomes exhibit radial regulative cleavage. In deuterostomes, the endodermal lining of the archenteron usually forms buds called **coelomic pouches** that expand and ultimately obliterate the embryonic blastocoel (the cavity within the blastula and early gastrula) to become the **embryonic mesoderm**, the third germ layer. This happens when the mesodermal pouches become separated from the invaginating endodermal layer forming the archenteron, then expand and fuse to form the coelomic cavity. The resulting coelom is termed an **enterocoelom**. The archenteron develops into the alimentary canal, and a mouth opening is formed by invagination of ectoderm at the pole opposite the blastopore of the gastrula. The blastopore forms the anus of the alimentary system in the juvenile and adult forms. Cleavage in most deuterostomes is also *indeterminant*, meaning that the developmental fates of early embryonic cells are not decided at that point of embryonic development (this is why we could potentially clone most deuterostomes, including ourselves).

The deuterostomes consist of two major clades—the Chordata and the Ambulacraria. The Chordata include the vertebrates and two invertebrate subphyla, the urochordates and the cephalochordates. The Ambulacraria include the echinoderms and the hemichordates, which were once considered to be a chordate subphylum (see the figure below). The two clades, in addition to being deuterostomes, have some other interesting features in common. As we have seen, the vast majority of invertebrate animals do *not* possess a defined bony vertebral endoskeleton, or a bony cranium. However, one of the most ancestral groups of deuterostome invertebrates, the Echinodermata, do produce tiny skeletal "bones" called *ossicles* that make up a true **endoskeleton**, or internal skeleton, covered by an epidermis. The Hemichordata (acorn worms and pterobranchs) will not be covered here, but share with the echinoderms a three-part (tripartite) coelom, similar larval forms, and a derived metanephridium that rids the animals of nitrogenous wastes. They also share pharyngeal slits with the chordates (see the figure below). In addition, hemichordates have a dorsal nerve cord in the midline of the epidermis, but lack a neural tube, a true notochord and the endostyle and post-anal tail characteristic of chordates.

{{< mediafigure src="biology/Figure_28.48ab.png" kind="diagram" eager="true" alt="A two-part diagram. (a) A branching tree diagram: Deuterostomes splits into Ambulacraria and Chordates; Ambulacraria splits into Echinoderms and Hemichordates; Chordates splits into Cephalochordates, Urochordates, and Vertebrates. (b) Two labeled body outlines: a helical, worm-like Hemichordate with a row of blue pharyngeal slits along its upper coils, and a sac-shaped Urochordate with rows of blue pharyngeal slits across its front." longdesc="The tree in panel (a) reads left to right. Deuterostomes splits into two branches: the upper branch, Ambulacraria, splits again into Echinoderms (top) and Hemichordates (below it); the lower branch, Chordates, splits into three branches: Cephalochordates (top), Urochordates (middle), and Vertebrates (bottom). Panel (b) shows two labeled body drawings side by side: at left, a Hemichordate with a helical, worm-like body tapering to a coiled tail, its row of blue pharyngeal slits running along the upper part of the coil; at right, a Urochordate with a flattened, sac-like body, its rows of blue pharyngeal slits arranged across its front face." >}}
Ambulacraria and Chordata. (a) The major deuterostome taxa. (b) pharyngeal slits in hemichordates and urochordates. (credit a MAC; credit b modification of Gill Slits By Own work by Zebra.element [Public domain], via Wikimedia Commons)
{{< /mediafigure >}}

## Phylum Echinodermata

Echinodermata are named after their "prickly skin" (from the Greek "echinos" meaning "prickly" and "dermos" meaning "skin"). This phylum is a collection of about 7,000 described living species of exclusively marine, bottom-dwelling organisms. Sea stars (see the figure below), sea cucumbers, sea urchins, sand dollars, and brittle stars are all examples of echinoderms.
...
This phylum is divided into five extant classes: Asteroidea (sea stars), Ophiuroidea (brittle stars), Echinoidea (sea urchins and sand dollars), Crinoidea (sea lilies or feather stars), and Holothuroidea (sea cucumbers) (see the figure below).
...
{{< callout type="info" >}}
**Link to Learning.** Explore the [sea star's body plan](https://openstax.org/l/sea_star) up close, watch one move across the sea floor, and see it devour a mussel.
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_28_05_02abcde" kind="photo" alt="Five photos in a two-row grid. (a) A stout red-and-white sea star studded with short spikes, clinging to rock. (b) A brown, flat-bodied brittle star with long, thin, banded arms lying on pale rock. (c) A round, dark sea urchin covered in long, thin black spines. (d) A feathery, branching sea lily in shades of blue-green and white. (e) An elongated, spiny, mustard-yellow sea cucumber resting on a reef." >}}
...
the Echinoidea are the sea urchins and sand dollars
the Ophiuroidea are the brittle stars
the Crinoidea are the sea lilies and feather stars
the Holothuroidea are the sea cucumbers
{{< /selfcheck >}}

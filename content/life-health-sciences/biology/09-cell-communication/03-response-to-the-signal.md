...
description: >-
  How signal transduction pathways direct gene expression, cellular
  metabolism, and cell growth, the inhibitory role of PKC, and how apoptosis
  and signal termination keep a response appropriate — adapted from OpenStax
  Biology 2e, Section 9.3.
source_section: "9.3"
weight: 3
---
...
More information on cancer biology research can be found at the [National Cancer Institute website](https://openstax.org/l/cancer_research).
{{< /callout >}}
...
Apoptosis is also essential for normal embryological development. In vertebrates, for example, early stages of development include the formation of web-like tissue between individual fingers and toes (below). During the course of normal development, these unneeded cells must be eliminated, enabling fully separated fingers and toes to form. A cell signaling mechanism triggers apoptosis, which destroys the cells between the developing digits.

{{< mediafigure src="biology/Figure_09_03_02-cc77" kind="photo" alt="A purple-stained light micrograph of a mouse embryo's paw, showing five digit buds still joined by webbing of tissue between them, with a scale bar reading 500 µm." >}}
The histological section of a foot of a 15-day-old mouse embryo, visualized using light microscopy, reveals areas of tissue between the toes, which apoptosis will eliminate before the mouse reaches its full gestational age at 27 days. (credit: modification of work by Michal Mañas)
{{< /mediafigure >}}

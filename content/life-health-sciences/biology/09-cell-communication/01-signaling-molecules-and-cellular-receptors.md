...
description: >-
  The four categories of chemical signaling in multicellular organisms, the
  difference between internal and cell-surface receptors, and how a ligand's
  chemical structure determines which kind of receptor it can reach —
  adapted from OpenStax Biology 2e, Section 9.1.
source_section: "9.1"
weight: 1
---
...
{{< mediafigure src="biology/09_01_01_fix" kind="diagram" alt="A four-row table titled 'Forms of Chemical Signaling,' each row pairing a mode's name and definition with a labeled cell diagram: autocrine (a cell releases a signal that curves back to bind itself), signaling across gap junctions (a signaling cell passes molecules directly into an adjacent target cell through channel proteins), paracrine (a signaling cell releases molecules that diffuse to a nearby target cell), and endocrine (a signaling cell releases molecules that travel through the bloodstream to a distant target cell)." eager="true" >}}
...
{{< mediafigure src="biology/Figure_09_01_03" kind="diagram" alt="A cross-section diagram: a signaling molecule in the extracellular fluid crosses the plasma membrane into the cytoplasm, binds an intracellular receptor there, and the resulting complex crosses into the nucleus and binds DNA." longdesc="Layered top to bottom: 'Extracellular fluid' above a tan band labeled 'Plasma membrane'; below it, the 'Cytoplasm' contains a blue triangular shape labeled 'Intracellular receptor.' A red circle labeled 'Signaling molecule' arrives from the extracellular fluid, crosses the membrane, and an arrow shows it binding the receptor triangle. A second arrow carries the joined receptor-signaling molecule pair down through a purple region labeled 'Nucleus' to a coiled double helix labeled 'DNA.'" >}}
...
{{< mediafigure src="biology/Figure_09_01_06-c601" kind="photo" alt="A weathered 1866 broadside headed 'NOTICE. PREVENTIVES OF CHOLERA!' in large type, followed by public-health advice on eating, drinking, warmth, and hygiene, signed by the mayor and the chairman of the sanitary committee." >}}
...
{{< mediafigure src="biology/Figure_09_01_08" kind="diagram" alt="Chemical structures of estradiol, testosterone, and cholesterol, each drawn as a fused four-ring skeleton with a hydroxyl (OH) or ketone (=O) group and methyl (CH₃) branches; estradiol's first ring is aromatic, while testosterone and cholesterol share a similar fused-ring skeleton with different double-bond positions and side chains." >}}
...
opening a ligand-gated ion channel

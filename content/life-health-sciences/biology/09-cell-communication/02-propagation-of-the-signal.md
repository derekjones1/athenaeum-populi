...
description: >-
  How ligand binding at a cell-surface receptor sets off a signaling pathway
  inside the cell, the role of phosphorylation by kinases in relaying that
  signal, and the second messengers — calcium ions, cAMP, DAG, and IP₃ —
  that carry it further — adapted from OpenStax Biology 2e, Section 9.2.
source_section: "9.2"
weight: 2
---
...
Observe [an animation of cell signaling](https://openstax.org/l/cell_signals).
{{< /callout >}}

...
description: >-
  How hormones from the hypothalamus, pituitary, adrenal glands, pancreas,
  thyroid, parathyroid glands, and gonads regulate water balance, reproduction,
  metabolism, blood calcium, growth, and the stress response, and the diseases
  that follow when each system over- or under-produces its hormone — adapted
  from OpenStax Biology 2e, Section 37.3.
source_section: "37.3"
weight: 3
---
...
{{< mediafigure src="biology/Figure_37_03_01b" kind="diagram" eager="true" alt="A flow chart tracing the renin-angiotensin-aldosterone pathway from angiotensin through renin, angiotensin I and II, to the release of aldosterone and ADH, alongside a body outline showing where each hormone is produced." longdesc="A heading reads 'The renin-angiotensin-aldosterone system increases blood volume and pressure.' Below it, a left-to-right chain of boxes reads 'Angiotensin' → 'Angiotensin I' → 'Angiotensin II,' with a tan box labeled 'Renin' positioned above the gap between 'Angiotensin' and 'Angiotensin I.' An arrow from 'Angiotensin II' points right to a bulleted list headed 'Direct effects:', which lists three effects: arterial constriction that increases blood pressure, a decreased glomerular filtration rate that causes water retention, and increased thirst. Below 'Angiotensin II,' two arrows under the label 'Triggers release' point down to two boxes, 'Aldosterone' and 'ADH.' An arrow below 'Aldosterone' points to the text: 'Causes nephron distal tubules to reabsorb more Na⁺ and water, which increases blood volume.' An arrow below 'ADH' points to two bullets: 'Mediates insertion of aquaporins into nephron collecting duct cells. As a result, more water is reabsorbed into the blood,' and 'Causes arteries to constrict.' Below this chain, a body outline carries five leader lines: one to the liver, labeled 'Angiotensin is made by the liver'; one to an adrenal gland atop a kidney, labeled 'Aldosterone is produced by the adrenal glands, located on top of the kidneys'; one to a kidney, labeled 'Renin is produced by the kidney'; and two from a single label, one to a red dot in the brain and one to a smaller green dot just below it, labeled 'ADH is made in the hypothalamus and released by the posterior pituitary.'" >}}
...
{{< mediafigure src="biology/Figure_B37_03_02" kind="diagram" alt="A diagram of a woman's body tracing hormonal signaling between the brain and the ovaries and uterus, from GnRH release in the hypothalamus through FSH and LH to the ovarian hormones that feed back on the pituitary." longdesc="At the upper left, text reads 'GnRH secreted from the hypothalamus stimulates FSH and LH production in the pituitary.' At the upper right, leader lines from a brain cross-section label 'Hypothalamus' (a green dot) and, just below it, 'Pituitary' (a red dot); a small curved red arrow inside the brain runs from the hypothalamus down to the pituitary. Below the upper-left text, more text reads 'FSH and LH stimulate follicle growth in the ovaries. A surge in LH triggers ovulation.' Two overlapping red arrows form a crossing loop between the head and the pelvis: one curves down from the pituitary, its arrowhead ending at the ovary on the right of the image; the other, thin where it leaves that ovary, widens as it curves up, its arrowhead pointing up into the pituitary. At the lower body, leader lines label 'Uterus' and, beside it, 'Ovary.' To the right, text reads 'Estradiol, progesterone and inhibin are secreted from the ovaries. Estradiol and progesterone regulate female sex characteristics and the female cycle. Inhibin inhibits FSH production by the pituitary.'" >}}
Hormonal regulation of the ovarian reproductive system involves hormones from the hypothalamus, pituitary, and ovaries.
{{< /mediafigure >}}
...
Watch [an animation describing the role of insulin and the pancreas in diabetes](https://openstax.org/l/insulin).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_37_03_04" kind="diagram" alt="A body outline with seven labels, six of them on leader lines, showing where the symptoms of diabetes appear: the brain, eyes, breath, general body weight, the respiratory system, the stomach, and the urinary system." longdesc="Leader lines from a body outline point to six of seven labeled regions; the seventh, 'Systemic,' sits near the torso with no leader line. Reading top to bottom: 'Central nervous system' (a line to the head) lists lethargy, stupor, excessive thirst, and excessive hunger. 'Eyes' lists blurred vision. 'Breath' (a line to the throat) lists smell of acetone. 'Systemic' lists weight loss. 'Respiratory' (a line to the lungs) lists hyperventilation. 'Gastric' (a line to the stomach) lists nausea, vomiting, and abdominal pain. 'Urinary' (a line to the kidney on the right of the image) lists frequent urination and glucose in urine." >}}
...
### Regulation of Metabolic Rates by Thyroid Hormones
...
{{< mediafigure src="biology/Figure_B37_03_05" kind="diagram" alt="A torso and neck tracing parathyroid hormone from the neck to the kidneys, arrows from the kidneys on to bone and, as calcitriol, to the intestine, and the raised blood calcium feeding back to inhibit the parathyroid glands." longdesc="At the top, 'Parathyroid glands' labels four small circles on the thyroid in the neck. Two wide red arrows rise from a red glow over the chest, one on each side, their arrowheads pointing up at the glands, each marked with a white minus sign in a red circle; the text 'Increased calcium in blood' sits at the left beside the left red arrow. From the glands a blue band, labeled in blue 'Parathyroid hormone', runs down through the chest and splits into two wide blue arrows, one ending at each kidney, where the label 'Kidneys' sits between them. Beside the right blue arrow, two green plus-sign icons read 'Calcium reabsorption' and 'Calcitriol formation from vitamin D.' From the kidneys, wide orange arrows sweep out: two curve down to the left and back up, their arrowheads pointing up at the upper-arm bone beside the label 'Bones' and at the lower ribs, and under 'Bones' a green plus-sign icon reads 'Calcium absorption'; a third curves down and around to the right, its arrowhead pointing to the label 'Intestines' at the lower right, beside which a second green plus-sign icon also reads 'Calcium absorption.' The label 'Calcitriol' sits on the orange sweep below the kidneys." >}}
...
{{< mediafigure src="biology/Figure_B37_03_06" kind="diagram" alt="A body outline tracing how growth hormone from the pituitary gland acts on muscle, the liver, and adipocytes, and how insulin-like growth factors from the liver act on bone in turn." longdesc="At the upper left, 'Pituitary gland' labels a leader line to the small pituitary just below a brain cross-section at the top of the figure. To its right, bold green text reads 'Growth hormone (GH),' beside a broad green ribbon flowing down from the pituitary that splits into three arrows: one curves left into the shoulder, ending at a muscle illustration beside the italic label 'Muscle growth'; the middle one ends on the liver, drawn over the upper abdomen above the label 'The liver breaks down glycogen.'; the right one ends on the body just left of the label 'Adipocytes break down triglycerides.' At the upper right, green text reads 'GHRH (GH-releasing hormone) stimulates the release of GH.' and, below it, 'GHIH (GH-inhibiting hormone) inhibits the release of GH.' A separate blue arrow starts at the liver and curves left, ending at the elbow of the arm's bone illustration beside the italic label 'Bone growth'; below it, blue text reads 'Insulin-like growth factors (IGFs) stimulate amino acid uptake by target cells, promoting protein synthesis.'" >}}
...
Watch [a Discovery Channel animation describing the fight-or-flight response](https://openstax.org/l/adrenaline).
{{< /callout >}}
...
{{< multiplechoice
  ...
  answer="GnRH"
  hint="Reread the opening paragraph of the section's reproductive-system discussion, on what controls the pituitary's release of FSH and LH."
>}}
TSH
GnRH
T₃
...
prolactin levels are regulated by prolactin-releasing hormone (PRH) and prolactin-inhibiting hormone (PIH)
the posterior pituitary releases oxytocin, which stimulates uterine contractions during childbirth
contractions increase in intensity as blood levels of oxytocin rise until the birth is complete
{{< /selfcheck >}}
...
{{< textin
  ...
  hint="Look at the opening paragraph of the section's reproductive-system discussion, where FSH and LH are first introduced."
>}}
...
{{< multiplechoice
  ...
  answer="insulin"
  hint="Look at the opening paragraphs of the section's discussion of how hormones regulate blood glucose."
>}}
T₃
glucagon
insulin
...
long-term stress results in the production of glucocorticoids, such as cortisol
glucocorticoids inhibit the function of the immune system
this makes people more susceptible to infectious diseases
{{< /selfcheck >}}

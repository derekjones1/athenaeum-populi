...
{{< multiplechoice
  ...
  hint="The receptor disappears from the cell surface once it's brought inside — think about which listed process describes a reduction in receptor availability rather than a new signaling event."
>}}
cAMP activation
...
{{< textin
  question="The hormone that binds to a plasma membrane hormone receptor to trigger a signal transduction pathway is called the ________."

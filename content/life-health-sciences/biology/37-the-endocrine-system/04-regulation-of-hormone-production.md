...
description: >-
  How hormone production and release are controlled by negative feedback, and
  the three mechanisms — humoral, hormonal, and neural stimuli — that trigger
  endocrine glands to synthesize and release hormones — adapted from OpenStax
  Biology 2e, Section 37.4.
source_section: "37.4"
weight: 4
---
...
Patient B has symptoms associated with increased metabolism, and may be suffering from hyperthyroidism
{{< /selfcheck >}}
...
a stimulus causes the release of a substance whose effects then inhibit further release
the anterior pituitary signals the thyroid to release thyroid hormones
...
===CHECKS===
humoral stimuli respond to changes in extracellular fluids such as blood or ion concentration
a rise in blood glucose triggers the pancreatic release of insulin as an example of a humoral stimulus

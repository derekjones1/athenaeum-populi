...
{{< mediafigure src="biology/Figure_B23_03_01" kind="diagram" eager="true" alt="A branching cladogram titled 'Eukaryotic Supergroups,' rooted at a common eukaryotic ancestor and splitting into six colored bands — Archaeplastida, Amoebozoa, Opisthokonta, Rhizaria, Chromalveolata, and Excavata — each subdivided into its member groups." longdesc="The chart is rooted at a 'Common eukaryotic ancestor' box on the left, joined to six colored bands on the right by one solid line and five dotted lines (the dotted lines mark relationships among supergroups that remain debated). The purple Archaeplastida band branches into Red algae, Chlorophytes (green algae), and a joint split into Charophytes (green algae) and Land plants. The blue Amoebozoa band splits into Slime molds, Gymnamoebas, and Entamoebas. The green Opisthokonta band splits into a Nucleariids/Fungi branch and a Choanoflagellates/Animals branch. The red Rhizaria band splits into Cercozoans, Forams, and Radiolarians. The orange Chromalveolata band divides into an Alveolates sub-branch (Dinoflagellates, Apicomplexans, Ciliates) and a Stramenopiles sub-branch (Diatoms, Golden algae, Brown algae, Oomycetes). The yellow Excavata band splits into Diplomonads, Parabasalids, and Euglenozoans." >}}
...
{{< mediafigure src="biology/Figure_23_03_15" kind="photo" alt="Three side-by-side light micrographs of Volvox colonies: a translucent sphere studded with small dark-green daughter cells; a similar colony at higher magnification with several large green daughter cells pressing outward; and a torn, ruptured sphere releasing some green cells against a dark background while others remain attached." longdesc="Left panel (50 µm scale bar): a pale, translucent sphere about 400 µm across, its surface studded with small dark-green daughter cells. Middle panel (200 µm scale bar): a similar colony at higher magnification, four large green daughter cells pressing outward through the gelatinous matrix. Right panel (300 µm scale bar): a torn, ruptured matrix against a dark background, releasing several free round green cells while a cluster of cells remains attached to the broken sphere; a thin, thread-like filament trails from one free cell." >}}
...
{{< mediafigure src="biology/Figure_23_03_17" kind="photo" alt="A light micrograph of an amoeba with an irregular, lobed, dark orange body and long, thin, radiating pseudopodial projections extending outward against a brownish background." >}}
...
{{< mediafigure src="biology/Figure_B23_03_05ab" kind="diagram" alt="Two-panel diagram: (a) a labeled cutaway of an apicomplexan protist cell showing the apical complex at its narrow end; (b) a numbered life-cycle diagram of Plasmodium alternating between mosquito and human stages, from an infectious bite through liver and blood stages to gamete formation and back to a mosquito bite." longdesc="Panel (a) shows an elongated, teardrop-shaped apicomplexan cell labeled 'Apicomplexan protist,' its narrow apical end at upper left bracketed as the 'Apical complex,' with internal organelles drawn in cross-section. Panel (b) is a 10-step cycle alternating red arrows (mosquito stages) and blue arrows (human stages) around a central human figure: (1) a mosquito takes a blood meal and injects Plasmodium; (2) a liver cell is infected; (3) Plasmodium multiplies in the liver; (4) Plasmodium enters the blood as an immature ring stage, which matures; (5) gametes (1n) are produced by meiosis via gametocytes and a ruptured schizont, or the ring stage continues dividing by mitosis; (6) a mosquito takes another blood meal and ingests the gametes; (7) a microgamete fertilizes a macrogamete; (8) a zygote (2n) forms; (9) the zygote undergoes mitosis; (10) the parasite differentiates and enters the mosquito's saliva, ready to restart the cycle at step 1." >}}
...
{{< mediafigure src="biology/Figure_B23_03_20" kind="diagram" alt="A titled 6-step life-cycle diagram, 'Tsetse Fly Stages' and 'Human Stages,' tracing Trypanosoma brucei from an infectious bite through multiplication in human blood and lymph, another tsetse fly bite, midgut multiplication, and transformation, to reinfection of the salivary gland." longdesc="Blue arrows trace the human-stage half of the cycle (right side), red arrows the tsetse-fly-stage half (left side), around a central human figure and a small fly icon. (1) A tsetse fly takes a blood meal and injects T. brucei into the bloodstream. (2) T. brucei multiplies by binary fission in blood, lymph, and spinal fluid. (3) Another tsetse fly takes a blood meal and ingests T. brucei. (4) In the fly's midgut, T. brucei multiplies by binary fission. (5) T. brucei transforms into an infectious stage. (6) T. brucei enters the fly's salivary gland and multiplies there, ready to be injected into another human at the next bite, restarting the cycle at step 1. Each numbered stage is illustrated with a small elongated, flagellated trypanosome cell." >}}
...
{{< multiplechoice
  ...
  answer="*Caulerpa*"
  hint="This genus undergoes nuclear division without completing cytokinesis, remaining one giant single cell."
>}}
*Dictyostelium*
*Ulva*
*Plasmodium*
...
{{< multiplechoice
  ...
  hint="Rhizaria build elaborate calcium carbonate, silicon, or strontium-salt tests and move with thin, thread-like pseudopodia."
>}}
...
{{< multiplechoice
  ...
  answer="parabasalids"
  hint="This Excavata group's modified mitochondria are called hydrogenosomes because they output hydrogen gas anaerobically."
>}}
slime molds
diatoms
parabasalids
...
{{< multiplechoice
  ...
  answer="locomotion"
  hint="The diatom expels a stream of mucopolysaccharides from this slit to attach to surfaces or move."
>}}
locomotion
defense
capturing food

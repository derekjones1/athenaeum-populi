...
description: >-
  A survey of the six eukaryotic supergroups — Archaeplastida, Amoebozoa,
  Opisthokonta, Rhizaria, Chromalveolata, and Excavata — with representative
  protists, their defining features, and how each supergroup traces to
  plants, animals, or fungi — adapted from OpenStax Biology 2e, Section 23.3.
source_section: "23.3"
weight: 3
---
...
In the span of several decades, the Kingdom Protista has been disassembled because sequence analyses have revealed new genetic (and therefore evolutionary) relationships among these eukaryotes. Moreover, protists that exhibit similar morphological features may have evolved analogous structures because of similar selective pressures—rather than because of recent common ancestry. This phenomenon, called convergent evolution, is one reason why protist classification is so challenging. The emerging classification scheme groups the entire domain Eukarya into six "supergroups" that contain all of the protists as well as animals, plants, and fungi that evolved from a common ancestor: *Archaeplastida*, *Amoebozoa*, *Opisthokonta*, *Rhizaria*, *Chromalveolata*, *Excavata* (illustrated below). Each of the supergroups is believed to be monophyletic, meaning that all organisms within each supergroup are believed to have evolved from a single common ancestor, and thus all members are most closely related to each other than to organisms outside that group. There is still evidence lacking for the monophyly of some groups. Each supergroup can be viewed as representing one of many variants on eukaryotic cell structure. In each group, one or more of the defining characters of the eukaryotic cell—the nucleus, the cytoskeleton, and the endosymbiotic organelles—may have diverged from the "typical" pattern.

{{< mediafigure src="biology/Figure_B23_03_01" kind="diagram" eager="true" alt="A branching cladogram titled 'Eukaryotic Supergroups,' rooted at a common eukaryotic ancestor and splitting into six colored bands — Archaeplastida, Amoebozoa, Opisthokonta, Rhizaria, Chromalveolata, and Excavata — each subdivided into its member groups." longdesc="The chart is rooted at the label 'Common eukaryotic ancestor' on the left, whose vertical trunk joins the six colored bands on the right by one solid line and four dotted lines (the dotted lines mark relationships among supergroups that remain debated): the solid line to Archaeplastida, one dotted line shared by Amoebozoa and Opisthokonta, which then split from each other along a dotted fork, and one dotted line each to Rhizaria, Chromalveolata, and Excavata. The purple Archaeplastida band branches into Red algae and a branch that splits into Chlorophytes (green algae) and a joint split into Charophytes (green algae) and Land plants. The blue Amoebozoa band splits three ways into Slime molds, Gymnamoebas, and Entamoebas. The green Opisthokonta band splits into a Nucleariids/Fungi branch and a Choanoflagellates/Animals branch. The red Rhizaria band splits into Radiolarians and a Cercozoans/Forams branch. The orange Chromalveolata band divides, along a dotted fork, into an Alveolates sub-branch (Ciliates, and a Dinoflagellates/Apicomplexans pair) and a Stramenopiles sub-branch (Oomycetes, and a three-way split into Diatoms, Golden algae, and Brown algae). The yellow Excavata band splits into Euglenozoans and a Diplomonads/Parabasalids branch." >}}
...
Molecular evidence supports the hypothesis that all Archaeplastida are descendents of an endosymbiotic relationship between a heterotrophic protist and a cyanobacterium. The protist members of the group include the red algae and green algae. It was from a common ancestor of these protists that the land plants evolved, since their closest relatives are found in this group. The red and green algae include unicellular, multicellular, and colonial forms. A variety of algal life cycles exists, but the most complex is alternation of generations, in which both haploid and diploid stages are multicellular. A diploid sporophyte contains cells that undergo meiosis to produce haploid spores. The spores germinate and grow into a haploid gametophyte, which then makes gametes by mitosis. The gametes fuse to form a zygote that grows into a diploid sporophyte. Alternation of generations is seen in some species of Archaeplastid algae, as well as some species of Stramenopiles. In some species, the gametophyte and sporophyte look quite different, while in others they are nearly indistinguishable.

### Glaucophytes

Glaucophytes are a small group of Archaeplastida interesting because their chloroplasts retain remnants of the peptidoglycan cell wall of the ancestral cyanobacterial endosymbiont (pictured below).

{{< mediafigure src="biology/Figure_B23_03_02" kind="photo" alt="A light micrograph of a loose cluster of Glaucocystis colonies: several green, oval-shaped cells held together by the translucent, extended cell wall of a prior generation." >}}
Glaucocystis. (credit: By ja:User:NEON / commons:User:NEON_ja - Own work, CC BY-SA 2.5, [https://commons.wikimedia.org/w/index.php?curid=1706641](https://openstax.org/l/Glaucocystis))
{{< /mediafigure >}}
...
The chlorophyte *Volvox* is one of only a few examples of a colonial organism, which behaves in some ways like a collection of individual cells, but in other ways like the specialized cells of a multicellular organism (pictured below). *Volvox* colonies contain 500 to 60,000 cells, each with two flagella, contained within a hollow, spherical matrix composed of a gelatinous glycoprotein secretion. Individual cells in a *Volvox* colony move in a coordinated fashion and are interconnected by cytoplasmic bridges. Only a few of the cells reproduce to create daughter colonies, an example of basic cell specialization in this organism. Daughter colonies are produced with their flagella on the inside and have to evert as they are released.

{{< mediafigure src="biology/Figure_23_03_15" kind="photo" alt="Three side-by-side light micrographs of Volvox colonies: a translucent sphere studded with small dark-green daughter cells; a similar colony at lower magnification with several large green daughter colonies inside it; and a torn, ruptured sphere releasing some green cells against a dark background while others remain attached." longdesc="Left panel (50 µm scale bar): a pale, translucent sphere about 300 µm across by its scale bar, its surface studded with small dark-green daughter cells. Middle panel (200 µm scale bar): a similar colony at lower magnification, about 400 µm across, holding five large, round green daughter colonies, one of them faint, inside its dotted matrix. Right panel (300 µm scale bar): a torn, ruptured matrix against a dark background, releasing several free round green cells while a cluster of cells remains attached to the broken sphere; a thin, thread-like filament trails from one free cell." >}}
Volvox. *Volvox aureus* is a green alga in the supergroup Archaeplastida. This species exists as a colony, consisting of cells immersed in a gel-like matrix and intertwined with each other via hair-like cytoplasmic extensions. (credit: Dr. Ralf Wagner)
{{< /mediafigure >}}

True multicellular organisms, such as the sea lettuce, *Ulva*, are also represented among the chlorophytes. In addition, some chlorophytes exist as large, multinucleate, single cells. Species in the genus *Caulerpa* exhibit flattened fern-like foliage and can reach lengths of 3 meters (pictured below). *Caulerpa* species undergo nuclear division, but their cells do not complete cytokinesis, remaining instead as massive and elaborate single cells.

{{< mediafigure src="biology/Figure_23_03_16" kind="photo" alt="An underwater photo of dense, feathery, fern-like green Caulerpa fronds carpeting the sea bottom, growing beside taller blade-like seagrass stems." >}}
A multinucleate alga. *Caulerpa taxifolia* is a chlorophyte consisting of a single cell containing potentially thousands of nuclei. (credit: NOAA). An interesting question is how a single cell can produce such complex shapes.
{{< /mediafigure >}}

{{< callout type="info" >}}
**Link to Learning**

Watch [this video of cytoplasmic streaming in a green alga](https://openstax.org/l/chara_corallina).
{{< /callout >}}
...
The slime molds are categorized on the basis of their life cycles into plasmodial or cellular types. Plasmodial slime molds are composed of large, multinucleate cells and move along surfaces like an amorphous blob of slime during their feeding stage (pictured below). Food particles are lifted and engulfed into the slime mold as it glides along. The "dog vomit" slime mold pictured below is a particularly colorful specimen and its ability to creep about might well trigger suspicion of alien invasion. Upon maturation, the plasmodium takes on a net-like appearance with the ability to form fruiting bodies, or sporangia, during times of stress. Haploid spores are produced by meiosis within the sporangia, and spores can be disseminated through the air or water to potentially land in more favorable environments. If this occurs, the spores germinate to form ameboid or flagellate haploid cells that can combine with each other and produce a diploid zygotic slime mold to complete the life cycle.

{{< mediafigure src="biology/Figure_B23_03_18" kind="diagram" alt="A circular life-cycle diagram, 'Plasmodial Slime Mold Life Cycle,' running from haploid spores through amoeboid/flagellated cells, fertilization, a feeding plasmodium, and a mature plasmodium to spore-forming sporangia, with a photo inset of the actual bright yellow plasmodium." longdesc="The cycle runs counterclockwise from the top: down the left side, across the bottom, and up the right. Haploid (1n) spores germinate into cells that can convert between amoeboid and flagellated forms. Fertilization by fusion of either cell type produces a diploid (2n) zygote. The zygote undergoes mitosis without cytokinesis, becoming a single-celled, multinucleate feeding plasmodium (drawn as an orange, dotted mass; a curved arrow leads from it to a photo inset at lower right showing an actual plasmodium, an irregular, lumpy bright yellow mass spreading over dark leaf litter). The plasmodium matures into a net-like, veined mass. Sporangia grow up from the mature plasmodium: one, drawn cut open on a thin stalk to show the spores inside, is labeled Sporangium and Stalk; the other is a closed, egg-shaped bulb with no stalk. Meiosis inside each sporangium produces new haploid spores, completing the cycle." >}}
Plasmodial slime molds. The life cycle of the plasmodial slime mold is shown. The brightly colored plasmodium in the inset photo is a single-celled, multinucleate mass. (credit: modification of work by Dr. Jonatha Gott and the Center for RNA Molecular Biology, Case Western Reserve University)
{{< /mediafigure >}}

The cellular slime molds function as independent amoeboid cells when nutrients are abundant. When food is depleted, cellular slime molds aggregate into a mass of cells that behaves as a single unit, called a slug. Some cells in the slug contribute to a 2–3-millimeter stalk, drying up and dying in the process. Cells atop the stalk form an asexual fruiting body that contains haploid spores (pictured below). As with plasmodial slime molds, the spores are disseminated and can germinate if they land in a moist environment. One representative genus of the cellular slime molds is *Dictyostelium*, which commonly exists in the damp soil of forests.

{{< mediafigure src="biology/Figure_B23_03_07-jpg" kind="photo" alt="A close-up photo of several translucent Dictyostelium discoideum fruiting bodies: thin, thread-like stalks rising from a wet surface, each topped with a small rounded, glistening sporangium." >}}
Cellular Slime Mold. The image shows several stages in the life cycle of *Dictyostelium discoideum*, including aggregated cells, mobile slugs and their transformation into fruiting bodies with a cluster of spores supported by a stalk. (credit: By Usman Bashir (Own work) [CC BY-SA 4.0](https://openstax.org/l/CCBY), via Wikimedia Commons)
{{< /mediafigure >}}

{{< callout type="info" >}}
**Link to Learning**

Watch [this video of a cellular slime mold forming a fruiting body](https://openstax.org/l/slime_mold).
{{< /callout >}}

## Opisthokonta

The Opisthokonts are named for the single posterior flagellum seen in flagellated cells of the group. The flagella of other protists are anterior and their movement pulls the cells along, while the opisthokonts are pushed. Protist members of the opisthokonts include the animal-like choanoflagellates, which are believed to resemble the common ancestor of sponges and perhaps, all animals. Choanoflagellates include unicellular and colonial forms (pictured below), and number about 244 described species. In these organisms, the single, apical flagellum is surrounded by a contractile collar composed of microvilli. The collar is used to filter and collect bacteria for ingestion by the protist. A similar feeding mechanism is seen in the collar cells of sponges, which suggests a possible connection between choanoflagellates and animals.
...
{{< mediafigure src="biology/Figure_B23_03_08" kind="photo" alt="A phase-contrast micrograph of a colonial choanoflagellate: a central rounded structure with numerous smaller circular cells arranged around its surface, a 10 µm scale bar at upper left." >}}
A Colonial Choanoflagellate. (credit: By Dhzanette ([http://en.wikipedia.org/wiki/Choanoflagellate](https://openstax.org/l/choano)) [Public domain], via Wikimedia Commons)
{{< /mediafigure >}}
...
The Cercozoa are both morphologically and metabolically diverse, and include both naked and shelled forms. The Chlorarachniophytes (pictured below) are photosynthetic, having acquired chloroplasts by secondary endosymbiosis. The chloroplast contains a remnant of the chlorophyte endosymbiont nucleus, sandwiched between the two sets of chloroplast membranes. Vampyrellids or "vampire amoebae," as their name suggests, obtain their nutrients by thrusting a pseudopod into the interior of other cells and sucking out their contents.

{{< mediafigure src="biology/Figure_B23_03_12" kind="photo" alt="A light micrograph of a Chlorarachniophyte: several rounded green cells connected by a fine web of thread-like cytoplasmic pseudopodia." >}}
A Chlorarachniophyte. This rhizarian is mixotrophic, and can obtain nutrients both by photosynthesis and by trapping various microorganisms with its network of pseudopodia. (credit: By ja:User:NEON / commons:User:NEON_ja (Own work) [CC BY-SA 2.5](https://openstax.org/l/CCBY_25) or [CC BY-SA 2.5](https://openstax.org/l/CCBY_25), via Wikimedia Commons)
{{< /mediafigure >}}
...
Dinoflagellates exhibit extensive morphological diversity and can be photosynthetic, heterotrophic, or mixotrophic. The chloroplast of photosynthetic dinoflagellates was derived by secondary endosymbiosis of a red alga. Many dinoflagellates are encased in interlocking plates of cellulose. Two perpendicular flagella fit into the grooves between the cellulose plates, with one flagellum extending longitudinally and a second encircling the dinoflagellate (pictured below). Together, the flagella contribute to the characteristic spinning motion of dinoflagellates. These protists exist in freshwater and marine habitats, and are a component of **plankton**, the typically microscopic organisms that drift through the water and serve as a crucial food source for larger aquatic organisms.

{{< mediafigure src="biology/Figure_23_03_04" kind="diagram" alt="A line drawing of two differently shaped dinoflagellates, each encased in patterned cellulose plates with two perpendicular grooves, a flagellum lying in each groove: the left cell is walnut-shaped with a groove circling its middle and a second groove running back from the center; the right cell is horseshoe-shaped, its body extending from the wide end toward the narrow end, with the same two perpendicular grooves and flagella." >}}
...
Some dinoflagellates generate light, called **bioluminescence**, when they are jarred or stressed. Large numbers of marine dinoflagellates (billions or trillions of cells per wave) can emit light and cause an entire breaking wave to twinkle or take on a brilliant blue color (pictured below). For approximately 20 species of marine dinoflagellates, population explosions (also called blooms) during the summer months can tint the ocean with a muddy red color. This phenomenon is called a red tide, and it results from the abundant red pigments present in dinoflagellate plastids. In large quantities, these dinoflagellate species secrete an asphyxiating toxin that can kill fish, birds, and marine mammals. Red tides can be massively detrimental to commercial fisheries, and humans who consume these protists may become poisoned.

{{< mediafigure src="biology/Figure_23_03_05" kind="photo" alt="A night photo of an ocean wave glowing bright blue along its breaking edge from dinoflagellate bioluminescence, with city lights visible on the shoreline beyond." >}}
Dinoflagellate bioluminescence. Bioluminescence is emitted from dinoflagellates in a breaking wave, as seen from the New Jersey coast. (credit: "catalano82"/Flickr)
{{< /mediafigure >}}

The apicomplexan protists are named for a structure called an apical complex (pictured below), which appears to be a highly modified secondary chloroplast. The apicoplast genome is similar to those of dinoflagellate chloroplasts. The apical complex is specialized for entry and infection of host cells. Indeed, all apicomplexans are parasitic. This group includes the genus *Plasmodium*, which causes malaria in humans. Apicomplexan life cycles are complex, involving multiple hosts and stages of sexual and asexual reproduction.

{{< mediafigure src="biology/Figure_B23_03_05ab" kind="diagram" alt="Two-panel diagram: (a) a labeled cutaway of an apicomplexan protist cell showing the apical complex at its narrow end; (b) a numbered life-cycle diagram of Plasmodium alternating between mosquito and human stages, from an infectious bite through liver and blood stages to gamete formation and back to a mosquito bite." longdesc="Panel (a) shows an elongated, teardrop-shaped apicomplexan cell labeled 'Apicomplexan protist,' its narrow end at upper left labeled 'Apical end' and the structures just inside it bracketed as the 'Apical complex,' with internal organelles drawn in cross-section. Panel (b) is a 10-step cycle alternating red arrows (mosquito stages) and blue arrows (human stages) around a central human figure: (1) a mosquito takes a blood meal and injects Plasmodium; (2) a liver cell is infected; (3) Plasmodium multiplies in the liver (steps 2 and 3 are labeled 'Human liver stages'); (4) Plasmodium enters the blood, where a red blood cell becomes an immature ring stage. In this 'Human blood stages' loop, one path runs from the immature ring stage to a mature ring stage, then by mitosis to a cell packed with parasites, a ruptured schizont, and back to a fresh red blood cell; a second path runs from the immature ring stage to (5) gametes (1n) produced by meiosis, then to female and male gametocytes; (6) a mosquito takes another blood meal and ingests the gametes; (7) a microgamete fertilizes a macrogamete; (8) a zygote (2n) forms; (9) the zygote undergoes mitosis; (10) the parasite differentiates and enters the mosquito's saliva, ready to restart the cycle at step 1." >}}
Apicomplexa. (a) Apicomplexans are parasitic protists. They have a characteristic apical complex that enables them to infect host cells. (b) *Plasmodium*, the causative agent of malaria, has a complex life cycle typical of apicomplexans. (credit b: modification of work by CDC)
{{< /mediafigure >}}

The ciliates, which include *Paramecium* and *Tetrahymena*, are a group of protists 10 to 3,000 micrometers in length that are covered in rows, tufts, or spirals of tiny cilia. By beating their cilia synchronously or in waves, ciliates can coordinate directed movements and ingest food particles. Certain ciliates have fused cilia-based structures that function like paddles, funnels, or fins. Ciliates also are surrounded by a pellicle, providing protection without compromising agility. The genus *Paramecium* includes protists that have organized their cilia into a plate-like primitive mouth, called an oral groove, which is used to capture and digest bacteria (pictured below). Food captured in the oral groove enters a food vacuole, where it combines with digestive enzymes. Waste particles are expelled by an exocytic vesicle that fuses at a specific region on the cell membrane, called the anal pore. In addition to a vacuole-based digestive system, *Paramecium* also uses **contractile vacuoles**, which are osmoregulatory vesicles that fill with water as it enters the cell by osmosis and then contract to squeeze water from the cell. Ciliates therefore exhibit considerable structural complexity without having achieved multicellularity.

{{< mediafigure src="biology/Figure_23_03_06ab" kind="diagram" alt="Two-panel figure titled 'Paramecium': (left) a labeled cutaway illustration of a shoe-shaped cell showing cilia, food vacuoles, the macronucleus, micronucleus, two contractile vacuoles, a mouth pore, and an anal pore; (right) a light micrograph of an actual Paramecium of similar shape, a 25 µm scale bar shown." longdesc="The left illustration labels, from top to bottom: cilia covering the outer edge of the shoe-shaped cell; food vacuoles scattered through the cytoplasm; the large, oval macronucleus near the cell's center; two small star-shaped contractile vacuoles, one toward each end (the upper one pointer-labeled); the smaller, round micronucleus beside the macronucleus; the mouth pore, an indentation on the concave side where the cell narrows; and the anal pore, a small opening on the lower edge near the left end. The right panel is a light micrograph of a single elongated, oval Paramecium with visible internal granules, alongside a 25 µm scale bar." >}}
Paramecium. *Paramecium* has a primitive mouth (called an oral groove) to ingest food, and an anal pore to eliminate waste. Contractile vacuoles allow the organism to excrete excess water. Cilia enable the organism to move. (credit "paramecium micrograph": modification of work by NIH; scale-bar data from Matt Russell)
{{< /mediafigure >}}

{{< callout type="info" >}}
**Link to Learning**

Watch [this video of a *Paramecium*'s contractile vacuole expelling water to keep the cell osmotically balanced](https://openstax.org/l/paramecium).
{{< /callout >}}

*Paramecium* has two nuclei, a macronucleus and a micronucleus, in each cell. The micronucleus is essential for sexual reproduction, and is in many ways a typical eukaryotic nucleus, except that its genes are not transcribed. The transcribed nucleus is the macronucleus, which directs asexual binary fission and all other biological functions. The macronucleus is a multiploid nucleus constructed from the micronucleus during sexual reproduction. Periodic reconstruction of the macronucleus is necessary because the macronucleus divides amitotically, and thus becomes genetically unbalanced over a period of successive cell replications. *Paramecium* and most other ciliates reproduce sexually by conjugation. This process begins when two different mating types of *Paramecium* make physical contact and join with a cytoplasmic bridge (illustrated below). The diploid micronucleus in each cell then undergoes meiosis to produce four haploid micronuclei. Three of these degenerate in each cell, leaving one micronucleus that then undergoes mitosis, generating two haploid micronuclei. The cells each exchange one of these haploid nuclei and move away from each other. Fusion of the haploid micronuclei generates a completely novel diploid pre-micronucleus in each conjugative cell. This pre-micronucleus undergoes three rounds of mitosis to produce eight copies, and the original macronucleus disintegrates. Four of the eight pre-micronuclei become full-fledged micronuclei, whereas the other four perform multiple rounds of DNA replication. The copies of the micronuclear chromosomes are severely edited to form hundreds of smaller chromosomes that contain only the protein coding genes. Each of these smaller chromosomes gets new telomeres as the macronucleus differentiates. Two cycles of cell division then yield four new *Paramecia* from each original conjugative cell.

{{< mediafigure src="biology/Figure_B23_03_07-png" kind="diagram" alt="A titled 8-step circular diagram, 'Sexual Reproduction in Paramecium,' tracing conjugation from two mating types forming a cytoplasmic bridge through meiosis, nuclear exchange, and fusion to four daughter cells, with a micrograph inset of two conjugating cells." longdesc="The steps run clockwise from the top. (1) Two different mating types of Paramecium, each with one macronucleus and one micronucleus, join through a cytoplasmic bridge; a labeled diagram identifies the macronucleus, micronucleus, and cytoplasmic bridge, and a center inset micrograph (25 µm scale bar) shows two blue-green-stained cells lying side by side, with two purple-stained cells and a paler pink one around them. (2) In each cell, meiosis of the micronucleus produces four haploid micronuclei, of which three (gray) disintegrate. (3) The one remaining micronucleus (blue in the left cell, red in the right) divides once by mitosis, giving two micronuclei per cell. (4) The conjugate pair swaps one micronucleus each, shown as blue and red circles crossing between the cells. (5) From here a single cell is drawn: its haploid micronuclei fuse into a single diploid micronucleus. (6) That micronucleus undergoes three rounds of mitosis; the step's text says this produces eight micronuclei, though the cell is drawn with seven small blue circles beside its macronucleus. (7) The original macronucleus disintegrates, and four of the eight micronuclei become new macronuclei. (8) Two rounds of cell division follow, yielding four daughter cells from each original conjugating cell, each with one macronucleus and one micronucleus." >}}
Conjugation in Paramecium. The complex process of sexual reproduction in *Paramecium* creates eight daughter cells from two original cells. Each cell has a macronucleus and a micronucleus. During sexual reproduction, the macronucleus dissolves and is replaced by a micronucleus. (credit "micrograph": modification of work by Ian Sutton; scale-bar data from Matt Russell)
{{< /mediafigure >}}
...
The other subgroup of chromalveolates, the stramenopiles, includes photosynthetic marine algae and heterotrophic protists. The chloroplast of these algae is derived from red alga. The identifying feature of this group is the presence of a textured, or "hairy," flagellum. Many stramenopiles also have an additional flagellum that lacks hair-like projections (pictured below). Members of this subgroup range in size from single-celled diatoms to the massive and multicellular kelp.

{{< mediafigure src="biology/Figure_23_03_08" kind="diagram" alt="A labeled line drawing of an egg-shaped stramenopile cell with a purple central nucleus, one smooth 'hairless flagellum' trailing from the narrow end, and one much longer 'hairy flagellum' fringed along its length with fine bristle-like projections." >}}
Stramenopile flagella. This stramenopile cell has a single hairy flagellum and a secondary smooth flagellum.
{{< /mediafigure >}}
...
The brown algae are primarily marine, multicellular organisms that are known colloquially as seaweeds. Giant kelps are a type of brown alga. Some brown algae have evolved specialized tissues that resemble terrestrial plants, with root-like holdfasts, stem-like stipes, and leaf-like blades that are capable of photosynthesis. The stipes of giant kelps are enormous, extending in some cases for 60 meters. Like the green algae, brown algae have a variety of life cycles, including alternation of generations. In the brown algae genus *Laminaria*, haploid spores develop into multicellular gametophytes, which produce haploid gametes that combine to produce diploid organisms that then become multicellular organisms with a different structure from the haploid form (illustrated below).

{{< mediafigure src="biology/Figure_23_03_10" kind="diagram" alt="A titled life-cycle diagram, 'Laminaria Life Cycle,' running from a photo of the kelp sporophyte through meiosis, male and female gametophytes, fertilization, and a developing sporophyte back to the mature kelp, with a labeled sporangia cross-section inset." longdesc="At left, a photo shows the sporophyte (2n): a brown kelp with long, flat blade-like leaves attached to green stalks, submerged underwater, with a boxed region on one blade indicating the sporangia. A curved arrow leads from that box to an enlarged section labeled 'Sporangia': a tall, dark green sporangium packed with round spores, standing between long, club-shaped cells. Two arrows, labeled 'Meiosis,' lead from it to two haploid 'Zoospores (1n),' one of which grows into a small, branching male gametophyte and the other into a female gametophyte. The female gametophyte produces an egg; the male gametophyte produces sperm. Fertilization joins them into a diploid (2n) zygote, which by mitosis grows into a small developing sporophyte, shown with a cluster of purple cells, that matures back into the large kelp sporophyte, completing the cycle." >}}
...
Among the Excavata are the diplomonads, which include the intestinal parasite, *Giardia lamblia* (pictured below). Until recently, these protists were believed to lack mitochondria. Mitochondrial remnant organelles, called mitosomes, have since been identified in diplomonads, but although these mitosomes are essentially nonfunctional as respiratory organelles, they do function in iron and sulfur metabolism. Diplomonads exist in anaerobic environments and use alternative pathways, such as glycolysis, to generate energy. Each diplomonad cell has two similar, but not identical haploid nuclei. Diplomonads have four pairs of locomotor flagella that are fairly deeply rooted in basal bodies that lie between the two nuclei.

{{< mediafigure src="biology/Figure_23_03_02" kind="photo" alt="A scanning electron micrograph of Giardia lamblia: a flattened, teardrop-shaped cell with several whip-like flagella trailing from its midsection and a single tail flagellum extending from its narrow back end, a 2 µm scale bar at lower right." >}}
Giardia. The mammalian intestinal parasite *Giardia lamblia*, visualized here using scanning electron microscopy, is a waterborne protist that causes severe diarrhea when ingested. (credit: modification of work by Janice Carr, CDC; scale-bar data from Matt Russell)
{{< /mediafigure >}}
...
The parabasalid *Trichomonas vaginalis* causes trichomoniasis, a sexually transmitted disease in humans, which appears in an estimated 180 million cases worldwide each year. Whereas males rarely exhibit symptoms during an infection with this protist, infected females may become more susceptible to secondary infection with human immunodeficiency virus (HIV) and may be more likely to develop cervical cancer. Pregnant people infected with *T. vaginalis* are at an increased risk of serious complications, such as pre-term delivery.
...
Watch [this video about termite gut endosymbionts](https://openstax.org/l/endosymbiont).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_B23_03_20" kind="diagram" alt="A titled 6-step life-cycle diagram, 'Tsetse Fly Stages' and 'Human Stages,' tracing Trypanosoma brucei from an infectious bite through multiplication in human blood and lymph, another tsetse fly bite, midgut multiplication, and transformation, to reinfection of the salivary gland." longdesc="The cycle runs clockwise: blue arrows trace the human-stage half (right side), red arrows the tsetse-fly-stage half (left side), around a central human figure and a small fly icon. (1) A tsetse fly takes a blood meal and injects T. brucei into the bloodstream. (2) T. brucei multiplies by binary fission in blood, lymph, and spinal fluid. (3) Another tsetse fly takes a blood meal and ingests T. brucei. (4) In the fly's midgut, T. brucei multiplies by binary fission. (5) T. brucei transforms into an infectious stage. (6) T. brucei enters the fly's salivary gland and multiplies there, ready to be injected into another human at the next bite, restarting the cycle at step 1. Steps 1 and 3 are each drawn as a boxed close-up of a fly biting skin, with a smaller box holding a trypanosome beneath it, joined by lines to the human figure; elsewhere single elongated, flagellated trypanosome cells sit along the arrows, and pairs of cells dividing lengthwise mark steps 2 and 4." >}}
Sleeping sickness. *Trypanosoma brucei*, the causative agent of sleeping sickness, spends part of its life cycle in the tsetse fly and part in humans. (credit: modification of work by CDC)
{{< /mediafigure >}}

{{< callout type="info" >}}
**Link to Learning**

Watch [this video of *T*. *brucei* swimming](https://openstax.org/l/T_brucei).
{{< /callout >}}
...
{{< multiplechoice
  question="What genus of protists appears to contradict the statement that unicellularity restricts cell size?"
  answer="*Caulerpa*"
  hint="The chlorophyte paragraphs of Green Algae: Chlorophytes and Charophytes answer this."
>}}
*Dictyostelium*
*Ulva*
*Plasmodium*
...
{{< multiplechoice
  question="A marine biologist analyzing water samples notices a protist with a calcium carbonate shell that moves by pseudopodia extension. The protist is likely to be closely related to which species?"
  answer="*Ammonia tepida*"
  hint="Compare the shell materials the Rhizaria subsections and their figures give for each group and species."
>}}
...
===CHECKS===
the flagellum on the posterior end of cells
choanoflagellates use the flagellum for filter feeding
sponges use the flagellum for filter feeding
male gametes use the flagellum for locomotion
fungi spores use the flagellum for locomotion
{{< /selfcheck >}}
...
{{< multiplechoice
  question="Which protist group exhibits mitochondrial remnants with reduced functionality?"
  answer="parabasalids"
  hint="Check what the section says about the mitochondria of each of these groups."
>}}
slime molds
diatoms
parabasalids
...
{{< multiplechoice
  question="What is the function of the raphe in diatoms?"
  answer="locomotion"
  hint="The glossary entry for this structure gives its function."
>}}
locomotion
defense
capturing food
...
cannot directly obtain nutrition by searching for light
a chemotactic mechanism that senses the odors released during decay
...
mitosis of the micronucleus after meiosis instead of direct meiotic production of gametes
{{< /selfcheck >}}

...
{{< mediafigure src="biology/Figure_23_01_02" alt="Two panels. (a) A cross-section illustration of a chloroplast, drawn as a green oval bounded by an outer and an inner membrane, with several stacks of green, disk-shaped thylakoid membranes inside, linked by pale connecting membranes. (b) A light micrograph of plant cells arranged in rows, each cell containing many small, round green chloroplasts scattered through it." kind="diagram" >}}

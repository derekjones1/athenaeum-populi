...
{{< mediafigure src="biology/Figure_B23_02_02" alt="Part a shows a shoe-shaped Paramecium, which is covered with fine, hair-like cilia. Part b shows an Amoeba, which is irregular in shape with long extensions of cytoplasm jutting out from the main body. The extensions are called pseudopods. Part c shows an oval Euglena, tapering to a narrow point at one end; a long, whip-like flagellum protrudes from the opposite, rounded end." kind="diagram" >}}

...
{{< textin
  ...
  answer="osmotic needs" accept="osmotic need"
  hint="This section's opening sentence and its Summary both name the same two-word balance — of water and solutes — that hormonal signals keep the kidneys tracking."
>}}
...
{{< multiplechoice
  ...
  hint="Compare the table's 'Where produced' entry for renin with the prose that follows it — do the granular cells, the kidneys, and the nephrons name three different sites, or the same site described three ways?"
>}}
...
{{< multiplechoice
  ...
  hint="Addison's disease means a failing adrenal cortex that can no longer produce aldosterone — think about what aldosterone normally reclaims for the body, and what happens once that reclaiming stops."
>}}
retain water
retain salts
...
{{< multiplechoice
  ...
  answer="epinephrine"
  hint="This hormone, made alongside a closely related one by the adrenal medulla, is also what constricts the afferent arterioles and sets off the renin-angiotensin-aldosterone cascade during extreme stress."
>}}
epinephrine
mineralocorticoids
...
{{< textin
  ...
  accept="ACE"
  hint="The module later notes that blood pressure can be controlled by drugs that block this very enzyme — its full name literally describes the conversion it performs."
>}}
...
{{< textin
  question="The hormone that prevents the loss of water is called ________."
  answer="anti-diuretic hormone"
  accept="ADH|vasopressin|antidiuretic hormone"
  hint="This hormone is formed in the hypothalamus but stored in and released from the posterior pituitary, and it acts by inserting aquaporins into the collecting ducts."
>}}

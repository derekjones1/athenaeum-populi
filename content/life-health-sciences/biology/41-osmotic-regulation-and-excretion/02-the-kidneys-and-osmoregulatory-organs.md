...
description: >-
  How the kidneys filter blood and regulate body-fluid osmolarity — the
  structure of the kidney and the nephron, the three-step process of
  glomerular filtration, tubular reabsorption, and tubular secretion, and
  how the loop of Henle's countercurrent multiplier concentrates urine —
  adapted from OpenStax Biology 2e, Section 41.2.
source_section: "41.2"
weight: 2
---
...
Go to [an animation of the workings of nephrons and another coronal section of the kidney](https://openstax.org/l/kidney_section).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_41_03_04" kind="diagram" alt="Illustration of a single continuous nephron tube, numbered 1 through 6, running from the glomerulus through the proximal convoluted tubule, the descending and ascending limbs of the loop of Henle, the distal convoluted tubule, and into the collecting duct." longdesc="The nephron is drawn as one continuous tube, numbered 1 through 6 in the order filtrate travels it. (1) Glomerulus, a small red circle at the left, feeds into (2) Proximal convoluted tubule, a coiled segment above it. The tubule then straightens into two parallel vertical segments that share a single hairpin turn at the bottom of the figure — (3) Descending loop of Henle and (4) Ascending loop of Henle — before coiling again as (5) Distal tubule near the top. The distal tubule threads down into (6) Collecting duct, a separate straight vertical line at the right edge of the figure that continues downward off the bottom of the drawing." >}}
...
To learn more about the vascular system of kidneys, click through [this review of the steps of blood flow through the kidneys](https://openstax.org/l/kidneys).
{{< /callout >}}
...
===CHECKS===
loop diuretics decrease the excretion of salt into the renal medulla, reducing its osmolality
less water is excreted into the medulla by the descending limb
...
the second layer is the perirenal fat capsule
...
in the loop of Henle, the filtrate exchanges solutes and water with the renal medulla and the vasa recta
the vasa recta acts as the countercurrent exchanger
the kidneys maintain the osmolality of the rest of the body at a constant 300 mOsm by concentrating the filtrate as it passes through the loop of Henle
{{< /selfcheck >}}

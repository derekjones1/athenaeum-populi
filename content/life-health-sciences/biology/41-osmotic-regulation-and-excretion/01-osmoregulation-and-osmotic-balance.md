...
description: >-
  How osmosis, electrolytes, and active transport keep the body's blood
  plasma, extracellular fluid, and intracellular fluid in osmotic balance,
  the mole-based units (molarity, molality, milliequivalent, milliosmole)
  used to measure solute concentration, and how osmoregulators and
  osmoconformers adapt to different salinities — adapted from OpenStax
  Biology 2e, Section 41.1.
source_section: "41.1"
weight: 1
---

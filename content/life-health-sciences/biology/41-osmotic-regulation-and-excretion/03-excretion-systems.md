...
description: >-
  How microorganisms, flatworms, annelids, and insects excrete metabolic
  wastes and maintain osmotic balance without a kidney — contractile
  vacuoles, flame cells and nephridia, and the Malpighian tubules of insects
  — adapted from OpenStax Biology 2e, Section 41.3.
source_section: "41.3"
weight: 3
---
...
Watch [a dissected cockroach, including a close-up look at its Malpighian tubules](https://openstax.org/l/malpighian).
{{< /callout >}}
...
having organs that specialize in this process and that operate separately from other organs provides a measure of safety for the organism
{{< /selfcheck >}}

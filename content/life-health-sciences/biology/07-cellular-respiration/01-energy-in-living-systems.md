...
the molecule can be charged, stored, and used as needed
the energy from hydrolyzing ATP is delivered as a consistent amount
harvesting energy from the bonds of several different compounds would result in energy deliveries of different quantities
{{< /selfcheck >}}

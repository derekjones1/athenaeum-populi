...
description: >-
  How feedback inhibition and allosteric regulation control glucose entry,
  glycolysis, the citric acid cycle, and the electron transport chain — adapted
  from OpenStax Biology 2e, Section 7.7.
source_section: "7.7"
weight: 7
---
...
{{< mediafigure src="biology/Figure_07_07_01" alt="Two labeled cell diagrams showing insulin binding a receptor, a Glut4-carrying vesicle fusing with the plasma membrane, and glucose then entering the cell through Glut4." longdesc="Two oval cell diagrams side by side, connected by an arrow. Left: a blue insulin receptor spans the orange plasma membrane, with red insulin molecules outside binding to it. Red arrows lead from the receptor to a purple vesicle inside the cell that carries a green Glut4 transporter, and on to the membrane, showing the vesicle moving toward and fusing with it. Yellow glucose molecules sit outside the cell. A caption below reads: in the presence of insulin, Glut4 vesicles fuse with the plasma membrane. Right: the same cell after fusion, with Glut4 now embedded in a purple patch of the plasma membrane; a yellow arrow shows glucose passing through Glut4 into the cell interior, where several yellow dots have already accumulated. A caption below reads: Glut4 allows glucose to enter the cell." kind="diagram" eager="true" >}}
...
{{< callout type="info" >}}
**Link to Learning.** Visit [this animation of the electron transport chain and ATP synthesis](https://openstax.org/l/electron_transp) to see the process in motion.
{{< /callout >}}
...
it can turn it off
positive feedback accelerates the process, allowing the cell no control over it
negative feedback naturally maintains homeostasis
...
{{< multiplechoice
  ...
  answer="decrease the rate of electron transport"
  hint="The table's row for the electron transport chain pairs each nucleotide with the direction it pushes the pathway's activity."
>}}
increase the rate of electron transport
decrease the rate of electron transport
have no effect on the rate of electron transport
double the rate of electron transport
{{< /multiplechoice >}}

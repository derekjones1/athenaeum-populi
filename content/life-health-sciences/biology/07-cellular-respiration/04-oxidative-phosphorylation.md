...
description: >-
  How electrons move through the four complexes of the electron transport
  chain and lose energy along the way, and how the resulting H⁺ gradient
  drives ATP synthase to make ATP by chemiosmosis — adapted from OpenStax
  Biology 2e, Section 7.4.
source_section: "7.4"
weight: 4
---
...
The fourth complex is composed of cytochrome proteins c, a, and a₃. This complex contains two heme groups (one in each of the two cytochromes, a, and a₃) and three copper ions (a pair of Cu<sub>A</sub> and one Cu<sub>B</sub> in cytochrome a₃). The cytochromes hold an oxygen molecule very tightly between the iron and copper ions until the oxygen is completely reduced by the gain of two electrons. The reduced oxygen then picks up two hydrogen ions from the surrounding medium to make water (H₂O). The removal of the hydrogen ions from the system contributes to the ion gradient that forms the foundation for the process of chemiosmosis.

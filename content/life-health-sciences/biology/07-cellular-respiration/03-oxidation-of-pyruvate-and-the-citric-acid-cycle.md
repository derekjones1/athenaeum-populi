...
description: >-
  How pyruvate is oxidized to acetyl CoA before it enters the mitochondrial
  matrix, and how the citric acid cycle's eight steps run as a closed loop
  that releases CO₂ while reducing NAD⁺ and FAD to NADH and FADH₂ — adapted
  from OpenStax Biology 2e, Section 7.3.
source_section: "7.3"
weight: 3
---
...
View [an animation of the citric acid cycle](https://openstax.org/l/krebs_cycle).
{{< /callout >}}

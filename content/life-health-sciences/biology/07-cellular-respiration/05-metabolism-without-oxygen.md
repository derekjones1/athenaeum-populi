...
description: >-
  How organisms regenerate NAD⁺ without oxygen through anaerobic cellular
  respiration and fermentation, including the lactic acid and alcohol
  fermentation pathways — adapted from OpenStax Biology 2e, Section 7.5.
source_section: "7.5"
weight: 5
---
...
{{< callout type="info" >}}
**Link to Learning.** See fermentation in action at [this interactive fermentation site](https://openstax.org/l/fermentation).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_07_05_01" kind="photo" alt="A satellite photo of a coastline where a green bloom of sulfate-reducing bacteria colors the dark ocean water near the shore, contrasting with the tan desert land along the coast." eager="true" >}}
...
lactate levels rise after exercise, making the symptoms worse
milk sickness is rare today but was common in the midwestern United States in the early 1800s
{{< /selfcheck >}}

...
description: >-
  How the catabolism of other sugars, amino acids, cholesterol, and
  triglycerides all connect into glycolysis and the citric acid cycle, and
  why metabolic pathways are porous rather than closed systems — adapted
  from OpenStax Biology 2e, Section 7.6.
source_section: "7.6"
weight: 6
---
...
{{< mediafigure src="biology/Figure_07_06_01" alt="A citric acid cycle diagram (glucose through oxaloacetate) surrounded by pale-green boxes of amino acids, each linked by arrows to the cycle intermediate its carbon skeleton feeds into — pyruvate, acetyl CoA (via acetoacetate), glutamate (feeding alpha-ketoglutarate), succinyl CoA, fumarate, or oxaloacetate — showing how amino acids from protein catabolism enter glucose catabolism." longdesc="Two-way links below are drawn as pairs of red arrows pointing in opposite directions. The pink boxes: glucose and phosphoenolpyruvate are linked two-way; oxaloacetate flows one-way up into phosphoenolpyruvate; phosphoenolpyruvate flows one-way into pyruvate, which flows one-way into acetyl CoA and, by a separate line, one-way into oxaloacetate; acetyl CoA enters the ring at citrate, and the ring runs one-way through isocitrate, alpha-ketoglutarate, succinyl CoA, succinate, fumarate, and malate back to oxaloacetate. Eight pale-green boxes (seven amino-acid groups and glutamate) surround the ring, each linked two-way: alanine, glycine, threonine, cysteine, serine, and tryptophan to pyruvate; isoleucine, boxed alone, to acetyl CoA; leucine, lysine, phenylalanine, tyrosine, and tryptophan to acetoacetate, which is itself linked two-way to acetyl CoA; arginine, proline, histidine, and glutamine to glutamate, which is linked to alpha-ketoglutarate; isoleucine, valine, methionine, and threonine to succinyl CoA; tyrosine and phenylalanine to fumarate; and asparagine and aspartate to oxaloacetate." kind="diagram" eager="true" >}}
...
{{< mediafigure src="biology/Figure_07_06_02" alt="A flow chart of four connected process boxes — glycolysis, pyruvate oxidation, the citric acid cycle, and oxidative phosphorylation — each of the first three fed by an arrow from a labeled input box above naming the fuels (carbohydrates, amino acids, glycerol, fatty acids) that enter at that step." longdesc="Three colored input boxes sit above a row of four connected process boxes, in reading order left to right. The first input box, labeled carbohydrates, some amino acids, and glycerol, has an arrow down into the first process box, glycolysis. The second input box, labeled some amino acids, has an arrow down into the second process box, pyruvate oxidation. The third input box, labeled fatty acids and some amino acids, has an arrow down into the third process box, citric acid cycle. Arrows connect glycolysis to pyruvate oxidation, pyruvate oxidation to the citric acid cycle, and the citric acid cycle to the fourth process box, oxidative phosphorylation, which has no input box of its own above it." kind="diagram" >}}
...
{{< multiplechoice
  ...
  hint="Reread the first paragraph under Connections of Other Sugars to Glucose Metabolism."
>}}
glucose-6-phosphate
...
{{< multiplechoice
  question="Beta-oxidation is ________."
  answer="the breakdown of fatty acids"
  hint="Reread the second paragraph under Connections of Lipid and Glucose Metabolisms."
>}}
...
{{< multiplechoice
  question="Before an amino acid can enter the pathways of glucose catabolism, it must first ________."
  answer="have its amino group removed and converted into ammonia"
  hint="Reread the paragraph under Connections of Proteins to Glucose Metabolism."
>}}
have its amino group removed and converted into ammonia
be phosphorylated to glycerol-3-phosphate
be assembled into a new polypeptide
...
{{< multiplechoice
  question="According to this section, why are metabolic pathways not considered closed systems?"
  answer="Many of the substrates, intermediates, and products in one pathway are reactants in other pathways"
  hint="Reread the section's opening paragraph."
>}}
Many of the substrates, intermediates, and products in one pathway are reactants in other pathways
Each pathway runs independently and never exchanges any material with another pathway
Every pathway produces only ATP and no other usable product
Pathways only connect to each other during starvation
{{< /multiplechoice >}}

{{< selfcheck question="Would you describe metabolic pathways as inherently wasteful or inherently economical? Why?" hint="Reread the section's opening paragraph." >}}

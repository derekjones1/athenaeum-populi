...
description: >-
  How humans depend on biodiversity for medicines, food security, and
  ecosystem services such as pollination and pest control, and why species
  loss threatens each of these — adapted from OpenStax Biology 2e, Section
  47.2.
source_section: "47.2"
weight: 2
---
...
the seeds will keep even if the electricity fails
{{< /selfcheck >}}
...
===CHECKS===
soil organisms maintain nutrient cycles and soil texture
they provide benefits to human food production
they provide benefits to drinking water availability and breathable air
{{< /selfcheck >}}

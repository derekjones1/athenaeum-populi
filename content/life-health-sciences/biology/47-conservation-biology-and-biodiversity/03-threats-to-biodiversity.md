...
description: >-
  The four proximate threats reducing global biodiversity — habitat loss,
  overharvesting, the introduction of exotic species, and anthropogenic
  climate change — and the mechanisms by which each is driving species
  toward extinction — adapted from OpenStax Biology 2e, Section 47.3.
source_section: "47.3"
weight: 3
---
...
{{< callout type="info" >}}
**Everyday Connection.** *Preventing Habitat Destruction with Wise Wood Choices*
...
{{< mediafigure src="biology/Figure_B47_03_06" kind="diagram" alt="A map of North America shaded with three overlapping regions: a dark brown area for historic grizzly bear range, a lighter tan area for the present range of grizzly bears, and a red diagonally hatched area for polar bear range." longdesc="The map's legend lists three regions: historic grizzly bear range (dark brown), present-day grizzly bear range (tan), and polar bear range (red diagonal hatching). The dark-brown historic range covers the western United States, from the Mexican border north through the Rocky Mountain states into the mid-latitudes of Canada. The tan present-day range encloses that entire historic area and extends much farther north, covering all of Alaska and most of Canada up to the Arctic coastline and islands. The red-hatched polar bear range covers the Canadian Arctic islands and the northern coastline of Alaska and Canada, overlapping the northern edge of the tan present-day grizzly range along that coastline." >}}
...
unsustainable resource use causes habitat destruction to build new settlements and agricultural fields
larger human populations have led to unsustainable fishing and hunting of wild animal populations
...
{"bins": ["Habitat Loss", "Overharvesting", "Exotic Species", "Climate Change"],
 "items": [
  ...
  {"label": "The accidental introduction of the brown tree snake led to the extinction of three kinds of birds on Guam", "bin": 2},
  {"label": "Some European bird populations have shifted their ranges about 91 km northward", "bin": 3}
 ]}
{{< /sortbins >}}
...
{{< textin
  question="The generic term for a wild-caught animal used as food, typically referring to hunting in the tropics of sub-Saharan Africa, Asia, and the Americas, is ________."
  answer="bush meat"
  accept="bushmeat"
  hint="This section says the practice was traditionally used to feed families directly, before commercialization made it available in grocery stores."
>}}

{{< textin
  question="The economic principle that resources held in common will inevitably be overexploited is called the ________."
  answer="tragedy of the commons"
  hint="This section applies the idea to a fishery nobody personally owns, where no individual fisher has a reason to hold back."
>}}

{{< textin
  question="The disease of amphibians caused by the fungus *Batrachochytrium dendrobatidis*, thought to be a major cause of the global amphibian decline, is called ________."
  answer="chytridiomycosis"
  hint="This section names the African clawed toad as a possible carrier that spread this fungal disease worldwide."
>}}

{{< textin
  question="The disease of cave-hibernating bats in the eastern United States and Canada associated with the fungus *Geomyces destructans* is called ________."
  answer="white-nose syndrome"
  hint="This section traces its spread from a point of origin in western New York State, carried unintentionally by cavers."
>}}
...
it is at risk from exotic species, either as a new predator or through diseases such as chytridiomycosis
it is also possible that habitat destruction will threaten the species
{{< /selfcheck >}}

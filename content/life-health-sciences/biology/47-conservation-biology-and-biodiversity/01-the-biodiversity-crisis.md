...
{{< mediafigure src="biology/Figure_47_01_06" kind="diagram" alt="A graph plots the number of species present versus area in meters squared. The number of species present increases as a power function, such that the slope of the curve increases sharply at first, then more gradually as area increases." longdesc="The y-axis, \"Number of species,\" runs from 0 to 35 in increments of 5; the x-axis, \"Habitat area (m²),\" runs from 0 to 70 in increments of 10. Eight plotted data points rise steeply at first, from about 9 species at the smallest habitat area to about 17 species by 4 m², then more gradually to about 28 species at the largest plotted area, roughly 64 m², with a smooth curve fit through the points." >}}
...
{{< multiplechoice
  ...
  hint="Both examples this section opens with, the Galápagos finches and the Lake Victoria cichlids, are famous not for anything to do with radioactivity, but for how many new species branched off from a common ancestor in a short span of time."
>}}

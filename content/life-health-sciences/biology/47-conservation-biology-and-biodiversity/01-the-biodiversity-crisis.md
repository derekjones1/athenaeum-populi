...
description: >-
  Biodiversity's several measures — species, genetic, chemical, and ecosystem
  diversity — the geography of species richness and biodiversity hotspots,
  and the five mass extinctions and today's accelerating extinction rate —
  adapted from OpenStax Biology 2e, Section 47.1.
source_section: "47.1"
weight: 1
---
...
{{< mediafigure src="biology/Figure_47_01_01abf" kind="photo" eager="true" alt="Photo a shows a coral reef. Some of the coral is lobe-shaped, with bumpy pink protrusions, and the other coral has long, slender beige branches. Fish swim among the coral. Photo b shows a rolling prairie, with nothing but tall brown grass as far as the eye can see." >}}
...
| Taxonomic Group | Mora et al. 2011 Described | Mora et al. 2011 Predicted | Chapman 2009 Described | Chapman 2009 Predicted | Groombridge & Jenkins 2002 Described | Groombridge & Jenkins 2002 Predicted |
| --- | --- | --- | --- | --- | --- | --- |
...
Sources: Mora Camilo et al., "How Many Species Are There on Earth and in the Ocean?" *PLoS Biology* (2011), doi:10.1371/journal.pbio.1001127; Arthur D. Chapman, *Numbers of Living Species in Australia and the World*, 2nd ed. (Canberra, AU: Australian Biological Resources Study, 2009), [https://www.environment.gov.au/system/files/pages/2ee3f4a1-f130-465b-9c7a-79373680a067/files/nlsaw-2nd-complete.pdf](https://openstax.org/l/Aus_diversity); Brian Groombridge and Martin D. Jenkins, *World Atlas of Biodiversity: Earth's Living Resources in the 21st Century* (Berkeley: University of California Press, 2002).
...
{{< mediafigure src="biology/Figure_47_01_02" kind="diagram" alt="A world map shows the number of amphibian species by area. The greatest number of species, 61-144, occur in a narrow band on the northern coast of South America and a patch of west-central Africa; the Amazon basin and much of central Africa have 41-60. Between 21 and 60 species are found in other parts of South America and Africa, and in the eastern United States and Southeast Asia. Other parts of the world have between 1 and 20 amphibian species, with the fewest species occurring at northern and southern latitudes. Generally, more amphibian species are found in warmer, wetter climates." longdesc="The legend, titled \"Number of species,\" lists ten classes in two rows of five swatches each. Top row, left to right: purple for 1 species, blue for 2–3, teal for 4–6, green for 7–10, and olive green for 11–15. Bottom row, left to right: pale green for 16–20, tan for 21–30, light orange for 31–40, orange for 41–60, and red for 61–144. On the map, orange (41–60 species) covers the Amazon basin of South America and parts of central and southeastern Africa, while red (61–144) appears only in a narrow band on the northern coast of South America and a patch of west-central Africa near Cameroon; the purples, blues, and teal (1–6 species) cover the northern edges of North America and Eurasia, much of central Asia, the margins of the Sahara and Arabia, interior Australia, and the southern tip of South America; white patches, which the legend does not key, cover Greenland and the driest deserts." >}}
...
{{< mediafigure src="biology/Figure_B47_01_04-extinctions" kind="diagram" alt="A line graph plots percent extinction occurrences of marine genera against millions of years before the present, running from about 540 million years ago on the left to 0 (the present) on the right. The jagged line has five labeled peaks marking the five mass extinctions, the tallest by far at the end-Permian boundary." longdesc="The y-axis, \"Extinction occurrences (% marine genera),\" runs from 0 to just above 50 in increments of 10; the x-axis, \"Millions of years before present time,\" runs from about 540 down to 0 (labeled every 50 from 500), reading left to right toward the present. A jagged gray line traces extinction intensity across that span, with five purple dots marking the five mass extinctions, each labeled above its dot: end-Ordovician at about 450 million years ago and 30 percent; end-Devonian at about 375 million years ago and roughly 22 percent; end-Permian at about 250 million years ago and just over 50 percent, the tallest point on the graph; end-Triassic at about 200 million years ago and roughly 29 percent; and end-Cretaceous at about 66 million years ago and just over 30 percent. The plot area is shaded in background colors that change at four of those boundaries: tan from about 540 to 445 million years ago, salmon from 445 to 375, lavender from 375 to 200, and pale blue from 200 to 66, the transitions landing at the end-Ordovician, end-Devonian, end-Triassic, and end-Cretaceous dots; a fifth, cream-colored band covers 66 million years ago to the present. The end-Permian dot falls inside the lavender band rather than at a color change." >}}
...
{{< callout type="info" >}}
**Link to Learning.** Explore [this interactive website](https://openstax.org/l/extinctions) about mass extinctions.
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_47_01_06" kind="diagram" alt="A graph plots the number of species present versus area in meters squared. The number of species present increases as a power function, such that the slope of the curve increases sharply at first, then more gradually as area increases." longdesc="The y-axis, \"Number of species,\" runs from 0 to 35 in increments of 5; the x-axis, \"Habitat area (m²),\" runs from 0 to 70 in increments of 10. Nine plotted data points, the first three bunched against the y-axis, rise steeply at first, from about 9 species at the smallest habitat area through about 14 at 2 m² to about 17 species by 4 m², then more gradually (about 19 at 8 m², 22 at 16 m², and 25 at 32 m²) to about 28 species at the largest plotted area, roughly 64 m², with a smooth curve fit through the points." >}}
...
{{< multiplechoice
  ...
  answer="a burst of speciation"
  hint="Reread the section's opening paragraph on the Lake Victoria cichlids, where the term is defined."
>}}
...
the second method is a calculation based on the amount of habitat destruction and species-area curves
{{< /selfcheck >}}
...
a spike in iridium in the geological layers that mark the K–Pg transition
an impact crater off the Yucatán Peninsula that is the right size and age to have caused the extinction event
{{< /selfcheck >}}

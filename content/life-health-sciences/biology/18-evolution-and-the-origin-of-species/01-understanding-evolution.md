...
description: >-
  How Darwin and Wallace independently discovered natural selection, what
  adaptation, convergent evolution, and divergent evolution mean, and the
  fossil, anatomical, and molecular evidence for evolution — adapted from
  OpenStax Biology 2e, Section 18.1.
source_section: "18.1"
weight: 1
---
...
In 1858, Darwin and Wallace (see the portraits below) presented papers at the Linnean Society in London that discussed the idea of natural selection. The following year Darwin's book, *On the Origin of Species*, was published. His book outlined in considerable detail his arguments for evolution by natural selection.

{{< mediafigure src="biology/Figure_18_01_02ab" kind="photo" alt="Two portraits side by side: (a) an older Charles Darwin, balding with combed-back white hair and long side-whiskers, seated in a dark coat over a light checked waistcoat and cravat; (b) an engraved portrait of a bearded, bespectacled Alfred Russel Wallace in a dark coat." >}}
Both (a) Charles Darwin and (b) Alfred Wallace wrote scientific papers on natural selection that they presented together at the Linnean Society in 1858.
{{< /mediafigure >}}

Studies of evolution by natural selection are difficult to conduct, as they require analyses of several generations of the investigated species in order to document the changes pointing to evolutionary change. The Galápagos finches are an excellent example. Peter and Rosemary Grant and their colleagues have studied Galápagos finch populations every year since 1973 *(Source note: the source says 1976; the Grants' Daphne Major study began in 1973 (Grant and Grant, *Science* 296:707).)* and have provided important evidence of natural selection. The Grants found changes from one generation to the next in beak shape distribution with the medium ground finch on the Galápagos island of Daphne Major. The birds have inherited a variation in their bill shape with some having wide deep bills and others having thinner bills. During a period in which rainfall was higher than normal because of an El Niño, there was a lack of large hard seeds of which the large-billed birds ate; however, there was an abundance of the small soft seeds which the small-billed birds ate. Therefore, the small-billed birds were able to survive and reproduce. In the years following this El Niño, the Grants measured beak sizes in the population and found that the average bill size was smaller. Since bill size is an inherited trait, parents with smaller bills had more offspring and the bill evolved into a much smaller size. As conditions improved in 1987 and larger seeds became more available, the trend toward smaller average bill size ceased.

{{< callout type="info" >}}
**Career Connection.** *Field Biologist.* Many people hike, explore caves, scuba dive, or climb mountains for recreation. People often participate in these activities hoping to see wildlife. Experiencing the outdoors can be incredibly enjoyable and invigorating. What if your job entailed working in the wilderness? Field biologists by definition work outdoors in the "field." The term field in this case refers to any location outdoors, even under water. A field biologist typically focuses research on a certain species, group of organisms, or a single habitat (see the photo below).

{{< mediafigure src="biology/Figure_18_01_03-0b39" kind="photo" alt="A field biologist crouches on packed snow beside a large white bear lying on its side, writing notes on a clipboard, with a flag pole and equipment cases in the background." >}}
...
The evolution of species has resulted in enormous variation in form and function. Sometimes, evolution gives rise to groups of organisms that become tremendously different from each other. We call two species that evolve in diverse directions from a common point **divergent evolution**. We can see such divergent evolution in the forms of the reproductive organs of flowering plants which share the same basic anatomies; however, they can look very different as a result of selection in different physical environments and adaptation to different kinds of pollinators (see the photos below).

{{< mediafigure src="biology/Figure_18_01_04ab-e353" kind="photo" alt="Two close-up photos side by side: (a) a dense blazing star's flower spike, covered in thin, upright, purple, thread-like petals; (b) a purple coneflower's raised central cone, spiky and shading from green at the center through yellow and orange, ringed by drooping pink-purple petals." >}}
...
{{< callout type="info" >}}
**Link to Learning.** Watch [a video exploring the bones in the human body](https://openstax.org/l/bone_structures).
{{< /callout >}}

Another piece of evidence of evolution is the convergence of form in organisms that share similar environments. For example, species of unrelated animals, such as the arctic fox and ptarmigan, living in the arctic region have been selected for seasonal white phenotypes during winter to blend with the snow and ice (see the photos below). These similarities occur not because of common ancestry, but because of similar selection pressures—the benefits of predators not seeing them.

{{< mediafigure src="biology/Figure_18_01_07ab" kind="photo" alt="Two photos side by side: (a) a white arctic fox curled up resting in a snowy hollow beside a large snow-covered mound; (b) a white ptarmigan standing upright on snow, its plumage nearly matching the snow around it." >}}
...
{{< callout type="info" >}}
**Link to Learning.** [Explore a site addressing common misconceptions about the theory of evolution](https://openstax.org/l/misconceptions).
{{< /callout >}}
...
competing with other individuals for those resources
...
a vestigial structure indicates a past form or function that has since changed
...
it is the strongest form of knowledge in science
a theory in common vernacular can mean a guess or speculation
...
the monkey represents greater progress to that goal than the mouse
both species are likely to be well adapted to their particular environments

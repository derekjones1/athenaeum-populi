...
{{< mediafigure src="biology/Figure_33_02_06" kind="diagram" alt="An illustration of loose connective tissue: a loose mesh of wavy pink fibers of two widths crossing in every direction, with small purple oval cells scattered among them; labels point to a thin fiber as 'Elastin fiber,' a thick fiber as 'Collagen fiber,' and one of the oval cells as 'Fibroblasts.'" longdesc="Three guide lines run from labels at the top down into the fiber mesh. 'Elastin fiber,' at left, points to one of the thin, wavy strands crossing the field. 'Fibroblasts,' in the middle, points to one of the small, oval, purple-staining cells scattered loosely among the fibers. 'Collagen fiber,' at right, points to one of the wider, more heavily shaded bands running through the mesh. Fibers of both widths cross and loop through the field in no consistent direction, with open space visible between them." >}}
...
{{< multiplechoice
  ...
  answer="squamous"
  hint="Look back at the epithelial-tissue table for which cell shape lines the lung's air sacs and the walls of capillaries — thin cells make for a short diffusion path."
>}}
squamous
cuboidal
columnar
...
{{< multiplechoice
  ...
  answer="cuboidal"
  hint="This shape prepares and secretes material in glandular tissue and lines kidney and liver tubules."
>}}
squamous
cuboidal
columnar
...
{{< multiplechoice
  ...
  answer="transitional"
  hint="This epithelium changes thickness as an organ that stores fluid fills and empties."
>}}
squamous
cuboidal
columnar
...
{{< multiplechoice
  ...
  hint="This tissue type is found in tendons and ligaments, where cells and matrix are sparse compared to the fiber content."
>}}
...
{{< multiplechoice
  ...
  hint="This muscle type has multiple nuclei at the cell periphery and moves the bones under conscious control."
>}}
smooth muscle
skeletal muscle
cardiac muscle
...
{{< multiplechoice
  ...
  answer="cell body"
  hint="Picture the neuron's parts: the nucleus sits inside the largest, most central structure, not in any of its thread-like projections."
>}}
cell body
dendrite
axon
...
{{< textin
  ...
  answer="astrocytes"
  accept="astrocyte"
  hint="Their star-shaped projections sit alongside the axon but do not wrap around it, unlike their neighboring glial cell."
>}}
...
{{< textin
  ...
  accept="oligodendrocyte"
  hint="Their segments wrap directly around the axon, forming a sheath, unlike the star-shaped glial cells that only sit nearby."
>}}

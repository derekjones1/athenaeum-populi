...
description: >-
  The four primary animal tissues — epithelial, connective, muscle, and
  nervous — their defining cell shapes and arrangements, and where each is
  found in the body — adapted from OpenStax Biology 2e, Section 33.2.
source_section: "33.2"
weight: 2
---
...
{{< mediafigure src="biology/Figure_B33_02_01ab" kind="photo" eager="true" alt="Two-panel image. Panel (a): a flat illustration of squamous cells — irregular polygon-shaped cells, each with one small, round, centrally placed purple nucleus, fitted edge to edge with no gaps. Panel (b): a photomicrograph of a cross section of human cervix tissue stained pink and purple, layered from the free surface down: a thin, tightly packed layer of flattened cells at the top, a broader zone of loosely packed rounded cells through the middle, and a denser layer of elongated cells at the base, with small red-stained capillaries near the bottom; a 25 µm scale bar sits at lower right." >}}
...
{{< mediafigure src="biology/Figure_33_02_02" kind="diagram" alt="An illustration of cuboidal epithelial cells: three separate rosettes, each made of six to eight wedge-shaped cells arranged around a small, empty central lumen, giving each rosette the look of a sliced pie; every cell has one round, centrally placed purple nucleus." >}}
...
{{< mediafigure src="biology/Figure_33_02_03" kind="diagram" alt="An illustration of a row of tall columnar epithelial cells standing side by side, each with cilia fringing the top and an oval nucleus near the base, with two flask-shaped goblet cells interspersed among them and labels pointing to each cell type; a pale layer with scattered, flattened purple cells lies beneath." longdesc="Two guide lines labeled 'Goblet cells' at the top point down to two pale, swollen, flask-shaped cells that reach up to the ciliated surface, wider than their neighbors. A second label, 'Columnar epithelial cells,' has two guide lines pointing to the tall, narrow cells flanking the goblet cells, each with an oval purple nucleus set near its base and short cilia fringing its top edge. Beneath the row of columnar and goblet cells lies a pale layer of tissue with small, flattened, spindle-shaped purple cells scattered through it, lying horizontally." >}}
...
{{< mediafigure src="biology/Figure_33_02_04" kind="diagram" alt="An illustration of pseudostratified columnar epithelium: tall cells reaching the ciliated free surface stand alongside shorter cells whose nuclei sit lower, so the nuclei appear at two different levels; two pale, flask-shaped goblet cells are interspersed among them, with labels pointing to the goblet cells and to the pseudostratified epithelial cells; a pale layer with scattered, flattened purple cells lies beneath." longdesc="Two guide lines from the label 'Goblet cells' at the top point to two pale, swollen, flask-shaped cells that widen toward the ciliated surface. A second label, 'Pseudostratified epithelial cells,' has two guide lines pointing to the surrounding tall and short cells: the tall cells' nuclei sit high, near the middle of the layer, while shorter cells wedged between them have nuclei set lower, close to the base — the staggered nuclear heights are what make the single layer look stratified. Cilia fringe the free surface at top. Beneath the row lies a pale layer of tissue with small, flattened, spindle-shaped purple cells scattered through it, lying horizontally." >}}
...
Pseudostratified columnar epithelia occur in a single layer, but the arrangement of nuclei makes it appear that more than one layer is present.
...
{{< mediafigure src="biology/Figure_33_02_06" kind="diagram" alt="An illustration of loose connective tissue: a loose mesh of fibers of two kinds crossing in every direction, broad mauve bands and thin, dark purple strands, with small purple oval cells scattered among them; labels point to a thin fiber as 'Elastin fiber,' a thick fiber as 'Collagen fiber,' and one of the oval cells as 'Fibroblasts.'" longdesc="Three guide lines run from labels at the top down into the fiber mesh. 'Elastin fiber,' at left, points to one of the thin, dark purple strands crossing the field. 'Fibroblasts,' in the middle, points to one of the small, oval, purple-staining cells scattered loosely among the fibers. 'Collagen fiber,' at right, points to one of the wider, more heavily shaded bands running through the mesh. Fibers of both widths cross and loop through the field in no consistent direction, with open space visible between them." >}}
...
{{< mediafigure src="biology/Figure_33_02_07" kind="diagram" alt="An illustration of dense fibrous connective tissue: parallel, tightly packed pink collagen fibers run left to right, with five small oval purple nuclei, each in a pale, spindle-shaped fibroblast lying flat between the fiber bundles; labels point to a fibroblast nucleus, to two fibroblasts, and to the collagen fibers." longdesc="Guide lines point from three labels at the top into the parallel fiber bundles. 'Fibroblast nuclei,' at left, points to a small, oval, purple-staining nucleus near the top, set in a pale, spindle-shaped streak between fiber strands. 'Fibroblasts,' in the middle, sends two lines: one to that same pale streak just right of the nucleus, the other to a second nucleus in its own pale streak farther right and lower, each streak oriented in the same left-to-right direction as the fibers. 'Collagen fibers,' at right, points to one of the wavy pink bands running the width of the image. The whole field is made up of these parallel bands, with five such nuclei in pale streaks spaced through it." >}}
...
{{< mediafigure src="biology/Figure_33_02_08" kind="diagram" alt="An illustration of hyaline cartilage: pairs and small clusters of round chondrocytes, each with a red nucleus, sit inside clear, bordered lacunae embedded in a pale lavender matrix." >}}
...
{{< mediafigure src="biology/Figure_33_02_09" kind="diagram" alt="A three-panel diagram of bone structure. Panel (a) shows a whole long bone at upper left labeled with its compact and spongy regions, an arrow leading to an enlarged 3D block of bone tissue labeled with an osteon, its central blood vessels, nerve, and lymphatic vessel, and its outer trabeculae. Panel (b) is a flat cross section of several osteons, each a set of concentric rings around a central Haversian canal, with lacunae and radiating canaliculi labeled. Panel (c) is a single osteon shown as a cutaway oval with osteocytes, osteoclasts, and osteoblasts labeled around its lamellae." longdesc="Panel (a), upper left: a small whole long bone is labeled 'Compact bone' at its shaft and 'Spongy bone' at its widened end; an arrow leads from a boxed region of the shaft down to a large 3D block of bone tissue. On the block, a circled region is labeled 'Osteon'; the block's top face is dotted with osteons, each with a small bundle of colored tubes (red, blue, yellow, green) at its center, and red and blue vessels run between them through connecting channels, visible on the block's front face. Lines from 'Lymphatic vessel' (to the green tube), 'Nerve' (to the yellow tube), and 'Blood vessels' (two lines, to the red and the blue tube) point to the bundle of a small osteon near the block's right edge, just right of the circled one. 'Trabeculae' labels the web-like mesh at the block's wider end. Brackets at the bottom and right of the block are labeled 'Compact bone' and 'Spongy bone,' naming the block's dense outer region and porous inner region. Panel (b), lower left: a flat, square cross section shows several circular osteons packed together, each made of concentric rings. 'Lacunae (contains osteocytes)' points to small dark flecks scattered between the rings; 'Lamellae (concentric circles)' points to the rings themselves; 'Haversian canal' points to the open circle at the center of one osteon; 'Canaliculi (canals radiating outward)' points to the fine lines radiating from the rings toward the lacunae. A bracket beneath one osteon is labeled 'Osteon.' Panel (c), lower right: a single osteon is drawn as a cutaway oval. 'Osteocyte' points to a cell within the rings; 'Osteoclast' points to one of two larger, multi-nucleated cells at the oval's left and right edges; 'Osteoblast' points to small cells lining the oval's outer edge; 'Canaliculi' and 'Lamellae' point to the fine radiating lines and concentric rings inside the oval." >}}
...
{{< mediafigure src="biology/Figure_33_02_10" kind="diagram" alt="An illustration of adipose tissue: large, angular, empty-looking cells packed tightly edge to edge, each outlined by a thin yellow-orange membrane line, with a few small purple nuclei crowded at the cells' edges." >}}
...
{{< mediafigure src="biology/Figure_33_02_11" kind="diagram" alt="An illustration of blood cells scattered across a white background: many small, disc-shaped red erythrocytes with a paler central dimple; many much smaller tan, spindle-shaped platelets; and larger, rounder white blood cells of several distinct shapes and internal patterns, each identified by a labeled line." longdesc="Reading roughly left to right across the field: at far left, 'Macrophage' labels a very large, irregular cell with finger-like projections and a large oval nucleus. Above and right of it, 'Neutrophil' labels a round cell with a lobed, multi-part nucleus and fine granules. 'Monocyte,' at upper middle, labels a large round cell with a kidney-bean-shaped nucleus. 'Lymphocyte,' at upper right, labels a round cell with a large, smooth, off-center nucleus that fills most of the cell. In the lower middle, 'Eosinophil' labels a round, coarsely granular cell with a two-lobed nucleus. At right, 'Basophil' labels a round cell packed with dark granules around an H-shaped nucleus. 'Erythrocyte (red blood cell),' at center, sends two lines to two of the many small, disc-shaped red cells with a lighter central dimple that fill the rest of the field. 'Platelets,' at lower center, sends two lines to two of the many small, tan, spindle-shaped fragments scattered among the red cells." >}}
...
{{< mediafigure src="biology/Figure_33_02_12abc" kind="diagram" alt="A three-panel comparison of muscle tissue. Left panel, 'Smooth muscle cells': long, spindle-shaped cells with a single, dark, oval nucleus each, lying in parallel bands with no cross-banding. Middle panel, 'Skeletal muscle cells': long fibers marked with fine, regularly spaced cross-stripes, with several small nuclei set at the fiber edges. Right panel, 'Cardiac muscle cells': shorter, wavy fibers with only faint lengthwise streaks (no cross-stripes drawn), four elongated nuclei among them, joined end to end at short white crosswise lines, one labeled 'Intercalated disc.'" longdesc="Three tissue samples are shown side by side, each captioned with its own title above it. Left, 'Smooth muscle cells': elongated spindle-shaped cells run roughly parallel, each with a single dark oval nucleus near its middle and no visible banding. Middle, 'Skeletal muscle cells': long, gently wavy fibers cross the panel, each ruled with fine, evenly spaced light cross-stripes (striations) and studded along its edges with several small, dark nuclei. Right, 'Cardiac muscle cells': shorter, wavy fibers marked only with faint lengthwise streaks (the drawing shows no cross-stripes here), with four elongated nuclei scattered among them, never more than one in a cell; a guide line labeled 'Intercalated disc' points to one of several short white crosswise lines where the end of one cell meets the next." >}}
...
{{< mediafigure src="biology/Figure_33_02_13" kind="diagram" alt="An illustration of a neuron: a large, star-shaped yellow cell body with a purple nucleus and many branching dendrites, tapering into a single long axon wrapped in segmented teal sheaths, ending in a spray of thin axon terminals; a smaller, star-shaped tan cell sits beside the axon." longdesc="At the upper left, the axon of another neuron enters from off-frame, wrapped in teal segments, and ends in faint, pale yellow branching terminals among this neuron's dendrites. 'Cell body (soma)' labels the large, star-shaped yellow cell with a round purple nucleus at the image's left-center; many thin, branching dendrites radiate from its edges. 'Dendrites' labels this same branching fringe. From the opposite side of the cell body, 'Axon' labels a long, narrow yellow projection that runs right and down across the image, wrapped at intervals in short teal segments. 'Oligodendrocyte' labels a rounded teal cell body sitting on the sheath partway along the axon, with thin extensions running to neighboring teal segments. Below the axon's midpoint, 'Astrocyte' labels a smaller, star-shaped tan cell with its own short branching projections, sitting beside but not touching the axon. At the lower right, the axon ends in a spray of thin, branching yellow filaments labeled 'Axon terminals.'" >}}
...
{{< multiplechoice
  ...
  answer="squamous"
  hint="Look back at the epithelial-tissue table's Description and Location columns, and at the paragraph on the first cell shape the section describes."
>}}
squamous
cuboidal
columnar
...
{{< multiplechoice
  ...
  answer="cuboidal"
  hint="Look at the Location column of the epithelial-tissue table."
>}}
squamous
cuboidal
columnar
...
{{< multiplechoice
  ...
  answer="transitional"
  hint="Look at the Location column of the epithelial-tissue table, and at the last epithelium the section describes."
>}}
squamous
cuboidal
columnar
...
a single layer of cells presents a very thin epithelia that minimally inhibits diffusion
as a stratified epithelia, the surface cells can be sloughed off
cells in deeper layers protect the underlying tissues from damage
{{< /selfcheck >}}
...
{{< multiplechoice
  ...
  hint="Compare the Fibers column of the connective-tissue table."
>}}
...
both have cells that lodge in spaces within the tissue called lacunae
both collagen and elastic fibers are found in bone and cartilage
both tissues participate in vertebrate skeletal development and formation
{{< /selfcheck >}}
...
the person has to make the choice to work those muscles through exercise or movement
smooth muscles are involved in involuntary activities of the body
they are active even when a person is sedentary
{{< /selfcheck >}}
...
the death of oligodendrocytes results in the loss of the insulating sheath around the axon
the electrical impulses travel much more slowly down the length of the axon
{{< /selfcheck >}}

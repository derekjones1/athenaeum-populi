...
description: >-
  Animal body plans and symmetry, the limits diffusion and skeleton type
  place on size and shape, and how bioenergetics — endothermy, ectothermy,
  and torpor — relates to body size, activity, and environment — adapted
  from OpenStax Biology 2e, Section 33.1.
source_section: "33.1"
weight: 1
---
...
An important concept in understanding how efficient diffusion is as a means of transport is the surface to volume ratio. Recall that any three-dimensional object has a surface area and volume; the ratio of these two quantities is the surface-to-volume ratio. Consider a cell shaped like a perfect sphere: it has a surface area of $4\pi r^2$, and a volume of $(4/3)\pi r^3$. The surface-to-volume ratio of a sphere is 3/r; as the cell gets bigger, its surface to volume ratio decreases, making diffusion less efficient. The larger the size of the sphere, or animal, the less surface area for diffusion it possesses.
...
Visit [a time-lapse video of zebrafish development](https://openstax.org/l/nanoscopy).
{{< /callout >}}
...
{{< callout type="info" >}}
**Career Connection.** *Physical Anthropologist.* Physical anthropologists study the adaptation, variability, and evolution of human beings, plus their living and fossil relatives. They can work in a variety of settings, although most will have an academic appointment at a university, usually in an anthropology department or a biology, genetics, or zoology department.
...
if a cell exceeds this distance, the center cannot get adequate nutrients nor expel enough waste to survive
cells can loosely adhere to each other in a liquid medium
...
the blood diffuses through the tissue space, delivering nutrients and receiving wastes
the blood diffuses back to the heart to be pumped again
this limits animals with an open circulatory system to fairly small volumes, so blood can diffuse rapidly enough
{{< /selfcheck >}}
...
the temperature range in a geographic area limits ectotherms

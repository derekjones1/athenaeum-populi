...
title: Homeostasis
description: >-
  How animals maintain a dynamic equilibrium around a set point through
  negative and positive feedback loops, alteration, and acclimatization, and
  how endotherms and ectotherms regulate body temperature — adapted from
  OpenStax Biology 2e, Section 33.3.
source_section: "33.3"
weight: 3
---
...
negative feedback loops tend to keep a system at equilibrium
...
{{< callout type="info" >}}
**Link to Learning.** Feedback mechanisms can be understood in terms of driving a race car along a track: watch [a short video lesson on positive and negative feedback loops](https://www.openstax.org/l/feedback_loops).
{{< /callout >}}
...
{{< callout type="info" >}}
**Link to Learning.** Watch [this video on thermoregulation](https://www.openstax.org/l/thermoregulate) to see illustrations of this process in a variety of animals.
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_33_03_03" kind="photo" alt="Four photos in a 2×2 grid: (a) a bright sun low in a clear blue sky; (b) a close view of a sweat-beaded shoulder and neck; (c) a lion with its mane blowing in the wind, resting in tall grass; (d) a hand holding a steaming mug of a hot drink near another hand holding toast." >}}
...
inducing shivering
stopping sweat glands from secreting fluid
{{< /selfcheck >}}
...
bacterial enzymes are inhibited at either higher or lower temperatures
fever increases the destruction of the invading bacteria by increasing the effectiveness of body defenses
...
an uncoupling protein provides a channel in the inner mitochondrial membrane that allows protons to leave the lumen without moving through the ATP synthase
this generates heat rather than chemical energy as the final product of cellular respiration
{{< /selfcheck >}}

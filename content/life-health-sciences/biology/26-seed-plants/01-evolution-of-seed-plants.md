...
description: >-
  Seeds and pollen as the two innovations that freed seed plants from a
  dependence on water for reproduction, and the evolutionary sequence from
  progymnosperms through gymnosperms to the flowering angiosperms — adapted
  from OpenStax Biology 2e, Section 26.1.
source_section: "26.1"
weight: 1
---
...
The fossil plant *Elkinsia polymorpha*, a "seed fern" from the Devonian period—about 400 million years ago—is considered the earliest seed plant known to date. Seed ferns (figure below) produced their seeds along their branches, in structures called cupules that enclosed and protected the ovule—the female gametophyte and associated tissues—which develops into a seed upon fertilization. Seed plants resembling modern tree ferns became more numerous and diverse in the coal swamps of the Carboniferous period.

{{< mediafigure src="biology/Figure_26_01_02" kind="photo" alt="A close-up photo of a fossilized leaf more than ten centimeters long, brown and feather-shaped, with a metric ruler laid beside it for scale." >}}
...
Fossil records indicate the first gymnosperms (progymnosperms) most likely originated in the Paleozoic era, during the middle Devonian period: about 390 million years ago. The following Carboniferous period was wet and dominated by giant fern trees. But the following Permian period was dry, which gave a reproductive edge to seed plants, which are better adapted to survive dry spells. The Ginkgoales, a group of gymnosperms with only one surviving species—the *Ginkgo biloba*—were the first gymnosperms to appear during the early Permian. Gymnosperms expanded in the Mesozoic era (about 240 million years ago), supplanting ferns in the landscape, and reaching their greatest diversity during this time. The Jurassic period was as much the age of the cycads (palm-tree-like gymnosperms) as the age of the dinosaurs. Ginkgoales and the more familiar conifers also dotted the landscape. Today, although angiosperms (flowering plants) are the major form of plant life in most biomes, gymnosperms still dominate some ecosystems, such as the taiga (boreal forests) and the alpine forests at higher mountain elevations (figure below) because of their adaptation to cold and dry growth conditions.

{{< mediafigure src="biology/Figure_26_01_03" kind="photo" alt="A photo of a boreal forest with a uniform low layer of plants and tall conifers scattered throughout the landscape, with the snow-capped mountains of the Alaska Range in the background." >}}
...
{{< mediafigure src="biology/Figure_26_01_05" kind="photo" alt="A black-and-white photo of a fossilized leaf imprint that looks much like a modern teardrop-shaped leaf, its network of branching veins clearly visible against the surrounding rock." >}}
*Ficus* imprint. This leaf imprint shows a *Ficus speciosissima*, an angiosperm that flourished during the Cretaceous period. (credit: W. T. Lee, USGS)
{{< /mediafigure >}}
...
- **ovule** — structure within which the female gametophyte develops; it becomes the seed after fertilization. *(Source note: the source glossary says "female gametophyte"; this book's Angiosperms section describes the ovule as the integument-covered structure containing the megasporangium in which the female gametophyte forms.)*
...
allowed them to expand their range onto dry land
...
herbivory contributed to diversity
plants needed to attract some insects
plants needed to repel others
{{< /selfcheck >}}

...
description: >-
  Angiosperm coevolution with herbivores and pollinators, the roles seed
  plants play in human diets, medicine, and industry, and how deforestation
  threatens plant biodiversity — adapted from OpenStax Biology 2e, Section
  26.4.
source_section: "26.4"
weight: 4
---
...
4. Observe the movement of the flies for one hour. Record the number of visits to the flowers using a table similar to the one below. Given the rapid movement of flies, it may be beneficial to use a video camera to record the fly–flower interaction. Replay the video in slow motion to obtain an accurate record of the number of fly visits to the flowers.
...
it can refer to variation within a species, within an ecosystem, or on an entire planet
it ensures a resource for new food crops and medicines
plant life balances ecosystems, protects watersheds, mitigates erosion, moderates climate, and provides shelter for animal species
{{< /selfcheck >}}

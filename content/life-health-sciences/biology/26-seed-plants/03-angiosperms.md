...
title: Angiosperms
description: >-
  Flowers and fruit, the two reproductive innovations behind the angiosperms'
  dominance of terrestrial ecosystems, traced through flower structure, the
  double-fertilization life cycle, and the monocot/eudicot split — adapted
  from OpenStax Biology 2e, Section 26.3.
source_section: "26.3"
weight: 3
---
...
without a microsporangium, pollen would not form
{{< /selfcheck >}}
...
{{< mediafigure src="biology/Figure_26_05" kind="photo" alt="A close-up of a large, fully open white magnolia flower with six broad petal-like tepals surrounding a maroon-tipped, cone-shaped center covered in yellow anthers and thread-like stamens, some already shed and browning." >}}
...
{{< mediafigure src="biology/Figure_26_03_05" kind="photo" alt="Two labeled rows of photos: 'Monocots' above (a) a rice paddy with drooping grain heads, (b) a wheat field with pale golden seed heads, and (c) banana trees hung with bunches of green bananas; 'Dicots' above (d) a bed of pale-green cabbage heads, (e) scattered brown speckled beans, and (f) clusters of ripe orange peaches on a branch." >}}
Monocot and dicot crop plants. The world's major crops are flowering plants. (a) Rice, (b) wheat, and (c) bananas are monocots, while (d) cabbage, (e) beans, and (f) peaches are dicots. (credit a: modification of work by David Nance, USDA ARS; credit b, c: modification of work by Rosendahl; credit d: modification of work by Bill Tarpenning, USDA; credit e: modification of work by Scott Bauer, USDA ARS; credit f: modification of work by Keith Weller, USDA)
{{< /mediafigure >}}
...
cycads produce large, female cones that produce naked seeds
cycads produce smaller male cones on separate plants
palms do not
{{< /selfcheck >}}

{{< selfcheck question="What are the two structures that allow angiosperms to be the dominant form of plant life in most terrestrial ecosystems?" hint="These are the two novel reproductive structures named in the section's opening paragraphs." >}}
...
flowers
fruit
these structures protect reproduction from variability in the environment
{{< /selfcheck >}}
...
{"bins": ["Monocot", "Eudicot"],
 "items": [
  ...
  {"label": "Two cotyledons in the embryo", "bin": 1},
  {"label": "Parallel leaf veins", "bin": 0},
  {"label": "Leaf veins forming a branched network", "bin": 1},
  {"label": "Scattered vascular tissue in the stem", "bin": 0},
  {"label": "Vascular tissue arranged in a ring in the stem", "bin": 1},
  {"label": "A fibrous network of roots, with no major tap root", "bin": 0},
  {"label": "A tap root with many lateral roots", "bin": 1},
  {"label": "Pollen with a single furrow", "bin": 0},
  {"label": "Pollen with three furrows", "bin": 1},
  {"label": "Flower parts in three, or a multiple of three", "bin": 0},

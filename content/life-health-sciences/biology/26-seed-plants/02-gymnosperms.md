...
title: Gymnosperms
description: >-
  Gymnosperm characteristics, their Mesozoic dominance and adaptations to
  dry or cold conditions, the four modern-day phyla, and the alternation-of-
  generations life cycle traced through a conifer — adapted from OpenStax
  Biology 2e, Section 26.2.
source_section: "26.2"
weight: 2
---
...
{{< callout type="info" >}}
**Link to Learning.** Watch [this video showing the process of seed production in gymnosperms](https://www.openstax.org/l/gymnosperm2).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_26_02_02abcd" kind="photo" alt="Four photos of conifers: (a) a tall evergreen spruce covered in cones, (b) a gnarled juniper trunk in a rocky, arid landscape, (c) a broad-trunked sequoia towering over surrounding trees, and (d) a stand of tamarack conifers with yellow autumn needles." >}}
...
{{< mediafigure src="biology/Figure_26_02_03" kind="photo" alt="Photo shows a cycad with leaves resembling those of a fern, with thin leaves branching from a thick stem. Two very large cones sit in the middle of the leaves, close to the ground." >}}
...
{{< mediafigure src="biology/Figure_26_02_05" kind="photo" alt="Three photos of gnetophytes: (a) a short, scrubby yellow-branched shrub in a dry, gravelly landscape; (b) broad, teardrop-shaped green leaves growing in dense foliage; and (c) a low plant with long, flat leaves radiating along desert sand from a central crown bearing dark, dry, cone-like growths." >}}
...
{{< callout type="info" >}}
**Link to Learning.** Watch [this BBC video describing the strangeness of *Welwitschia*](https://www.openstax.org/l/welwitschia2).
{{< /callout >}}
...
The gametophyte is the longest phase of the life cycle.
{{< /multiplechoice >}}
...
{{< textin
  question="The layer of sporophyte tissue that surrounds the megasporangium, and later the embryo, is called the ________."
  answer="integument"
  hint="This tissue layer becomes part of the mature seed coat."
>}}
...
{{< multiplechoice
  ...
  answer="conifer"
  hint="Cold, dry taiga forests favor the phylum whose thick cuticle and needle-shaped leaves reduce water loss and shed snow easily."
>}}
conifer
cycad
*Ginkgo biloba*
...
{{< selfcheck question="The Mediterranean landscape along the sea shore is dotted with pines and cypresses. The weather is not cold, and the trees grow at sea level. What evolutionary adaptation of conifers makes them suitable to the Mediterranean climate?" hint="Conifers are adapted to more than just cold — think about what a dry Mediterranean summer and a dry taiga winter have in common." >}}
...
{{< textin
  ...
  answer="Paleozoic"
  accept="Palaeozoic"
  hint="This era comes before the Mesozoic, during which the gymnosperms' dominance later peaked."
>}}
...
{{< multiplechoice
  question="What is the ploidy of the following structures: gametophyte, seed, spore, sporophyte?"
  answer="1*n*, 2*n*, 1*n*, 2*n*"
  hint="The gametophyte and the spore it germinates from share the same ploidy; the seed encloses the embryo, whose ploidy matches the sporophyte's."
>}}
1*n*, 1*n*, 2*n*, 2*n*
1*n*, 2*n*, 1*n*, 2*n*
2*n*, 1*n*, 2*n*, 1*n*

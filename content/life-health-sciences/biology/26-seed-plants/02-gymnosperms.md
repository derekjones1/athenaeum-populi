...
{{< textin
  ...
  answer="integument"
  hint="Reread this section's key terms."
>}}

{{< textin
  question="Gymnosperms are ________ seed plants that produce naked seeds."
...
{{< multiplechoice
  ...
  hint="Reread the Life Cycle of a Conifer subsection and the ploidy labels on its diagram."
>}}
1*n*, 1*n*, 2*n*, 2*n*
1*n*, 2*n*, 1*n*, 2*n*
2*n*, 1*n*, 2*n*, 1*n*

...
description: >-
  What ecology studies at the organismal, population, community, and
  ecosystem levels, why understanding it draws on other scientific
  disciplines, and how biotic and abiotic components of an environment
  relate to one another — adapted from OpenStax Biology 2e, Section 44.1.
source_section: "44.1"
weight: 1
---
...
Climate change can alter where organisms live, which can sometimes directly affect human health. Watch the PBS video [“Feeling the Effects of Climate Change”](https://openstax.org/l/climate_health), in which researchers discover a pathogenic organism living far outside of its normal range.
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_44_01_02" kind="photo" alt="A Karner blue butterfly perched with its wings spread, showing pale blue-violet wings rimmed in white, with a band of small orange and black spots along the lower edge of each wing, and long banded antennae curving above its head." >}}
...
{{< mediafigure src="biology/Figure_44_01_03" kind="photo" alt="A tall wild lupine flower spike surrounded by leafy foliage: its unopened buds are green at the top, the buds just below them are tinged pink and blue, and the fully open flowers toward the bottom are a deep blue-violet." >}}
...
{{< mediafigure src="biology/Figure_44_01_04" kind="photo" alt="A researcher crouches over an open plastic carrier on dry grassland, with shredded paper bedding spilling out beside a burrow opening ringed with dirt; a second, closed carrier sits in the background." >}}
...
See [an interview with Stephen Wing, a marine ecologist from the University of Otago](https://openstax.org/l/ecologist_role), discussing the role of an ecologist and the types of issues ecologists explore.
{{< /callout >}}
...
{{< textin
  question="The section's summary states that ecologists ask questions comprising four levels of general biological organization: organismal, population, community, and ________."
  answer="ecosystem"
  hint="Reread the Summary's second sentence, which lists the four levels in order."
>}}
...
{{< textin
  question="Individuals that are members of different species are called ________."
  answer="heterospecifics"
  accept="heterospecific"
...
community ecology and ecosystem ecology might pose greater challenges for collaboration
...
this definition of a population could be considered a drawback if it prohibits the ecologist from studying a population's individuals that may be transitory, but still influential
some species with members that have a wide geographic range might not be considered to be a population, but could still have many of the qualities of a population
{{< /selfcheck >}}
...
factors affecting reproduction, such as physiology and behavior
habitat requirements, such as plants and soils
potential human influences on the population and its habitat, derived through studies in sociology and urban ecology
{{< /selfcheck >}}
...
the ecosystem includes the biotic (living) and abiotic (nonliving) components of an area, such as air, water, and soil
ecosystem biologists ask how nutrients and energy are stored and move among organisms and through the surrounding atmosphere, soil, and water
{{< /selfcheck >}}

...
title: Biogeography
description: >-
  How biogeography explains the geographic distribution of species, the
  abiotic factors — light, temperature, water, and nutrients — that shape
  where plants and animals live in aquatic and terrestrial environments,
  and how those factors govern a biome's net primary productivity —
  adapted from OpenStax Biology 2e, Section 44.2.
source_section: "44.2"
weight: 2
---
...
{{< mediafigure src="biology/Figure_44_02_01ab" kind="photo" eager="true" alt="Photo (a) depicts a wallaby, a member of the kangaroo family. The wallaby is brown with white flecks on its fur and a light brown underbelly. Its hands are clasped together. Photo (b) shows an echidna. Like a porcupine, the echidna has a compact body covered with brown and white quills. It has a long, slender snout." >}}
...
Check out this [video of a platypus swimming in its natural habitat](https://openstax.org/l/platypus) in New South Wales, Australia.
{{< /callout >}}
...
The availability of nutrients in aquatic systems such as oceans is also an important aspect of energy or photosynthesis. Many organisms sink to the bottom of the ocean when they die in the open water; when this occurs, the energy and nutrients found in that living organism are sequestered for some time unless ocean upwelling occurs. **Ocean upwelling** is the rising of deep ocean waters that occurs when prevailing winds blow along surface waters near a coastline, shown below. As the wind pushes ocean waters offshore, water from the bottom of the ocean moves up to replace this water. As a result, the energy and nutrients once contained in dead organisms become available for reuse by other living organisms.

{{< mediafigure src="biology/Figure_B44_02_04" kind="diagram" alt="Arrows in the illustration indicate that the prevailing wind direction is from the coastline toward the open ocean. The wind pushes the surface water away from shore, inducing a current in this direction. A counter-current flows from the depths toward shore, where it meets the surface current. The counter-current brings nutrients from the depths up toward the surface near the shoreline." longdesc="A cross-section with sky at the top, ocean at the lower left, and a steep brown coastline at the lower right. A chain of green arrows arcs from above the coastline down and to the left, low over the water's surface, all pointing left (offshore); the word 'Wind' labels this chain. Below the wind arrows, a row of red arrows lies along the ocean's surface, also pointing left, running parallel to the wind. That surface row connects to a second red arrow that curves up the coastal slope, pointing up and to the left toward the surface row, labeled 'nutrients' along its curve. At the bottom of the diagram, a third row of red arrows runs along the ocean floor, pointing right, toward the base of the coastal slope, feeding into the rising 'nutrients' arrow." >}}
...
{{< selfcheck question="How might turnover in tropical lakes differ from turnover in lakes that exist in temperate regions? Think of the variation, or lack of variation, in seasonal temperature change." hint="Ask whether a tropical lake's surface ever gets cold enough to freeze, and what the water column can still do even without an ice-driven turnover." >}}
...
===CHECKS===
tropical lakes don't freeze, so they don't undergo spring turnover the same way temperate lakes do
stratification does occur, as well as seasonal turnover
{{< /selfcheck >}}
...
Fire is another terrestrial factor that can be an important agent of disturbance in terrestrial ecosystems. Some organisms are adapted to fire and, thus, require the high heat associated with fire to complete a part of their life cycle. For example, the jack pine (*Pinus banksiana*) requires heat from fire for its seed cones to open, shown below. Through the burning of pine needles, fire adds nitrogen to the soil and limits competition by destroying undergrowth.

{{< mediafigure src="biology/Figure_44_02_06" kind="photo" alt="Photo shows two pine cones that are tightly closed and attached to a branch." >}}
...
these species remain distinctly different from those of surrounding areas
...
spring and fall turnover is a seasonal process driven by springtime warming and autumn cooling
both processes let nutrients from the bottom of the body of water be recycled and reused by living things
{{< /selfcheck >}}

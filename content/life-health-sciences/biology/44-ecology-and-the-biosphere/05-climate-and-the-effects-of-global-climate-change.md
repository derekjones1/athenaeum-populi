...
description: >-
  How scientists use ice cores and other indirect evidence to trace Earth's
  climate through 400,000 years of natural cycles, and the three natural
  drivers — Milankovitch cycles, solar intensity, and volcanic eruptions —
  that shaped climate before the Industrial Era. Covers the greenhouse
  effect, the human-driven rise in atmospheric CO₂ since industrialization,
  and its documented effects on glaciers, sea level, and species' timing —
  adapted from OpenStax Biology 2e, Section 44.5.
source_section: "44.5"
weight: 5
---
...
Watch [a NASA video about the mixed effects of global warming on plant growth](https://openstax.org/l/climate_plants). While scientists found that warmer temperatures in the 1980s and 1990s caused an increase in plant productivity, this advantage has since been counteracted by more frequent droughts.
{{< /callout >}}
...
It has cycled up and down every few decades.
It has stayed essentially constant.
{{< /multiplechoice >}}
...
ocean waters will cause the rising of sea levels at the coastlines
continued melting of glaciers and reduced spring and summer meltwaters may cause summertime water shortages
changes in seasonal temperatures may alter lifecycles and interrupt breeding patterns in many species of plants and animals
{{< /selfcheck >}}
...
these natural processes cause periodic, intermittent changes in global climate
human activity, through emissions from the burning of fossil fuels, has caused a progressive rise in atmospheric carbon dioxide levels
{{< /selfcheck >}}

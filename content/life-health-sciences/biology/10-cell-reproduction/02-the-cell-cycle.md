...
- **G₁ phase** — (also, first gap) first phase of interphase centered on cell growth *(Source note: the source glossary ends "during mitosis"; this section's own text places G₁ in interphase, before the mitotic phase, and its G₂ entry is phrased as preparation for mitosis.)*

...
description: >-
  How a gene mutation in a proto-oncogene or a tumor suppressor gene releases
  the cell cycle from its checkpoints, and why cells with a faulty p53
  protein are especially prone to becoming cancerous — adapted from OpenStax
  Biology 2e, Section 10.4.
source_section: "10.4"
weight: 4
---
...
{{< callout type="info" >}}
**Link to Learning.** Watch [an animation of how cancer results from errors in the cell cycle](https://www.openstax.org/l/cancer).
{{< /callout >}}

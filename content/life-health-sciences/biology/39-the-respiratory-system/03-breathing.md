...
title: Breathing
description: >-
  How the lungs, thoracic cavity, and diaphragm work together to change
  pressure and move air, why lung compliance and airway resistance shape the
  work of breathing, and how a ventilation/perfusion mismatch creates dead
  space in the lung — adapted from OpenStax Biology 2e, Section 39.3.
source_section: "39.3"
weight: 3
---
...
{{< callout type="info" >}}
**Evolution Connection.** *Avian Respiration.* Birds have evolved a respiratory system that enables them to fly. Flying is a high-energy process and requires a lot of oxygen. Furthermore, many birds fly in high altitudes where the concentration of oxygen is low. How did birds evolve a respiratory system that is so unique?

Decades of research by paleontologists have shown that birds evolved from theropods, meat-eating dinosaurs (shown below). In fact, fossil evidence shows that meat-eating dinosaurs that lived more than 100 million years ago had a similar flow-through respiratory system with lungs and air sacs. *Archaeopteryx* and *Xiaotingia*, for example, were flying dinosaurs and are believed to be early precursors of birds.

{{< mediafigure src="biology/Figure_39.14" kind="diagram" eager="true" alt="Illustration compares a dinosaur and a bird. Both have anterior air sacs in front of the lungs, and posterior air sacs behind them. The air sacs connect to hollow openings in bones." longdesc="A dinosaur skeleton (left) and a bird skeleton (right) are drawn in matching silhouette, each with its respiratory soft tissue layered over the bones in the same color code: teal-blue for the anterior air sacs at the base of the neck and front of the chest, purple for the lung in the chest, and green for the posterior air sacs just behind the lung, over the hips. On each skeleton, a band shaded from red at its rear end (below the posterior air sacs, near the hips) through orange to yellow runs forward through the body and out the open mouth, where a white arrow labeled 'Exhalation pathway' (printed once, on the dinosaur) marks the direction of outgoing air; the bird carries the same band and arrow, unlabeled. A caption at the top, 'Bones showing signs of connection to air sac tissue,' branches into four lines, two down to the dinosaur and two down to the bird; each line ends at a small yellow dot — one over the base of the neck within the teal-blue anterior air sacs and one over the hip region within the green posterior air sacs, on each animal — marking the fossil bones that show the same air-sac connections in both." >}}
Dinosaurs, from which birds descended, have similar hollow bones and are believed to have had a similar respiratory system. (credit: modification of work by Zina Deretsky, National Science Foundation)
{{< /mediafigure >}}
...
Boyle's Law is the gas law that states that in a closed space, pressure and volume are inversely related. As volume decreases, pressure increases and vice versa (shown below). The relationship between gas pressure and volume helps to explain the mechanics of breathing.

{{< mediafigure src="biology/Figure_39_03_02" kind="diagram" alt="In this graph, pressure is plotted against volume. The line curves downward from a state of high pressure and low volume, steeply at first, then more gradually and levels off at a state of low pressure and high volume." longdesc="The vertical axis, labeled Pressure, runs from 20 to 120 in steps of 20; the horizontal axis, labeled Volume, runs from 10 to 50 in steps of 5. Twenty-five connected data points trace a single curve beginning at about pressure 118 and volume 12, dropping steeply through the first several points, then leveling off more and more gradually as volume increases, ending at about pressure 29 and volume 48 — one smooth inverse curve throughout, with no straight segments or breaks." >}}
...
There is always a slightly negative pressure within the thoracic cavity, which aids in keeping the airways of the lungs open. During inhalation, volume increases as a result of contraction of the diaphragm, and pressure decreases (according to Boyle's Law). This decrease of pressure in the thoracic cavity relative to the environment makes the cavity less than the atmosphere (shown below, part a). Because of this drop in pressure, air rushes into the respiratory passages. To increase the volume of the lungs, the chest wall expands. This results from the contraction of the **intercostal muscles**, the muscles that are connected to the rib cage. Lung volume expands because the diaphragm contracts and the intercostal muscles contract, thus expanding the thoracic cavity. This increase in the volume of the thoracic cavity lowers pressure compared to the atmosphere, so air rushes into the lungs, thus increasing its volume. The resulting increase in volume is largely attributed to an increase in alveolar space, because the bronchioles and bronchi are stiff structures that do not change in size.

{{< mediafigure src="biology/Figure_39_03_03" kind="diagram" alt="Part a shows expanded lungs with alveoli filled with air during inhalation. The diaphragm is pulled downward, and the muscles of the chest wall are pulled outward. Part b shows collapsed lungs during expiration. The diaphragm is pushed upward, and the chest cavity muscles are pushed inward." longdesc="Two panels, each pairing a torso outline with a matching illustration of the lungs and airway. Panel (a), labeled Inhalation: a light blue circled plus sign sits just outside the nose and mouth with a small light blue arrow pointing from it into the mouth (air drawn in), and a light blue circled minus sign sits inside the blue-shaded chest cavity (pressure lower than outside); two orange arrows point from the torso toward the lung illustration, and a large orange arrow beneath the torso points downward, showing the diaphragm pulled down. The paired lung illustration shows both lungs fully expanded, their blue-outlined bronchial branches visible throughout, with the diaphragm pulled low beneath them. Panel (b), labeled Expiration: a light blue circled minus sign sits outside the nose and mouth, and a light blue circled plus sign with a small upward arrow sits inside the chest cavity, and the blue shading now fills the whole airway from the chest up through the throat to the nose and mouth (air pushed out); two orange arrows point from the lung illustration back toward the torso, and a large orange arrow beneath the torso points upward, showing the diaphragm pushed up. The paired lung illustration shows both lungs smaller and darker, their bronchial branching less visible, with the diaphragm domed higher beneath them." >}}
...
The chest wall expands out and away from the lungs. The lungs are elastic; therefore, when air fills the lungs, the **elastic recoil** within the tissues of the lung exerts pressure back toward the interior of the lungs. These outward and inward forces compete to inflate and deflate the lung with every breath. Upon exhalation, the lungs recoil to force the air out of the lungs, and the intercostal muscles relax, returning the chest wall back to its original position (shown above, part b). The diaphragm also relaxes and moves higher into the thoracic cavity. This increases the pressure within the thoracic cavity relative to the environment, and air rushes out of the lungs. The movement of air out of the lungs is a passive event. No muscles are contracting to expel the air.

Each lung is surrounded by an invaginated sac. The layer of tissue that covers the lung and dips into spaces is called the visceral **pleura**. A second layer of parietal pleura lines the interior of the thorax (shown below). The space between these layers, the **intrapleural space**, contains a small amount of fluid that protects the tissue and reduces the friction generated from rubbing the tissue layers together as the lungs contract and relax. **Pleurisy** results when these layers of tissue become inflamed; it is painful because the inflammation increases the pressure within the thoracic cavity and reduces the volume of the lung.

{{< mediafigure src="biology/Figure_B39_03_04" kind="diagram" alt="The illustration shows human lungs. Each lung is covered by an inner visceral pleura and an outer parietal pleura. The intrapleural space is the space between the two membranes." longdesc="A silhouette of a person's head, neck, and upper torso, turned to face right, with the chest opened to reveal the trachea branching into the two main bronchi and both lungs. The right lung (on the viewer's left) is shown as a shaded cross-section with its internal branching visible; three labels point to it in order from outside in. 'Parietal pleura' points to the outermost line around the lung, 'Visceral pleura' points to a second line just inside it hugging the lung's surface, and 'Intrapleural space' points to the thin gap between those two lines, partway down the lung's outer edge (roughly two-fifths of the way from its apex to its base, well above the lower edge). The left lung (on the viewer's right) is shown as a solid, unlabeled shape with its lobes outlined, alongside the branching trachea and bronchi between the two lungs." >}}
A tissue layer called pleura surrounds the lung and interior of the thoracic cavity. (credit: modification of work by NCI)
{{< /mediafigure >}}

{{< callout type="info" >}}
**Link to Learning**

View how Boyle's Law is related to breathing, and watch [a video on Boyle's Law](https://www.openstax.org/l/boyles_law).
{{< /callout >}}
...
Examples of **restrictive diseases** are respiratory distress syndrome and pulmonary fibrosis. In both diseases, the airways are less compliant and they are stiff or fibrotic. There is a decrease in compliance because the lung tissue cannot bend and move. In these types of restrictive diseases, the intrapleural pressure is more positive and the airways collapse upon exhalation, which traps air in the lungs. Forced or **functional vital capacity (FVC)**, which is the amount of air that can be forcibly exhaled after taking the deepest breath possible, is much lower than in normal patients, and the time it takes to exhale most of the air is greatly prolonged (shown below). A patient suffering from these diseases cannot exhale the normal amount of air.

**Obstructive diseases** and conditions include emphysema, asthma, and pulmonary edema. In emphysema, which mostly arises from smoking tobacco, the walls of the alveoli are destroyed, decreasing the surface area for gas exchange. The overall compliance of the lungs is increased, because as the alveolar walls are damaged, lung elastic recoil decreases due to a loss of elastic fibers, and more air is trapped in the lungs at the end of exhalation. Asthma is a disease in which inflammation is triggered by environmental factors. Inflammation obstructs the airways. The obstruction may be due to edema (fluid accumulation), smooth muscle spasms in the walls of the bronchioles, increased mucus secretion, damage to the epithelia of the airways, or a combination of these events. Those with asthma or edema experience increased occlusion from increased inflammation of the airways. This tends to block the airways, preventing the proper movement of gases (shown below). Those with obstructive diseases have large volumes of air trapped after exhalation and breathe at a very high lung volume to compensate for the lack of airway recruitment.

{{< mediafigure src="biology/Figure_39_03_05f" kind="diagram" alt="A line graph titled FEV1/FVC Ratio plots volume exhaled on the vertical axis against time in seconds on the horizontal axis. Three curves rise from the origin: a steep red curve for normal lungs reaches the highest plateau quickly, a shallower orange curve for restrictive diseases levels off later at a lower plateau, and a still shallower blue curve for obstructive diseases rises slowly to the lowest plateau. A dotted vertical line marks one second, where each curve's FEV1 value is read; a dot near each curve's plateau marks its FVC value." longdesc="The vertical axis is labeled Volume exhaled and the horizontal axis is labeled Time (seconds); a dotted vertical line rises from a label reading '1 second' near the bottom. Three curves are drawn, top to bottom. A red curve labeled 'Normal lungs' rises steeply and plateaus a short way past the one-second line; its gray dot labeled FEV1 on the one-second line sits close beneath its black dot labeled FVC, which marks the start of its plateau — the FEV1 dot at about nine-tenths of the FVC height. An orange curve labeled 'Restrictive diseases' rises less steeply and levels off at a lower plateau about three-quarters of the way across the graph, where its FVC dot sits; its FEV1 dot on the one-second line is at about three-quarters of that FVC height. A blue curve labeled 'Obstructive diseases' rises much more gradually to the lowest plateau, with its FEV1 dot on the one-second line at only about half the height of its own FVC dot, which is reached near the right end of the graph — the two dots far apart." >}}
...
Watch [an animation of the mechanics of breathing](https://www.openstax.org/l/breathing).
{{< /callout >}}
...
{{< multiplechoice
  ...
  answer="It would prevent inhalation because the intrapleural pressure would not change."
  hint="Reread the paragraph in The Mechanics of Human Breathing that describes what the diaphragm's contraction does during inhalation."
>}}
...
{{< multiplechoice
  ...
  answer="both a and c"
  hint="Check each option against the paragraph on respiratory rate and alveolar ventilation in The Work of Breathing."
>}}
...
the intrapleural pressure must be negative for the lung to function properly
this negative pressure is caused by the contraction of the diaphragm pulling the lungs down and drawing air into the lungs
{{< /selfcheck >}}
...
the intrapleural pressure would be less negative

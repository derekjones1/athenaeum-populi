...
description: >-
  How animals exchange oxygen and carbon dioxide with their environment —
  from direct diffusion in single cells through gills and tracheal systems to
  the branching human airway from nasal cavity to alveoli — and the
  protective mechanisms that keep particulate matter out of the lungs —
  adapted from OpenStax Biology 2e, Section 39.1.
source_section: "39.1"
weight: 1
---
...
{{< mediafigure src="biology/Figure_39_01_01" kind="photo" eager="true" alt="The photo shows a round, green, balloon-like cell with a smooth, shiny surface, photographed underwater among coral." >}}
...
{{< mediafigure src="biology/Figure_39_01_02" kind="photo" alt="The photo shows a black, ribbon-like flatworm covered in white spots, resting on light-colored sand." >}}
...
{{< mediafigure src="biology/Figure_39_01_03" kind="photo" alt="The photo shows a hand holding a golden carp with a wedge of skin behind the head cut away, revealing bright red gills." >}}
...
{{< mediafigure src="biology/Figure_B39_01_04" kind="diagram" alt="A labeled illustration traces a fish's gill anatomy from a boxed region behind its head to a close-up of the comb-like gill filaments on a gill arch, then to a further close-up of the feathery lamellae, where arrows show oxygen-rich and oxygen-poor blood flowing opposite the direction of water flow." longdesc="At upper left, a small fish icon has a black box outlining the gill region just behind its head, with a gray arrow leading down to a close-up of one gill. That close-up is labeled Gill arch (the central structure the gill attaches to), Blood vessels (the red and blue lines running along the arch), and Gill filaments (the row of comb-like projections extending from the arch), with small blue arrows showing water flowing down and out between the filaments. A second gray arrow leads right to a further close-up of the lamellae: stacked, feather-like structures labeled Lamella, with an arrow labeled Oxygen-rich blood leaving toward the fish's body and an arrow labeled Oxygen-poor blood entering from the body, while several arrows labeled Water flow pass over the lamellae from the opposite direction." >}}
...
{{< mediafigure src="biology/Figure_39_01_05" kind="diagram" alt="A cutaway side view of a bee shows its internal tracheal system as a blue main tube running the length of the body with short branches ending in rounded tips, alongside separate red and purple vessels and a green organ, with the rounded tips of two branches near the rear of the body labeled as openings." longdesc="One leader line from the label Tracheal system points to the network of eight vertical tubes branching from a main tube that runs along the top of the body from front to back. Two leader lines from the label Spiracles point to the rounded tips of two of these eight branches, the second and third from the rear, in the striped hind part of the body; the art draws each spiracle as the rounded end of a branch, midway down the body's side rather than on its lower wall." >}}
...
{{< mediafigure src="biology/Figure_B39_01_06" kind="diagram" alt="A labeled cutaway of the human chest shows the airway branching from the nasal cavity and pharynx through the larynx, trachea, bronchi, and bronchioles into the lungs, with an inset magnifying a terminal bronchiole into an alveolar duct, alveolar sac, and a single alveolus wrapped in capillaries." longdesc="The upper drawing is a chest cutaway. On its right side, one leader line each labels Nasal cavity, Pharynx, Larynx, Trachea, and Diaphragm, top to bottom. On its left side, one leader line each labels Primary bronchus, Secondary bronchus, Tertiary bronchus, Bronchiole, and Terminal bronchiole, also top to bottom, tracing the airway from where the trachea first forks down to its finest branches. A gray arrow leads from the boxed terminal bronchiole down to the left of two insets below. The left inset labels Pulmonary vein and Pulmonary artery on the vessels running alongside an Alveolar duct, which opens into grape-like clusters drawn twice: an outside view labeled Alveolar sac, and a cut-open view of individual units labeled Alveolus (the Alveolus label has a second leader line reaching into the right inset). A second gray arrow leads from the cut-open cluster to the right inset, a single alveolus wrapped in a network labeled Capillary, where a curved arrow under O₂ points down from the alveolus into its capillary-covered wall and a curved arrow under CO₂ points up from the wall into the alveolus." >}}
...
{{< multiplechoice
  question="Which of the following statements about the mammalian respiratory system is false?"
  answer="The bronchioles branch into bronchi."
  hint="Check each statement against the labels of the figure just above and its inset."
>}}
...
{{< mediafigure src="biology/Figure_39_01_07" kind="diagram" alt="The illustration shows the trachea, or windpipe, with the larynx as a wide collar at its top. At the bottom, the trachea bifurcates into the primary bronchi, which enter the right and left lungs; inside each lung, the bronchi branch further into secondary and tertiary bronchi, then into bronchioles." longdesc="Reading top to bottom: one leader line labels Larynx, the wide structure capping the tube; one leader line labels Trachea, the central ringed tube below it. Where the trachea forks, two leader lines from the label Primary bronchi point to the first branch on each side, one into each bronchial tree (no lungs are drawn around the trees). Two leader lines from Tertiary bronchi point to finer branch points, both within the tree on the viewer's left. Two leader lines from Secondary bronchi point to two branch points between the primary and tertiary branches, also both within the tree on the viewer's left. One leader line from Bronchiole points to the finest, thread-like branch at the far left of that tree." >}}
...
{{< mediafigure src="biology/Figure_B39_01_08" kind="diagram" alt="A body outline shows the trachea descending into the right lung, made of three lobes, and the smaller left lung, made of two lobes, with the diaphragm domed beneath both." longdesc="One leader line labels Trachea, the ringed tube descending from the neck. On the body's right side, the bold label Right lung introduces three leader lines labeling Upper lobe, Middle lobe, and Lower lobe, top to bottom. On the body's left side, the bold label Left lung introduces two leader lines labeling Upper lobe and Lower lobe. A leader line from the bold label Diaphragm points to the dome-shaped structure beneath both lungs." >}}
...
{{< mediafigure src="biology/Figure_39_01_09" kind="diagram" alt="A single respiratory bronchiole leads through an alveolar duct into a grape-like cluster of alveoli labeled the alveolar sac; a matching cluster is shown in cutaway alongside it, revealing the open atrium at its center and a network of capillaries wrapping each alveolus." longdesc="On the left, a bracket labeled Alveolar sac spans the pink, grape-like cluster of sacs. Below it, one leader line each labels Alveolar duct (the pink tube leading into the cluster, alongside the red and blue vessels), Mucous gland (small orange shapes at its base), Respiratory bronchiole (the green tube at the very base), Pulmonary vein, and Pulmonary artery (the red and blue vessels running alongside the duct). On the right, a second branch of the same tube feeds a matching cluster whose lower front is cut away: one leader line labels Capillaries, the purple network covering its surface; one leader line labels Atrium, the open central airspace; and one leader line labels Alveolus, one of the individual grape-like sacs opening into that airspace. Pale curved arrows in the cutaway run from the atrium out into the surrounding alveoli, showing air spreading into them." >}}
...
Watch [an animation reviewing the respiratory system](https://www.openstax.org/l/lungs_pulmonary).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_39_01_10" kind="photo" alt="In this electron micrograph, cilia appear as a dense field of long, thin, hair-like projections covering a surface, with a 2 µm scale bar in the lower right." >}}
...
{{< multiplechoice
  ...
  hint="Reread the section's opening paragraph on what the respiratory system does."
>}}
...
{{< multiplechoice
  ...
  answer="nasal cavity, larynx, trachea, bronchi, bronchioles, alveoli"
  hint="Follow the labels of the respiratory-system figure in the Mammalian Systems section, from the nasal cavity down into the lungs."
>}}
...
the main bronchus attaches the lungs to the end of the trachea, where it bifurcates
the trachea is the cartilaginous structure that extends from the pharynx to the primary bronchi
the alveoli are the sites of gas exchange, located at the terminal regions of the lung, attached to the respiratory bronchioles
...
the alveoli are made of thin-walled parenchymal cells
...
{{< multiplechoice
  ...
  answer="prevent damage to the lungs"
  hint="Reread the opening paragraph of Mammalian Systems on what happens to air in the nasal cavity."
>}}
ward off infection

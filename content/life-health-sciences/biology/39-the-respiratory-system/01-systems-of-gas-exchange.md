...
{{< mediafigure src="biology/Figure_39_01_05" kind="diagram" alt="A cutaway side view of a bee shows its internal tracheal system as a network of red, blue, purple, and green tubes running the length of the body, with two small openings labeled along the lower body wall." longdesc="One leader line from the label Tracheal system points to the network of vertical tubes branching from a main tube that runs along the top of the body from front to back. Two leader lines from the label Spiracles point to two of the small openings along the lower body wall, in the thorax and abdomen, where the tracheal tubes originate." >}}

...
{{< multiplechoice
  ...
  hint="Trace the airway in the order it's drawn — from the nasal cavity through the pharynx, larynx, and trachea, into the bronchi, and on to the bronchioles and alveolar ducts — and check whether each statement matches that branching direction."
>}}
...
{{< multiplechoice
  ...
  hint="The first paragraph says the system delivers one gas to the tissues and removes a different one as waste — which of the four options names only the delivered gas?"
>}}
...
{{< multiplechoice
  ...
  hint="The nasal cavity leads to the throat and voice box before air ever reaches the windpipe — check where the larynx falls relative to the trachea in each option."
>}}
...
{{< multiplechoice
  ...
  hint="The text calls warming, humidifying, and particle removal together by one protective name — think about what that name implies these processes guard against, rather than what they cause."
>}}
ward off infection
...
{{< textin
  question="The complex glycoprotein found in mucus is called ________."
  answer="mucin"
  hint="Along with salts and water, this glycoprotein is one of the components that makes the lung's protective secretion sticky."
>}}

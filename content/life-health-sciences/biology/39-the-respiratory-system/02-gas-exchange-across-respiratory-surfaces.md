...
{{< multiplechoice
  ...
  hint="Trace where blood goes right after it leaves the body tissues in the figure — does it return to the heart first, or does it skip straight to the lungs?"
>}}
...
{{< multiplechoice
  ...
  hint="This is the reserve volume on the inhaling side of a normal breath — one option describes its counterpart on the exhaling side, and the other two describe a capacity and a volume this section defines differently."
>}}
...
{{< multiplechoice
  ...
  hint="Total lung capacity is the sum of every one of the four lung volumes this section names — count how many terms each option adds together."
>}}
...
{{< selfcheck question="If a patient has increased resistance in their lungs, how can this be detected by a doctor? What does this mean?" hint="This section ties a low FEV1/FVC ratio to one specific named lung condition — think about which one involves the airways being harder to move air out of, rather than the lung tissue itself being stiff." >}}

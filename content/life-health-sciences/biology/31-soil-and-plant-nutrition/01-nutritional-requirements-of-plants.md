...
description: >-
  How plants obtain water, carbon dioxide, and mineral nutrients, and the
  macronutrients and micronutrients a plant needs to complete its life cycle
  — adapted from OpenStax Biology 2e, Section 31.1.
source_section: "31.1"
weight: 1
---
...
{{< mediafigure src="biology/Figure_31_01_01" kind="diagram" eager="true" alt="A schematic root tip, its lower portion bare and its upper portion covered with fine hairs; a cross-section near the top shows a central web of xylem tissue with four oval phloem patches around its periphery, and lines point from the labels Xylem, Phloem, and Root hairs to their respective structures." >}}
...
he thought plant growth and increased weight resulted from the intake of water
that conclusion has since been disproven
{{< /selfcheck >}}
...
{{< selfcheck question="List two essential macronutrients and two essential micronutrients." hint="The essential-elements table above sorts all twenty into these two columns." >}}
...
===CHECKS===
essential macronutrients include carbon, hydrogen, oxygen, nitrogen, phosphorus, potassium, calcium, magnesium, and sulfur
...
{"bins": ["Macronutrients", "Micronutrients"],
 "items": [
  {"label": "Carbon (C)", "bin": 0},
  {"label": "Iron (Fe)", "bin": 1},
  {"label": "Nitrogen (N)", "bin": 0},
  {"label": "Manganese (Mn)", "bin": 1},
  {"label": "Phosphorus (P)", "bin": 0},
  {"label": "Boron (B)", "bin": 1},
  {"label": "Potassium (K)", "bin": 0},
  {"label": "Zinc (Zn)", "bin": 1},
  {"label": "Calcium (Ca)", "bin": 0},
  {"label": "Chlorine (Cl)", "bin": 1},
  {"label": "Magnesium (Mg)", "bin": 0},
  {"label": "Sodium (Na)", "bin": 1}]}
{{< /sortbins >}}

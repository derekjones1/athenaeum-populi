...
title: The Soil
description: >-
  How soil forms from parent material, climate, topography, biological
  factors, and time, its mineral and organic composition, and the O, A, B,
  and C horizons of a mature soil profile — adapted from OpenStax Biology
  2e, Section 31.2.
source_section: "31.2"
weight: 2
---
...
{{< mediafigure src="biology/Figure_31_02_01" kind="diagram" eager="true" alt="A pie chart divided into four wedges: inorganic mineral matter, the largest wedge, at 45 percent; water and air as two equal adjacent wedges, each 25 percent and bracketed together with a shared 50 percent label; and organic matter (microorganisms and macroorganisms), a thin sliver, at 5 percent." longdesc="Reading clockwise from the largest wedge: inorganic mineral matter fills nearly half the pie, labeled 45%. Beside it, a thin sliver labeled 'Organic matter (microorganisms and macroorganisms) 5%' sits at the boundary with the next wedge. The pie's other half is split evenly into two equal wedges, 'Water 25%' on the left and 'Air 25%' on the right; a bracket joins these two wedges beneath the pie and is labeled 50%." >}}
...
{{< callout type="info" >}}
**Link to Learning.** Explore [an interactive map of soil data from the USDA's National Cooperative Soil Survey](https://openstax.org/l/soil_survey_map) for almost any region in the United States.
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_31_02_04" kind="photo" alt="Photo shows a man standing next to a wall of soil in a pit that is as deep as he is tall, a numbered depth stick propped against the wall beside him." >}}
...
{{< selfcheck question="Name and briefly explain the factors that affect soil formation." hint="Five factors are named together in the Soil Formation section's second paragraph, each given its own subsection afterward." >}}
...
===CHECKS===
parent material, climate, topography, biological factors, and time affect soil formation
parent material is the material in which soils form
climate describes how temperature, moisture, and wind cause different patterns of weathering
topography affects the characteristics and fertility of a soil
biological factors include the presence of living organisms that greatly affect soil formation
...
strips away parent material and affects plant growth
steep soils are more prone to erosion
...
an organic soil is formed from sedimentation
it mostly consists of humus
{{< /selfcheck >}}

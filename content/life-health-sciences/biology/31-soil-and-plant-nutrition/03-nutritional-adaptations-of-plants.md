...
description: >-
  How plants beyond ordinary photosynthesis and root uptake acquire scarce
  nutrients — nitrogen fixation through rhizobial root nodules, mycorrhizal
  partnerships with fungi, and the parasitic, saprophytic, symbiotic,
  epiphytic, and insectivorous strategies some plants use instead — adapted
  from OpenStax Biology 2e, Section 31.3.
source_section: "31.3"
weight: 3
---
...
This [video reviewing basic concepts about photosynthesis](https://openstax.org/l/basic_photosyn) lets you click each tab in the left panel to select a topic for review.
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_31_03_01abc" kind="photo" eager="true" alt="Three side-by-side photos of shelled legumes: (a) a white bowl of peanuts, some still in reddish-brown skins, (b) a mass of glossy dark-red kidney beans filling the frame, and (c) a clear plastic bag of pale, bumpy chickpeas." >}}
...
the belowground nitrogen can be used in the next season by the corn
{{< /selfcheck >}}
...
{{< mediafigure src="biology/Figure_31_03_02ab" kind="photo" alt="Two side-by-side photos: (a) a tangle of long, thin yellow-orange legume roots against a dark background, with several bulbous nodules along the roots labeled 'Nitrogen-fixing nodules,' and (b) a black-and-white transmission electron micrograph of a nodule cell cross section showing several oval, dark-rimmed vesicles labeled 'Rhizobia inside vesicles,' scattered unevenly across the gray cell interior." >}}
Soybean roots contain (a) nitrogen-fixing nodules. Cells within the nodules are infected with *Bradyrhizobium japonicum*, a rhizobia or "root-loving" bacterium. The bacteria are encased in (b) vesicles inside the cell, as can be seen in this transmission electron micrograph. (credit a: modification of work by USDA; credit b: modification of work by Louisa Howard, Dartmouth Electron Microscope Facility; scale-bar data from Matt Russell)
{{< /mediafigure >}}
...
{{< mediafigure src="biology/Figure_31_03_03" kind="photo" alt="A close-up photo of a cluster of pale, branching root tips coated in a fuzzy off-white mycorrhizal fungus, several rounded, swollen tips visible against a blurred green-gray background." >}}
...
{{< mediafigure src="biology/Figure_31_03_04" kind="photo" alt="A close-up photo of a beige, thread-like dodder vine wound around the green leafy stems of its host plant, with several clusters of small white flowers and green flower buds where the vine tangles over the host's leaves." >}}
...
{{< mediafigure src="biology/Figure_31_03_05" kind="photo" alt="A close-up photo of a saprophytic plant with several fleshy, translucent pink stems rising from leaf litter, each stem topped with a cluster of drooping, bell-shaped pink flowers, set against a dark forest background." >}}
Saprophytes, like this Dutchmen’s pipe (*Monotropa hypopitys*), obtain their food from dead matter and do not have chlorophyll. (credit: modification of work by Iwona Erskine-Kellie)
{{< /mediafigure >}}
...
{{< mediafigure src="biology/Figure_31_03_06" kind="photo" alt="An upward-looking photo of a tall pine trunk against a blue sky, its bark thickly clustered with bright yellow-green lichen, with two more conifers rising in the background." >}}
Lichens, covered in *Ecology of Fungi*, which often have symbiotic relationships with other plants, can sometimes be found growing on trees. (credit: "benketaro"/Flickr)
{{< /mediafigure >}}
...
{{< mediafigure src="biology/Figure_31_03_07" kind="photo" alt="A photo inside a greenhouse showing a tree trunk almost completely obscured by a dense mass of epiphytes — trailing gray-green tillandsias, fanning ferns, and broad-leaved bromeliads — layered over its bark and hanging down toward the ferns and philodendrons below." >}}
...
{{< mediafigure src="biology/Figure_31_03_08" kind="photo" alt="A close-up photo of several yellow-green Venus flytrap leaves, their hinged lobes fringed with long, interlocking white spines, some open and some closed, with reddish coloring visible inside the open traps." >}}
...
nitrogen fixation allows the plant to obtain nitrogen from the air
{{< /selfcheck >}}

...
title: Lipids
description: >-
  Fats, oils, waxes, phospholipids, and steroids: how saturated, unsaturated,
  and trans fatty acids differ, how phospholipids build the plasma membrane,
  and how cholesterol helps keep it fluid — adapted from OpenStax Biology 2e,
  Section 3.3.
source_section: "3.3"
weight: 3
---
...
{{< mediafigure src="biology/Figure_03_03_05-ff6c" alt="A structural-formula comparison of stearic acid, a saturated fatty acid, with cis and trans oleic acid, two unsaturated fatty acids that share the same double bond but differ in the arrangement of the hydrogens across it." longdesc="Three stacked structural formulas. Top, labeled Saturated fatty acid — Stearic acid: a straight seventeen-carbon chain joined entirely by single bonds, ending in a carboxyl group. Middle, labeled Unsaturated fatty acids — Cis oleic acid: the same seventeen-carbon chain with one double bond, drawn with both hydrogens on the double-bonded carbons, highlighted, on the same side, which bends the chain into a sharp angle at that point. Bottom, labeled Trans oleic acid: the same double bond, but with the two highlighted hydrogens on opposite sides of the chain, so the chain stays straight like the saturated fatty acid." kind="diagram" >}}
...
**Wax** covers some aquatic birds' feathers and some plants' leaf surfaces. Because of waxes' hydrophobic nature, they prevent water from sticking on the surface (below). Long fatty acid chains esterified to long-chain alcohols comprise waxes.

{{< mediafigure src="biology/Figure_03_03_11" alt="Glossy, thick green leaves on a plant, their waxy surface reflecting bright sunlight." kind="photo" >}}
...
The head is the hydrophilic part, and the tail contains the hydrophobic fatty acids. In a membrane, a bilayer of phospholipids forms the structure's matrix, phospholipids' fatty acid tails face inside, away from water; whereas, the phosphate group faces the outside, aqueous side (above).

Phospholipids are responsible for the plasma membrane's dynamic nature. If a drop of phospholipids is placed in water, it spontaneously forms a structure that scientists call a micelle, where the hydrophilic phosphate heads face the outside and the fatty acids face the structure's interior. *(Source note: a phospholipid, with two fatty acid tails, does not usually pack into a micelle; in water it forms a bilayer, which can close into a hollow sphere called a liposome, as section 5.1 describes. Micelles form from single-tailed molecules such as fatty acids and detergents.)*
...
{{< callout type="info" >}}
**Link to Learning.** For an additional perspective on lipids, watch [this video about types of fat](https://openstax.org/l/lipids).
{{< /callout >}}

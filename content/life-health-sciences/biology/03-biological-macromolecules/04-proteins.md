...
title: Proteins
description: >-
  The types and functions of proteins, the structure of amino acids and how
  they link into polypeptides, and the four levels of protein structure from
  a linear amino acid sequence to a multi-subunit assembly — adapted from
  OpenStax Biology 2e, Section 3.4.
source_section: "3.4"
weight: 4
---
...
{{< mediafigure src="biology/Figure_03_04_01" kind="diagram" alt="An amino acid's basic structure: a central alpha carbon bonded to an amino group, a carboxyl group, a hydrogen atom, and a variable side chain, the R group." eager="true" >}}
...
{{< mediafigure src="biology/Figure_03_04_03" kind="diagram" alt="The formation of a peptide bond between two amino acids. When the peptide bond forms, the carbon from the carbonyl group becomes attached to the nitrogen from the amino group, and the OH from the carboxyl group and an H from the amino group form a molecule of water." >}}
...
{{< callout type="info" >}}
**Link to Learning.** Click through the steps of protein synthesis in this [interactive tutorial](https://openstax.org/l/protein_synth).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_03_04_06" kind="photo" alt="A bright-field light micrograph of red blood cells from a patient with sickle cell anemia. Most of the cells have a normal, disk shape, but about one in five has a sickle shape. A normal blood cell is eight microns across." >}}
...
{{< mediafigure src="biology/Figure_03_04_09-fda7" kind="diagram" alt="The four levels of protein structure: primary structure is the amino acid sequence, secondary structure is a regular folding pattern from hydrogen bonding, tertiary structure is the three-dimensional folding of the protein from interactions between amino acid side chains, and quaternary structure is the interaction of two or more polypeptide chains." longdesc="Four panels, left to right, tracing one protein from its sequence to its final assembly. Primary structure: four generic amino acids, labeled Amino Acid 1 through 4, each drawn as its own backbone unit with an R group, joined in a vertical chain by peptide bonds. Secondary structure: the same backbone drawn as a coiled alpha-helix ribbon with ball-and-stick atoms. Tertiary structure: the helix folds into a single compact beta-globin polypeptide, drawn as a folded purple ribbon. Quaternary structure: four folded polypeptides — two beta-globin chains, one purple (upper left) and one light blue (lower right), and two alpha-globin chains, one yellow (upper right) and one green (lower left) — pack together to form the complete hemoglobin molecule; a heme group is drawn as a small disk on the purple chain and another on the light blue chain." >}}
...
{{< callout type="info" >}}
**Link to Learning.** For an additional perspective on proteins, view [this animation](https://openstax.org/l/proteins) called "Biomolecules: The Proteins."
{{< /callout >}}

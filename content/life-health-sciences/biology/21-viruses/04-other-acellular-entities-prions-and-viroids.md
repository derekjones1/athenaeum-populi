...
description: >-
  Prions are infectious, misfolded proteins that cause fatal diseases such as
  mad cow disease and Creutzfeldt-Jakob disease without any DNA or RNA of
  their own, while viroids are small circular RNA plant pathogens that damage
  crops without producing any protein — adapted from OpenStax Biology 2e,
  Section 21.4.
source_section: "21.4"
weight: 4
---
...
{{< mediafigure src="biology/Figure_21_04_02" kind="photo" alt="The photo shows shriveled, cracked potatoes." >}}
...
{{< mediafigure src="biology/Figure_21_04_03" kind="photo" alt="This photo shows a scientist in a field, measuring the length of an egg." >}}
...
- **PrP<sup>c</sup>** — normal prion protein
- **PrP<sup>sc</sup>** — infectious form of a prion protein
...
{{< selfcheck question="Prions are responsible for variant Creutzfeldt-Jakob Disease, which has resulted in over 100 human deaths in Great Britain during the last 10 years. How do humans contract this disease?" hint="Re-read the paragraph on how BSE crossed from cattle to humans." >}}
This prion-based disease is transmitted through human consumption of infected meat.
===CHECKS===
transmitted through human consumption
...
confirm that an RNA molecule is the etiological agent of disease
the RNA can infect plant cells without a capsid
the RNA replicates

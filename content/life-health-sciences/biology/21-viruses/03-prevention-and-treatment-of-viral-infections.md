...
description: >-
  How vaccines and antiviral drugs prevent and treat viral infections, from
  live and killed vaccines to HIV combination therapy, and how viruses
  themselves are put to work against genetic disease, cancer, and bacterial
  infections — adapted from OpenStax Biology 2e, Section 21.3.
source_section: "21.3"
weight: 3
---
...
{{< mediafigure src="biology/Figure_21_03_02-607c" kind="photo" alt="A close-up photo of a person's upper arm as another person's hand, wearing a camouflage-patterned sleeve, gives them an injection with a syringe." >}}
Vaccinations are designed to boost immunity to a virus to prevent infection. (credit: Navy Medicine)
{{< /mediafigure >}}

{{< callout type="info" >}}
**Link to Learning.** Watch [a NOVA video](https://openstax.org/l/1918_flu) to learn how microbiologists are attempting to replicate the deadly 1918 Spanish influenza virus so they can understand more about virology.
{{< /callout >}}
...
{{< multiplechoice
  question="Vaccines ________."
  answer="stimulate an immune response"
  hint="Match this to the glossary definition of a vaccine."
>}}
...
routine vaccination of domestic animals makes it unlikely humans will contract rabies from an animal bite
...
Gardasil stimulates the immune system to prevent infection of the tissue
HPV is often asymptomatic, particularly in men
the vaccine also controls the spread of disease
{{< /selfcheck >}}

...
description: >-
  The body-plan and developmental traits scientists use to classify
  animals — symmetry, germ layers, the coelom, and the protostome/
  deuterostome split in early embryonic development — adapted from
  OpenStax Biology 2e, Section 27.2.
source_section: "27.2"
weight: 2
---
...
{{< mediafigure src="biology/Figure_B27_02_02abcd" kind="photo" alt="Five photographs: (a) a cluster of yellow-green, bumpy sponges on rock; (b) a jellyfish trailing long, thin tentacles from a translucent, disc-shaped bell; (c) a sea anemone with thick orange tentacles radiating from a cup-shaped body; (d) a black swallowtail butterfly with folded wings perched on flowers; (e) a translucent, ribbed ctenophore swimming with its mouth open against a dark background." >}}
...
{{< callout type="info" >}}
**Link to Learning.** Watch [a quick sketch of the different types of body symmetry](https://www.openstax.org/l/symmetry).
{{< /callout >}}
...
more skillful seeking of resources and escaping from predators
shock absorption for internal organs
greater body flexibility and more efficient movement
loose placement of organs allows spatial freedom for growth and arrangement

...
description: >-
  How multicellular animal life emerged during the Ediacaran and Cryogenian
  periods and then rapidly diversified in the Cambrian explosion, and how
  repeated mass extinctions have since reshaped the evolutionary history of
  the animal kingdom — adapted from OpenStax Biology 2e, Section 27.4.
source_section: "27.4"
weight: 4
---
...
Fossils believed to represent the oldest animals with hard body parts were recently discovered in South Australia. These sponge-like fossils, named *Coronacollina acula*, date back as far as 560 million years, and are believed to show the existence of hard body parts and spicules that extended 20–40 cm from the thimble-shaped body (estimated about 5 cm long). Other fossils from the Ediacaran period are shown below.

{{< mediafigure src="biology/Figure_B27_04_02ab" kind="photo" alt="Three photographs of Ediacaran-period fossils pressed into rock: (a) a round, wheel-like impression with spokes radiating from a raised central hub; (b) a broad, teardrop-shaped impression with fine ribs radiating from a central rib line; (c) a narrow, elongated impression with a segmented, feather-like ridge pattern." >}}
...
If the fossils of the Ediacaran and Cryogenian periods are enigmatic, those of the following Cambrian period are far less so, and include body forms similar to those living today. The Cambrian period, occurring between approximately 542–488 million years ago, marks the most rapid evolution of new animal phyla and animal diversity in Earth’s history. The rapid diversification of animals that appeared during this period, including most of the animal phyla in existence today, is often referred to as the **Cambrian explosion** (below). Animals resembling echinoderms, mollusks, worms, arthropods, and chordates arose during this period. What may have been a top predator of this period was an arthropod-like creature named *Anomalocaris*, over a meter long, with compound eyes and spiky tentacles. Obviously, all these Cambrian animals already exhibited complex structures, so their ancestors must have existed much earlier.

{{< mediafigure src="biology/Figure_27_04_03" kind="photo" alt="A full-color illustrated reconstruction of a Cambrian seafloor: a large winged, eye-stalked predator swims at upper left above segmented, crab-like arthropods walking on the sandy bottom among green tube- and cone-shaped sponges and worms." >}}
...
View [an animation of what ocean life may have been like during the Cambrian explosion](https://www.openstax.org/l/ocean_life).
{{< /callout >}}
...
ecological factors, such as competitive pressures and predator-prey relationships, reached a threshold that supported rapid evolution
{{< /selfcheck >}}
...
how the evolution of so many new animal species occurred in such a short period of time
whether Earth's atmosphere ever contained oxygen
{{< /multiplechoice >}}
...
the majority of animal species were commonly wiped out during these events
a small number of animal species representing each phylum were usually able to survive each extinction event

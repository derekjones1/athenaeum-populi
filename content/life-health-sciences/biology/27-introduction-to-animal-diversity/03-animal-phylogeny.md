...
description: >-
  How biologists build and revise the animal phylogenetic tree from
  morphological, fossil, and molecular evidence, and what recent molecular
  data have revealed about the relationships among the major animal clades —
  adapted from OpenStax Biology 2e, Section 27.3.
source_section: "27.3"
weight: 3
---
...
{{< mediafigure src="biology/Figure_27_03_01" kind="diagram" eager="true" alt="Three labeled illustrations in a row: a teal, egg-shaped choanoflagellate cell with a long flagellum and a purple nucleus; an orange sponge choanocyte cell of the same egg shape, flagellum, and nucleus color beside it; and a vase-shaped sponge cross-section at right, its wall marked with a small black square around one cell, joined to the choanocyte drawing by a wide gray arrow." >}}
...
Explore [an interactive tree of life](https://openstax.org/l/tree_of_life2) here. Zoom in and out and click to learn more about the organisms and their evolutionary relationships.
{{< /callout >}}
...
Watch [a video explaining how biologists use genetic data to determine relationships among organisms](https://openstax.org/l/build_phylogeny).
{{< /callout >}}

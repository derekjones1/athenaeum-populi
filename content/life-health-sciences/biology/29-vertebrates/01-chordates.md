...
title: Chordates
description: >-
  The five defining features of chordates — notochord, dorsal hollow nerve
  cord, pharyngeal slits, endostyle, and post-anal tail — and how the
  invertebrate lancelets and tunicates compare to the craniates and
  vertebrates that share them — adapted from OpenStax Biology 2e, Section
  29.1.
source_section: "29.1"
weight: 1
---
...
{{< callout type="info" >}}
**Link to Learning.** Watch [an interactive video discussing the evolution of chordates and the five characteristics they share](https://www.openstax.org/l/chordate_evol).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_29_01_04" kind="diagram" alt="A labeled illustration of a lancelet with its head protruding from the sand and the rest of its body buried, showing tentacles around the mouth, an internal digestive tract, pharyngeal slits opening into an atrium and atriopore, segmented body muscle, and a post-anal tail." longdesc="Reading head to tail: at the front, tentacles surround the mouth, bracketed together as the head. From the mouth, a digestive tract runs the length of the body. Alongside it, the pharyngeal slits open into a chamber labeled atrium, which empties through the atriopore. A dorsal hollow nerve cord and a notochord run above the digestive tract the length of the body. Segmented muscle blocks line the body wall. Toward the rear, the anus opens just before the body narrows into the post-anal tail, and the whole animal is shown with its head end protruding from a bed of sand while the rest of the body stays buried." >}}
...
{{< mediafigure src="biology/Figure_29_01_05" kind="diagram" alt="A grayscale illustration of a placoderm fish skull in profile, labeling the domed cranium at the top of the head and the toothed mandible forming the lower jaw." longdesc="A side-on skull illustration with two labels. 'Cranium' points to the domed upper portion of the skull enclosing the braincase. 'Mandible' points to the toothed lower jaw beneath it." >}}
...
{{< mediafigure src="biology/Figure_29_01_06" kind="photo" alt="A museum photograph of an articulated fish skeleton mounted on an orange platform against a blue backdrop, its vertebral column running from skull to tail." >}}

...
title: Birds
description: >-
  Feathers, pneumatic bones, air sacs, and the unidirectional lung that make
  flight possible, and the fossil and molecular evidence tracing birds to
  maniraptoran theropod dinosaurs — adapted from OpenStax Biology 2e,
  Section 29.5.
source_section: "29.5"
weight: 5
---
...
Feathers not only provide insulation, but also allow for flight, producing the lift and thrust necessary for flying birds to become and stay airborne. The feathers on a wing are *flexible*, so the feathers at the end of the wing separate as air moves over them, reducing the drag on the wing. Flight feathers are also asymmetrical and curved, so that air flowing over them generates lift. Two types of flight feathers are found on the wings, *primary feathers* and *secondary feathers* (pictured below). **Primary feathers** are located at the tip of the wing and provide thrust as the bird moves its wings downward, using the pectoralis major muscles. **Secondary feathers** are located closer to the body, in the forearm portion of the wing, and provide lift. In contrast to primary and secondary feathers, contour feathers are found on the body, where they help reduce form drag produced by wind resistance against the body during flight. They create a smooth, aerodynamic surface so that air moves swiftly over the bird's body, preventing turbulence and creating ideal aerodynamic conditions for efficient flight.

{{< mediafigure src="biology/Figure_B29_05_01" kind="diagram" eager="true" alt="A wing diagram (a) with primary feathers fanning back from the wing tip and secondary feathers set closer to the body, both pointed to by leader lines; beside it, a photograph (b) of two real flight feathers laid side by side, mottled brown and cream, the primary feather long and narrow and the secondary feather shorter and broader." >}}
Flight feathers. (a) Primary feathers are located at the wing tip and provide thrust; secondary feathers are located close to the body and provide lift. (b) Primary and secondary feathers from a common buzzard (*Buteo buteo*). (Credit b: Mod. from S. Seyfert [https://commons.wikimedia.org/w/index.php?curid=613813](https://openstax.org/l/buzzard_feathers))
{{< /mediafigure >}}
...
The respiratory system of birds is dramatically different from that of reptiles and mammals, and is well adapted for the high metabolic rate required for flight. To begin, the air spaces of pneumatic bone are sometimes connected to **air sacs** in the body cavity, which replace coelomic fluid and also lighten the body. These air sacs are also connected to the path of airflow through the bird's body, and function in respiration. Unlike mammalian lungs in which air flows in two directions, as it is breathed in and out, diluting the concentration of oxygen, airflow through bird lungs is unidirectional (pictured below). Gas exchange occurs in "air capillaries" or microscopic air passages within the lungs. The arrangement of air capillaries in the lungs creates a cross-current exchange system with the pulmonary blood. In a cross-current exchange system, the flow of air is perpendicular to the flow of blood, producing a favorable diffusion gradient and creating an efficient means of gas exchange. This very effective oxygen-delivery system of birds supports their higher metabolic activity. In effect, ventilation is provided by the **parabronchi** (minimally expandable lungs) with thin air sacs located among the visceral organs and the skeleton. A **syrinx** (voice box) resides near the junction of the trachea and bronchi. The syrinx, however, is *not* homologous to the mammalian larynx, which resides within the upper part of the trachea.

{{< mediafigure src="biology/Figure_29_05_03f" kind="diagram" alt="Two side-by-side bird outlines, each with a trachea, a ladder-shaped lung, a circular anterior air sac near the head, and a circular posterior air sac near the tail; a short tube joins each sac to the lung, and a longer tube runs from the trachea, beneath the lung, to the posterior air sac. Small arrows ring both sacs, and other arrows mark the trachea and the lung's connections." longdesc="Two bird outlines are drawn side by side. Each shows a Trachea running from the beak, a ladder-shaped structure labeled Lungs with several parallel rungs, a circular Anterior air sac near the head, and a circular Posterior air sac near the tail; the trachea forks partway along its length into a short branch that leads up into the anterior air sac and a longer, double-lined branch that continues past the lungs to the posterior air sac, and a separate short tube joins the top of the lung ladder to the anterior air sac. The left outline is labeled Inhalation: its trachea arrow points inward, toward the fork; the long branch's arrow points forward into the posterior air sac; an arrow inside the lung ladder points from the posterior side toward the anterior side, into the short tube leading up to the anterior air sac; and small arrows ring both air sacs pointing outward, showing them expanding as they fill. The right outline is labeled Exhalation: its trachea arrow now points outward, from the fork toward the beak; the short tube into the anterior air sac still shows its arrow pointing into the sac; an arrow beside the posterior air sac points from the sac into the lung ladder; and small arrows ring both air sacs pointing inward, showing them collapsing as they empty." >}}
Air flow in bird lungs. Avian respiration is an efficient system of gas exchange with air flowing *unidirectionally*. A full ventilation cycle takes two breathing cycles. During the first inhalation, air passes from the trachea into posterior air sacs. The first exhalation moves the air from the posterior air sacs to the lungs. The second inhalation moves the air in the lungs to the anterior air sacs, and the second exhalation moves the air in the anterior air sacs out of the body. Overall, each inhalation moves air into the air sacs, while each exhalation moves fresh air through the lungs and "used" air out of the body. The air sacs are connected to the hollow interior of bones. (credit: modification of work by L. Shyamal)
{{< /mediafigure >}}

Beyond the unique characteristics discussed above, birds are also unusual vertebrates because of a number of other features. First, they typically have an elongated (very "dinosaurian") S-shaped neck, but a short tail or *pygostyle*, produced from the fusion of the caudal vertebrae. Unlike mammals, birds have only one occipital condyle, allowing them extensive movement of the head and neck. They also have a very thin epidermis without sweat glands, and a specialized **uropygial gland** or sebaceous "preening gland" found at the dorsal base of the tail. This gland is essential to **preening** (a virtually continuous activity) in most birds because it produces an oily substance that birds use to help waterproof their feathers as well as keep them flexible for flight. A number of birds, such as pigeons, parrots, hawks, and owls, lack a uropygial gland but have specialized feathers that "disintegrate" into a powdery down, which serves the same purpose as the oils of the uropygial gland.
...
{{< callout type="info" >}}
**Link to Learning.** Watch [a video on when birds had teeth](https://www.openstax.org/r/BirdTeeth) to learn more about the evolution of birds.
{{< /callout >}}
...
Birds have feathers, which allow for insulation and flight, as well as for mating and warning signals. Flight feathers have a broad and continuously curved vane that produces lift. Some birds have pneumatic bones containing air spaces that are sometimes connected to air sacs in the body cavity. Airflow through bird lungs travels in one direction, creating a cross-current gas exchange with the blood. *(Source note: the source summary says counter-current; this section's own text describes a cross-current system, with air flowing perpendicular to the blood.)*
...
- **_Archaeopteryx_** — transition species from dinosaur to bird from the Jurassic period.
...
{{< multiplechoice
  ...
  hint="Its fossils show cuplike teeth and a long bony tail like a dinosaur, but flight feathers on both the forelimbs and the tail like a bird."
>}}
Neornithes
Archaeopteryx
Enantiornithes
...
the design of the hip and wrist bones
the presence of a furcula, or wishbone, formed by the fusing of the clavicles
{{< /selfcheck >}}

{{< textin
  question="The transition species from dinosaur to bird from the Jurassic period is called ________."
  answer="Archaeopteryx"
  hint="Its skeleton mixes a toothed jaw and long bony tail with flight feathers on the forelimbs and tail."
>}}
...
{{< multiplechoice
  ...
  hint="This feather type covers the body itself, smoothing airflow over it rather than generating thrust or lift at the wing."
>}}
Flight feathers
Primary feathers
Secondary feathers
...
fusion of the clavicles, forming the furcula or wishbone
the furcula is flexible enough to bend during flapping and provides support to the shoulder girdle
...
penguins and flight birds like terns have similar chest structures with a keel sternum and large pectoral muscles
ostriches, which move by running, do not have a keel to their sternum
ostriches have smaller pectoral muscles but larger thigh muscles than a flying bird their size
{{< /selfcheck >}}

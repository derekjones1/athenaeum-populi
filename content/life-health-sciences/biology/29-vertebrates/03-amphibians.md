...
title: Amphibians
description: >-
  Frogs, salamanders, and caecilians as the tetrapods whose life cycle
  bridges water and land, from the Devonian fossil evidence for their
  origin to the traits distinguishing Urodela, Anura, and Apoda — adapted
  from OpenStax Biology 2e, Section 29.3.
source_section: "29.3"
weight: 3
---
...
{{< callout type="info" >}}
**Link to Learning.** Watch this series of four videos on tetrapod evolution:

- [The evolution from fish to earliest tetrapod](https://www.openstax.org/l/tetrapod_evol1)
- [The discovery of coelacanth and *Acanthostega* fossils](https://www.openstax.org/l/tetrapod_evol2)
- [The number of fingers on “legs”](https://www.openstax.org/l/tetrapod_evol3)
- [Reconstructing the environment of early tetrapods](https://www.openstax.org/l/tetrapod_evol4)
{{< /callout >}}

## Characteristics of Amphibians

As tetrapods, most amphibians are characterized by four well-developed limbs. In some species of salamanders, hindlimbs are reduced or absent, but all caecilians are (secondarily) limbless. An important characteristic of extant amphibians is a moist, permeable skin that is achieved via mucus glands. Most water is taken in across the skin rather than by drinking. The skin is also one of three respiratory surfaces used by amphibians. The other two are the lungs and the buccal (mouth) cavity. Air is taken first into the mouth through the nostrils, and then pushed by positive pressure into the lungs by closing the nostrils and elevating the throat.
...
In 2006, researchers published news of their discovery of a fossil of a “tetrapod-like fish,” *Tiktaalik roseae*, which seems to be a morphologically “intermediate form” between sarcopterygian fishes having feet-like fins and early tetrapods having true limbs (pictured below). *Tiktaalik* likely lived in a shallow water environment about 375 million years ago (Daeschler, E. B., Shubin, N. H., and Jenkins, F. J. “A Devonian tetrapod-like fish and the evolution of the tetrapod body plan,” *Nature* 440 (2006): 757–763, doi:10.1038/nature04639, [http://www.nature.com/nature/journal/v440/n7085/abs/nature04639.html](https://openstax.org/l/tetrapod)). Tiktaalik also had gills and lungs, but the loss of some gill elements gave it a neck, which would have allowed its head to move sideways for feeding. The eyes were on top of the head. It had fins, but the attachment of the fin bones to the shoulder suggested they might be weight-bearing. Tiktaalik preceded *Acanthostega* and *Ichthyostega*, with their four limbs, by about 10 million years and is considered to be a true intermediate clade between fish and amphibians.

{{< mediafigure src="biology/Figure_29_03_01" kind="diagram" eager="true" alt="A digital reconstruction of a tetrapod-like fish resting at the water's edge: a scaled, fish-shaped body and long tail still submerged, while a flattened, crocodile-like head and a pair of stubby, limb-like front fins have pulled up onto a sandy shore." >}}
...
in the adult form, the gills and lateral line system disappear, and four limbs develop
the jaws grow larger, suitable for carnivorous feeding
the digestive system transforms into the typical short gut of a predator
...
after metamorphosis, most frogs develop lungs and lose their gills
adults continue to perform gas exchange through their skin
lungs allow the adult to move out of the water and become terrestrial
this limits competition between adults and tadpoles by opening new living space and food sources to the adult
{{< /selfcheck >}}

...
{{< mediafigure src="biology/Figure_30_02_10abcdef" kind="photo" alt="Photos show six types of modified stems: (a) Lumpy white ginger rhizomes are connected together. A green shoot projects from one end. (b) The carrion flower corm is a dark, rounded lump seen from above, with white roots spreading out from it over the moss. (c) Two grass plants are connected by a thick, brown stem. (d) Strawberry plants are connected together by a red runner. (e) The part of the potato plant that humans consume is a tuber. (f) The part of the onion plant that humans consume is a bulb." >}}
...
{{< mediafigure src="biology/Figure_B30_02_11ab" kind="photo" alt="Photo shows (a) a plant clinging to a stick by wormlike tendrils and (b) a long, slender, pale green thorn rising from a green stem." >}}

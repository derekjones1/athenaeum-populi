...
title: Stems
description: >-
  How stems, characterized by nodes and internodes, build their dermal,
  vascular, and ground tissue systems and grow both in length and in girth —
  adapted from OpenStax Biology 2e, Section 30.2.
source_section: "30.2"
weight: 2
---
...
{{< mediafigure src="biology/Figure_B30_02_01" kind="photo" eager="true" alt="A close-up photo of a leafy stem with call-out lines: 'Nodes' points to two swellings where petioles branch off, 'Internode' marks the stem length between them, and lines identify a 'Leaf', its 'Petiole', and an 'Axillary bud' budding out just above a lower node." >}}
...
{{< mediafigure src="biology/Figure_30_02_03" kind="photo" alt="Micrograph shows collenchyma cells, which are irregularly shaped and 25 to 50 microns across. The collenchyma cells are adjacent to a layer of rectangular cells that form the epidermis." >}}
...
Watch this [BBC Nature video](https://openstax.org/l/motion_plants) showing how time-lapse photography captures plant growth at high speed.
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_30_02_08" kind="photo" alt="Photo shows rough, white ovals embedded in a smooth, reddish brown woody tree trunk. Where the ovals are, it appears as if the bark has been scraped away." >}}
...
{{< mediafigure src="biology/Figure_30_02_09" kind="photo" alt="Photo shows a cross section of a large tree trunk with many rings projecting outward from the center." >}}
...
Watch botanist Wendy Hodgson, of Desert Botanical Garden in Phoenix, Arizona, explain how agave plants were cultivated for food hundreds of years ago in the Arizona desert in this [video, *Finding the Roots of an Ancient Crop*](https://openstax.org/l/ancient_crop).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_B30_02_11ab" kind="photo" alt="Photo shows (a) a plant clinging to a stick by wormlike tendrils and (b) a thick, green thorn on a green stem." >}}
...
a plant could not get the carbon dioxide needed for photosynthesis
...
xylem cells transport water and dissolved minerals and are dead at maturity
phloem is made up of sieve-tube cells and companion cells
phloem cells transport carbohydrates and are alive at maturity
{{< /selfcheck >}}
...
it produces new cells towards the interior, which enables the plant to increase in girth
it also produces cork cells towards the exterior
...
===CHECKS===
in woody stems
lenticels allow internal cells to exchange gases with the outside atmosphere
{{< /selfcheck >}}

...
description: >-
  How plants sense and respond to their environment without moving —
  phytochrome and phototropin light signals, gravitropism, the five major
  growth hormones, thigmotropism and thigmonasty, and physical and chemical
  defenses against herbivores and pathogens — adapted from OpenStax Biology
  2e, Section 30.6.
source_section: "30.6"
weight: 6
---
...
{{< mediafigure src="biology/Figure_30_06_01" kind="diagram" eager="true" alt="A schematic diagram on a peach background showing two labeled phytochrome states, Pr (inactive) at top and Pfr (active) at lower center, connected by a pair of straight red arrows labeled 'Red light' and 'Far-red light,' and by a longer curved black arrow labeled 'Darkness' arcing from Pfr back up to Pr. A green block arrow points down from Pfr (active) to the words 'Cellular response' at the bottom." longdesc="At upper right, the label 'Pr (inactive).' At the far left, a long black curved arrow labeled 'Darkness' arcs from the bottom of the diagram up to the top, its arrowhead pointing into 'Pr (inactive).' Between the two states, two straight red arrows run in parallel: the left one, labeled 'Far-red light,' points upward into 'Pr (inactive)'; the right one, labeled 'Red light,' points downward into 'Pfr (active).' Below the two arrows sits the label 'Pfr (active).' Beneath that, a green block arrow points straight down to the words 'Cellular response' at the very bottom of the diagram." >}}
...
Phototropism—the directional bending of a plant toward or away from a light source—is a response to blue wavelengths of light. Positive phototropism is growth towards a light source (pictured below), while negative phototropism (also called skototropism) is growth away from light.
...
In their 1880 treatise *The Power of Movement in Plants* *(Source note: the source prints "Movements"; the 1880 title is singular.)*, Charles Darwin and his son Francis first described phototropism as the bending of seedlings toward light. Darwin observed that light was perceived by the tip of the plant (the apical meristem), but that the response (bending) took place in a different part of the plant. They concluded that the signal had to travel from the apical meristem to the base of the plant.

{{< mediafigure src="biology/Figure_30_06_02" kind="photo" alt="A cluster of small, pale blue-violet flowers, each with four petals and a yellow center, growing on slender stems and mostly tilted in the same direction, photographed in soft focus against a dark background." >}}
...
{{< callout type="info" >}}
**Link to Learning.** Watch [a video of plants in motion](https://openstax.org/l/plnts_n_motion).
{{< /callout >}}
...
{{< callout type="info" >}}
**Link to Learning.** Watch [three short movies of a Venus flytrap capturing prey, sensitive plant leaflets closing, and tendrils twining](https://openstax.org/l/nastic_mvmt).
{{< /callout >}}
...
some pathogens secrete virulence factors that inhibit the closing of stomata
abscisic acid is the stress hormone responsible for inducing closing of stomata
{{< /selfcheck >}}

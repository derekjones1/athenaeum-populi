...
description: >-
  How dominant and recessive alleles produce an organism’s phenotype and
  genotype, the Punnett square and test cross methods used to predict a
  monohybrid cross’s genotypes, and the non-Mendelian patterns (incomplete
  dominance, codominance, multiple alleles, sex linkage, and lethal alleles)
  that extend Mendel’s model — adapted from OpenStax Biology 2e, Section 12.2.
source_section: "12.2"
weight: 2
---
...
all three plants might have acquired only the dominant gene even if the recessive one is present
...
{{< mediafigure src="biology/Figure_12_02_11" kind="diagram" alt="A four-generation pedigree titled Pedigree Analysis for Alkaptonuria, using the legend square = male, circle = female, yellow fill = unaffected, blue fill = affected. Individuals 1, 2, and 3 are shown as numbered, unlabeled shapes; every other individual's shape carries a printed genotype (aa, Aa, or the uncertain A?)." longdesc="Top to bottom, four generations connected by horizontal marriage lines and vertical descent lines. First generation: a blue square labeled 1 married to a yellow circle labeled 2. Second generation: their child, a blue square labeled aa, married to a yellow circle labeled Aa who married into the family. Third generation: the aa–Aa couple's three children — a blue circle labeled aa on the left, married to a yellow square labeled 3 who married into the family; a yellow square labeled Aa in the middle, unmarried with no children shown; and a yellow circle labeled Aa on the right, married to a yellow square labeled Aa who married into the family. Fourth generation: the child of the aa circle and individual 3 is a blue circle labeled aa; the right-hand third-generation couple has two children, a blue circle labeled aa and a yellow circle labeled A?." >}}
...
individual 2 has the genotype Aa
individual 3 has the genotype Aa
{{< /selfcheck >}}
...
{{< mediafigure src="biology/Figure_12_02_06" kind="photo" alt="Close-up photo comparing two fruit flies: the wild-type fly on the left has short antennae on its head, while the Antennapedia mutant on the right has jointed, leg-like structures on its head in place of antennae." >}}
...
{{< mediafigure src="biology/Figure_12_02_07" kind="photo" alt="Two side-by-side photos. Panel (a) is a color photograph of an Anopheles gambiae mosquito perched on skin. Panel (b) is a false-color transmission electron micrograph of a sickle-shaped Plasmodium falciparum parasite, shown in pink and purple tones." >}}
...
Eye color in *Drosophila* was one of the first X-linked traits to be identified. Thomas Hunt Morgan mapped this trait to what became known as the X chromosome in 1910. Like humans, *Drosophila* males have an XY chromosome pair, and females are XX. In flies, the wild-type eye color is red (X<sup>W</sup>) and it is dominant to white eye color (X<sup>w</sup>) (see the figure below). Because of the location of the eye-color gene, reciprocal crosses do not produce the same offspring ratios. Males are said to be **hemizygous**, because they have only one allele for any X-linked characteristic. Hemizygosity makes the descriptions of dominance and recessiveness irrelevant for XY males. *Drosophila* males lack a second allele copy on the Y chromosome; that is, their genotype can only be X<sup>W</sup>Y or X<sup>w</sup>Y. In contrast, females have two allele copies of this gene and can be X<sup>W</sup>X<sup>W</sup>, X<sup>W</sup>X<sup>w</sup>, or X<sup>w</sup>X<sup>w</sup>.

{{< mediafigure src="biology/Figure_12_02_08" kind="photo" alt="A close-up photograph of six fruit flies lying on a white surface, each with a compound eye of a visibly different color, ranging from dark brown and deep red shades through orange and pale white to bright red." >}}
...
In an X-linked cross, the genotypes of F₁ and F₂ offspring depend on whether the recessive trait was expressed by the male or the female in the P₁ generation. With regard to *Drosophila* eye color, when the P₁ male expresses the white-eye phenotype and the female is homozygous red-eyed, all members of the F₁ generation exhibit red eyes (see the figure below). The F₁ females are heterozygous (X<sup>W</sup>X<sup>w</sup>), and the males are all X<sup>W</sup>Y, having received their X chromosome from the homozygous dominant P₁ female and their Y chromosome from the P₁ male. A subsequent cross between the X<sup>W</sup>X<sup>w</sup> female and the X<sup>W</sup>Y male would produce only red-eyed females (with X<sup>W</sup>X<sup>W</sup> or X<sup>W</sup>X<sup>w</sup> genotypes) and both red- and white-eyed males (with X<sup>W</sup>Y or X<sup>w</sup>Y genotypes). Now, consider a cross between a homozygous white-eyed female and a male with red eyes. The F₁ generation would exhibit only heterozygous red-eyed females (X<sup>W</sup>X<sup>w</sup>) and only white-eyed males (X<sup>w</sup>Y). Half of the F₂ females would be red-eyed (X<sup>W</sup>X<sup>w</sup>) and half would be white-eyed (X<sup>w</sup>X<sup>w</sup>). Similarly, half of the F₂ males would be red-eyed (X<sup>W</sup>Y) and half would be white-eyed (X<sup>w</sup>Y).

{{< mediafigure src="biology/Figure_12_02_09" kind="diagram" alt="A Punnett square diagram titled Punnett Square Analysis of a Sex-linked Trait, showing an illustrated red-eyed male fruit fly crossed with a white-eyed female fruit fly, with their offspring's genotypes and eye colors filled in the grid below." longdesc="At top, an illustrated red-eyed male fly labeled XᵂY is crossed with an illustrated white-eyed female fly labeled XʷXʷ. Below, a grid lists the female's gametes, Xʷ and Xʷ, across the top, and the male's gametes, Xᵂ and Y, down the side. The two upper cells each show a red-eyed female fly labeled XᵂXʷ, with a note that all female offspring have red eyes. The two lower cells each show a white-eyed male fly labeled XʷY, with a note that all male offspring have white eyes." >}}
...
half would be homozygous recessive with white eyes
half of the male offspring would be hemizygous dominant with red eyes
half would be hemizygous recessive with white eyes
{{< /selfcheck >}}
...
{{< callout type="info" >}}
**Link to Learning.** Watch [a video introduction to sex-linked traits](https://www.openstax.org/l/sex-linked_trts).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_12_02_10" kind="photo" alt="A fluorescence micrograph on a dark red background showing several yellow-green neurons with branching processes among many small blue-stained cell nuclei; the central neuron has an orange nuclear inclusion." >}}
...
F₁ would be all heterozygous Aa with axial phenotype
F₂ would have possible genotypes of AA, Aa, and aa
...
t and t along the top, and T and t along the left side
the genotypes listed within the boxes will be Tt, Tt, tt, and tt
the phenotypic ratio will be 1 tall:1 dwarf
{{< /selfcheck >}}
...
if a homozygous dominant donor was used, the unknown genotype could still be determined
the F₁ offspring would have to be self-crossed
...
they cannot carry it because an individual needs two X chromosomes to be a carrier
{{< /selfcheck >}}

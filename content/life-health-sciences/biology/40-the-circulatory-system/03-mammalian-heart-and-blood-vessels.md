...
{{< mediafigure src="biology/Figure_40_03_03" kind="diagram" alt="Three side-by-side heart diagrams show the chambers alternately filling and contracting during cardiac diastole, atrial systole, and atrial diastole/ventricular systole, each with black arrows tracing blood movement." longdesc="Panel (a), Cardiac diastole, shows three black arrows pointing down into the relaxed chambers — two in the blue-toned right heart and one in the pink-toned left heart — as blood flows in from the great vessels above. Panel (b), Atrial systole and ventricular diastole, shows two hooked black arrows, one in each ventricle — the blue-toned right and the pink-toned left — each dipping down inside the ventricle and curling back up so its head points at the valve from the atrium above, as the atria contract and push blood down into the ventricles. Panel (c), Atrial diastole and ventricular systole, shows two black arrows pointing straight up from the ventricles toward the valves, one on each side, plus five more black arrows fanning outward from the tops of the aorta and pulmonary artery, as the ventricles contract and blood leaves the heart." >}}
...
{{< multiplechoice
  ...
  hint="Look at what a microscope shows about the two tissues' banding pattern, not at how each one behaves in the body — involuntary rhythmic beating is something cardiac muscle shares with a different tissue type instead."
>}}
...
{{< textin
  ...
  accept="tricuspid valve"
  hint="Think about which valve sits between an atrium and a ventricle, not between a ventricle and a great vessel — it goes by two names in the text, and either one is accepted here."
>}}
...
{{< textin
  ...
  hint="The name combines a root meaning 'hardening' with a root for a fatty, gruel-like deposit."
>}}
...
{{< multiplechoice
  ...
  answer="contracting"
  hint="This phase's name shares a root with a word meaning 'to contract' — match that root to exactly one of the four options."
>}}
contracting
relaxing
...
{{< textin
  ...
  answer="diastole"
  hint="This phase's Greek root means 'to draw apart' — the opposite of the cycle's contraction phase."
>}}
...
{{< multiplechoice
  ...
  hint="Arteries handle blood fresh from a forceful pump; that pressure difference is what the vessel wall itself has to be built for."
>}}

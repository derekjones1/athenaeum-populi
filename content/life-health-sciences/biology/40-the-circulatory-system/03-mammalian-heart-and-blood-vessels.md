...
description: >-
  How the four-chambered mammalian heart pumps blood through the coronary,
  pulmonary, and systemic circuits, what the cardiac cycle's electrical
  pacemaker does at each stage, and how arteries, veins, and capillaries
  differ in structure and function — adapted from OpenStax Biology 2e,
  Section 40.3.
source_section: "40.3"
weight: 3
---
...
{{< mediafigure src="biology/Figure_B40_03_01ab" kind="diagram" eager="true" alt="A diagram of a person's upper body and head shows the heart's four chambers linked by labeled vessels, with a bracket marking the pulmonary circuit between the heart and the lungs and a second bracket marking the systemic circuit below the heart." longdesc="At upper left, leader lines label Superior vena cava and Right atrium, pointing to the vessel and chamber entering the top of the heart. At right, four leader lines label, top to bottom, Aorta (the red vessel rising from the heart to a capillary network above it, in the upper body), Pulmonary artery (the blue vessel arcing out to the network in the lung on the right), Left atrium (the red upper chamber), and Pulmonary vein (the red vessel returning from that lung network toward the heart). Four purple capillary networks are drawn: one above the heart, one in each lung, and one below the heart. At lower left, leader lines label Right ventricle and Inferior vena cava; at lower right, one leader line labels Left ventricle. A bracket at the left, spanning the vessels between the heart and the drawn lungs, is labeled Pulmonary circuit. A second bracket at the bottom, spanning the capillary network beneath the heart, is labeled Systemic circuit. Arrowheads trace a figure-eight: from the venae cavae (the superior one returning from the upper network, the inferior one from the lower) into the right atrium and ventricle, out through the pulmonary artery to both lung networks, back through the pulmonary veins to the left atrium and ventricle, and out through red arteries to the upper and lower networks." >}}
...
{{< mediafigure src="biology/Figure_40_03_02ab" kind="diagram" alt="Two-panel diagram of the heart. Panel (a) is a labeled cutaway showing the four chambers, valves, and great vessels, with an inset cross-section of the wall layers. Panel (b) shows the heart's outer surface with its coronary arteries and veins." longdesc="Panel (a)'s left side carries seven leader lines, top to bottom: Pulmonary artery, Superior vena cava, Right atrium, Pulmonary valve (semilunar), Tricuspid valve (atrioventricular), Right ventricle, and Inferior vena cava. Its right side carries six leader lines, top to bottom: Aorta, Pulmonary artery, Left atrium, Aortic valve (semilunar), Mitral valve (atrioventricular), and Left ventricle. A gray arrow leads from a small boxed region of the left ventricle's wall near the apex to an inset of the wall's layers, outermost at top: Fibrous pericardium (a fibrous top band), Parietal pericardium (a pale band beneath it), Pericardial space (a thin gap), Epicardium (a thin layer just below the gap, on the muscle), Myocardium (the thick muscle band), and Endocardium (the wavy bottom edge). A bracket labeled Pericardium spans from the top band down to the epicardium. Panel (b), below, shows the heart's outer surface with the label Coronary arteries pointing to two red vessels and Cardiac veins pointing to two blue vessels; each red artery runs down the surface beside a blue vein, in two grooves, with finer red and blue branches spreading over the heart." >}}
...
{{< mediafigure src="biology/Figure_40_03_03" kind="diagram" alt="Three side-by-side heart diagrams show the chambers alternately filling and contracting during cardiac diastole, atrial systole, and atrial diastole/ventricular systole, each with black arrows tracing blood movement." longdesc="Panel (a), Cardiac diastole, shows four black arrows pointing down into the relaxed chambers — two in the blue-toned right heart (one curving down within the atrium, one running from the atrium into the ventricle) and two in the pink-toned left heart (one down through the atrium to the valve, one continuing into the ventricle) — as blood flows in from the great vessels above. Panel (b), Atrial systole and ventricular diastole, shows two hooked black arrows, one in each ventricle — the blue-toned right and the pink-toned left — each dipping down inside the ventricle and curling back up so its head points at the valve from the atrium above, as the atria contract and push blood down into the ventricles. Panel (c), Atrial diastole and ventricular systole, shows two black arrows pointing up from the ventricles toward the valves at their tops, one on each side (straight up on the right, slanting up and to the left on the left), plus five more black arrows fanning outward from the tops of the aorta and pulmonary artery, as the ventricles contract and blood leaves the heart." >}}
...
{{< mediafigure src="biology/Figure_B40_03_04" kind="photo" alt="A micrograph of oblong, striated cardiac muscle cells, with an inset magnifying a smaller boxed region to show the striations and a cell-to-cell junction in more detail; scale bars mark 50 µm on the main image and 10 µm on the inset." >}}
...
{{< mediafigure src="biology/Figure_40_03_05" kind="diagram" alt="Four heart-and-graph panels trace the heartbeat's electrical impulse from the sinoatrial node through the atrioventricular node and Purkinje fibers to the ventricles, with a matching ECG trace below each heart highlighting the electrical event in that panel." longdesc="One leader line above panel (a) labels Sinoatrial node, pointing to a small oval at the top of that heart; one leader line above panel (b) labels Atrioventricular node, pointing to a second oval lower in that heart. Below panel (a), two more leader lines label Purkinje fiber, tracing a curved line down the septum and around the ventricle floor, and Heart apex, the bottom tip of the heart. Each of the four panels shows the same heart, with both ovals in it, and purple shading marks where the signal is: in (a) across both atria; in (b) only a small patch around the atrioventricular node; in (c) down the septum, around the apex, and up the outer ventricle walls; in (d) filling both ventricles. Below each heart is its own ECG trace: a black line with one short purple segment marking that panel's event. In (a) the purple segment is the small hump before the sharp spike, as the impulse spreads through the atria. In (b) it is the flat segment right after that hump, as the impulse is delayed at the atrioventricular node. In (c) it is a brief downward dip just before the spike, as bundle branches carry the signal toward the heart apex. In (d) the sharp spike itself is purple, as the signal spreads through the ventricle walls." >}}
The beating of the heart is regulated by an electrical impulse that causes the characteristic reading of an ECG. The signal is initiated at the sinoatrial node. The signal then (a) spreads to the atria, causing them to contract. The signal is (b) delayed at the atrioventricular node before it is passed on to the (c) heart apex. The delay allows the atria to relax before the (d) ventricles contract. The final part of the ECG cycle prepares the heart for the next beat.
{{< /mediafigure >}}

{{< callout type="info" >}}
**Link to Learning**

Watch [an animation of the heart's electrical pacemaker in action](https://openstax.org/l/electric_heart).
{{< /callout >}}
...
{{< multiplechoice
  ...
  answer="they are striated"
  hint="Reread the paragraph in The Cardiac Cycle that compares cardiomyocytes with skeletal and smooth muscle, and the micrograph beside it."
>}}
...
{{< textin
  question="The buildup of fatty plaques in the coronary arteries of the heart is called ________."
  answer="atherosclerosis"
  hint="Look at the end of the paragraph on the heart's own blood vessels, in Structure of the Heart."
>}}
...
{{< multiplechoice
  question="During the systolic phase of the cardiac cycle, the heart is ________."
  answer="contracting"
  hint="Reread the paragraph on the two phases of the cardiac cycle, at the start of The Cardiac Cycle."
>}}
contracting
relaxing

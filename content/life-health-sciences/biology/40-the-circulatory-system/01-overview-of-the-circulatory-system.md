...
{{< multiplechoice
  ...
  hint="The passage on wing-spanned insects and birds explains this as a trade-off: a closed system can move more blood to active tissues, but there's a cost to keeping blood confined to vessels — think about what the open system saves by skipping that."
>}}
...
{{< selfcheck question="Describe a closed circulatory system." hint="Contrast this with the hemocoel of an open system — what does a closed system keep blood separated from, and in what does it stay contained?" >}}
...
{{< textin
  question="A system in which blood is separated from the bodily interstitial fluid and contained in blood vessels is called a ________."
  answer="closed circulatory system"
  hint="This is the opposite of the system found in insects, where blood mixes with body fluid in an open cavity."
>}}
...
{{< textin
  ...
  answer="ostium"
  accept="ostia"
  hint="There are several of these small openings along an insect's dorsal blood vessel, each one letting hemolymph flow back into the heart."
>}}
...
{{< textin
  ...
  answer="ventricle"
  hint="This chamber sits below the atrium and does the heavier pumping work of the two."
>}}

...
description: >-
  How the heart's pumping action, vessel diameter, precapillary sphincters,
  and one-way valves move blood and lymph through the body, and how cardiac
  output and peripheral resistance combine to set and regulate blood
  pressure — adapted from OpenStax Biology 2e, Section 40.4.
source_section: "40.4"
weight: 4
---
...
{{< mediafigure src="biology/Figure_40_04_01ab" kind="diagram" eager="true" alt="Illustration A shows an artery branching off into an arteriole, which branches into a capillary bed. The start of each capillary has a sphincter regulating flow through it. The capillaries converge into a venule, which joins a vein. Part B shows a valve in a blood vessel. The valve is slightly curved such that flow in one direction pushes it open, while flow in the other direction pushes it closed." longdesc="Panel (a), reading top to bottom then left to right: at the top, two leader lines label Precapillary sphincters, pointing to two of the narrow pinch points where capillaries branch from the arteriole, a third label reads Thoroughfare channel, the wider vessel running straight across the middle of the capillary web, and a fourth labels Venule, where the vessels rejoin at the upper right. At the left, one leader line labels Arteriole, the vessel feeding the web from the artery. Along the bottom, leader lines label Artery at the far left, Capillaries at the branching web in the middle, Tissue cells at the shaded mass the capillaries wrap around, and Vein at the vessel leaving the venule at the right. A single chain of black-and-white arrows runs from the arteriole along the thoroughfare channel into the venule; no arrows are drawn in the narrower capillaries. Panel (b) stacks two copies of the same curved vessel with a yellow valve at its center: in the upper copy, a blue arrow passes rightward through the valve, shown open, beside a blue circle; in the lower copy, a blue arrow points leftward into the same valve, now pinched shut, beside a red X." >}}
...
it has to flow up to reach it
{{< /selfcheck >}}

{{< callout type="info" >}}
**Link to Learning**

See [the circulatory system's blood flow](https://www.openstax.org/l/circulation).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_40_04_02" kind="diagram" alt="Illustration shows an arteriole and a venule branching off into a capillary bed. Lymph capillaries surround the capillary bed. Fluid diffuses from the blood vessels into the lymphatic vessels." longdesc="The image is titled 'Lymph Capillaries in the Tissue Spaces.' Reading top to bottom: at the upper left, one leader line labels Lymph capillary, pointing to one of several green, blind-ended tubes that reach up into a capillary bed at the top of the illustration, whose vessels shade from red on the arteriole side to blue on the venule side; at the upper right, one leader line labels Tissue cells, the pale stippled background the vessels run through. At the left, one leader line labels Arteriole, the red vessel entering from that side; at the right, one leader line labels Venule, the blue vessel leaving on that side; small pale arrows show blood rising in the arteriole and turning into the capillary bed, and flowing down the venule. At the lower left, one leader line labels Tissue fluid, ending on a small gray arrow inside a green lymph vessel; at the lower right, one leader line labels Lymphatic vessel, the network of larger green vessels along the bottom that the lymph capillaries drain into. Small gray arrows point into the tips of the lymph capillaries and along the green vessels, showing tissue fluid entering the lymph capillaries and flowing on through the lymph network." >}}
Fluid from the capillaries moves into the interstitial space and lymph capillaries by diffusion down a pressure gradient and also by osmosis. Out of 7,200 liters of fluid pumped by the average heart in a day, roughly 20 liters is filtered. *(Source note: the source says "over 1,500 liters"; textbook estimates of daily net capillary filtration run from about 8 to 30 liters (StatPearls, "Physiology, Lymphatic System"), and the caption uses the middle of that range.)* (credit: modification of work by NCI, NIH)
{{< /mediafigure >}}
...
{{< mediafigure src="biology/Figure_40_04_03" kind="diagram" alt="Graph A shows blood pressure, which starts high in the arteries and gradually drops as blood passes through the capillaries and veins. Blood velocity drops gradually in the arteries, then precipitously in the capillaries. Velocity increases as blood enters the veins. In the arteries, both blood pressure and velocity fluctuate to a higher level during systole and a lower level during diastole." longdesc="Two line graphs stacked vertically share the same three x-axis zones, labeled left to right: Arteries/arterioles (shaded peach), Capillaries (a narrow pink band), and Veins/venules (shaded blue). The top graph's y-axis is labeled Blood Pressure: within the arteries/arterioles zone the curve oscillates in a tight zigzag between an upper envelope labeled Systolic pressure and a lower envelope labeled Diastolic pressure, both sloping downward ever more steeply as the swings shrink; at the right end of the arteries/arterioles zone the zigzag ends in a sharp drop, so the curve enters the capillaries zone already low, declines gently through it, and levels off low and flat through the veins/venules zone. The bottom graph's y-axis is labeled Blood velocity: the curve oscillates in the same tight zigzag at a high, roughly level value through the arteries/arterioles zone, drops sharply at that zone's right end to its lowest point inside the capillaries zone, then rises again steadily through the veins/venules zone." >}}
...
which increases the hydrostatic pressure against the artery walls

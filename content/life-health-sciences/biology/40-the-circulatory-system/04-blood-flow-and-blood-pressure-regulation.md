...
{{< multiplechoice
  ...
  hint="Cardiac output and peripheral resistance both push blood pressure in the same direction — find the combination that raises it instead of lowering it."
>}}
...
{{< textin
  ...
  hint="Multiplying this quantity by heart rate gives cardiac output."
>}}

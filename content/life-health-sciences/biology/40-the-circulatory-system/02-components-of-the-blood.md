...
description: >-
  The liquid and cellular components of blood — plasma, red blood cells,
  white blood cells, and platelets — how red and white blood cells differ in
  structure and function, and the distinction between blood plasma and serum
  — adapted from OpenStax Biology 2e, Section 40.2.
source_section: "40.2"
weight: 2
---
...
{{< mediafigure src="biology/Figure_40_02_03ab" kind="diagram" alt="Illustration of five white blood cell types in two groups: (a) Granulocytes—Neutrophil, Eosinophil, and Basophil, similar in size with lobed, granular nuclei; (b) Agranulocytes—the larger Monocyte, with a U-shaped nucleus, and the smaller Lymphocyte, with an oblong nucleus." >}}
...
{{< mediafigure src="biology/Figure_40_02_05" kind="diagram" alt="Four identical red blood cells labeled O, A, B, and AB: the O cell has no surface markers; the A cell is covered in small blue arrow-shaped markers; the B cell is covered in small green round markers; the AB cell is covered in both the blue and green markers." >}}
...
the lymph nodes filter the lymph by percolation through connective tissue filled with white blood cells

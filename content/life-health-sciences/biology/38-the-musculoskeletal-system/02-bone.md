...
title: Bone
description: >-
  How bones are classified by shape, the microscopic structure of compact
  and spongy bone tissue, the roles of the cells that build, maintain, and
  remodel it, and how bones form, lengthen, thicken, and repair through
  ossification — adapted from OpenStax Biology 2e, Section 38.2.
source_section: "38.2"
weight: 2
---
...
**Short bones**, or cuboidal bones, are bones that are the same width and length, giving them a cube-like shape. For example, the bones of the wrist (carpals) and ankle (tarsals) are short bones (shown above).

**Flat bones** are thin and relatively broad bones that are found where extensive protection of organs is required or where broad surfaces of muscle attachment are required. Examples of flat bones are the sternum (breast bone), ribs, scapulae (shoulder blades), and the roof of the skull (shown above).
...
**Sesamoid bones** are small, flat bones and are shaped similarly to a sesame seed. The patellae are sesamoid bones (shown below). Sesamoid bones develop inside tendons and may be found near joints at the knees, hands, and feet.

{{< mediafigure src="biology/Figure_38_02_03" kind="photo" alt="A close-up photo of a smooth, rounded, teardrop-shaped bone lying flat, lit against a blue background." >}}
...
{{< multiplechoice
  question="Which of the following statements about bone tissue is false?"
  answer="Haversian canals contain blood vessels only."
  hint="Compare each option against the definition of the Haversian canal given just above this figure."
>}}
...
View the micrographs of musculoskeletal tissues (*Muscle* histology resources at histology.medicine.umich.edu) as you review the anatomy.
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_38_02_07" kind="photo" alt="A grayscale X-ray image of a bent arm showing a fractured long bone with visible bone fragments at the break, plus small radiographic markers in the frame." >}}
After this bone is set, a callus will knit the two ends together. (credit: Bill Rhodes)
{{< /mediafigure >}}
...
spongy bone tissue forms the inner layer of all bones and consists of trabeculae
spongy bone is prominent in areas of bones that are not heavily stressed or at which stresses arrive from many directions
{{< /selfcheck >}}

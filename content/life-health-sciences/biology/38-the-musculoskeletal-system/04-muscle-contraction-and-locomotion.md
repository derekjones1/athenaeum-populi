...
description: >-
  How skeletal, smooth, and cardiac muscle tissue differ in structure and
  control, and how the sliding-filament cross-bridge cycle, its regulatory
  proteins, and excitation-contraction coupling let a stimulated muscle fiber
  generate tension and drive locomotion — adapted from OpenStax Biology 2e,
  Section 38.4.
source_section: "38.4"
weight: 4
---
...
Muscle cells are specialized for contraction. Muscles allow for motions such as walking, and they also facilitate bodily processes such as respiration and digestion. The body contains three types of muscle tissue: skeletal muscle, cardiac muscle, and smooth muscle (shown below).

{{< mediafigure src="biology/Figure_38_04_01" kind="photo" eager="true" alt="The skeletal muscle cells are long and arranged in parallel bands that give the appearance of striations. Each cell has multiple nuclei. Smooth muscle cells have no striations and only one nuclei per cell. Cardiac muscles are striated but have only one nucleus." >}}
...
Each skeletal muscle fiber is a skeletal muscle cell. These cells are incredibly large, with diameters of up to 100 µm and lengths of up to 30 cm. The plasma membrane of a skeletal muscle fiber is called the **sarcolemma**. The sarcolemma is the site of action potential conduction, which triggers muscle contraction. Within each muscle fiber are **myofibrils**—long cylindrical structures that lie parallel to the muscle fiber. Myofibrils run the entire length of the muscle fiber, and because they are only approximately 1.2 µm in diameter, hundreds to thousands can be found inside one muscle fiber. They attach to the sarcolemma at their ends, so that as myofibrils shorten, the entire muscle cell contracts (illustrated below).

{{< mediafigure src="biology/Figure_38_04_02" kind="diagram" alt="Illustration shows a long, tubular skeletal muscle cell that runs the length of a muscle fiber. Long, cylindrical bundles called myofibrils run the length of the cell. The myofibrils have a banded appearance. A sarcoplasm exists around the myofibrils, and the sarcolemma surrounds everything." longdesc="A cutaway cylindrical muscle fiber is banded orange along its visible length and opens at the right end, where several rounded myofibril cross-sections are exposed, each showing alternating light and dark cross-bands with a scatter of small red dots inside it. Four leader lines run from the right margin to the drawing, top to bottom: 'Sarcolemma' points to the fiber's outer casing, 'Sarcoplasm' points to the space around the myofibrils inside that casing, 'Myofibrils' points to two of the exposed rounded bundles, and 'Striations' points to two of the banding patterns on separate myofibrils. A double-headed arrow beneath the whole drawing spans its length and is labeled 'Muscle fiber.'" >}}
...
Each I band has a dense line running vertically through the middle called a Z disc or Z line. The Z discs mark the border of units called **sarcomeres**, which are the functional units of skeletal muscle. One sarcomere is the space between two consecutive Z discs and contains one entire A band and two halves of an I band, one on either side of the A band. A myofibril is composed of many sarcomeres running along its length, and as the sarcomeres individually contract, the myofibrils and muscle cells shorten (illustrated below).

{{< mediafigure src="biology/Figure_B38_04_03-myofibril" kind="diagram" alt="Illustration shows part of a tubular myofibril, which consists of many sarcomeres. Zigzagging lines, called Z lines, run perpendicular to the fiber. Each sarcomere starts at one Z line and ends at the next. A straight perpendicular line, called an M line, exists halfway between each Z line. Thick filaments extend out from the M lines, parallel to the length of the myofibril. Thin filaments extend from the Z lines, and extend into the space between the thick filaments." longdesc="A single cylindrical myofibril runs the width of the drawing, its surface a horizontal red-and-tan banded pattern. Two zigzagging yellow 'Z line' markers cross the myofibril, one near the left edge and one at the right edge; only the left one carries a 'Z line' label on a leader from above, while the right one sits under the right foot of the 'Sarcomere' bracket. A 'Sarcomere' bracket spans the full distance from the left Z line to the right Z line, and a shorter 'M line' bracket nested beneath it points to the vertical red line bisecting that distance. Below the M line, a 'Thin filament' leader points to a light band just left of center, and a 'Thick filament' leader points to a darker band just right of center. A double-headed arrow beneath the whole drawing spans its length and is labeled 'Myofibril.'" >}}
...
Thick and thin filaments are themselves composed of proteins. Thick filaments are composed of the protein myosin. The tail of a myosin molecule connects with other myosin molecules to form the central region of a thick filament near the M line, whereas the heads align on either side of the thick filament where the thin filaments overlap. The primary component of thin filaments is the actin protein. Two other components of the thin filament are tropomyosin and troponin. Actin has binding sites for myosin attachment. Strands of tropomyosin block the binding sites and prevent actin–myosin interactions when the muscles are at rest. Troponin consists of three globular subunits. One subunit binds to tropomyosin, one subunit binds to actin, and one subunit binds Ca²⁺ ions.

{{< callout type="info" >}}
**Link to Learning**

View [an animation showing the organization of muscle fibers](https://openstax.org/l/skeletal_muscle).
{{< /callout >}}

## Sliding Filament Model of Contraction

For a muscle cell to contract, the sarcomere must shorten. However, thick and thin filaments—the components of sarcomeres—do not shorten. Instead, they slide by one another, causing the sarcomere to shorten while the filaments remain the same length. The sliding filament theory of muscle contraction was developed to fit the differences observed in the named bands on the sarcomere at different degrees of muscle contraction and relaxation. The mechanism of contraction is the binding of myosin to actin, forming cross-bridges that generate filament movement (illustrated below).

{{< mediafigure src="biology/Figure_B38_04_04-filaments" kind="diagram" alt="A two-panel diagram of a sarcomere before and after contraction: panel (a), a relaxed sarcomere, is labeled with a Z line at each end, a central M line, and the thin (actin) and thick (myosin) filaments that extend from them and partially overlap; panel (b), the same sarcomere contracted, shows the same zigzag and filament pattern with the filaments overlapping completely." longdesc="Panel (a), at the top, shows a relaxed sarcomere as seven parallel rows of thick filaments, interleaved with thin filaments, between two yellow zigzag 'Z line' markers, one at the left edge and one at the right edge. From each Z line a thin blue line labeled 'Thin filament (actin)' extends inward, and a thick red bristled line labeled 'Thick filaments (myosin)' extends from a central vertical red 'M line' outward toward each Z line, overlapping the inner ends of the thin filaments. Below the drawing, three brackets read, left to right: 'I band' (Z line to the start of the thick filaments), 'A band' (the full span of the thick filaments, with a narrower 'H zone' bracket nested inside it marking the gap between the thin filaments' inner tips), and 'I band' (mirroring the left side). Panel (b), below, shows the same sarcomere contracted: the two Z lines have moved inward so the thin filaments from each side now overlap each other around the M line, and the thick filaments span nearly the full width between the Z lines. Below panel (b), three brackets again read, left to right, 'I band,' 'A band,' and 'I band'; the two I band brackets are now much narrower than in panel (a), and no H zone bracket is drawn, since the thin filaments overlap completely at full contraction." >}}
...
{{< multiplechoice
  question="Which of the following statements about muscle contraction is true?"
  answer="The power stroke occurs when ADP and phosphate dissociate from the myosin head."
  hint="Walk through the five numbered frames above and find the one captioned as the power stroke — notice what leaves the myosin head at that step, and from where."
>}}
...
The power stroke occurs when Ca²⁺ binds the calcium head.
{{< /multiplechoice >}}

{{< callout type="info" >}}
**Link to Learning**

View [an animation of the cross-bridge muscle contraction](https://openstax.org/l/muscle_contract).
{{< /callout >}}
...
To enable a muscle contraction, tropomyosin must change conformation, uncovering the myosin-binding site on an actin molecule and allowing cross-bridge formation. This can only happen in the presence of calcium, which is kept at extremely low concentrations in the sarcoplasm. If present, calcium ions bind to troponin, causing conformational changes in troponin that allow tropomyosin to move away from the myosin binding sites on actin. Once the tropomyosin is removed, a cross-bridge can form between actin and myosin, triggering contraction. Cross-bridge cycling continues until either Ca²⁺ ions or ATP are no longer available and tropomyosin again covers the binding sites on actin.
...
ACh is broken down by the enzyme **acetylcholinesterase** (AChE) into acetyl and choline. AChE resides in the synaptic cleft, breaking down ACh so that it does not remain bound to ACh receptors, which would cause unwanted extended muscle contraction (illustrated below).

{{< mediafigure src="biology/Figure_38_04_06f" kind="diagram" alt="A two-panel diagram of a neuromuscular junction and the muscle cell beneath it. Panel (a), the four steps that start a contraction, is labeled with the axon terminal, its synaptic vesicles, the acetylcholine receptor, the synaptic cleft, the T tubule, and the sarcoplasmic reticulum. Panel (b), the three steps that end it, is labeled with the sarcolemma (muscle cell plasma membrane) and acetylcholinesterase." longdesc="Panel (a), at left, shows a bulb-shaped axon terminal labeled 'Axon terminal' above a row of small circles labeled 'Synaptic vesicles,' releasing dots labeled 'Acetylcholine' into a gap labeled 'Synaptic cleft' above the cell's wavy membrane, which is studded with receptors labeled 'Acetylcholine receptor.' Below the membrane, a tube dips down and is labeled 'T tubule,' beside a light blue kidney-shaped sac labeled 'Sarcoplasmic reticulum (muscle cell endoplasmic reticulum),' releasing small blue dots labeled 'Ca²⁺' through a gray arrow into a small inset drawing of the beaded actin-myosin cross-bridge below. Four numbered circles mark this panel in reading order: 1 at the membrane where acetylcholine meets its receptors, 2 at the T tubule, 3 at the sarcoplasmic reticulum releasing Ca²⁺, and 4 at the inset cross-bridge drawing. Panel (b), at right, repeats the same axon terminal and membrane, now labeled 'Sarcolemma (muscle cell plasma membrane)' and 'Acetylcholine,' with an enzyme labeled 'Acetylcholinesterase' drawn among the receptors; the same sarcoplasmic reticulum sac now shows blue dots moving back up into it, and the inset cross-bridge drawing below shows the myosin head detached, carrying 'ADP' and 'P' ovals. Three numbered circles mark this panel: 5 at the membrane where acetylcholinesterase meets acetylcholine, 6 at the sarcoplasmic reticulum, and 7 at the inset cross-bridge drawing. Below both panels, seven numbered sentences restate each step: (1) acetylcholine released from synaptic vesicles in the axon terminal binds to receptors on the muscle cell plasma membrane; (2) an action potential is initiated that travels down the T tubule; (3) calcium ions are released from the sarcoplasmic reticulum in response to the change in voltage; (4) calcium ions bind to troponin, exposing active sites on actin, cross-bridge formation occurs, and muscles contract; (5) acetylcholinesterase removes acetylcholine from the synaptic cleft; (6) calcium ions are transported back into the sarcoplasmic reticulum; (7) tropomyosin binds active sites on actin, causing the cross-bridge to detach." >}}
...
at first, muscle activity is intense and uncontrolled
the ion gradients dissipate, so electrical signals in the T-tubules are no longer possible
...
{{< multiplechoice
  ...
  answer="sarcolemma"
  hint="This is the term used earlier in the section for a skeletal muscle fiber's plasma membrane — not the cytoplasm inside it or the smaller cylindrical bundles running through it."
>}}
myofibril
sarcolemma
sarcoplasm
...
{{< textin
  ...
  hint="This tissue lacks striations and has just one nucleus per spindle-shaped cell — unlike the other two types of muscle tissue this section describes."
>}}
...
{{< multiplechoice
  question="In relaxed muscle, the myosin-binding site on actin is blocked by ________."
  answer="tropomyosin"
  hint="This is the regulatory protein that must change shape and move aside before actin and myosin can form a cross-bridge — not the protein that then binds calcium and helps position it."
>}}
titin
troponin
myoglobin
...
{{< multiplechoice
  question="The muscle relaxes if no new nerve signal arrives. However the neurotransmitter from the previous stimulation is still present in the synapse. The activity of ________ helps to remove this neurotransmitter."
  answer="acetylcholinesterase"
  hint="This is the enzyme that breaks acetylcholine down into acetyl and choline once it has done its job at the synapse."
>}}
myosin
action potential
tropomyosin
...
muscles would remain rigidly contracted until more ATP was available for the myosin cross-bridge release
...
the length of the muscle fiber at rest

...
{{< mediafigure src="biology/Figure_38_01_13" kind="diagram" alt="The human lower-limb skeleton seen from the front, both legs hanging from the pelvis, with leader-line labels on the right-hand leg naming the thigh, leg, and foot bones." longdesc="Two legs are shown side by side below the pelvis, with one set of leader-line labels that point only to the right-hand leg (the left is identical and unlabeled): 'Femur' labels the thigh bone; 'Patella' labels the kneecap; 'Tibia' labels the thicker, inner bone of the lower leg; 'Fibula' labels the thinner, outer bone of the lower leg; 'Tarsals' labels the ankle bones; 'Metatarsals' labels the bones of the foot; 'Phalanges' labels the toe bones at the bottom — seven labels in all." >}}
...
{{< mediafigure src="biology/Figure_38_01_14" kind="diagram" alt="Two views of the human foot and ankle skeleton side by side, with three bracket labels naming the tarsal, metatarsal, and phalange bones shared by both." longdesc="Two feet are shown side by side. Three bracket labels on the right attach only to the right-hand foot (the left is identical and unlabeled): 'Tarsals' brackets the cluster of ankle bones at the back of the foot; 'Metatarsals' brackets the row of long bones across the middle of the foot; 'Phalanges' brackets the toe bones at the front — three labels in all." >}}

...
{{< multiplechoice
  ...
  hint="The humerus is named elsewhere in this section as the single bone of the upper arm, not the forearm — which two other bones does the section name as making up the forearm itself?"
>}}
radius and ulna
radius and humerus
ulna and humerus
...
{{< multiplechoice
  ...
  hint="The sternum and the coccyx are axial-skeleton bones the pectoral girdle attaches to or near, not girdle bones themselves — which two bones does the section name as making up the girdle?"
>}}
...
{{< multiplechoice
  ...
  answer="pelvic"
  hint="Three of these terms name actual groups of vertebrae in the vertebral column; one instead names a different region of the skeleton."
>}}
thoracic
cervical
lumbar
...
{{< multiplechoice
  ...
  answer="lacrimal"
  hint="Frontal, occipital, and temporal are named among the section's eight cranial bones — the facial bones are listed separately, just after them."
>}}
frontal
occipital
lacrimal
...
{{< textin
  ...
  answer="skull"
  accept="cranium"
  hint="This structure is made of 22 bones in total, split into cranial bones and facial bones."
>}}
...
{{< multiplechoice
  ...
  hint="Re-read each statement against the section's own sentences on growth, organism size, and defense — one topic here is never mentioned by the section at all."
>}}

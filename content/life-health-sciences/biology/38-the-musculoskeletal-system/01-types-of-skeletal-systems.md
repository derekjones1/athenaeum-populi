...
description: >-
  The three skeleton designs — hydrostatic, exoskeleton, and endoskeleton —
  and how the human endoskeleton's axial and appendicular divisions support,
  protect, and move the body — adapted from OpenStax Biology 2e, Section 38.1.
source_section: "38.1"
weight: 1
---
...
{{< mediafigure src="biology/Figure_38_01_01" kind="photo" eager="true" alt="Photo shows a white sea star with red bumps along the tops and tips of its arms." >}}
The skeleton of the red-knobbed sea star (*Protoreaster linckii*) is an example of a hydrostatic skeleton. (credit: “Amada44”/Wikimedia Commons)
{{< /mediafigure >}}
...
{{< mediafigure src="biology/Figure_38_01_02" kind="photo" alt="Photo shows a crab with orange legs and a black body crawling on a tree." >}}
...
{{< mediafigure src="biology/Figure_38_01_03" kind="photo" alt="Photo shows a human skeleton riding a bucking horse skeleton." >}}
...
{{< mediafigure src="biology/Figure_38_01_05" kind="diagram" alt="A side view of a human skull, colored by region, with leader-line labels naming each cranial and facial bone visible from this angle." longdesc="The skull is shown from its left side, face toward the viewer's left, colored by bone. Reading top to bottom on the left: 'Frontal' labels the pale yellow forehead region; 'Sphenoid' labels a small pink area behind the eye socket; 'Ethmoid' labels a thin orange-red sliver inside the eye socket, just behind the lacrimal; 'Nasal' labels the small green bone at the bridge of the nose; 'Lacrimal' labels a small tan area inside the eye socket, near the nose; 'Maxilla' labels the olive-green upper-jaw bone bearing the upper teeth; 'Mandible' labels the pale blue lower-jaw bone at the bottom, bearing the lower teeth — seven labels. On the right: 'Parietal' labels the large blue dome making up most of the skull roof; 'Temporal' is printed directly on the orange bone that makes up the side of the skull, below the parietal, with no leader line; 'Zygomatic', printed at the lower right, leads up to the white cheekbone below and behind the eye socket; 'Occipital' leads to the green area at the lower back of the skull — four more labels, eleven in all." >}}
...
{{< mediafigure src="biology/Figure_38_01_06" kind="diagram" alt="A front (anterior) view of a human skull, colored by bone, with leader-line labels on the left, the top three under a 'Cranial bones' bracket, and on the right under a 'Facial bones' bracket." longdesc="The skull is shown from the front. On the left, five leader-line labels run top to bottom, the first three gathered by a bracket labeled 'Cranial bones': 'Frontal bone' (the pink dome across the top), 'Parietal bone' (tan, at the side above the temple, behind the frontal bone), 'Sphenoid bone' (two leader lines, one to a tan patch at the temple and one to the tan back wall of the eye socket); then, below the bracket, 'Temporal bone' (mauve, at the side of the skull) and 'Ethmoid bone' (a small mauve sliver on the inner wall of the eye socket). A bracket on the right labeled 'Facial bones' gathers eight leader-line labels, top to bottom: 'Orbit' (a small bracket over the eye socket opening), 'Lacrimal bone' (a small pale yellow-green bone on the inner wall of the eye socket), 'Palatine bone' (a tiny spot at the inner floor of the eye socket), 'Zygomatic bone' (the cheekbone beside the eye socket), 'Nasal bone' (the bridge of the nose), 'Vomer' (a thin bone in the center of the nasal opening), 'Maxilla' (the upper jaw bearing the upper teeth), and 'Mandible' (the lower jaw bearing the lower teeth, at the bottom) — thirteen labels in all. A caption beneath the drawing reads 'Anterior view.'" >}}
The cranial bones, including the frontal, parietal, ethmoid, and sphenoid bones, cover the top of the head. The facial bones of the skull form the face and provide cavities for the eyes, nose, and mouth.
{{< /mediafigure >}}
...
{{< mediafigure src="biology/Figure_B38_01_07ab" kind="diagram" alt="Two illustrations of the human vertebral column: (a) a color-coded column of individual vertebrae, each labeled by its region and number, and (b) a side view of a body with the spine's four curves labeled and bracketed." longdesc="The figure is headed 'Vertebral Column.' (a) A vertical color-coded stack of vertebrae is labeled top to bottom, one leader line per bone except 'C1 (Atlas),' which is printed beside the top bone without a line: 'C1 (Atlas),' 'C2 (Axis),' 'C3,' 'C4,' 'C5,' 'C6,' 'C7' (seven cervical vertebrae, colored red-orange); 'Th1' through 'Th12' (twelve thoracic vertebrae, colored purple); 'L1' through 'L5' (five lumbar vertebrae, colored yellow); 'Os sacrum' (the fused triangular bone, colored green); and 'Coccyx' (the small tailbone below it, magenta) — 26 labels in all. (b) A side view of a body outline shows the spine curving through the neck, chest, lower back, and pelvis, with five leader-line labels — 'Cervical vertebrae,' 'Thoracic vertebrae,' 'Lumbar vertebrae,' 'Sacrum,' and 'Coccygeal vertebrae' — pointing to the matching regions of the spine, and four bracket labels along the right margin — 'Cervical curve,' 'Thoracic curve,' 'Lumbar curve,' and 'Sacral curve' — spanning the neck, chest, and lower-back regions and, for the sacral curve, the sacrum and coccygeal vertebrae together." >}}
...
{{< mediafigure src="biology/Figure_38_01_11" kind="diagram" alt="Two views of the human upper-limb skeleton, front and back, with leader-line labels naming the arm, forearm, and hand bones shared by both." longdesc="Two upper limbs are shown side by side, one from the front and one from behind, with the labels printed between them: 'Humerus' (the single long bone of the upper arm), 'Ulna' and 'Radius' (the two forearm bones, the ulna on the pinky-finger side and the radius on the thumb side), and 'Carpals' (the small wrist bones) each have two leader lines, one to each limb; 'Metacarpals' is a small bracket on the left hand's palm bones only; 'Phalanges' is a bracket on the right hand's finger bones only — six labels in all." >}}
...
{{< mediafigure src="biology/Figure_38_01_13" kind="diagram" alt="The human lower-limb skeleton seen from the front, both legs hanging from the pelvis, with leader-line labels on the right-hand leg naming the thigh, leg, and foot bones." longdesc="Two legs are shown side by side below the pelvis, with one set of leader-line labels that point only to the right-hand leg (the left-hand one, its mirror image, is unlabeled): 'Femur' labels the thigh bone; 'Patella' labels the kneecap; 'Tibia' labels the thicker, inner bone of the lower leg; 'Fibula' labels the thinner, outer bone of the lower leg; 'Tarsals' labels the ankle bones; 'Metatarsals' labels the bones of the foot; 'Phalanges' labels the toe bones at the bottom — seven labels in all." >}}
...
{{< mediafigure src="biology/Figure_38_01_14" kind="diagram" alt="The skeletons of a left and a right human foot and ankle side by side, seen from above as mirror images, with three bracket labels on the right-hand foot naming the tarsal, metatarsal, and phalange bones." longdesc="Two feet are shown side by side. Three bracket labels on the right attach only to the right-hand foot (the left-hand one, its mirror image, is unlabeled): 'Tarsals' brackets the cluster of ankle bones at the back of the foot; 'Metatarsals' brackets the row of long bones across the middle of the foot; 'Phalanges' brackets the toe bones at the front — three labels in all." >}}
...
{{< multiplechoice
  ...
  hint="Reread the first paragraph of The Upper Limb subsection."
>}}
radius and ulna
radius and humerus
ulna and humerus
...
{{< multiplechoice
  ...
  hint="Reread the opening sentences of The Pectoral Girdle subsection."
>}}
...
the female pelvis is wider, lighter, and shallower than the male pelvis
...
the pectoral girdle is only sparingly attached to the ribcage
the pelvic girdle's deep sockets make the femur more stable than the pectoral girdle's shallow sockets make the scapula
most tetrapods carry about 75 percent of their weight on the front legs because the head and neck are so heavy
...
===CHECKS===
normal vertebral columns are stacked in a vertical line
a sideways curve disrupts the support and cushioning functions of the vertebrae
...
{{< multiplechoice
  question="Which of the following is **not** a true statement comparing exoskeletons and endoskeletons?"
  answer="Exoskeletons provide less mechanical leverage."
  hint="Check each statement against the Exoskeleton and Endoskeleton subsections."
>}}
Endoskeletons can support larger organisms.
Only endoskeletons can grow as an organism grows.
Exoskeletons provide greater protection of the internal organs.
...
hydrostatic skeletons do not provide protection from external trauma
exoskeletons are hard structures that protect the organs from environmental damage
exoskeletons, being rigid, provide little shock absorption
{{< /selfcheck >}}

{{< textin
  question="Although a hydrostatic skeleton is well-suited to invertebrate organisms such as earthworms and some aquatic organisms, it is not an efficient skeleton for ________ animals."
  answer="terrestrial"
  accept="land"
  hint="Look at the last sentence of the section's first skeleton-design subsection."
>}}

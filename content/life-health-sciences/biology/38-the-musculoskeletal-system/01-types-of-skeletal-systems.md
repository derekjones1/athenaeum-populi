...
{{< mediafigure src="biology/Figure_38_01_14" kind="diagram" alt="Two views of the human foot and ankle skeleton side by side, with three bracket labels naming the tarsal, metatarsal, and phalange bones shared by both." longdesc="Two feet are shown side by side. Three bracket labels on the right point to both: 'Tarsals' brackets the cluster of ankle bones at the back of the foot; 'Metatarsals' brackets the row of long bones across the middle of the foot; 'Phalanges' brackets the toe bones at the front — three labels in all." >}}

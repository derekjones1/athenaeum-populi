...
description: >-
  How meiosis reduces a diploid cell's chromosome number by half through two
  rounds of nuclear division, the cellular events of meiosis I and meiosis
  II, how meiosis compares with mitosis, and the crossover and
  independent-assortment mechanisms that make every gamete genetically
  unique — adapted from OpenStax Biology 2e, Section 11.1.
source_section: "11.1"
weight: 1
---
...
{{< callout type="info" >}}
**Link to Learning.** Watch [a video reviewing the process of meiosis](https://openstax.org/l/animal_meiosis).
{{< /callout >}}
...
{{< callout type="info" >}}
**Link to Learning.** Click through [an interactive animation comparing the meiotic process of cell division to mitosis](https://openstax.org/l/how_cells_dvide).
{{< /callout >}}
...
sister chromatids are held together at the centromere by cohesin proteins
the synaptonemal complex facilitates crossover between nonsister chromatids
...
the fused kinetochore ensures that each spindle microtubule will attach to both sister chromatids
{{< /selfcheck >}}
...
the chromosomes do not decondense and the nuclear envelopes do not form in telophase I
all of the stages of meiosis II have the same events as the stages of mitosis
in prophase II, the chromosomes are still condensed and there is no nuclear envelope
{{< /selfcheck >}}
...
this limits the genetic diversity of the individual's gametes to what occurs during independent assortment

...
{{< mediafigure src="biology/Figure_B42_02_04" kind="diagram" alt="A flow chart shows a CD4⁺ helper T cell being activated by an antigen-presenting cell and cloning itself, with its clones activating a B cell and a CD8⁺ T cell that becomes cytotoxic; a second flow chart shows that cytotoxic T cell releasing perforins and granzymes to lyse an infected cell." longdesc="Two boxed flow charts, each a left-to-right sequence of illustrations linked by gray arrows, with a numbered caption below each step. Top box, labeled CD4⁺ T cells: an antigen-presenting immune cell displays an epitope on an MHC II molecule; a CD4⁺ helper T cell binds it via its T cell receptor and CD4, and both cells release cytokines — caption 1. An arrow leads to the activated helper T cell, still releasing cytokines — caption 2. A second arrow leads to two identical T cell clones. Two more arrows lead from the clones to their targets: a B cell that clones itself, and a CD8⁺ T cell that becomes cytotoxic — caption 3. Bottom box, labeled CD8⁺ T cells: a cytotoxic T cell, bearing CD8, granzymes, and perforins, binds the MHC I–epitope complex on an infected cell — caption 1. An arrow leads to the infected cell as perforins open pores in its membrane and granzymes enter — caption 2. A second arrow leads to the lysed, fragmented cell beside the cytotoxic T cell." >}}
...
{{< mediafigure src="biology/Figure_42_02_07" kind="diagram" alt="Two rows of illustrations. In the top row, a natural killer cell touches a healthy cell displaying MHC I and does not harm it. In the bottom row, a natural killer cell touches an infected cell that lacks MHC I, and an arrow leads to that cell being destroyed." longdesc="Top row, left to right: an NK cell approaches a healthy cell whose surface is studded with MHC I markers; an arrow leads to the same healthy cell afterward, unchanged. Bottom row, left to right: an NK cell approaches an infected cell, marked by two small virus particles and displaying no MHC I; an arrow leads to that cell afterward, burst into fragments." >}}
...
{{< mediafigure src="biology/Figure_42_02_08" kind="diagram" alt="A cross-section of intestinal lining shows M cells taking up antigen and passing it to dendritic cells, which migrate to a Peyer's patch where T cells and B cells are activated, some traveling through the lymphatic system to the lymph nodes and back, while activated cells at the surface secrete IgA into the intestinal lumen." longdesc="Reading left to right across the intestinal lining: an M cell, shaped like an upside-down U, sits among column-shaped epithelial cells (labeled epithelial cell — the artwork's own label misspells this 'Epithilial cell') whose surface cilia and mucous coat are labeled Mucous. Small dots labeled Antigen are taken up by the M cell into the pocket formed by its underside. Below the epithelium, a bracket labels the Peyer's patch, containing two blue ovals labeled Organized lymphoid follicles, each holding T cell and B cell labels. One gray arrow leads down from the follicles into a boxed inset below; a second, curving gray arrow leads from the follicles, past a label reading Lymphatic system, up through the epithelium at the right, where Y-shaped antibodies labeled IgA are released into the intestinal lumen at the surface. The inset magnifies one follicle: star-shaped dendritic cells display red MHC II tags to green T cells and to pink B cells, one of which is labeled at its Y-shaped B cell receptor." >}}
...
{{< textin
  ...
  accept="acquired immunity"
  hint="This is the immune system's slower, second line of defense — the one this whole section describes, as opposed to the system that acts within minutes using genetically fixed defenses."
>}}
...
{{< multiplechoice
  ...
  answer="missing self"
  hint="NK cells recognize a normal cell by checking for MHC I; the four options each pair “self” with a different qualifier — think about which one names a molecule that has been lost entirely, rather than one that looks foreign, unusual, or unrecognizable."
>}}
altered self
missing self
normal self
...
{{< multiplechoice
  ...
  answer="plasma cell"
  hint="A memory B cell skips the naive stage entirely and differentiates directly into the antibody-secreting cell type this section names in the paragraph about clonal selection — which option is that cell type, rather than a T-cell population?"
>}}
CTL
naïve B cell
memory T cell
...
{{< multiplechoice
  ...
  hint="This term describes the immune system deliberately NOT reacting to something harmless — think about which of the four options names a state of restraint rather than a state of reacting too much or attacking the wrong target."
>}}

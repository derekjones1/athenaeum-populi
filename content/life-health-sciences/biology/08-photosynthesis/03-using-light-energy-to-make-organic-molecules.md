...
description: >-
  How the Calvin cycle uses ATP and NADPH to fix carbon dioxide into G3P
  through the stages of fixation, reduction, and regeneration, and how
  photosynthesis and cellular respiration form a continuous energy cycle
  between all living things — adapted from OpenStax Biology 2e, Section 8.3.
source_section: "8.3"
weight: 3
---
...
{{< callout type="info" >}}
**Link to Learning.** This link leads to [an animation of photosynthesis and the Calvin cycle](https://openstax.org/l/calvin_cycle).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_08_03_03-cd68" kind="photo" alt="A cluster of round, spiny cacti, some green and some dried reddish-brown at the top, growing wedged among light gray rocks." >}}

...
description: >-
  The three cytoskeletal fiber types — microfilaments, intermediate
  filaments, and microtubules — their structures and roles, the "9 + 2"
  microtubule array shared by cilia and flagella, and how these and other
  cell components differ across prokaryotic, animal, and plant cells —
  adapted from OpenStax Biology 2e, Section 4.5.
source_section: "4.5"
weight: 5
---
...
{{< callout type="info" >}}
**Link to Learning.** To see an example of a white blood cell in action, watch [a short time-lapse video of a white blood cell capturing two bacteria](https://www.openstax.org/l/chasing_bcteria). It engulfs one and then moves on to the other.
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_04_05_03" kind="diagram" alt="An illustration of several intertwined strands of fibrous protein bundled together to form an intermediate filament." >}}
...
{{< mediafigure src="biology/Figure_04_05_05" kind="photo" alt="A transmission electron micrograph showing cross sections of two flagella, each a ring of nine microtubule doublets surrounding a single central microtubule doublet, with a scale bar reading 30 nm." >}}
...
Gram-negative bacteria also have an additional outer membrane containing lipopolysaccharides that surrounds their cell wall
{{< /selfcheck >}}

{{< multiplechoice
  question="According to the table above, which cell structure is present in prokaryotic cells and in plant cells, but absent in animal cells?"
  answer="Cell wall"
  hint="Look for the row where the answer is “Yes” under both Prokaryotes and Plant Cells, but “No” under Animal Cells."
>}}
Cell wall
Mitochondria
Golgi apparatus

...
description: >-
  How DNA polymerase, helicase, primase, and other enzymes replicate the
  antiparallel, double-stranded prokaryotic chromosome from a single origin,
  and why one new strand is synthesized continuously while the other forms
  Okazaki fragments — adapted from OpenStax Biology 2e, Section 14.4.
source_section: "14.4"
weight: 4
---
...
The following table summarizes the enzymes involved in prokaryotic DNA replication and the functions of each.
...
{{< callout type="info" >}}
**Link to Learning.** Review [the full process of DNA replication](https://openstax.org/l/replication_DNA).
{{< /callout >}}
...
- **exonuclease** — enzymes that cleave nucleotides one at a time from the end of a polynucleotide chain
...
synthesized in a direction away from the replication fork
...
if there is a mutated helicase gene, the replication fork will not be extended
{{< /selfcheck >}}
...
there would be no reaction in the tube without a primer
...
topoisomerase relieves the excess DNA supercoiling that occurs ahead of the replication fork
if topoisomerase is inhibited, DNA helicase will only be able to unwind the DNA for a short stretch before the supercoiling becomes too overwound
{{< /selfcheck >}}

...
description: >-
  Friedrich Miescher's discovery of nuclein, Griffith's bacterial
  transformation experiments, Avery, MacLeod, and McCarty's identification of
  DNA as the transforming principle, Hershey and Chase's radiolabeled
  bacteriophage experiment, and Chargaff's rules on base ratios — the
  experiments that established DNA as the genetic material — adapted from
  OpenStax Biology 2e, Section 14.1.
source_section: "14.1"
weight: 1
---
...
{{< mediafigure src="biology/Figure_14_01_01-1dae" kind="photo" alt="A black-and-white archival portrait photograph of Friedrich Miescher: a balding man with a full beard and mustache, wearing a dark suit, white collar, and dark necktie, gazing slightly to the side." eager="true" >}}
Friedrich Miescher (1844–1895) discovered nucleic acids.
{{< /mediafigure >}}

{{< callout type="info" >}}
**Link to Learning.** To see Miescher conduct the experiment that led to his discovery of DNA and its associated proteins in the nucleus, review [an interactive walkthrough of Miescher's isolation of nuclein](https://openstax.org/l/miescher_levene).
{{< /callout >}}
...
Chargaff demonstrated that A=T and G=C

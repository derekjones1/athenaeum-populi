...
description: >-
  How eukaryotic DNA replication differs from the prokaryotic process in
  scale, origins, and polymerases, and how the enzyme telomerase solves the
  end-replication problem at the ends of linear chromosomes — adapted from
  OpenStax Biology 2e, Section 14.5.
source_section: "14.5"
weight: 5
---
...
{{< mediafigure src="biology/Figure_14_05_02" kind="photo" alt="Elizabeth Blackburn, an older woman with shoulder-length gray hair and glasses, smiling at a reception, with blurred guests in the background." >}}
...
{"bins": ["Prokaryotes", "Eukaryotes"],
 "items": [
  ...
  {"label": "5 known DNA polymerase types", "bin": 0},
  {"label": "14 known DNA polymerase types", "bin": 1},
  {"label": "Telomerase not present", "bin": 0},
  {"label": "Telomerase present", "bin": 1},
  {"label": "RNA primer removed by DNA pol I", "bin": 0},
  {"label": "RNA primer removed by RNase H", "bin": 1},
  {"label": "Strand elongation carried out by DNA pol III", "bin": 0},
  {"label": "Strand elongation carried out by pol α, pol δ, and pol ε", "bin": 1}]}
{{< /sortbins >}}
...
extends the 3′ end
primer is synthesized and extended

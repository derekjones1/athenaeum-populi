...
description: >-
  The nucleotide building blocks of DNA, the Watson-Crick double-helix model,
  Sanger dideoxy sequencing, and how prokaryotic and eukaryotic cells package
  their DNA differently — adapted from OpenStax Biology 2e, Section 14.2.
source_section: "14.2"
weight: 2
---
...
{{< mediafigure src="biology/Figure_14_02_01" kind="diagram" eager="true" alt="Two-panel diagram. The left panel shows one nucleoside triphosphate: a pentose sugar labeled with carbons 5′, 4′, 1′, 3′, and 2′, a base attached at the 1′ position by a glycosidic bond, and a chain of three phosphate groups linked to the 5′ position, with brackets marking the nucleoside and the nucleoside monophosphate, diphosphate, and triphosphate. The right panel shows two boxed groups of ring structures: three pyrimidines (cytosine, thymine, uracil), each a single six-membered ring, and two purines (adenine, guanine), each a six-membered ring fused to a five-membered ring." longdesc="Left panel, reading right to left along the chain: a pentose sugar ring with carbons numbered 5′ (bearing the phosphate chain), 4′, 1′ (bonded to a blue Base label; a green arrow labeled glycosidic bond points to that bond), 3′ (bearing an OH group), and 2′, with a note that OH at 2′ means ribose and H at 2′ means deoxyribose; a chain of three red phosphate groups, each with a negative charge, extends from the 5′ carbon (the outermost phosphate carries two). Dashed brackets beneath the molecule mark, from shortest to longest phosphate chain: nucleoside (sugar plus base only), then the three nucleotides — nucleoside monophosphate, diphosphate, and triphosphate. Right panel, two boxed groups of ring diagrams with nitrogen and carbon positions labeled: the Pyrimidines box shows cytosine (C), thymine (labeled “in DNA,” T), and uracil (labeled “in RNA,” U), each a single six-membered ring with its own attached side groups; the Purines box shows adenine and guanine, each a six-membered ring fused to a five-membered ring, likewise with attached side groups." >}}
...
{{< selfcheck question="The images above illustrate the five bases of DNA and RNA. Examine the images and explain why these are called “nitrogenous bases.” How are the purines different from the pyrimidines? How is one purine or pyrimidine different from another, e.g., adenine from guanine? How is a nucleoside different from a nucleotide?" hint="The opening paragraph names what every base has in common; the ring drawings show what sets the two base families apart; the bracket labels below the sugar show what sets a nucleoside apart from a nucleotide." >}}
...
===CHECKS===
each one is a nitrogen-bearing ring structure
the purines have a double-ring structure, a six-membered ring fused to a five-membered ring
the pyrimidines are smaller, with a single six-membered ring
a nucleoside is a base attached to a five-carbon sugar
a nucleotide is a nucleoside with one, two, or three phosphate groups attached
{{< /selfcheck >}}
...
{{< mediafigure src="biology/Figure_14_02_02" kind="photo" alt="A circular X-ray diffraction photograph on a dark purple background, showing a symmetrical pattern of dark, blurred spots arranged in an X shape around a bright center." >}}
...
{{< mediafigure src="biology/Figure_14_02_03abc-c0c6" kind="diagram" alt="Three-panel illustration. Panel (a) shows a double helix ribbon with rungs colored by base, labeled sugar phosphate backbone and base pair. Panel (b) shows the chemical structures of a thymine–adenine pair joined by two dashed hydrogen bonds and a guanine–cytosine pair joined by three dashed hydrogen bonds, the bases sitting on two antiparallel sugar-phosphate strands with 5′ and 3′ ends marked. Panel (c) shows a molecular model of the double helix standing upright, with leader lines from either side pointing into it, labeled major groove and minor groove." longdesc="Panel (a): a light blue double helix with paired rungs colored red for adenine, orange for thymine, blue for guanine, and green for cytosine (a key titled “Nitrogenous bases:” gives the colors), two leader lines from “Base pair” to two rungs and one from “Sugar phosphate backbone” to the outer ribbon. Panel (b): two sugar-phosphate strands, one on each side. The left strand starts at a phosphate marked 5′ at top left, runs through the sugar carrying thymine, then a phosphate, then the sugar carrying guanine, ending at an HO group marked 3′ at bottom left. The right strand runs the opposite way: it starts at an OH marked 3′ at top right on the sugar carrying adenine, passes through a phosphate to the sugar carrying cytosine, and ends at a phosphate marked 5′ at bottom right. Thymine pairs with adenine at top by two dashed hydrogen bonds; guanine pairs with cytosine at bottom by three dashed hydrogen bonds. Panel (c): an upright ball-and-stick model of the helix, gray and white with red, orange, and green atoms and blue-violet base rungs; an elbowed leader line from “Major groove” at bottom left points into the helix's left side, and one from “Minor groove” at bottom right points into its right side." >}}
...
{{< callout type="info" >}}
**Link to Learning.** Visit [a video explaining the DNA sequence-reading technique that resulted from Sanger's work](https://openstax.org/l/DNA_sequencing).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_14_02_04ab-b7be" kind="diagram" alt="Two-panel diagram with no panel letters. The left panel shows four colored arrows of different lengths, each a DNA fragment terminated by a different dye-labeled dideoxynucleotide, aligned above a row of colored boxes spelling out a base sequence. The right panel shows an electropherogram: overlapping colored peaks above position numbers on an axis, with the corresponding base-call letters printed beneath the peaks." longdesc="Left panel: four arrow-shaped strands of different lengths, each capped by a triangular arrowhead colored to match the dideoxynucleotide named on it; top to bottom they are the longest, blue, ddCTP; a short one, green, ddATP; a longer one, black, ddGTP; and the shortest, red, ddTTP. They are stacked above a single row of eight colored boxes reading, left to right, G (black), A (green), T (red), T (red), C (blue), A (green), G (black), C (blue), captioned “Dye-labeled dideoxynucleotides are used to generate DNA fragments of different lengths.” Right panel: a trace of overlapping black, green, red, and blue peaks running left to right above the axis positions 120 and 130, with the base-call sequence “GATAAATCTGGTCTTATTTCC” printed in matching colors beneath the peaks." >}}
...
{{< callout type="info" >}}
**Link to Learning.** Sanger's genome sequencing has led to a race to sequence human genomes at rapid speed and low cost. Learn more by viewing [an animation about the race to sequence human genomes quickly and cheaply](https://openstax.org/l/DNA_and_genomes).
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_14_02_09" kind="photo" alt="Two side-by-side photographs. The first shows an agarose gel under UV light with nine lanes of glowing white DNA bands on a black background; the outer two lanes hold a DNA size standard with many closely spaced bands near the top and more widely spaced bands lower down, and the seven middle lanes each hold one or two sample bands at varying positions and spacing. The second shows gloved hands lowering an eight-channel pipette toward wells at the top of a blue gel." longdesc="First photo: an agarose gel, nine lanes across, imaged under UV light so the DNA fluoresces as thin white bands on a black background. Lanes one and nine (the outer lanes) each show many bands from a DNA size standard, closely spaced near the top of the gel and progressively farther apart toward the bottom. Lanes two through eight each show one or two bands; some sample lanes carry bands that run the same distance into the gel as a neighboring lane's (matching sizes), while others run a slightly different distance (a small size difference). Second photo: one gloved hand grips a handheld multichannel pipette fitted with eight tips while a second gloved hand steadies its base, lowering the tips into a row of wells near the top of a blue gel in its tray; that row and a second row of wells near the bottom of the gel show as dashed lines of blue dye." >}}
...
{{< callout type="info" >}}
**Link to Learning.** Watch [Svante Pääbo's talk explaining the Neanderthal genome research](https://openstax.org/l/neanderthal) at the 2011 annual TED (Technology, Entertainment, Design) conference.
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_14_02_06_new" kind="diagram" alt="Side-by-side diagram. The eukaryotic cell on the left is large and oval, with labeled arrows pointing to the Nucleus, the Nucleolus inside it, and the Chromatin strands filling the nucleus, plus assorted organelles scattered through the cytoplasm. The prokaryotic cell on the right is much smaller and oval, with a labeled arrow pointing to a compact region of DNA called the Nucleoid (folded chromosome)." longdesc="Eukaryotic cell (left, labeled Eukaryote): a large yellow oval cell with a rounded nucleus, ringed by a blue nuclear envelope, containing purple coiled chromatin strands and a dark purple nucleolus; leader lines labeled Nucleus, Nucleolus, and Chromatin point to those structures. Around the nucleus, blue-violet folded membranes (endoplasmic reticulum) are studded with small red dots (ribosomes); the rest of the cytoplasm holds three orange mitochondria, small light blue vesicles, a pink stack of curved sacs (Golgi apparatus), and scattered green and pink circles. Prokaryotic cell (right, labeled Prokaryote), drawn much smaller: a small oval with a thick tan wall and a single wavy flagellum, holding scattered small red dots and, near its center, a compact red-orange clump labeled by a leader line reading Nucleoid (folded chromosome); it has no nucleus or other membrane-bound compartment." >}}
...
{{< selfcheck question="In eukaryotic cells, DNA and RNA synthesis occur in a separate compartment from protein synthesis. In prokaryotic cells, both processes occur together. What advantages might there be to separating the processes? What advantages might there be to having them occur together?" hint="Compare where the DNA sits in the two cells of the figure above, then weigh what each arrangement gains." >}}
...
===CHECKS===
compartmentalization enables a eukaryotic cell to divide processes into discrete steps
build more complex protein and RNA products
RNA and protein synthesis occurs much more quickly in a prokaryotic cell
{{< /selfcheck >}}
...
{{< mediafigure src="biology/Figure_14_02_07-de13" kind="diagram" alt="A five-row diagram titled “Organization of Eukaryotic Chromosomes,” each row showing one level of packaging; a bracket under each row's whole drawing leads down to a small box marking the tiny part of the next row that it magnifies: DNA double helix; DNA wrapped around a histone; nucleosomes coiled into a chromatin fiber; further condensation of the chromatin fiber around a central scaffold; and a duplicated, X-shaped chromosome." longdesc="Row 1, “DNA double helix”: a light blue double helix with colored rungs; a bracket spanning the whole helix leads down to a small box outlining a short stretch of the DNA in row 2. Row 2, “DNA wrapped around histone”: the double helix coiled around a cluster of colored globular histone proteins; a bracket spanning the whole drawing leads down to a small box around one bead in row 3. Row 3, “Nucleosomes coiled into a chromatin fiber”: a row of the histone-DNA beads strung together and coiled into a thicker fiber; a bracket spanning the whole fiber leads down to a small box on one loop in row 4. Row 4, “Further condensation of chromatin”: the fiber shown looped repeatedly around a central red rod-like scaffold; a bracket spanning the whole drawing leads down to a small box on one arm of the chromosome in row 5. Row 5, “Duplicated chromosome”: two blue sister chromatids, each with a yellow centromere, touching at their centromeres to form an X, the most condensed and final structure in the sequence." >}}
...
{{< multiplechoice
  question="DNA double helix does not have which of the following?"
  answer="uracil"
  hint="Reread the section's opening paragraphs on the structure of the double helix, then check each option against them."
>}}
...
{{< multiplechoice
  question="According to the section summary, the currently accepted model of the double-helix structure of DNA was proposed by ________."
  answer="Watson and Crick"
  hint="Reread the section summary's first sentence."
>}}
Pauling and Wilkins
...
{{< selfcheck question="Describe the structure and complementary base pairing of DNA." hint="Reread the paragraph after the X-ray diffraction photograph and the three-panel double-helix figure." >}}
...
===CHECKS===
DNA has two strands in anti-parallel orientation
the sugar-phosphate linkages form a backbone on the outside
the bases are paired on the inside: A with T, and G with C
{{< /selfcheck >}}

### Explain the Sanger method of DNA sequencing

{{< textin
  question="The technique used to separate DNA fragments according to size is called ________."
  answer="electrophoresis"
  accept="gel electrophoresis"
  hint="Reread the paragraph after the second Link to Learning in DNA Sequencing Techniques."
>}}

{{< selfcheck question="Provide a brief summary of the Sanger sequencing method." hint="Reread the dideoxy chain termination paragraphs in DNA Sequencing Techniques and the figure between them." >}}
...
===CHECKS===
the template DNA strand is mixed with a DNA polymerase, a primer, the 4 deoxynucleotides, and a limiting concentration of 4 dideoxynucleotides
incorporation of ddNTPs at different locations results in DNA fragments that have terminated at every possible base in the template
these fragments are separated by gel electrophoresis and visualized by a laser detector
{{< /selfcheck >}}

{{< multiplechoice
  question="In the dideoxy chain termination method, a ddNTP halts strand synthesis because it lacks a free ________ needed to add the next nucleotide."
  answer="3′ OH group"
  hint="Reread the paragraph that introduces the dideoxy chain termination method."
>}}
5′ phosphate group
3′ OH group
2′-OH group
...
{{< textin
  question="According to the section summary, eukaryotic chromosomes have two distinct regions that can be distinguished by ________, reflecting different states of packaging and compaction."
  answer="staining"
  hint="Reread the section summary's last sentence."
>}}

{{< multiplechoice
  question="In eukaryotes, what is the DNA wrapped around?"
  answer="histones"
  hint="Reread the paragraph on how eukaryotes pack their linear chromosomes, in DNA Packaging in Cells."
>}}
...
{{< selfcheck question="Prokaryotes have a single circular chromosome while eukaryotes have linear chromosomes. Describe one advantage and one disadvantage to the eukaryotic genome packaging compared to the prokaryotes." hint="Start from DNA Packaging in Cells, then weigh what packing more DNA gains a cell against what it costs." >}}

...
title: DNA Repair
description: >-
  How DNA polymerase's proofreading, mismatch repair, and nucleotide excision
  repair correct replication errors and UV damage, the point and frameshift
  mutations that arise when errors go uncorrected, and the skin-cancer risk
  of xeroderma pigmentosa — adapted from OpenStax Biology 2e, Section 14.6.
source_section: "14.6"
weight: 6
---
...
{{< mediafigure src="biology/Figure_14_06_04" kind="photo" alt="A close, side-on photo of the lower half of a person's face, showing extensive mottled, rough, dark brown and black skin lesions concentrated around the nose, cheek, and upper lip." >}}
...
deletion of an "A" in the 12th position of the coding region
{{< /selfcheck >}}

---
title: "Knowledge Check: Unit 7 — Chapters 33–43"
description: >-
  A cumulative self-test on Unit 7, Animal Structure and Function — the
  animal body, nutrition and digestion, the nervous, sensory, endocrine,
  musculoskeletal, respiratory, circulatory, osmoregulatory, and immune
  systems, and animal reproduction and development — with every question
  written from the chapters' own text in OpenStax Biology 2e.
source_chapters: "33-43"
weight: 50
---

{{< callout type="info" >}}
  **Test yourself on Unit 7: Animal Structure and Function (Chapters 33–43).** Every question below was written from
...
{{< multiplechoice
  question="Approximately what is the basal metabolic rate (BMR) of a human male?"
  answer="1600 to 1800 kcal/day"
>}}
...
{{< selfcheck question="Why does a larger spherical cell have less effective diffusion than a smaller one, in terms of its surface-to-volume ratio?" >}}
...
{{< textin
  question="The type of tissue that either lines or covers organs or other tissues in the body is called ________."
  answer="epithelial tissue"
  accept="epithelium|epithelia|epithelial"
>}}

{{< multiplechoice
  question="Besides storing fat for energy metabolism, what other roles does adipose tissue serve?"
  answer="Insulation to help maintain body temperature and cushioning against damage to body organs."
>}}
Insulation to help maintain body temperature and cushioning against damage to body organs.
Transport of oxygen and carbon dioxide through the body.
Providing structure to the animal and points of attachment for tendons.
Participating in the stages leading up to coagulation of the blood.
{{< /multiplechoice >}}

{{< selfcheck question="What components make up loose (areolar) connective tissue, and where in the body is it found?" >}}
...
loose connective tissue has fibroblasts and macrophages
loose connective tissue is found around every blood vessel and helps to keep the vessel in place
it is also found around and between most body organs
{{< /selfcheck >}}

### 33.3 Homeostasis

{{< textin
  question="The hormone released when blood calcium levels decrease, increasing calcium absorption through the intestines and kidneys, is called ________."
  answer="parathyroid hormone"
  accept="PTH"
>}}

{{< multiplechoice
  question="Which mechanism helps an endotherm conserve heat by reducing blood flow in peripheral blood vessels and forcing blood toward the body's core?"
...
{{< selfcheck question="When a change occurs in an animal's environment, what is the pathway of events from detection to response?" >}}
...
===CHECKS===
the receptor senses the change in the environment
sends a signal to the control center, which in turn generates a response that is signaled to an effector
...
{{< multiplechoice
  question="In earthworms, the digestive system consisting of one tube with a mouth at one end and an anus at the other is called the ________."
...
===CHECKS===
pepsin is synthesized in an inactive form called pepsinogen
pepsinogen does not have the same enzyme functionality as pepsin
...
{"bins": ["Must be consumed", "Anabolized by the body"],
 "items": [
  {"label": "isoleucine", "bin": 0},
  {"label": "alanine", "bin": 1},
  {"label": "leucine", "bin": 0},
  {"label": "aspartate", "bin": 1},
  {"label": "lysine", "bin": 0},
  {"label": "cysteine", "bin": 1},
  {"label": "methionine", "bin": 0},
  {"label": "glycine", "bin": 1},
  {"label": "phenylalanine", "bin": 0},
  {"label": "serine", "bin": 1}]}
{{< /sortbins >}}
...
{{< multiplechoice
  question="Which of the following peptide-digesting enzymes both reduces peptides to free amino acids and is produced by the pancreas?"
...
{{< textin
  question="The elimination of food by forceful expulsion through the mouth, regulated by the medulla, is called ________."
  answer="emesis"
  accept="vomiting|vomit"
>}}

{{< selfcheck question="Why does emulsification by bile salts increase the efficiency of lipid digestion by pancreatic lipases?" >}}
...
===CHECKS===
very little surface area of the lipids is available for the lipases to act on if they aggregate into large globules
bile salts increase the available surface area of the lipids manyfold by forming an emulsion
the pancreatic lipases can then act on the lipids more efficiently and digest them
{{< /selfcheck >}}

### 34.4 Digestive System Regulation

{{< multiplechoice
  question="Which of the following is one of the three factors that stimulate the gastric phase?"
...
===CHECKS===
it triggers other hormonal and neural events
coordinate the activities of the intestinal tract, pancreas, liver, and gallbladder
{{< /selfcheck >}}
...
{{< multiplechoice
  question="Which structure on a neuron's cell body integrates signals from multiple synapses and serves as the junction between the cell body and the axon?"
  answer="axon hillock"
>}}
axon terminal
node of Ranvier
...
===CHECKS===
neurogenesis is the birth of new neurons, and it continues into adulthood
about 1,000 new neurons develop in the hippocampus each day
exercise and some antidepressant medications promote neurogenesis in the hippocampus
...
it can be recycled, sometimes called reuptake, by the presynaptic neuron
{{< /selfcheck >}}

### 35.3 The Central Nervous System

{{< multiplechoice
  question="Which brain structure sits at the base of the brain atop the brainstem and controls balance while helping coordinate movement and learning new motor tasks?"
...
===CHECKS===
the olfactory nerve transmits only sensory information, carrying information about smells from the nose to the brainstem
the oculomotor nerve transmits almost solely motor information, controlling the opening and closing of the eyelid and some eye movements
the glossopharyngeal nerve carries a mix of sensory and motor fibers, with a role in both taste and swallowing
{{< /selfcheck >}}
...
{{< multiplechoice
  question="Research on the cause of ADHD points to a delay and dysfunction in the development of which brain region, along with disturbances in neurotransmission?"
...
{{< multiplechoice
  question="Thermoreceptor pathways from the skin into the brain run from the spinal cord through the thalamus to which structure?"
  answer="the primary somatosensory cortex"
>}}
...
{{< selfcheck question="Why do peppers taste 'hot' even though capsaicin is a harmless stimulus rather than a true source of tissue injury?" >}}
...
===CHECKS===
pain also can be caused by harmless stimuli that mimic the action of damaging stimuli
capsaicins are the compounds that cause peppers to taste hot
...
{{< multiplechoice
  question="Which fundamental taste was identified in 1908 by Japanese scientist Kikunae Ikeda while he worked with seaweed broth?"
  answer="umami"
>}}
sweet
sour
...
from the medulla, taste signals travel to the thalamus
...
{{< multiplechoice
  question="A light wave's wavelength, which varies inversely with frequency, manifests itself to the visual system as ________."
  answer="hue"
>}}
hue
brightness
...
===CHECKS===
the magnocellular (big cell) pathway carries information about form, movement, depth, and differences in brightness
the parvocellular (small cell) pathway carries information on color and fine detail
in the thalamus, the magnocellular and parvocellular distinctions remain intact, with different layers of the thalamus dedicated to each
{{< /selfcheck >}}
...
{{< multiplechoice
  question="Steroid hormones are insoluble in water and are transported by transport proteins in the blood. What effect does this have on them compared with peptide hormones?"
  answer="They remain in circulation longer than peptide hormones."
>}}
They cannot pass through the plasma membrane of target cells.
Their chemical names end in “-ine.”
They remain in circulation longer than peptide hormones.
They are stored within vesicles until a stimulus triggers their release.
{{< /multiplechoice >}}

{{< textin
  question="The pineal gland in the brain makes and secretes ________, which regulates sleep cycles."
  answer="melatonin"
>}}

{{< selfcheck question="Why can't amino acid-derived and peptide hormones enter target cells directly, and where are their receptors located instead?" >}}
...
their receptors are found on the surface of the target cells
{{< /selfcheck >}}

### 37.2 How Hormones Work

{{< multiplechoice
  question="Vitamin D and thyroxine are lipid-soluble hormones that are not steroid hormones. Where are their receptors located?"
  answer="In the nucleus of the target cell."
>}}
On the outer surface of the plasma membrane.
Attached to a G-protein in the cell membrane.
In the cytoplasm, bound to a heat shock protein.
...
===CHECKS===
the binding of a hormone at a single receptor causes the activation of many G-proteins
each molecule of adenylyl cyclase triggers the formation of many molecules of cAMP
protein kinases activated by cAMP can catalyze many reactions
a small amount of hormone can trigger the formation of a large amount of cellular product
{{< /selfcheck >}}
...
===CHECKS===
the indirect mechanism of GH action is mediated by insulin-like growth factors (IGFs)
IGFs are growth-promoting proteins produced by the liver
IGFs stimulate the uptake of amino acids from the blood
...
{{< multiplechoice
  question="After a rise in blood glucose triggers insulin release, what signals the pancreas to stop producing insulin in the negative feedback loop?"
  answer="a drop in blood glucose levels"
>}}
...
{{< multiplechoice
  question="Most people have how many parathyroid glands, though the number can vary?"
  answer="four"
>}}
two
four
...
it is most prominent in infants, becoming smaller in size through adulthood
the thymus produces hormones called thymosins, which contribute to the development of the immune response
{{< /selfcheck >}}
...
{{< textin
  question="The process of deposition of mineral salts on the collagen fiber matrix that crystallizes and hardens bone tissue is called ________."
  answer="calcification"
>}}

{{< selfcheck question="What is appositional growth, and how do osteoblasts and osteoclasts work together to achieve it?" >}}
...
osteoblasts at the bone surface secrete bone matrix
osteoclasts on the inner surface break down bone
...
{{< multiplechoice
  question="Into how many categories are synovial joints classified, on the basis of the shape and structure of the joint?"
  answer="six"
>}}
two
three
...
{{< selfcheck question="What are the four categories used to classify joints structurally, and what determines which category a joint belongs to?" >}}
...
===CHECKS===
the structural classification divides joints into bony, fibrous, cartilaginous, and synovial joints
depending on the material composing the joint
the presence or absence of a cavity in the joint
{{< /selfcheck >}}

{{< multiplechoice
  question="Rheumatoid arthritis primarily affects the synovial joints of which body regions?"
  answer="the hands, feet, and cervical spine"
>}}
...
{{< multiplechoice
  question="What is the approximate maximum length of a skeletal muscle fiber?"
  answer="30 cm"
>}}
30 cm
100 µm
...
{{< selfcheck question="When a sarcomere shortens during muscle contraction, which of its bands or zones shrink and which stay the same length?" >}}
...
===CHECKS===
the H zone, the central region of the A band containing only thick filaments, is shortened during contraction
the I band, which contains only thin filaments, also shortens
the A band does not shorten and remains the same length
thin filaments are pulled by the thick filaments toward the center of the sarcomere
{{< /selfcheck >}}
...
{{< multiplechoice
  question="Which respiratory structure do earthworms and amphibians use to exchange gases with the outside environment?"
  answer="skin"
>}}
gills
tracheal system
...
{{< textin
  question="The domed skeletal muscle located under the lungs that marks the end of the thoracic cavity is called the ________."
  answer="diaphragm"
>}}
...
{{< multiplechoice
  question="About what percentage of atmospheric gas is oxygen?"
  answer="20.9 percent"
>}}
78.6 percent
20.9 percent
...
===CHECKS===
alveolar oxygen partial pressure is higher in the alveoli than blood oxygen partial pressure in the capillaries
because this pressure gradient exists, oxygen diffuses down its pressure gradient
moving out of the alveoli and entering the blood of the capillaries where oxygen binds to hemoglobin
{{< /selfcheck >}}

### 39.3 Breathing

{{< selfcheck question="Why did birds evolve a respiratory system suited to high oxygen demand, and from which ancient organisms did birds evolve?" >}}
...
many birds fly in high altitudes where the concentration of oxygen is low
birds evolved from theropods, meat-eating dinosaurs
...
{{< multiplechoice
  question="Emphysema, in which the walls of the alveoli are destroyed, has which effect on the lungs?"
  answer="increases the overall compliance of the lungs"
>}}
increases the overall compliance of the lungs
decreases the overall compliance of the lungs
decreases the amount of air trapped in the lungs at the end of exhalation
increases the surface area available for gas exchange
{{< /multiplechoice >}}

{{< textin
  question="A region of the lung that lacks proper ventilation or perfusion because of a functional impairment, such as infection or edema, rather than an anatomical block, is called ________."
  answer="physiological dead space"
  accept="physiological shunt|physiologic dead space|physiologic shunt"
>}}
...
{{< multiplechoice
  question="Which of the following conditions is caused by a defect in either the alpha or the beta subunit of hemoglobin, producing red blood cells with lower-than-normal levels of hemoglobin?"
  answer="thalassemia"
>}}
sickle cell anemia
thalassemia
...
{{< selfcheck question="Why is carbon monoxide poisoning particularly dangerous and hard to detect, and what symptoms can it cause?" >}}
...
carbon monoxide can cause headaches, confusion, and nausea
long-term exposure can cause brain damage or death
{{< /selfcheck >}}
...
{{< multiplechoice
  question="Which animals are the most primitive to exhibit a four-chambered heart?"
  answer="alligators and crocodiles"
>}}
mammals and birds
fish and amphibians
jellies and comb jellies
alligators and crocodiles
{{< /multiplechoice >}}

{{< selfcheck question="Why do biologists describe the four-chambered hearts of birds and mammals as an example of convergent evolution?" >}}
...
this independent evolution of the same or a similar biological trait is referred to as convergent evolution
{{< /selfcheck >}}

### 40.2 Components of the Blood

{{< multiplechoice
  question="Which respiratory pigment uses copper instead of iron to bind oxygen, and is found in mollusks, crustaceans, and some arthropods?"
  answer="hemocyanin"
>}}
chlorocruorin
hemocyanin
...
T cells attack viruses by releasing toxins that kill the viruses
{{< /selfcheck >}}

### 40.3 Mammalian Heart and Blood Vessels

{{< textin
  question="The complete blockage of the coronary arteries resulting in the death of cardiac muscle tissue is called ________."
  answer="myocardial infarction"
  accept="heart attack"
>}}

{{< multiplechoice
  question="Which event produces the heart's monosyllabic 'lup' sound?"
  answer="closing of the atrioventricular valves"
>}}
...
{{< multiplechoice
  question="What percentage of the body's capillary beds have blood actually flowing through them at any given moment?"
  answer="5–10%"
>}}
85%
15%
...
{{< textin
  question="Organisms such as goldfish that can tolerate only a relatively narrow range of salinity are referred to as ________."
  answer="stenohaline"
  accept="stenohaline organisms"
>}}
...
{{< multiplechoice
  question="In the planarian's excretory system, what happens to valuable metabolites drawn into the flame-cell tubules along with waste?"
  answer="recovered by reabsorption"
>}}
recovered by reabsorption
stored in a bladder before secretion
...
terrestrial organisms have evolved other mechanisms to excrete nitrogenous wastes
they must detoxify ammonia by converting it into a relatively nontoxic form such as urea or uric acid
{{< /selfcheck >}}
...
===CHECKS===
a fever causes the liver to withhold iron from the blood
certain pathogens, such as some bacteria, are unable to replicate without iron
...
{{< multiplechoice
  question="Approximately what percentage of circulating lymphocytes in human blood are T cells?"
  answer="80 to 90 percent"
>}}
80 to 90 percent
10 to 20 percent
0.1 percent
...
{{< textin
  question="The activation of B cells corresponding to one specific B cell receptor variant, and the dramatic proliferation of that variant, is called ________."
...
{{< multiplechoice
  question="The basic principle of radioimmunoassay (RIA) is which of the following?"
  answer="competitive binding"
>}}
competitive binding
opsonization
complement fixation
...
{{< textin
  question="The failure, insufficiency, or delay in the response of the immune system, which may be acquired or inherited, is called ________."
  answer="immunodeficiency"
  accept="immunodeficiencies|immune deficiency|immune deficiencies"
>}}
...
heart muscle has a similar structure to the surface of S. pyogenes
...
{{< textin
  question="In some species that change sex during their lives, being female first and later becoming male is termed ________."
  answer="protogyny"
  accept="first female|protogynous"
>}}
...
{{< selfcheck question="How does the structure of the mammalian uterus differ between species that produce large numbers of offspring at a time and species, such as primates, that produce one offspring at a time?" >}}
...
===CHECKS===
the uterus has two chambers in species that produce large numbers of offspring at a time
...
{{< textin
  question="The muscular tube that allows menstrual flow to leave the body and serves as the receptacle for the penis during intercourse is called the ________."
  answer="vagina"
>}}

{{< multiplechoice
  question="Which cells in the wall of the seminiferous tubules are described as 'nursemaid' cells that protect the developing germ cells and promote their development?"
...
{{< selfcheck question="What is the acrosome, and how does it help a sperm fertilize an egg?" >}}
...
===CHECKS===
an acrosome is found at the top of the head of the sperm
this structure contains lysosomal enzymes that can digest the protective coverings that surround the egg
...
{{< textin
  question="A condition in pregnant people during the first trimester that includes feelings of nausea is called ________."
  answer="morning sickness"
>}}

{{< multiplechoice
  question="From eight weeks of gestation, when the body is essentially formed, which term applies to the developing human?"
  answer="fetus"
>}}
zygote
blastocyst
...
{{< selfcheck question="How does an intrauterine device (IUD) work to prevent pregnancy?" >}}
...
and establish an inflammatory condition
that prevents fertilized eggs from implanting into the uterine wall
{{< /selfcheck >}}
...
{{< textin
  question="Each cell within the blastula is called a ________."
  answer="blastomere"
>}}
...
{{< textin
  question="The nematode used to study organogenesis that has roughly 1,000 somatic cells with a mapped developmental fate for each individual cell is called ________."
...
{{< multiplechoice
  question="Even though animal bodies have externally visible symmetry, which organ lies on the right side of the body rather than the left?"
  answer="the liver"
>}}
the heart
the brain

...
description: >-
  How pathogenic bacteria have caused historic plagues and epidemics, how
  biofilms drive foodborne disease, and why overuse of antibiotics is
  producing resistant "superbugs" such as MRSA — adapted from OpenStax
  Biology 2e, Section 22.4.
source_section: "22.4"
weight: 4
---
...
Bubonic plague is caused by the bacterium *Yersinia pestis*. One of the most devastating pandemics attributed to bubonic plague was the **Black Death** (1346 to 1361). It is thought to have originated in China and spread along the Silk Road, a network of land and sea trade routes, to the Mediterranean region and Europe, carried by fleas living on black rats that were always present on ships. The Black Death was probably named for the tissue necrosis, one of the symptoms shown below. The "buboes" of bubonic plague were painfully swollen areas of lymphatic tissue. A *pneumonic form* of the plague, spread by the coughing and sneezing of infected individuals, spreads directly from human to human and can cause death within a week. The pneumonic form was responsible for the rapid spread of the Black Death in Europe. The Black Death reduced the world's population from an estimated 450 million to about 350 to 375 million. Bubonic plague struck London yet again in the mid-1600s, also pictured below. In modern times, approximately 1,000 to 3,000 cases of plague arise globally each year, and a "sylvatic" form of plague, carried by fleas living on rodents such as prairie dogs and black footed ferrets, infects 10 to 20 people annually in the American Southwest. Although contracting bubonic plague before antibiotics meant almost certain death, the bacterium responds to several types of modern antibiotics, and mortality rates from plague are now very low.

{{< mediafigure src="biology/Figure_22_04_02" alt="Three panels. (a) A hand-colored engraving titled 'Plague in 1665' showing two men loading a dead body onto a horse-drawn cart while another body lies in the street. (b) A black-and-white scanning electron micrograph of numerous short, plump, oval bacteria, with a 500 nm scale bar. (c) A photograph of a patient's bare torso and hands, the wrists bandaged and the fingers discolored black from gangrene." kind="photo" >}}
...
{{< callout type="info" >}}
**Link to Learning.** Watch a [video](https://openstax.org/l/black_death) on the modern understanding of the Black Death—bubonic plague in Europe during the 14th century.
{{< /callout >}}
...
The distribution of a particular disease is *dynamic*. Changes in the environment, the pathogen, or the host population can dramatically impact the spread of a disease. According to the World Health Organization (WHO), an **emerging disease**, mapped below, is one that has appeared in a population for the first time, or that may have existed previously but is rapidly increasing in incidence or geographic range. This definition also includes *re-emerging diseases* that were previously under control. Approximately 75 percent of recently emerging infectious diseases affecting humans are zoonotic diseases. **Zoonoses** are diseases that primarily infect animals but can be transmitted to humans; some are of viral origin and some are of bacterial origin. Brucellosis is an example of a prokaryotic zoonosis that is re-emerging in some regions, and *necrotizing fasciitis* (commonly known as flesh-eating bacteria) has been increasing in virulence for the last 80 years for unknown reasons.

{{< mediafigure src="biology/Figure_22_04_03" alt="A world map with labeled points marking where bacterial diseases are emerging or re-emerging. Multidrug-resistant tuberculosis is marked in North America, Europe, north Africa, and Asia. Vancomycin-resistant Staphylococcus aureus and E. coli O157:H7 are marked in North America and East Asia. Lyme disease is marked in North America. Cholera is marked in Africa and South America. Diphtheria is marked in Russia and typhoid fever in South Asia." longdesc="A world map on a pale tan (land) and blue (ocean) background, with black lines connecting text labels to red dots marking specific locations. In North America, a line from 'E. coli O157:H7' points to a dot in the western United States, a line from 'Vancomycin-resistant Staphylococcus aureus' points to a dot just west of the Great Lakes, and a line from 'Lyme disease' points to a dot in the east. Four lines fan out from 'Multidrug-resistant tuberculosis,' near the top of the map, to dots in eastern North America, Europe, North Africa, and East Asia. A line from 'Diphtheria' points to a dot in western Russia, east of the European tuberculosis dot. Two lines from 'Cholera,' at the bottom of the map, point to dots in South America and in central Africa. A line from 'Typhoid fever' points to a dot in South Asia. In East Asia, a line from 'E. coli O157:H7' points to a dot on Japan, and a bent line from 'Vancomycin-resistant Staphylococcus aureus' joins two dots: one on Japan, overlapping the E. coli dot, and one on the southern coast of China." kind="diagram" >}}
Emerging diseases. The map shows regions where bacterial diseases are emerging or re-emerging. (credit: modification of work by NIH)
{{< /mediafigure >}}

Some of the present emerging diseases are not actually new, but are diseases that were catastrophic in the past, pictured below. They devastated populations and became dormant for a while, just to come back, sometimes more virulent than before, as was the case with bubonic plague. Other diseases, like tuberculosis, were never eradicated but were under control in some regions of the world until coming back, mostly in urban centers with high concentrations of immunocompromised people. WHO has identified certain diseases whose worldwide re-emergence should be monitored. Among these are three viral diseases (dengue fever, yellow fever, and zika), and three bacterial diseases (diphtheria, cholera, and bubonic plague). The war against infectious diseases has no foreseeable end.

{{< mediafigure src="biology/Figure_B22_04_08" alt="Three panels. (a) A photograph of a red, bullseye-shaped rash on a person's forearm. (b) A dark-field micrograph of several thin, corkscrew-shaped Borrelia bacteria, with a 2 µm scale bar. (c) A diagram titled 'Life Cycle of the Ixodes scapularis Tick.'" longdesc="Panel (c) is a circular diagram titled 'Life Cycle of the Ixodes scapularis Tick,' with the seasons Spring (left), Summer (bottom), Fall (right), and Winter (top) labeled around the circle, and arrows running counterclockwise, from spring down through summer, up to fall, and over winter back to spring. An arrow labeled 1 month leads from an Egg dot at spring down to Larvae, which feed once for 2 days (mouse is the preferred host); a long solid arc runs from the larvae through summer to fall, and a dashed outer arc continues through winter to Nymph at spring. From Nymph, a solid inner arc runs through summer to fall, labeled feeds once, 3–4 days (mouse is the preferred host). At fall, two arrows marked with the male and female symbols lead up to the adult stage, which feeds once (deer is the preferred host); a dashed inner arc then runs through winter to an arrow labeled 3 weeks, ending at a dot labeled 'Eggs Deposited, Adults Die,' and a short dashed line joins that dot back to the Egg." kind="diagram" >}}
Lyme Disease. Lyme disease often, but not always, results in (a) a characteristic bullseye rash. The disease is caused by a (b) Gram-negative spirochete bacterium of the genus *Borrelia*. The bacteria (c) infect ticks, which in turn infect mice. Deer are the preferred secondary host, but the ticks also may feed on humans. Untreated, the disease causes chronic disorders in the nervous system, eyes, joints, and heart. The disease is named after Lyme, Connecticut, where an outbreak occurred in 1975 and has subsequently spread. *(Source note: the source prints 1995; the cluster of childhood arthritis cases in Lyme, Connecticut that named the disease was investigated in 1975 (Steere et al., *Arthritis and Rheumatism* 20 [1977]: 7).)* The disease is not new, however. Genetic evidence suggests that Ötzi the Iceman, a 5,300-year-old mummy found in the Alps, was infected with *Borrelia*. (credit a: James Gathany, CDC; credit b: CDC; scale-bar data from Matt Russell)
{{< /mediafigure >}}
...
All types of food can potentially be contaminated with bacteria. Recent outbreaks of *Salmonella* reported by the CDC occurred in foods as diverse as peanut butter, alfalfa sprouts, and eggs. A deadly outbreak in Germany in 2010 was caused by *E. coli* contamination of vegetable sprouts, shown below. The strain that caused the outbreak was found to be a new serotype not previously involved in other outbreaks, which indicates that *E. coli* is continuously evolving. Outbreaks of listeriosis, due to contamination of meats, raw cheeses, and frozen or fresh vegetables with *Listeria monocytogenes*, are becoming more frequent.

{{< mediafigure src="biology/Figure_22_04_06f" alt="Three panels. (a) A photograph of a hand holding pale, sprouted seeds with thin white roots and stems. (b) A colorized scanning electron micrograph of a mass of rod-shaped bacteria, most colored orange and about a dozen picked out in other colors, with a 2 µm scale bar. (c) A pair of illustrated panels comparing normal, disk-shaped red blood cells (left) with red blood cells that are deformed, incomplete, or fragmented (right)." longdesc="Panel (b) shows about a dozen rod-shaped bacteria, colored blue, green, yellow, purple, magenta, red, and teal, lying on and among many more rods colored orange, the rods mostly longer than the 2 µm scale bar, over a dark red background. Panel (c) is two side-by-side grey illustrated panels: the left panel shows nine round, disk-shaped red blood cells with a lighter depressed center; the right panel shows about a dozen red blood cells, several of which are crescent-shaped, ring-shaped, or otherwise fragmented rather than intact disks." kind="diagram" >}}
Foodborne pathogens. (a) Vegetable sprouts grown at an organic farm were the cause of an (b) *E. coli* outbreak that killed 53 people and sickened more than 3,800 in Germany in 2011. *(Source note: the source says 32 deaths; the Robert Koch Institute's final report on the 2011 O104:H4 outbreak counts 53 deaths among 3,842 cases.)* The strain responsible, *E. coli* O104:H4, produces Shiga toxin, a substance that inhibits protein synthesis in the host cell. The toxin (c) destroys red blood cells resulting in bloody diarrhea. Deformed red blood cells clog the capillaries of the kidney, which can lead to kidney failure, as happened to 845 patients in the 2011 outbreak. Kidney failure is usually reversible, but some patients experience kidney problems years later. (credit c: NIDDK, NIH)
{{< /mediafigure >}}
...
{{< callout type="info" >}}
**Link to Learning.** Watch a recent news [report](https://openstax.org/l/antibiotics) on the problem of routine antibiotic administration to livestock and antibiotic-resistant bacteria.
{{< /callout >}}

### One of the Superbugs: MRSA

The imprudent use of antibiotics has paved the way for the expansion of resistant bacterial populations. For example, *Staphylococcus aureus*, often called "staph," is a common bacterium that can live in the human body and is usually easily treated with antibiotics. However, a very dangerous strain, **methicillin-resistant *Staphylococcus aureus* (MRSA)** has made the news over the past few years, shown below. This strain is resistant to many commonly used antibiotics, including methicillin, amoxicillin, penicillin, and oxacillin. MRSA can cause infections of the skin, but it can also infect the bloodstream, lungs, urinary tract, or sites of injury. While MRSA infections are common among people in healthcare facilities, they have also appeared in healthy people who haven't been hospitalized, but who live or work in tight populations (like military personnel and prisoners). Researchers have expressed concern about the way this latter source of MRSA targets a much younger population than those residing in care facilities. *The Journal of the American Medical Association* reported that, among MRSA-afflicted persons in healthcare facilities, the average age is 68, whereas people with "community-associated MRSA" (**CA-MRSA**) have an average age of 23 (Naimi, TS, LeDell, KH, Como-Sabetti, K, et al. Comparison of community- and health care-associated methicillin-resistant *Staphylococcus aureus* infection. *JAMA* 290 (2003): 2976–84, doi: 10.1001/jama.290.22.2976.).

{{< mediafigure src="biology/Figure_B22_04_03" alt="Colorized scanning electron micrograph showing clusters of round, golden-colored bacteria, each about 0.4 micrometers across, clinging to a teal-colored surface, with a 2 µm scale bar." kind="photo" >}}
MRSA. This scanning electron micrograph shows methicillin-resistant *Staphylococcus aureus* bacteria, commonly known as MRSA. *S. aureus* is not always pathogenic, but can cause diseases such as food poisoning and skin and respiratory infections. (credit: modification of work by Janice Haney Carr; scale-bar data from Matt Russell)
{{< /mediafigure >}}
...
{{< mediafigure src="biology/Figure_22_04_07" alt="A close-up photograph of medical supplies on a table: several capped syringes, a stack of individually wrapped alcohol swabs, cotton balls, and a pile of round adhesive bandages in the foreground." kind="photo" >}}
...
a biofilm is more difficult to remove than free (planktonic) cells
bacteria can be taken up in the water that plants are grown in
entering the plant tissues rather than simply residing on the leaf surface
{{< /selfcheck >}}
...
{{< multiplechoice
  ...
  answer="An antibiotic is any substance produced by an organism that is antagonistic to the growth of prokaryotes."
  hint="Compare each statement with the glossary definition in Key terms."
>}}
...
only the resistant ones will survive
these resistant bacteria will reproduce
after a while, there will be only resistant bacteria
{{< /selfcheck >}}

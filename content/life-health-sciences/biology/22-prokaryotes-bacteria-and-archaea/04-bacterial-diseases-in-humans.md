...
{{< mediafigure src="biology/Figure_22_04_02" alt="Three panels. (a) A hand-colored engraving titled 'Plague in 1665' showing two men loading a dead body onto a horse-drawn cart while another body lies in the street. (b) A black-and-white scanning electron micrograph of numerous elongated, rod-shaped bacteria, with a 500 nm scale bar. (c) A photograph of a patient's bare torso and hands, with the fingers, palms, and forearms discolored black from gangrene." kind="photo" >}}
...
{{< mediafigure src="biology/Figure_B22_04_08" alt="Three panels. (a) A photograph of a red, bullseye-shaped rash on a person's forearm. (b) A dark-field micrograph of several thin, corkscrew-shaped Borrelia bacteria, with a 2 µm scale bar. (c) A diagram titled 'Life Cycle of the Ixodes scapularis Tick.'" longdesc="Panel (c) is a circular diagram titled 'Life Cycle of the Ixodes scapularis Tick,' with the seasons Spring, Summer, Fall, and Winter labeled around the circle and arrows running counterclockwise through four stages: an egg deposited in spring hatches, after about a month, into a larva that feeds once for 2 days (preferring a mouse host) in summer; the larva molts into a nymph that feeds once for 3–4 days (preferring a mouse host); after about 3 weeks the nymph molts into an adult that feeds once, preferring a deer host, in fall; the cycle closes with eggs deposited the following spring, after which the adults die. A dashed portion of the arrow marks the tick's winter dormancy." kind="diagram" >}}

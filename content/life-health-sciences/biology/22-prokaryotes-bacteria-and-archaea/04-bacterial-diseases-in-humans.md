...
{{< mediafigure src="biology/Figure_22_04_03" alt="A world map with labeled points marking where bacterial diseases are emerging or re-emerging. Multidrug-resistant tuberculosis is marked in North America, Europe, north Africa, and Asia. Vancomycin-resistant Staphylococcus aureus and E. coli O157:H7 are marked in North America and East Asia. Lyme disease is marked in North America. Cholera is marked in Africa and South America. Diphtheria and typhoid fever are marked in Asia." longdesc="A world map on a pale tan (land) and blue (ocean) background, with black lines connecting text labels to red dots marking specific locations. In North America, a line from 'E. coli O157:H7' points to a dot in the western United States, a line from 'Vancomycin-resistant Staphylococcus aureus' points to a dot in north-central Canada, and a line from 'Lyme disease' points to a dot in the east. Four lines fan out from 'Multidrug-resistant tuberculosis,' near the top of the map, to dots in eastern North America, Europe, North Africa, and East Asia. A line from 'Diphtheria' points to a dot near eastern Europe. Two lines from 'Cholera,' at the bottom of the map, point to dots in South America and in central Africa. A line from 'Typhoid fever' points to a dot in South Asia. Near Japan, two nearby dots on the East Asian coast are labeled separately, one 'E. coli O157:H7' and one 'Vancomycin-resistant Staphylococcus aureus.'" kind="diagram" >}}
...
{{< mediafigure src="biology/Figure_B22_04_08" alt="Three panels. (a) A photograph of a red, bullseye-shaped rash on a person's forearm. (b) A dark-field micrograph of several thin, corkscrew-shaped Borrelia bacteria, with a 2 µm scale bar. (c) A diagram titled 'Life Cycle of the Ixodes scapularis Tick.'" longdesc="Panel (c) is a circular diagram titled 'Life Cycle of the Ixodes scapularis Tick,' with the seasons Spring (left), Summer (bottom), Fall (right), and Winter (top) labeled around the circle and solid arrows running clockwise: an egg at spring hatches, after about 1 month, into larvae that feed once for 2 days (preferring a mouse host) in summer; the next arc, feeding once for 3–4 days (preferring a mouse host), leads to fall, where the adult feeds once (preferring a deer host) and mates; a final arrow labeled 3 weeks leads to 'Eggs Deposited, Adults Die' beside the egg. Dashed inner arcs through winter return to a 'Nymph' stage next to the egg at spring, marking the winter dormancy spent as a nymph." kind="diagram" >}}
...
{{< mediafigure src="biology/Figure_22_04_06f" alt="Three panels. (a) A photograph of a hand holding pale, sprouted seeds with thin white roots and stems. (b) A colorized scanning electron micrograph of rod-shaped bacteria, roughly 2 micrometers long, clustered on a textured orange surface, with a 2 µm scale bar. (c) A pair of illustrated panels comparing normal, disk-shaped red blood cells (left) with red blood cells that are deformed, incomplete, or fragmented (right)." longdesc="Panel (b) shows about a dozen rod-shaped bacteria, colored blue, green, yellow, purple, magenta, red, and teal, scattered across an orange fibrous surface, with a 2 µm scale bar. Panel (c) is two side-by-side grey illustrated panels: the left panel shows about eight round, disk-shaped red blood cells with a lighter depressed center; the right panel shows a similar number of red blood cells, several of which are crescent-shaped, ring-shaped, or otherwise fragmented rather than intact disks." kind="diagram" >}}
...
{{< multiplechoice
  ...
  hint="The section's own definition names the chemical's effect on prokaryote growth, not viruses or eukaryotic cells."
>}}
...
{{< multiplechoice
  ...
  hint="Consider the delay in treating patients with the right drug and the risk of MRSA acquiring still more resistance genes, as well as spreading its own."
>}}

...
description: >-
  How prokaryotes' deep evolutionary history, from microbial mats and
  stromatolites to the cyanobacteria that oxygenated Earth's atmosphere, set
  the stage for the extreme habitats extremophiles tolerate today and for why
  most prokaryotes still resist laboratory culture — adapted from OpenStax
  Biology 2e, Section 22.1.
source_section: "22.1"
weight: 1
---
...
*Microbial mats* or large biofilms may represent the earliest forms of prokaryotic life on Earth; there is fossil evidence of their presence starting about 3.5 billion years ago. It is remarkable that cellular life appeared on Earth only a billion years after the Earth itself formed, suggesting that pre-cellular "life" that could replicate itself had evolved much earlier. A **microbial mat** is a multi-layered sheet of prokaryotes (pictured below) that includes mostly bacteria, but also archaeans. Microbial mats are only a few centimeters thick, and they typically grow where different types of materials interface, mostly on moist surfaces. The various types of prokaryotes that comprise them carry out different metabolic pathways, and that is the reason for their various colors. Prokaryotes in a microbial mat are held together by a glue-like sticky substance that they secrete called *extracellular matrix*.
...
{{< mediafigure src="biology/Figure_22_01_01" kind="photo" eager="true" alt="Two panels: (a) a photo of a mound-shaped microbial mat, roughly one meter across, with a reddish-yellow surface, growing over a hydrothermal vent; a small raised chimney on its surface is marked with an arrow; (b) a fluorescence micrograph showing many thin, glowing rod-shaped bacteria scattered over a denser mat of bacteria." >}}
...
Fossilized microbial mats represent the earliest record of life on Earth. A **stromatolite** is a sedimentary structure formed when minerals are precipitated out of water by prokaryotes in a microbial mat (pictured below). Stromatolites form layered rocks made of carbonate or silicate. Although most stromatolites are artifacts from the past, there are places on Earth where stromatolites are still forming. For example, growing stromatolites have been found in the Anza-Borrego Desert State Park in San Diego County, California.

{{< mediafigure src="biology/Figure_22_01_02ab" kind="photo" alt="Two photos: (a) a beach and shallow water dotted with numerous dark, mound-shaped stromatolites stretching toward the horizon; (b) a close-up of banded, swirling gray-and-white marbled rock layers in a fossilized stromatolite." >}}
...
Evidence indicates that during the first two billion years of Earth's existence, the atmosphere was **anoxic**, meaning that there was no molecular oxygen. Therefore, only those organisms that can grow without oxygen—*anaerobic organisms*—were able to live. Autotrophic organisms that convert solar energy into chemical energy are called **phototrophs**, and they appeared within one billion years of the formation of Earth. Then, **cyanobacteria**, also known as "blue-green algae," evolved from these simple phototrophs at least one billion years later. It was the ancestral cyanobacteria (pictured below) that began the "oxygenation" of the atmosphere: Increased atmospheric oxygen allowed the evolution of more efficient O₂-utilizing catabolic pathways. It also opened up the land to increased colonization, because some O₂ is converted into O₃ (ozone) and ozone effectively absorbs the ultraviolet light that could have otherwise caused lethal mutations in DNA. The current evidence suggests that the increase in O₂ concentrations allowed the evolution of other life forms.

{{< mediafigure src="biology/Figure_22_01_03" kind="photo" alt="A photo of a woman crouching beside a mineral-crusted runoff channel at a hot spring, with green cyanobacteria-colored water flowing past where she points; the channel's edges appear a brighter green than its center." >}}
...
the close proximity of cells also facilitates lateral gene transfer
genes such as antibiotic-resistance genes are transferred from one bacterium to another
one bacterium that produces an exo-enzyme that destroys antibiotic may save neighboring bacteria
{{< /selfcheck >}}
...
their presence could be detected through molecular techniques
such as PCR
{{< /selfcheck >}}

...
{{< mediafigure src="biology/Figure_B22_02_10" kind="diagram" alt="Three diagrams of DNA transfer mechanisms in prokaryotes: (a) transformation, in which a cell absorbs a small loop of DNA from its surroundings and incorporates it into its chromosome; (b) transduction, in which a bacteriophage injects DNA into a cell, which is then incorporated into its chromosome; (c) conjugation, in which two cells joined by a channel exchange a loop of DNA." longdesc="Three labeled panels are shown left to right. Panel (a), “Transformation”: a small green circular strand of DNA sits outside an oval cell; a gray arrow shows it entering the cell, and below, a second oval cell shows the same green DNA now merged into the purple, tangled chromosome inside. Panel (b), “Transduction”: an angular blue-and-green shape (a bacteriophage) sits atop a cell injecting a short green strand of DNA; below, a second cell shows that green strand incorporated into the purple chromosome. Panel (c), “Conjugation”: two oval cells, each with a purple circular chromosome, are joined by a short horizontal bridge; the left cell is ringed with pale yellow arrow-tipped projections and the right cell with orange dot-tipped ones; a green loop of DNA is shown partway across the bridge, with a black arrow indicating its direction of transfer from the left cell to the right cell." >}}
...
{{< multiplechoice
  ...
  hint="Fungi, protists, and animals are all eukaryotes."
>}}
bacteria and fungi
archaea and fungi
...
{{< multiplechoice
  ...
  answer="archaea"
  hint="This domain's members are best known for thriving in extreme conditions."
>}}
fungi
bacteria
viruses
...
{{< multiplechoice
  ...
  hint="This outer envelope surrounds a thin layer of peptidoglycan."
>}}
archaean cells

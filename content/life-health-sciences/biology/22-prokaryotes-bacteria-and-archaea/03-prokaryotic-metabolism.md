...
description: >-
  How prokaryotes obtain macronutrients and micronutrients, generate energy
  and carbon through phototrophic, chemotrophic, autotrophic, and
  heterotrophic strategies, and drive the carbon and nitrogen cycles —
  adapted from OpenStax Biology 2e, Section 22.3.
source_section: "22.3"
weight: 3
---
...
Ammonification is the process by which ammonium ion (NH₄⁺) is released from decomposing organic compounds.
Nitrification is the process by which nitrites (NO₂⁻) are converted to ammonium ion (NH₄⁺).
{{< /multiplechoice >}}
...
They are necessary for the function of the cytochromes involved in electron-transport reactions.
...
there is not a lot of organic material in the ocean, so prokaryotes would probably use inorganic sources, thus they would be chemolithotrophs
...
nitrate from soil is transformed to gaseous nitrogen compounds such as NO, N₂O, and N₂

...
description: >-
  How prokaryotic cells regulate gene expression almost entirely at the
  transcriptional level, while eukaryotic cells layer epigenetic,
  transcriptional, post-transcriptional, translational, and
  post-translational controls onto the physically separated processes of
  transcription and translation — adapted from OpenStax Biology 2e, Section
  16.1.
source_section: "16.1"
weight: 1
---
...
{{< multiplechoice
  question="How does the regulation of gene expression support continued evolution of more complex organisms?"
  answer="Both A and B."
  hint="Two of the four options are each individually defensible — check whether the fourth option just names both of them together."
>}}
Cells can become specialized within a multicellular organism.
Organisms can conserve energy and resources.
Cells grow larger to accommodate protein production.
Both A and B.
{{< /multiplechoice >}}

{{< textin
  question="The processes that control the turning on or turning off of a gene are collectively called ________."
  answer="gene expression"
  hint="This is the term the section's opening paragraph introduces for turning a gene on to produce RNA and protein."
>}}

{{< textin
  question="Although every somatic cell in an organism contains the same DNA, not every cell expresses the same ________."
  answer="proteins"
  accept="protein"
  hint="This is what genes are ultimately transcribed and translated to produce, and it is what differs between cell types despite an identical genome."
>}}

### Describe how prokaryotic gene regulation occurs at the transcriptional level

{{< sortbins question="Assign each property to the type of cell it describes." hint="Check whether DNA sits free in the cytoplasm or inside a nuclear compartment, and whether transcription and translation happen together or are split between two locations." >}}
{"bins": ["Prokaryotic organisms", "Eukaryotic organisms"],
 "items": [
  {"label": "Lack a membrane-bound nucleus", "bin": 0},
  {"label": "Contain nucleus", "bin": 1},
  {"label": "DNA is confined to the nuclear compartment", "bin": 1},
  {"label": "DNA is found in the cytoplasm", "bin": 0},
  {"label": "RNA transcription and protein formation occur almost simultaneously", "bin": 0},
  {"label": "Gene expression is regulated at many levels, from epigenetic to post-translational", "bin": 1},
  {"label": "Gene expression is regulated primarily at the transcriptional level", "bin": 0},
  {"label": "RNA transcription occurs in the nucleus before translation in the cytoplasm", "bin": 1}]}
{{< /sortbins >}}

{{< selfcheck question="Name two differences between prokaryotic and eukaryotic cells and how these differences benefit multicellular organisms." hint="Think about what a nuclear membrane changes about where transcription and translation happen, and how many stages of the process each cell type can separately control." >}}
...
gene expression occurs at many stages in eukaryotic cells
in prokaryotic cells, control of gene expression only occurs at the transcriptional level
different cell types can arise in an individual organism
{{< /selfcheck >}}

{{< textin
  question="In prokaryotic cells, transcription and translation occur almost ________."
  answer="simultaneously"
  hint="Prokaryotic cells have no nuclear membrane to separate the two processes in time."
>}}
...
{{< multiplechoice
  ...
  answer="epigenetic, transcriptional, post-transcriptional, translational, and post-translational levels"
  hint="Eukaryotic regulation is not limited to any one stage between DNA and a finished, functional protein."
>}}
...
{{< multiplechoice
  ...
  answer="regulation of gene expression after translation"
  hint="\"Post-\" means after, and the second half of the word names which step it comes after."
>}}
...
{{< selfcheck question="Describe how controlling gene expression will alter the overall protein levels in the cell." hint="Consider that a prokaryotic cell has only one dial to turn, transcription, while a eukaryotic cell has several: accessibility, transcription, translation, and more." >}}
...
===CHECKS===
prokaryotic cells alter the transcription rate to turn genes on or off
eukaryotic cells change the accessibility, transcription, or translation of a gene
this will alter the amount of RNA and the lifespan of the RNA
eukaryotic cells also control protein translation to increase or decrease the overall levels
{{< /selfcheck >}}

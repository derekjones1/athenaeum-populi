...
{{< mediafigure src="biology/Figure_16_03_01ab" alt="Panel (a) is a computer-rendered illustration of a nucleosome: a tightly fused cluster of large, rounded, dark-green histone lobes forms a compact globular shape, with a red-and-white DNA double helix wound around the cluster twice, labeled Histone, DNA, and Nucleosome. Panel (b) is a grayscale electron micrograph showing many thin, thread-like DNA strands studded with small dark particles spaced along their length, giving a beads-threaded-on-a-string look, with a 150 μm scale bar." longdesc="(a) A 3D rendering of a single nucleosome: a tightly fused cluster of large, rounded, dark-green histone lobes forms one compact globular shape. A red-and-white DNA double helix winds around the cluster twice; a line labeled 'DNA' points to the helix, a line labeled 'Histone' points to the green cluster, and a bracket labeled 'Nucleosome' spans the whole cluster. Free DNA helix continues beyond each side of the nucleosome. (b) A grayscale electron micrograph: many thin, thread-like DNA strands loop loosely across the field, each dotted with small dark round particles spaced along its length so that stretches of nucleosomes look like beads threaded loosely on a string; a scale bar in the lower right reads 150 μm." kind="diagram" eager="true" >}}
...
{{< selfcheck question="In females, one of the two X chromosomes is inactivated during embryonic development because of epigenetic changes to the chromatin. What impact do you think these changes would have on nucleosome packing?" hint="Compare the two panels of the figure above: X-inactivation permanently silences one whole X chromosome, so think about which panel's spacing pattern that outcome resembles." >}}
...
{{< multiplechoice
  ...
  hint="Epigenetic changes never alter the DNA base sequence itself — think about what kind of change to histones and DNA can be added and later removed."
>}}
...
{{< multiplechoice
  ...
  hint="Check each of the first three statements against the section — if every one of them holds true, the last option follows."
>}}
...
{{< textin
  ...
  accept="transcription factors"
  hint="RNA polymerase needs this kind of protein's help to bind the promoter or enhancer and initiate transcription."
>}}

### Describe how access to DNA is controlled by histone modification

{{< selfcheck question="Some autoimmune diseases show a positive correlation with dramatically decreased expression of histone deacetylase 9 (HDAC9, an enzyme that removes acetyl groups from histones). Why would the decreased expression of HDAC9 cause immune cells to produce inflammatory genes at inappropriate times?" hint="Histone acetylation and histone deacetylation have opposite effects on how tightly DNA wraps around histones — think about which one HDAC9 normally performs, and what its loss leaves unresolved." >}}
...
{{< selfcheck question="In cancer cells, alteration to epigenetic modifications turns off genes that are normally expressed. Hypothetically, how could you reverse this process to turn these genes back on?" hint="Think about the two epigenetic mechanisms this section describes as silencing genes, and what the opposite chemical change to each one would do to chromatin structure." >}}
...
{{< multiplechoice
  question="According to the section summary, chromatin remodeling controls how DNA is packed into the nucleus by regulating how tightly the DNA is wound around ________."
  answer="histone proteins"
  hint="This is the type of protein that a nucleosome is built from."
>}}
...
{{< selfcheck question="A scientific study demonstrated that rat mothering behavior impacts the stress response in their pups. Rats that were born and grew up with attentive mothers showed low activation of stress-response genes later in life, while rats with inattentive mothers had high activation of stress-response genes in the same situation. An additional study that swapped the pups at birth (i.e., rats born to inattentive mothers grew up with attentive mothers and vice versa) showed the same positive effect of attentive mothering. How do genetics and/or epigenetics explain the results of this study?" hint="The swap-at-birth result rules out an explanation based on inherited DNA sequence differences — think about what kind of chemical change to the genes attentive mothering itself could still cause." >}}
...
{{< textin
  ...
  accept="silence a gene|silence the gene|silence the genes"
  hint="This is the same effect methylation is described as having on genes earlier in the section — think about what 'usually silenced' becomes as a verb phrase."
>}}

...
description: >-
  The ecosystem types, food chains and food webs, and the conceptual,
  analytical, and simulation models ecologists use to study ecosystem
  structure and dynamics — adapted from OpenStax Biology 2e, Section 46.1.
source_section: "46.1"
weight: 1
---
...
{{< mediafigure src="biology/Figure_46_01_01ab" kind="photo" eager="true" alt="Left photo shows a rocky tide pool with seaweed and snails. Right photo shows the Amazon Rainforest landscape, with seemingly every inch of land covered by plants of some kind." >}}
A (a) tidal pool ecosystem in Matinicus Island in Maine is a small ecosystem, while the (b) Amazon Rainforest in Brazil is a large ecosystem. (credit a: modification of work by "takomabibelot"/Flickr; credit b: modification of work by Ivan Mlinaric)
{{< /mediafigure >}}
...
{{< mediafigure src="biology/Figure_46_01_03" kind="diagram" alt="A vertical diagram with two columns, Organism and Trophic Level, listing four organism boxes connected by upward arrows from bottom to top: green algae, mollusks, a small fish, and a salmon, each paired with its named trophic level in a colored box." longdesc="Reading bottom to top, with a gray arrow pointing from each organism up to the one that eats it: green algae sits at the bottom beside a green Primary Producer box; above it, two mollusks (snails) sit beside an orange Primary Consumer box; above that, the slimy sculpin, a small fish, sits beside a blue Secondary Consumer box; and at the top, the Chinook salmon sits beside a purple Tertiary (apex) Consumer box." >}}
These are the trophic levels of a food chain in Lake Ontario at the United States-Canada border. Energy and nutrients flow from photosynthetic green algae at the bottom to the top of the food chain: the Chinook salmon.
{{< /mediafigure >}}
...
{{< mediafigure src="biology/Figure_46_01_04" kind="diagram" alt="A horizontal bar graph titled Relative Energy Content in Trophic Levels, with Energy content (kcal/m²/yr) on the horizontal axis from 0 to 20,000 and four trophic levels listed on the vertical axis from bottom to top, each represented by a purple bar of decreasing length." longdesc="The vertical axis lists, bottom to top: Primary producers, Primary consumers, Secondary consumers, Tertiary (apex) consumers. The horizontal axis, Energy content (kcal/m²/yr), is gridlined at 0, 5,000, 10,000, 15,000, and 20,000. The Primary producers bar is by far the longest, extending just past the 20,000 gridline; the Primary consumers bar is much shorter, reaching a little past 3,000; the Secondary consumers bar is a short sliver near 400; and the Tertiary (apex) consumers bar is barely visible, near 20." >}}
The relative energy in trophic levels in a Silver Springs, Florida, ecosystem is shown. Each trophic level has less energy available and supports fewer organisms at the next level.
{{< /mediafigure >}}
...
{{< callout type="info" >}}
**Link to Learning.** Head to this [online interactive food web simulator](https://openstax.org/l/food_web) to investigate food web function. In the *Interactive Labs* box, under Food Web, click **Step 1**. Read the instructions first, and then click **Step 2** for additional instructions. When you are ready to create a simulation, in the upper-right corner of the *Interactive Labs* box, click **OPEN SIMULATOR**.
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_46_01_06" kind="photo" alt="Two small striped fish swim mid-water above a bed of multicolored, rounded rocks in murky, tan-colored water." >}}
The three-spined stickleback evolved from a saltwater fish to freshwater fish. (credit: Barrett Paul, USFWS)
{{< /mediafigure >}}
{{< /callout >}}
...
all energy consumed by living systems is eventually lost as heat or used for respiration
the total energy output of the system must equal the energy that went into it
{{< /selfcheck >}}
...
{{< callout type="info" >}}
**Link to Learning.** Visit [The Darwin Project](https://openstax.org/l/Darwin_project) to view a variety of ecosystem models, including simulations that [model predator-prey relationships](https://openstax.org/l/Darwin_projct2) to learn more.
{{< /callout >}}
...
ocean ecosystems are the most common and are responsible for much of the photosynthesis that occurs on Earth
...
conceptual models are more descriptive than quantitative, so it is difficult to draw conclusions about a system's resistance or resilience from them
...
food chains are linear aspects of food webs that describe the succession of organisms consuming one another at defined trophic levels
food webs are a more accurate representation of the structure and dynamics of an ecosystem

...
{{< multiplechoice
  ...
  hint="The section's own name for this recycling process combines the studies of living things, rocks, and chemical reactions — think about what fields of science its name draws on besides biology."
>}}
biological
bioaccumulation
biogeochemical
...
{{< multiplechoice
  ...
  hint="Photosynthesis pulls this exact gas out of the air to build sugars — which option names that gas?"
>}}
carbon dioxide
carbonate ion
carbon dust
...
{{< multiplechoice
  ...
  answer="salt water"
  hint="The section opens by naming the one form that makes up 97.5 percent of Earth's water and cannot be drunk without treatment."
>}}
ice
water vapor
fresh water
...
{{< multiplechoice
  ...
  hint="This is the first of the three terrestrial nitrogen-cycle steps, performed by bacteria that convert atmospheric N₂ into a form other organisms can use."
>}}
nitrification
denitrification
nitrogen fixation
...
{{< multiplechoice
  ...
  hint="The section discusses fungi as decomposers — think about what stops happening to dead organic matter once nothing is left to break it down."
>}}
...
{{< multiplechoice
  ...
  hint="Photosynthesis is the process the carbon cycle uses to pull CO₂ out of the atmosphere and into organic carbon — which option increases that process directly?"
>}}

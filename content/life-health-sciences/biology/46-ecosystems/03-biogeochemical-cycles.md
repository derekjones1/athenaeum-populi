...
description: >-
  How water, carbon, nitrogen, phosphorus, and sulfur cycle between living
  organisms, the atmosphere, the oceans, and the land, and how human
  activities such as fossil-fuel combustion and fertilizer runoff disrupt
  these cycles — adapted from OpenStax Biology 2e, Section 46.3.
source_section: "46.3"
weight: 3
---
...
Head to [this overview of biogeochemical cycles](https://openstax.org/l/biogeochemical) to learn more.
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_46_03_01" kind="diagram" eager="true" alt="A teal 3-D disc labeled Saltwater 97.5% (1,365,000,000 km³) has a thin wedge, labeled Freshwater 2.5% (35,000,000 km³), that a tan arrow expands into a narrow vertical bar at left divided into three stacked segments." longdesc="A squat teal 3-D disc at right represents all of Earth's water, labeled Saltwater 97.5% (1,365,000,000 km³). A thin wedge cut from its edge is bracketed and labeled Freshwater 2.5% (35,000,000 km³); a wide tan arrow expands that wedge into a narrow vertical bar at left, divided into three segments read top to bottom: Lakes and rivers 0.3% (a thin sliver at the top), Groundwater (soil moisture, swamp water, permafrost) 30.8% (the middle segment), and Glaciers and permanent snow cover 68.9% (the largest, bottom segment)." >}}
...
{{< mediafigure src="biology/Figure_46_03_02" kind="diagram" alt="A titled list, Average Residence Time for Water Molecules, names nine reservoirs. Each row sits on a lavender bar whose length grows with residence time: the top six are short ticks, Oceans and seas reaches about halfway across, and the last two run the full width." longdesc="Nine rows, read top to bottom, each naming a reservoir and its printed residence time. Each row sits on a lavender bar whose length grows with residence time. The top six rows carry only a short vertical tick before the text, slightly wider for the lower of these rows: Biospheric (in living organisms), 1 week; Atmospheric, 1.5 weeks; Rivers, 2 weeks; Soil moisture, 2 weeks to 1 year; Swamps, 1 to 10 years; Lakes and reservoirs, 10 years. The bottom three rows carry long bars, marking the longest residence times: Oceans and seas, 4,000 years, on a bar reaching about halfway across; then Groundwater, 2 weeks to 10,000 years, and Glaciers and permafrost, 1,000 to 10,000 years, each on a full-width bar." >}}
...
Head to [this overview of the world's fresh water supply](https://openstax.org/l/freshwater) to learn more.
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_B46_03_03" kind="diagram" alt="An illustration titled The Water Cycle shows water moving between the atmosphere, land, and oceans through labeled processes and arrows: volcanic steam and evaporation carrying water up into the atmosphere, condensation forming clouds, precipitation and desublimation returning water to Earth, and infiltration, groundwater flow, streamflow, and surface runoff carrying water back to the ocean." longdesc="Read left to right and top to bottom. At upper left, a small volcano on a snow-capped mountain is labeled Volcanic steam, with a plume of smoke but no arrow; Ice and snow labels the snowy slopes below it. Water in the atmosphere is labeled at top center, beneath a long blue arc: the arc rises from the ocean at lower right, is labeled Condensation where it curves up the right side, runs left across the sky, and ends at upper left center. From that end, a long arrow descends to the ice and snow on the upper-left mountain, and a shorter branch curves down into the storm clouds above the Precipitation label. Precipitation has two short arrows falling to Snowmelt runoff on the mountainside. Below the clouds at center, a paired up/down arrow is labeled Sublimation (rising) and Desublimation (falling). Fog drip is a bare label on the slopes at center, near painted lightning. Evapotranspiration is a tall arrow rising from the vegetated headland right of center, and a separate short Evaporation arrow rises from the ocean surface at right. Surface runoff labels an arrow that splits in two, one branch down-left to a Flora and fauna label and one down-right toward the shore; Dew is a bare label (no arrow) to their right. On the left, two thick arrows start together high on the mountainside: one, labeled Infiltration, runs down the left edge into Groundwater storage at the bottom; the other, labeled Groundwater discharge, runs down and to the right beneath the slope to end at the coast, sending three small arrows up and to the right to Seepage, a Spring, and a Freshwater pool along the way. A small arrow from the bed of the Freshwater pool runs down into the Groundwater discharge arrow, and another small arrow near the Infiltration label carries snowmelt into the ground. Streamflow is a bare label naming the painted stream above the pool. A second Evaporation arrow rises from the Freshwater pool, and Plant uptake labels a short arrow rising from the soil beside it. At lower right, a short arrow runs from the Groundwater storage layer out into the ocean; Vents and volcanoes is a bare label beside a small vent on the ocean floor, and Oceans labels the blue water body at right." >}}
...
{{< mediafigure src="biology/Figure_B46_03_04_carbon" kind="diagram" alt="An illustration titled The Carbon Cycle shows carbon dioxide entering the atmosphere from a volcano, from soil, from respiration, from human emissions, and from marine respiration, while terrestrial and marine photosynthesis remove carbon dioxide from the atmosphere; on land and at sea, carbon also moves between soil, fossil carbon, and ocean sediments." longdesc="Read from the atmosphere band downward. At top center, Carbon dioxide in atmosphere. A curved arrow from a volcano at upper left adds carbon dioxide to the atmosphere; a second, longer curved arrow rises from the Microbial respiration and decomposition box at bottom center, passing left of the Terrestrial photosynthesis icon, and also points into the atmosphere. Beneath the atmosphere band sit three icons in a row: an arrow points down from the atmosphere into Terrestrial photosynthesis (removing carbon dioxide), while arrows of the same weight point up from Respiration and from Human emissions into the atmosphere (adding carbon dioxide). At right, two diagonal arrows cross the sky: one points down from the atmosphere into Marine photosynthesis (removing carbon dioxide), the other points up from Marine respiration into the atmosphere (adding carbon dioxide). At left, Weathering of terrestrial rocks and Decomposition of organisms both feed down into Soil carbon; Soil carbon sends two arrows, one down-left into Fossil carbon and one down-right into the Microbial respiration and decomposition box at bottom center, and Fossil carbon connects by a rightward arrow to the Microbial respiration and decomposition box at bottom center. An arrow rises from that box up to Leaching/Runoff, which points right into Ocean sediments; Ocean sediments feeds down into Uplifting, which points left back into the Microbial respiration and decomposition box, closing that loop. Oceans is printed nearby as a plain label with no arrow of its own." >}}
...
{{< mediafigure src="biology/Figure_46_03_05" kind="diagram" alt="A four-row table, alternating green and tan backgrounds, lists the stepwise equilibrium reactions of carbon dioxide dissolving in water: Step 1, CO₂ (atmospheric) ⇌ CO₂ (dissolved); Step 2, CO₂ (dissolved) + H₂O ⇌ H₂CO₃ (carbonic acid); Step 3, H₂CO₃ ⇌ H⁺ + HCO₃⁻ (bicarbonate ion); Step 4, HCO₃⁻ ⇌ H⁺ + CO₃²⁻ (carbonate ion)." >}}
...
{{< mediafigure src="biology/Figure_B46_03_05" kind="diagram" alt="An illustration titled The Nitrogen Cycle shows nitrogen gas moving between the atmosphere and terrestrial and marine ecosystems through labeled bacterial processes: nitrogen fixation, ammonification, nitrification, and denitrification on land, and an analogous set of processes at sea, plus fertilizer and runoff inputs from land to ocean." longdesc="At top center, Nitrogen gas in atmosphere (N₂). A thick vertical arrow runs straight down the middle of the figure from the atmosphere to Nitrogen fixation by bacteria at the bottom; a second, unlabeled, lighter vertical arrow near it rises from the marine side of the figure back up to the atmosphere. On the left (terrestrial) side, an arrow leads left from Nitrogen fixation by bacteria to Ammonification by bacteria and fungi to NH₄⁺; a diagonal arrow also leads from Nitrogen fixation by bacteria up to Terrestrial food webs, and a second diagonal arrow leads from Terrestrial food webs down to Nitrogenous wastes in soil, which feeds down into the same Ammonification box. From Ammonification, an arrow leads left to Nitrification by bacteria to NO₂⁻, then up to Nitrification by bacteria to NO₃⁻, which sends a curved arrow up and right into Terrestrial food webs as well as an arrow up to Denitrification by bacteria; from there a long curved arrow sweeps up and right, past a volcano, back to Nitrogen gas in atmosphere. On the right (marine) side, Fertilizers feeds down into Marine food webs, and a separate Runoff arrow leads right from the land toward the denitrification box near the top of the marine chain. From Marine food webs, one arrow leads down to Nitrification by bacteria to NO₃⁻, NO₂⁻ and a second leads down to Nitrogenous sediments fall to ocean floor. From the marine nitrification box, an arrow leads up to Denitrification by bacteria to N₂, and a long curved arrow sweeps up and left back to Nitrogen gas in atmosphere, mirroring the terrestrial curve. Freshwater and Oceans are printed as plain labels with no arrows of their own." >}}
...
{{< multiplechoice
  ...
  answer="Nitrification by bacteria converts nitrates (NO₃⁻) to nitrites (NO₂⁻)."
  hint="Check each option against the nitrogen-cycle figure and the paragraph above it on the three terrestrial steps."
>}}
...
As discussed in [Ecology and the Biosphere](/life-health-sciences/biology/44-ecology-and-the-biosphere), excess phosphorus and nitrogen that enters these ecosystems from fertilizer runoff and from sewage causes excessive growth of microorganisms and depletes the dissolved oxygen, which leads to the death of many ecosystem fauna, such as shellfish and finfish. This process is responsible for dead zones in lakes and at the mouths of many major rivers, shown below.

{{< mediafigure src="biology/Figure_B46_03_07" kind="diagram" alt="An oval world map carries three legends — a blue Particulate Organic Carbon scale, a tan Population Density scale, and a red Dead Zone Size scale — with red circles of varying size marking dead zones along several coastlines." longdesc="The map carries three legends below it: a blue gradient for Particulate Organic Carbon (10 to 1,000 mg/m³), a tan gradient for Population Density (1 to 100k persons/km²), and a scale of red circles for Dead Zone Size (an unknown-size dot, then 0.1, 1, 10, 100, 1k, and 10k km²). On the map, clusters of large red circles mark dead zones along the eastern coast of the United States from New England to the Gulf of Mexico, a smaller cluster off the western coast of the United States, a dense cluster in the North Sea and Baltic Sea off northern Europe, several circles in the Mediterranean Sea, two large circles in the northwestern Black Sea, and a cluster off the eastern coast of Asia. Smaller, open gray (unknown-size) circles crowd the coasts of the British Isles and western Europe and dot the coastlines of South America, Africa, and India, and one isolated red circle sits near New Zealand." >}}
Dead zones occur when phosphorus and nitrogen from fertilizers cause excessive growth of microorganisms, which depletes oxygen and kills fauna. Worldwide, large dead zones are found in coastal areas of high population density. (credit: NASA Earth Observatory)
{{< /mediafigure >}}
...
{{< mediafigure src="biology/Figure_B46_03_09-sulfur" kind="diagram" alt="An illustration titled The Sulfur Cycle shows sulfur dioxide entering the atmosphere from a volcano and from human emissions, then reaching land as precipitation and fallout, cycling through terrestrial and marine ecosystems as hydrogen sulfide and sulfate, and eventually returning to the atmosphere." longdesc="At upper left, Volcano eruption (H₂S) sends a curved arrow up and right into Atmospheric sulfur (SO₂); Human emissions (H₂S) (SO₂), at center, sends a separate arrow straight up into the same label. A single downward arrow, labeled Precipitation on its left and Fallout on its right, carries sulfur from Atmospheric sulfur down into Terrestrial ecosystems. From Terrestrial ecosystems, an arrow leads down and left into Decomposition (H₂S). Separately, an arrow labeled Runoff starts on the land below Terrestrial ecosystems and leads down and right into the ocean, ending near Marine ecosystems. A long curved arrow rises from Decomposition (H₂S) up and around the left edge of the figure back into Atmospheric sulfur (SO₂). Decomposition (H₂S) also connects down to Soil sulfates (SO₄²⁻) by a curved arrow pointing up into Decomposition. A horizontal arrow leads left from Pyrite into Soil sulfates (SO₄²⁻), and a curved arrow leads down and left from Marine sulfate (SO₄²⁻) into Pyrite. Marine ecosystems connects up to Marine sulfate (SO₄²⁻) by a curved arrow; Oceans is printed nearby as a plain label with no arrow of its own." >}}
Sulfur dioxide from the atmosphere becomes available to terrestrial and marine ecosystems when it is dissolved in precipitation as weak sulfurous acid or when it falls directly to the Earth as fallout. Weathering of rocks also makes sulfates available to terrestrial ecosystems. Decomposition of living organisms returns sulfates to the ocean, soil, and atmosphere. (credit: modification of work by John M. Evans and Howard Perlman, USGS)
{{< /mediafigure >}}
...
Click [this overview of global climate change](https://openstax.org/l/climate_change) to learn more.
{{< /callout >}}
...
- **acid rain** — corrosive rain caused by rainwater falling to the ground through sulfur dioxide gas, turning it into weak sulfurous acid; can damage structures and ecosystems
...
{{< multiplechoice
  question="The movement of mineral nutrients through organisms and their environment is called a ________ cycle."
  answer="biogeochemical"
  hint="The section's opening paragraphs name this kind of cycle before turning to water, carbon, nitrogen, phosphorus, and sulfur in turn."
>}}
biological
bioaccumulation
biogeochemical
...
{{< multiplechoice
  question="Carbon is present in the atmosphere as ________."
  answer="carbon dioxide"
  hint="See the first sentence of the carbon-cycle figure's caption."
>}}
carbon dioxide
carbonate ion
carbon dust
...
{{< multiplechoice
  ...
  answer="salt water"
  hint="The water-cycle subsection opens by breaking Earth's stores of water down by percentage; the water-reservoir chart shows the same split."
>}}
ice
water vapor
fresh water
...
{{< multiplechoice
  question="The average time a molecule spends in its reservoir is known as ________."
  answer="residence time"
  hint="See the paragraph just before the water-cycle subsection's second chart."
>}}
residence time
restriction time
resilience time
...
{{< multiplechoice
  question="The process whereby nitrogen is brought into organic molecules is called ________."
  answer="nitrogen fixation"
  hint="See the opening paragraph of the nitrogen-cycle subsection."
>}}
nitrification
denitrification
nitrogen fixation
...
{{< multiplechoice
  question="How would loss of fungi in a forest affect biogeochemical cycles in the area?"
  answer="Carbon would accumulate in dead organic matter and waste."
  hint="See the Biogeochemical Carbon Cycle subsection's paragraph on carbon stored on land."
>}}
...
{{< selfcheck question="Describe nitrogen fixation and why it is important to agriculture." hint="See the nitrogen-cycle subsection's first two paragraphs and its paragraph on human activity." >}}
...
===CHECKS===
nitrogen fixation brings nitrogen gas from the atmosphere and incorporates it into organic molecules
most plants do not have this capability and must rely on free-living or symbiotic bacteria to do this
nitrogen is often the limiting nutrient in crop growth, so farmers use artificial fertilizers to supply it
{{< /selfcheck >}}

### Explain how human activities have impacted these cycles and the potential consequences for Earth

{{< multiplechoice
  question="The process whereby oxygen is depleted by the growth of microorganisms due to excess nutrients in aquatic systems is called ________."
  answer="eutrophication"
  hint="See the paragraph just after the nitrogen-cycle figure's question."
>}}
dead zoning
eutrophication
retrofication
...
{{< multiplechoice
  question="Which of the following approaches would be the most effective way to reduce greenhouse carbon dioxide?"
  answer="Plant more environmentally-suitable plants."
  hint="See The Biological Carbon Cycle subsection."
>}}
...
Increase livestock agriculture.
{{< /multiplechoice >}}

{{< selfcheck question="What are the factors that cause dead zones? Describe eutrophication, in particular, as a cause." hint="See the phosphorus-cycle subsection's paragraphs before and after the dead-zone map." >}}
...
===CHECKS===
dead zones can be caused by eutrophication, oil spills, toxic waste spills, changes in climate, and dumping of garbage into the ocean
eutrophication results from nutrient-rich runoff using artificial fertilizers high in nitrogen and phosphorus
these nutrients cause the rapid and excessive growth of microorganisms, which deplete local dissolved oxygen and kill many fish and other aquatic organisms
{{< /selfcheck >}}

{{< selfcheck question="Why are drinking water supplies still a major concern for many countries?" hint="See the water-cycle subsection's opening paragraph and its freshwater chart." >}}

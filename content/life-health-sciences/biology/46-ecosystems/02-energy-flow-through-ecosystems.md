...
{{< multiplechoice
  ...
  answer="autotrophs"
  hint="The section names one broad category that groups together the organisms that use sunlight and the organisms that use inorganic molecules as their energy source — look for the word that covers both, not only the subset that skips photosynthesis."
>}}
autotrophs
heterotrophs
photoautotrophs
...
{{< multiplechoice
  ...
  hint="This is the law named right after the section describes energy loss as metabolic heat during every transfer — not the law about matter or energy being conserved."
>}}

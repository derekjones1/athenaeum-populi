...
title: Vision
description: >-
  How light travels as electromagnetic waves and is focused by the cornea and
  lens onto the retina's rods and cones, transduced by rhodopsin, and
  processed through tonic photoreceptor activity before the signal leaves the
  eye along the optic nerve — adapted from OpenStax Biology 2e, Section 36.5.
source_section: "36.5"
weight: 5
---
...
Review [an interactive matching activity for the anatomical structures of the eye](https://openstax.org/l/eye_diagram) to practice identification.
{{< /callout >}}
...
{{< mediafigure src="biology/Figure_36_05_07" kind="diagram" alt="A flag-shaped graphic divided by a cross into four green rectangles, with the cross itself colored yellow outlined in black and a small white dot marking its center." >}}
...
View [an interactive presentation reviewing how vision functions](https://openstax.org/l/sense_of_sight).
{{< /callout >}}
...
The astronaut will see the explosion, and then hear the boom.
The astronaut will feel the concussive force of the explosion, but will not see it.
{{< /multiplechoice >}}
...
when the lens becomes cloudy instead of clear, it scatters light over the back of the retina
...
day length is shorter in winter than in summer
...
stimulation of the receptors turns this inhibition off

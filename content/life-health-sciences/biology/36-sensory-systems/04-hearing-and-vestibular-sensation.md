...
{{< multiplechoice
  ...
  hint="A cochlear implant sends its electrical signal straight onto a nerve, bypassing the cochlea entirely — think about what still has to be working for that signal to reach the brain at all."
>}}
...
{{< multiplechoice
  ...
  hint="Semicircular canals normally detect turning and rotation, not the straight-down pull that the utricle and saccule respond to — think about what the migrated crystals now do inside them."
>}}
...
{{< multiplechoice
  ...
  answer="hair cells"
  hint="Both systems transduce a mechanical stimulus into a nerve signal using the same kind of receptor cell — one option is found only in the cochlea, one only in the vestibular labyrinth, and one is shared by both."
>}}
basilar membrane
hair cells
semicircular canals
...
{{< textin
  ...
  answer="utricle"
  hint="This vestibular receptor organ, along with the saccule, lies in the vestibule and responds to straight-line acceleration such as gravity — not to rotation."
>}}

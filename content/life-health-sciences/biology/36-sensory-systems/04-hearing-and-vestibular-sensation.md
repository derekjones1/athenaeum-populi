...
description: >-
  How a sound wave's frequency and amplitude become pitch and volume, the
  path of sound energy from the outer ear through the ossicles and cochlea to
  the hair cells of the organ of Corti, and how the vestibular system's
  utricle, saccule, and semicircular canals detect gravity and rotation —
  adapted from OpenStax Biology 2e, Section 36.4.
source_section: "36.4"
weight: 4
---
...
{{< mediafigure src="biology/Figure_B36_04_02" kind="diagram" alt="A cross-section of the human ear from the outer auricle and ear canal through the tympanic membrane, three tiny middle-ear bones, and the fluid-filled canals and coiled cochlea of the inner ear, with the external, middle, and inner ear regions bracketed below the drawing." longdesc="Left to right: 'Auricle' labels the outer visible fold of the ear, and 'Ear canal' labels the tube leading inward to the 'Tympanic membrane,' a pale oval sealing the canal's inner end. Behind it, in the air-filled 'Tympanic cavity,' two small bones are labeled 'Malleus' and 'Incus'; a third is captioned 'Stapes (attached to oval window)' at the border with the inner ear. Continuing right, three unlabeled looping canals rise from a small chamber labeled 'Vestibule'; 'Vestibular nerve' labels the upper yellow nerve bundle leaving it, 'Cochlear nerve' labels the lower yellow bundle, 'Round window' labels a small dark-red opening in the inner wall of the tympanic cavity, just left of the cochlea and below the stapes, 'Cochlea' labels the coiled snail-shell structure, and 'Eustachian tube' labels a duct running down and to the right from the tympanic cavity. Three brackets beneath the drawing span, left to right: 'External ear' (auricle through tympanic membrane), 'Middle ear' (the tympanic cavity), and 'Inner ear' (vestibule through cochlea)." >}}
...
{{< mediafigure src="biology/Figure_B36_04_03abc" kind="diagram" alt="A five-step diagram: a tuning fork at left emits wave-crest symbols traveling toward a cutaway ear, above a small graph plotting the sound wave's frequency; a gray arrow leads from the ear down into a cutaway cylinder representing the uncoiled, fluid-filled cochlea, labeled with its three internal chambers and the organ of Corti and basilar membrane inside it, above a second small graph plotting the resulting standing wave's frequency." longdesc="Five numbered captions trace the sequence. ① 'Sound wave represents alternating areas of high and low pressure,' beside a tuning fork at far left and a row of teal wave-crest arcs traveling right toward the ear; below this, a small graph plots 'Frequency of sound wave measured in Hz (cycles per second),' with 'Wavelength' labeling the span between two crests. ② 'Tympanic membrane vibrates in response to sound wave,' with an arrow into the tympanic membrane inside the cutaway ear. ③ 'Vibrations are amplified across ossicles,' with an arrow crossing the three middle-ear bones. ④ 'Vibrations against oval window set up standing wave in fluid of vestibuli,' where a large gray arrow points down from a box drawn around the base of the cochlea into a cutaway cylinder labeled, top to bottom, 'Scala vestibuli,' 'Cochlear duct' (containing 'Organ of Corti' and 'Basilar membrane'), and 'Scala tympani.' A red arrow enters the scala vestibuli at the cylinder's left end, and wave arcs travel right along it; near the left end, a small red arrow bends down through the cochlear duct at an orange spot on the basilar membrane into the scala tympani, where wave arcs travel back left and a red arrow exits at the left end. ⑤ 'Pressure bends the membrane of the cochlear duct at a point of maximum vibration for a given frequency, causing hair cells in the basilar membrane to vibrate,' with a leader line to that orange spot; dashed lines drop from the scala tympani's waves to a second small graph plotting 'Frequency of standing wave is the same as sound wave.'" >}}
...
{{< multiplechoice
  question="Cochlear implants can restore hearing in people who have a nonfunctional cochlea. The implant consists of a microphone that picks up sound. A speech processor selects sounds in the range of human speech, and a transmitter converts these sounds to electrical impulses, which are then sent to the auditory nerve. Which of the following types of hearing loss would not be restored by a cochlear implant?"
  answer="Hearing loss resulting from an abnormal auditory nerve."
  hint="Check each type of hearing loss against the implant's path, as the stem describes it."
>}}
...
{{< mediafigure src="biology/Figure_B36_015" kind="diagram" alt="A two-panel diagram: the left panel is an unlabeled cutaway of the coiled cochlear duct with a small black box outlining one region, linked by a curved gray arrow to the right panel, a zoomed view of two adjacent hair cells whose stereocilia reach up to touch a pale band across the top." longdesc="In the left panel, the cochlea is cut through its coils, with yellow nerve bundles leaving it at the right; the small box sits on the organ of Corti in one turn. In the right, zoomed panel, top to bottom: 'Tectorial membrane' labels the pale horizontal band across the top. Below it, two tall yellow hair cells stand side by side among pink supporting cells, each topped with a row of three finger-like projections that step down in height from left to right, their tips reaching up into the tectorial membrane; 'Tether' labels the short strands linking the tips of neighboring projections, and 'Stereocilia' has three leader lines, one to each projection of the right-hand cell. 'Hair cell' labels the tall yellow cell body beneath the bundle; each hair cell has a round nucleus, and yellow nerve endings curl around its base. A blue band runs along the bottom of the panel." >}}
...
Watch [an animation of sound entering the outer ear, moving through the ear structure, stimulating cochlear nerve impulses, and eventually sending signals to the temporal lobe](https://openstax.org/l/hearing).
{{< /callout >}}
...
Click through [this interactive tutorial to review the parts of the ear and how they function to process sound](https://openstax.org/l/ear_anatomy).
{{< /callout >}}
...
sound is transmitted through particles of gas
there are fewer particles, at a lower density, at higher altitudes
{{< /selfcheck >}}
...
the two auricles will not collect the sound at the exact same time
the brain uses this slight difference in timing to determine the location of the sound
{{< /selfcheck >}}
...
{{< multiplechoice
  question="Which of the following are found both in the auditory system and the vestibular system?"
  answer="hair cells"
  hint="Check each option against the opening sentences of the Vestibular Information discussion."
>}}
basilar membrane
hair cells
semicircular canals
...
a situation of reduced gravity would likely impair vestibular sensation
{{< /selfcheck >}}

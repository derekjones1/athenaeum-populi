...
description: >-
  How free nerve endings and the four primary skin mechanoreceptors —
  Merkel's disks, Meissner's corpuscles, Ruffini endings, and Pacinian
  corpuscles — detect touch, why their density differs between glabrous and
  hairy skin, and why the perception of pain is a subjective, brain-level
  interpretation of nociception — adapted from OpenStax Biology 2e, Section
  36.2.
source_section: "36.2"
weight: 2
---
...
{{< mediafigure src="biology/Figure_36_02_03" kind="photo" alt="A photomicrograph of skin in cross-section, showing a deeply staining, ridged epidermis above a lighter-staining dermis; an arrow points to an oval Meissner corpuscle sitting between two of the epidermis's finger-like ridges." >}}
...
{{< mediafigure src="biology/Figure_36_02_04" kind="photo" alt="A photomicrograph showing three round, ringed Pacinian corpuscles, each resembling a cut tree stump in cross-section, embedded in the dermis." >}}
...
View [a video that animates the five phases of nociceptive pain](https://openstax.org/l/nociceptive).
{{< /callout >}}
...
{{< multiplechoice
  ...
  hint="This unencapsulated receptor type is the most common nerve ending in skin and extends the furthest into the epidermis of any receptor discussed in this section."
>}}
free nerve endings
Ruffini endings
Pacinian corpuscle
...
{{< multiplechoice
  ...
  answer="hair receptors; hairy"
  hint="This receptor type wraps around the base of hair follicles, so it can only be present where hair follicles are."
>}}
...
{{< selfcheck question="Many studies have demonstrated that females are able to tolerate the same painful stimuli for longer than males. Why don't all people experience pain the same way?" hint="Recall that nociception, the receptor signal, and pain, the perception of it, are two different steps, and only the second one happens in the brain." >}}
...
{{< textin
  question="The neural processing of noxious, or damaging, stimuli is called ________."
  answer="nociception"
  hint="This process is distinct from pain itself, which is the brain's perception of it once the signal is communicated there."
>}}
...
{{< multiplechoice
  ...
  answer="the brain"
  hint="This is the step where the signal is actually perceived and interpreted, rather than just relayed — the reason pain is subjective rather than a fixed reading off the sensory receptors."
>}}
the spinal cord
the brain
the skin

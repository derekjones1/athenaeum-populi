...
description: >-
  Taste and smell both work by binding molecules to chemoreceptors, but each
  takes its own path to the brain and relies on its own set of receptor
  types — from the five basic tastes sensed by papillae on the tongue to the
  millions of olfactory receptors that make a dog's nose so much more
  sensitive than a human's — adapted from OpenStax Biology 2e, Section 36.3.
source_section: "36.3"
weight: 3
---
...
{{< mediafigure src="biology/Figure_36_03_01" kind="diagram" eager="true" alt="A two-panel diagram: panel (a) is a simple black-and-white outline drawing of a bipolar neuron, with branching dendrites at the top, an oval cell body holding a dot marking the nucleus, and a mirroring set of branching processes at the bottom. Panel (b) is a color anatomical illustration of a human head in profile, cut away to show the nasal cavity, with a fan of yellow, thread-like nerve fibers running down from a band at the top of the cavity into the mucosa lining it, and four leader lines labeling parts of the illustration." longdesc="Panel (a), on the left, is a simple outline drawing of a bipolar neuron: branching dendrites fan out from the top of an oval cell body, which contains a small dot marking the nucleus, and a mirroring set of branching processes extends from the bottom; the drawing is labeled 'Bipolar neuron' beneath it. Panel (b), on the right, is a color side-view illustration of a human head, cut away to show the nasal cavity. A cluster of yellow, thread-like nerve fibers fans down from a horizontal band at the top of the nasal cavity into the mucosa lining its inner wall. Four leader lines run from the illustration to labels at the right margin, top to bottom: 'Olfactory bulb' (the horizontal band the fibers emerge from), 'Olfactory epithelium' (the lining of the cavity's roof just beside the fibers), 'Nerve endings' (the branching fibers just below the roof), and 'Nasal cavity' (the open space itself)." >}}
...
{{< mediafigure src="biology/Figure_36_03_02" kind="photo" alt="A close-up photo of an orange-and-black striped tiger with its head turned toward the camera, upper lip curled back and mouth open, exposing its canine teeth and tongue, amid green foliage and a large gray rock." >}}
...
{{< mediafigure src="biology/Figure_36_03_03" kind="diagram" alt="Two-panel figure: panel (a) is a color illustration of a tongue viewed from above, its surface covered in small round bumps, with leader lines labeling 'Foliate papillae' (a bracket along the side edge near the back), 'Circumvallate papillae' (a back row of larger bumps), 'Fungiform papillae' (scattered bumps across the middle), and 'Filiform papillae' (the finely bumped front two-thirds). Panel (b) is a magenta-stained light micrograph of tall, finger-like tissue folds." longdesc="Panel (a) shows a tongue viewed from above, widest at the back and tapering slightly at the tip, its surface stippled with small round bumps throughout the front two-thirds. At the left margin, a bracket spans the back-left edge of the tongue and is labeled 'Foliate papillae.' Near the back of the tongue, a row of larger ringed bumps forms an inverted V; two leader lines from the label 'Circumvallate papillae' point to bumps in that row. Two leader lines point to smaller bumps scattered across the middle of the tongue, labeled 'Fungiform papillae.' One leader line points down to the finely stippled front two-thirds of the tongue's surface, labeled 'Filiform papillae.' Panel (b), to the right, is a magenta-and-purple light micrograph showing several tall, finger-like tissue folds rising side by side from a denser base layer, matching the foliate papillae's ridged folds; a scale bar at the lower right marks 100 µm, roughly a third of the width of one fold." >}}
...
{{< mediafigure src="biology/Figure_B36_03_03" kind="diagram" alt="A composite diagram: a small tongue illustration with four highlighted regions, each connected by an arrow to an enlarged cutaway block showing that region's papilla type — circumvallate, foliate, fungiform, and filiform — with the circumvallate block also connected by an arrow to a magenta light micrograph. A separate labeled cutaway shows a single onion-shaped taste bud, its hair-like projections and cells labeled where they meet the tongue's surface." longdesc="At upper left, a tongue viewed from above, its surface stippled with small bumps, carries four small square markers. The uppermost marker, near the back of the tongue, connects by a gray arrow curving up and right to a wedge-shaped cutaway block labeled 'Circumvallate papilla': a dome-shaped bump ringed by a groove, with a fan of four fine leader lines converging on a 'Taste buds' label pointing into the block's cut face. A second gray arrow leads from a small square on this block's cut face rightward into a magenta-and-purple light micrograph at the top right. A second marker, on the tongue's right edge, connects by an arrow curving right and then down to a block third from the left in the bottom row, labeled 'Foliate papilla': a block with vertical ridged folds, also labeled 'Taste buds' by converging leader lines. A third marker, lower-left on the tongue, connects by an arrow curving down and left to a bottom-left block labeled 'Fungiform papilla': a block with a bumpy dome top and no taste-bud leader lines drawn. A fourth marker, below and right of the third, connects by an arrow curving right and then down to a block second from the left in the bottom row, labeled 'Filiform papilla': a slender, pointed, bristle-like projection, also with no taste-bud leader lines. Separate from these four arrows, at the bottom right, a standalone cutaway shows a single onion-shaped taste bud: a bundle of parallel spindle-shaped cells studded with oval purple nuclei, capped at the surface by short hair-like projections. Three leader lines from the top: two fan from 'Taste hairs' to the projections, and one runs from 'Taste pore' to the right edge of the narrow opening in the surface where the projections sit; three leader lines from the lower part of the bundle point to 'Basal cell' at one of the small oval cells at its base, 'Gustatory cell' at one of the tall, pale spindle cells in the middle of the bundle, and 'Transitional cell' at the tapering outer wall of the bundle." >}}
...
View [this animation, which shows how the sense of taste works](https://openstax.org/l/taste).
{{< /callout >}}
...
Regarding olfaction, there are many thousands of odorants, but humans detect only about 10,000. Olfactory receptors are sensitive to different odorants: some receptors detect more than one odor, and many odors can be detected by more than one receptor. *(Source note: the source's summary says "Like taste receptors, olfactory receptors are each responsive to only one odorant"; this section's own account of Buck's work, above, says that some receptors detect more than one odor and that many odors can be detected by more than one receptor.)* Odorants dissolve in nasal mucosa, where they excite their corresponding olfactory sensory cells. When these cells detect an odorant, they send their signals to the main olfactory bulb and then to other locations in the brain, including the olfactory cortex.
...
{{< multiplechoice
  question="How many different taste molecules do taste cells each detect?"
  answer="one"
  hint="See the Summary's second sentence."
>}}
one
five
ten
...
might not be able to discriminate between spoiled food and safe food
or between foods that contain necessary nutrients, such as proteins, and foods that do not
{{< /selfcheck >}}
...
the hypothesis is that the dogs are capable of detecting volatile compounds (evaporating scent molecules) that are only produced in people with cancer
the dogs are a better choice because their sense of smell is more sensitive due to the increased number of olfactory receptors
{{< /selfcheck >}}

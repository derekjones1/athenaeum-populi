...
description: >-
  How sensory receptors detect a stimulus, transduce it into an electrical
  receptor potential, and how the resulting signal travels to the brain for
  perception, closing with the just-noticeable difference that links a
  stimulus's magnitude to how readily a change in it is detected — adapted
  from OpenStax Biology 2e, Section 36.1.
source_section: "36.1"
weight: 1
---
...
{{< mediafigure src="biology/Figure_36_01_02" kind="diagram" alt="A two-panel diagram of the brain. Panel (a) shows a mid-sagittal view with a red loop drawn around the inner limbic structures and a line labeled 'Thalamus' pointing to a small oval structure at their center. Panel (b) shows a lateral view of the brain with three colored regions: a purple strip near the top, a blue patch over the temporal lobe, and a green region covering the back of the brain." longdesc="Panel (a) is a single label: a line from the word 'Thalamus' points to a small pale oval near the center of a mid-sagittal brain section, which is encircled by a red curved outline running around the inner limbic structures. Panel (b) is a lateral view of the brain carrying three labeled colored regions: a purple band near the top, running down toward the middle of the brain, labeled 'Somatosensory processing region'; a blue, oval patch lower down over the temporal lobe, labeled 'Auditory processing region'; and a green region covering the back of the brain, labeled 'Visual processing region'." >}}
...
special senses are all located in the head region
...
a relatively fixed proportion, such as 10 percent

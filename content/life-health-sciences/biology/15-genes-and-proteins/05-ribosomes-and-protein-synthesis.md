...
description: >-
  How the translation machinery — ribosomes, tRNAs, and aminoacyl tRNA
  synthetases — carries out the three phases of protein synthesis, from
  initiation at the start codon through elongation and termination to the
  newly made protein's folding and targeting — adapted from OpenStax Biology
  2e, Section 15.5.
source_section: "15.5"
weight: 5
---
...
{{< mediafigure src="biology/Figure_15_05_01-3c2f" alt="Two-panel line-structure diagram. Top panel: two separate amino acids side by side, each drawn as H₂N–CH(R)–COOH (left) and H₂N–CH(R′)–COOH (right), with the carboxyl OH of the left amino acid and an amino H of the right amino acid boxed together in red between them. Bottom panel: the same two amino acids now joined by a new C–N bond, with the boxed OH and H no longer drawn; an orange-shaded box around the joining C=O and N–H is labeled 'Peptide bond,' and the remaining amino and carboxyl groups are still shown at each outer end." longdesc="Top panel: the left amino acid is drawn with H₂N– at upper left, a central carbon bearing R above and H below, connecting right to a carbonyl carbon double-bonded to O with an OH below it; the right amino acid mirrors this with R′ and its own carbonyl. A red-outlined box surrounds the left amino acid's OH and the right amino acid's amino H, sitting between the two molecules. Bottom panel repeats the same two structures, now bonded through a new C–N linkage; the previously boxed OH and H are gone from the drawing. An orange-shaded box covers the left amino acid's carbonyl carbon with its double-bonded O above and the right amino acid's nitrogen with its H above, and a leader line from below labels it 'Peptide bond'; the outer amino and carboxyl groups (H₂N– on the left, –COOH on the right) remain unreacted." kind="diagram" eager="true" >}}
...
{{< callout type="info" >}}
**Link to Learning.** Click through the steps of [this PBS interactive](https://openstax.org/l/prokary_protein) to see protein synthesis in action.
{{< /callout >}}
...
{{< mediafigure src="biology/aminoandtrna" alt="Two-stage diagram of tRNA charging. Top banner 'Amino Acid and tRNA Enter Active Site': a blue hexagon labeled 'Cysteine (Cys) Amino Acid' and a purple looped tRNA labeled 'Cys-tRNA' (with an inset circle zooming on its anticodon loop, labeled A-C-A) both arrow into a tan enzyme shape labeled 'Aminoacyl-tRNA Synthetase'. A white arrow leads down to the bottom banner 'Aminoacyl-tRNA Synthetase Catalyzes Covalent Bonding', where the same enzyme holds the tRNA with the blue amino acid attached at its tip; beside the white arrow, a black arrow runs from an orange ATP burst to 'AMP + 2 Pᵢ'." longdesc="A blue-gray background holds two dark banners. The upper banner reads 'Amino Acid and tRNA Enter Active Site' above a Cysteine (Cys) amino acid hexagon and a purple Cys-tRNA, both arrowing toward a tan kidney-shaped 'Aminoacyl-tRNA Synthetase' enzyme; an inset circle to the left zooms into the tRNA's anticodon loop, showing three bases labeled A, C, A and captioned 'Complementary tRNA Anticodon'; a large white arrow leads down from this enzyme to a second copy of it. The lower banner reads 'Aminoacyl-tRNA Synthetase Catalyzes Covalent Bonding' above the same enzyme shape, now shown holding the Cys-tRNA with the blue amino acid bonded to its top end. To the right of the white arrow, a curved black arrow runs from an orange starburst labeled 'ATP' down to the text 'AMP + 2 Pᵢ', showing ATP spent as the enzyme passes from the first stage to the second." kind="diagram" >}}
...
Protein synthesis begins with the formation of an **initiation complex**. In *E. coli*, this complex involves the small 30S ribosome, the mRNA template, three initiation factors (IFs; IF-1, IF-2, and IF-3), and a special **initiator tRNA**, called tRNA<sup>fMet</sup>.
...
{{< mediafigure src="biology/Figure_15_05_02-c4f4" alt="Sequence diagram of translation along an mRNA strand running 5′ to 3′. At the left, a small ribosomal subunit sits over a green start codon with an initiator tRNA, and a large subunit sits tilted on top of it. In the middle, a ribosome holds a short growing polypeptide chain with several purple tRNAs attached. At the right, a large subunit sits over a red stop codon, its small subunit separated below the strand, while a completed polypeptide chain floats free at the top right and empty tRNAs dissociate near each ribosome." longdesc="Left to right along an orange mRNA strand labeled '5′' at its left end: a small ribosomal subunit sits at a green-highlighted 'Start Codon,' with a purple 'Initiator tRNA' in place and a tan 'Large Subunit' sitting tilted on top of it; a 'Small Subunit' label points to the small ribosomal piece. Moving right, a complete ribosome holds three purple tRNAs bearing a growing blue 'Polypeptide' chain, with an arrow showing an empty tRNA leaving toward the upper left. Below the mRNA just right of this ribosome, an empty purple tRNA drifts free. At the far right, the mRNA's '3′' end curls up into a large subunit, ending in a red-highlighted 'Stop Codon'; the small subunit has dropped away below the strand, a second empty tRNA drifts beside it, and a fully formed blue chain labeled 'Completed Polypeptide' floats free above." kind="diagram" >}}
...
{{< multiplechoice
  question="Tetracycline blocks the A site on the bacterial ribosome. Which of the following processes would tetracycline directly affect?"
  answer="tRNA binding to the ribosome"
  hint="Reread the first paragraph of Translation, Elongation, and Termination."
>}}
...
{{< multiplechoice
  question="Chloramphenicol blocks peptidyl transfer. Which of the following processes would chloramphenicol directly affect?"
  answer="growth of the protein chain"
  hint="Reread the elongation paragraph just before the translation figure."
>}}
tRNA binding to the ribosome
ribosome assembly
growth of the protein chain
...
{{< mediafigure src="biology/translationtermination" alt="Three-panel diagram of translation termination, left to right. Panel 1, 'Ribosome Reaches a Stop Codon on mRNA': a ribosome holding a blue release factor and a purple polypeptide-bearing tRNA sits over an orange mRNA strand with its stop codon at the A site. Panel 2, 'Release Factor Promotes Hydrolysis': the same ribosome now shows a free polypeptide detached above it. Panel 3, 'Ribosome Subunits and Other Components Dissociate': the ribosome's large and small subunits separate from each other and from the mRNA, alongside the released tRNA, with '2 GTP → 2 GDP + 2 Pᵢ' shown below." longdesc="Panel 1 ('Ribosome Reaches a Stop Codon on mRNA'): a tan ribosome sits on an orange mRNA strand labeled 5′ at left and 3′ at right; a blue rectangular 'Release Factor' occupies the ribosome's A site beside a purple tRNA carrying a short blue polypeptide, over the codon that a leader line from below labels 'Stop Codon (UAG, UAA, or UGA)'. Panel 2 ('Release Factor Promotes Hydrolysis'): the same arrangement, with a short blue 'Free Polypeptide' chain now shown detached above the ribosome. Panel 3 ('Ribosome Subunits and Other Components Dissociate'): the ribosome has split into an upper piece (holding a purple tRNA, with an arrow pointing up and to the left) and a lower piece at the bottom; between them the mRNA strand (labeled 5′ and 3′) floats free of both, and a second purple tRNA floats free at its left. Below, between the second and third panels, an orange burst labeled '2 GTP' arrows to the text '2 GDP + 2 Pᵢ'." kind="diagram" >}}
...
{{< mediafigure src="biology/Targeted_Protein_Formation-XZZ" alt="Diagram of a protein being co-translationally targeted into the endoplasmic reticulum. In the labeled cytosol at bottom left, a ribosome on an mRNA strand produces a growing polypeptide topped by a signal peptide, which a signal recognition particle (SRP) binds; the SRP-bound complex then docks at a translocation complex and SRP receptor protein on the ER membrane. Four more ribosome-mRNA complexes to the right show the complex docking, the chain threading through the membrane into the ER lumen, the signal peptide being clipped off, and finished protein chains accumulating in the ER lumen." longdesc="Left to right, five ribosome-mRNA complexes trace the pathway through a region labeled 'Cytosol,' and a sixth ribosome at the lower right sits dissociated into its two separate subunits beside an mRNA strand. The first (bottom left) is labeled with 'Ribosome' and 'mRNA'; from it rises a blue polypeptide topped with three red beads labeled 'Signal Peptide,' and a free teal L-shaped 'Signal Recognition Particle (SRP)' floats beside it, with a red arrow leading up to the second complex. The second complex, higher up, has the SRP clamped onto its signal peptide, and a red arrow leads from it up to a small dark blue 'Translocation Complex' and 'SRP Receptor Protein' in the wavy ER membrane at the top of the image, which separates the 'Cytosol' below from the 'ER Lumen' above; a second red arrow leads from there down and right to the third complex. The third complex, still carrying the SRP, sits just under the membrane beside a dark blue receptor. The fourth is docked on the dark blue translocation complex, its signal peptide inserted into the membrane, while the teal SRP drifts away below it on a downward red arrow. Next to the fifth, a free run of red beads is labeled 'Signal Peptide Removed'; the fifth complex's chain, with no signal peptide, threads through the membrane and coils up inside the ER Lumen, and a separate finished coiled chain in the lumen beside it is labeled 'Protein.'" kind="diagram" >}}
...
- **initiator tRNA** — in prokaryotes, called tRNA<sup>fMet</sup>; in eukaryotes, called tRNA<sub>i</sub>; a tRNA that interacts with a start codon, binds directly to the ribosome P site, and links to a special methionine to begin a polypeptide chain
- **Kozak's rules** — determines the correct initiation AUG in a eukaryotic mRNA; the following consensus sequence must appear around the AUG: 5′-GCC(**purine**)CC<u>AUG</u>**G**-3′; the bolded bases are most important
...
{{< multiplechoice
  question="In any given species, there are at least how many types of aminoacyl tRNA synthetases?"
  answer="20"
  hint="Reread the paragraph under Aminoacyl tRNA Synthetases."
>}}
20
40
100
...
{{< selfcheck question="Transcribe and translate the following DNA sequence (nontemplate strand): 5′-ATGGCCGGTTATTAAGCA-3′" hint="Use the codon table in Section 15.1." >}}
...
the protein would be MAGY
the fifth codon corresponds to a stop
the sixth codon would not be translated
{{< /selfcheck >}}

{{< selfcheck question="Explain how single nucleotide changes can have vastly different effects on protein function." hint="Reread Section 15.1’s paragraph on degeneracy, and this section’s initiation and termination paragraphs." >}}
...
===CHECKS===
nucleotide changes in the third position of codons may not change the amino acid
would have no effect on the protein
other nucleotide changes that change important amino acids or create or delete start or stop codons
would have severe effects on the amino acid sequence of the protein
{{< /selfcheck >}}

{{< selfcheck question="A normal mRNA that reads 5′-UGCCAUGGUAAUAACACAUGAGGCCUGAAC-3′ has an insertion mutation that changes the sequence to 5′-UGCCAUGG**U**UAAUAACACAUGAGGCCUGAAC-3′. Translate the original mRNA and the mutated mRNA, and explain how insertion mutations can have dramatic effects on proteins. (Hint: Be sure to find the initiation site.)" hint="Use the codon table in Section 15.1." >}}
The original mRNA reads 5′-UGCC AUG GUA AUA ACA CAU GAG GCC UGA AC-3′, which translates to Met–Val–Ile–Thr–His–Glu–Ala. The mutated mRNA reads 5′-UGCC AUG G**U**U AAU AAC ACA UGA GGCCUGAAC-3′, which translates to Met–Val–Asn–Asn–Thr. Insertion mutations can have dramatic effects on proteins because they shift the reading frame for the codons; this changes the amino acids encoded by the mRNA and can introduce premature start or stop sites.
===CHECKS===
the original mRNA translates to Met–Val–Ile–Thr–His–Glu–Ala
the mutated mRNA translates to Met–Val–Asn–Asn–Thr
insertion mutations shift the reading frame for the codons
this changes the amino acids encoded by the mRNA
can introduce premature start or stop sites
{{< /selfcheck >}}

{{< textin
  question="The mRNA triplet from which translation begins, and which always specifies methionine, is called the ________."
  answer="start codon"
  hint="Reread the third paragraph of Initiation of Translation."
>}}

### Discuss the role of ribosomes in protein synthesis

{{< multiplechoice
  question="The RNA components of ribosomes are synthesized in the ________."
  answer="nucleolus"
  hint="Reread the first paragraph under the Ribosomes heading."
>}}
cytoplasm
nucleus
nucleolus
...
{{< multiplechoice
  question="A scientist introduces a mutation that makes the 60S ribosomal subunit nonfunctional in a human cell line. What would be the predicted effect on translation?"
  answer="Translation stalls after the initiation AUG codon is identified."
  hint="Reread the last two paragraphs of Initiation of Translation."
>}}
...
{{< textin
  question="The RNA-based enzyme integrated into the 50S ribosomal subunit that catalyzes the formation of peptide bonds is called ________."
...
{{< textin
  ...
  answer="polysome"
  hint="Reread the end of the second paragraph under the Ribosomes heading."
>}}

...
{{< mediafigure src="biology/Figure_15_05_02-c4f4" alt="Sequence diagram of translation along an mRNA strand running 5′ to 3′. At the left, a small ribosomal subunit sits over a green start codon with an initiator tRNA, and a large subunit is arriving from above. In the middle, a ribosome holds a short growing polypeptide chain with several purple tRNAs attached. At the right, a ribosome sits over a red stop codon with a small subunit already detaching above it, while a completed polypeptide chain floats free at the top right and empty tRNAs dissociate near each ribosome." longdesc="Left to right along an orange mRNA strand labeled '5′' at its left end: a small ribosomal subunit sits at a green-highlighted 'Start Codon,' with a purple 'Initiator tRNA' in place and a tan 'Large Subunit' arriving from above with an arrow; a 'Small Subunit' label points to the small ribosomal piece. Moving right, a complete ribosome holds three purple tRNAs bearing a growing blue 'Polypeptide' chain, with an arrow showing an empty tRNA leaving toward the upper left. Farther right, a fully formed blue chain labeled 'Completed Polypeptide' floats free at the top, with an empty purple tRNA drifting away below it. At the far right, a ribosome sits over a red-highlighted 'Stop Codon' near the mRNA's '3′' end, with its subunits shown separated above and below the strand." kind="diagram" >}}
...
{{< multiplechoice
  ...
  hint="The A site is where an incoming charged tRNA first binds the ribosome, before any peptide bond forms."
>}}
...
{{< multiplechoice
  ...
  hint="Peptidyl transferase catalyzes the peptide bonds that lengthen the polypeptide chain one amino acid at a time."
>}}
tRNA binding to the ribosome
ribosome assembly
growth of the protein chain
...
{{< multiplechoice
  ...
  answer="20"
  hint="At least one synthetase exists for each amino acid used to build proteins."
>}}
20
40
100
...
{{< selfcheck question="Transcribe and translate the following DNA sequence (nontemplate strand): 5′-ATGGCCGGTTATTAAGCA-3′" hint="Read the sequence in triplets, translate to the mRNA's complementary bases, and watch for a stop codon partway through." >}}
...
{{< selfcheck question="Explain how single nucleotide changes can have vastly different effects on protein function." hint="Think about where in a codon a substitution is least likely to change the amino acid, versus where it can create or destroy a start or stop codon." >}}
...
{{< multiplechoice
  ...
  answer="nucleolus"
  hint="This is the nuclear substructure the section says is completely specialized for the synthesis and assembly of rRNAs."
>}}
cytoplasm
nucleus
nucleolus
...
{{< multiplechoice
  ...
  hint="The 40S subunit alone can find the AUG start codon; recall which subunit joins afterward to complete the translation complex."
>}}
...
{{< textin
  ...
  hint="It is built into the ribosome's large subunit, not encoded by a separate free-floating protein."
>}}

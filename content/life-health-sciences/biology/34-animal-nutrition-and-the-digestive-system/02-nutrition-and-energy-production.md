...
description: >-
  The diet's role as the animal body's source of biosynthetic materials and
  ATP production, the essential nutrients — vitamins, minerals, some fatty
  acids, and some amino acids — the body cannot synthesize for itself, and
  how excess food energy is stored as glycogen and fat — adapted from
  OpenStax Biology 2e, Section 34.2.
source_section: "34.2"
weight: 2
---
...
{{< mediafigure src="biology/Figure_B34_02_01" kind="diagram" eager="true" alt="Healthy diet logo shows a plate divided into four sections, labeled fruits; vegetables; grains; and protein. The vegetables and grains sections are larger than the other two. A circle to the side of the plate is labeled dairy. Beneath the plate is the web address, which reads Choose My Plate dot gov." >}}
...
The first step in ensuring that you are meeting the food requirements of your body is an awareness of the food groups and the nutrients they provide. To learn more about each food group and the recommended daily amounts, explore this [interactive site](https://openstax.org/l/food_groups) by the United States Department of Agriculture.
{{< /callout >}}
...
| --- | --- | --- | --- |
| Vitamin B₁ (Thiamine) | Needed by the body to process lipids, proteins, and carbohydrates; coenzyme removes CO₂ from organic compounds | Muscle weakness, Beriberi: reduced heart function, CNS problems | Milk, meat, dried beans, whole grains |
...
| Vitamin B₅ (Pantothenic acid) | Assists in producing energy from foods (lipids, in particular); component of coenzyme A | Fatigue, numbness or burning sensation in hands and feet | Meat, whole grains, milk, fruits, vegetables |
...
| Vitamin B₁₂ (Cobalamin) | Maintains healthy nervous system and assists with blood cell formation; coenzyme in nucleic acid metabolism | Anemia, neurological disorders, numbness, loss of balance | Meat, eggs, animal products |
...
| Vitamin D | Critical for calcium absorption for bone development and strength; maintains a stable nervous system; maintains a normal and strong heartbeat *(Source note: the source row adds "helps in blood clotting," the function this table's own vitamin K row assigns to vitamin K)* | Rickets, osteomalacia, immunity | Cod liver oil, milk, egg yolk |
...
malnourished children have vision and dental problems
may develop many serious health problems
{{< /selfcheck >}}
...
essential for the absorption of fat-soluble vitamins and production of some hormones
fats send a satiation signal to the brain that regulates hunger
without fats, many people may have consumed more calories, resulting in weight gain
{{< /selfcheck >}}
...
not having minerals in the diet can be potentially harmful
{{< /selfcheck >}}
...
the macromolecules move into the small intestine after digestion by the stomach's acid and digestive enzymes
the carbohydrates from the bread are absorbed through the microvilli into the bloodstream
in muscle cells the carbohydrates are broken down into glucose and used for cellular respiration to create ATP
the muscles use the ATP to perform the mechanical work needed to climb a flight of stairs
{{< /selfcheck >}}
...
consuming more processed foods and less fruits and vegetables
even young children who are obese can face health concerns
{{< /selfcheck >}}

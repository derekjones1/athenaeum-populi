...
{{< mediafigure src="biology/Figure_34_01_04ab" kind="diagram" alt="Two labeled line drawings: (a) a vase-shaped hydra with tentacles around its rim and a bell-shaped jellyfish medusa with trailing tentacles, each labeled with a single central Mouth leading into a Gastrovascular cavity; (b) a long, tapering nematode body labeled, front to back, Mouth, Pharynx, Intestine, and Anus." longdesc="The figure has two panels. (a) On the left, a vase-shaped hydra stands upright: a leader line labeled 'Mouth' points to the opening at the top center, ringed by tentacles, and a second leader line labeled 'Gastrovascular cavity' points to the shaded interior chamber that fills most of the body. Beside it, a bell-shaped jellyfish medusa lies on its side with tentacles trailing from the rim of the bell; a leader line labeled 'Mouth' points to the opening at the center underside of the bell, which opens into the same shaded gastrovascular cavity — no separate cavity label is drawn for the jellyfish since it shares the panel's single cavity shading. (b) On the right, a long, tube-shaped nematode is drawn front to back with four leader lines in this order: 'Mouth' at the wide front end, 'Pharynx' just behind it, 'Intestine' along the long shaded middle section, and 'Anus' near the tapered tail end." >}}
...
{{< mediafigure src="biology/Figure_34_01_09" kind="diagram" alt="A schematic line drawing of three side-by-side esophagus segments, each a pair of parallel walls narrowing around a hatched oval mass, with arrows showing the constriction moving down the tube behind the mass in each successive segment." longdesc="Three near-identical drawings sit side by side, each a vertical tube formed by two parallel walls. In each one a hatched oval (the food bolus) sits inside the tube, with the walls pinched inward directly behind it and two small arrows pointing down and outward from that pinch point, showing the constriction pressing the bolus onward. A 'Direction of food' label with a downward arrow sits beside the leftmost drawing. Reading left to right, the pinch point sits progressively lower in the tube in each successive drawing, showing the same wave of constriction traveling farther down the esophagus and pushing the bolus ahead of it." >}}
...
{{< multiplechoice
  ...
  hint="In the figure above, the blood and lymphatic vessels run up inside the villi themselves — check which structure, one level smaller, is a single cell's own surface projections instead."
>}}
...
{{< multiplechoice
  ...
  answer="bicarbonates"
  hint="Look at what the pancreatic juices are rich in when they mix with chyme in the duodenum — an alkaline salt, not a strong industrial base or an acid."
>}}
potassium hydroxide
sodium hydroxide
bicarbonates
...
{{< textin
  ...
  answer="chyme"
  hint="It forms in a saclike organ whose contents have a pH between 1.5 and 2.5, before moving on to the small intestine."
>}}
...
{{< multiplechoice
  ...
  answer="camel"
  hint="The section names two example animals as pseudo-ruminants, ones with a three-chambered stomach and a large fermenting cecum; rule out the true ruminant, the monogastric omnivore, and the bird."
>}}
cow
pig
crow
...
{{< multiplechoice
  ...
  hint="The section explains why birds need to eat often and digest quickly — check whether that reason is about covering distance in flight or about something else flight requires."
>}}
...
{{< multiplechoice
  ...
  hint="Look at which animal's monogastric system the section describes as having an enlarged small intestine and cecum to digest more plant material — it is neither the carnivore nor the two animals without a true single stomach chamber."
>}}
lion
snowshoe hare
earthworm
...
{{< multiplechoice
  ...
  answer="duodenum"
  hint="Bile from the liver, along with pancreatic secretions, enters the first, C-shaped part of the small intestine — not the stomach or the colon."
>}}
stomach
liver
duodenum
...
{{< textin
  ...
  answer="gallbladder"
  accept="gall bladder"
  hint="This organ sits between the liver and the duodenum, releasing its stored contents when fatty acids enter the duodenum."
>}}

...
description: >-
  How herbivores, carnivores, and omnivores digest their food — from a
  single-opening gastrovascular cavity through monogastric, avian, and
  ruminant stomachs — and the vertebrate digestive tract's organs from
  mouth to anus — adapted from OpenStax Biology 2e, Section 34.1.
source_section: "34.1"
weight: 1
---
...
{{< mediafigure src="biology/Figure_34_01_01ab" kind="photo" eager="true" alt="Two photos: (a) a stag with large branching antlers, mouth open mid-call, standing in dry grass; (b) a black, yellow, and white striped caterpillar clinging to a leaf edge and eating into it." >}}
...
{{< mediafigure src="biology/Figure_34_01_02ab" kind="photo" alt="Two photos: (a) a maned lion resting on the ground in dry grassland; (b) a red ladybug with black spots perched on a green leaf." >}}
...
{{< mediafigure src="biology/Figure_34_01_03ab" kind="photo" alt="Two photos: (a) a brown bear wading in shallow water at the edge of a stream; (b) a reddish-brown crayfish perched among green leaves." >}}
...
{{< mediafigure src="biology/Figure_34_01_04ab" kind="diagram" alt="Two labeled line drawings: (a) a vase-shaped hydra with tentacles around its rim and a dome-shaped jellyfish medusa with no tentacles drawn, each labeled with a single central Mouth leading into a Gastrovascular cavity; (b) a long, tapering nematode body labeled, front to back, Mouth, Pharynx, Intestine, and Anus." longdesc="The figure has two panels, one above the other. (a) On the left, a vase-shaped hydra stands upright with four tentacles curving up from its rim; a leader line labeled 'Mouth' points to the opening at the top center, between the tentacles. Beside it, a dome-shaped jellyfish medusa sits bell up, its edge flaring out at the base, with no tentacles drawn; a second 'Mouth' leader points to the opening at the center of its underside. A single label between them, 'Gastrovascular cavity,' sends one line to each animal's shaded interior chamber: the hydra's fills most of its body, and the medusa's spreads across the inside of the dome above its mouth. Beneath the drawings: '(a) A gastrovascular cavity has one opening.' (b) Below, a long, tube-shaped nematode lies horizontally, wide at the left and tapering to a tail at the right, with four leader lines in this order: 'Mouth' at the wide front end, 'Pharynx' just behind it, 'Intestine' along the long shaded middle section, and 'Anus' near the tapered tail end. Beneath it: '(b) An alimentary canal has two openings.'" >}}
...
{{< mediafigure src="biology/Figure_34_01_05ab" kind="diagram" alt="Two labeled side-view line drawings tracing a digestive tract from mouth to anus: (a) a human profile with a straight esophagus leading to a kidney-shaped stomach, a coiled small intestine, a short cecum, and a large intestine ending at the anus; (b) a rabbit profile with the same organs, but a much longer, more tightly coiled small intestine and a long, segmented cecum curving off to the right, beside a winding colon that leads to the anus." longdesc="Two side-view drawings, each showing a tube-like digestive tract with leader-line labels from the mouth down to the anus. (a) Human digestive system, eight labels top to bottom: Esophagus (the straight tube from the mouth), Liver (a dark red wedge sitting against the stomach), Stomach (the kidney-shaped pouch below the esophagus), Pancreas (a pale organ tucked beneath the stomach), Small intestine (a tightly coiled tube below the stomach), Cecum (a small pouch where the small intestine meets the large intestine), Large intestine (a short, wide, segmented tube running straight down from the cecum), and Anus (the tract's opening at the bottom). (b) Rabbit digestive system, the same eight organs in the same top-to-bottom order — Esophagus, Liver, Stomach, Pancreas, Small intestine, Cecum, Colon (labeled in place of 'large intestine'), and Anus — but drawn with a much longer, more tightly wound small intestine; a long, wide, segmented cecum that extends off to the right and hooks down at its end; and a narrow, winding colon folded back and forth below the coils on its way to the anus." >}}
...
{{< mediafigure src="biology/Figure_34_01_07" kind="diagram" alt="A labeled line drawing of a goat in profile with its four stomach chambers — Rumen, Reticulum, Omasum, Abomasum — drawn as connected pouches in its belly, threaded with red and blue arrows tracing two loops between the esophagus and the chambers, and leader lines to the small intestine, large intestine, and anus." longdesc="A goat stands in profile, head and neck at the right. Two parallel tracks of small arrows, one red and one blue, run down the esophagus from the mouth toward the body. At the base of the neck the esophagus ends at a junction above the stomach chambers, and there a single red arrow points back up the esophagus toward the mouth. Red track: from the junction a red arrow runs left along the top of the Rumen (labeled; the largest chamber, center-left); red arrows circle down its left side, along its bottom, and up its right side, and a red arrow leads back to the junction. From the junction red arrows also run down into the Reticulum (labeled; a small pouch at the right end of the cluster) and loop back up to the junction, where the red arrow turns back up the esophagus. Blue track: from the junction blue arrows lead into the Omasum (labeled; a round chamber between the rumen and the reticulum) and curve around inside it, then run along the bottom of the Abomasum (labeled; the pouch wrapping below and to the left of the omasum) and up its left side into a tube that folds over the top of the rumen and runs left, still carrying blue arrows, to the coiled Small intestine (labeled) at the goat's rear flank. A leader labeled Large intestine points to the tube that runs from the coils along the back toward the tail, and Anus labels its end beneath the tail." >}}
...
{{< mediafigure src="biology/Figure_34_01_08ab" kind="diagram" alt="Two labeled cutaway side-view line drawings of a human head: (a) the oral cavity and throat, showing the nasal cavity, tongue, uvula, jaw, and lips opening into the pharynx and esophagus; (b) the same head with the three salivary glands — parotid, submandibular, and sublingual — shown beside the teeth." longdesc="Two cutaway side-view drawings of a human head in profile. (a) Nine leader lines: Nasal cavity (the pink chamber above the mouth), Oral cavity (the space inside the closed mouth, under the roof of the mouth and above the tongue), Uvula (the small flap hanging at the back of the mouth), Pharynx (the passage behind the uvula), Lips and Jaw (the mouth's outer structures), Tongue (the muscle filling the lower mouth), Larynx and Esophagus (the two tubes at the base of the throat, larynx toward the front, esophagus toward the back). (b) Four leader lines: Teeth (the row inside the open mouth), Parotid gland (a large gland behind the jaw, toward the ear), Submandibular gland (a smaller gland beneath the jaw), and Sublingual gland (a gland further forward, beneath the tongue)." >}}
...
{{< mediafigure src="biology/Figure_34_01_09" kind="diagram" alt="A schematic line drawing of three side-by-side esophagus segments, each a pair of parallel walls narrowing around a hatched oval mass, with arrows showing the constriction moving down the tube behind the mass in each successive segment." longdesc="Three near-identical drawings sit side by side, each a vertical tube formed by two parallel walls. In each one a hatched oval (the food bolus) sits inside the tube, with the walls pinched inward directly behind it and two small arrows pointing down and outward from that pinch point, showing the constriction pressing the bolus onward. A 'Direction of food' label, with no arrow of its own, sits at the upper left beside the leftmost drawing; the down-pointing arrows show that direction. Reading left to right, the pinch point sits progressively lower in the tube in each successive drawing, showing the same wave of constriction traveling farther down the esophagus and pushing the bolus ahead of it." >}}
...
{{< mediafigure src="biology/Figure_34_01_11f" kind="diagram" alt="A three-panel diagram of the small intestine wall: a 3D block of tissue with villi on its inner surface, an arrow leading to an enlarged cross-section of two villi threaded with blood and lymphatic vessels, and a second arrow leading to a close-up of a single absorptive cell's microvilli." longdesc="Three panels connected left to right by two gray arrows. Left panel: a block of intestinal tissue labeled with four leader lines — Vessel carrying blood (branching vessels at the top), Lumen (the hollow opening at the cut face), Muscle layers (two lines to the outer wall of the block), and Villi (three lines to the small fingerlike projections on the inner surface). A gray arrow leads from a small box on the block to the middle panel: an enlarged cross-section of two upside-down-U-shaped villi, each covered along its outer edge by a row of Absorptive cells (labeled at upper right); a vertical bracket at the left, labeled Villi, spans the height of the left villus. A green vessel runs up the middle of each villus and joins a green vessel along the base of the panel, labeled Lymphatic vessel. Only the right villus also holds blood vessels: a red vessel labeled Artery and a blue vessel labeled Vein run up either side of the green one, joined by small cross-links, one of them labeled Capillary; below, the red and blue vessels join red and blue vessels running along the base beside the green one. A second gray arrow leads from a small box on the right villus's cell layer to the right panel: a close-up cross-section of one absorptive cell, its bristly upper border labeled Microvilli, its interior showing scattered organelles and a central nucleus." >}}
Villi are folds on the small intestine lining that increase the surface area to facilitate the absorption of nutrients.
{{< /mediafigure >}}

{{< multiplechoice
  question="Which of the following statements about the small intestine is false?"
  answer="Microvilli are lined with blood vessels as well as lymphatic vessels."
  hint="Compare each statement with the labels on the small-intestine figure above and the Small Intestine paragraph."
>}}
...
{{< mediafigure src="biology/Figure_34_01_12" kind="diagram" alt="A labeled diagram of the large intestine drawn as a squared-off loop, its ascending, transverse, and descending colon segments shaded teal, with the cecum, vermiform appendix, sigmoid colon, rectum, and anus shown at its two lower ends." longdesc="The large intestine is drawn as a squared-off loop with eight leader-line labels. On the left, from bottom to top: Vermiform appendix (a thin projection hanging off the cecum), Cecum (a small, olive-yellow rounded pouch above it), and Ascending colon (the teal segment rising from the cecum). Across the top: Transverse colon (the teal segment running left to right). On the right, from top to bottom: Descending colon (the teal segment descending), then Sigmoid colon (two lines to the curving teal segment at the bottom, which bends back toward the middle), Rectum (the magenta segment it leads into, hanging downward), and Anus (the tract's opening at the very bottom, labeled at lower left)." >}}
...
{{< multiplechoice
  ...
  answer="bicarbonates"
  hint="Look at the Small Intestine subsection, at what happens to chyme once it leaves the stomach."
>}}
potassium hydroxide
sodium hydroxide
bicarbonates
...
{{< multiplechoice
  ...
  answer="camel"
  hint="Look at the Pseudo-ruminants subsection, which names its example animals."
>}}
cow
pig
crow
...
{{< multiplechoice
  question="A scientist dissects a new species of animal. If the animal's digestive system has a single stomach with an extended small intestine, to which animal could the dissected specimen be closely related?"
  answer="snowshoe hare"
  hint="Look at the Monogastric: Single-chambered Stomach subsection and the digestive-system figures that follow it."
>}}
lion
snowshoe hare
earthworm
...
the abomasum is the "true" stomach, equivalent to the monogastric stomach chamber
the four-compartment chamber provides larger space and microbial support for digesting plant material
{{< /selfcheck >}}
...
the salivary glands, liver, pancreas, and gallbladder play important roles
malfunction of any of these organs can lead to disease states
{{< /selfcheck >}}
...
food is stored, soaked, and ground into finer particles, often using pebbles
...
physically breaking food into smaller components exposes a larger surface area for chemical digestion
the teeth break large bites down into smaller pieces that are easily swallowed
the stomach's muscle contractions churn food to expose it to acid and digestive enzymes
{{< /selfcheck >}}

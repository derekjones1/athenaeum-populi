...
{{< multiplechoice
  ...
  hint="Rule out the two statements that misassign where an enzyme acts, and the statement claiming no absorption occurs before the small intestine — the diagram's stomach panel already lists an absorption event."
>}}
...
{{< textin
  ...
  answer="digestion"
  hint="This step reduces large protein, polysaccharide, and lipid molecules into fragments small enough to cross the digestive epithelium."
>}}
...
{{< multiplechoice
  ...
  hint="The first step happens at the mouth; the last step removes what the body could not use."
>}}
...
{{< multiplechoice
  ...
  answer="stomach"
  hint="Recall which organ pepsin acts in, breaking intact protein down into peptides."
>}}
stomach
duodenum
mouth
...
{{< multiplechoice
  ...
  hint="This organ receives what remains of the food only after the small intestine has finished absorbing nutrients."
>}}
the large intestine
the small intestine
the stomach

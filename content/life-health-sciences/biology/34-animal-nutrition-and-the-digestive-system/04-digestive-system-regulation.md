...
description: >-
  How the brain's neural responses to food and the endocrine system's
  hormones — gastrin, somatostatin, secretin, cholecystokinin, and gastric
  inhibitory peptide — together regulate the phases of digestion — adapted
  from OpenStax Biology 2e, Section 34.4.
source_section: "34.4"
weight: 4
---
...
{{< callout type="info" >}}
**Link to Learning** Visit [this website](https://openstax.org/l/enteric_endo) to learn more about the endocrine system. Review how control is implemented in the endocrine system.
{{< /callout >}}
...
gastrin stimulates stomach acid secretion in response to food intake
...
malfunction of this process leaves excess bilirubin in the blood and low bile levels
the body struggles with dealing with fatty food
...
a nonfunctional receptor means somatostatin cannot signal the stomach parietal cells to stop acid secretion
acid secretion continues when no food is present and can damage the stomach tissue

...
description: >-
  How land plants' alternation of generations, sporangia, gametangia, and
  apical meristems let them meet the challenges of colonizing land, and how
  the fossil record traces their spread from the Ordovician onward —
...
{{< callout type="info" >}}
**Link to Learning.** Go to [this article for a more in-depth view of the Charophytes](https://openstax.org/l/charophytes).
{{< /callout >}}
...
The sporophyte of seedless plants is diploid and results from syngamy (fusion) of two gametes. The sporophyte bears the sporangia (singular, sporangium). The term "sporangia" literally means "a vessel for spores," as it is a reproductive sac in which spores are formed. Inside the multicellular sporangia, the diploid **sporocytes**, or mother cells, produce haploid spores by meiosis, during which the 2*n* chromosome number is reduced to 1*n* (note that in many plants, chromosome number is complicated by polyploidy: for example, durum wheat is tetraploid, bread wheat is hexaploid, and some ferns are 1000-ploid). The spores are later released by the sporangia and disperse in the environment. When the haploid spore germinates in a hospitable environment, it generates a multicellular gametophyte by mitosis. The gametophyte supports the zygote formed from the fusion of gametes and the resulting young sporophyte (vegetative form). The cycle then begins anew.

{{< mediafigure src="biology/Figure_25_01_02" alt="A close, low-angle photo of green moss carpeted with dozens of slender, upright stalks, each tipped with a small teardrop-shaped green sporangium; a few reddish-brown, leafless moss stems are interspersed among them." kind="photo" >}}
Sporangia. Spore-producing sacs called sporangia grow at the ends of long, thin stalks in this photo of the moss *Bryum capillare*. (credit: Javier Martin)
{{< /mediafigure >}}
...
- **charophyte** — one of the two groups of green algae; considered the closest relative of land plants. *(Source note: the source glossary says "other term for green algae"; this section's own opening names the chlorophytes and charophytes as the two green-algal groups.)*
- **diplontic** — diploid stage is the dominant stage.
- **embryophyte** — other name for land plant; embryo is protected and nourished by the gametophyte.
...
- **haplodiplontic** — haploid and diploid stages alternate.
...
there is no need to collect light at additional wavelengths
...
there is less humidity in the air and less water in the soil
cactuses are often not densely populated, whereas cattails occur in groups
deserts are usually hot during the day, which increases the risk of desiccation, and have broader temperature ranges
{{< /selfcheck >}}
...
increasing the oxygen concentration in the atmosphere
providing shelter or shade from the sun

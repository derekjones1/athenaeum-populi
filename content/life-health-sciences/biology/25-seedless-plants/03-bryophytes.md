...
{{< mediafigure src="biology/Figure_25_03_05" kind="diagram" alt="A labeled diagram of the hornwort life cycle: a flat gametophyte thallus with cutaway antheridia and archegonia on its underside, and a tall sporophyte tube rising from the thallus, splitting open at the tip to release spores." longdesc="At upper left, an unlabeled lobed young thallus with rhizoids carries a spore case; beside it at upper center, a small curved shoot labeled 'Protonema (1n)' carries a round spore case. The main illustration below shows a flat, lobed gametophyte thallus labeled 'Gametophyte plant (1n)' with 'Thallus' and 'Rhizoids' at its base. Two cutaway circles rise from the thallus: at left an 'Antheridium' containing coiled 'Sperm (1n)', and at right an 'Archegonium' containing an 'Egg (1n)', joined by a small 'Sperm (1n)' circle between them and the caption 'Sperm swim into the archegonium and fertilize the egg, producing a 2n embryo.' From the thallus, a 'Sporophyte (2n)' label points to a short emerging shoot captioned 'The embryo develops into a slender sporophyte,' which continues upward into the tall mature sporophyte at upper right. That sporophyte is labeled top to bottom 'Spores (1n),' 'Pseudoelater,' and 'Stoma,' its split tip shown releasing round spore clusters, with 'Meristem' and 'Foot' labeled near its base and a caption reading 'Within the sporophyte, meiosis produces 1n spores. Each spore grows into a 1n gametophyte plant.'" >}}
...
{{< multiplechoice
  ...
  answer="root"
  hint="Bryophytes anchor themselves with thin filamentous rhizoids instead of this true vascular-plant organ."
>}}
...
{{< multiplechoice
  ...
  hint="Think about what the mosses' shallow rhizoids let them do on frozen ground."
>}}
...
{{< textin
  question="The group of non-vascular plants in which stomata appear is called the ________."
  answer="hornworts"
  accept="hornwort|Anthocerotophyta"
  hint="This phylum's narrow, pipe-like sporophyte keeps growing throughout the life of the plant, and its thallus cells each hold a single chloroplast."
>}}

{{< textin
  question="The most primitive group of the non-vascular plants is called the ________."
  answer="liverworts"
  accept="liverwort|Marchantiophyta"
  hint="This group's flat, lobed thallus gave the phylum its name, since the lobes vaguely resemble those of an organ."
>}}
...
{{< multiplechoice
  ...
  answer="hornworts"
  hint="This group's sporophyte is abundantly covered in these openable, closable air pores. Rule out the algae, the group whose pores are not true stomata, and the generation of another group that the section says lacks them."
>}}
Charales
liverworts
hornworts
...
{{< textin
  ...
  answer="mosses"
  accept="moss|Bryophyta"
  hint="This group occupies a threshold position between the other bryophytes and the vascular plants."
>}}
...
{{< multiplechoice
  ...
  answer="1*n*"
  hint="The protonema germinates directly from a spore, before any fertilization has occurred."
>}}
1*n*
2*n*
3*n*
...
{{< multiplechoice
  ...
  answer="gametophyte"
  hint="This is the dominant, longer-lived stage of the bryophyte life cycle, tolerant of desiccation."
>}}
zygote
gametophyte
sporophyte

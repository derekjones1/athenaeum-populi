...
title: Bryophytes
description: >-
  The three bryophyte phyla — liverworts, hornworts, and mosses — as
  non-vascular, gametophyte-dominant land plants, tracing their shared land
  adaptations and the alternation-of-generations life cycle each one follows
  — adapted from OpenStax Biology 2e, Section 25.3.
source_section: "25.3"
weight: 3
---
...
{{< mediafigure src="biology/Figure_25_03_01" kind="diagram" eager="true" alt="A hand-colored 1904 botanical plate arranging roughly seventeen numbered liverwort species in a grid: leafy, moss-like branching stems in the outer columns, flat lobed thalli, star-shaped and umbrella-topped rosettes, and cup-like structures through the middle, each form its own separate species with no labels beyond a small reference number." >}}
Liverworts. This 1904 drawing shows the variety of forms of Marchantiophyta.
{{< /mediafigure >}}

{{< mediafigure src="biology/Figure_B25_03_10" kind="photo" alt="A close-up photo of a mat of scalloped, glossy green liverwort thalli covering a rock, tiny white dots speckling their surface; a black circle at upper right highlights a small cluster of crescent-shaped gemmae nestled in a cup on one thallus." >}}
...
{{< mediafigure src="biology/Figure_B25_03_03" kind="diagram" alt="A two-part diagram of the liverwort life cycle: a top strip of five drawings tracing fertilization of the egg through spore release and germination, and below it, separate male and female liverwort plants labeled with their antheridial and archegonial heads, thalli, gemma cups, and rhizoids." longdesc="The top strip runs left to right as five drawings joined by four arrows, with three captions beneath. First, a flask-shaped 'Archegonium' holds an Egg (1n), with Sperm (1n) swimming at its base; an arrow leads to the same archegonium holding an Embryo (2n); these two carry the caption 'The sperm swims into the archegonium and fertilizes the egg.' An arrow leads to a larger structure labeled 'Mature Sporophyte,' with a Seta and a sac of Spores (1n) inside it, and an arrow to the same sporophyte with its sac burst open, spilling spores; these carry the caption 'The embryo grows into a slender stalk called a seta. Meiosis produces spores.' A fourth arrow leads to a germinating spore and a small young thallus, both with pointers labeled 'Rhizoids,' captioned 'The spore grow into a thallus with rhizoids.' Below this strip, two separate plants are drawn side by side. On the left, a Female Gametophyte: an Archegonial head (1n) with finger-like Archegonia at the top of a slender stalk, rising from a broad, lobed Thallus (1n) that carries two gemma cups (one label, 'Gemma Cup (Asexual reproduction),' with a leader to each) and Rhizoids at its base. On the right, a Male Gametophyte: an Antheridial head (1n) studded with Antheridia, with a Sperm cell shown in a small circle between the two heads, rising from its own lobed Thallus, which carries one small gemma cup, with Rhizoids at its base. A bar across the bottom reads 'Liverwort Life Cycle.'" >}}
...
{{< mediafigure src="biology/Figure_25_03_04" kind="photo" alt="A close-up photo of a cluster of slender, upright hornwort sporophytes — green near the base, deepening to reddish-brown toward their tapering tips — rising from a wrinkled, dark-green thallus mat." >}}
...
{{< mediafigure src="biology/Figure_25_03_05" kind="diagram" alt="A labeled diagram of the hornwort life cycle: a flat gametophyte thallus with cutaway views of an antheridium and an archegonium sunk in its tissue, and a tall sporophyte tube rising from the thallus, splitting open at the tip to release spores." longdesc="At upper left, an unlabeled lobed young thallus with rhizoids grows from a round, four-part orange spore at its base; beside it at upper center, a small curved green filament labeled 'Protonema (1n)' grows from another such spore. The main illustration below shows a flat, lobed gametophyte thallus labeled 'Gametophyte plant (1n)' with 'Thallus' and 'Rhizoids' at its base. Two cutaway sections of thallus tissue sit above it, each joined to the thallus surface by a leader line: at left an 'Antheridium' sunk in a chamber, its red-dotted contents linked to a magnified circle above labeled 'Sperm (1n)' showing one flagellated sperm, and at right an 'Archegonium' sunk in the tissue, containing an 'Egg (1n)'; between them runs the caption 'Sperm swim into the archegonium and fertilize the egg, producing a 2n embryo.' From the thallus rise two young sporophytes, both pointed to by one 'Sporophyte (2n)' label: a short yellow-green shoot and a taller, slender one whose split tip releases orange spores; the caption 'The embryo develops into a slender sporophyte' points to the taller one. At upper right, an enlarged cutaway of a sporophyte tube stands in a patch of gametophyte tissue. That sporophyte is labeled top to bottom 'Spores (1n),' 'Pseudoelater,' and 'Stoma,' its split tip shown releasing round four-part spores, with 'Meristem' (a bracket just above the base) and 'Foot' (the rounded base embedded in the gametophyte tissue) labeled near its base and a caption reading 'Within the sporophyte, meiosis produces 1n spores. Each spore grows into a 1n gametophyte plant.'" >}}
...
{{< mediafigure src="biology/Figure_B25_03_06" kind="diagram" alt="A four-quadrant flow diagram titled 'Life Cycle of a Typical Moss,' tracing fertilization of egg and sperm, growth of the zygote into a mature spore-capped sporophyte, meiosis and spore release, and germination of the spores into new male and female gametophytes." longdesc="The diagram is titled 'Life Cycle of a Typical Moss' and divided into four boxes joined by arrows. The top half is a lavender band labeled 'Fertilization.' At its left, a pink box shows an Antheridial head with Sperm and Antheridium above a blue box showing an Archegonial head with a Venter and Egg cell; a red arrow leads from the antheridial box down to the archegonial box. Top right, a 2n panel of cutaway drawings: the blue arrow from the archegonial box enters at its lower left, at a Zygote in the Venter beside a Neck; above the zygote sits an Early embryo (2n) in the Venter; to the right a stage labeled Developing calyptra, Enlarged venter wall, Capsule, Seta, and Foot; and at the far right a tall mature sporophyte, boxed in green and labeled 'Sporophyte,' rising from the top of a leafy gametophyte shoot, with a brown Calyptra capping its tip; the red 'Seta' label points both to its long stalk and to the developing stage, and the red 'Capsule' label points to the developing stage only. The blue arrow connects the archegonial box to this panel, and a curved green arrow runs from the mature Sporophyte box down into the bottom-right box. Bottom left, a box labeled 'Mature Gametophytes' (1n) shows two moss shoots side by side, labeled Male and Female, the tip of the male shoot boxed in pink-red and the tip of the female shoot boxed in blue (matching the antheridial and archegonial boxes above), each with Non-vascular 'leaves' and a Non-vascular 'Stem' above Rhizoids at the base. The bottom half is a tan band labeled 'Meiosis' at its lower right. Its right box (1n) shows the sporophyte's Capsule on its Seta with the Operculum and the Calyptra lifted off, releasing red dots; a 'Meiospores (spores)' label points to the red dots and to one larger green spore. Below, a germinating spore has a round swelling labeled 'Spore case' and a short tail labeled 'Rhizoid'; beneath it a boxed inset labeled 'Protonema' shows a branching green filament whose own round swelling and tip carry the same two labels, with a small leafy 'Bud' on it. At the bottom, two leafy shoots labeled 'Young gametophyte' rise from a thread creeping along the ground with 'Rhizoids,' and a 'Bud' label points to two small buds farther along it." >}}
Reproductive cycle of mosses. This illustration shows the life cycle of mosses. (credit: modification of work by Mariana Ruiz Villareal)
{{< /mediafigure >}}
...
The moss sporophyte is dependent on the gametophyte for nutrients. The slender **seta** (plural, setae), as seen below, contains tubular cells that transfer nutrients from the base of the sporophyte (the foot) to the sporangium or **capsule**.

{{< mediafigure src="biology/Figure_25_03_07" kind="photo" alt="A close-up photo of several long, slender, arching dark reddish-brown moss setae, each bearing an oval yellow-green capsule tinged reddish-orange at its base and tip; a pointed cap is visible on some capsules." >}}
Moss sporophyte. This photograph shows the long slender stems, called setae, connected to capsules of the moss *Thamnobryum alopecurum*. The operculum and remnants of the calyptra are visible in some capsules. (credit: modification of work by Hermann Schachner)
{{< /mediafigure >}}
...
do not need soil
do not derive much nutrition from the soil
{{< /selfcheck >}}
...
{{< multiplechoice
  ...
  answer="They do not have true roots and can grow on hard surfaces."
  hint="Reread the Mosses subsection's sentences on the tundra."
>}}
...
the hornworts or Anthocerotophyta
the mosses or true Bryophyta
{{< /selfcheck >}}

{{< textin
  question="A leaf fragment that spreads for asexual reproduction is called a ________."
  answer="gemma"
  accept="gemmae"
  hint="Reread the caption of the photo of a lobate thallus, at its circled structures."
>}}

{{< textin
  question="The most primitive group of the non-vascular plants is called the ________."
  answer="liverworts"
  accept="Marchantiophyta"
  hint="Reread this section's summary, at the sentence that ranks one group as the most primitive."
>}}
...
{{< multiplechoice
  ...
  answer="hornworts"
  hint="Reread the sentences on stomata in the three group subsections."
>}}
Charales
liverworts
hornworts
...
===CHECKS===
a primitive conductive system in their stalks that transports nutrients and water
a more complex, multicellular rhizoid system
{{< /selfcheck >}}
...
{{< multiplechoice
  ...
  answer="1*n*"
  hint="Reread the paragraph on the moss life cycle, at the protonema."
>}}
1*n*
2*n*
3*n*
...
{{< multiplechoice
  question="A botanist travels to an area that has experienced a long, severe drought. While examining the bryophytes in the area, they notice that many are in the same life-cycle stage. Which life-cycle stage *should* be the most common?"
  answer="gametophyte"

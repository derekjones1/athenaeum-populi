---
title: "Knowledge Check: Unit 5 — Chapters 21–29"
description: >-
  A cumulative self-test on Unit 5, Biological Diversity — viruses,
  prokaryotes, protists, fungi, seedless and seed plants, the animal
  kingdom, invertebrates, and vertebrates — with every question written
  from the chapters' own text in OpenStax Biology 2e.
source_chapters: "21-29"
weight: 34
---

{{< callout type="info" >}}
  **Test yourself on Unit 5: Biological Diversity (Chapters 21–29).** Every question below was written from
  the chapters' own text — their summaries, key terms, explanations, and
  tables — and none repeats a question from the section pages. There are no
  hints: treat it like a test. Questions are grouped by the section they
  come from, so a miss tells you exactly which section to review.
{{< /callout >}}
...
{{< multiplechoice
  question="Newly discovered viruses hosted by which organisms can reach up to about 1000 nanometers in diameter, far larger than a typical virion?"
  answer="amoebae"
>}}
bacteria
amoebae
...
===CHECKS===
most viruses probably evolved from different ancestors
viruses have no common genomic sequence that they all share
the 16S rRNA sequence so useful for constructing prokaryote phylogenies is of no use for a creature with no ribosomes
{{< /selfcheck >}}

### 21.2 Virus Infections and Hosts

{{< multiplechoice
  question="The bacteriophage T4, which infects *Escherichia coli* in the human intestinal tract, is an example of a phage with which kind of replication cycle?"
...
===CHECKS===
enveloped viruses have two ways of entering cells after binding to their receptors: receptor-mediated endocytosis, or fusion
fusion only occurs with enveloped virions
special fusion proteins in their envelopes cause the envelope to fuse with the plasma membrane of the cell
...
{{< multiplechoice
  question="Which viral enzyme does Tamiflu (oseltamivir) inhibit to block new influenza virions from leaving their infected host cells?"
...
this leads to an exponential increase of the PrPsc protein
which aggregates
{{< /selfcheck >}}
...
{{< multiplechoice
  question="Autotrophic organisms that convert solar energy into chemical energy, and that appeared within one billion years of Earth's formation, are called ________."
  answer="phototrophs"
>}}
cyanobacteria
phototrophs
...
===CHECKS===
guidelines to identify the organisms responsible for specific diseases
present in all infected samples and absent in all healthy samples
able to reproduce the infection after being cultured multiple times
{{< /selfcheck >}}

### 22.2 Structure of Prokaryotes: Bacteria and Archaea

{{< selfcheck question="According to the principle of the molecular clock, how does the similarity of two species' genes and proteins relate to how recently those species diverged?" >}}
...
===CHECKS===
the more recently two species have diverged, the more similar their genes and proteins will be
species that diverged long ago will have more genes that are dissimilar
{{< /selfcheck >}}
...
the methane moves into the zone above the sediment, which is richer in oxygen
bacteria called methane oxidizers oxidize the methane to carbon dioxide
{{< /selfcheck >}}

### 22.4 Bacterial Diseases in Humans

{{< multiplechoice
  question="What percentage of Native Americans is estimated to have died from infectious diseases introduced by European conquerors?"
  answer="90 percent"
>}}
90 percent
75 percent
...
{{< selfcheck question="Nitrogenase, the enzyme that fixes nitrogen, is inactivated by oxygen. How does a root nodule allow nitrogen fixation to take place without starving the bacteria of the oxygen they need for respiration?" >}}
The nodule provides an oxygen-free area for nitrogen fixation to take place. The oxygen is sequestered by a form of plant hemoglobin called leghemoglobin, which protects the nitrogenase but releases enough oxygen to support respiratory activity.
===CHECKS===
the nodule provides an oxygen-free area for nitrogen fixation to take place
the oxygen is sequestered by a form of plant hemoglobin called leghemoglobin
leghemoglobin protects the nitrogenase but releases enough oxygen to support respiratory activity
{{< /selfcheck >}}

{{< multiplechoice
  question="Several species of bacteria can carry out the biotransformation of which toxic metal, an active ingredient of some pesticides and a by-product of battery production, into nontoxic forms?"
  answer="mercury"
>}}
selenium
arsenic
...
{{< multiplechoice
  question="What treatment has successfully reestablished a healthy gut microbial community in patients with severe diarrhea from a *Clostridium difficile* overgrowth after high-dose antibiotics?"
  answer="fecal transplants from healthy donors"
>}}
additional high-dose antibiotics
cataloging the patient's microbiome through the Human Microbiome Project
fecal transplants from healthy donors
{{< /multiplechoice >}}
...
{{< multiplechoice
  question="Which process of nuclear division, in which replicated chromosomes are divided and separated using elements of the cytoskeleton, is universally present in eukaryotes?"
  answer="mitosis"
>}}
sexual reproduction
karyogamy
...
{{< textin
  question="In the 1960s, American biologist ________ of Boston University developed the endosymbiotic theory, later introducing new data in 1967 to support it."
  answer="Lynn Margulis"
  accept="Margulis"
>}}

{{< selfcheck question="What evidence from the mitochondrion's own membrane structure supports the idea that mitochondria arose through endosymbiosis?" >}}
...
===CHECKS===
mitochondria are shaped like alpha-proteobacteria and are surrounded by two membranes
the inner membrane is bacterial in nature and the outer membrane is eukaryotic in nature
the outer mitochondrial membrane was derived from the enclosing vesicle
the inner membrane was derived from the plasma membrane of the endosymbiont
{{< /selfcheck >}}

### 23.2 Characteristics of Protists

{{< multiplechoice
  question="Protists that ingest food particles by engulfing them with the cell membrane and pinching off an intracellular vesicle are using a process called ________."
  answer="phagocytosis"
>}}
binary fission
phagocytosis
...
{{< textin
  question="Movement toward light, achieved by coupling a protist's locomotion strategy with a light-sensing organ, is called ________."
  answer="phototaxis"
>}}
...
some protists are composed of enormous, multinucleate, single cells that look like amorphous blobs of slime
in some species of protists, the nuclei are different sizes and have distinct roles in protist cell function
{{< /selfcheck >}}

### 23.3 Groups of Protists

{{< multiplechoice
  question="Which giant, multinucleate amoeba has lost its mitochondria but replaced them with bacterial endosymbionts?"
  answer="*Pelomyxa*"
>}}
*Amoeba proteus*
*Dictyostelium*
...
===CHECKS===
rhizarians die and their tests sink into deep water
the carbonates are out of reach of most decomposers, locking carbon dioxide away from the atmosphere
this process is described as the biological carbon pump
carbon is pumped to the ocean depths where it is inaccessible to the atmosphere as carbon dioxide
{{< /selfcheck >}}

### 23.4 Ecology of Protists

{{< textin
  question="The oomycete disease that causes discolored, withered grape leaves and nearly collapsed the French wine industry in the nineteenth century is called ________."
  answer="downy mildew"
>}}
...
without saprobe species, life would cease to exist as all organic carbon became tied up in dead organisms
{{< /selfcheck >}}
...
possess a stem-like structure as well as a root-like fungal mycelium in the soil
...
when the zygospore germinates, it undergoes meiosis and produces haploid spores
...
{{< multiplechoice
  question="Most members of the kingdom Fungi grow in which environment, rich in decaying plant and animal debris?"
  answer="the forest floor"
>}}
...
===CHECKS===
animal dispersal is important for some fungi because an animal may carry fungal spores considerable distances from the source
fungal spores are rarely completely degraded in the gastrointestinal tract of an animal
many are able to germinate when they are passed in the feces
...
{{< multiplechoice
  question="Which fungal disease of cereal crops, especially rye, produces alkaloid toxins whose active ingredient is a precursor of the drug LSD?"
  answer="ergot"
>}}
rusts
smuts
...
Candida, a common member of the natural biota, can grow unchecked and infect the vagina or mouth
if the pH of the surrounding environment, the person's immune defenses, or the normal population of bacteria are altered
{{< /selfcheck >}}

### 24.5 Importance of Fungi in Human Life

{{< multiplechoice
  question="Louis Pasteur's development of a reliable strain of *Saccharomyces cerevisiae* for the French brewing industry in the 1850s was an early example of what?"
  answer="biotechnology patenting"
>}}
...
{{< multiplechoice
  question="Molds of which genus ripen many cheeses, including the wheels stacked in the caves of Roquefort, France, to capture the molds responsible for their blue veins?"
  answer="*Penicillium*"
>}}
*Saccharomyces*
*Penicillium*
...
{{< multiplechoice
  question="Both *Chlamydomonas* and *Ulva* produce flagellated gametes. What additionally happens in the multicellular *Ulva*, but not in the single-celled *Chlamydomonas*, after fertilization?"
  answer="A sporophyte grows by mitosis, exhibiting alternation of generations."
>}}
Cells divide along cell plates called phragmoplasts.
Intercellular channels called plasmodesmata connect adjacent cells.
A sporophyte grows by mitosis, exhibiting alternation of generations.
The organism shows apical growth, from the tips of the plant.
{{< /multiplechoice >}}

{{< textin
  question="The protist supergroup that now includes the brown and golden algae, once classified with the green algae in the kingdom Plantae, is called ________."
  answer="Chromalveolata"
  accept="chromalveolates"
>}}

{{< selfcheck question="What has recent DNA sequence analysis of the charophytes shown about which order is most closely related to the embryophytes?" >}}
...
===CHECKS===
DNA sequence analysis of charophytes indicates that the Zygnematales are more closely related to the embryophytes
than the Charales or the Coleochaetales
{{< /selfcheck >}}
...
the operculum sits at the tip of the spore capsule
...
{{< multiplechoice
  question="Compared to the thin rhizoids that anchor a bryophyte, what advantage do a vascular plant's roots provide?"
  answer="Their vascular tissue transfers water and minerals throughout the plant."
>}}
Their vascular tissue transfers water and minerals throughout the plant.
They produce cone-like strobili that contain sporangia.
They form microphylls, each with a single unbranched vein.
They release flagellated sperm that must swim through a layer of moisture.
{{< /multiplechoice >}}
...
a primary succession, where bare land is settled for the first time by living organisms
a secondary succession, where soil remains intact after a catastrophic event wipes out many existing species
{{< /selfcheck >}}
...
{{< multiplechoice
  question="In seed plants, which of the following develops into a female gametophyte that produces eggs?"
  answer="megaspore"
>}}
microspore
megaspore
...
===CHECKS===
the sperm of modern gymnosperms and all angiosperms lack flagella
in cycads, Ginkgo, and other primitive gymnosperms, the sperm are still motile
use flagella to swim to the female gamete
they are delivered to the female gametophyte enclosed in a pollen grain
{{< /selfcheck >}}

### 26.2 Gymnosperms

{{< multiplechoice
  question="In a pine's male cones, haploid microspores develop into male gametophytes through which process?"
  answer="mitosis"
>}}
pollination
meiosis
...
===CHECKS===
most conifers do not lose their leaves all at once
cannot shed parasites and restart with a fresh supply of leaves in spring
{{< /selfcheck >}}
...
===CHECKS===
male and female flowers are separate but carried on the same plant
sweetgums and birches are monoecious
male and female flowers are found on separate plants
willows and poplars are dioecious
{{< /selfcheck >}}

### 26.4 The Role of Seed Plants

{{< multiplechoice
  question="Ebony and Brazilian rosewood are two examples of tree species driven almost to extinction by which practice?"
  answer="indiscriminate logging"
>}}
...
===CHECKS===
discourage herbivores by stinging and attacking leaf-eaters and insects
help remove potential plant pathogens, such as fungal growths
support the ants with shelter in the hollows of large thorns
sugary secretions produced at the ends of the leaves
{{< /selfcheck >}}
...
{{< multiplechoice
  question="Which tissue type covers and protects both external and internal body surfaces, and may also have secretory functions?"
...
{{< multiplechoice
  question="In mammals, the coelom's abdominal cavity houses the digestive organs, while which cavity houses the heart and lungs?"
...
{{< multiplechoice
  question="Which group did a recent reanalysis of molecular evidence reaffirm as the first animal phylum to diverge from the common ancestor of metazoans?"
  answer="the sponges"
>}}
the comb jellies
the cnidarians
...
{{< multiplechoice
  question="Molecular analysis using rRNA data revealed that lophophorates (including brachiopods and bryozoans), once classified as primitive deuterostomes, are actually protostomes most closely related to which pair of groups?"
  answer="annelids and mollusks"
>}}
...
{{< multiplechoice
  question="The trilobite, a dominant Cambrian-period arthropod, was among the first animals to exhibit which of the following?"
  answer="a sense of vision"
>}}
a sense of vision
compound eyes and spiky tentacles
hard body parts and spicules
internal tubes or canals
{{< /multiplechoice >}}

{{< multiplechoice
  question="In the Cenozoic Era, which group of animals radiated into the terrestrial and aquatic niches once occupied by dinosaurs?"
  answer="mammals"
>}}
birds
mammals
...
{{< selfcheck question="Describe what the discovery of the *Coronacollina acula* fossils suggests about the earliest animals with hard body parts." >}}
...
dated back as far as 560 million years
believed to represent the oldest animals with hard body parts
spicules that extended 20–40 cm from a thimble-shaped body
{{< /selfcheck >}}
...
{{< multiplechoice
  question="Which class of sponges produces six-rayed, glassy siliceous spicules and no spongin?"
...
{{< textin
  question="The rearranging of sponge cells that lets them creep slowly along a substratum is called ________."
  answer="organizational plasticity"
  accept="organisational plasticity"
>}}

{{< selfcheck question="Why does temporal separation of egg and sperm production in a sequentially hermaphroditic sponge help increase genetic diversity?" >}}
...
===CHECKS===
sponges may become sequentially hermaphroditic, producing oocytes first and spermatozoa later
this temporal separation of gametes produced by the same sponge
helps to encourage cross-fertilization and genetic diversity
{{< /selfcheck >}}
...
{{< selfcheck question="What is the adaptive benefit of the septal mesenteries that divide a sea anemone's gastrovascular cavity into several chambers?" >}}
...
===CHECKS===
an increase in surface area for absorption of nutrients and gas exchange
additional mechanical support for the body of the anemone
{{< /selfcheck >}}
...
{{< selfcheck question="Why might nemerteans be regarded as coelomic even though they are sometimes classified as acoels?" >}}
...
===CHECKS===
sometimes classified as acoels
their closed circulatory system is derived from the coelomic cavity of the embryo
they may be regarded as coelomic
{{< /selfcheck >}}

### 28.4 Superphylum Lophotrochozoa: Mollusks and Annelids

{{< multiplechoice
  question="In which molluscan class does the mantle cavity itself form a tube open at both ends and serve as the respiratory structure, since ctenidia are absent?"
  answer="Scaphopoda"
>}}
Scaphopoda
Cephalopoda
...
{{< textin
  question="The primitive 'kidney' structure that facilitates excretion in annelids, consisting of a convoluted tubule and an open, ciliated funnel, present in every segment, is called a ________."
  answer="metanephridium"
  accept="metanephridia"
>}}

{{< selfcheck question="How do deepwater tubeworm polychaetes living near hydrothermal vents obtain nutrition, despite having no digestive tract?" >}}
These deepwater tubeworms have no digestive tract, but have a symbiotic relationship with bacteria living in their bodies.
===CHECKS===
these deepwater tubeworms have no digestive tract
they have a symbiotic relationship with bacteria living in their bodies
{{< /selfcheck >}}
...
{{< multiplechoice
  question="In nematodes, the fusion of all nerve cords at the anterior end forms which structure, acting as the head ganglion or 'brain' of the roundworm?"
  answer="pharyngeal nerve ring"
>}}
posterior ganglion
...
further growth occurs by enlarging the cells
...
{{< multiplechoice
  question="Which layer of the arthropod cuticle is a thin, waxy, water-resistant outer layer that contains no chitin?"
  answer="epicuticle"
>}}
exocuticle
endocuticle
...
{{< selfcheck question="How is a crustacean's brain formed, and what other nervous-system structures does a crustacean have?" >}}
Crustaceans possess a brain formed by the fusion of the first three segmental ganglia, as well as two compound eyes. A ventral nerve cord connects additional segmental ganglia.
===CHECKS===
a brain formed by the fusion of the first three segmental ganglia
two compound eyes
a ventral nerve cord connects additional segmental ganglia
{{< /selfcheck >}}
...
{{< textin
  question="The primitive gut cavity within the gastrula that opens outward via the blastopore is called the ________."
  answer="archenteron"
>}}

{{< multiplechoice
  question="Which class of echinoderms is the only one whose adults show functional bilateral symmetry, due to an extended oral-aboral axis?"
...
{{< selfcheck question="How do an echinoderm's tube feet let it move and capture prey?" >}}
...
===CHECKS===
tube feet can extend or retract based on the volume of water present in the system of that arm
allowing the animal to move
allowing it to capture prey with their suckerlike action
individual tube feet are controlled by bulblike ampullae
{{< /selfcheck >}}
...
the pharyngeal slits and the endostyle
the dorsal hollow nerve cord and pharyngeal slits
the post-anal tail and the endostyle
{{< /multiplechoice >}}
...
===CHECKS===
tetrapod literally means "four-footed"
refers to the phylogenetic history of various land vertebrates
...
===CHECKS===
nearly all bony fishes have an ossified skeleton with specialized bone cells (osteocytes)
reversed only in a few groups of Osteichthyes, such as sturgeons and paddlefish
which have primarily cartilaginous skeletons
{{< /selfcheck >}}
...
===CHECKS===
the papilla amphibiorum is sensitive to frequencies below 10,000 hertz and is unique to amphibians
the papilla basilaris is sensitive to higher frequencies, including mating calls
transmitted from the eardrum through the stapes bone
{{< /selfcheck >}}
...
{{< multiplechoice
  question="Most reptiles are ectotherms, but some members of which group maintain elevated thoracic temperatures and thus appear to be at least regional endotherms?"
  answer="crocodilians"
>}}
squamates
crocodilians
...
{{< selfcheck question="How does the structure of a snake's jaw allow it to swallow large prey?" >}}
...
===CHECKS===
a skull that is very flexible, involving eight rotational joints
mandibles without either bony or ligamentous attachment anteriorly
great dynamic expansion of the gape and independent motion of the two sides
{{< /selfcheck >}}
...
{{< selfcheck question="What does the name 'Enantiornithes' mean, and how did this group of birds differ from modern birds?" >}}
...
===CHECKS===
enantiornithes means "opposite birds"
certain bones of the shoulder are joined differently than the way the bones are joined in modern birds
these birds retained teeth in their jaws
they did not survive past the Cretaceous
{{< /selfcheck >}}

### 29.6 Mammals

{{< multiplechoice
  question="Which type of mammalian skin gland secretes substances used for chemical communication, as in skunks?"
...
{{< textin
  question="The family that includes the echidna, or spiny anteater, is called ________."
  answer="Tachyglossidae"
>}}

{{< selfcheck question="What is the function of the secondary palate, and why is it necessary for chewing?" >}}
...
===CHECKS===
chewing requires the ability to breathe at the same time
facilitated by the presence of a secondary palate
separates the area of the mouth where chewing occurs from the area above where respiration occurs
allowing breathing to proceed uninterrupted while the animal is chewing
{{< /selfcheck >}}
...
{{< selfcheck question="How did the diet of *Paranthropus* differ from that of the australopiths, and what does the wear on its molars suggest?" >}}
*Paranthropus* were muscular and had large grinding teeth. Their molars showed heavy wear, suggesting that they had a coarse and fibrous vegetarian diet as opposed to the partially carnivorous diet of the australopiths.
===CHECKS===
had large grinding teeth
their molars showed heavy wear
a coarse and fibrous vegetarian diet
as opposed to the partially carnivorous diet of the australopiths
{{< /selfcheck >}}

---

<small>This knowledge check is written for Unit 5 (Chapters 21–29) of [Biology 2e](https://openstax.org/books/biology-2e/pages/21-introduction) by Mary Ann Clark, Jung Choi, Matthew Douglas, and OpenStax, © OpenStax, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). Access the original for free at [openstax.org](https://openstax.org/details/books/biology-2e). Changes: every question is locally written from the pinned text of the chapters' own modules — their section summaries, glossary definitions, body passages, and comparison tables — and none is transcribed from the book's exercise sets, which the section pages already carry; no question carries a hint, and every self-check carries a rubric that decomposes a model answer made of the module's own sentences.</small>

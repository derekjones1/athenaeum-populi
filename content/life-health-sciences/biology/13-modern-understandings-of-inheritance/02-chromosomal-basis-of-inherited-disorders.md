...
description: >-
  How karyotypes and karyograms reveal chromosomal abnormalities, how
  nondisjunction during meiosis produces disorders in chromosome number such
  as aneuploidy and polyploidy, and how inversions and translocations
  rearrange chromosome structure — adapted from OpenStax Biology 2e, Section
  13.2.
source_section: "13.2"
weight: 2
---
...
{{< mediafigure src="biology/Figure_13_03_04-cfbf" kind="photo" alt="Photo shows an orange day lily, which is a plant with a large flower; the flower looks like it is bursting with orange petals." >}}
...
{{< mediafigure src="biology/Figure_13_03_05-caa3" kind="photo" alt="Photo shows a tortoiseshell cat with orange and black fur." >}}
...
{{< mediafigure src="biology/Figure_13_03_09" kind="diagram" alt="A diagram titled 'Reciprocal Translocation' showing a blue chromosome and an orange chromosome, each with a banded pattern and a black centromere, before and after exchanging chromosome segments outlined in red." longdesc="Two banded, rod-shaped chromosomes, one blue and one orange, each with a black centromere band, shown before and after translocation. 'Before Translocation' (left): a red-outlined segment just below the centromere of the shorter orange chromosome and a red-outlined segment near the bottom of the longer blue chromosome are joined by two curved arrows, indicating the segments are about to trade places. 'After Translocation' (right, past a gray arrow): the blue chromosome's lower end is now the short orange-banded segment it received, and the orange chromosome's lower arm is now the long blue-banded segment it received, each newly arrived segment still outlined in red; text below reads 'No gain or loss of genetic information.'" >}}
...
the diagram should look like the nondisjunction diagram above
{{< /selfcheck >}}

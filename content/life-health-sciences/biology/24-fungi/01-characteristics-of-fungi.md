...
description: >-
  An overview of what makes fungi distinct from plants and animals — their
  chitin cell walls, external digestion by exoenzymes, hyphal and mycelial
  growth, and both asexual and sexual reproduction through spores — adapted
  from OpenStax Biology 2e, Section 24.1.
source_section: "24.1"
weight: 1
---
...
{{< mediafigure src="biology/Figure_24_01_01" alt="Photo of two Amanita muscaria mushrooms growing among grass and dead leaves: a large mushroom with a wide, glossy red cap dotted with white wart-like patches sits beside a smaller mushroom of the same kind, with a cluster of small gray mushrooms growing at their base." kind="photo" eager="true" >}}
...
{{< mediafigure src="biology/Figure_24_01_02" alt="Micrograph of clumps of small round blue-stained yeast cells against a light blue background, with a line and label pointing to the nucleus inside one cell near the center, and a 20 µm scale bar at lower right." kind="photo" >}}
...
{{< mediafigure src="biology/Figure_24_01_03" alt="Photo of a light brown, wrinkled, disk-shaped fungal colony filling a Petri dish, with a hub-like indentation at its center and folds radiating outward like spokes, surrounded by a ring of powdery white-to-tan growth." kind="photo" >}}
...
{{< mediafigure src="biology/Figure_B24_01_07" alt="A circular diagram titled 'Fungi Life Cycle' showing an asexual loop between spores and a haploid mycelium at the top, and a sexual reproduction loop below running from the mycelium through a heterokaryotic stage and a diploid zygote to haploid spores and back to the mycelium." longdesc="At the top, a small loop connects a cluster of spores to a drawing of branching, cross-walled hyphae labeled 'Mycelium (1n)': an arrow on the right, labeled 'Mitosis,' curves up from the mycelium to the spores, and an arrow on the left, labeled 'Germination,' curves back down from the spores to the mycelium; the center of this loop is labeled 'Asexual Reproduction.' Below the mycelium, a longer loop runs counterclockwise and is labeled 'Sexual Reproduction' at its center. An arrow labeled 'Plasmogamy: Haploid cells from two different mycelia fuse to form a heterokaryotic cell with two or more nuclei' curves down-left from the mycelium to a short hyphal segment marked with a black dot and a red dot (two nuclei) and labeled 'Heterokaryotic stage.' An arrow labeled 'Karyogamy: The nuclei fuse to form a diploid (2n) zygote' curves down from there to a hyphal segment with a single black dot, labeled 'Zygote.' An arrow labeled 'Meiosis: Haploid (1n) spores are formed' curves up-right from the zygote to a second cluster of spores. Finally an arrow labeled 'Germination: A multi-cellular mycelium is formed' curves up from those spores back to the mycelium, closing the loop." kind="diagram" >}}
...
{{< callout type="info" >}}
**Link to Learning.** Watch [a video reviewing the characteristics of fungi](https://openstax.org/l/fungi_kingdom).
{{< /callout >}}
...
{{< selfcheck question="Compare plants, animals, and fungi, considering these components: cell wall, chloroplasts, plasma membrane, food source, and polysaccharide storage. Be sure to indicate fungi’s similarities and differences to plants and animals." hint="Work through the five components in order — cell wall, chloroplasts, plasma membrane, food source, and polysaccharide storage — naming the fungal trait first each time." >}}
...
===CHECKS===
fungi have cell walls containing chitin; plants have cell walls containing cellulose
chloroplasts are absent in both animals and fungi but are present in plants
fungi plasma membranes are stabilized with ergosterol
...
the large mycelium can secrete exoenzymes over a large area
having a large surface area increases the amount of digested molecules that are captured
{{< /selfcheck >}}
...
sexual reproduction allows the recombination of genetic traits
increases the odds of developing new adaptations better suited to a changed environment
{{< /selfcheck >}}

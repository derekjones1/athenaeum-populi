...
description: >-
  A survey of the five true fungal phyla — Chytridiomycota (chytrids),
  Zygomycota (conjugated fungi), Ascomycota (sac fungi), Basidiomycota (club
  fungi), and Glomeromycota — by their reproductive structures and life
  cycles, plus the discontinued Deuteromycota classification for fungi with
  no known sexual phase — adapted from OpenStax Biology 2e, Section 24.2.
source_section: "24.2"
weight: 2
---
...
{{< mediafigure src="biology/Figure_24_02_01" kind="photo" alt="Micrograph A shows an arthropod with a dark, densely speckled teardrop-shaped body, about 90 microns across and 120 microns long including its translucent appendages, with tentacle-like appendages jutting from its front, wide end and clusters of cilia-like appendages from its sides and back; transparent oval organisms about 20 microns across cling to it. Micrograph B shows similar transparent oval organisms clinging to rod-shaped algae about 5 microns across and 200 microns long." >}}
...
{{< mediafigure src="biology/Figure_24_02_03abf" kind="photo" alt="(a) A close-up photo of pale grayish-white fuzzy mold spreading over the crust of a piece of bread. (b) A close-up photo of many thin, hair-like fungal filaments studded with numerous small black dots against an orange-brown background." >}}
...
{{< mediafigure src="biology/Figure_24_02_06" kind="photo" alt="A photo of small white and tan toadstool mushrooms scattered in a curving line across a grassy lawn, forming part of a large ring, with a hedge and trees in the background." >}}
...
{{< mediafigure src="biology/Figure_24_02_08" kind="photo" alt="Micrograph shows Aspergillus mycelia, which look like long threads, and a spherical conidiophore about 40 microns across." >}}
...
animals act as agents of dispersal
the benefit to the fungus outweighs the cost of producing fleshy fruiting bodies
{{< /selfcheck >}}

{{< selfcheck question="For each of the four groups of perfect fungi (Chytridiomycota, Zygomycota, Ascomycota, and Basidiomycota), compare the body structure and features, and provide an example." hint="Work through each phylum in turn: body structure, a defining reproductive feature, then a named example." >}}
...
===CHECKS===
Chytridiomycota may have a unicellular or multicellular body structure; some are aquatic with motile spores with flagella; an example is Allomyces
Zygomycota have a multicellular body structure; features include zygospores and presence in soil; examples are bread and fruit molds
Ascomycota may have unicellular or multicellular body structure; a feature is sexual spores in sacs (asci); examples include the yeasts used in bread, wine, and beer production

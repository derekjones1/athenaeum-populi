...
description: >-
  How fungi support ecosystem balance, agriculture, food and beverage
  production, the chemical and pharmaceutical industries, and biological
  research as model organisms — adapted from OpenStax Biology 2e, Section 24.5.
source_section: "24.5"
weight: 5
---
...
{{< mediafigure src="biology/Figure_B24_05_02" alt="(a) A single morel mushroom with a dark, honeycomb-like convoluted cap growing amid dry grass. (b) A pile of halved white mushrooms with brown gills, viewed from above." kind="photo" >}}
Edible fungi. (a) The morel mushroom is an ascomycete greatly appreciated for its delicate taste. (credit: Jason Hollinger). (b) Basidiocarps of *Agaricus* ready for an omelet (credit: Mary Anne Clark)
{{< /mediafigure >}}
...
without fungi, decaying organic matter would accumulate in the forest
fungi decompose organic matter into small carbon-containing compounds
this process releases carbon dioxide back into the air for plants to use during the carbon-fixation steps of photosynthesis
decomposition by fungi also releases nitrogen for use by living organisms

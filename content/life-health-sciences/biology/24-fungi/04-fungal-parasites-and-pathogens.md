...
description: >-
  How fungi cause disease in plants and animals, the difference between
  superficial and systemic mycoses in humans, and why the shared eukaryotic
  biology of fungi and their hosts makes antifungal therapy hard to target —
  adapted from OpenStax Biology 2e, Section 24.4.
source_section: "24.4"
weight: 4
---
...
{{< callout type="info" >}}
**Scientific Method Connection.** *Dutch Elm Disease*
...
the two populations are constantly applying evolutionary pressure on each other
the grapes are the prey and the fungi are the predator
the grapes develop defenses to prevent infection by the fungi
{{< /selfcheck >}}

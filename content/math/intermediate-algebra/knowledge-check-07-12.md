---
title: 'Knowledge Check: Chapters 7–12'
description: >-
  A cumulative self-test covering rational expressions, roots and radicals,
  quadratic equations, exponential and logarithmic functions, conics, and
  sequences and series — adapted from the chapter Practice Tests of OpenStax
  Intermediate Algebra 2e and graded against the book's Answer Key.
source_chapters: "7-12"
weight: 14
---

{{< callout type="info" >}}
  **Test yourself on Chapters 7–12.** Every question comes from the source
...
$f(x)=\tfrac{x-4}{x^2-3x-10}$ and
$g(x)=\tfrac{x-5}{x^2-2x-8}$.
...
{{< graphplot
  question="Graph $f(x)=x^2-4x-1$ using transformations."
...
{{< fillin
  question="Find the inverse of the function $f(x)=x^5-9$."
  answer="\sqrt[5]{x+9}"
  answerDisplay="$f^{-1}(x)=\sqrt[5]{x+9}$"
>}}
...
{{< multiplechoice
  question="Identify the type of graph of $x^2+y^2+10x+6y+30=0$."
  answer="circle"
>}}
circle
parabola
...
{{< graphplot
  question="Use properties of the standard form to graph $y=2x^2-4x-2$."
  answerDisplay="$y=2(x-1)^2-4$"
...
{{< multiplechoice
  question="Solve the nonlinear system of equations by graphing: $3y^2-x=0$ and $y=-2x-1$."
  answer="no solution"
>}}
no solution
one solution

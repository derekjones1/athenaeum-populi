...
description: >-
  A cumulative self-test covering foundations, linear equations, graphs and
  functions, systems, polynomials, and factoring — adapted from the chapter
  Practice Tests of OpenStax Intermediate Algebra 2e and graded against the
  book's Answer Key.
source_chapters: "1-6"
weight: 7
---
...
{{< multiplechoice
  question="Is $(2,0)$ a solution of $5x + y = 10$?"
  answer="yes"
>}}
yes
no
...
{{< multiplechoice
  question="Classify the lines $y = 5x - 1$ and $10x + 2y = 0$."
  answer="neither"
>}}
parallel
perpendicular
...
{{< multiplechoice
  question="Is $(6,1)$ a solution of $x + y > 4$?"
  answer="yes"
>}}
yes
no
...
{{< multiplechoice
  question="Is $(2,-1)$ a solution of the system $4x + y > 6$ and $3x - y \le 12$?"
  answer="yes"
>}}
yes
no
...
{{< multiplechoice
  question="Classify $8y^4 - 3y^2 + 1$ by its number of terms."
  answer="trinomial"
>}}
monomial
binomial

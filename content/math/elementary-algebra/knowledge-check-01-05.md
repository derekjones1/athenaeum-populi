---
title: 'Knowledge Check: Chapters 1–5'
description: >-
  A cumulative self-test covering foundations, linear equations and
  inequalities, math models, graphs, and systems of linear equations —
  adapted from the chapter Practice Tests of OpenStax Elementary Algebra 2e
  and graded against the book's Answer Key.
source_chapters: "1-5"
weight: 6
---
...
{{< fillin
  question="Solve the formula $A = \tfrac{1}{2}bh$ for $h$."
  answer="\frac{2A}{b}"
...
{{< multiplechoice
  question="Is the ordered pair $(2, -1)$ a solution to the system: $4x + y > 6$ and $3x - y \le 12$?"
  answer="yes"
>}}
yes
no

...
description: >-
  A cumulative self-test covering whole numbers, the language of algebra,
  integers, fractions, decimals, and percents — adapted from the chapter
  Practice Tests of OpenStax Prealgebra 2e and graded against the book's
  Answer Key.
source_chapters: "1-6"
weight: 7
---
...
{{< fillin
  question="Translate the phrase into an algebraic expression: three times the difference of $a$ and $b$."
  answer="3(a-b)"
  answerDisplay="$3(a - b)$"
>}}
...
{{< fillin
  question="Order using < or >. Enter the full inequality: $-2\tfrac{1}{2} \_\_ -3$"
  answer="-2\frac{1}{2}>-3"

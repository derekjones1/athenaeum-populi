/**
 * Run with:  node --test assets/js/lib/math/check-answer.test.mjs   (needs Node 22+)
 *
...
// The shape checks the tools call directly (tools/verify/verify-answers.mjs and
// tools/verify/verify-replay.mjs read `checkFormAsGraded`), pinned on the writings

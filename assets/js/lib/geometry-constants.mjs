 ...
 *
 * NOT shared with `assets/js/lib/check-answer.mjs`, whose `SAMPLE_TOLERANCE`
 ...
 * with `tools/verify-answers.mjs`'s independent 1e-8 relative tolerance. The
 * two graders must be able to disagree — see tools/grader-differential.test.mjs.
 */

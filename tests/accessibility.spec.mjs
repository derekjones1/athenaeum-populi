...
const REPRESENTATIVE_PAGES = [
  ...
  {
    name: 'microbiology block 2 knowledge check (chapters 07–12)',
    path: '/life-health-sciences/microbiology/knowledge-check-07-12/',
  },
  {
    name: 'microbiology block 3 knowledge check (chapters 13–14)',

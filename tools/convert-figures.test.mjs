...
import { toSvgString } from '../assets/js/lib/graph-core.mjs';
...
import { buildGraph } from '../assets/js/lib/graph-core.mjs';

const TOOL = new URL('./convert-figures.mjs', import.meta.url).pathname;

/** a legacy figure block exactly as tools/render-figure.mjs emitted it */

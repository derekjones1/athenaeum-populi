 ...
 *
 * Three helpers were byte-identical across `tools/lint/lints.mjs` (which reads
 * authored HTML in Markdown), `tools/build/audit-build.mjs` and
 * `tools/build/check-pagefind.mjs` (which read Hugo's output). Identical by luck: a
 ...
 * attribute value does not end a tag. `tools/figures/render-figure.mjs` emits its

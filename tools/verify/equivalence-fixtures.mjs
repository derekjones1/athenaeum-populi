 ...
 *
 *   assets/js/lib/math/check-answer.mjs   the runtime grader a learner meets. Runs
 *                                    the Compute Engine's equivalence ladder
 *                                    (isSame → isEqual → simplify(diff)) with
 *                                    numeric sampling as the guarded fallback,
 *                                    absolute tolerance 1e-9.
 *   tools/verify/verify-answers.mjs         the corpus oracle. Deliberately never
 ...
 * tools/verify/grader-differential.test.mjs, and only the verdicts are compared.

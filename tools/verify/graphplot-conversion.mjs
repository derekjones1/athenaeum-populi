 ...
 *
 *   node tools/verify/graphplot-conversion.mjs init                  create the queue
 *   node tools/verify/graphplot-conversion.mjs candidates content   the unread queue
 *   node tools/verify/graphplot-conversion.mjs list content [--verdict convert]
 *   node tools/verify/graphplot-conversion.mjs merge <resultsDir>
 *   node tools/verify/graphplot-conversion.mjs stats content
 *   node tools/verify/graphplot-conversion.mjs prune content
 *
...
function usage(detail) {
  ...
  console.error('usage: node tools/verify/graphplot-conversion.mjs <init|candidates|list|merge|prune|stats> [root|resultsDir] [--verdict v] [--shard i/n] [--ledger path]');
  process.exit(2);
}

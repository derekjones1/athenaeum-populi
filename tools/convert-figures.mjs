 ...
 *
 *   node tools/convert-figures.mjs --dry-run content/math/<book>/<chapter>
 *   node tools/convert-figures.mjs content/math/<book>/<chapter>/03-section.md
 *
...
function main(argv) {
  ...
  if (!roots.length) {
    console.error('usage: node tools/convert-figures.mjs [--dry-run] [--tidy-pins] [--gallery out.html] <path…>')
    return 2
  }
